...
extension Archive.ArchiveError: @retroactive LocalizedError {
    public var errorDescription: String? {
        ...
        case .cancelledOperation:
            String(localized: "zip.error.cancelled-operation", defaultValue: "Operation cancelled.", comment: "Error description for cancelled ZIP operation")
    ...
    public var failureReason: String? {
        ...
        case .invalidCentralDirectoryEntryCount:
            String(localized: "zip.error.invalid-central-directory-count", defaultValue: "Invalid central directory entry count.", comment: "Failure reason for invalid central directory entry count")
