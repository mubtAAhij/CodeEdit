...
extension Archive.ArchiveError: @retroactive LocalizedError {
    public var errorDescription: String? {
        ...
        case .invalidLocalHeaderDataOffset,
            ...
            String(localized: "zip.error.invalid-file", defaultValue: "Invalid file detected.", comment: "Invalid file detected error")
        case .uncontainedSymlink:
            String(localized: "zip.error.uncontained-symlink", defaultValue: "Uncontained symlink detected.", comment: "Uncontained symlink detected error")
        }
    }
    ...
    public var failureReason: String? {
        return switch self {
        case .invalidLocalHeaderDataOffset:
            String(localized: "zip.error.invalid-local-header-offset", defaultValue: "Invalid local header data offset.", comment: "Invalid local header data offset error")
        ...
        case .missingEndOfCentralDirectoryRecord:
            String(localized: "zip.error.missing-end-of-central-directory", defaultValue: "Missing end of central directory record.", comment: "Missing end of central directory record error")
        default:
            nil
        }
    }
