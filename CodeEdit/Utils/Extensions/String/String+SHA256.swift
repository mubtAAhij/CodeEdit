...
extension String {
    ...
    func sha256(trim: Bool = false, caseSensitive: Bool = true) -> String {
        ...
        return computed.compactMap { String(format: String(localized: "string.sha256.hex-format", defaultValue: "%02x", comment: "Hexadecimal format specifier - technical format string, should not be localized"), $0) }.joined()
    }
}
