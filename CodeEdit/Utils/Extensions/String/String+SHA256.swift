...
extension String {
    ...
    func sha256(trim: Bool = false, caseSensitive: Bool = true) -> String {
        ...
        return computed.compactMap { String(format: String(localized: "utils.string.sha256.hex-byte-format", defaultValue: "%02x", comment: "Hex format specifier for SHA256 byte encoding"), $0) }.joined()
    }
}
