    ...
    var body: some Scene {
        Group {
            ...
            AboutWindow(
                ...
                actions: {
                    AboutButton(title: String(localized: "about.contributors", defaultValue: "Contributors", comment: "Button title for contributors section"), destination: {
                        ContributorsView()
                    })
                    AboutButton(title: String(localized: "about.acknowledgements", defaultValue: "Acknowledgements", comment: "Button title for acknowledgements section"), destination: {
