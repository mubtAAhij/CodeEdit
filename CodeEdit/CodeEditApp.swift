    ...
    var body: some Scene {
        Group {
            ...
            AboutWindow(
                ...
                actions: {
                    AboutButton(title: String(localized: "contributors", comment: "Title for contributors section in about window"), destination: {
                        ContributorsView()
                    })
                    AboutButton(title: String(localized: "acknowledgements", comment: "Title for acknowledgements section in about window"), destination: {
