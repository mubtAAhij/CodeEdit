    ...
    var body: some Scene {
        Group {
            ...
            AboutWindow(
                ...
                actions: {
                    AboutButton(title: String(localized: "contributors", comment: "Contributors section title"), destination: {
                        ContributorsView()
                    })
                    AboutButton(title: String(localized: "acknowledgements", comment: "Acknowledgements section title"), destination: {
