    ...
    var body: some Scene {
        Group {
            ...
            AboutWindow(
                ...
                actions: {
                    AboutButton(title: String(localized: "Contributors", comment: "Button text"), destination: {
                        ContributorsView()
                    })
                    AboutButton(title: String(localized: "Acknowledgements", comment: "Button text"), destination: {
