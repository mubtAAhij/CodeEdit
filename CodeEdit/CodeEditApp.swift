    ...
    var body: some Scene {
        Group {
            ...
            AboutWindow(
                ...
                actions: {
                    AboutButton(title: String(localized: "about.contributors", comment: "About button title"), destination: {
                        ContributorsView()
                    })
                    AboutButton(title: String(localized: "about.acknowledgements", comment: "About button title"), destination: {
