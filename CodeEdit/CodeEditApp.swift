    ...
    var body: some Scene {
        Group {
            ...
            AboutWindow(
                ...
                actions: {
                    AboutButton(title: String(localized: "contributors", comment: "Title for contributors button in about window"), destination: {
                        ContributorsView()
                    })
                    AboutButton(title: String(localized: "acknowledgements", comment: "Title for acknowledgements button in about window"), destination: {
