    ...
    var body: some Scene {
        Group {
            ...
            AboutWindow(
                ...
                actions: {
                    AboutButton(title: String(localized: "Contributors", comment: "Button to view contributors"), destination: {
                        ContributorsView()
                    })
                    AboutButton(title: String(localized: "Acknowledgements", comment: "Button to view acknowledgements"), destination: {
