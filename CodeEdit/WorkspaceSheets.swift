        ...
        EmptyView()
            ...
            .alert(isPresented: $sourceControlManager.discardAllAlertIsPresented) {
                Alert(
                    ...
                    message: Text(String(localized: "workspace.discard-all-changes-message", defaultValue: "This action cannot be undone.", comment: "Discard all changes alert message")),
                    primaryButton: .destructive(Text(String(localized: "workspace.discard", defaultValue: "Discard", comment: "Discard button"))) {
