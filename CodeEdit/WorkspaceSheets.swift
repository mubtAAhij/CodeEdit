    ...
    var body: some View {
        EmptyView()
            ...
            .alert(isPresented: $sourceControlManager.discardAllAlertIsPresented) {
                Alert(
                    title: Text(String(localized: "workspace.source-control.discard-all-alert-title", defaultValue: "Do you want to discard all uncommitted, local changes?", comment: "Alert title asking for confirmation to discard all uncommitted changes")),
                    message: Text(String(localized: "workspace.source-control.discard-all-alert-message", defaultValue: "This action cannot be undone.", comment: "Alert message warning that discard action cannot be undone")),
                    primaryButton: .destructive(Text(String(localized: "workspace.source-control.discard", defaultValue: "Discard", comment: "Destructive button to discard changes"))) {
            ...
            .alert(String(localized: "workspace.source-control.cannot-stage-changes", defaultValue: "Cannot Stage Changes", comment: "Alert title when there are no changes to stage"), isPresented: $sourceControlManager.noChangesToStageAlertIsPresented) {
                Button(String(localized: "workspace.source-control.ok", defaultValue: "OK", comment: "OK button in alert dialog"), role: .cancel) {}
            } message: {
