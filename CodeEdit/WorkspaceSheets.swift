    ...
    var body: some View {
        EmptyView()
            ...
            .alert(isPresented: $sourceControlManager.discardAllAlertIsPresented) {
                Alert(
                    title: Text(String(
                        localized: "workspace-sheets.discard-changes.confirmation.title",
                    ...
                    message: Text(String(
                        localized: "workspace-sheets.discard-changes.confirmation.message",
                        defaultValue: "This action cannot be undone.",
                        comment: "Confirmation message warning that discard action is irreversible."
                    )),
                    primaryButton: .destructive(Text(String(
                        localized: "workspace-sheets.discard-changes.confirmation.discard-button",
                        defaultValue: "Discard",
                        comment: "Destructive button title for confirming discard action."
                    ))) {
            ...
            .alert(String(
                ...
                comment: "Error title shown when staging changes fails."
            ), isPresented: $sourceControlManager.noChangesToStageAlertIsPresented) {
                Button(String(
                    localized: "workspace-sheets.alert.ok-button",
                    defaultValue: "OK",
                    comment: "Default confirmation button for workspace alert dialogs."
                ), role: .cancel) {}
            } message: {
                Text(String(
                    ...
                    comment: "Message shown when no uncommitted changes are available for requested source control action."
                ))
            }
            .alert(String(
                localized: "workspace-sheets.unstage-changes.error.title",
                defaultValue: "Cannot Unstage Changes",
                comment: "Error title shown when unstaging changes fails."
            ...
            .alert(String(
                ...
                comment: "Error title shown when stashing changes fails."
            ...
            .alert(String(
                ...
                comment: "Error title shown when discarding changes fails."
