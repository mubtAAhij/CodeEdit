...
final class AppDelegate: NSObject, NSApplicationDelegate, ObservableObject {
    ...
    private func terminateLanguageServers() {
        Task { @MainActor in
            let task = TaskNotificationModel(
                ...
                title: String(localized: "app-delegate.terminate-lsp.title", defaultValue: "Stopping Language Servers", comment: "Task notification title when stopping language servers"),
                message: String(localized: "app-delegate.terminate-lsp.message", defaultValue: "Stopping running language server processes...", comment: "Task notification message when stopping language servers"),
                isLoading: true
            )
    ...
    private func terminateTasks() {
        let task = TaskNotificationModel(
            ...
            title: String(localized: "app-delegate.terminate-tasks.title", defaultValue: "Terminating Tasks", comment: "Task notification title when terminating tasks"),
            message: String(localized: "app-delegate.terminate-tasks.message", defaultValue: "Interrupting all running tasks before quitting...", comment: "Task notification message when terminating tasks"),
            isLoading: true
        )
