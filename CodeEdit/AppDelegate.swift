...
final class AppDelegate: NSObject, NSApplicationDelegate, ObservableObject {
    ...
    private func terminateLanguageServers() {
        Task { @MainActor in
            let task = TaskNotificationModel(
                ...
                title: String(localized: "stopping_language_servers", comment: "Title for stopping language servers task"),
                message: String(localized: "stopping_language_server_processes", comment: "Message for stopping language server processes"),
                isLoading: true
            )
    ...
    private func terminateTasks() {
        let task = TaskNotificationModel(
            ...
            title: String(localized: "terminating_tasks", comment: "Title for terminating tasks"),
            message: String(localized: "interrupting_running_tasks", comment: "Message for interrupting running tasks before quitting"),
            isLoading: true
        )
