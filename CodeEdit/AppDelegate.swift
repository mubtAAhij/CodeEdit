...
final class AppDelegate: NSObject, NSApplicationDelegate, ObservableObject {
    ...
    private func terminateLanguageServers() {
        Task { @MainActor in
            let task = TaskNotificationModel(
                ...
                title: String(localized: "app.stopping-lsp", defaultValue: "Stopping Language Servers", comment: "Stopping language servers title"),
                message: String(localized: "app.stopping-lsp-message", defaultValue: "Stopping running language server processes...", comment: "Stopping language servers message"),
                isLoading: true
            )
    ...
    private func terminateTasks() {
        let task = TaskNotificationModel(
            ...
            title: String(localized: "app.terminating-tasks", defaultValue: "Terminating Tasks", comment: "Terminating tasks title"),
            message: String(localized: "app.terminating-tasks-message", defaultValue: "Interrupting all running tasks before quitting...", comment: "Terminating tasks message"),
            isLoading: true
        )
