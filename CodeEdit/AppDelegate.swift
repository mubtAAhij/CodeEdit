...
final class AppDelegate: NSObject, NSApplicationDelegate, ObservableObject {
    ...
    private func terminateLanguageServers() {
        Task { @MainActor in
            let task = TaskNotificationModel(
                ...
                title: String(localized: "app.terminate_lsp_title", comment: "Stopping Language Servers"),
                message: String(localized: "app.terminate_lsp_message", comment: "Stopping running language server processes..."),
                isLoading: true
            )
    ...
    private func terminateTasks() {
        let task = TaskNotificationModel(
            ...
            title: String(localized: "app.terminate_tasks_title", comment: "Terminating Tasks"),
            message: String(localized: "app.terminate_tasks_message", comment: "Interrupting all running tasks before quitting..."),
            isLoading: true
        )
