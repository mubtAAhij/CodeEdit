...
final class AppDelegate: NSObject, NSApplicationDelegate, ObservableObject {
    ...
    private func terminateLanguageServers() {
        Task { @MainActor in
            let task = TaskNotificationModel(
                ...
                title: String(
                    localized: "app-delegate.quit.stopping-language-servers",
                    defaultValue: "Stopping Language Servers",
                    comment: "Progress title shown while language servers are being stopped during app quit"
                ),
                message: String(
                    localized: "app-delegate.quit.stopping-language-server-processes",
                    defaultValue: "Stopping running language server processes...",
                    comment: "Progress detail shown while stopping running language server processes during app quit"
                ),
                isLoading: true
            )
    ...
    private func terminateTasks() {
        let task = TaskNotificationModel(
            ...
            title: String(
                localized: "app-delegate.quit.terminating-tasks",
                defaultValue: "Terminating Tasks",
                comment: "Progress title shown while terminating running tasks during app quit"
            ),
            message: String(
                localized: "app-delegate.quit.interrupting-running-tasks",
                defaultValue: "Interrupting all running tasks before quitting...",
                comment: "Progress detail shown while interrupting running tasks before quitting"
            ),
            isLoading: true
        )
