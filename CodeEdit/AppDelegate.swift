...
final class AppDelegate: NSObject, NSApplicationDelegate, ObservableObject {
    ...
    private func terminateLanguageServers() {
        Task { @MainActor in
            let task = TaskNotificationModel(
                ...
                title: String(localized: "app.quit.stopping-lsp", defaultValue: "Stopping Language Servers", comment: "Status message while stopping language servers on quit"),
                message: String(localized: "app.quit.stopping-lsp-description", defaultValue: "Stopping running language server processes...", comment: "Description of stopping language servers during quit"),
                isLoading: true
            )
    ...
    private func terminateTasks() {
        let task = TaskNotificationModel(
            ...
            title: String(localized: "app.quit.terminating-tasks", defaultValue: "Terminating Tasks", comment: "Status message while terminating tasks on quit"),
            message: String(localized: "app.quit.terminating-tasks-description", defaultValue: "Interrupting all running tasks before quitting...", comment: "Description of interrupting tasks during quit"),
            isLoading: true
        )
