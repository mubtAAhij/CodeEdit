    ...
    private func terminateLanguageServers() {
        Task { @MainActor in
            let task = TaskNotificationModel(
                ...
                title: String(localized: "app.stopping-language-servers", defaultValue: "Stopping Language Servers", comment: "Title for stopping language servers task"),
                message: String(localized: "app.stopping-language-servers-message", defaultValue: "Stopping running language server processes...", comment: "Message for stopping language servers task"),
                isLoading: true
            )
