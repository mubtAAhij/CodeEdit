...
final class AppDelegate: NSObject, NSApplicationDelegate, ObservableObject {
    ...
    private func terminateLanguageServers() {
        Task { @MainActor in
            let task = TaskNotificationModel(
                ...
                title: String(localized: "app.stopping-language-servers", defaultValue: "Stopping Language Servers", comment: "Stopping language servers notification title"),
                message: String(localized: "app.stopping-language-servers.message", defaultValue: "Stopping running language server processes...", comment: "Stopping language servers notification message"),
                isLoading: true
            )
    ...
    private func terminateTasks() {
        let task = TaskNotificationModel(
            ...
            title: String(localized: "app.terminating-tasks", defaultValue: "Terminating Tasks", comment: "Terminating tasks notification title"),
            message: String(localized: "app.terminating-tasks.message", defaultValue: "Interrupting all running tasks before quitting...", comment: "Terminating tasks notification message"),
            isLoading: true
        )
