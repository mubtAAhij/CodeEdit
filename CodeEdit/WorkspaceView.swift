...
struct WorkspaceView: View {
    ...
    var body: some View {
        if workspace.workspaceFileManager != nil, let sourceControlManager = workspace.sourceControlManager {
                    ...
                    .task {
                        do {
                            ...
                            await sourceControlManager.showAlertForError(
                                title: String(localized: "workspace.source-control.error.refresh-git", defaultValue: "Error refreshing Git data", comment: "Error title when git data refresh fails"),
                                error: error
                            )
                        }
                    }
            ...
            .accessibilityLabel(String(localized: "workspace.accessibility.label", defaultValue: "workspace area", comment: "Accessibility label for workspace area"))
        }
    }
