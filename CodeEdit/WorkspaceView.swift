...
struct WorkspaceView: View {
    ...
    var body: some View {
        if workspace.workspaceFileManager != nil, let sourceControlManager = workspace.sourceControlManager {
                    ...
                    .task {
                        do {
                            ...
                            await sourceControlManager.showAlertForError(
                                title: String(localized: "Error refreshing Git data", comment: "Error alert title for Git refresh failures"),
                                error: error
                            )
                        }
                    }
            ...
            .accessibilityLabel(Text("workspace area", comment: "Accessibility label for workspace area"))
        }
    }
