    ...
    var body: some View {
        if workspace.workspaceFileManager != nil, let sourceControlManager = workspace.sourceControlManager {
                    ...
                    .task {
                        ...
                        do {
                            ...
                            await sourceControlManager.showAlertForError(
                                title: String(
                                    localized: "workspace.git.error-refreshing-data",
                                    defaultValue: "Error refreshing Git data",
                                    comment: "Error message shown when refreshing git data fails"
                                ),
                                error: error
                            )
                        }
            ...
            .accessibilityLabel(String(
                localized: "workspace.area.accessibility-label",
                defaultValue: "workspace area",
                comment: "Accessibility label for workspace area"
            ))
        }
    }
