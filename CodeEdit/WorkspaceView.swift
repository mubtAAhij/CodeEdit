...
struct WorkspaceView: View {
    ...
    var body: some View {
        if workspace.workspaceFileManager != nil, let sourceControlManager = workspace.sourceControlManager {
                    ...
                    .task {
                        ...
                        do {
                            ...
                            await sourceControlManager.showAlertForError(
                                title: String(localized: "source-control.refresh-error", defaultValue: "Error refreshing Git data", comment: "Error message for Git refresh failure"),
                                error: error
                            )
                        }
                    }
            ...
            .accessibilityLabel(String(localized: "workspace.area", defaultValue: "workspace area", comment: "Accessibility label for workspace area"))
        }
    }
