...
struct WorkspaceView: View {
    ...
    var body: some View {
        if workspace.workspaceFileManager != nil, let sourceControlManager = workspace.sourceControlManager {
                    ...
                    .task {
                        do {
                            ...
                            await sourceControlManager.showAlertForError(
                                title: String(localized: "error_refreshing_git_data", comment: "Error message for Git data refresh failure"),
                                error: error
                            )
                        }
                    }
            ...
            .accessibilityLabel(String(localized: "workspace_area", comment: "Accessibility label for workspace area"))
        }
    }
