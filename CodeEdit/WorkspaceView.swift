...
struct WorkspaceView: View {
    ...
    var body: some View {
        if workspace.workspaceFileManager != nil, let sourceControlManager = workspace.sourceControlManager {
                    ...
                    .task {
                        ...
                        do {
                            ...
                            await sourceControlManager.showAlertForError(
                                title: String(localized: "workspace.git.refresh-error", defaultValue: "Error refreshing Git data", comment: "Error title when git data refresh fails"),
                                error: error
                            )
                        }
                    }
            ...
            .accessibilityLabel(String(localized: "workspace.area.identifier", defaultValue: "workspace area", comment: "Accessibility identifier label for workspace area"))
        }
    }
