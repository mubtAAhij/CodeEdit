                    ...
                    .task {
                        ...
                        do {
                            ...
                            await sourceControlManager.showAlertForError(
                                title: String(localized: "workspace.error.refreshing-git-data", defaultValue: "Error refreshing Git data", comment: "Error message shown when refreshing Git data fails"),
                                error: error
                            )
                        }
                    }
