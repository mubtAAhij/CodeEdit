...
struct WorkspaceView: View {
    ...
    var body: some View {
        if workspace.workspaceFileManager != nil, let sourceControlManager = workspace.sourceControlManager {
                    ...
                    .task {
                        ...
                        do {
                            ...
                            await sourceControlManager.showAlertForError(
                                title: String(localized: "workspace.git-refresh-error", defaultValue: "Error refreshing Git data", comment: "Error alert title when Git data refresh fails"),
                                error: error
                            )
                        }
                    }
            ...
            .accessibilityLabel(String(localized: "workspace.area", defaultValue: "workspace area", comment: "Workspace area accessibility label"))
        }
    }
