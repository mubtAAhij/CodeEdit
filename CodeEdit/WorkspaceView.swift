                    ...
                    .task {
                        ...
                        do {
                            ...
                            await sourceControlManager.showAlertForError(
                                title: String(localized: "source-control.error.refresh-git-data", defaultValue: "Error refreshing Git data", comment: "Error title when refreshing Git data fails"),
                                error: error
                            )
                        }
                    }
