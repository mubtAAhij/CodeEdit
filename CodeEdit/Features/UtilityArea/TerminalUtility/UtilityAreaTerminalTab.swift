        ...
        Label {
            if #available(macOS 14, *) {
                ...
                TextField(String(
                    ...
                    defaultValue: "Name",
                    comment: "Placeholder for terminal tab name input"
                ), text: terminalTitle)
                    .focused($isFocused)
                    .padding(.leading, -8)
            }
        ...
        .contextMenu {
            ...
            if selectedIDs.contains(terminal.id) && selectedIDs.count > 1 {
                Button(String(
                    ...
                    comment: "Menu action title to kill multiple terminal sessions"
                )) {
                ...
                Button(String(
                    ...
                    comment: "Menu action title to kill a single terminal session"
                )) {
