    ...
    var body: some View {
        ...
        Label {
            if #available(macOS 14, *) {
                ...
                TextField(String(
                    localized: "utility-area.terminal-tab.name-title",
                    defaultValue: "Name",
                    comment: "Terminal tab detail label for terminal name"
                ), text: terminalTitle)
                    .focused($isFocused)
            } else {
                ...
                TextField(String(
                    ...
                    defaultValue: "Name",
                    comment: "Terminal rename text field placeholder"
                ), text: terminalTitle)
                    .focused($isFocused)
                    .padding(.leading, -8)
            }
        ...
        .contextMenu {
            Button(String(
                ...
                defaultValue: "Rename...",
                comment: "Context menu action to rename terminal"
            )) {
                isFocused = true
            }
            ...
            if selectedIDs.contains(terminal.id) && selectedIDs.count > 1 {
                Button(String(
                    ...
                    comment: "Context menu action to terminate all terminals"
                )) {
                ...
                Button(String(
                    ...
                    comment: "Context menu action to terminate current terminal"
                )) {
