    ...
    var body: some View {
        ...
        .contextMenu {
            ...
            if selectedIDs.contains(terminal.id) && selectedIDs.count > 1 {
                Button(String(localized: "terminal.kill-terminals", defaultValue: "Kill Terminals", comment: "Kill terminals menu item")) {
                    removeTerminals(selectedIDs)
                }
            } else {
                Button(String(localized: "terminal.kill-terminal", defaultValue: "Kill Terminal", comment: "Kill terminal menu item")) {
