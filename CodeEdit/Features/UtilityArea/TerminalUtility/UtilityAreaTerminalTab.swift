    ...
    var body: some View {
        ...
        .contextMenu {
            ...
            if selectedIDs.contains(terminal.id) && selectedIDs.count > 1 {
                Button(String(localized: "terminal.kill-multiple", defaultValue: "Kill Terminals", comment: "Kill multiple terminals menu item")) {
                    removeTerminals(selectedIDs)
                }
            } else {
                Button(String(localized: "terminal.kill-single", defaultValue: "Kill Terminal", comment: "Kill single terminal menu item")) {
