        ...
        UtilityAreaTabView(model: utilityAreaViewModel.tabViewModel) { tabState in
            ZStack {
                ...
                if let selectedTerminal = getSelectedTerminal() {
                    ...
                    CEContentUnavailableView(String(localized: "utility-area.terminal.no-selection", defaultValue: "No Selection", comment: "Message shown when no terminal is selected"))
                }
            }
            ...
            .paneToolbar {
                ...
                PaneToolbarSection {
                    ...
                    .help(String(localized: "utility-area.terminal.reset-button", defaultValue: "Reset the terminal", comment: "Tooltip for button to reset terminal"))
                    ...
                    .help(String(localized: "utility-area.terminal.split-button", defaultValue: "Implementation Needed", comment: "Tooltip for split terminal button (not yet implemented)"))
                    .disabled(true)
                }
            }
            .background {
