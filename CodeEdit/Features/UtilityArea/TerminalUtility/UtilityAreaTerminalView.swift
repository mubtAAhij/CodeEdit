        ...
        UtilityAreaTabView(model: utilityAreaViewModel.tabViewModel) { tabState in
            ...
            .paneToolbar {
                ...
                PaneToolbarSection {
                    ...
                    .help(String(localized: "utility_area.terminal.reset", comment: "Reset terminal tooltip"))
                    ...
                    .help(String(localized: "utility_area.terminal.implementation_needed", comment: "Placeholder for unimplemented feature"))
                    .disabled(true)
                }
            }
            .background {
