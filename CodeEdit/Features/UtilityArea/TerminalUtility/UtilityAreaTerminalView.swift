        ...
        UtilityAreaTabView(model: utilityAreaViewModel.tabViewModel) { tabState in
            ZStack {
                ...
                if let selectedTerminal = getSelectedTerminal() {
                    ...
                    CEContentUnavailableView(String(localized: "terminal.no-selection", defaultValue: "No Selection", comment: "Message displayed when no terminal is selected"))
                }
            }
            ...
            .paneToolbar {
                ...
                PaneToolbarSection {
                    ...
                    .help(String(localized: "terminal.reset", defaultValue: "Reset the terminal", comment: "Help text for reset terminal button"))
                    ...
                    .help(String(localized: "terminal.implementation-needed", defaultValue: "Implementation Needed", comment: "Help text for unimplemented split terminal feature"))
                    .disabled(true)
                }
            }
            .background {
