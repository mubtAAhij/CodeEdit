        ...
        UtilityAreaTabView(model: utilityAreaViewModel.tabViewModel) { tabState in
            ...
            .paneToolbar {
                ...
                PaneToolbarSection {
                    ...
                    .help(String(localized: "utility-area.terminal.reset-help", defaultValue: "Reset the terminal", comment: "Reset terminal help text"))
                    ...
                    .help(String(localized: "utility-area.terminal.split-help", defaultValue: "Implementation Needed", comment: "Split terminal help text (placeholder)"))
                    .disabled(true)
                }
            }
            .background {
