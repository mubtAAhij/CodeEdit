        ...
        UtilityAreaTabView(model: utilityAreaViewModel.tabViewModel) { tabState in
            ZStack {
                ...
                if let selectedTerminal = getSelectedTerminal() {
                    ...
                    CEContentUnavailableView("String(localized: "no_selection", comment: "Message displayed when no terminal is selected")")
                }
            }
            ...
            .paneToolbar {
                ...
                PaneToolbarSection {
                    ...
                    .help("String(localized: "reset_the_terminal", comment: "Button text to reset the terminal session")")
                    ...
                    .help("String(localized: "implementation_needed", comment: "Placeholder text indicating feature implementation is required")")
                    .disabled(true)
                }
            }
            .background {
