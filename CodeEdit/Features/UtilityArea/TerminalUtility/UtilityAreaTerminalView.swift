        ...
        UtilityAreaTabView(model: utilityAreaViewModel.tabViewModel) { tabState in
            ZStack {
                ...
                if let selectedTerminal = getSelectedTerminal() {
                    ...
                    CEContentUnavailableView(String(localized: "terminal.no-selection", defaultValue: "No Selection", comment: "No terminal selected message"))
                }
            }
            ...
            .paneToolbar {
                ...
                PaneToolbarSection {
                    ...
                    .help(String(localized: "terminal.reset-button.help", defaultValue: "Reset the terminal", comment: "Reset terminal button help text"))
                    ...
                    .help(String(localized: "terminal.split-button.help", defaultValue: "Implementation Needed", comment: "Split terminal button help text"))
                    .disabled(true)
                }
            }
            .background {
