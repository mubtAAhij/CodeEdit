        ...
        UtilityAreaTabView(model: utilityAreaViewModel.tabViewModel) { tabState in
            ...
            .paneToolbar {
                ...
                PaneToolbarSection {
                    ...
                    .help(String(localized: "reset_terminal", comment: "Button text to reset the terminal"))
                    ...
                    .help(String(localized: "implementation_needed", comment: "Placeholder text for unimplemented features"))
                    .disabled(true)
                }
            }
            .background {
