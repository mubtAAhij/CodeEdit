        ...
        UtilityAreaTabView(model: utilityAreaViewModel.tabViewModel) { tabState in
            ZStack {
                ...
                if let selectedTerminal = getSelectedTerminal() {
                    ...
                    CEContentUnavailableView(String(localized: "no-selection", defaultValue: "No Selection", comment: "Empty state when no terminal is selected"))
                }
            }
            ...
            .paneToolbar {
                ...
                PaneToolbarSection {
                    ...
                    .help(String(localized: "implementation-needed", defaultValue: "Implementation Needed", comment: "Tooltip for unimplemented feature"))
                    .disabled(true)
                }
            }
            .background {
