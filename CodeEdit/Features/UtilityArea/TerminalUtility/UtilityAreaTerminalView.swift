        ...
        UtilityAreaTabView(model: utilityAreaViewModel.tabViewModel) { tabState in
            ...
            .paneToolbar {
                ...
                PaneToolbarSection {
                    ...
                    .help(String(localized: "utility-area.terminal.reset", defaultValue: "Reset the terminal", comment: "Help text for reset terminal button"))
                    ...
                    .help(String(localized: "utility-area.terminal.implementation-needed", defaultValue: "Implementation Needed", comment: "Help text for unimplemented split terminal button"))
                    .disabled(true)
                }
            }
            .background {
