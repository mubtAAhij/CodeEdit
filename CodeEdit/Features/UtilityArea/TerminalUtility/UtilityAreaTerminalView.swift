        ...
        UtilityAreaTabView(model: utilityAreaViewModel.tabViewModel) { tabState in
            ZStack {
                ...
                if let selectedTerminal = getSelectedTerminal() {
                    ...
                    CEContentUnavailableView(String(localized: "utility.terminal.no-selection", defaultValue: "No Selection", comment: "Message when no terminal is selected"))
                }
            }
            ...
            .paneToolbar {
                ...
                PaneToolbarSection {
                    ...
                    .help(String(localized: "utility.terminal.reset-help", defaultValue: "Reset the terminal", comment: "Help text for reset terminal button"))
                    ...
                    .help(String(localized: "utility.terminal.split-help", defaultValue: "Implementation Needed", comment: "Help text for split terminal button (not yet implemented)"))
                    .disabled(true)
                }
            }
            .background {
