        ...
        UtilityAreaTabView(model: utilityAreaViewModel.tabViewModel) { tabState in
            ZStack {
                ...
                if let selectedTerminal = getSelectedTerminal() {
                    ...
                    CEContentUnavailableView(String(localized: "no-selection", defaultValue: "No Selection", comment: "Empty state when no selection is made"))
                }
            }
            ...
            .paneToolbar {
                ...
                PaneToolbarSection {
                    ...
                    .help(String(localized: "terminal.implementation-needed", defaultValue: "Implementation Needed", comment: "Implementation needed tooltip"))
                    .disabled(true)
                }
            }
            .background {
