        ...
        UtilityAreaTabView(model: utilityAreaViewModel.tabViewModel) { tabState in
            ZStack {
                ...
                if let selectedTerminal = getSelectedTerminal() {
                    ...
                    CEContentUnavailableView(String(localized: "No Selection", comment: "Message shown when no terminal is selected"))
                }
            }
            ...
            .paneToolbar {
                ...
                PaneToolbarSection {
                    ...
                    .help(String(localized: "Reset the terminal", comment: "Tooltip for terminal reset button"))
                    ...
                    .help(String(localized: "Implementation Needed", comment: "Tooltip for feature not yet implemented"))
                    .disabled(true)
                }
            }
            .background {
