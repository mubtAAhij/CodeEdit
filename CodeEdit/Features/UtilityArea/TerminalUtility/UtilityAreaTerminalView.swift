        ...
        UtilityAreaTabView(model: utilityAreaViewModel.tabViewModel) { tabState in
            ZStack {
                ...
                if let selectedTerminal = getSelectedTerminal() {
                    ...
                    CEContentUnavailableView(String(localized: "utility.terminal.no-selection", defaultValue: "No Selection", comment: "Message shown when no terminal is selected"))
                }
            }
            ...
            .paneToolbar {
                ...
                PaneToolbarSection {
                    ...
                    .help(String(localized: "utility.terminal.reset", defaultValue: "Reset the terminal", comment: "Help text for reset terminal button"))
                    ...
                    .help(String(localized: "utility.terminal.implementation-needed", defaultValue: "Implementation Needed", comment: "Help text for not yet implemented feature"))
                    .disabled(true)
                }
            }
            .background {
