        ...
        UtilityAreaTabView(model: utilityAreaViewModel.tabViewModel) { tabState in
            ZStack {
                ...
                if let selectedTerminal = getSelectedTerminal() {
                    ...
                    CEContentUnavailableView(String(localized: "terminal.no-selection", defaultValue: "No Selection", comment: "Empty state message when no terminal is selected"))
                }
            }
            ...
            .paneToolbar {
                ...
                PaneToolbarSection {
                    ...
                    .help(String(localized: "terminal.reset", defaultValue: "Reset the terminal", comment: "Tooltip for reset terminal button"))
                    ...
                    .help(String(localized: "terminal.split.not-implemented", defaultValue: "Implementation Needed", comment: "Tooltip for unimplemented split terminal feature"))
                    .disabled(true)
                }
            }
            .background {
