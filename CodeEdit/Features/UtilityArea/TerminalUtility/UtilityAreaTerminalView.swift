        ...
        UtilityAreaTabView(model: utilityAreaViewModel.tabViewModel) { tabState in
            ZStack {
                ...
                if let selectedTerminal = getSelectedTerminal() {
                    ...
                    CEContentUnavailableView(String(localized: "utility-area.terminal.no-selection", defaultValue: "No Selection", comment: "Empty state when no terminal is selected"))
                }
            }
            ...
            .paneToolbar {
                ...
                PaneToolbarSection {
                    ...
                    .help(String(localized: "utility-area.terminal.implementation-needed", defaultValue: "Implementation Needed", comment: "Placeholder for unimplemented split terminal feature"))
                    .disabled(true)
                }
            }
            .background {
