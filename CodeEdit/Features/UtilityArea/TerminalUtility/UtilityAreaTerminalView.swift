        ...
        UtilityAreaTabView(model: utilityAreaViewModel.tabViewModel) { tabState in
            ...
            .paneToolbar {
                ...
                PaneToolbarSection {
                    ...
                    .help(String(localized: "utility-area.terminal.split-not-implemented", defaultValue: "Implementation Needed", comment: "Tooltip for unimplemented split terminal button"))
                    .disabled(true)
                }
            }
            .background {
