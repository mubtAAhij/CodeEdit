        ...
        UtilityAreaTabView(model: utilityAreaViewModel.tabViewModel) { tabState in
            ...
            .paneToolbar {
                ...
                PaneToolbarSection {
                    ...
                    .help(String(localized: "utility-area.terminal.reset-help", defaultValue: "Reset the terminal", comment: "Help text for reset terminal button"))
                    ...
                    .help(String(localized: "utility-area.terminal.split-help", defaultValue: "Implementation Needed", comment: "Help text for split terminal button (not yet implemented)"))
                    .disabled(true)
                }
            }
            .background {
