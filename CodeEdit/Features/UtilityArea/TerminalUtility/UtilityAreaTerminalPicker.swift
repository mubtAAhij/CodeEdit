...
struct UtilityAreaTerminalPicker: View {
    ...
    var body: some View {
        Picker(String(localized: "terminal_tab", comment: "Label for terminal tab picker"), selection: selectedID) {
            ...
            if terminals.isEmpty {
                Text(String(localized: "no_open_terminals", comment: "Message displayed when there are no terminal tabs open"))
            }
        }
        .labelsHidden()
        .controlSize(.small)
