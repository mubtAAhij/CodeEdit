...
struct UtilityAreaTerminalPicker: View {
    ...
    var body: some View {
        Picker(String(localized: "utility-area.terminal.picker.label", defaultValue: "Terminal Tab", comment: "Picker label for terminal tab selection"), selection: selectedID) {
