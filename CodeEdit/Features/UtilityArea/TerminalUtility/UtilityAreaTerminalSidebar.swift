    ...
    var body: some View {
        ...
        .contextMenu {
            ...
            Menu(String(localized: "terminal.new-terminal-with-profile", defaultValue: "New Terminal With Profile", comment: "New terminal with profile menu")) {
                Button(String(localized: "default", defaultValue: "Default", comment: "Default profile option")) {
                    utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
                }
                Divider()
        ...
        .accessibilityLabel(String(localized: "terminals", defaultValue: "Terminals", comment: "Accessibility label for terminals list"))
