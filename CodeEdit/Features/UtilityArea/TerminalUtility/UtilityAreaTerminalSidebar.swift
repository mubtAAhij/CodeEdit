...
struct UtilityAreaTerminalSidebar: View {
    ...
    var body: some View {
        ...
        .contextMenu {
            Button(String(localized: "terminal.sidebar.new-terminal", defaultValue: "New Terminal", comment: "Button to create a new terminal")) {
                utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
            }
            Menu(String(localized: "terminal.sidebar.new-terminal-with-profile", defaultValue: "New Terminal With Profile", comment: "Menu to create terminal with specific profile")) {
                Button(String(localized: "terminal.sidebar.profile-default", defaultValue: "Default", comment: "Default terminal profile option")) {
                    utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
                }
                Divider()
        ...
        .accessibilityLabel(String(localized: "terminal.sidebar.accessibility-label", defaultValue: "Terminals", comment: "Accessibility label for terminals list"))
