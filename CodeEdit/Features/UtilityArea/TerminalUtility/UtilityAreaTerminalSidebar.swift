...
struct UtilityAreaTerminalSidebar: View {
    ...
    var body: some View {
        ...
        .contextMenu {
            ...
            Menu(String(localized: "utility-area.terminal.new-with-profile", defaultValue: "New Terminal With Profile", comment: "Context menu item to create new terminal with profile")) {
        ...
        .accessibilityLabel(String(localized: "utility-area.terminal.sidebar.accessibility.label", defaultValue: "Terminals", comment: "Accessibility label for terminals sidebar"))
