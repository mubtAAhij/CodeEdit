...
struct UtilityAreaTerminalSidebar: View {
    ...
    var body: some View {
        ...
        .contextMenu {
            ...
            Menu(String(localized: "new_terminal_with_profile", comment: "Button text to create a new terminal with a specific profile")) {
                Button("Default") {
                    utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
                }
                Divider()
        ...
        .accessibilityLabel(String(localized: "terminals", comment: "Section header for terminal list"))
