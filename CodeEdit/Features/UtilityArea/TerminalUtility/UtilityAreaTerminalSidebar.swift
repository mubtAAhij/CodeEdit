    ...
    var body: some View {
        ...
        .contextMenu {
            ...
            Menu(String(localized: "new_terminal_with_profile", comment: "Menu item to create a new terminal with a specific profile")) {
                Button(String(localized: "default", comment: "Label for default terminal profile")) {
                    utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
                }
                Divider()
        ...
        .accessibilityLabel(String(localized: "terminals", comment: "Section header for terminals list"))
