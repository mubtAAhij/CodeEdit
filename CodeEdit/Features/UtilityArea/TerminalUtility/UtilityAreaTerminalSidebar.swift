...
struct UtilityAreaTerminalSidebar: View {
    ...
    var body: some View {
        ...
        .contextMenu {
            Button(String(localized: "terminal.new", defaultValue: "New Terminal", comment: "Context menu item to create new terminal")) {
                utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
            }
            Menu(String(localized: "terminal.new-with-profile", defaultValue: "New Terminal With Profile", comment: "Context menu to create new terminal with specific profile")) {
        ...
        .accessibilityLabel(String(localized: "terminal.list.label", defaultValue: "Terminals", comment: "Accessibility label for terminals list"))
