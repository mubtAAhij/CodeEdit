    ...
    var body: some View {
        ...
        .contextMenu {
            ...
            Menu(String(localized: "terminal.new-with-profile", defaultValue: "New Terminal With Profile", comment: "New terminal with profile menu")) {
                Button(String(localized: "terminal.profile.default", defaultValue: "Default", comment: "Default profile")) {
                    utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
                }
                Divider()
        ...
        .accessibilityLabel(String(localized: "terminal.list", defaultValue: "Terminals", comment: "Terminals list accessibility label"))
