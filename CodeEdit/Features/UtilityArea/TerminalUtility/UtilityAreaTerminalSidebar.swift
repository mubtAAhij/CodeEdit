    ...
    var body: some View {
        ...
        .contextMenu {
            Button(String(
                ...
                comment: "Menu action to create a new terminal session"
            )) {
            ...
            Menu(String(
                ...
                comment: "Menu action to create a terminal with a selected profile"
            )) {
                Button(String(
                    localized: "utility-area.terminal-sidebar.default-profile",
                    defaultValue: "Default",
                    comment: "Default terminal profile label"
                )) {
                    utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
                }
                Divider()
        ...
        .accessibilityLabel(String(
            ...
            comment: "Sidebar section title for terminal sessions"
        ))
