...
struct UtilityAreaTerminalSidebar: View {
    ...
    var body: some View {
        ...
        .contextMenu {
            Button(String(localized: "utility-area.terminal.new-terminal", defaultValue: "New Terminal", comment: "New terminal context menu item")) {
                utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
            }
            Menu(String(localized: "utility-area.terminal.new-terminal-profile", defaultValue: "New Terminal With Profile", comment: "New terminal with profile submenu")) {
