...
struct UtilityAreaTerminalSidebar: View {
    ...
    var body: some View {
        ...
        .contextMenu {
            Button(String(localized: "utility-area.terminal.new-terminal", defaultValue: "New Terminal", comment: "Menu item to create a new terminal")) {
                utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
            }
            Menu(String(localized: "utility-area.terminal.new-terminal-with-profile", defaultValue: "New Terminal With Profile", comment: "Menu item to create a new terminal with a specific profile")) {
                Button(String(localized: "utility-area.terminal.default-profile", defaultValue: "Default", comment: "Default terminal profile option")) {
                    utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
                }
                Divider()
        ...
        .accessibilityLabel(String(localized: "utility-area.terminal.terminals-label", defaultValue: "Terminals", comment: "Accessibility label for terminals list"))
