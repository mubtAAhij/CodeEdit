...
struct UtilityAreaTerminalSidebar: View {
    ...
    var body: some View {
        ...
        .contextMenu {
            Button(String(localized: "utility-area.terminal.new", defaultValue: "New Terminal", comment: "New terminal menu item")) {
                utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
            }
            Menu(String(localized: "utility-area.terminal.new-with-profile", defaultValue: "New Terminal With Profile", comment: "New terminal with profile menu item")) {
                Button(String(localized: "utility-area.terminal.default-profile", defaultValue: "Default", comment: "Default terminal profile")) {
                    utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
                }
                Divider()
        ...
        .accessibilityLabel(String(localized: "utility-area.terminal.title", defaultValue: "Terminals", comment: "Terminals sidebar title"))
