...
struct UtilityAreaTerminalSidebar: View {
    ...
    var body: some View {
        ...
        .contextMenu {
            Button(String(localized: "terminal.new-terminal", defaultValue: "New Terminal", comment: "Context menu item to create a new terminal")) {
                utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
            }
            Menu(String(localized: "terminal.new-terminal-with-profile", defaultValue: "New Terminal With Profile", comment: "Context menu submenu for creating terminal with specific shell")) {
                Button(String(localized: "terminal.profile.default", defaultValue: "Default", comment: "Default terminal profile option")) {
                    utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
                }
                Divider()
        ...
        .accessibilityLabel(String(localized: "accessibility.terminals", defaultValue: "Terminals", comment: "Accessibility label for terminals list"))
