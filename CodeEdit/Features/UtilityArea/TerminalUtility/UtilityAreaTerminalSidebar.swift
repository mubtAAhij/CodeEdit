...
struct UtilityAreaTerminalSidebar: View {
    ...
    var body: some View {
        ...
        .contextMenu {
            Button(String(localized: "utility-area.new-terminal", defaultValue: "New Terminal", comment: "New terminal button")) {
                utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
            }
            Menu(String(localized: "utility-area.new-terminal-with-profile", defaultValue: "New Terminal With Profile", comment: "New terminal with profile menu")) {
                Button(String(localized: "utility-area.default-profile", defaultValue: "Default", comment: "Default terminal profile")) {
                    utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
                }
                Divider()
        ...
        .accessibilityLabel(String(localized: "utility-area.terminals", defaultValue: "Terminals", comment: "Terminals accessibility label"))
