...
struct UtilityAreaTerminalSidebar: View {
    ...
    var body: some View {
        ...
        .contextMenu {
            Button(String(localized: "utility-area.terminal-sidebar.new-terminal", defaultValue: "New Terminal", comment: "Menu action to create a new terminal session")) {
                utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
            }
            Menu(String(localized: "utility-area.terminal-sidebar.new-terminal-with-profile", defaultValue: "New Terminal With Profile", comment: "Menu action to create a terminal with a selected profile")) {
                Button(String(localized: "utility-area.terminal-sidebar.default-profile", defaultValue: "Default", comment: "Default terminal profile label")) {
                    utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
                }
                Divider()
        ...
        .accessibilityLabel(String(localized: "utility-area.terminal-sidebar.terminals", defaultValue: "Terminals", comment: "Sidebar section title for terminal sessions"))
