...
struct UtilityAreaTerminalSidebar: View {
    ...
    var body: some View {
        ...
        .contextMenu {
            Button(String(localized: "terminal.new", defaultValue: "New Terminal", comment: "New terminal button")) {
        ...
        .accessibilityLabel(String(localized: "terminal.list.label", defaultValue: "Terminals", comment: "Terminals list accessibility label"))
