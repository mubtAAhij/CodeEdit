...
struct UtilityAreaTerminalSidebar: View {
    ...
    var body: some View {
        ...
        .contextMenu {
            Button(String(localized: "utility.terminal.new-terminal", defaultValue: "New Terminal", comment: "Menu item to create a new terminal")) {
                utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
            }
            Menu(String(localized: "utility.terminal.new-with-profile", defaultValue: "New Terminal With Profile", comment: "Menu for creating terminal with specific shell profile")) {
                Button(String(localized: "utility.terminal.profile-default", defaultValue: "Default", comment: "Default terminal profile option")) {
                    utilityAreaViewModel.addTerminal(rootURL: workspace.fileURL)
                }
                Divider()
        ...
        .accessibilityLabel(String(localized: "utility.terminal.sidebar-label", defaultValue: "Terminals", comment: "Accessibility label for terminals sidebar"))
