...
struct UtilityAreaOutputSourcePicker: View {
    ...
    var body: some View {
        Picker(String(localized: "output_source", comment: "Output source picker label"), selection: $selectedSource) {
            ...
            if languageServerClients.isEmpty {
                Text(String(localized: "no_language_servers", comment: "Text shown when no language servers are available"))
            } else {
            ...
            if extensionManager.extensions.isEmpty {
                Text(String(localized: "no_extensions", comment: "Text shown when no extensions are available"))
            } else {
