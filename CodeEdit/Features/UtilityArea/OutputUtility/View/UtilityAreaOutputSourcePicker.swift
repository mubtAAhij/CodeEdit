    ...
    var body: some View {
        Picker(String(localized: "output.source_picker.title", comment: "Output source picker title"), selection: $selectedSource) {
            ...
            if languageServerClients.isEmpty {
                Text(String(localized: "output.source_picker.no_language_servers", comment: "Message when no language servers are available"))
            } else {
            ...
            if extensionManager.extensions.isEmpty {
                Text(String(localized: "output.source_picker.no_extensions", comment: "Message when no extensions are available"))
            } else {
