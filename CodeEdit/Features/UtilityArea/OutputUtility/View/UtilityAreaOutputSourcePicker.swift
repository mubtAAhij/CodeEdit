...
struct UtilityAreaOutputSourcePicker: View {
    ...
    var body: some View {
        Picker(String(localized: "utility.output.source-picker-label", defaultValue: "Output Source", comment: "Label for output source picker"), selection: $selectedSource) {
            ...
            if languageServerClients.isEmpty {
                Text(String(localized: "utility.output.no-language-servers", defaultValue: "No Language Servers", comment: "Message when no language servers are available"))
            } else {
            ...
            if extensionManager.extensions.isEmpty {
                Text(String(localized: "utility.output.no-extensions", defaultValue: "No Extensions", comment: "Message when no extensions are available"))
            } else {
