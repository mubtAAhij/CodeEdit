...
struct UtilityAreaOutputLogList<Source: UtilityAreaOutputSource, Toolbar: View>: View {
    ...
    var body: some View {
        ...
        .paneToolbar {
            toolbar()
            Spacer()
            UtilityAreaFilterTextField(title: String(localized: "utility-area.output.filter", defaultValue: "Filter", comment: "Filter text field placeholder in utility area output log"), text: $filterText)
                .frame(maxWidth: 175)
            Button {
