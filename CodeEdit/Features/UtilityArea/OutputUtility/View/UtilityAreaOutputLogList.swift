...
struct UtilityAreaOutputLogList<Source: UtilityAreaOutputSource, Toolbar: View>: View {
    ...
    var body: some View {
        ...
        .paneToolbar {
            toolbar()
            Spacer()
            UtilityAreaFilterTextField(title: String(localized: "utility-area.filter.placeholder", defaultValue: "Filter", comment: "Placeholder text for utility area filter field"), text: $filterText)
                .frame(maxWidth: 175)
            Button {
