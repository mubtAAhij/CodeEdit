    ...
    enum Sources: Hashable {
        ...
        var title: String {
            ...
            case .extensions(let source):
                String(localized: "output.extension \(source.extensionInfo.name)")
            case .languageServer(let source):
                String(localized: "output.language_server \(source.id)")
            case .devOutput:
                String(localized: "output.internal_development")
            }
        }
