        ...
        var title: String {
            ...
            case .extensions(let source):
                String(format: String(
                    ...
                    comment: "Output source label for extension-provided output"
            ...
            case .languageServer(let source):
                String(format: String(
                    ...
                    comment: "Output source label for language server output"
                ), "\(source.id)")
            case .devOutput:
                String(
            ...
            Group {
                if let selectedSource {
                    ...
                    Text(String(
                        ...
                        comment: "Empty state title when selected output source has no output"
                    ))
                        .font(.system(size: 16))
                        ...
                        .paneToolbar {
                            ...
                            UtilityAreaFilterTextField(title: String(
                                ...
                                defaultValue: "Filter",
                                comment: "Filter field placeholder in output view"
                            ), text: $filterText)
                                .frame(maxWidth: 175)
                            Button { } label: {
