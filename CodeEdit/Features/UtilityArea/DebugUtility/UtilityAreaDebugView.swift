            ...
            ZStack {
                ...
                if let taskShowingOutput = taskManager.taskShowingOutput,
                   let activeTask = taskManager.activeTasks[taskShowingOutput] {
                    ...
                    CEContentUnavailableView(String(localized: "No Task Selected", comment: "Message text"))
                }
            }
        } leadingSidebar: { _ in
            ZStack {
                Text(String(localized: "No Tasks are Running", comment: "Message text"))
                    .font(.system(size: 16))
                                ...
                                .contextMenu(
                                    ContextMenu {
                                        Button {
                                            ...
                                            Text(String(localized: "Delete", comment: "Button text"))
                                        }
                                    }
                                )
                        }
