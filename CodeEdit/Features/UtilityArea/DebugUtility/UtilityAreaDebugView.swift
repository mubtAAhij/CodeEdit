            ...
            ZStack {
                ...
                if let taskShowingOutput = taskManager.taskShowingOutput,
                   let activeTask = taskManager.activeTasks[taskShowingOutput] {
                    ...
                    CEContentUnavailableView("debug.no_task_selected", comment: "No task selected")
                }
            }
        } leadingSidebar: { _ in
            ZStack {
                Text("debug.no_tasks_running", comment: "No tasks are running")
                    .font(.system(size: 16))
                                ...
                                .contextMenu(
                                    ContextMenu {
                                        Button {
                                            ...
                                            Text("actions.delete", comment: "Delete action")
                                        }
                                    }
                                )
                        }
