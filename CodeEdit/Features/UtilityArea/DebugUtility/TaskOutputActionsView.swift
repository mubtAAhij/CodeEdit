...
struct TaskOutputActionsView: View {
    ...
    var body: some View {
        HStack {
            ...
            .buttonStyle(.icon)
            .help(String(localized: "run_task", comment: "Button to run a task"))
            ...
            .help(String(localized: "stop_task", comment: "Button to stop a task"))
            ...
            .help(activeTask.status == .stopped ? String(localized: "resume_task", comment: "Button to resume a task") : String(localized: "suspend_task", comment: "Button to suspend a task"))
            ...
            .buttonStyle(.icon)
            .help(String(localized: "scroll_down_to_the_bottom", comment: "Accessibility hint for scroll button"))
            ...
            .buttonStyle(.icon)
            .help(String(localized: "clear_output", comment: "Button to clear output"))
        }
    }
}
