...
struct TaskOutputActionsView: View {
    ...
    var body: some View {
        HStack {
            ...
            .buttonStyle(.icon)
            .help(String(localized: "taskOutput.runTask", comment: "Tooltip text"))
            ...
            .help(String(localized: "taskOutput.stopTask", comment: "Tooltip text"))
            ...
            .help(activeTask.status == .stopped ? String(localized: "taskOutput.resumeTask", comment: "Tooltip text") : String(localized: "taskOutput.suspendTask", comment: "Tooltip text"))
            ...
            .buttonStyle(.icon)
            .help(String(localized: "taskOutput.scrollToBottom", comment: "Tooltip text"))
            ...
            .buttonStyle(.icon)
            .help(String(localized: "taskOutput.clearOutput", comment: "Tooltip text"))
        }
    }
}
