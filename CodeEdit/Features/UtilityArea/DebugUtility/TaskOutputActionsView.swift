...
struct TaskOutputActionsView: View {
    ...
    var body: some View {
        HStack {
            ...
            .buttonStyle(.icon)
            .help(String(localized: "run_task", comment: "Tooltip for button to run a task"))
            ...
            .help(String(localized: "stop_task", comment: "Tooltip for button to stop a task"))
            ...
            .help(activeTask.status == .stopped ? String(localized: "resume_task", comment: "Tooltip for button to resume a task") : String(localized: "suspend_task", comment: "Tooltip for button to suspend a task"))
            ...
            .buttonStyle(.icon)
            .help(String(localized: "scroll_to_bottom", comment: "Tooltip for button to scroll to bottom of output"))
            ...
            .buttonStyle(.icon)
            .help(String(localized: "clear_output", comment: "Tooltip for button to clear task output"))
        }
    }
}
