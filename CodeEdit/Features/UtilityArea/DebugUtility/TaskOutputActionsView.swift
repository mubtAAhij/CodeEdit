...
struct TaskOutputActionsView: View {
    ...
    var body: some View {
        HStack {
            ...
            .buttonStyle(.icon)
            .help("debug.run_task", comment: "Tooltip for run task button")
            ...
            .help("debug.stop_task", comment: "Tooltip for stop task button")
            ...
            .help(activeTask.status == .stopped ? "debug.resume_task" : "debug.suspend_task", comment: "Tooltip for pause/resume task button")
            ...
            .buttonStyle(.icon)
            .help("debug.scroll_to_bottom", comment: "Tooltip for scroll to bottom button")
            ...
            .buttonStyle(.icon)
            .help("debug.clear_output", comment: "Tooltip for clear output button")
        }
    }
}
