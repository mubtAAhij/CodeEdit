...
struct TaskOutputActionsView: View {
    ...
    var body: some View {
        HStack {
            ...
            .buttonStyle(.icon)
            .help(String(localized: "Run Task", comment: "Tooltip for run task button"))
            ...
            .help(String(localized: "Stop Task", comment: "Tooltip for stop task button"))
            ...
            .help(activeTask.status == .stopped ? String(localized: "Resume Task", comment: "Tooltip for resume task button") : String(localized: "Suspend Task", comment: "Tooltip for suspend task button"))
            ...
            .buttonStyle(.icon)
            .help(String(localized: "Scroll down to the bottom", comment: "Tooltip for scroll to bottom button"))
            ...
            .buttonStyle(.icon)
            .help(String(localized: "Clear Output", comment: "Tooltip for clear output button"))
        }
    }
}
