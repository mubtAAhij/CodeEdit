...
struct TaskOutputActionsView: View {
    ...
    var body: some View {
        HStack {
            ...
            .buttonStyle(.icon)
            .help(String(localized: "task.run", defaultValue: "Run Task", comment: "Run task tooltip"))
            ...
            .help(String(localized: "task.stop", defaultValue: "Stop Task", comment: "Stop task tooltip"))
            ...
            .help(activeTask.status == .stopped ? String(localized: "task.resume", defaultValue: "Resume Task", comment: "Resume task tooltip") : String(localized: "task.suspend", defaultValue: "Suspend Task", comment: "Suspend task tooltip"))
            ...
            .buttonStyle(.icon)
            .help(String(localized: "task.scroll-bottom", defaultValue: "Scroll down to the bottom", comment: "Scroll to bottom tooltip"))
