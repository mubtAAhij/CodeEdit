    ...
    func addTerminal(shell: Shell? = nil, rootURL: URL?) {
        ...
        terminals.append(
            UtilityAreaTerminal(
                ...
                title: shell?.rawValue ?? String(localized: "utility-area.terminal.default-title", defaultValue: "terminal", comment: "Default terminal title when shell is auto-detected"),
                shell: shell
            )
        )
