...
struct SchemeDropDownView: View {
    ...
    var workspaceDisplayName: String {
        ...
        ? (workspaceFileManager?.workspaceItem.fileName() ?? String(localized: "scheme-dropdown.no-project", defaultValue: "No Project found", comment: "Message when no project is found"))
        : workspaceName
    }
    ...
    var body: some View {
        ...
        .accessibilityHint(String(localized: "scheme-dropdown.hint", defaultValue: "Open the active scheme menu", comment: "Accessibility hint for scheme menu"))
        .accessibilityAction {
            isSchemePopOverPresented.toggle()
        }
    }
    ...
    @ViewBuilder var popoverContent: some View {
        ...
        Divider()
            .padding(.vertical, 5)
        Group {
            OptionMenuItemView(label: String(localized: "scheme-dropdown.add-folder", defaultValue: "Add Folder...", comment: "Menu item to add a folder")) {
