...
struct SchemeDropDownView: View {
    ...
    var workspaceDisplayName: String {
        ...
        ? (workspaceFileManager?.workspaceItem.fileName() ?? String(localized: "scheme-dropdown.no-project", defaultValue: "No Project found", comment: "Placeholder text when no project is found"))
        : workspaceName
    }
    ...
    var body: some View {
        ...
        .accessibilityLabel(String(localized: "scheme-dropdown.label", defaultValue: "Active Scheme", comment: "Accessibility label for the scheme dropdown button"))
        .accessibilityHint(String(localized: "scheme-dropdown.hint", defaultValue: "Open the active scheme menu", comment: "Accessibility hint for the scheme dropdown button"))
        .accessibilityAction {
            isSchemePopOverPresented.toggle()
        }
    }
