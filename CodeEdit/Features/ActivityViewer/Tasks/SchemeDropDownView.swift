...
struct SchemeDropDownView: View {
    ...
    var workspaceDisplayName: String {
        ...
        ? (workspaceFileManager?.workspaceItem.fileName() ?? String(localized: "scheme.no-project", defaultValue: "No Project found", comment: "No project found message"))
        : workspaceName
    }
    ...
    var body: some View {
        ...
        .accessibilityLabel(String(localized: "scheme.active", defaultValue: "Active Scheme", comment: "Active scheme label"))
        .accessibilityHint(String(localized: "scheme.menu-tooltip", defaultValue: "Open the active scheme menu", comment: "Active scheme menu tooltip"))
        .accessibilityAction {
            isSchemePopOverPresented.toggle()
        }
    }
