...
struct SchemeDropDownView: View {
    ...
    var workspaceDisplayName: String {
        ...
        ? (workspaceFileManager?.workspaceItem.fileName() ?? String(localized: "scheme.no_project", defaultValue: "No Project found", comment: "No project found message"))
        : workspaceName
    }
    ...
    var body: some View {
        ...
        .accessibilityIdentifier(String(localized: "scheme.dropdown.identifier", defaultValue: "SchemeDropdown", comment: "Scheme dropdown accessibility identifier"))
        .accessibilityValue(workspaceDisplayName)
        .accessibilityLabel(String(localized: "scheme.dropdown.label", defaultValue: "Active Scheme", comment: "Active scheme accessibility label"))
        .accessibilityHint(String(localized: "scheme.dropdown.hint", defaultValue: "Open the active scheme menu", comment: "Open active scheme menu hint"))
        .accessibilityAction {
            isSchemePopOverPresented.toggle()
        }
    }
    ...
    @ViewBuilder var popoverContent: some View {
        ...
        Divider()
            .padding(.vertical, 5)
        Group {
            OptionMenuItemView(label: String(localized: "scheme.add_folder", defaultValue: "Add Folder...", comment: "Add folder menu item")) {
                // TODO: Implment Add Folder
                print("NOT IMPLEMENTED")
            }
            .disabled(true)
            OptionMenuItemView(label: String(localized: "scheme.workspace_settings", defaultValue: "Workspace Settings...", comment: "Workspace settings menu item")) {
                NSApp.sendAction(
