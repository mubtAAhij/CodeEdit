...
struct SchemeDropDownView: View {
    ...
    var workspaceDisplayName: String {
        ...
        ? (workspaceFileManager?.workspaceItem.fileName() ?? String(
            ...
            comment: "Placeholder text when no project is available for scheme selection"
        ))
        : workspaceName
    }
    ...
    var body: some View {
        ...
        .accessibilityLabel(String(
            ...
            comment: "Accessibility label for active scheme menu control"
        ))
        .accessibilityHint(String(
            localized: "activity-viewer.scheme-dropdown.open-active-scheme-menu",
            defaultValue: "Open the active scheme menu",
            comment: "Accessibility hint for active scheme menu control"
        ))
        .accessibilityAction {
            isSchemePopOverPresented.toggle()
        }
    ...
    @ViewBuilder var popoverContent: some View {
        ...
        Group {
            OptionMenuItemView(label: String(
                ...
                comment: "Menu action title to add folder to workspace"
            )) {
            ...
            OptionMenuItemView(label: String(
                ...
                comment: "Menu action title to open workspace settings"
            )) {
                NSApp.sendAction(
