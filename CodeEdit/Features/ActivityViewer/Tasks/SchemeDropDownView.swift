...
struct SchemeDropDownView: View {
    ...
    var workspaceDisplayName: String {
        ...
        ? (workspaceFileManager?.workspaceItem.fileName() ?? String(localized: "project.no-project-found", defaultValue: "No Project found", comment: "No project found placeholder"))
        : workspaceName
    }
    ...
    var body: some View {
        ...
        .accessibilityHint(String(localized: "scheme.open-menu", defaultValue: "Open the active scheme menu", comment: "Open scheme menu hint"))
        .accessibilityAction {
            isSchemePopOverPresented.toggle()
        }
    }
