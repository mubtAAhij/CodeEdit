...
struct SchemeDropDownView: View {
    ...
    var workspaceDisplayName: String {
        ...
        ? (workspaceFileManager?.workspaceItem.fileName() ?? String(localized: "activity-viewer.no-project-found", defaultValue: "No Project found", comment: "No project found message"))
        : workspaceName
    }
    ...
    var body: some View {
        ...
        .accessibilityHint(String(localized: "activity-viewer.open-scheme-menu", defaultValue: "Open the active scheme menu", comment: "Open scheme menu accessibility hint"))
        .accessibilityAction {
            isSchemePopOverPresented.toggle()
        }
    }
    ...
    @ViewBuilder var popoverContent: some View {
        ...
        Divider()
            .padding(.vertical, 5)
        Group {
            OptionMenuItemView(label: String(localized: "activity-viewer.add-folder", defaultValue: "Add Folder...", comment: "Add folder menu item")) {
                // TODO: Implment Add Folder
                print("NOT IMPLEMENTED")
            }
            .disabled(true)
            OptionMenuItemView(label: String(localized: "activity-viewer.workspace-settings", defaultValue: "Workspace Settings...", comment: "Workspace settings menu item")) {
                NSApp.sendAction(
