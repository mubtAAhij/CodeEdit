...
struct SchemeDropDownView: View {
    ...
    var workspaceDisplayName: String {
        ...
        ? (workspaceFileManager?.workspaceItem.fileName() ?? String(localized: "scheme.no-project", defaultValue: "No Project found", comment: "Fallback when no project is found"))
        : workspaceName
    }
    ...
    var body: some View {
        ...
        .accessibilityLabel(String(localized: "scheme.active-scheme", defaultValue: "Active Scheme", comment: "Accessibility label for active scheme"))
        .accessibilityHint(String(localized: "scheme.open-menu-hint", defaultValue: "Open the active scheme menu", comment: "Accessibility hint for opening scheme menu"))
        .accessibilityAction {
            isSchemePopOverPresented.toggle()
        }
    }
