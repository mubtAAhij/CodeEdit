...
struct TaskDropDownView: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel(String(localized: "task-dropdown.active-task", defaultValue: "Active Task", comment: "Accessibility label for active task"))
        .accessibilityHint(String(localized: "task-dropdown.open-menu-hint", defaultValue: "Open the active task menu", comment: "Accessibility hint for task menu"))
        .accessibilityAction {
