...
struct TaskDropDownView: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel(String(localized: "task-dropdown.label", defaultValue: "Active Task", comment: "Accessibility label for the task dropdown button"))
    ...
    @ViewBuilder private var taskPopoverContent: some View {
        ...
        OptionMenuItemView(label: String(localized: "task-dropdown.manage-tasks", defaultValue: "Manage Tasks...", comment: "Menu item to manage tasks")) {
            NSApp.sendAction(#selector(CodeEditWindowController.openWorkspaceSettings(_:)), to: nil, from: nil)
        }
    }
}
