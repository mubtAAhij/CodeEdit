    ...
    var body: some View {
        Group {
            if let selectedTask = taskManager.selectedTask {
                ...
                Text(String(localized: "create_tasks", comment: "Create tasks button text"))
                    .frame(minWidth: 0)
            }
        }
        ...
        .accessibilityLabel(String(localized: "active_task", comment: "Accessibility label for active task"))
