    ...
    var body: some View {
        Group {
            if let selectedTask = taskManager.selectedTask {
                ...
                Text(String(
                    localized: "task-dropdown.create-tasks",
        ...
        .accessibilityLabel(String(
            localized: "task-dropdown.active-task",
            defaultValue: "Active Task",
            comment: "Accessibility label for active task dropdown"
        ))
        .accessibilityHint(String(
            localized: "task-dropdown.hint",
            defaultValue: "Open the active task menu",
            comment: "Accessibility hint for task dropdown button"
        ))
        .accessibilityAction {
