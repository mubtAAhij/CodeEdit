...
struct ActivityViewer: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel(String(localized: "activity-viewer.accessibility.label", defaultValue: "Activity Viewer", comment: "Accessibility label for the activity viewer"))
    }
