...
struct CECircularProgressView: View {
    ...
    var body: some View {
        Circle()
            ...
            .accessibilityValue(
                progress != nil ? Text(progress!, format: .percent) : Text(String(localized: "accessibility.working", defaultValue: "working", comment: "Accessibility identifier - technical constant, should not be localized"))
            )
    }
}
