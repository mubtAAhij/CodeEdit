...
struct CECircularProgressView: View {
    ...
    var body: some View {
        Circle()
            ...
            .accessibilityValue(
                progress != nil ? Text(progress!, format: .percent) : Text(String(localized: "activity.working", defaultValue: "working", comment: "Accessibility value for indeterminate progress indicator"))
            )
    }
}
