...
struct CECircularProgressView: View {
    ...
    var body: some View {
        Circle()
            ...
            .accessibilityValue(
                progress != nil ? Text(progress!, format: .percent) : Text(String(localized: "activity-viewer.progress.working", defaultValue: "working", comment: "Accessibility value when progress is indeterminate"))
            )
    }
}
