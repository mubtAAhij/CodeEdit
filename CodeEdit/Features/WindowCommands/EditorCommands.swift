...
struct EditorCommands: Commands {
    ...
    var body: some Commands {
        CommandMenu(String(localized: "window-commands.editor.menu-title", defaultValue: "Editor", comment: "Top-level editor commands menu title.")) {
            Menu(String(localized: "window-commands.editor.structure.menu-title", defaultValue: "Structure", comment: "Structure submenu title in editor commands.")) {
