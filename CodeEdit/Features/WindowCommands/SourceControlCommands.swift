    ...
    var body: some Commands {
        CommandMenu(String(localized: "menu.source-control", defaultValue: "Source Control", comment: "Source Control menu")) {
            Group {
                ...
                Button(String(localized: "menu.source-control.stage-all-changes", defaultValue: "Stage All Changes", comment: "Stage all changes menu item")) {
                        ...
                        Task {
                            do {
                                ...
                                await sourceControlManager.showAlertForError(
                                    title: String(localized: "menu.source-control.failed-to-stage", defaultValue: "Failed To Stage Changes", comment: "Failed to stage changes error"),
                                    error: error
                                )
                            }
                        }
                ...
                Button(String(localized: "menu.source-control.unstage-all-changes", defaultValue: "Unstage All Changes", comment: "Unstage all changes menu item")) {
                    guard let sourceControlManager else { return }
                    if sourceControlManager.changedFiles.isEmpty {
                        ...
                        Task {
                            do {
                                ...
                                await sourceControlManager.showAlertForError(
                                    title: String(localized: "menu.source-control.failed-to-unstage", defaultValue: "Failed To Unstage Changes", comment: "Failed to unstage changes error"),
                                    error: error
                                )
                            }
                        }
                ...
                Button(String(localized: "menu.source-control.discard-all-changes", defaultValue: "Discard All Changes...", comment: "Discard all changes menu item")) {
                    if sourceControlManager?.changedFiles.isEmpty ?? false {
                ...
                Button(String(localized: "menu.source-control.add-existing-remote", defaultValue: "Add Exisiting Remote...", comment: "Add existing remote menu item")) {
