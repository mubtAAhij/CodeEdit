    ...
    var body: some Commands {
        CommandMenu(String(localized: "window-commands.source-control.menu-title", defaultValue: "Source Control", comment: "Title of the Source Control command menu")) {
            Group {
                        ...
                        Task {
                            do {
                                ...
                                await sourceControlManager.showAlertForError(
                                    title: String(localized: "window-commands.source-control.failed-to-stage-changes", defaultValue: "Failed To Stage Changes", comment: "Error title shown when staging changes fails"),
                                    error: error
                                )
                            }
                        }
                    ...
                    if sourceControlManager.changedFiles.isEmpty {
                        ...
                        Task {
                            do {
                                ...
                                await sourceControlManager.showAlertForError(
                                    title: String(localized: "window-commands.source-control.failed-to-unstage-changes", defaultValue: "Failed To Unstage Changes", comment: "Error title shown when unstaging changes fails"),
                                    error: error
                                )
                            }
                        }
                ...
                Button(String(localized: "window-commands.source-control.stash-changes", defaultValue: "Stash Changes...", comment: "Menu item title to open stash changes action")) {
