                        ...
                        Task {
                            do {
                                ...
                                await sourceControlManager.showAlertForError(
                                    title: String(localized: "source-control.error.stage-failed", defaultValue: "Failed To Stage Changes", comment: "Error title when staging fails"),
                                    error: error
                                )
                            }
                        }
                    ...
                    if sourceControlManager.changedFiles.isEmpty {
                        ...
                        Task {
                            do {
                                ...
                                await sourceControlManager.showAlertForError(
                                    title: String(localized: "source-control.error.unstage-failed", defaultValue: "Failed To Unstage Changes", comment: "Error title when unstaging fails"),
                                    error: error
                                )
                            }
                        }
