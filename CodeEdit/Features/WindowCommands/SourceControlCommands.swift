    ...
    var body: some Commands {
        CommandMenu(String(localized: "source-control.menu", defaultValue: "Source Control", comment: "Source control menu title")) {
            Group {
                ...
                Button(String(localized: "source-control.fetch", defaultValue: "Fetch Changes", comment: "Fetch changes menu item")) {
                    sourceControlManager?.fetchSheetIsPresented = true
                }

                Divider()

                Button(String(localized: "source-control.stage-all", defaultValue: "Stage All Changes", comment: "Stage all changes menu item")) {
                        ...
                        Task {
                            do {
                                ...
                                await sourceControlManager.showAlertForError(
                                    title: String(localized: "source-control.stage-all.error", defaultValue: "Failed To Stage Changes", comment: "Failed to stage changes error"),
                                    error: error
                                )
                            }
                        }
                ...
                Button(String(localized: "source-control.unstage-all", defaultValue: "Unstage All Changes", comment: "Unstage all changes menu item")) {
                    guard let sourceControlManager else { return }
                    if sourceControlManager.changedFiles.isEmpty {
                        ...
                        Task {
                            do {
                                ...
                                await sourceControlManager.showAlertForError(
                                    title: String(localized: "source-control.unstage-all.error", defaultValue: "Failed To Unstage Changes", comment: "Failed to unstage changes error"),
                                    error: error
                                )
                            }
                        }
                ...
                Button(String(localized: "source-control.stash", defaultValue: "Stash Changes...", comment: "Stash changes menu item")) {
                ...
                Button(String(localized: "source-control.discard-all", defaultValue: "Discard All Changes...", comment: "Discard all changes menu item")) {
                    if sourceControlManager?.changedFiles.isEmpty ?? false {
                ...
                Button(String(localized: "source-control.add-remote", defaultValue: "Add Exisiting Remote...", comment: "Add existing remote menu item")) {
