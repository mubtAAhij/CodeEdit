...
struct SourceControlCommands: Commands {
    ...
    var body: some Commands {
        CommandMenu(String(
            localized: "window-commands.source-control.title",
            defaultValue: "Source Control",
            comment: "Title for Source Control command menu"
        )) {
            Group {
                Button(String(
                    localized: "window-commands.source-control.commit",
                    defaultValue: "Commit...",
                    comment: "Menu item title to open commit action"
                )) {
                ...
                Button(String(
                    ...
                    defaultValue: "Push...",
                    comment: "Menu item title to open push action"
                )) {
                ...
                Button(String(
                    ...
                    defaultValue: "Pull...",
                    comment: "Menu item title to open pull action"
                )) {
                ...
                Button(String(
                    ...
                    comment: "Menu item title to stage all source control changes"
                )) {
                            ...
                            do {
                                ...
                                await sourceControlManager.showAlertForError(
                                    title: String(
                                        ...
                                        comment: "Error title shown when staging all changes fails"
                                    ),
                                    error: error
                                )
                            }
                ...
                Button(String(
                    ...
                    comment: "Menu item title to unstage all source control changes"
                )) {
                    guard let sourceControlManager else { return }
                    if sourceControlManager.changedFiles.isEmpty {
                            ...
                            do {
                                ...
                                await sourceControlManager.showAlertForError(
                                    title: String(
                                        ...
                                        comment: "Error title shown when unstaging all changes fails"
                                    ),
                                    error: error
                                )
                            }
                ...
                Button(String(
                    ...
                    comment: "Menu item title to open cherry-pick action"
                )) {
                ...
                Button(String(
                    ...
                    comment: "Menu item title to stash source control changes"
                )) {
                ...
                Button(String(
                    ...
                    comment: "Menu item title to discard all source control changes"
                )) {
                    if sourceControlManager?.changedFiles.isEmpty ?? false {
