    ...
    var body: some Commands {
        CommandMenu(String(localized: "menu.find", defaultValue: "Find", comment: "Find menu title")) {
            Group {
                ...
                Button(String(localized: "menu.find.find-and-replace", defaultValue: "Find and Replace...", comment: "Menu item to open find and replace")) {
                ...
                Button(String(localized: "menu.find.use-selection", defaultValue: "Use Selection for Find", comment: "Menu item to use current selection for find")) {
                    send(.setFindString)
                }
                .keyboardShortcut("e")
