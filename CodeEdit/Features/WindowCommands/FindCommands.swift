    ...
    var body: some Commands {
        CommandMenu(String(localized: "window-commands.find.menu-title", defaultValue: "Find", comment: "Title of the Find command menu")) {
            Group {
                ...
                Button(String(localized: "window-commands.find.use-selection-for-find", defaultValue: "Use Selection for Find", comment: "Menu item title to use the current selection for find")) {
                    send(.setFindString)
                }
                .keyboardShortcut("e")
