...
struct FindCommands: Commands {
    ...
    var body: some Commands {
        CommandMenu(String(localized: "menu.find", defaultValue: "Find", comment: "Find menu title")) {
            Group {
                Button(String(localized: "menu.find.find", defaultValue: "Find...", comment: "Menu item to open find dialog")) {
                    send(.showFindPanel)
                }
                .keyboardShortcut("f")

                Button(String(localized: "menu.find.find-and-replace", defaultValue: "Find and Replace...", comment: "Menu item to open find and replace dialog")) {
