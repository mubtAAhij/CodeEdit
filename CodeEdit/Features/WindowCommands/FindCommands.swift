...
struct FindCommands: Commands {
    ...
    var body: some Commands {
        CommandMenu(String(
            ...
            defaultValue: "Find",
            comment: "Top-level Find menu title"
        )) {
            Group {
                Button(String(
                    localized: "window-commands.find.find",
                    defaultValue: "Find...",
                    comment: "Menu command title for opening find panel"
                )) {
                    send(.showFindPanel)
                }
                .keyboardShortcut("f")
                ...
                Button(String(
                    ...
                    comment: "Menu command title for opening find and replace panel"
                )) {
                ...
                Button(String(
                    ...
                    comment: "Menu command title for finding next match"
                )) {
                    send(.next)
                }
                .keyboardShortcut("g")
                ...
                Button(String(
                    ...
                    comment: "Menu command title for finding previous match"
                )) {
                    send(.previous)
                }
                ...
                Button(String(
                    ...
                    comment: "Menu command title to use selected text for find"
                )) {
                    send(.setFindString)
                }
                .keyboardShortcut("e")
                ...
                Button(String(
                    ...
                    comment: "Menu command title to jump to selected text"
                )) {
