...
struct FindCommands: Commands {
    ...
    defaultValue: "Find...",
    comment: "Find command menu item"
)) {
                    send(.showFindPanel)
                }
                .keyboardShortcut("f")
    ...
    comment: "Find and Replace command menu item"
)) {
    ...
    comment: "Find Next command menu item"
)) {
                    send(.next)
                }
                .keyboardShortcut("g")
    ...
    comment: "Find Previous command menu item"
)) {
                    send(.previous)
                }
    ...
    comment: "Use Selection for Find command menu item"
)) {
                    send(.setFindString)
                }
                .keyboardShortcut("e")
    ...
    comment: "Jump to Selection command menu item"
)) {
