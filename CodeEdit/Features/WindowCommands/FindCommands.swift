...
struct FindCommands: Commands {
    ...
    var body: some Commands {
        CommandMenu(String(
            localized: "window-commands.find.title",
            defaultValue: "Find",
            ...
            Group {
                Button(String(
                    ...
                    defaultValue: "Find...",
                    comment: "Menu item title to open find panel"
                )) {
                    send(.showFindPanel)
                }
                .keyboardShortcut("f")
                ...
                Button(String(
                    ...
                    comment: "Menu item title to open find and replace panel"
                )) {
                ...
                Button(String(
                    ...
                    comment: "Menu item title to use current selection for find"
                )) {
                    send(.setFindString)
                }
                .keyboardShortcut("e")
                ...
                Button(String(
                    ...
                    comment: "Menu item title to jump to selected text"
                )) {
