...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(localized: "commands.file.new", defaultValue: "New", comment: "Menu command to create new file")) {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button(String(localized: "commands.file.open", defaultValue: "Open...", comment: "Menu command to open file")) {
                ...
                Menu(String(localized: "commands.file.open-recent", defaultValue: "Open Recent", comment: "Menu for recently opened files")) { }

                Button(String(localized: "commands.file.open-quickly", defaultValue: "Open Quickly", comment: "Menu command to open quick file navigator")) {
        ...
        CommandGroup(replacing: .saveItem) {
            Button(String(localized: "commands.file.close-tab", defaultValue: "Close Tab", comment: "Menu command to close current tab")) {
            ...
            Button(String(localized: "commands.file.close-editor", defaultValue: "Close Editor", comment: "Menu command to close current editor")) {
            ...
            Button(String(localized: "commands.file.close-window", defaultValue: "Close Window", comment: "Menu command to close current window")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            .keyboardShortcut("w", modifiers: [.shift, .command])

            Button(String(localized: "commands.file.close-workspace", defaultValue: "Close Workspace", comment: "Menu command to close current workspace")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            ...
            if let utilityAreaViewModel {
                Button(String(localized: "commands.file.close-terminal", defaultValue: "Close Terminal", comment: "Menu command to close terminal")) {
            ...
            Button(String(localized: "commands.file.workspace-settings", defaultValue: "Workspace Settings", comment: "Menu command to open workspace settings")) {
            ...
            Button(String(localized: "commands.file.save", defaultValue: "Save", comment: "Menu command to save current file")) {
