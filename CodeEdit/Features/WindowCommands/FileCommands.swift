...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(localized: "file.new", defaultValue: "New", comment: "Menu item to create a new document")) {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button(String(localized: "file.open", defaultValue: "Open...", comment: "Menu item to open a document")) {
                ...
                Menu(String(localized: "file.open-recent", defaultValue: "Open Recent", comment: "Menu item to show recently opened projects")) { }

                Button(String(localized: "file.open-quickly", defaultValue: "Open Quickly", comment: "Menu item to quickly open a file")) {
        ...
        CommandGroup(replacing: .saveItem) {
            Button(String(localized: "file.close-tab", defaultValue: "Close Tab", comment: "Menu item to close the current tab")) {
            ...
            Button(String(localized: "file.close-editor", defaultValue: "Close Editor", comment: "Menu item to close the active editor")) {
            ...
            Button(String(localized: "file.close-window", defaultValue: "Close Window", comment: "Menu item to close the current window")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            .keyboardShortcut("w", modifiers: [.shift, .command])

            Button(String(localized: "file.close-workspace", defaultValue: "Close Workspace", comment: "Menu item to close the workspace")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            ...
            if let utilityAreaViewModel {
                Button(String(localized: "file.close-terminal", defaultValue: "Close Terminal", comment: "Menu item to close the selected terminal")) {
            ...
            Button(String(localized: "file.save", defaultValue: "Save", comment: "Menu item to save the current document")) {
