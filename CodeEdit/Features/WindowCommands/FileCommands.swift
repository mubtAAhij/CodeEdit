...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(localized: "file-commands.new", defaultValue: "New", comment: "New file command")) {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button(String(localized: "file-commands.open", defaultValue: "Open...", comment: "Open file command")) {
                ...
                Menu(String(localized: "file-commands.open-recent", defaultValue: "Open Recent", comment: "Open recent menu")) { }

                Button(String(localized: "file-commands.open-quickly", defaultValue: "Open Quickly", comment: "Open quickly command")) {
        ...
        CommandGroup(replacing: .saveItem) {
            Button(String(localized: "file-commands.close-tab", defaultValue: "Close Tab", comment: "Close tab command")) {
            ...
            Button(String(localized: "file-commands.close-editor", defaultValue: "Close Editor", comment: "Close editor command")) {
            ...
            Button(String(localized: "file-commands.close-window", defaultValue: "Close Window", comment: "Close window command")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            .keyboardShortcut("w", modifiers: [.shift, .command])

            Button(String(localized: "file-commands.close-workspace", defaultValue: "Close Workspace", comment: "Close workspace command")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            ...
            if let utilityAreaViewModel {
                Button(String(localized: "file-commands.close-terminal", defaultValue: "Close Terminal", comment: "Close terminal command")) {
            ...
            Button(String(localized: "file-commands.workspace-settings", defaultValue: "Workspace Settings", comment: "Workspace settings command")) {
            ...
            Button(String(localized: "file-commands.save", defaultValue: "Save", comment: "Save command")) {
