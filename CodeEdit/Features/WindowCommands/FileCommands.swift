...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button("file.new", comment: "Button text") {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button("file.open", comment: "Button text") {
                ...
                Menu("file.openRecent", comment: "Menu title") { }

                Button("file.openQuickly", comment: "Button text") {
        ...
        CommandGroup(replacing: .saveItem) {
            Button("file.closeTab", comment: "Button text") {
            ...
            Button("file.closeEditor", comment: "Button text") {
            ...
            Button("file.closeWindow", comment: "Button text") {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            .keyboardShortcut("w", modifiers: [.shift, .command])

            Button("file.closeWorkspace", comment: "Button text") {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            ...
            if let utilityAreaViewModel {
                Button("file.closeTerminal", comment: "Button text") {
            ...
            Button("file.workspaceSettings", comment: "Button text") {
            ...
            Button("file.save", comment: "Button text") {
