...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(
    localized: "window-commands.file.new",
    defaultValue: "New",
    comment: "File menu command to create a new document"
)) {
                ...
                Button(String(
    localized: "window-commands.file.open-ellipsis",
    defaultValue: "Open...",
    comment: "File menu command to open an existing document"
)) {
                ...
                Menu(String(
    localized: "window-commands.file.open-recent",
    defaultValue: "Open Recent",
    comment: "File menu submenu title for recently opened projects"
)) { }

                Button(String(
    localized: "window-commands.file.open-quickly",
    defaultValue: "Open Quickly",
    comment: "File menu command to quickly open a file"
)) {
        ...
        CommandGroup(replacing: .saveItem) {
            Button(String(
    localized: "window-commands.file.close-tab",
    defaultValue: "Close Tab",
    comment: "File menu command to close the current tab"
)) {
            ...
            Button(String(
    localized: "window-commands.file.close-editor",
    defaultValue: "Close Editor",
    comment: "File menu command to close the active editor"
)) {
            ...
            Button(String(
    localized: "window-commands.file.close-window",
    defaultValue: "Close Window",
    comment: "File menu command to close the current window"
)) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            ...
            Button(String(
    localized: "window-commands.file.close-workspace",
    defaultValue: "Close Workspace",
    comment: "File menu command to close the workspace window"
)) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            ...
            if let utilityAreaViewModel {
                Button(String(
    localized: "window-commands.file.close-terminal",
    defaultValue: "Close Terminal",
    comment: "File menu command to close selected terminal"
)) {
            ...
            Button(String(
    localized: "window-commands.file.workspace-settings",
    defaultValue: "Workspace Settings",
    comment: "File menu command to open workspace settings"
)) {
            ...
            Button(String(
    localized: "window-commands.file.save",
    defaultValue: "Save",
    comment: "File menu command to save the current document"
)) {
