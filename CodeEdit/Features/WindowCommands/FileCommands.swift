...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(localized: "file-commands.new", defaultValue: "New", comment: "Menu item to create a new file")) {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button(String(localized: "file-commands.open", defaultValue: "Open...", comment: "Menu item to open a file")) {
                ...
                Menu(String(localized: "file-commands.open-recent", defaultValue: "Open Recent", comment: "Menu item for recent projects")) { }

                Button(String(localized: "file-commands.open-quickly", defaultValue: "Open Quickly", comment: "Menu item to open file quickly")) {
        ...
        CommandGroup(replacing: .saveItem) {
            Button(String(localized: "file-commands.close-tab", defaultValue: "Close Tab", comment: "Menu item to close current tab")) {
            ...
            Button(String(localized: "file-commands.close-editor", defaultValue: "Close Editor", comment: "Menu item to close active editor")) {
            ...
            Button(String(localized: "file-commands.close-window", defaultValue: "Close Window", comment: "Menu item to close window")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            .keyboardShortcut("w", modifiers: [.shift, .command])

            Button(String(localized: "file-commands.close-workspace", defaultValue: "Close Workspace", comment: "Menu item to close workspace")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            ...
            if let utilityAreaViewModel {
                Button(String(localized: "file-commands.close-terminal", defaultValue: "Close Terminal", comment: "Menu item to close terminal")) {
            ...
            Button(String(localized: "file-commands.save", defaultValue: "Save", comment: "Menu item to save document")) {
