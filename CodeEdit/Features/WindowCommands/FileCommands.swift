...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(localized: "file.new", defaultValue: "New", comment: "Menu item to create new file")) {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button(String(localized: "file.open", defaultValue: "Open...", comment: "Menu item to open file")) {
                ...
                Menu(String(localized: "file.open-recent", defaultValue: "Open Recent", comment: "Menu item for recent projects")) { }

                Button(String(localized: "file.open-quickly", defaultValue: "Open Quickly", comment: "Menu item to open quickly")) {
        ...
        CommandGroup(replacing: .saveItem) {
            ...
            Button(String(localized: "file.close-editor", defaultValue: "Close Editor", comment: "Menu item to close active editor")) {
            ...
            Button(String(localized: "file.close-window", defaultValue: "Close Window", comment: "Menu item to close window")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
