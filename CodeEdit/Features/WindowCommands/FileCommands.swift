...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(localized: "file.new", defaultValue: "New", comment: "New file menu item")) {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button(String(localized: "file.open", defaultValue: "Open...", comment: "Open file menu item")) {
                ...
                Menu(String(localized: "file.open-recent", defaultValue: "Open Recent", comment: "Open recent menu item")) { }
        ...
        CommandGroup(replacing: .saveItem) {
            ...
            Button(String(localized: "file.close-editor", defaultValue: "Close Editor", comment: "Close editor menu item")) {
            ...
            Button(String(localized: "file.close-window", defaultValue: "Close Window", comment: "Close window menu item")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            .keyboardShortcut("w", modifiers: [.shift, .command])

            Button(String(localized: "file.close-workspace", defaultValue: "Close Workspace", comment: "Close workspace menu item")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            ...
            if let utilityAreaViewModel {
                Button(String(localized: "file.close-terminal", defaultValue: "Close Terminal", comment: "Close terminal menu item")) {
