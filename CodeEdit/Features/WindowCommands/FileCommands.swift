    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                ...
                Menu(String(localized: "open_recent", comment: "Menu item for opening recent files")) { }

                Button(String(localized: "open_quickly", comment: "Menu item for quick file opening")) {
        ...
        CommandGroup(replacing: .saveItem) {
            ...
            Button(String(localized: "workspace_settings", comment: "Menu item for workspace settings")) {
            ...
            Button(String(localized: "save", comment: "Save menu item")) {
