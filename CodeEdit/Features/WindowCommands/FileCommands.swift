...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(localized: "menu.file.new", defaultValue: "New", comment: "New file menu item")) {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button(String(localized: "menu.file.open", defaultValue: "Open...", comment: "Open file menu item")) {
                ...
                Menu(String(localized: "menu.file.open-recent", defaultValue: "Open Recent", comment: "Open recent menu item")) { }
        ...
        CommandGroup(replacing: .saveItem) {
            ...
            Button(String(localized: "menu.file.save", defaultValue: "Save", comment: "Save file menu item")) {
