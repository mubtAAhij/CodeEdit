    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                ...
                Menu(String(localized: "file.open-recent", defaultValue: "Open Recent", comment: "Menu item to open recent files")) { }
        ...
        CommandGroup(replacing: .saveItem) {
            ...
            Button(String(localized: "file.close-editor", defaultValue: "Close Editor", comment: "Menu item to close editor")) {
