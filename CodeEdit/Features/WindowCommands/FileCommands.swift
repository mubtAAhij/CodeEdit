...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(localized: "file.new", comment: "Menu item for new file")) {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button(String(localized: "file.open", comment: "Menu item to open file")) {
                ...
                Menu(String(localized: "file.open_recent", comment: "Menu item for recent files")) { }

                Button(String(localized: "file.open_quickly", comment: "Menu item for quick open")) {
        ...
        CommandGroup(replacing: .saveItem) {
            Button(String(localized: "file.close_tab", comment: "Menu item to close tab")) {
            ...
            Button(String(localized: "file.close_editor", comment: "Menu item to close editor")) {
            ...
            Button(String(localized: "file.close_window", comment: "Menu item to close window")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            .keyboardShortcut("w", modifiers: [.shift, .command])

            Button(String(localized: "file.close_workspace", comment: "Menu item to close workspace")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            ...
            if let utilityAreaViewModel {
                Button(String(localized: "file.close_terminal", comment: "Menu item to close terminal")) {
            ...
            Button(String(localized: "file.workspace_settings", comment: "Menu item to open workspace settings")) {
            ...
            Button(String(localized: "file.save", comment: "Menu item to save current file")) {
