...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(localized: "file.new", defaultValue: "New", comment: "Menu command to create new file")) {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button(String(localized: "file.open", defaultValue: "Open...", comment: "Menu command to open file")) {
                ...
                Menu(String(localized: "file.open_recent", defaultValue: "Open Recent", comment: "Menu command to open recent files")) { }

                Button(String(localized: "file.open_quickly", defaultValue: "Open Quickly", comment: "Menu command to open quickly")) {
        ...
        CommandGroup(replacing: .saveItem) {
            Button(String(localized: "file.close_tab", defaultValue: "Close Tab", comment: "Menu command to close tab")) {
            ...
            Button(String(localized: "file.close_editor", defaultValue: "Close Editor", comment: "Menu command to close editor")) {
            ...
            Button(String(localized: "file.close_window", defaultValue: "Close Window", comment: "Menu command to close window")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            .keyboardShortcut("w", modifiers: [.shift, .command])

            Button(String(localized: "file.close_workspace", defaultValue: "Close Workspace", comment: "Menu command to close workspace")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            ...
            if let utilityAreaViewModel {
                Button(String(localized: "file.close_terminal", defaultValue: "Close Terminal", comment: "Menu command to close terminal")) {
            ...
            Button(String(localized: "file.workspace_settings", defaultValue: "Workspace Settings", comment: "Menu command to open workspace settings")) {
            ...
            Button(String(localized: "file.save", defaultValue: "Save", comment: "Menu command to save file")) {
