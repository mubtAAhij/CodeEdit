...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(localized: "new", comment: "Menu item to create new document")) {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button(String(localized: "open", comment: "Menu item to open document")) {
                ...
                Menu(String(localized: "open_recent", comment: "Menu item to open recent documents")) { }

                Button(String(localized: "open_quickly", comment: "Menu item to open documents quickly")) {
        ...
        CommandGroup(replacing: .saveItem) {
            ...
            Button(String(localized: "close_editor", comment: "Menu item to close active editor")) {
            ...
            Button(String(localized: "close_window", comment: "Menu item to close current window")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
