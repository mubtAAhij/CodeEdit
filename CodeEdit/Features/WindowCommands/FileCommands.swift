    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                ...
                Button(String(localized: "window-commands.file.open", defaultValue: "Open...", comment: "File menu command to open a document")) {
        ...
        CommandGroup(replacing: .saveItem) {
            ...
            Button(String(localized: "window-commands.file.close-workspace", defaultValue: "Close Workspace", comment: "File menu command to close the current workspace")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            ...
            if let utilityAreaViewModel {
                Button(String(localized: "window-commands.file.close-terminal", defaultValue: "Close Terminal", comment: "File menu command to close selected terminal tabs")) {
            ...
            Button(String(localized: "window-commands.file.save", defaultValue: "Save", comment: "File menu command to save the active document")) {
