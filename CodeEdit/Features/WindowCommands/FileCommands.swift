...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button("file.new", comment: "Create new file menu item") {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button("file.open", comment: "Open file menu item") {
                ...
                Menu("file.open_recent", comment: "Open recent files menu") { }

                Button("file.open_quickly", comment: "Open quickly menu item") {
        ...
        CommandGroup(replacing: .saveItem) {
            Button("file.close_tab", comment: "Close current tab menu item") {
            ...
            Button("file.close_editor", comment: "Close editor menu item") {
            ...
            Button("file.close_window", comment: "Close window menu item") {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            .keyboardShortcut("w", modifiers: [.shift, .command])

            Button("file.close_workspace", comment: "Close workspace menu item") {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            ...
            if let utilityAreaViewModel {
                Button("file.close_terminal", comment: "Close terminal menu item") {
            ...
            Button("file.workspace_settings", comment: "Workspace settings menu item") {
            ...
            Button("file.save", comment: "Save file menu item") {
