...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(localized: "menu.file.new", defaultValue: "New", comment: "File menu new item")) {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button(String(localized: "menu.file.open", defaultValue: "Open...", comment: "File menu open item")) {
                ...
                Menu(String(localized: "menu.file.open-recent", defaultValue: "Open Recent", comment: "File menu open recent submenu")) { }

                Button(String(localized: "menu.file.open-quickly", defaultValue: "Open Quickly", comment: "File menu open quickly item")) {
        ...
        CommandGroup(replacing: .saveItem) {
            Button(String(localized: "menu.file.close-tab", defaultValue: "Close Tab", comment: "File menu close tab item")) {
            ...
            Button(String(localized: "menu.file.close-editor", defaultValue: "Close Editor", comment: "File menu close editor item")) {
            ...
            Button(String(localized: "menu.file.close-window", defaultValue: "Close Window", comment: "File menu close window item")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            .keyboardShortcut("w", modifiers: [.shift, .command])

            Button(String(localized: "menu.file.close-workspace", defaultValue: "Close Workspace", comment: "File menu close workspace item")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            ...
            if let utilityAreaViewModel {
                Button(String(localized: "menu.file.close-terminal", defaultValue: "Close Terminal", comment: "File menu close terminal item")) {
            ...
            Button(String(localized: "menu.file.workspace-settings", defaultValue: "Workspace Settings", comment: "File menu workspace settings item")) {
            ...
            Button(String(localized: "menu.file.save", defaultValue: "Save", comment: "File menu save item")) {
