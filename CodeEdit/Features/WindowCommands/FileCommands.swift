...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(localized: "new", comment: "Menu item for creating new file")) {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button(String(localized: "open", comment: "Menu item to open file")) {
                ...
                Menu(String(localized: "open_recent", comment: "Menu item to open recent files")) { }

                Button(String(localized: "open_quickly", comment: "Menu item to open file quickly")) {
        ...
        CommandGroup(replacing: .saveItem) {
            Button(String(localized: "close_tab", comment: "Menu item to close current tab")) {
            ...
            Button(String(localized: "close_editor", comment: "Menu item to close editor")) {
            ...
            Button(String(localized: "close_window", comment: "Menu item to close window")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            .keyboardShortcut("w", modifiers: [.shift, .command])

            Button(String(localized: "close_workspace", comment: "Menu item to close workspace")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            ...
            if let utilityAreaViewModel {
                Button(String(localized: "close_terminal", comment: "Menu item to close terminal")) {
            ...
            Button(String(localized: "workspace_settings", comment: "Menu item to open workspace settings")) {
            ...
            Button(String(localized: "save", comment: "Menu item to save file")) {
