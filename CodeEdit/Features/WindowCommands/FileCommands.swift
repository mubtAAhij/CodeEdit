...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(localized: "new", comment: "New file menu item")) {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button(String(localized: "open", comment: "Open file menu item")) {
                ...
                Menu(String(localized: "open_recent", comment: "Open recent files menu")) { }

                Button(String(localized: "open_quickly", comment: "Open quickly menu item")) {
        ...
        CommandGroup(replacing: .saveItem) {
            Button(String(localized: "close_tab", comment: "Close tab menu item")) {
            ...
            Button(String(localized: "close_editor", comment: "Close editor menu item")) {
            ...
            Button(String(localized: "close_window", comment: "Close window menu item")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            .keyboardShortcut("w", modifiers: [.shift, .command])

            Button(String(localized: "close_workspace", comment: "Close workspace menu item")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            ...
            if let utilityAreaViewModel {
                Button(String(localized: "close_terminal", comment: "Close terminal menu item")) {
            ...
            Button(String(localized: "workspace_settings", comment: "Workspace settings menu item")) {
            ...
            Button(String(localized: "save", comment: "Save file menu item")) {
