...
struct FileCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .newItem) {
            Group {
                Button(String(localized: "file.new", defaultValue: "New", comment: "New document menu item")) {
                    NSDocumentController.shared.newDocument(nil)
                }
                .keyboardShortcut("n")

                Button(String(localized: "file.open", defaultValue: "Open...", comment: "Open document menu item")) {
                ...
                Menu(String(localized: "file.open_recent", defaultValue: "Open Recent", comment: "Open recent menu")) { }

                Button(String(localized: "file.open_quickly", defaultValue: "Open Quickly", comment: "Open quickly menu item")) {
        ...
        CommandGroup(replacing: .saveItem) {
            Button(String(localized: "file.close_tab", defaultValue: "Close Tab", comment: "Close tab menu item")) {
            ...
            Button(String(localized: "file.close_editor", defaultValue: "Close Editor", comment: "Close editor menu item")) {
            ...
            Button(String(localized: "file.close_window", defaultValue: "Close Window", comment: "Close window menu item")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            .keyboardShortcut("w", modifiers: [.shift, .command])

            Button(String(localized: "file.close_workspace", defaultValue: "Close Workspace", comment: "Close workspace menu item")) {
                NSApp.sendAction(#selector(NSWindow.performClose(_:)), to: NSApp.keyWindow, from: nil)
            }
            ...
            if let utilityAreaViewModel {
                Button(String(localized: "file.close_terminal", defaultValue: "Close Terminal", comment: "Close terminal menu item")) {
            ...
            Button(String(localized: "file.workspace_settings", defaultValue: "Workspace Settings", comment: "Workspace settings menu item")) {
            ...
            Button(String(localized: "file.save", defaultValue: "Save", comment: "Save document menu item")) {
