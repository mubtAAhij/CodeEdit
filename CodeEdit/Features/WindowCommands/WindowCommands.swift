...
struct WindowCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .singleWindowList) {
            ...
            Button(String(localized: "menu.about-codeedit", defaultValue: "About CodeEdit", comment: "Menu item to open about window")) {
                openWindow(sceneID: .about)
            }
            .keyboardShortcut("2", modifiers: [.shift, .command])

            Button(String(localized: "menu.manage-extensions", defaultValue: "Manage Extensions", comment: "Menu item to open extensions window")) {
