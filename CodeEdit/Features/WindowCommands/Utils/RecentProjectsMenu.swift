...
final class RecentProjectsMenu: NSObject, NSMenuDelegate {
    ...
    private let menuTitle = String(localized: "commands.file.open-recent", defaultValue: "Open Recent", comment: "Open Recent menu title")
    ...
    private func rebuildMenu() {
        ...
        let clearMenuItem = NSMenuItem(
            title: String(localized: "commands.file.clear-recent", defaultValue: "Clear Menu", comment: "Recent project menu clear button"),
