...
struct MainCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(replacing: .appInfo) {
            Button(String(localized: "menu.about", defaultValue: "About CodeEdit", comment: "About menu item")) {
                openWindow(sceneID: .about)
            }

            Button(String(localized: "menu.check_updates", defaultValue: "Check for updates...", comment: "Check for updates menu item")) {
