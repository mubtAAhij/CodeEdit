    ...
    var body: some Commands {
        CommandMenu(String(localized: "menu.tasks.title", defaultValue: "Tasks", comment: "Tasks menu title")) {
            let selectedTaskName: String = if let selectedTask = taskManager?.selectedTask {
                ...
                String(localized: "menu.tasks.no-selected-task", defaultValue: "(No Selected Task)", comment: "Label when no task is selected")
            }
            ...
            Menu {
                ...
                Text(String(localized: "menu.tasks.choose-task", defaultValue: "Choose Task...", comment: "Menu item to choose task"))
            }
