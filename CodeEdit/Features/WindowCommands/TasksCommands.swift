...
struct TasksCommands: Commands {
    ...
    var body: some Commands {
        CommandMenu(String(localized: "window.commands.tasks.menu-title", defaultValue: "Tasks", comment: "Top-level Tasks command menu title")) {
            ...
            Button(String(format: String(localized: "window.commands.tasks.run-selected", defaultValue: "Run %@", comment: "Command title to run the selected task"), "\(selectedTaskName)"), systemImage: "play.fill") {
            ...
            Button(String(format: String(localized: "window.commands.tasks.stop-selected", defaultValue: "Stop %@", comment: "Command title to stop the selected task"), "\(selectedTaskName)"), systemImage: "stop.fill") {
            ...
            Button(String(format: String(localized: "window.commands.tasks.show-selected-output", defaultValue: "Show %@ Output", comment: "Command title to show output for selected task"), "\(selectedTaskName)")) {
                showOutput()
            }
