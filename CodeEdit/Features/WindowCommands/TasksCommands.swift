    ...
    var body: some Commands {
        CommandMenu(String(localized: "tasks.menu", defaultValue: "Tasks", comment: "Tasks menu")) {
            let selectedTaskName: String = if let selectedTask = taskManager?.selectedTask {
                ...
                String(localized: "tasks.no-selected", defaultValue: "(No Selected Task)", comment: "No selected task")
            }
            ...
            Menu {
                ...
                Text(String(localized: "tasks.choose", defaultValue: "Choose Task...", comment: "Choose task menu item"))
            }
