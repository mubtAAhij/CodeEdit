...
struct TasksCommands: Commands {
    ...
    var body: some Commands {
        CommandMenu(String(localized: "menu.tasks", defaultValue: "Tasks", comment: "Tasks menu")) {
            ...
            Button(String(format: String(localized: "task.run-task", defaultValue: "Run %@", comment: "Run task menu item"), selectedTaskName), systemImage: "play.fill") {
            ...
            Button(String(format: String(localized: "task.stop-task", defaultValue: "Stop %@", comment: "Stop task menu item"), selectedTaskName), systemImage: "stop.fill") {
            ...
            Button(String(format: String(localized: "task.show-task-output", defaultValue: "Show %@ Output", comment: "Show task output menu item"), selectedTaskName)) {
                showOutput()
            }
            ...
            Menu {
                ...
                if taskManager?.availableTasks.isEmpty ?? true {
                    Button(String(localized: "task.create-tasks", defaultValue: "Create Tasks", comment: "Create tasks menu item")) {
                        openSettings()
                    }
                }
            } label: {
                Text(String(localized: "task.choose-task", defaultValue: "Choose Task...", comment: "Choose task menu item"))
            }
