    ...
    var body: some Commands {
        CommandMenu(String(localized: "window-commands.tasks.menu-title", defaultValue: "Tasks", comment: "Title of the Tasks command menu")) {
            let selectedTaskName: String = if let selectedTask = taskManager?.selectedTask {
                ...
                String(localized: "window-commands.tasks.no-selected-task", defaultValue: "(No Selected Task)", comment: "Menu placeholder when no task is selected")
            }
            ...
            Button(String(format: String(localized: "window-commands.tasks.show-output-selected", defaultValue: "Show %@ Output", comment: "Menu item title to show output for the selected task"), "\(selectedTaskName)")) {
                showOutput()
            }
