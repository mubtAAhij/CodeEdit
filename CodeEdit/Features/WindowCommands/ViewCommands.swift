...
struct ViewCommands: Commands {
    ...
    var body: some Commands {
        CommandGroup(after: .toolbar) {
            ...
            Button(String(format: String(localized: "view.toggle-jump-bar", defaultValue: "%@ Jump Bar", comment: "Toggle Jump Bar menu item"), showEditorJumpBar ? String(localized: "view.hide", defaultValue: "Hide", comment: "Hide action") : String(localized: "view.show", defaultValue: "Show", comment: "Show action"))) {
...
extension ViewCommands {
    struct HideCommands: View {
        ...
        var body: some View {
            Button(String(format: String(localized: "view.toggle-navigator", defaultValue: "%@ Navigator", comment: "Toggle Navigator menu item"), navigatorCollapsed ? String(localized: "view.show", defaultValue: "Show", comment: "Show action") : String(localized: "view.hide", defaultValue: "Hide", comment: "Hide action"))) {
                windowController?.toggleFirstPanel()
            }
            .disabled(windowController == nil)
            .keyboardShortcut("0", modifiers: [.command])

            Button(String(format: String(localized: "view.toggle-inspector", defaultValue: "%@ Inspector", comment: "Toggle Inspector menu item"), inspectorCollapsed ? String(localized: "view.show", defaultValue: "Show", comment: "Show action") : String(localized: "view.hide", defaultValue: "Hide", comment: "Hide action"))) {
                windowController?.toggleLastPanel()
            }
            .disabled(windowController == nil)
            .keyboardShortcut("i", modifiers: [.control, .command])

            Button(String(format: String(localized: "view.toggle-utility-area", defaultValue: "%@ Utility Area", comment: "Toggle Utility Area menu item"), utilityAreaCollapsed ? String(localized: "view.show", defaultValue: "Show", comment: "Show action") : String(localized: "view.hide", defaultValue: "Hide", comment: "Hide action"))) {
                CommandManager.shared.executeCommand("open.drawer")
            }
            .disabled(windowController == nil)
            .keyboardShortcut("y", modifiers: [.shift, .command])

            Button(String(format: String(localized: "view.toggle-toolbar", defaultValue: "%@ Toolbar", comment: "Toggle Toolbar menu item"), toolbarCollapsed ? String(localized: "view.hide", defaultValue: "Hide", comment: "Hide action") : String(localized: "view.show", defaultValue: "Show", comment: "Show action"))) {
                windowController?.toggleToolbar()
            }
            .disabled(windowController == nil)
            .keyboardShortcut("t", modifiers: [.option, .command])

            Button(String(format: String(localized: "view.toggle-interface", defaultValue: "%@ Interface", comment: "Toggle Interface menu item"), isInterfaceHidden ? String(localized: "view.show", defaultValue: "Show", comment: "Show action") : String(localized: "view.hide", defaultValue: "Hide", comment: "Hide action"))) {
