...
struct NavigateCommands: Commands {
    ...
    var body: some Commands {
        CommandMenu(String(localized: "menu.navigate", defaultValue: "Navigate", comment: "Navigate menu")) {
            Group {
                Button(String(localized: "menu.navigate.reveal-in-project", defaultValue: "Reveal in Project Navigator", comment: "Menu item to reveal file in project navigator")) {
