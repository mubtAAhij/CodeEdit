...
struct NavigateCommands: Commands {
    ...
    var body: some Commands {
        CommandMenu(String(localized: "window-commands.navigate.title", defaultValue: "Navigate", comment: "Title for the Navigate command menu")) {
            Group {
                ...
                Button(String(localized: "window-commands.navigate.open-in-next-editor", defaultValue: "Open in Next Editor", comment: "Menu item title to open current document in next editor")) {

                }
                .keyboardShortcut(",", modifiers: [.option, .command])
                .disabled(true)

                Button(String(localized: "window-commands.navigate.open-in", defaultValue: "Open in...", comment: "Menu item title to open current document in a selected location")) {
