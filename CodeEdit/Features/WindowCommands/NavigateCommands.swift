    ...
    var body: some Commands {
        CommandMenu(String(localized: "navigate.menu", defaultValue: "Navigate", comment: "Navigate menu title")) {
            ...
            Group {
                ...
                Button(String(localized: "navigate.forward", defaultValue: "Go Forward", comment: "Go forward menu item")) {
                    editor?.goForwardInHistory()
                }
                .disabled(!(editor?.canGoForwardInHistory ?? false))

                Button(String(localized: "navigate.back", defaultValue: "Go Back", comment: "Go back menu item")) {
