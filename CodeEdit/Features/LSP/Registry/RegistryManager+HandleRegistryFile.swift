    ...
    func handleUpdateError(_ error: Error) {
        ...
        if let regError = error as? RegistryManagerError {
            ...
            case .invalidResponse(let statusCode):
                logger.error(String(localized: "registry.error.invalid-response", defaultValue: "Invalid response received: \(statusCode)", comment: "Log message for invalid HTTP response from registry"))
