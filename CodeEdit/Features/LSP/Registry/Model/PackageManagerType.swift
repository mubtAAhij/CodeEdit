...
enum PackageManagerType: String, Codable {
    ...
    var userDescription: String {
        ...
        case .sourceBuild:
            String(localized: "package-manager.build-from-source", defaultValue: "Build From Source", comment: "Display name for building language server from source")
        case .github:
            String(localized: "package-manager.download-from-github", defaultValue: "Download From GitHub", comment: "Display name for downloading language server from GitHub")
        }
    }
}
