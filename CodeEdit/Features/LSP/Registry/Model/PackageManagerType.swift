...
enum PackageManagerType: String, Codable {
    ...
    var userDescription: String {
        ...
        case .sourceBuild:
            String(localized: "package-manager.source-build", defaultValue: "Build From Source", comment: "Build from source installation method")
        case .github:
            String(localized: "package-manager.github-download", defaultValue: "Download From GitHub", comment: "Download from GitHub installation method")
        }
    }
}
