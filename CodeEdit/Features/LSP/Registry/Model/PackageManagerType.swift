...
enum PackageManagerType: String, Codable {
    ...
    var userDescription: String {
        ...
        case .cargo:
            "Cargo"
        case .golang:
            String(localized: "package-manager.go", defaultValue: "Go", comment: "Go package manager name")
        case .pip:
        ...
        case .sourceBuild:
            String(localized: "package-manager.build-from-source", defaultValue: "Build From Source", comment: "Build from source installation method")
        case .github:
            String(localized: "package-manager.download-from-github", defaultValue: "Download From GitHub", comment: "Download from GitHub installation method")
        }
    }
}
