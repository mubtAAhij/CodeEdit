...
enum PackageManagerType: String, Codable {
    ...
    var userDescription: String {
        ...
        case .sourceBuild:
            String(localized: "lsp.package-manager.build-from-source", defaultValue: "Build From Source", comment: "Build from source installation method")
        case .github:
            String(localized: "lsp.package-manager.download-github", defaultValue: "Download From GitHub", comment: "Download from GitHub installation method")
        }
    }
}
