...
enum InstallationMethod: Equatable {
    ...
    var installerDescription: String {
        guard let packageManagerType else { return String(localized: "lsp.registry.installation-method.unknown", defaultValue: "Unknown", comment: "Fallback label for unknown language server installation method") }
        switch packageManagerType {
