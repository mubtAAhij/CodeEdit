...
enum InstallationMethod: Equatable {
    ...
    var installerDescription: String {
        ...
        case .nuget, .opam, .gem, .composer:
            return String(format: String(localized: "lsp.installation.unsupported", defaultValue: "(Unsupported) %@", comment: "Unsupported package manager type"), packageManagerType.userDescription)
        }
    }
