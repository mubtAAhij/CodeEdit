...
enum InstallationMethod: Equatable {
    ...
    var installerDescription: String {
        ...
        case .nuget, .opam, .gem, .composer:
            return String(localized: "unsupported_package_manager", comment: "Label for unsupported package managers").replacingOccurrences(of: "%@", with: packageManagerType.userDescription)
        }
    }
