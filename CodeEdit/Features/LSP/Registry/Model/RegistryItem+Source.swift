                ...
                if let singleValue = try? container.decode(String.self) {
                    ...
                    throw DecodingError.typeMismatch(
                        ...
                        DecodingError.Context(
                            ...
                            debugDescription: String(localized: "lsp.registry.source.invalid-target-format", defaultValue: "Invalid target format", comment: "Error message for malformed target format in registry source")
                        )
                    )
                }
            }
            ...
            init(from decoder: Decoder) throws {
                ...
                if let singleValue = try? container.decode(String.self) {
                    ...
                    throw DecodingError.typeMismatch(
                        ...
                        DecodingError.Context(
                            codingPath: decoder.codingPath,
                            debugDescription: String(localized: "lsp.registry.source.invalid-bin-format", defaultValue: "Invalid bin format", comment: "Error message for malformed binary format in registry source")
                        )
                    )
                }
            }
