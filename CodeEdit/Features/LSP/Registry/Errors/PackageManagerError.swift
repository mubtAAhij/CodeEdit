...
enum PackageManagerError: Error, LocalizedError {
    ...
    var errorDescription: String? {
        switch self {
        case .unknown:
            String(localized: "package_manager.error.unknown", comment: "Generic error message for unknown package manager errors")
        case .packageManagerNotInstalled:
            String(localized: "package_manager.error.not_installed", comment: "Error message when package manager is not installed")
        case .initializationFailed:
            String(localized: "package_manager.error.initialization_failed", comment: "Error message when installation directory initialization fails")
