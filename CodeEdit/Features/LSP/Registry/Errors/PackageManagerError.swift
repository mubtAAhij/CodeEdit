    ...
    var errorDescription: String? {
        ...
        case .unknown:
            String(
                ...
                comment: "Fallback package manager error message for unknown failure"
            )
        case .packageManagerNotInstalled:
            String(
                localized: "lsp.package-manager-error.package-manager-not-installed",
                defaultValue: "The required package manager is not installed.",
                comment: "Package manager error when required package manager executable is missing"
            )
        case .initializationFailed:
            String(
                ...
                comment: "Package manager error when installation directory initialization fails"
            )
        case .installationFailed:
            String(
                localized: "lsp.package-manager-error.package-installation-failed",
                defaultValue: "Package installation failed.",
                comment: "Package manager error when package installation fails"
            )
        case .invalidConfiguration:
            String(
                ...
                comment: "Package manager error when registry installation configuration is invalid"
            )
        }
    }
