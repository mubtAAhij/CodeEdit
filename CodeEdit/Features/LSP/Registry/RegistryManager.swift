    ...
    private func updateActivityViewer(
        ...
        if failed {
            NotificationManager.shared.post(
                ...
                description: String(localized: "registry_manager.error.installation_problem", comment: "Generic error message for installation problems"),
                actionButtonTitle: String(localized: "registry_manager.status.done", comment: "Status message indicating completion"),
                action: {},
            )
        } else {
            TaskNotificationHandler.postTask(
