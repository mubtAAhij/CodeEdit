...
final class PackageManagerProgressModel: ObservableObject {
    ...
    func createDirectoryStructure(for packagePath: URL) throws {
        ...
        if FileManager.default.fileExists(atPath: decodedPath) {
            status(String(localized: "lsp.registry.install-progress.removing-existing-installation", defaultValue: "Removing existing installation.", comment: "Progress message when removing an existing language server installation"))
