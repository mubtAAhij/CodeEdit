...
final class PackageManagerInstallOperation: ObservableObject, Identifiable {
    ...
    private func runNext() async throws {
        ...
        accumulatedOutput.append(OutputItem(isStepDivider: true, contents: String(format: String(localized: "package-manager.install.step-progress", defaultValue: "Step %d: %@", comment: "Package manager installation step progress"), currentStepIdx + 1, task.name)))
