        ...
        case .sourceBuild:
            PackageManagerInstallStep(
                ...
                confirmation: .required(
                    message: String(localized: "package-manager.github.git-permission", defaultValue: "This package requires the use of git to install. Allow CodeEdit to run git commands?", comment: "Confirmation message requesting permission to use git")
                )
            ) { model in
