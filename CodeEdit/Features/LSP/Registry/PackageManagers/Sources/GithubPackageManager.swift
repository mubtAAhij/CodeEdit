...
final class GithubPackageManager: PackageManagerProtocol {
        ...
        case .sourceBuild:
            PackageManagerInstallStep(
                ...
                confirmation: .required(
                    message: String(localized: "package_manager.git_install_confirmation", comment: "Confirmation message for git command permissions")
                )
            ) { model in
    ...
    private func downloadBinary(
        ...
        PackageManagerInstallStep(
            name: String(localized: "package_manager.download_binary_executable", comment: "Step name for downloading binary executable"),
            confirmation: .none
        ) { model in
            do {
    ...
    private func decompressBinary(
        ...
        PackageManagerInstallStep(
            name: String(localized: "package_manager.decompress_binary_executable", comment: "Step name for decompressing binary executable"),
            confirmation: .none,
        ) { model in
            let fileName = url.lastPathComponent
            let downloadPath = installationDirectory.appending(path: source.entryName)
    ...
    private func gitClone(
        ...
        return PackageManagerInstallStep(
            name: String(localized: "package_manager.clone_with_git", comment: "Step name for git clone operation"),
    ...
    private func installFromSource(
        ...
        PackageManagerInstallStep(
            name: String(localized: "package_manager.install_from_source", comment: "Step name for installing from source"),
            ...
            do {
                ...
                throw PackageManagerError.installationFailed(String(localized: "package_manager.source_build_failed", comment: "Error message when source build fails"))
            }
        }
    }
}
