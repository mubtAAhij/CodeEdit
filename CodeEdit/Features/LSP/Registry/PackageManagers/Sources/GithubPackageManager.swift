        ...
        case .sourceBuild:
            PackageManagerInstallStep(
                ...
                confirmation: .required(
                    message: String(localized: "package-manager.github.git-confirmation", defaultValue: "This package requires git to install. Allow CodeEdit to run git commands?", comment: "Confirmation message for git installation requirement")
                )
            ) { model in
    ...
    private func decompressBinary(
        ...
        PackageManagerInstallStep(
            ...
            if packagePath.pathExtension == "tar" || packagePath.pathExtension == ".zip" {
                await model.status(String(format: NSLocalizedString("package-manager.github.decompressing", comment: "Status message while decompressing"), fileName))
