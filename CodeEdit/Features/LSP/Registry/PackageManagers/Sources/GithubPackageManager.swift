        ...
        case .sourceBuild:
            PackageManagerInstallStep(
                ...
                confirmation: .required(
                    message: String(localized: "package-manager.github.git-requires", defaultValue: "This package requires the use of git to install. Allow CodeEdit to run git commands?", comment: "Confirmation message for git requirement")
                )
            ) { model in
