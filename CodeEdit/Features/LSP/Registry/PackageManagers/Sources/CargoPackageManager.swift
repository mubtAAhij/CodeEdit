...
final class CargoPackageManager: PackageManagerProtocol {
    ...
    func runCargoInstall(_ source: PackageSource, in packagePath: URL) -> PackageManagerInstallStep {
        let qualifiedPackageName = String(format: "%@@%@", source.pkgName, source.version)

        return PackageManagerInstallStep(
            name: String(localized: "package-manager.cargo.install", defaultValue: "Install Package Using cargo", comment: "Step name for cargo package installation"),
