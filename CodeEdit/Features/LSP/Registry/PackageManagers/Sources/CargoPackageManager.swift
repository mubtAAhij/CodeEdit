...
final class CargoPackageManager: PackageManagerProtocol {
    ...
    func initialize(in packagePath: URL) -> PackageManagerInstallStep {
        PackageManagerInstallStep(name: String(localized: "lsp.cargo.initialize", defaultValue: "Initialize Directory Structure", comment: "Initialize cargo directory structure"), confirmation: .none) { model in
    ...
    func runCargoInstall(_ source: PackageSource, in packagePath: URL) -> PackageManagerInstallStep {
        ...
        return PackageManagerInstallStep(
            name: String(localized: "lsp.cargo.install-title", defaultValue: "Install Package Using cargo", comment: "Install package using cargo alert title"),
            confirmation: .required(
                message: String(format: String(localized: "lsp.cargo.install-message", defaultValue: "This requires the cargo package %@.\nAllow CodeEdit to install this package?", comment: "Install cargo package confirmation message"), qualifiedPackageName)
            )
        ) { model in
