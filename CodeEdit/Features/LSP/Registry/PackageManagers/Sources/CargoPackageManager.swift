...
final class CargoPackageManager: PackageManagerProtocol {
    ...
    func initialize(in packagePath: URL) -> PackageManagerInstallStep {
        PackageManagerInstallStep(name: String(localized: "lsp.cargo.step.initialize", defaultValue: "Initialize Directory Structure", comment: "Cargo install step name for directory initialization"), confirmation: .none) { model in
    ...
    func runCargoInstall(_ source: PackageSource, in packagePath: URL) -> PackageManagerInstallStep {
        ...
        return PackageManagerInstallStep(
            name: String(localized: "lsp.cargo.step.install", defaultValue: "Install Package Using cargo", comment: "Cargo install step name"),
            confirmation: .required(
                message: String(localized: "lsp.cargo.confirmation", defaultValue: "This requires the cargo package \(qualifiedPackageName).\nAllow CodeEdit to install this package?", comment: "Confirmation message for cargo package installation")
            )
        ) { model in
