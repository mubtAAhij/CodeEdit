...
final class PipPackageManager: PackageManagerProtocol {
    ...
    func runPipInstall(_ source: PackageSource, in packagePath: URL) -> PackageManagerInstallStep {
        ...
        return PackageManagerInstallStep(
            ...
            confirmation: .required(
                message: "String(localized: "pip_package_install_message", comment: "Message about installing pip package")"
                + "String(localized: "allow_pip_package_install_question", comment: "Question asking for permission to install pip package")"
            )
        ) { model in
    ...
    private func updateRequirements(in packagePath: URL) -> PackageManagerInstallStep {
        ...
        return PackageManagerInstallStep(
            ...
            await model.status("String(localized: "writing_requirements_to_file", comment: "Status message when writing package requirements to requirements.txt file")")
