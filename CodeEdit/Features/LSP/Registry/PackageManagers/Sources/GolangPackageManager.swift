...
final class GolangPackageManager: PackageManagerProtocol {
    ...
    func isInstalled(method installationMethod: InstallationMethod) -> PackageManagerInstallStep {
        PackageManagerInstallStep(
            name: "",
            confirmation: .required(message: "String(localized: "package_requires_go_permission", comment: "Message asking for permission to run go commands")")
        ) { model in
    ...
    func runGoInstall(_ source: PackageSource, packagePath: URL) -> PackageManagerInstallStep {
        ...
        return PackageManagerInstallStep(
            name: "String(localized: "install_package_using_go", comment: "Installation step name for installing Go package")",
            confirmation: .required(
                message: "String(localized: "requires_go_package_install", comment: "Message describing go package installation requirement").replacingOccurrences(of: "%@", with: installCommand)"
    ...
    func buildBinary(_ source: PackageSource, packagePath: URL) -> PackageManagerInstallStep {
        PackageManagerInstallStep(
            name: "String(localized: "build_from_source", comment: "Installation step name for building binary from source")",
            confirmation: .none
        ) { model in
