...
final class GolangPackageManager: PackageManagerProtocol {
    ...
    func isInstalled(method installationMethod: InstallationMethod) -> PackageManagerInstallStep {
        PackageManagerInstallStep(
            name: "",
            confirmation: .required(message: String(localized: "package_manager.go_install_confirmation", comment: "Confirmation message for go command permissions"))
        ) { model in
    ...
    func runGoInstall(_ source: PackageSource, packagePath: URL) -> PackageManagerInstallStep {
        ...
        return PackageManagerInstallStep(
            name: String(localized: "golang_package_manager.install_package_using_go", comment: "Step name for installing Go package"),
            confirmation: .required(
                message: String(localized: "golang_package_manager.install_confirmation", arguments: [installCommand], comment: "Confirmation message for Go package installation")
            )
        ) { model in
    ...
    func buildBinary(_ source: PackageSource, packagePath: URL) -> PackageManagerInstallStep {
        PackageManagerInstallStep(
            name: String(localized: "golang_package_manager.build_from_source", comment: "Step name for building from source"),
            confirmation: .none
        ) { model in
