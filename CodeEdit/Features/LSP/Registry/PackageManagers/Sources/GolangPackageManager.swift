...
final class GolangPackageManager: PackageManagerProtocol {
    ...
    func isInstalled(method installationMethod: InstallationMethod) -> PackageManagerInstallStep {
        PackageManagerInstallStep(
            name: "",
            confirmation: .required(message: "String(localized: "go_permission_message", comment: "Message asking for permission to run go commands")")
        ) { model in
    ...
    func runGoInstall(_ source: PackageSource, packagePath: URL) -> PackageManagerInstallStep {
        ...
        return PackageManagerInstallStep(
            ...
            confirmation: .required(
                message: "String(localized: "go_package_install_message", comment: "Message about installing go package")"
                + "String(localized: "allow_package_install_question", comment: "Question asking for permission to install package")"
            )
        ) { model in
