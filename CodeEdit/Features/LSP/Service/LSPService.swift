...
extension LSPService {
    private func notifyToInstallLanguageServer(language lspLanguage: LanguageIdentifier) {
        ...
        let notificationTitle = String(format: NSLocalizedString("lsp.install.title", comment: "Notification title for installing language server"), lspLanguageTitle)
        ...
        NotificationManager.shared.post(
            ...
            description: String(format: NSLocalizedString("lsp.install.description", comment: "Notification description for installing language server"), lspLanguageTitle),
