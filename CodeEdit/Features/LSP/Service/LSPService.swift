...
extension LSPService {
    private func notifyToInstallLanguageServer(language lspLanguage: LanguageIdentifier) {
        ...
        let notificationTitle = String(localized: "Install \(lspLanguageTitle) Language Server", comment: "Notification title prompting user to install a language server")
        ...
        NotificationManager.shared.post(
            ...
            description: String(localized: "Install the \(lspLanguageTitle) language server to enable code intelligence features.", comment: "Notification description explaining language server benefits"),
            actionButtonTitle: String(localized: "Install", comment: "Action button to install language server")
        ) { [weak self] in
            // TODO: Warning:
