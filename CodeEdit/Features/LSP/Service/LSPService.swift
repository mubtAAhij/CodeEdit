...
extension LSPService {
    private func notifyToInstallLanguageServer(language lspLanguage: LanguageIdentifier) {
        ...
        let notificationTitle = String(localized: "lsp.install_server \(lspLanguageTitle)", comment: "Notification title")
        ...
        NotificationManager.shared.post(
            ...
            description: String(localized: "lsp.install_description \(lspLanguageTitle)", comment: "Notification description"),
            actionButtonTitle: String(localized: "lsp.install_action", comment: "Button title")
        ) { [weak self] in
            // TODO: Warning:
