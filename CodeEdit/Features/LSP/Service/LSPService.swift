...
extension LSPService {
    private func notifyToInstallLanguageServer(language lspLanguage: LanguageIdentifier) {
        ...
        let notificationTitle = String(localized: "lsp.installLanguageServer", comment: "Notification title", arguments: lspLanguageTitle)
        ...
        NotificationManager.shared.post(
            ...
            description: String(localized: "lsp.installDescription", comment: "Notification description", arguments: lspLanguageTitle),
            actionButtonTitle: String(localized: "lsp.install", comment: "Button text")
        ) { [weak self] in
            // TODO: Warning:
