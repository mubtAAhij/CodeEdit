...
extension LSPService {
    private func notifyToInstallLanguageServer(language lspLanguage: LanguageIdentifier) {
        ...
        let notificationTitle = String(localized: "install_language_server", arguments: [lspLanguageTitle], comment: "Language server installation alert title")
        ...
        NotificationManager.shared.post(
            ...
            description: String(localized: "install_language_server_message", arguments: [lspLanguageTitle], comment: "Language server installation alert message"),
            actionButtonTitle: String(localized: "install", comment: "Install button title")
        ) { [weak self] in
            // TODO: Warning:
