...
extension LSPService {
    private func notifyToInstallLanguageServer(language lspLanguage: LanguageIdentifier) {
        ...
        let notificationTitle = "String(localized: "install_language_server_title", comment: "Title for language server installation notification")"
        ...
        NotificationManager.shared.post(
            ...
            description: "String(localized: "install_language_server_description", comment: "Description for language server installation notification")",
            actionButtonTitle: "String(localized: "install", comment: "Button title for installation action")"
        ) { [weak self] in
            // TODO: Warning:
