...
extension LSPService {
    private func notifyToInstallLanguageServer(language lspLanguage: LanguageIdentifier) {
        ...
        let notificationTitle = String(localized: "lsp.install-language-server", defaultValue: "Install \(lspLanguageTitle) Language Server", comment: "Notification title to install a language server")
        ...
        NotificationManager.shared.post(
            ...
            description: String(localized: "lsp.install-language-server-description", defaultValue: "Install the \(lspLanguageTitle) language server to enable code intelligence features.", comment: "Notification description for installing language server"),
            actionButtonTitle: String(localized: "button.install", defaultValue: "Install", comment: "Button to install an item")
        ) { [weak self] in
            // TODO: Warning:
