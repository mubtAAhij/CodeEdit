...
extension LSPService {
    private func notifyToInstallLanguageServer(language lspLanguage: LanguageIdentifier) {
        ...
        let notificationTitle = String(localized: "lsp.notification.install-title", defaultValue: "Install \(lspLanguageTitle) Language Server", comment: "Notification title prompting to install a language server")
        ...
        NotificationManager.shared.post(
            ...
            description: String(localized: "lsp.notification.install-description", defaultValue: "Install the \(lspLanguageTitle) language server to enable code intelligence features.", comment: "Notification description explaining language server installation"),
            actionButtonTitle: String(localized: "lsp.notification.install-button", defaultValue: "Install", comment: "Button to install language server")
        ) { [weak self] in
            // TODO: Warning:
