...
extension LSPService {
    private func notifyToInstallLanguageServer(language lspLanguage: LanguageIdentifier) {
        ...
        let notificationTitle = String(localized: "install_language_server_title", comment: "Title for language server installation notification").replacingOccurrences(of: "{lspLanguageTitle}", with: "\(lspLanguageTitle)")
        ...
        NotificationManager.shared.post(
            ...
            description: String(localized: "install_language_server_description", comment: "Description for language server installation notification").replacingOccurrences(of: "{lspLanguageTitle}", with: "\(lspLanguageTitle)"),
            actionButtonTitle: String(localized: "install", comment: "Button title for installing language server")
        ) { [weak self] in
            // TODO: Warning:
