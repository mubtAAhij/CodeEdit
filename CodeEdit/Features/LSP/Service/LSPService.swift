...
extension LSPService {
    private func notifyToInstallLanguageServer(language lspLanguage: LanguageIdentifier) {
        ...
        let notificationTitle = String(localized: "lsp.install-server", defaultValue: "Install \(lspLanguageTitle) Language Server", comment: "Notification title prompting to install a language server")
        ...
        NotificationManager.shared.post(
            ...
            description: String(localized: "lsp.install-server-description", defaultValue: "Install the \(lspLanguageTitle) language server to enable code intelligence features.", comment: "Notification description explaining language server installation"),
            actionButtonTitle: String(localized: "button.install", defaultValue: "Install", comment: "Install button for language server notification")
        ) { [weak self] in
            // TODO: Warning:
