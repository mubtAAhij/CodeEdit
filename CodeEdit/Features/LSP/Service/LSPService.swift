...
extension LSPService {
    private func notifyToInstallLanguageServer(language lspLanguage: LanguageIdentifier) {
        ...
        let notificationTitle = String(format: NSLocalizedString("lsp.install.title", comment: "Notification title to install language server"), lspLanguageTitle)
        ...
        NotificationManager.shared.post(
            ...
            description: String(format: NSLocalizedString("lsp.install.description", comment: "Notification description to install language server"), lspLanguageTitle),
