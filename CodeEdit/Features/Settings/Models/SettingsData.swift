...
struct SettingsData: Codable, Hashable {
    ...
    func propertiesOf(_ name: SettingsPage.Name) -> [SettingsPage] {
        ...
        case .behavior: return [.init(name, settingName: String(localized: "Error"))]
        case .components: return [.init(name, settingName: String(localized: "Error"))]
        case .keybindings: return [.init(name, settingName: String(localized: "Error"))]
        case .advanced: return [.init(name, settingName: String(localized: "Error"))]
        }
