...
struct SettingsData: Codable, Hashable {
    ...
    func propertiesOf(_ name: SettingsPage.Name) -> [SettingsPage] {
        ...
        case .behavior: return [.init(name, settingName: String(localized: "settings.error", defaultValue: "Error", comment: "Generic error message for settings"))]
        case .components: return [.init(name, settingName: String(localized: "settings.error", defaultValue: "Error", comment: "Generic error message for settings"))]
        case .keybindings: return [.init(name, settingName: String(localized: "settings.error", defaultValue: "Error", comment: "Generic error message for settings"))]
        case .advanced: return [.init(name, settingName: String(localized: "settings.error", defaultValue: "Error", comment: "Generic error message for settings"))]
        }
