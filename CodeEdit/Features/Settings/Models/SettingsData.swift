...
struct SettingsData: Codable, Hashable {
    ...
    func propertiesOf(_ name: SettingsPage.Name) -> [SettingsPage] {
        ...
        case .behavior: return [.init(name, settingName: String(localized: "settings.error", defaultValue: "Error", comment: "Settings error placeholder"))]
        case .components: return [.init(name, settingName: String(localized: "settings.error", defaultValue: "Error", comment: "Settings error placeholder"))]
        case .keybindings: return [.init(name, settingName: String(localized: "settings.error", defaultValue: "Error", comment: "Settings error placeholder"))]
        case .advanced: return [.init(name, settingName: String(localized: "settings.error", defaultValue: "Error", comment: "Settings error placeholder"))]
        }
