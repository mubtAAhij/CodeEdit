...
struct SettingsData: Codable, Hashable {
    ...
    func propertiesOf(_ name: SettingsPage.Name) -> [SettingsPage] {
        ...
        case .components: return [.init(name, settingName: String(localized: "settings.error", comment: "Error message for settings"))]
        case .keybindings: return [.init(name, settingName: String(localized: "settings.error.components", comment: "Error placeholder for components settings"))]
        case .advanced: return [.init(name, settingName: String(localized: "settings.error", comment: "Error message for settings"))]
        }
