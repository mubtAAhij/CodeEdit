...
struct SettingsData: Codable, Hashable {
    ...
    func propertiesOf(_ name: SettingsPage.Name) -> [SettingsPage] {
        ...
        case .behavior: return [.init(name, settingName: String(localized: "settings.error.not-implemented", defaultValue: "Error", comment: "Error message for unimplemented settings page"))]
        case .components: return [.init(name, settingName: String(localized: "settings.error.not-implemented", defaultValue: "Error", comment: "Error message for unimplemented settings page"))]
        case .keybindings: return [.init(name, settingName: String(localized: "settings.error.not-implemented", defaultValue: "Error", comment: "Error message for unimplemented settings page"))]
        case .advanced: return [.init(name, settingName: String(localized: "settings.error.not-implemented", defaultValue: "Error", comment: "Error message for unimplemented settings page"))]
        }
