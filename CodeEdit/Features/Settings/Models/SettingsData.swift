...
struct SettingsData: Codable, Hashable {
    ...
    func propertiesOf(_ name: SettingsPage.Name) -> [SettingsPage] {
        ...
        case .behavior: return [.init(name, settingName: "String(localized: "error", comment: "Generic error message")")]
        case .components: return [.init(name, settingName: "String(localized: "error", comment: "Generic error message")")]
        case .keybindings: return [.init(name, settingName: "String(localized: "error", comment: "Generic error message")")]
