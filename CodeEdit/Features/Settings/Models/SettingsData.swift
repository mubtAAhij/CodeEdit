...
struct SettingsData: Codable, Hashable {
    ...
    func propertiesOf(_ name: SettingsPage.Name) -> [SettingsPage] {
        ...
        case .behavior: return [.init(name, settingName: String(localized: "error", comment: "Error placeholder for behavior settings"))]
        case .components: return [.init(name, settingName: String(localized: "error", comment: "Error placeholder for components settings"))]
        case .keybindings: return [.init(name, settingName: String(localized: "error", comment: "Error placeholder for keybindings settings"))]
        case .advanced: return [.init(name, settingName: String(localized: "error", comment: "Error message"))]
        }
