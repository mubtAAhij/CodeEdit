...
struct SettingsData: Codable, Hashable {
    ...
    func propertiesOf(_ name: SettingsPage.Name) -> [SettingsPage] {
        ...
        case .behavior: return [.init(name, settingName: String(localized: "Error", comment: "Error message"))]
        case .components: return [.init(name, settingName: String(localized: "Error", comment: "Error message"))]
        case .keybindings: return [.init(name, settingName: String(localized: "Error", comment: "Error message"))]
