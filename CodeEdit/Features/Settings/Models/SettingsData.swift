...
struct SettingsData: Codable, Hashable {
    ...
    func propertiesOf(_ name: SettingsPage.Name) -> [SettingsPage] {
        ...
        case .behavior: return [.init(name, settingName: String(localized: "error", defaultValue: "Error", comment: "Error label"))]
        case .components: return [.init(name, settingName: String(localized: "error", defaultValue: "Error", comment: "Error label"))]
        case .keybindings: return [.init(name, settingName: String(localized: "error", defaultValue: "Error", comment: "Error label"))]
        case .advanced: return [.init(name, settingName: String(localized: "error", defaultValue: "Error", comment: "Error label"))]
        }
