...
struct SettingsData: Codable, Hashable {
    ...
    func propertiesOf(_ name: SettingsPage.Name) -> [SettingsPage] {
        ...
        case .behavior: return [.init(name, settingName: String(localized: "settings.error.behavior", comment: "Error placeholder for behavior settings"))]
        case .components: return [.init(name, settingName: String(localized: "settings.error.behavior", comment: "Error placeholder for behavior settings"))]
        case .keybindings: return [.init(name, settingName: String(localized: "settings.error.behavior", comment: "Error placeholder for behavior settings"))]
        case .advanced: return [.init(name, settingName: String(localized: "settings.error.behavior", comment: "Error placeholder for behavior settings"))]
        }
