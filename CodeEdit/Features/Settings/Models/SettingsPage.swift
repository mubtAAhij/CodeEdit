...
struct SettingsPage: Hashable, Equatable, Identifiable {
    ...
    enum Name: String {
        ...
        case search = String(localized: "settings_page_search", comment: "Search settings page title")
        case keybindings = "Key Bindings"
        case sourceControl = String(localized: "settings_page_source_control", comment: "Source Control settings page title")
        case components = "Components"
        case location = "Locations"
        case advanced = String(localized: "settings_page_advanced", comment: "Advanced settings page title")
        case languageServers = "Language Servers"
        case developer = String(localized: "settings_page_developer", comment: "Developer settings page title")
    }
