...
struct SettingsPage: Hashable, Equatable, Identifiable {
    ...
    enum Name: String {
        ...
        var displayName: String {
            ...
            case .textEditing:
                return String(localized: "settings.page.text_editing", defaultValue: "Text Editing", comment: "Text Editing settings page name")
            case .terminal:
            ...
            case .keybindings:
                return String(localized: "settings.page.key_bindings", defaultValue: "Key Bindings", comment: "Key Bindings settings page name")
            case .sourceControl:
                return String(localized: "settings.page.source_control", defaultValue: "Source Control", comment: "Source Control settings page name")
            case .components:
            ...
            case .languageServers:
                return String(localized: "settings.page.language_servers", defaultValue: "Language Servers", comment: "Language Servers settings page name")
            case .developer:
