...
struct InvisibleCharacterWarningList: View {
    ...
    var body: some View {
        KeyValueTable(
            ...
            keyColumnName: String(localized: "unicode_character_code", comment: "Column header for character codes"),
            valueColumnName: String(localized: "notes", comment: "Column header for character notes"),
            newItemInstruction: String(localized: "add_character_hexadecimal_unicode", comment: "Instruction to add a character as hexadecimal Unicode value"),
            actionBarTrailing: {
                Button {
                    ...
                    Text(String(localized: "restore_defaults", comment: "Button to restore default settings"))
                }
        ...
        .overlay {
            if items.isEmpty {
                Text(String(localized: "no_warning_characters", comment: "Message when no warning characters are configured"))
