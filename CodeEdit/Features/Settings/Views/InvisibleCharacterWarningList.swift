...
struct InvisibleCharacterWarningList: View {
    ...
    var body: some View {
        KeyValueTable(
            ...
            keyColumnName: String(localized: "settings.invisible-chars.unicode-code", defaultValue: "Unicode Character Code", comment: "Unicode character code column"),
            valueColumnName: String(localized: "settings.invisible-chars.notes", defaultValue: "Notes", comment: "Notes column"),
        ...
        .overlay {
            if items.isEmpty {
                Text(String(localized: "settings.invisible-chars.no-warnings", defaultValue: "No warning characters", comment: "No warning characters message"))
