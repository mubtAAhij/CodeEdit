    ...
    var body: some View {
        KeyValueTable(
            ...
            keyColumnName: String(
                localized: "settings.invisible-character-warning-list.unicode-character-code",
                defaultValue: "Unicode Character Code",
                comment: "Column header for Unicode character code in warning characters list"
            ),
            valueColumnName: String(
                localized: "settings.invisible-character-warning-list.notes",
                defaultValue: "Notes",
                comment: "Column header for notes in warning characters list"
            ),
            newItemInstruction: String(
                localized: "settings.invisible-character-warning-list.add-character-hexadecimal-unicode",
                defaultValue: "Add A Character As A Hexidecimal Unicode Value",
                comment: "Helper text describing how to add a character by hexadecimal Unicode value"
            ),
            actionBarTrailing: {
                Button {
                    ...
                    Text(String(
                        localized: "settings.invisible-character-warning-list.restore-defaults",
                        defaultValue: "Restore Defaults",
                        comment: "Button title to restore default warning characters"
                    ))
                }
        ...
        .overlay {
            if items.isEmpty {
                Text(String(
                    localized: "settings.invisible-character-warning-list.no-warning-characters",
                    defaultValue: "No warning characters",
                    comment: "Empty state text when no warning characters are configured"
                ))
