    ...
    var body: some View {
        KeyValueTable(
            ...
            keyColumnName: String(
                ...
                comment: "Column header for unicode character code"
            ),
            valueColumnName: String(
                localized: "settings.invisible-character-warning-list.notes",
                defaultValue: "Notes",
                comment: "Column header for warning character notes"
            ),
            newItemInstruction: String(
                localized: "settings.invisible-character-warning-list.add-character-as-hexidecimal-unicode-value",
                defaultValue: "Add A Character As A Hexidecimal Unicode Value",
                comment: "Button title to add warning character by hexadecimal unicode value"
            ),
            actionBarTrailing: {
                Button {
                    ...
                    Text(String(
                        ...
                        comment: "Action to restore default invisible warning characters"
                    ))
                }
