...
struct InvisibleCharacterWarningList: View {
    ...
    var body: some View {
        KeyValueTable(
            ...
            keyColumnName: String(localized: "settings.warning-characters.unicode-code", defaultValue: "Unicode Character Code", comment: "Column header for unicode character code"),
            valueColumnName: String(localized: "settings.warning-characters.notes", defaultValue: "Notes", comment: "Column header for notes"),
            newItemInstruction: String(localized: "settings.warning-characters.add-prompt", defaultValue: "Add A Character As A Hexidecimal Unicode Value", comment: "Placeholder text for adding unicode character"),
            actionBarTrailing: {
                Button {
