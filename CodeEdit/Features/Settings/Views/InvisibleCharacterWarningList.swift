...
struct InvisibleCharacterWarningList: View {
    ...
    var body: some View {
        KeyValueTable(
            ...
            keyColumnName: String(localized: "settings.warning-characters.unicode-code", defaultValue: "Unicode Character Code", comment: "Unicode character code column"),
            valueColumnName: String(localized: "settings.warning-characters.notes", defaultValue: "Notes", comment: "Notes column"),
            newItemInstruction: String(localized: "settings.warning-characters.add-instruction", defaultValue: "Add A Character As A Hexidecimal Unicode Value", comment: "Add character instruction"),
            actionBarTrailing: {
                Button {
        ...
        .overlay {
            if items.isEmpty {
                Text(String(localized: "settings.warning-characters.no-characters", defaultValue: "No warning characters", comment: "No warning characters message"))
