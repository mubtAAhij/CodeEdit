...
struct InvisibleCharacterWarningList: View {
    ...
    var body: some View {
        KeyValueTable(
            ...
            keyColumnName: String(localized: "settings.warning-characters.unicode-code", defaultValue: "Unicode Character Code", comment: "Unicode character code column header"),
            valueColumnName: String(localized: "settings.warning-characters.notes", defaultValue: "Notes", comment: "Notes column header"),
            newItemInstruction: String(localized: "settings.warning-characters.add-hex", defaultValue: "Add A Character As A Hexidecimal Unicode Value", comment: "Add character as hex tooltip"),
            actionBarTrailing: {
                Button {
        ...
        .overlay {
            if items.isEmpty {
                Text(String(localized: "settings.warning-characters.empty", defaultValue: "No warning characters", comment: "No warning characters message"))
