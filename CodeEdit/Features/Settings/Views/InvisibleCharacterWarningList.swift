...
struct InvisibleCharacterWarningList: View {
    ...
    var body: some View {
        KeyValueTable(
            ...
            keyColumnName: String(localized: "settings.invisible-chars.column.unicode", defaultValue: "Unicode Character Code", comment: "Unicode character code column name"),
            valueColumnName: String(localized: "settings.invisible-chars.column.notes", defaultValue: "Notes", comment: "Notes column name"),
            newItemInstruction: String(localized: "settings.invisible-chars.add-instruction", defaultValue: "Add A Character As A Hexidecimal Unicode Value", comment: "Instruction for adding a character"),
            actionBarTrailing: {
                Button {
        ...
        .overlay {
            if items.isEmpty {
                Text(String(localized: "settings.invisible-chars.no-characters", defaultValue: "No warning characters", comment: "No warning characters message"))
