    ...
    var body: some View {
        KeyValueTable(
            ...
            keyColumnName: String(
                localized: "settings.invisible-character-warning.unicode-character-code",
                defaultValue: "Unicode Character Code",
                comment: "Column header for unicode character code"
            ),
            valueColumnName: String(
                localized: "settings.invisible-character-warning.notes",
                defaultValue: "Notes",
                comment: "Column header for warning character notes"
            ),
            newItemInstruction: String(
                localized: "settings.invisible-character-warning.add-character-hex-unicode-value",
                defaultValue: "Add A Character As A Hexidecimal Unicode Value",
                comment: "Prompt text for adding a warning character by hexadecimal unicode value"
            ),
            actionBarTrailing: {
                Button {
                    ...
                    Text(String(
                        localized: "settings.invisible-character-warning.restore-defaults",
        ...
        .overlay {
            if items.isEmpty {
                Text(String(
                    localized: "settings.invisible-character-warning.no-warning-characters",
