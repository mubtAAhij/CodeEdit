...
struct InvisibleCharacterWarningList: View {
    ...
    var body: some View {
        KeyValueTable(
            ...
            keyColumnName: String(localized: "settings.unicode-character-code", defaultValue: "Unicode Character Code", comment: "Unicode character code column"),
            valueColumnName: String(localized: "settings.notes", defaultValue: "Notes", comment: "Notes column"),
            newItemInstruction: String(localized: "settings.add-character-hex", defaultValue: "Add A Character As A Hexidecimal Unicode Value", comment: "Add character instruction"),
            actionBarTrailing: {
                Button {
