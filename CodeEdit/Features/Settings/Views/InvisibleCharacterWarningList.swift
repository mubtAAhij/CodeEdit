...
struct InvisibleCharacterWarningList: View {
    ...
    var body: some View {
        KeyValueTable(
            ...
            keyColumnName: String(localized: "settings.warning-characters.column.code", defaultValue: "Unicode Character Code", comment: "Unicode character code column header"),
        ...
        .overlay {
            if items.isEmpty {
                Text(String(localized: "settings.warning-characters.empty", defaultValue: "No warning characters", comment: "Empty state when no warning characters are configured"))
