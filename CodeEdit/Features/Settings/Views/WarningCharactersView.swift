        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    ...
                    Text(String(localized: "warning_characters_description", comment: "Description of warning characters feature"))
                }
            }
            .formStyle(.grouped)
            Divider()
            HStack {
                ...
                Button {
                    ...
                    Text(String(localized: "done_button", comment: "Done button"))
                        .frame(minWidth: 56)
                }
