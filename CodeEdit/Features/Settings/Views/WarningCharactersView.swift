        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    ...
                    Text(String(localized: "settings.text-editing.warning-characters.title", defaultValue: "Warning Characters", comment: "Warning Characters section title"))
                    Text(String(localized: "settings.text-editing.warning-characters.description", defaultValue: "CodeEdit can help identify invisible or ambiguous characters, such as zero-width spaces, directional quotes, and more. These will appear with a red block highlighting them. You can disable characters or add more here.", comment: "Warning Characters section description"))
                }
            }
            .formStyle(.grouped)
            Divider()
            HStack {
                ...
                Button {
                    ...
                    Text(String(localized: "settings.text-editing.warning-characters.done", defaultValue: "Done", comment: "Done button in warning characters view"))
                        .frame(minWidth: 56)
                }
