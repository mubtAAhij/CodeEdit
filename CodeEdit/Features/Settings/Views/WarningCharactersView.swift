        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    ...
                    Text(String(
                        ...
                        comment: "Description of warning characters feature in settings"
                    ))
                }
            }
            .formStyle(.grouped)
            ...
            HStack {
                ...
                Button {
                    ...
                    Text(String(localized: "settings.warning-characters.done", defaultValue: "Done", comment: "Done button in warning characters settings"))
                        .frame(minWidth: 56)
                }
