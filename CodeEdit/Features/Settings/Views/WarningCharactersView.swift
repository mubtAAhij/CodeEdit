        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    ...
                    Text(String(
                        localized: "settings.warning-characters.title",
                        defaultValue: "Warning Characters",
                        comment: "Title for warning characters settings panel"
                    ))
                    Text(
                        String(
                            ...
                            comment: "Description explaining warning characters detection and customization"
                        )
                    )
                }
            }
            ...
            HStack {
                ...
                Button {
                    ...
                    Text(String(
                        localized: "settings.warning-characters.done",
                        defaultValue: "Done",
                        comment: "Button title to close warning characters editor"
                    ))
                        .frame(minWidth: 56)
                }
