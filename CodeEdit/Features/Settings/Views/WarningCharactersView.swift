        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    ...
                    Text(
                        String(localized: "CodeEdit can help identify invisible or ambiguous characters, such as zero-width spaces, directional quotes, and more. These will appear with a red block highlighting them. You can disable characters or add more here.", comment: "Warning characters description")
                    )
                }
            }
            .formStyle(.grouped)
