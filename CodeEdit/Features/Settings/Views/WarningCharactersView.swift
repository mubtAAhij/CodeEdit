        ...
        VStack(spacing: 0) {
            ...
            HStack {
                ...
                Button {
                    ...
                    Text(String(localized: "button.done", defaultValue: "Done", comment: "Done button for closing warning characters settings"))
                        .frame(minWidth: 56)
                }
