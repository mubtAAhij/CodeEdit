        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    ...
                    Text(String(localized: "settings.warning-characters.title", defaultValue: "Warning Characters", comment: "Title for warning characters settings panel"))
                    Text(
                        String(localized: "settings.warning-characters.description", defaultValue: "CodeEdit can help identify invisible or ambiguous characters, such as zero-width spaces, directional quotes, and more. These will appear with a red block highlighting them. You can disable characters or add more here.", comment: "Description explaining warning characters detection and customization")
                    )
                }
            }
            .formStyle(.grouped)
            ...
            HStack {
                ...
                Button {
                    ...
                    Text(String(localized: "settings.warning-characters.done", defaultValue: "Done", comment: "Button title to close warning characters editor"))
                        .frame(minWidth: 56)
                }
