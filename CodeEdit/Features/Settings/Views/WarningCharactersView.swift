        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    ...
                    Text(String(localized: "settings.warning_characters.title", defaultValue: "Warning Characters", comment: "Warning characters settings section title"))
                    Text(String(
                        localized: "settings.warning_characters.description",
                        ...
                        comment: "Description of warning characters feature"
                    ))
                }
            }
            .formStyle(.grouped)
