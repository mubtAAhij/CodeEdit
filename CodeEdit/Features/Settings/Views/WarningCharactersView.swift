        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    ...
                    Text(String(localized: "settings.warning-characters", defaultValue: "Warning Characters", comment: "Warning characters settings title"))
            ...
            HStack {
                ...
                Button {
                    ...
                    Text(String(localized: "settings.done", defaultValue: "Done", comment: "Done button"))
                        .frame(minWidth: 56)
                }
