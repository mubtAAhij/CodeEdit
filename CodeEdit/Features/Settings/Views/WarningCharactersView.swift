        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    ...
                    Text(String(localized: "settings.warning-characters.title", defaultValue: "Warning Characters", comment: "Warning characters settings title"))
            ...
            HStack {
                ...
                Button {
                    ...
                    Text(String(localized: "settings.warning-characters.done", defaultValue: "Done", comment: "Done button for warning characters settings"))
                        .frame(minWidth: 56)
                }
