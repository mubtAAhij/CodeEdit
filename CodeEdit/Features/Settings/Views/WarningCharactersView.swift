        ...
        VStack(spacing: 0) {
            ...
            HStack {
                ...
                Button {
                    ...
                    Text(String(localized: "settings.warning-characters.done", defaultValue: "Done", comment: "Button to dismiss warning characters settings sheet"))
                        .frame(minWidth: 56)
                }
