...
struct MonospacedFontPicker: View {
    ...
    var body: some View {
        Picker(selection: $selectedFontName, label: Text(title)) {
            Text(String(localized: "settings.font.system-font", defaultValue: "System Font", comment: "System font option in font picker"))
            ...
            if !otherFontFamilyNames.isEmpty {
                ...
                Menu {
                    ...
                    Text(String(localized: "settings.font.other-fonts", defaultValue: "Other fonts...", comment: "Menu item to show other non-monospaced fonts"))
                }
            }
        }
