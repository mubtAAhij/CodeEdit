...
struct MonospacedFontPicker: View {
    ...
    var body: some View {
        Picker(selection: $selectedFontName, label: Text(title)) {
            Text(String(localized: "font-picker.system-font", defaultValue: "System Font", comment: "System font option in font picker"))
            ...
            if !otherFontFamilyNames.isEmpty {
                ...
                Menu {
                    ...
                    Text(String(localized: "font-picker.other-fonts", defaultValue: "Other fonts...", comment: "Other fonts menu option"))
                }
            }
        }
