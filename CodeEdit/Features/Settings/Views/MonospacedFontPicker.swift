...
struct MonospacedFontPicker: View {
    ...
    var body: some View {
        Picker(selection: $selectedFontName, label: Text(title)) {
            Text(String(localized: "settings.font.system_font", comment: "Label for system font option in font picker"))
            ...
            if !otherFontFamilyNames.isEmpty {
                ...
                Menu {
                    ...
                    Text(String(localized: "settings.font.other_fonts", comment: "Label for other fonts option in font picker"))
                }
            }
        }
