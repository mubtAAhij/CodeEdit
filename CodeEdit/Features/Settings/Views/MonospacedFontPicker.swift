...
struct MonospacedFontPicker: View {
    ...
    var body: some View {
        Picker(selection: $selectedFontName, label: Text(title)) {
            Text(String(localized: "settings.system-font", defaultValue: "System Font", comment: "System font option"))
            ...
            if !otherFontFamilyNames.isEmpty {
                ...
                Menu {
                    ...
                    Text(String(localized: "settings.other-fonts", defaultValue: "Other fonts...", comment: "Button to show font picker"))
                }
            }
        }
