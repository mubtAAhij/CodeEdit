...
struct MonospacedFontPicker: View {
    ...
    var body: some View {
        Picker(selection: $selectedFontName, label: Text(title)) {
            Text(String(
                localized: "settings.monospaced-font-picker.system-font",
                defaultValue: "System Font",
                comment: "Option title for selecting the system monospaced font"
            ))
            ...
            if !otherFontFamilyNames.isEmpty {
                ...
                Menu {
                    ...
                    Text(String(
                        localized: "settings.monospaced-font-picker.other-fonts",
                        defaultValue: "Other fonts...",
                        comment: "Button title to open additional monospaced fonts"
                    ))
                }
            }
        }
