...
struct FontWeightPicker: View {
    ...
    var weightNames: [NSFont.Weight: String] = [
        .ultraLight: String(localized: "font.weight.ultra_light", defaultValue: "Ultra Light", comment: "Ultra light font weight"),
        ...
        .semibold: String(localized: "font.weight.semi_bold", defaultValue: "Semi Bold", comment: "Semi bold font weight"),
    ...
    var body: some View {
        Picker(label ?? String(localized: "font.weight.picker_label", defaultValue: "Font Weight", comment: "Font weight picker label"), selection: $selection) {
