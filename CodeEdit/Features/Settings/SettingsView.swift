    ...
    var body: some View {
        NavigationSplitView {
            ...
            Group {
                ...
                default:
                    Text(String(localized: "settings.implementation-needed", defaultValue: "Implementation Needed", comment: "Implementation needed placeholder")).frame(alignment: .center)
                }
            }
