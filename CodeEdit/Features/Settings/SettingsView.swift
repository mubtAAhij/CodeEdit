    ...
    var body: some View {
        NavigationSplitView {
            ...
            if #unavailable(macOS 26.0) {
                List { }
                    .searchable(text: $searchText, placement: .sidebar, prompt: String(localized: "common.search", defaultValue: "Search", comment: "Search field placeholder"))
                    .scrollDisabled(true)
                    .frame(height: 30)
            ...
            Group {
                ...
                default:
                    Text(String(localized: "common.implementation-needed", defaultValue: "Implementation Needed", comment: "Implementation needed placeholder")).frame(alignment: .center)
                }
            }
