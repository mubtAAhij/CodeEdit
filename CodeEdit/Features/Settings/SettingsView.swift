    ...
    var body: some View {
        NavigationSplitView {
            ...
            Group {
                ...
                default:
                    Text(String(localized: "settings.not-implemented", defaultValue: "Implementation Needed", comment: "Placeholder for unimplemented settings pages")).frame(alignment: .center)
                }
            }
