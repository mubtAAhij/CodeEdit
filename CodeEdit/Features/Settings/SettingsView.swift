    ...
    var body: some View {
        NavigationSplitView {
            ...
            Group {
                ...
                default:
                    Text(String(localized: "settings.not-implemented", defaultValue: "Implementation Needed", comment: "Settings page not implemented message")).frame(alignment: .center)
                }
            }
