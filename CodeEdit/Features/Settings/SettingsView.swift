    ...
    var body: some View {
        NavigationSplitView {
            ...
            if #unavailable(macOS 26.0) {
                List { }
                    .searchable(text: $searchText, placement: .sidebar, prompt: String(localized: "search_placeholder", comment: "Placeholder text for search field"))
                    .scrollDisabled(true)
                    .frame(height: 30)
            ...
            Group {
                ...
                default:
                    Text(String(localized: "implementation_needed", comment: "Placeholder text for unimplemented features")).frame(alignment: .center)
                }
            }
