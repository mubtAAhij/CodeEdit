    ...
    var body: some View {
        NavigationSplitView {
            ...
            if #unavailable(macOS 26.0) {
                List { }
                    .searchable(text: $searchText, placement: .sidebar, prompt: String(localized: "general.search", comment: "Search placeholder text"))
                    .scrollDisabled(true)
                    .frame(height: 30)
            ...
            Group {
                ...
                default:
                    Text(String(localized: "settings.implementation_needed", comment: "Placeholder text for unimplemented settings")).frame(alignment: .center)
                }
            }
