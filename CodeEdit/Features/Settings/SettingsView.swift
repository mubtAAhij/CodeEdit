    ...
    var body: some View {
        NavigationSplitView {
            ...
            Group {
                ...
                default:
                    Text(String(localized: "settings.not-implemented", defaultValue: "Implementation Needed", comment: "Message shown for unimplemented settings pages")).frame(alignment: .center)
                }
            }
