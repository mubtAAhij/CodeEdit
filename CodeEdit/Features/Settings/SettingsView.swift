    ...
    var body: some View {
        NavigationSplitView {
            ...
            if #unavailable(macOS 26.0) {
                List { }
                    .searchable(text: $searchText, placement: .sidebar, prompt: String(
                        localized: "settings.sidebar.search",
                        defaultValue: "Search",
                        comment: "Settings sidebar item title for search settings"
                    ))
                    .scrollDisabled(true)
                    .frame(height: 30)
                ...
                .searchable(text: $searchText, placement: .sidebar, prompt: String(
                    localized: "settings.navigation.search-title",
                    defaultValue: "Search",
                    comment: "Navigation title for search settings page"
                ))
                .navigationSplitViewColumnWidth(215)
            }
        } detail: {
            Group {
                ...
                default:
                    Text(String(
                        localized: "settings.page.implementation-needed",
                        defaultValue: "Implementation Needed",
                        comment: "Placeholder text for settings page not yet implemented"
