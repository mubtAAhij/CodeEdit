    ...
    var body: some View {
        NavigationSplitView {
            ...
            if #unavailable(macOS 26.0) {
                List { }
                    .searchable(text: $searchText, placement: .sidebar, prompt: String(localized: "settings.search.prompt", defaultValue: "Search", comment: "Search field prompt in settings sidebar"))
                    .scrollDisabled(true)
                    .frame(height: 30)
            ...
            Group {
                ...
                default:
                    Text(String(localized: "settings.implementation-needed", defaultValue: "Implementation Needed", comment: "Placeholder message for unimplemented settings pages")).frame(alignment: .center)
                }
            }
