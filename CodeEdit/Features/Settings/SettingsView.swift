    ...
    var body: some View {
        NavigationSplitView {
            ...
            if #unavailable(macOS 26.0) {
                List { }
                    .searchable(text: $searchText, placement: .sidebar, prompt: Text("Search", comment: "Search settings placeholder"))
                    .scrollDisabled(true)
                    .frame(height: 30)
            ...
            Group {
                ...
                default:
                    Text("Implementation Needed", comment: "Placeholder for unimplemented settings page").frame(alignment: .center)
                }
            }
