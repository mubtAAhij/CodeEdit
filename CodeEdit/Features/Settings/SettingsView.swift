    ...
    var body: some View {
        NavigationSplitView {
            ...
            if #unavailable(macOS 26.0) {
                List { }
                    .searchable(text: $searchText, placement: .sidebar, prompt: String(localized: "settings.search", defaultValue: "Search", comment: "Settings search prompt"))
                    .scrollDisabled(true)
                    .frame(height: 30)
            ...
            Group {
                ...
                default:
                    Text(String(localized: "settings.implementation-needed", defaultValue: "Implementation Needed", comment: "Placeholder for unimplemented settings pages")).frame(alignment: .center)
                }
            }
