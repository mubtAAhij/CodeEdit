    ...
    var body: some View {
        NavigationSplitView {
            ...
            if #unavailable(macOS 26.0) {
                List { }
                    .searchable(text: $searchText, placement: .sidebar, prompt: String(localized: "search", defaultValue: "Search", comment: "Search placeholder"))
                    .scrollDisabled(true)
                    .frame(height: 30)
            ...
            Group {
                ...
                default:
                    Text(String(localized: "implementation-needed", defaultValue: "Implementation Needed", comment: "Implementation needed placeholder")).frame(alignment: .center)
                }
            }
