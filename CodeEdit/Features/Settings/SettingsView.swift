    ...
    var body: some View {
        NavigationSplitView {
            ...
            if #unavailable(macOS 26.0) {
                List { }
                    .searchable(text: $searchText, placement: .sidebar, prompt: String(localized: "settings.search.prompt", defaultValue: "Search", comment: "Search prompt for settings"))
                    .scrollDisabled(true)
                    .frame(height: 30)
            ...
            Group {
                ...
                default:
                    Text(String(localized: "settings.implementation_needed", defaultValue: "Implementation Needed", comment: "Placeholder text for unimplemented settings page")).frame(alignment: .center)
                }
            }
