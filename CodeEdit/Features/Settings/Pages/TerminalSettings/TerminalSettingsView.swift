...
private extension TerminalSettingsView {
    ...
    private var optionAsMetaToggle: some View {
        Toggle(String(localized: "settings.terminal.option-as-meta", defaultValue: "Use \"Option\" key as \"Meta\"", comment: "Toggle for Option key as Meta"), isOn: $settings.optionAsMeta)
    }
