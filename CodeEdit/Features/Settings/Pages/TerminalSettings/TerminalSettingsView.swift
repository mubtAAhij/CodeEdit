...
private extension TerminalSettingsView {
    ...
    private var optionAsMetaToggle: some View {
        Toggle(String(localized: "settings.terminal.option-as-meta", defaultValue: "Use \"Option\" key as \"Meta\"", comment: "Option key as Meta toggle"), isOn: $settings.optionAsMeta)
    }

    private var useTextEditorFontToggle: some View {
        Toggle(String(localized: "settings.terminal.use-editor-font", defaultValue: "Use text editor font", comment: "Use text editor font toggle"), isOn: $settings.useTextEditorFont)
    }
    ...
    @ViewBuilder private var injectionOptions: some View {
        VStack {
            ...
            if !settings.useShellIntegration {
                HStack {
                    Image(systemName: String(localized: "settings.terminal.warning-icon", defaultValue: "exclamationmark.triangle.fill", comment: "Warning icon"))
