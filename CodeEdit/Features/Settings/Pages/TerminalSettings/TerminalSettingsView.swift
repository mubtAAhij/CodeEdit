...
private extension TerminalSettingsView {
    @ViewBuilder private var shellSelector: some View {
        Picker(String(localized: "terminal-settings.shell", defaultValue: "Shell", comment: "Label for shell selector"), selection: $settings.shell) {
    ...
    private var cursorBlink: some View {
        Toggle(String(localized: "terminal-settings.blink-cursor", defaultValue: "Blink Cursor", comment: "Toggle to enable cursor blinking"), isOn: $settings.cursorBlink)
    }
    ...
    @ViewBuilder private var injectionOptions: some View {
        VStack {
            Toggle(String(localized: "terminal-settings.shell-integration", defaultValue: "Shell Integration", comment: "Toggle for shell integration feature"), isOn: $settings.useShellIntegration)
