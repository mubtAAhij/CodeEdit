...
private extension TerminalSettingsView {
    ...
    @ViewBuilder private var injectionOptions: some View {
        VStack {
            Toggle(String(localized: "terminal.shell-integration", defaultValue: "Shell Integration", comment: "Toggle to enable shell integration"), isOn: $settings.useShellIntegration)
            ...
            if !settings.useShellIntegration {
                HStack {
                    Image(systemName: String(localized: "terminal.warning-icon", defaultValue: "exclamationmark.triangle.fill", comment: "Warning icon for shell integration"))
