...
private extension TerminalSettingsView {
    ...
    private var useTextEditorFontToggle: some View {
        Toggle(String(localized: "settings.terminal.use-editor-font", defaultValue: "Use text editor font", comment: "Use editor font toggle"), isOn: $settings.useTextEditorFont)
    }
