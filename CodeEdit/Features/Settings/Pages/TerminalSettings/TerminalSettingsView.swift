...
private extension TerminalSettingsView {
    @ViewBuilder private var shellSelector: some View {
        Picker(String(
            ...
            defaultValue: "Shell",
            comment: "Terminal settings label for shell selection"
        ), selection: $settings.shell) {
            Text(String(
                localized: "settings.terminal.shell.system-default",
                defaultValue: "System Default",
                comment: "Terminal shell picker option for using the system default shell"
            ))
                .tag(SettingsData.TerminalShell.system)
            Divider()
            Text(String(
                localized: "settings.terminal.shell.zsh",
                defaultValue: "Zsh",
                comment: "Terminal shell picker option for Zsh"
            ))
                .tag(SettingsData.TerminalShell.zsh)
            Text(String(
                localized: "settings.terminal.shell.bash",
                defaultValue: "Bash",
                comment: "Terminal shell picker option for Bash"
            ))
    ...
    private var cursorStyle: some View {
        Picker(String(
            ...
            comment: "Terminal settings label for cursor style selection"
        ), selection: $settings.cursorStyle) {
            Text(String(
                localized: "settings.terminal.cursor-style.block",
                defaultValue: "Block",
                comment: "Terminal cursor style option for block cursor"
            ))
                .tag(SettingsData.TerminalCursorStyle.block)
            Text(String(
                localized: "settings.terminal.cursor-style.underline",
                defaultValue: "Underline",
                comment: "Terminal cursor style option for underline cursor"
            ))
                .tag(SettingsData.TerminalCursorStyle.underline)
            Text(String(
                localized: "settings.terminal.cursor-style.bar",
                defaultValue: "Bar",
                comment: "Terminal cursor style option for bar cursor"
            ))
    ...
    private var cursorBlink: some View {
        Toggle(String(
            ...
            comment: "Terminal settings toggle for blinking cursor"
        ), isOn: $settings.cursorBlink)
    }

    private var optionAsMetaToggle: some View {
        Toggle(String(
            localized: "settings.terminal.use-option-as-meta",
            defaultValue: "Use \"Option\" key as \"Meta\"",
            comment: "Terminal settings toggle to treat Option key as Meta"
    ...
    private var useTextEditorFontToggle: some View {
        Toggle(String(
            ...
            comment: "Terminal settings toggle for using editor font in terminal"
    ...
    @ViewBuilder private var fontSelector: some View {
        MonospacedFontPicker(title: String(
            ...
            defaultValue: "Font",
            comment: "Terminal settings label for font selection"
    ...
    private var fontSizeSelector: some View {
        Stepper(
            String(
                ...
                comment: "Terminal settings label for terminal font size"
            ),
    ...
    @ViewBuilder private var injectionOptions: some View {
        VStack {
            Toggle(String(
                ...
                comment: "Terminal settings section title for shell integration"
            ...
            // swiftlint:disable:next line_length
                .help(String(
                    ...
                    comment: "Terminal settings description explaining shell integration support and benefits"
                ))
    ...
    @ViewBuilder private var useLoginShell: some View {
        if settings.useShellIntegration {
            Toggle(String(
                ...
                comment: "Terminal settings toggle for using a login shell"
            ...
            // swiftlint:disable:next line_length
                .help(String(
                    ...
                    comment: "Terminal settings help text explaining login shell behavior"
                ))
        } else {
            EmptyView()
        }
