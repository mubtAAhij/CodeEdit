...
private extension TerminalSettingsView {
    ...
    private var cursorStyle: some View {
        Picker(String(localized: "terminal.cursor-style", defaultValue: "Terminal Cursor Style", comment: "Terminal cursor style picker label"), selection: $settings.cursorStyle) {
            Text(String(localized: "terminal.cursor-block", defaultValue: "Block", comment: "Block cursor style option"))
                .tag(SettingsData.TerminalCursorStyle.block)
            Text(String(localized: "terminal.cursor-underline", defaultValue: "Underline", comment: "Underline cursor style option"))
                .tag(SettingsData.TerminalCursorStyle.underline)
            Text(String(localized: "terminal.cursor-bar", defaultValue: "Bar", comment: "Bar cursor style option"))
    ...
    private var optionAsMetaToggle: some View {
        Toggle(String(localized: "terminal.option-as-meta", defaultValue: "Use \"Option\" key as \"Meta\"", comment: "Use Option key as Meta toggle"), isOn: $settings.optionAsMeta)
    }

    private var useTextEditorFontToggle: some View {
        Toggle(String(localized: "terminal.use-text-editor-font", defaultValue: "Use text editor font", comment: "Use text editor font toggle"), isOn: $settings.useTextEditorFont)
    }
        ...
        VStack {
            ...
            if !settings.useShellIntegration {
                HStack {
                    ...
                    Text(String(localized: "terminal.shell-integration-warning", defaultValue: "Warning: Disabling integration disables features such as terminal title detection.", comment: "Shell integration disabled warning"))
                    Spacer()
                }
            }
        }
