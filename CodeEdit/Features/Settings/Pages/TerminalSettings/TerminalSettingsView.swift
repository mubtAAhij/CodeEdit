...
private extension TerminalSettingsView {
    @ViewBuilder private var shellSelector: some View {
        Picker(String(localized: "settings.terminal.shell", defaultValue: "Shell", comment: "Label for terminal shell selection picker"), selection: $settings.shell) {
        ...
        VStack {
            ...
            if !settings.useShellIntegration {
                HStack {
                    ...
                    Text(String(localized: "settings.terminal.shell-integration.warning", defaultValue: "Warning: Disabling integration disables features such as terminal title detection.", comment: "Warning message about disabling shell integration"))
                    Spacer()
                }
            }
        }
