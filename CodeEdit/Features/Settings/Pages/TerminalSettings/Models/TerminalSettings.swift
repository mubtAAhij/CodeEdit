...
extension SettingsData {
    ...
    struct TerminalSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.terminal.shell", defaultValue: "Shell", comment: "Shell setting label"),
                String(localized: "settings.terminal.option-as-meta", defaultValue: "Use \"Option\" key as \"Meta\"", comment: "Option as meta setting label"),
                String(localized: "settings.terminal.use-editor-font", defaultValue: "Use text editor font", comment: "Use editor font setting label"),
                "Font",
                String(localized: "settings.terminal.font-size", defaultValue: "Font Size", comment: "Font size setting label"),
                String(localized: "settings.terminal.cursor-style", defaultValue: "Terminal Cursor Style", comment: "Cursor style setting label"),
                String(localized: "settings.terminal.blink-cursor", defaultValue: "Blink Cursor", comment: "Blink cursor setting label")
            ]
