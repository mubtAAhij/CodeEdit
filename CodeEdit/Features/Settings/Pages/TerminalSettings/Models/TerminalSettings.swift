...
extension SettingsData {
    ...
    struct TerminalSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.terminal.search-key.shell", defaultValue: "Shell", comment: "Terminal settings search key"),
                String(localized: "settings.terminal.search-key.option-as-meta", defaultValue: "Use \"Option\" key as \"Meta\"", comment: "Terminal settings search key"),
                String(localized: "settings.terminal.search-key.use-editor-font", defaultValue: "Use text editor font", comment: "Terminal settings search key"),
                String(localized: "settings.terminal.search-key.font", defaultValue: "Font", comment: "Terminal settings search key"),
                String(localized: "settings.terminal.search-key.font-size", defaultValue: "Font Size", comment: "Terminal settings search key"),
                String(localized: "settings.terminal.search-key.cursor-style", defaultValue: "Terminal Cursor Style", comment: "Terminal settings search key"),
                String(localized: "settings.terminal.search-key.blink-cursor", defaultValue: "Blink Cursor", comment: "Terminal settings search key")
            ]
        }
