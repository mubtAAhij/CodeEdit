...
extension SettingsData {
    ...
    struct TerminalSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "terminal.shell", defaultValue: "Shell", comment: "Terminal settings search key"),
                String(localized: "terminal.option-as-meta", defaultValue: "Use \"Option\" key as \"Meta\"", comment: "Terminal settings search key"),
                String(localized: "terminal.use-text-editor-font", defaultValue: "Use text editor font", comment: "Terminal settings search key"),
                "Font",
                "Font Size",
                String(localized: "terminal.cursor-style", defaultValue: "Terminal Cursor Style", comment: "Terminal settings search key"),
                String(localized: "terminal.blink-cursor", defaultValue: "Blink Cursor", comment: "Terminal settings search key")
            ]
        }
