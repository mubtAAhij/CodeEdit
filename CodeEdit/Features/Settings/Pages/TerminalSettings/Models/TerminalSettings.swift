...
extension SettingsData {
    ...
    struct TerminalSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                NSLocalizedString("settings.terminal.shell", comment: "Shell"),
                NSLocalizedString("settings.terminal.option-as-meta", comment: "Use Option key as Meta"),
                NSLocalizedString("settings.terminal.use-editor-font", comment: "Use text editor font"),
                "Font",
                "Font Size",
                NSLocalizedString("settings.terminal.cursor-style", comment: "Terminal Cursor Style"),
                NSLocalizedString("settings.terminal.blink-cursor", comment: "Blink Cursor")
            ]
        }
