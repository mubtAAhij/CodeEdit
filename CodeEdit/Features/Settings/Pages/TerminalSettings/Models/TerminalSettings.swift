    ...
    struct TerminalSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "terminal-settings.search.use-editor-font", defaultValue: "Use text editor font", comment: "Terminal settings search key for using text editor font"),
                "Font",
                ...
                String(localized: "terminal-settings.search.blink-cursor", defaultValue: "Blink Cursor", comment: "Terminal settings search key for blink cursor option")
            ]
        }
