...
extension SettingsData {
    ...
    struct TerminalSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.terminal.shell", defaultValue: "Shell", comment: "Search keyword for terminal shell setting"),
                String(localized: "settings.terminal.use-option-as-meta", defaultValue: "Use \"Option\" key as \"Meta\"", comment: "Search keyword for using Option key as Meta in terminal"),
                String(localized: "settings.terminal.use-text-editor-font", defaultValue: "Use text editor font", comment: "Search keyword for using text editor font in terminal"),
                String(localized: "settings.terminal.font", defaultValue: "Font", comment: "Search keyword for terminal font setting"),
                String(localized: "settings.terminal.font-size", defaultValue: "Font Size", comment: "Search keyword for terminal font size setting"),
                String(localized: "settings.terminal.cursor-style", defaultValue: "Terminal Cursor Style", comment: "Search keyword for terminal cursor style setting"),
                String(localized: "settings.terminal.blink-cursor", defaultValue: "Blink Cursor", comment: "Search keyword for terminal cursor blink setting")
            ]
