...
extension SettingsData {
    ...
    struct TerminalSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "terminal-settings.search.shell", defaultValue: "Shell", comment: "Terminal settings search key for shell option"),
                String(localized: "terminal-settings.search.option-as-meta", defaultValue: "Use \"Option\" key as \"Meta\"", comment: "Terminal settings search key for option key as meta"),
                String(localized: "terminal-settings.search.use-editor-font", defaultValue: "Use text editor font", comment: "Terminal settings search key for using editor font"),
                String(localized: "terminal-settings.search.font", defaultValue: "Font", comment: "Terminal settings search key for font"),
                String(localized: "terminal-settings.search.font-size", defaultValue: "Font Size", comment: "Terminal settings search key for font size"),
                String(localized: "terminal-settings.search.cursor-style", defaultValue: "Terminal Cursor Style", comment: "Terminal settings search key for cursor style"),
                String(localized: "terminal-settings.search.blink-cursor", defaultValue: "Blink Cursor", comment: "Terminal settings search key for cursor blinking")
            ]
        }
