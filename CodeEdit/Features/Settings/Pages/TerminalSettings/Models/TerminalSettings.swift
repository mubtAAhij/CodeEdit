...
extension SettingsData {
    ...
    struct TerminalSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "Shell", comment: "Search key for shell settings"),
                String(localized: "Use \"Option\" key as \"Meta\"", comment: "Search key for Option key meta setting"),
                String(localized: "Use text editor font", comment: "Search key for text editor font setting"),
                String(localized: "Font", comment: "Search key for font settings"),
                String(localized: "Font Size", comment: "Search key for font size setting"),
                String(localized: "Terminal Cursor Style", comment: "Search key for cursor style setting"),
                String(localized: "Blink Cursor", comment: "Search key for cursor blink setting")
            ]
        }
