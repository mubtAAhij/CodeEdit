...
extension SettingsData {
    ...
    struct TerminalSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.terminal.shell", defaultValue: "Shell", comment: "Terminal shell search key"),
                String(localized: "settings.terminal.option-as-meta", defaultValue: "Use \"Option\" key as \"Meta\"", comment: "Option key as Meta search key"),
                String(localized: "settings.terminal.use-editor-font", defaultValue: "Use text editor font", comment: "Use text editor font search key"),
                String(localized: "settings.terminal.font", defaultValue: "Font", comment: "Terminal font search key"),
                String(localized: "settings.terminal.font-size", defaultValue: "Font Size", comment: "Font size search key"),
                String(localized: "settings.terminal.cursor-style", defaultValue: "Terminal Cursor Style", comment: "Terminal cursor style search key"),
                String(localized: "settings.terminal.blink-cursor", defaultValue: "Blink Cursor", comment: "Blink cursor search key")
            ]
        }
    ...
    struct TerminalFont: Codable, Hashable {
        ...
        var name: String = String(localized: "settings.terminal.font.sf-mono", defaultValue: "SF Mono", comment: "Default terminal font name")
