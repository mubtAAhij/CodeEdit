...
struct LanguageServerInstallView: View {
    ...
    var body: some View {
        ...
        .alert(
            ...
            Button(String(localized: "continue", comment: "Continue button text")) {
        ...
        HStack {
            ...
            case .complete:
                Button {
                    ...
                    Text(String(localized: "continue", comment: "Continue button text"))
                        .frame(minWidth: 56)
                }
                .buttonStyle(.borderedProminent)
            }
        ...
        if let error = operation.error {
            Section {
                HStack(spacing: 4) {
                    ...
                    Text(String(localized: "error_occurred", comment: "Error message when an error occurs"))
                }
                .font(.title3)
            ...
            LabeledContent(String(localized: "step", comment: "Label for installation step")) {
                if registryManager.installedLanguageServers[operation.package.name] != nil {
                    HStack(spacing: 4) {
                        ...
                        Text(String(localized: "successfully_installed", comment: "Message when installation is successful"))
