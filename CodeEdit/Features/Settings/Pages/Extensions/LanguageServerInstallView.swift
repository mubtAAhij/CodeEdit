...
struct LanguageServerInstallView: View {
    ...
    var body: some View {
        ...
        .alert(
            ...
            Button(String(localized: "common.continue", comment: "Continue button")) {
        ...
        HStack {
            ...
            case .none:
                ...
                Button {
                    ...
                    Text(String(localized: "language_server_install.install", comment: "Install button"))
                }
    ...
    @ViewBuilder private var packageInfoSection: some View {
        Section {
            ...
            LabeledContent(String(localized: "language_server_install.homepage", comment: "Label for package homepage")) {
                sourceButton.cursor(.pointingHand)
            }
            VStack(alignment: .leading, spacing: 6) {
                Text(String(localized: "language_server_install.description", comment: "Label for package description"))
        ...
        if let error = operation.error {
            Section {
                HStack(spacing: 4) {
                    ...
                    Text(String(localized: "common.error_occurred", comment: "Error occurred message"))
                }
                .font(.title3)
            ...
            LabeledContent(String(localized: "language_server_install.step", comment: "Label for installation step")) {
                if registryManager.installedLanguageServers[operation.package.name] != nil {
                    HStack(spacing: 4) {
                        ...
                        Text(String(localized: "language_server_install.successfully_installed", comment: "Success message for installation"))
    ...
    @ViewBuilder private var notInstalledSection: some View {
        Section {
            if let method = operation.package.installMethod {
                ...
                LabeledContent(String(localized: "language_server_install.installer", comment: "Label for installer"), value: "Unknown")
            }
        }
    }
}
