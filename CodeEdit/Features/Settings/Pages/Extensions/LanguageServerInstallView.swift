...
struct LanguageServerInstallView: View {
    ...
    var body: some View {
        ...
        .alert(
            ...
            Button(String(localized: "cancel", comment: "Cancel button in confirmation alert")) {
                registryManager.cancelInstallation()
            }
            Button(String(localized: "continue", comment: "Continue button in confirmation alert")) {
        ...
        HStack {
            ...
            case .none:
                Button {
                    ...
                    Text(String(localized: "cancel", comment: "Cancel button in footer"))
                }
                ...
                Button {
                    ...
                    Text(String(localized: "install", comment: "Install button"))
                }
            ...
            case .complete:
                Button {
                    ...
                    Text(String(localized: "continue", comment: "Continue button after installation"))
                        .frame(minWidth: 56)
                }
                .buttonStyle(.borderedProminent)
            }
    ...
    @ViewBuilder private var packageInfoSection: some View {
        Section {
            ...
            LabeledContent(String(localized: "homepage", comment: "Label for package homepage")) {
                sourceButton.cursor(.pointingHand)
            }
            VStack(alignment: .leading, spacing: 6) {
                Text(String(localized: "description", comment: "Section label for package description"))
        ...
        if let error = operation.error {
            Section {
                HStack(spacing: 4) {
                    ...
                    Text(String(localized: "error_occurred", comment: "Error section title"))
                }
                .font(.title3)
    ...
    @ViewBuilder private var progressSection: some View {
        Section {
            LabeledContent(String(localized: "step", comment: "Installation step label")) {
                if registryManager.installedLanguageServers[operation.package.name] != nil {
                    HStack(spacing: 4) {
                        Image(systemName: "checkmark.circle.fill")
                            .foregroundColor(.green)
                        Text(String(localized: "successfully_installed", comment: "Success message for completed installation"))
    ...
    @ViewBuilder private var notInstalledSection: some View {
        Section {
            if let method = operation.package.installMethod {
                ...
                LabeledContent(String(localized: "installer", comment: "Label for installer type"), value: "Unknown")
            }
        }
    }
}
