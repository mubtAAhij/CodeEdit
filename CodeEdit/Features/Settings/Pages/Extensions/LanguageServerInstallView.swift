...
struct LanguageServerInstallView: View {
        ...
        HStack {
            ...
            case .none:
                Button {
                    ...
                    Text(String(localized: "language-server-install.cancel", defaultValue: "Cancel", comment: "Cancel button"))
                }
            ...
            case .complete:
                Button {
                    ...
                    Text(String(localized: "language-server-install.continue", defaultValue: "Continue", comment: "Continue button"))
                        .frame(minWidth: 56)
                }
                .buttonStyle(.borderedProminent)
            }
        ...
        if let error = operation.error {
            Section {
                HStack(spacing: 4) {
                    ...
                    Text(String(localized: "language-server-install.error-occurred", defaultValue: "Error Occurred", comment: "Error occurred message"))
                }
                .font(.title3)
    ...
    @ViewBuilder private var progressSection: some View {
        Section {
            LabeledContent(String(localized: "language-server-install.step", defaultValue: "Step", comment: "Installation step label")) {
