...
struct LanguageServerInstallView: View {
    ...
    var body: some View {
        ...
        .alert(
            ...
            Button(String(localized: "continue", comment: "Continue button")) {
            ...
            LabeledContent(String(localized: "step", comment: "Label for installation step")) {
                if registryManager.installedLanguageServers[operation.package.name] != nil {
                    HStack(spacing: 4) {
                        ...
                        Text(String(localized: "successfully_installed", comment: "Status message for successful installation"))
                            .foregroundStyle(.primary)
                    }
                } else if operation.error != nil {
                    Text(String(localized: "error_occurred", comment: "Error occurred status message"))
                } else {
