        ...
        HStack {
            ...
            case .none:
                Button {
                    ...
                    Text(String(localized: "language-server-install.cancel-footer", defaultValue: "Cancel", comment: "Cancel footer button"))
                }
            ...
            case .running:
                Button {
                    ...
                    Text(String(localized: "language-server-install.cancel-running", defaultValue: "Cancel", comment: "Cancel running installation"))
                        .frame(minWidth: 56)
                }
                .buttonStyle(.bordered)
            case .complete:
                Button {
                    ...
                    Text(String(localized: "language-server-install.continue-complete", defaultValue: "Continue", comment: "Continue after completion"))
                        .frame(minWidth: 56)
                }
                .buttonStyle(.borderedProminent)
            }
            ...
            LabeledContent(String(localized: "language-server-install.step", defaultValue: "Step", comment: "Step label")) {
                if registryManager.installedLanguageServers[operation.package.name] != nil {
                    HStack(spacing: 4) {
                        ...
                        Text(String(localized: "language-server-install.success", defaultValue: "Successfully Installed", comment: "Successfully installed label"))
