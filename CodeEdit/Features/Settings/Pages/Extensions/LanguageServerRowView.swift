...
struct LanguageServerRowView: View, Equatable {
    ...
    var body: some View {
        ...
        .alert(String(format: String(localized: "language-server-row.remove-confirmation-title", defaultValue: "Remove %@?", comment: "Remove language server confirmation title"), package.sanitizedName), isPresented: $showingRemovalConfirmation) {
            ...
            Button(String(localized: "language-server-row.remove-action", defaultValue: "Remove", comment: "Remove button"), role: .destructive) {
        ...
        HStack {
            if isRemoving {
                ...
                Button {
                    ...
                    Text(String(localized: "language-server-row.remove-action", defaultValue: "Remove", comment: "Remove button"))
                }
            }
            Toggle(
                "",
