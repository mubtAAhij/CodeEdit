...
struct LanguageServersView: View {
        ...
        Group {
            SettingsForm {
                ...
                Section {
                    ...
                    Label(
                        String(localized: "language_server.experimental_warning", comment: "Warning about experimental language server installation"),
    ...
    private func getInfoString() -> AttributedString {
        let string = String(localized: "language_server.info_description", comment: "Information about language server installation process")
