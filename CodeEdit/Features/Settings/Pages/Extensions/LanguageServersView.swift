        ...
        Group {
            SettingsForm {
                ...
                Section {
                    ...
                    Label(
                        String(localized: "settings.extensions.lsp-warning", defaultValue: "Warning: Language server installation is experimental. Use at your own risk.", comment: "Warning about experimental language server installation"),
