...
struct LanguageServersView: View {
    ...
    private func getInfoString() -> AttributedString {
        let string = "String(localized: "mason_registry_description_part1", comment: "First part of Mason Registry description for language server installation")"
        + "String(localized: "mason_registry_description_part2", comment: "Second part of Mason Registry description explaining package manager usage")"
        + "String(localized: "mason_registry_description_part3", comment: "Third part of Mason Registry description about installation location")"
        + "String(localized: "experimental_installation_warning_part1", comment: "First part of experimental installation warning")"
        + "String(localized: "experimental_installation_warning_part2", comment: "Second part of experimental installation warning")"
