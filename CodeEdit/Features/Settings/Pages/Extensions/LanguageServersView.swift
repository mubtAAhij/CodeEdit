...
struct LanguageServersView: View {
        ...
        Group {
            SettingsForm {
                ...
                Section {
                    ...
                    Label(
                        String(localized: "language_server.warning.experimental", comment: "Warning about experimental language server installation"),
    ...
    private func getInfoString() -> AttributedString {
        let string = String(localized: "language_server.info.experimental_description", comment: "Detailed description of experimental language server installation process")
