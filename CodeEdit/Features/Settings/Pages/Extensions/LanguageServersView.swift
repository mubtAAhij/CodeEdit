        ...
        Group {
            SettingsForm {
                ...
                Section {
                    ...
                    Label(
                        String(localized: "settings.language-servers.warning", defaultValue: "Warning: Language server installation is experimental. Use at your own risk.", comment: "Language server installation warning"),
