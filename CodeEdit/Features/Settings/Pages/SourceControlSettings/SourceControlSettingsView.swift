...
struct SourceControlSettingsView: View {
            ...
            Section {
                ...
                if settings.sourceControlIsEnabled {
                    Picker("", selection: $selectedTab) {
                        ...
                        Text(String(localized: "source_control.git", comment: "Git version control system name")).tag("git")
                    }
    ...
    private var sourceControlIsEnabled: some View {
        Toggle(
            ...
            Label {
                Text(String(localized: "source_control.title", comment: "Source Control settings page title"))
                Text("""
