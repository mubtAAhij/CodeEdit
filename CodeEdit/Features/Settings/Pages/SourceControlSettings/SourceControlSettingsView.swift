...
struct SourceControlSettingsView: View {
            ...
            Section {
                ...
                if settings.sourceControlIsEnabled {
                    Picker("", selection: $selectedTab) {
                        ...
                        Text("settings.source_control.git", comment: "Tab label").tag("git")
                    }
    ...
    private var sourceControlIsEnabled: some View {
        Toggle(
            ...
            Label {
                Text("settings.source_control.label", comment: "Setting label")
                Text("settings.source_control.description", comment: "Setting description")
                .font(.callout)
             } icon: {
