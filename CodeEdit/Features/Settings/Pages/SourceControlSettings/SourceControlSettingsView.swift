            ...
            Section {
                ...
                if settings.sourceControlIsEnabled {
                    Picker("", selection: $selectedTab) {
                        ...
                        Text(String(localized: "settings.source-control.git", defaultValue: "Git", comment: "Tab label for Git settings")).tag("git")
                    }
    ...
    private var sourceControlIsEnabled: some View {
        Toggle(
            ...
            Label {
                ...
                Text(String(localized: "settings.source-control.description", defaultValue: "Back up your files, collaborate with others, and tag your releases. [Learn more...](https://developer.apple.com/documentation/xcode/source-control-management)", comment: "Description for source control settings with link"))
                .font(.callout)
             } icon: {
