    ...
    struct SourceControlSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "source-control.search.fetch-refresh-server", defaultValue: "Fetch and refresh server status automatically", comment: "Fetch and refresh server status search key"),
                ...
                String(localized: "source-control.search.show-changes", defaultValue: "Show source control changes", comment: "Show source control changes search key"),
                String(localized: "source-control.search.include-upstream", defaultValue: "Include upstream changes", comment: "Include upstream changes search key"),
                String(localized: "source-control.search.comparison-view", defaultValue: "Comparison view", comment: "Comparison view search key"),
                String(localized: "source-control.search.navigator", defaultValue: "Source control navigator", comment: "Source control navigator search key"),
                String(localized: "source-control.search.default-branch", defaultValue: "Default branch name", comment: "Default branch name search key"),
                ...
                String(localized: "source-control.search.prefer-rebase", defaultValue: "Prefer to rebase when pulling", comment: "Prefer to rebase search key"),
                String(localized: "source-control.search.show-merge-commits", defaultValue: "Show merge commits in per-file log", comment: "Show merge commits search key")
            ]
        }
