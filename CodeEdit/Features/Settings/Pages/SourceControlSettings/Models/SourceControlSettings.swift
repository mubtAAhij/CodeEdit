...
extension SettingsData {
    ...
    struct SourceControlSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "source-control-search.general", defaultValue: "General", comment: "General search key"),
                String(localized: "source-control-search.enable-source-control", defaultValue: "Enable source control", comment: "Enable source control search key"),
                String(localized: "source-control-search.refresh-local-status", defaultValue: "Refresh local status automatically", comment: "Refresh local status search key"),
                String(localized: "source-control-search.fetch-refresh-server-status", defaultValue: "Fetch and refresh server status automatically", comment: "Fetch and refresh server status search key"),
                String(localized: "source-control-search.add-remove-files", defaultValue: "Add and remove files automatically", comment: "Add and remove files search key"),
                String(localized: "source-control-search.select-files-to-commit", defaultValue: "Select files to commit automatically", comment: "Select files to commit search key"),
                String(localized: "source-control-search.show-source-control-changes", defaultValue: "Show source control changes", comment: "Show source control changes search key"),
                String(localized: "source-control-search.include-upstream-changes", defaultValue: "Include upstream changes", comment: "Include upstream changes search key"),
                String(localized: "source-control-search.comparison-view", defaultValue: "Comparison view", comment: "Comparison view search key"),
                String(localized: "source-control-search.source-control-navigator", defaultValue: "Source control navigator", comment: "Source control navigator search key"),
                String(localized: "source-control-search.default-branch-name", defaultValue: "Default branch name", comment: "Default branch name search key"),
                String(localized: "source-control-search.git", defaultValue: "Git", comment: "Git search key"),
                String(localized: "source-control-search.author-name", defaultValue: "Author Name", comment: "Author name search key"),
                String(localized: "source-control-search.author-email", defaultValue: "Author Email", comment: "Author email search key"),
                String(localized: "source-control-search.prefer-rebase-when-pulling", defaultValue: "Prefer to rebase when pulling", comment: "Prefer to rebase when pulling search key"),
                String(localized: "source-control-search.show-merge-commits-per-file-log", defaultValue: "Show merge commits in per-file log", comment: "Show merge commits in per-file log search key")
            ]
        }
