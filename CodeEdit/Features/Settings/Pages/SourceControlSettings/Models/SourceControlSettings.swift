    ...
    struct SourceControlSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "source-control-settings.add-remove-files", defaultValue: "Add and remove files automatically", comment: "Add and remove files search key"),
                ...
                String(localized: "source-control-settings.show-changes", defaultValue: "Show source control changes", comment: "Show source control changes search key"),
                ...
                String(localized: "source-control-settings.navigator", defaultValue: "Source control navigator", comment: "Source control navigator search key"),
                String(localized: "source-control-settings.default-branch", defaultValue: "Default branch name", comment: "Default branch name search key"),
