...
extension SettingsData {
    ...
    struct SourceControlSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.source-control.search.general", defaultValue: "General", comment: "Search key for general source control settings"),
                String(localized: "settings.source-control.search.enable", defaultValue: "Enable source control", comment: "Search key for enabling source control"),
                String(localized: "settings.source-control.search.refresh-local", defaultValue: "Refresh local status automatically", comment: "Search key for automatic local status refresh"),
                String(localized: "settings.source-control.search.fetch-server", defaultValue: "Fetch and refresh server status automatically", comment: "Search key for automatic server status fetch"),
                String(localized: "settings.source-control.search.add-remove-files", defaultValue: "Add and remove files automatically", comment: "Search key for automatic file staging"),
                String(localized: "settings.source-control.search.select-files", defaultValue: "Select files to commit automatically", comment: "Search key for automatic file selection"),
                String(localized: "settings.source-control.search.show-changes", defaultValue: "Show source control changes", comment: "Search key for showing source control changes"),
                String(localized: "settings.source-control.search.include-upstream", defaultValue: "Include upstream changes", comment: "Search key for including upstream changes"),
                String(localized: "settings.source-control.search.comparison-view", defaultValue: "Comparison view", comment: "Search key for comparison view settings"),
                String(localized: "settings.source-control.search.navigator", defaultValue: "Source control navigator", comment: "Search key for source control navigator settings"),
                String(localized: "settings.source-control.search.branch-name", defaultValue: "Default branch name", comment: "Search key for default branch name"),
                String(localized: "settings.source-control.search.git", defaultValue: "Git", comment: "Search key for Git settings"),
                String(localized: "settings.source-control.search.author-name", defaultValue: "Author Name", comment: "Search key for Git author name"),
                String(localized: "settings.source-control.search.author-email", defaultValue: "Author Email", comment: "Search key for Git author email"),
                String(localized: "settings.source-control.search.rebase-pull", defaultValue: "Prefer to rebase when pulling", comment: "Search key for rebase preference"),
                String(localized: "settings.source-control.search.merge-commits", defaultValue: "Show merge commits in per-file log", comment: "Search key for showing merge commits")
            ]
        }
