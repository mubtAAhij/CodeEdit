    ...
    var body: some View {
        Group {
            Section {
                ...
                Text(String(localized: "git_configuration", comment: "Header for Git configuration section"))
                Text("""
            ...
            Section {
                ...
                Text(String(localized: "ignored_files", comment: "Header for ignored files section"))
                Text("""
...
private extension SourceControlGitView {
    ...
    private var defaultBranchName: some View {
        TextField(text: $defaultBranch) {
            ...
            Text(String(localized: "branch_name_restrictions", comment: "Help text for default branch name field restrictions"))
        }
    ...
    private var preferToRebaseWhenPulling: some View {
        Toggle(
            String(localized: "prefer_rebase_when_pulling", comment: "Toggle option to prefer rebase when pulling"),
    ...
    private var showMergeCommitsInPerFileLog: some View {
        Toggle(
            String(localized: "show_merge_commits_per_file_log", comment: "Toggle option to show merge commits in per-file log"),
