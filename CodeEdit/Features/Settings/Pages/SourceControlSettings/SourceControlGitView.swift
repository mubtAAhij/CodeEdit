        ...
        Group {
            Section {
                ...
                Text(String(
                    ...
                    comment: "Description for git configuration settings with docs link."
                ))
            }
            Section {
                defaultBranchName
            ...
            Section {
                ...
                Text(String(
                    ...
                    comment: "Description for ignored files settings with docs link."
                ))
            }
            Section {
                gitIgnoreEditor
...
private extension SourceControlGitView {
    ...
    private var defaultBranchName: some View {
        TextField(text: $defaultBranch) {
            ...
            Text(String(
                ...
                comment: "Validation message for default branch name input."
            ))
        }
    ...
    private var preferToRebaseWhenPulling: some View {
        Toggle(
            String(
                localized: "settings.source-control.git.prefer-rebase-when-pulling.toggle",
    ...
    private var showMergeCommitsInPerFileLog: some View {
        Toggle(
            String(
                localized: "settings.source-control.git.show-merge-commits.toggle",
    ...
    private var gitConfigEditor: some View {
        HStack {
            Text(String(
                ...
                comment: "Informational text showing location of git configuration file."
            ))
                .font(.subheadline)
            ...
            Button(String(
                ...
                comment: "Button title to open git configuration file in editor."
    ...
    private var gitIgnoreEditor: some View {
        HStack {
            Text(String(format: String(
                localized: "settings.source-control.git.ignore-location.message",
                defaultValue: "Ignored file patterns are stored in \"%@\".",
                comment: "Informational text showing location of global gitignore file."
            ), "\(resolvedGitIgnorePath)"))
                .font(.subheadline)
                .foregroundStyle(.secondary)
                .frame(maxWidth: .infinity, alignment: .leading)
            Button(String(
                localized: "settings.source-control.git.ignore-location.open-in-editor",
                defaultValue: "Open in Editor...",
                comment: "Button title to open global gitignore file in editor."
