    ...
    var body: some View {
        Group {
            Section {
                ...
                Text(String(localized: "settings.source_control.git.configuration", defaultValue: "Git Configuration", comment: "Section header for git configuration"))
                Text(String(localized: "settings.source_control.git.configuration_description", defaultValue: "Applied globally to all repositories on your Mac. [Learn more...](https://git-scm.com/docs/git-config)", comment: "Description for git configuration section"))
            }
            Section {
                defaultBranchName
            ...
            Section {
                ...
                Text(String(localized: "settings.source_control.git.ignored_files", defaultValue: "Ignored Files", comment: "Section header for ignored files"))
                Text(String(localized: "settings.source_control.git.ignored_files_description", defaultValue: "Patterns for files and folders that Git should ignore and not track. Applied globally to all repositories on your Mac. [Learn more...](https://git-scm.com/docs/gitignore)", comment: "Description for ignored files section"))
            }
            Section {
                gitIgnoreEditor
            }
...
private extension SourceControlGitView {
    private var gitAuthorName: some View {
        TextField(String(localized: "settings.source_control.git.author_name", defaultValue: "Author Name", comment: "Label for git author name field"), text: $authorName)
    ...
    private var gitEmail: some View {
        TextField(String(localized: "settings.source_control.git.author_email", defaultValue: "Author Email", comment: "Label for git author email field"), text: $authorEmail)
    ...
    private var defaultBranchName: some View {
        TextField(text: $defaultBranch) {
            Text(String(localized: "settings.source_control.git.default_branch_name", defaultValue: "Default branch name", comment: "Label for default branch name field"))
            Text(String(localized: "settings.source_control.git.default_branch_help", defaultValue: "Cannot contain spaces, backslashes, or other symbols", comment: "Help text for default branch name field"))
        }
    ...
    private var preferToRebaseWhenPulling: some View {
        Toggle(
            String(localized: "settings.source_control.git.prefer_rebase", defaultValue: "Prefer to rebase when pulling", comment: "Toggle label for prefer rebase when pulling"),
    ...
    private var showMergeCommitsInPerFileLog: some View {
        Toggle(
            String(localized: "settings.source_control.git.show_merge_commits", defaultValue: "Show merge commits in per-file log", comment: "Toggle label for showing merge commits in per-file log"),
    ...
    private var gitConfigEditor: some View {
        HStack {
            Text(String(localized: "settings.source_control.git.config_stored_location", defaultValue: "Git configuration is stored in \"~/.gitconfig\".", comment: "Info text about git config file location"))
                .font(.subheadline)
                .foregroundStyle(.secondary)
                .frame(maxWidth: .infinity, alignment: .leading)
            Button(String(localized: "settings.source_control.git.open_in_editor", defaultValue: "Open in Editor...", comment: "Button to open git config in editor"), action: openGitConfigFile)
        }
    ...
    private var gitIgnoreEditor: some View {
        HStack {
            Text(String(format: String(localized: "settings.source_control.git.ignore_stored_location", defaultValue: "Ignored file patterns are stored in \"%@\".", comment: "Info text about gitignore file location"), resolvedGitIgnorePath))
                .font(.subheadline)
                .foregroundStyle(.secondary)
                .frame(maxWidth: .infinity, alignment: .leading)
            Button(String(localized: "settings.source_control.git.open_in_editor", defaultValue: "Open in Editor...", comment: "Button to open gitignore in editor"), action: openGitIgnoreFile)
        }
        .frame(maxWidth: .infinity)
        .onAppear {
            Task {
