...
private extension SourceControlGitView {
    ...
    private var defaultBranchName: some View {
        TextField(text: $defaultBranch) {
            ...
            Text(String(localized: "source_control.branch_name_constraints", comment: "Constraints for branch names"))
        }
    ...
    private var gitConfigEditor: some View {
        HStack {
            ...
            Button(String(localized: "source_control.open_in_editor", comment: "Open in Editor button text"), action: openGitConfigFile)
        }
