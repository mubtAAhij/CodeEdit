...
struct SourceControlGeneralView: View {
    ...
    var body: some View {
        Group {
            Section(String(localized: "settings.source-control.section", defaultValue: "Source Control", comment: "Source control settings section header")) {
...
private extension SourceControlGeneralView {
    ...
    private var comparisonView: some View {
        Picker(
            ...
            Text(String(localized: "settings.source-control.local-revision-left", defaultValue: "Local Revision on Left Side", comment: "Comparison view option for local revision on left"))
                .tag(SettingsData.RevisionComparisonLayout.localLeft)
            Text(String(localized: "settings.source-control.local-revision-right", defaultValue: "Local Revision on Right Side", comment: "Comparison view option for local revision on right"))
    ...
    private var sourceControlNavigator: some View {
        Picker(
            ...
            Text(String(localized: "settings.source-control.sort-by-name", defaultValue: "Sort by Name", comment: "Source control navigator sorting option"))
                .tag(SettingsData.ControlNavigatorOrder.sortByName)
            Text(String(localized: "settings.source-control.sort-by-date", defaultValue: "Sort by Date", comment: "Source control navigator sorting option"))
