...
struct SourceControlGeneralView: View {
    ...
    var body: some View {
        Group {
            Section(String(localized: "source-control.title", defaultValue: "Source Control", comment: "Source Control section header")) {
...
private extension SourceControlGeneralView {
    private var refreshLocalStatusAuto: some View {
        Toggle(
            String(localized: "source-control.refresh-local-status-automatically", defaultValue: "Refresh local status automatically", comment: "Refresh local status automatically toggle label"),
    ...
    private var fetchRefreshStatusAuto: some View {
        Toggle(
            String(localized: "source-control.fetch-and-refresh-server-status-automatically", defaultValue: "Fetch and refresh server status automatically", comment: "Fetch and refresh server status automatically toggle label"),
    ...
    private var addRemoveFilesAuto: some View {
        Toggle(
            String(localized: "source-control.add-and-remove-files-automatically", defaultValue: "Add and remove files automatically", comment: "Add and remove files automatically toggle label"),
    ...
    private var selectFilesToCommitAuto: some View {
        Toggle(
            String(localized: "source-control.select-files-to-commit-automatically", defaultValue: "Select files to commit automatically", comment: "Select files to commit automatically toggle label"),
    ...
    private var showSourceControlChanges: some View {
        Toggle(
            String(localized: "source-control.show-source-control-changes", defaultValue: "Show source control changes", comment: "Show source control changes toggle label"),
    ...
    private var includeUpstreamChanges: some View {
        Toggle(
            String(localized: "source-control.include-upstream-changes", defaultValue: "Include upstream changes", comment: "Include upstream changes toggle label"),
    ...
    private var comparisonView: some View {
        Picker(
            String(localized: "source-control.comparison-view", defaultValue: "Comparison view", comment: "Comparison view picker label"),
    ...
    private var sourceControlNavigator: some View {
        Picker(
            String(localized: "source-control.source-control-navigator", defaultValue: "Source control navigator", comment: "Source control navigator picker label"),
