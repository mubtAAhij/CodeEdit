...
struct SourceControlGeneralView: View {
    ...
    var body: some View {
        Group {
            Section(String(localized: "source-control-general.source-control", defaultValue: "Source Control", comment: "Source Control section header")) {
                refreshLocalStatusAuto
                fetchRefreshStatusAuto
                addRemoveFilesAuto
                selectFilesToCommitAuto
            }
            Section(String(localized: "source-control-general.text-editing", defaultValue: "Text Editing", comment: "Text Editing section header")) {
