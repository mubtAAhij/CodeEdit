...
private extension SourceControlGeneralView {
    ...
    private var comparisonView: some View {
        Picker(
            ...
            Text(String(localized: "source_control.comparison.local_left", comment: "Option to show local revision on left side"))
                .tag(SettingsData.RevisionComparisonLayout.localLeft)
            Text(String(localized: "source_control.comparison.local_right", comment: "Option to show local revision on right side"))
    ...
    private var sourceControlNavigator: some View {
        Picker(
            ...
            Text(String(localized: "source_control.navigator.sort_by_name", comment: "Sort source control navigator by name"))
                .tag(SettingsData.ControlNavigatorOrder.sortByName)
            Text(String(localized: "source_control.navigator.sort_by_date", comment: "Sort source control navigator by date"))
