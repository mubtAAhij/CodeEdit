...
struct IgnoredFilesListView: View {
    ...
    var body: some View {
        GlobPatternList(
            ...
            emptyMessage: String(localized: "source-control.ignored-files.empty", defaultValue: "No ignored files", comment: "Message shown when no ignored files are configured")
        )
    }
}
