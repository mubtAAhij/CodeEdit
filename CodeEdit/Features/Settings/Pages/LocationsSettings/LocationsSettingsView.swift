...
private extension LocationsSettingsView {
    @ViewBuilder private var applicationSupportLocation: some View {
        ExternalLink(destination: Settings.shared.baseURL) {
            Text(String(localized: "settings.locations.application-support", defaultValue: "Application Support", comment: "Application Support folder label in locations settings"))
    ...
    private var extensionsLocation: some View {
        ExternalLink(destination: ThemeModel.shared.extensionsURL) {
            Text(String(localized: "settings.locations.extensions", defaultValue: "Extensions", comment: "Extensions folder label in locations settings"))
