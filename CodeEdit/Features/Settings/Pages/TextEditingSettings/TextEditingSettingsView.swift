    ...
    @ViewBuilder private var indentOption: some View {
        Group {
            ...
            if textEditing.indentOption.indentType == .spaces {
                HStack {
                    Stepper(
                        String(localized: "settings.text-editing.indent-width", defaultValue: "Indent Width", comment: "Label for indent width setting"),
    ...
    @ViewBuilder private var invisibles: some View {
        HStack {
            ...
            Button {
                ...
                Text(String(localized: "settings.text-editing.configure-invisible", defaultValue: "Configure...", comment: "Button to configure invisible characters"))
            }
