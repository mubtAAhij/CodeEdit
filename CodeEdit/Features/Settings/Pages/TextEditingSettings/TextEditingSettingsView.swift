...
private extension TextEditingSettingsView {
    ...
    @ViewBuilder private var autocompleteBraces: some View {
        Toggle(isOn: $textEditing.autocompleteBraces) {
            Text(String(localized: "text-editing.autocomplete-braces", defaultValue: "Autocomplete braces", comment: "Autocomplete braces toggle label"))
    ...
    @ViewBuilder private var enableTypeOverCompletion: some View {
        Toggle(String(localized: "text-editing.enable-type-over-completion", defaultValue: "Enable type-over completion", comment: "Enable type-over completion toggle label"), isOn: $textEditing.enableTypeOverCompletion)
    }

    @ViewBuilder private var wrapLinesToEditorWidth: some View {
        Toggle(String(localized: "text-editing.wrap-lines", defaultValue: "Wrap lines to editor width", comment: "Wrap lines to editor width toggle label"), isOn: $textEditing.wrapLinesToEditorWidth)
    }

    @ViewBuilder private var useSystemCursor: some View {
        if #available(macOS 14, *) {
            Toggle(String(localized: "text-editing.use-system-cursor", defaultValue: "Use System Cursor", comment: "Use system cursor toggle label"), isOn: $textEditing.useSystemCursor)
        } else {
            EmptyView()
        }
    }
    ...
    @ViewBuilder private var overscroll: some View {
        Group {
            Picker(
                String(localized: "text-editing.editor-overscroll", defaultValue: "Editor Overscroll", comment: "Editor overscroll picker label"),
    ...
    @ViewBuilder private var indentOption: some View {
        Group {
            Picker(String(localized: "text-editing.prefer-indent-using", defaultValue: "Prefer Indent Using", comment: "Prefer indent using picker label"), selection: $textEditing.indentOption.indentType) {
                Text(String(localized: "text-editing.indent.tabs", defaultValue: "Tabs", comment: "Indent option tabs"))
                    .tag(SettingsData.TextEditingSettings.IndentOption.IndentType.tab)
                Text(String(localized: "text-editing.indent.spaces", defaultValue: "Spaces", comment: "Indent option spaces"))
            ...
            if textEditing.indentOption.indentType == .spaces {
                HStack {
                    ...
                    Text(String(localized: "text-editing.spaces-label", defaultValue: "spaces", comment: "Spaces label"))
    ...
    @ViewBuilder private var defaultTabWidth: some View {
        HStack(alignment: .top) {
            ...
            Text(String(localized: "text-editing.tab-width.spaces-label", defaultValue: "spaces", comment: "Spaces label for tab width"))
                .foregroundColor(.secondary)
        }
    ...
    @ViewBuilder private var bracketPairHighlight: some View {
        Group {
            Picker(
                String(localized: "text-editing.bracket-pair-highlight", defaultValue: "Bracket Pair Highlight", comment: "Bracket pair highlight picker label"),
                selection: $textEditing.bracketEmphasis.highlightType
            ) {
                Text(String(localized: "text-editing.bracket-highlight.disabled", defaultValue: "Disabled", comment: "Bracket highlight disabled option")).tag(SettingsData.TextEditingSettings.BracketPairEmphasis.HighlightType.disabled)
                Divider()
                Text(String(localized: "text-editing.bracket-highlight.bordered", defaultValue: "Bordered", comment: "Bracket highlight bordered option")).tag(SettingsData.TextEditingSettings.BracketPairEmphasis.HighlightType.bordered)
                Text(String(localized: "text-editing.bracket-highlight.flash", defaultValue: "Flash", comment: "Bracket highlight flash option")).tag(SettingsData.TextEditingSettings.BracketPairEmphasis.HighlightType.flash)
                Text(String(localized: "text-editing.bracket-highlight.underline", defaultValue: "Underline", comment: "Bracket highlight underline option")).tag(SettingsData.TextEditingSettings.BracketPairEmphasis.HighlightType.underline)
            }
            if [.bordered, .underline].contains(textEditing.bracketEmphasis.highlightType) {
                Toggle(String(localized: "text-editing.bracket-highlight.use-custom-color", defaultValue: "Use Custom Color", comment: "Use custom color toggle label"), isOn: $textEditing.bracketEmphasis.useCustomColor)
                SettingsColorPicker(
                    String(localized: "text-editing.bracket-highlight.color", defaultValue: "Bracket Pair Highlight Color", comment: "Bracket pair highlight color picker label"),
    ...
    @ViewBuilder private var showGutter: some View {
        Toggle(String(localized: "text-editing.show-gutter", defaultValue: "Show Gutter", comment: "Show gutter toggle label"), isOn: $textEditing.showGutter)
    ...
    @ViewBuilder private var showMinimap: some View {
        Toggle(String(localized: "text-editing.show-minimap", defaultValue: "Show Minimap", comment: "Show minimap toggle label"), isOn: $textEditing.showMinimap)
    ...
    @ViewBuilder private var showFoldingRibbon: some View {
        Toggle(String(localized: "text-editing.show-folding-ribbon", defaultValue: "Show Code Folding Ribbon", comment: "Show code folding ribbon toggle label"), isOn: $textEditing.showFoldingRibbon)
            .disabled(!textEditing.showGutter) // Disabled when the gutter is disabled
            // swiftlint:disable:next line_length
            .help(String(localized: "text-editing.show-folding-ribbon.help", defaultValue: "The code folding ribbon lets you fold regions of code. When the gutter is disabled, the folding ribbon is disabled.", comment: "Show folding ribbon help text"))
    }

    @ViewBuilder private var reformatSettings: some View {
        Toggle(String(localized: "text-editing.show-reformatting-guide", defaultValue: "Show Reformatting Guide", comment: "Show reformatting guide toggle label"), isOn: $textEditing.showReformattingGuide)
            .help(String(localized: "text-editing.show-reformatting-guide.help", defaultValue: "Shows a vertical guide at the reformat column.", comment: "Show reformatting guide help text"))

        Stepper(
            String(localized: "text-editing.reformat-at-column", defaultValue: "Reformat at Column", comment: "Reformat at column stepper label"),
            value: Binding<Double>(
        ...
        .help(String(localized: "text-editing.reformat-at-column.help", defaultValue: "The column at which text should be reformatted.", comment: "Reformat at column help text"))
    }

    @ViewBuilder private var invisibles: some View {
        HStack {
            Text(String(localized: "text-editing.show-invisible-characters", defaultValue: "Show Invisible Characters", comment: "Show invisible characters label"))
            Spacer()
            Toggle(isOn: $textEditing.invisibleCharacters.enabled, label: { EmptyView() })
            Button {
                isShowingInvisibleCharacterSettings = true
            } label: {
                Text(String(localized: "text-editing.configure-button", defaultValue: "Configure...", comment: "Configure button label"))
            }
    ...
    @ViewBuilder private var warningCharacters: some View {
        HStack {
            Text(String(localized: "text-editing.show-warning-characters", defaultValue: "Show Warning Characters", comment: "Show warning characters label"))
            Spacer()
