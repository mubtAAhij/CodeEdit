...
private extension TextEditingSettingsView {
    ...
    @ViewBuilder private var indentOption: some View {
        Group {
            Picker(String(localized: "text-editing.prefer-indent-using", defaultValue: "Prefer Indent Using", comment: "Indent type picker label"), selection: $textEditing.indentOption.indentType) {
    ...
    @ViewBuilder private var invisibles: some View {
        HStack {
            Text(String(localized: "text-editing.show-invisibles", defaultValue: "Show Invisible Characters", comment: "Show invisible characters toggle label"))
            Spacer()
            Toggle(isOn: $textEditing.invisibleCharacters.enabled, label: { EmptyView() })
            Button {
                isShowingInvisibleCharacterSettings = true
            } label: {
                Text(String(localized: "common.configure", defaultValue: "Configure...", comment: "Configure button"))
            }
