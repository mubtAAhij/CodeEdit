...
private extension TextEditingSettingsView {
    @ViewBuilder private var fontSelector: some View {
        MonospacedFontPicker(title: String(
            localized: "settings.text-editing.view.font",
            defaultValue: "Font",
            comment: "Section row title for font setting in text editing settings view."
    ...
    @ViewBuilder private var fontSizeSelector: some View {
        Stepper(
            String(
                localized: "settings.text-editing.view.font-size",
                defaultValue: "Font Size",
                comment: "Section row title for font size setting in text editing settings view."
            ),
    ...
    @ViewBuilder private var autocompleteBraces: some View {
        Toggle(isOn: $textEditing.autocompleteBraces) {
            Text(String(
                localized: "settings.text-editing.view.autocomplete-braces",
                defaultValue: "Autocomplete braces",
                comment: "Toggle label for autocomplete braces in text editing settings view."
            ))
            Text(String(
                localized: "settings.text-editing.view.autocomplete-braces.help",
                defaultValue: "Automatically insert closing braces (\"}\")",
                comment: "Help text describing autocomplete braces behavior."
            ))
        }
    }
    ...
    @ViewBuilder private var enableTypeOverCompletion: some View {
        Toggle(String(
            localized: "settings.text-editing.view.enable-type-over-completion",
    ...
    @ViewBuilder private var wrapLinesToEditorWidth: some View {
        Toggle(String(
            localized: "settings.text-editing.view.wrap-lines-to-editor-width",
    ...
    @ViewBuilder private var useSystemCursor: some View {
        if #available(macOS 14, *) {
            Toggle(String(
                localized: "settings.text-editing.view.use-system-cursor",
                defaultValue: "Use System Cursor",
                comment: "Toggle label for using system cursor in editor."
    ...
    @ViewBuilder private var overscroll: some View {
        Group {
            Picker(
                String(
                    localized: "settings.text-editing.view.editor-overscroll",
                    defaultValue: "Editor Overscroll",
                    comment: "Section title for editor overscroll setting."
                ),
                selection: $textEditing.overscroll
            ) {
                Text(String(
                    localized: "settings.text-editing.view.editor-overscroll.none",
                    defaultValue: "None",
                    comment: "Option label for no overscroll in editor."
                ))
                    .tag(SettingsData.TextEditingSettings.OverscrollOption.none)
                Divider()
                Text(String(
                    localized: "settings.text-editing.view.editor-overscroll.small",
                    defaultValue: "Small",
                    comment: "Option label for small overscroll in editor."
                ))
                    .tag(
                        SettingsData.TextEditingSettings.OverscrollOption.small
                    )
                Text(String(
                    localized: "settings.text-editing.view.editor-overscroll.medium",
                    defaultValue: "Medium",
                    comment: "Option label for medium overscroll in editor."
                ))
                    .tag(
                        SettingsData.TextEditingSettings.OverscrollOption.medium
                    )
                Text(String(
                    localized: "settings.text-editing.view.editor-overscroll.large",
                    defaultValue: "Large",
                    comment: "Option label for large overscroll in editor."
                ))
                    .tag(
    ...
    @ViewBuilder private var lineHeight: some View {
        Stepper(
            String(
                localized: "settings.text-editing.view.line-height",
                defaultValue: "Line Height",
                comment: "Section row title for line height setting."
            ),
    ...
    @ViewBuilder private var indentOption: some View {
        Group {
            Picker(String(
                localized: "settings.text-editing.view.prefer-indent-using",
                defaultValue: "Prefer Indent Using",
                comment: "Section title for preferred indentation type."
            ), selection: $textEditing.indentOption.indentType) {
                Text(String(
                    localized: "settings.text-editing.view.prefer-indent-using.tabs",
                    defaultValue: "Tabs",
                    comment: "Option label for tabs indentation."
                ))
                    .tag(SettingsData.TextEditingSettings.IndentOption.IndentType.tab)
                Text(String(
                    localized: "settings.text-editing.view.prefer-indent-using.spaces",
                    defaultValue: "Spaces",
                    comment: "Option label for spaces indentation."
                ))
            ...
            if textEditing.indentOption.indentType == .spaces {
                HStack {
                    Stepper(
                        String(
                            localized: "settings.text-editing.view.indent-width",
                            defaultValue: "Indent Width",
                            comment: "Section title for indent width setting."
                        ),
                    ...
                    Text(String(
                        localized: "settings.text-editing.view.indent-width.spaces-suffix",
                        defaultValue: "spaces",
                        comment: "Unit label for indent width value in spaces."
                    ))
                        .foregroundColor(.secondary)
                }
                .help(String(
                    localized: "settings.text-editing.view.indent-width.help",
                    defaultValue: "The number of spaces to insert when the tab key is pressed.",
                    comment: "Help text describing indent width setting."
                ))
            }
        }
    }
    ...
    @ViewBuilder private var defaultTabWidth: some View {
        HStack(alignment: .top) {
            Stepper(
                String(
                    localized: "settings.text-editing.view.tab-width",
                    defaultValue: "Tab Width",
                    comment: "Section title for tab width setting."
                ),
                value: Binding<Double>(
            ...
            Text(String(
                localized: "settings.text-editing.view.tab-width.spaces-suffix",
                defaultValue: "spaces",
                comment: "Unit label suffix for tab width value in spaces."
            ))
                .foregroundColor(.secondary)
        }
        .help(String(
            localized: "settings.text-editing.view.tab-width.help",
            defaultValue: "The visual width of tabs.",
            comment: "Help text describing tab width setting."
        ))
    }
    ...
    @ViewBuilder private var letterSpacing: some View {
        Stepper(
            String(
                localized: "settings.text-editing.view.letter-spacing",
                defaultValue: "Letter Spacing",
                comment: "Section row title for letter spacing setting."
            ),
    ...
    @ViewBuilder private var bracketPairHighlight: some View {
        Group {
            Picker(
                String(
                    localized: "settings.text-editing.view.bracket-pair-highlight",
                    defaultValue: "Bracket Pair Highlight",
                    comment: "Section title for bracket pair highlight settings."
                ),
                selection: $textEditing.bracketEmphasis.highlightType
            ) {
                Text(String(
                    localized: "settings.text-editing.view.bracket-pair-highlight.disabled",
                    defaultValue: "Disabled",
                    comment: "Option label for disabling bracket pair highlight."
                )).tag(SettingsData.TextEditingSettings.BracketPairEmphasis.HighlightType.disabled)
                Divider()
                Text(String(
                    localized: "settings.text-editing.view.bracket-pair-highlight.bordered",
                    defaultValue: "Bordered",
                    comment: "Option label for bordered bracket pair highlight style."
                )).tag(SettingsData.TextEditingSettings.BracketPairEmphasis.HighlightType.bordered)
                Text(String(
                    localized: "settings.text-editing.view.bracket-pair-highlight.flash",
                    defaultValue: "Flash",
                    comment: "Option label for flash bracket pair highlight style."
                )).tag(SettingsData.TextEditingSettings.BracketPairEmphasis.HighlightType.flash)
                Text(String(
                    localized: "settings.text-editing.view.bracket-pair-highlight.underline",
                    defaultValue: "Underline",
                    comment: "Option label for underline bracket pair highlight style."
            ...
            if [.bordered, .underline].contains(textEditing.bracketEmphasis.highlightType) {
                Toggle(String(
                    localized: "settings.text-editing.view.bracket-pair-highlight.use-custom-color",
                    defaultValue: "Use Custom Color",
                    comment: "Toggle label for using a custom bracket pair highlight color."
                ), isOn: $textEditing.bracketEmphasis.useCustomColor)
                SettingsColorPicker(
                    String(
                        localized: "settings.text-editing.view.bracket-pair-highlight.color",
    ...
    @ViewBuilder private var showMinimap: some View {
        Toggle(String(
            ...
            .help(String(
                ...
                comment: "Help text describing the minimap feature."
            ))
    }

    @ViewBuilder private var showFoldingRibbon: some View {
        Toggle(String(
            localized: "settings.text-editing.view.show-code-folding-ribbon",
            ...
            // swiftlint:disable:next line_length
            .help(String(
                localized: "settings.text-editing.view.show-code-folding-ribbon.help",
                ...
                comment: "Help text describing the code folding ribbon behavior."
            ))
    }

    @ViewBuilder private var reformatSettings: some View {
        Toggle(String(
            localized: "settings.text-editing.view.show-reformatting-guide",
            ...
            .help(String(
                localized: "settings.text-editing.view.show-reformatting-guide.help",
                defaultValue: "Shows a vertical guide at the reformat column.",
                comment: "Help text describing the reformatting guide."
            ))

        Stepper(
            String(
                localized: "settings.text-editing.view.reformat-at-column",
        ...
        .help(String(
            localized: "settings.text-editing.view.reformat-at-column.help",
            defaultValue: "The column at which text should be reformatted.",
            comment: "Help text describing reformat at column setting."
        ))
    }
    ...
    @ViewBuilder private var invisibles: some View {
        HStack {
            Text(String(
                ...
                comment: "Text editing settings toggle label for showing invisible characters"
            ))
            Spacer()
            ...
            Button {
                ...
                Text(String(
                    ...
                    comment: "Button title to configure invisible characters settings"
                ))
            }
    ...
    @ViewBuilder private var warningCharacters: some View {
        HStack {
            Text(String(
                ...
                comment: "Text editing settings toggle label for showing warning characters"
            ))
            Spacer()
            ...
            Button {
                ...
                Text(String(
                    ...
                    defaultValue: "Configure...",
                    comment: "Button title to configure warning characters settings"
                ))
            }
