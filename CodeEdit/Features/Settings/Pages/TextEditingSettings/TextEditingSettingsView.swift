...
private extension TextEditingSettingsView {
    ...
    @ViewBuilder private var autocompleteBraces: some View {
        Toggle(isOn: $textEditing.autocompleteBraces) {
            ...
            Text(String(localized: "text-editing.autocomplete-braces-subtitle", defaultValue: "Automatically insert closing braces (\"}\")", comment: "Automatically insert closing braces subtitle"))
        }
    }
    ...
    @ViewBuilder private var bracketPairHighlight: some View {
        Group {
            ...
            if [.bordered, .underline].contains(textEditing.bracketEmphasis.highlightType) {
                ...
                SettingsColorPicker(
                    String(localized: "text-editing.bracket-highlight-color", defaultValue: "Bracket Pair Highlight Color", comment: "Bracket Pair Highlight Color picker"),
    ...
    @ViewBuilder private var reformatSettings: some View {
        Toggle("Show Reformatting Guide", isOn: $textEditing.showReformattingGuide)
            .help(String(localized: "text-editing.reformat-guide-help", defaultValue: "Shows a vertical guide at the reformat column.", comment: "Reformat guide help text"))
