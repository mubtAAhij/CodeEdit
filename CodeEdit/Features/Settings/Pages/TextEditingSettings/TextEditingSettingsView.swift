...
private extension TextEditingSettingsView {
        ...
        Group {
            ...
            if textEditing.indentOption.indentType == .spaces {
                HStack {
                    ...
                    Text(String(localized: "settings.text-editing.indent-width.spaces-label", defaultValue: "spaces", comment: "Spaces label for indent width"))
    ...
    @ViewBuilder private var defaultTabWidth: some View {
        HStack(alignment: .top) {
            ...
            Text(String(localized: "settings.text-editing.tab-width.spaces-label", defaultValue: "spaces", comment: "Spaces label for tab width"))
                .foregroundColor(.secondary)
        }
    ...
    @ViewBuilder private var invisibles: some View {
        HStack {
            ...
            Button {
                ...
                Text(String(localized: "settings.text-editing.configure-invisibles", defaultValue: "Configure...", comment: "Configure invisibles button"))
            }
    ...
    @ViewBuilder private var warningCharacters: some View {
        HStack {
            ...
            Button {
                ...
                Text(String(localized: "settings.text-editing.configure-warnings", defaultValue: "Configure...", comment: "Configure warnings button"))
            }
