...
private extension TextEditingSettingsView {
    ...
    @ViewBuilder private var autocompleteBraces: some View {
        Toggle(isOn: $textEditing.autocompleteBraces) {
            ...
            Text(String(localized: "settings.text-editing.autocomplete-braces-help", defaultValue: "Automatically insert closing braces (\"}\")", comment: "Help text for autocomplete braces toggle"))
        }
    }
    ...
    @ViewBuilder private var bracketPairHighlight: some View {
        Group {
            ...
            if [.bordered, .underline].contains(textEditing.bracketEmphasis.highlightType) {
                Toggle(String(localized: "settings.text-editing.use-custom-color", defaultValue: "Use Custom Color", comment: "Toggle for using custom color"), isOn: $textEditing.bracketEmphasis.useCustomColor)
                SettingsColorPicker(
                    String(localized: "settings.text-editing.bracket-highlight-color", defaultValue: "Bracket Pair Highlight Color", comment: "Label for bracket pair highlight color picker"),
    ...
    @ViewBuilder private var showGutter: some View {
        Toggle("Show Gutter", isOn: $textEditing.showGutter)
            .help(String(localized: "settings.text-editing.gutter-help", defaultValue: "The gutter displays line numbers and code folding regions.", comment: "Help text for gutter toggle"))
    }
    ...
    @ViewBuilder private var showMinimap: some View {
        Toggle(String(localized: "settings.text-editing.show-minimap", defaultValue: "Show Minimap", comment: "Toggle for showing minimap"), isOn: $textEditing.showMinimap)
            ...
            .help(String(localized: "settings.text-editing.minimap-help", defaultValue: "The minimap gives you a high-level summary of your source code, with controls to quickly navigate your document.", comment: "Help text for minimap toggle"))
    }
    ...
    @ViewBuilder private var showFoldingRibbon: some View {
        Toggle(String(localized: "settings.text-editing.show-folding-ribbon", defaultValue: "Show Code Folding Ribbon", comment: "Toggle for showing code folding ribbon"), isOn: $textEditing.showFoldingRibbon)
            ...
            // swiftlint:disable:next line_length
            .help(String(localized: "settings.text-editing.folding-ribbon-help", defaultValue: "The code folding ribbon lets you fold regions of code. When the gutter is disabled, the folding ribbon is disabled.", comment: "Help text for folding ribbon toggle"))
    }

    @ViewBuilder private var reformatSettings: some View {
        Toggle("Show Reformatting Guide", isOn: $textEditing.showReformattingGuide)
            .help(String(localized: "settings.text-editing.reformatting-guide-help", defaultValue: "Shows a vertical guide at the reformat column.", comment: "Help text for reformatting guide toggle"))
        ...
        .help(String(localized: "settings.text-editing.reformat-column-help", defaultValue: "The column at which text should be reformatted.", comment: "Help text for reformat column stepper"))
    }
    ...
    @ViewBuilder private var invisibles: some View {
        HStack {
            ...
            Button {
                ...
                Text(String(localized: "settings.text-editing.configure-ellipsis", defaultValue: "Configure...", comment: "Button to configure settings"))
            }
