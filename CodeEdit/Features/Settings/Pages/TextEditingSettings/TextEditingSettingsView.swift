...
private extension TextEditingSettingsView {
    @ViewBuilder private var fontSelector: some View {
        MonospacedFontPicker(
            title: String(
                localized: "text-editing-settings.font",
                defaultValue: "Font",
                comment: "Label for font selection picker"
            ),
    ...
    @ViewBuilder private var fontSizeSelector: some View {
        Stepper(
            String(
                localized: "text-editing-settings.font-size",
                defaultValue: "Font Size",
                comment: "Label for font size stepper"
            ),
    ...
    @ViewBuilder private var autocompleteBraces: some View {
        Toggle(isOn: $textEditing.autocompleteBraces) {
            ...
            Text(String(
                localized: "text-editing-settings.autocomplete-braces-description",
    ...
    @ViewBuilder private var useSystemCursor: some View {
        if #available(macOS 14, *) {
            Toggle(
                String(
                    localized: "text-editing-settings.use-system-cursor",
                    defaultValue: "Use System Cursor",
                    comment: "Toggle to use system cursor instead of custom cursor"
                ),
    ...
    @ViewBuilder private var overscroll: some View {
        Group {
            Picker(
                ...
                Text(String(
                    localized: "text-editing-settings.overscroll.none",
                    defaultValue: "None",
                    comment: "No overscroll option"
                ))
                    .tag(SettingsData.TextEditingSettings.OverscrollOption.none)
                Divider()
                Text(String(
                    localized: "text-editing-settings.overscroll.small",
                    defaultValue: "Small",
                    comment: "Small overscroll option"
                ))
                    .tag(
                        SettingsData.TextEditingSettings.OverscrollOption.small
                    )
                Text(String(
                    localized: "text-editing-settings.overscroll.medium",
                    defaultValue: "Medium",
                    comment: "Medium overscroll option"
                ))
                    .tag(
                        SettingsData.TextEditingSettings.OverscrollOption.medium
                    )
                Text(String(
                    localized: "text-editing-settings.overscroll.large",
                    defaultValue: "Large",
                    comment: "Large overscroll option"
                ))
                    .tag(
    ...
    @ViewBuilder private var indentOption: some View {
        Group {
            Picker("Prefer Indent Using", selection: $textEditing.indentOption.indentType) {
                Text(String(
                    localized: "text-editing-settings.indent.tabs",
                    defaultValue: "Tabs",
                    comment: "Indent using tabs option"
                ))
                    .tag(SettingsData.TextEditingSettings.IndentOption.IndentType.tab)
                Text(String(
                    localized: "text-editing-settings.indent.spaces",
                    defaultValue: "Spaces",
                    comment: "Indent using spaces option"
                ))
            ...
            if textEditing.indentOption.indentType == .spaces {
                HStack {
                    Stepper(
                        String(
                            localized: "text-editing-settings.indent-width",
                    ...
                    Text(String(
                        localized: "text-editing-settings.indent-width-unit",
                        defaultValue: "spaces",
                        comment: "Unit label for indent width (spaces)"
                    ))
                        .foregroundColor(.secondary)
                }
                .help(String(
                    localized: "text-editing-settings.indent-width-help",
    ...
    @ViewBuilder private var defaultTabWidth: some View {
        HStack(alignment: .top) {
            ...
            Text(String(
                localized: "text-editing-settings.tab-width-unit",
                defaultValue: "spaces",
                comment: "Unit label for tab width (spaces)"
            ))
                .foregroundColor(.secondary)
        }
        .help(String(
            localized: "text-editing-settings.tab-width-help",
    ...
    @ViewBuilder private var bracketPairHighlight: some View {
        Group {
            Picker(
                ...
                Text(String(
                    localized: "text-editing-settings.bracket-highlight.disabled",
                    defaultValue: "Disabled",
                    comment: "Disabled bracket highlight option"
                )).tag(SettingsData.TextEditingSettings.BracketPairEmphasis.HighlightType.disabled)
                Divider()
                Text(String(
                    localized: "text-editing-settings.bracket-highlight.bordered",
                    defaultValue: "Bordered",
                    comment: "Bordered bracket highlight option"
                )).tag(SettingsData.TextEditingSettings.BracketPairEmphasis.HighlightType.bordered)
                Text(String(
                    localized: "text-editing-settings.bracket-highlight.flash",
                    defaultValue: "Flash",
                    comment: "Flash bracket highlight option"
                )).tag(SettingsData.TextEditingSettings.BracketPairEmphasis.HighlightType.flash)
                Text(String(
                    localized: "text-editing-settings.bracket-highlight.underline",
                    defaultValue: "Underline",
                    comment: "Underline bracket highlight option"
            ...
            if [.bordered, .underline].contains(textEditing.bracketEmphasis.highlightType) {
                Toggle(
                    String(
                        localized: "text-editing-settings.bracket-highlight.use-custom-color",
                        defaultValue: "Use Custom Color",
                        comment: "Toggle to use custom color for bracket highlighting"
                    ),
                    isOn: $textEditing.bracketEmphasis.useCustomColor
                )
                SettingsColorPicker(
                    String(
                        localized: "text-editing-settings.bracket-highlight-color",
    ...
    @ViewBuilder private var showGutter: some View {
        Toggle("Show Gutter", isOn: $textEditing.showGutter)
            .help(String(
                localized: "text-editing-settings.show-gutter-help",
                defaultValue: "The gutter displays line numbers and code folding regions.",
                comment: "Help text for show gutter toggle"
            ))
    }
    ...
    @ViewBuilder private var showMinimap: some View {
        Toggle(
            String(
                localized: "text-editing-settings.show-minimap",
                defaultValue: "Show Minimap",
                comment: "Toggle to show minimap in editor"
            ),
            isOn: $textEditing.showMinimap
        )
            // swiftlint:disable:next line_length
            .help(String(
                localized: "text-editing-settings.show-minimap-help",
                ...
                comment: "Help text for show minimap toggle"
            ))
    }
    ...
    @ViewBuilder private var showFoldingRibbon: some View {
        Toggle(
            String(
                localized: "text-editing-settings.show-folding-ribbon",
                defaultValue: "Show Code Folding Ribbon",
                comment: "Toggle to show code folding ribbon in editor"
            ),
            ...
            // swiftlint:disable:next line_length
            .help(String(
                localized: "text-editing-settings.show-folding-ribbon-help",
                ...
                comment: "Help text for show code folding ribbon toggle"
            ))
    }
    ...
    @ViewBuilder private var reformatSettings: some View {
        Toggle("Show Reformatting Guide", isOn: $textEditing.showReformattingGuide)
            .help(String(
                localized: "text-editing-settings.show-reformatting-guide-help",
                defaultValue: "Shows a vertical guide at the reformat column.",
                comment: "Help text for show reformatting guide toggle"
            ))
        ...
        .help(String(
            localized: "text-editing-settings.reformat-at-column-help",
            defaultValue: "The column at which text should be reformatted.",
            comment: "Help text for reformat at column stepper"
        ))
    }
    ...
    @ViewBuilder private var invisibles: some View {
        HStack {
            Text(String(
                localized: "text-editing-settings.show-invisible-characters",
                defaultValue: "Show Invisible Characters",
                comment: "Label for show invisible characters setting"
            ))
            Spacer()
            ...
            Button {
                ...
                Text(String(
                    localized: "text-editing-settings.configure",
                    defaultValue: "Configure...",
                    comment: "Button to configure invisible characters settings"
                ))
            }
    ...
    @ViewBuilder private var warningCharacters: some View {
        HStack {
            Text(String(
                localized: "text-editing-settings.show-warning-characters",
                defaultValue: "Show Warning Characters",
                comment: "Label for show warning characters setting"
            ))
            Spacer()
