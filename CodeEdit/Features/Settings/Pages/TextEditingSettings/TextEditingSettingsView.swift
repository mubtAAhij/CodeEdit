...
private extension TextEditingSettingsView {
    ...
    @ViewBuilder private var useSystemCursor: some View {
        if #available(macOS 14, *) {
            Toggle(String(localized: "text-editing-settings.use-system-cursor", defaultValue: "Use System Cursor", comment: "Use system cursor toggle"), isOn: $textEditing.useSystemCursor)
        } else {
            EmptyView()
        }
    }
    ...
    @ViewBuilder private var overscroll: some View {
        Group {
            Picker(
                ...
                Text(String(localized: "text-editing-settings.overscroll-none", defaultValue: "None", comment: "None overscroll option"))
        ...
        Group {
            ...
            if textEditing.indentOption.indentType == .spaces {
                HStack {
                    ...
                    Text(String(localized: "text-editing-settings.spaces-unit", defaultValue: "spaces", comment: "Spaces unit label"))
    ...
    @ViewBuilder private var defaultTabWidth: some View {
        HStack(alignment: .top) {
            ...
            Text(String(localized: "text-editing-settings.tab-width-spaces-unit", defaultValue: "spaces", comment: "Spaces unit label for tab width"))
                .foregroundColor(.secondary)
        }
    ...
    @ViewBuilder private var bracketPairHighlight: some View {
        Group {
            ...
            if [.bordered, .underline].contains(textEditing.bracketEmphasis.highlightType) {
                Toggle(String(localized: "text-editing-settings.use-custom-color", defaultValue: "Use Custom Color", comment: "Use custom color toggle"), isOn: $textEditing.bracketEmphasis.useCustomColor)
                SettingsColorPicker(
                    String(localized: "text-editing-settings.bracket-highlight-color", defaultValue: "Bracket Pair Highlight Color", comment: "Bracket pair highlight color picker label"),
    ...
    @ViewBuilder private var showGutter: some View {
        Toggle("Show Gutter", isOn: $textEditing.showGutter)
            .help(String(localized: "text-editing-settings.show-gutter-help", defaultValue: "The gutter displays line numbers and code folding regions.", comment: "Show gutter help text"))
    }

    @ViewBuilder private var showMinimap: some View {
        Toggle("Show Minimap", isOn: $textEditing.showMinimap)
            // swiftlint:disable:next line_length
            .help(String(localized: "text-editing-settings.show-minimap-help", defaultValue: "The minimap gives you a high-level summary of your source code, with controls to quickly navigate your document.", comment: "Show minimap help text"))
    }

    @ViewBuilder private var showFoldingRibbon: some View {
        Toggle(String(localized: "text-editing-settings.show-code-folding-ribbon", defaultValue: "Show Code Folding Ribbon", comment: "Show code folding ribbon toggle"), isOn: $textEditing.showFoldingRibbon)
            .disabled(!textEditing.showGutter) // Disabled when the gutter is disabled
            // swiftlint:disable:next line_length
            .help(String(localized: "text-editing-settings.show-folding-ribbon-help", defaultValue: "The code folding ribbon lets you fold regions of code. When the gutter is disabled, the folding ribbon is disabled.", comment: "Show folding ribbon help text"))
    }

    @ViewBuilder private var reformatSettings: some View {
        Toggle("Show Reformatting Guide", isOn: $textEditing.showReformattingGuide)
            .help(String(localized: "text-editing-settings.show-reformatting-guide-help", defaultValue: "Shows a vertical guide at the reformat column.", comment: "Show reformatting guide help text"))
        ...
        .help(String(localized: "text-editing-settings.reformat-at-column-help", defaultValue: "The column at which text should be reformatted.", comment: "Reformat at column help text"))
    }
    ...
    @ViewBuilder private var invisibles: some View {
        HStack {
            ...
            Button {
                ...
                Text(String(localized: "text-editing-settings.configure-invisible-characters", defaultValue: "Configure...", comment: "Configure invisible characters button"))
            }
    ...
    @ViewBuilder private var warningCharacters: some View {
        HStack {
            ...
            Button {
                ...
                Text(String(localized: "text-editing-settings.configure-warning-characters", defaultValue: "Configure...", comment: "Configure warning characters button"))
            }
