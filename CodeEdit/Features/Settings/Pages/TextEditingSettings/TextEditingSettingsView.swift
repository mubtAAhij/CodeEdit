...
private extension TextEditingSettingsView {
    @ViewBuilder private var fontSelector: some View {
        MonospacedFontPicker(title: String(localized: "text-editing.font", defaultValue: "Font", comment: "Label for editor font picker"), selectedFontName: $textEditing.font.name)
    }

    @ViewBuilder private var fontSizeSelector: some View {
        Stepper(
            String(localized: "text-editing.font-size", defaultValue: "Font Size", comment: "Label for editor font size stepper"),
    ...
    @ViewBuilder private var autocompleteBraces: some View {
        Toggle(isOn: $textEditing.autocompleteBraces) {
            Text(String(localized: "text-editing.autocomplete-braces", defaultValue: "Autocomplete braces", comment: "Toggle to automatically complete braces"))
    ...
    @ViewBuilder private var enableTypeOverCompletion: some View {
        Toggle(String(localized: "text-editing.type-over-completion", defaultValue: "Enable type-over completion", comment: "Toggle for type-over completion"), isOn: $textEditing.enableTypeOverCompletion)
    }
    ...
    @ViewBuilder private var indentOption: some View {
        Group {
            Picker(String(localized: "text-editing.prefer-indent", defaultValue: "Prefer Indent Using", comment: "Label for indent preference picker"), selection: $textEditing.indentOption.indentType) {
    ...
    @ViewBuilder private var bracketPairHighlight: some View {
        Group {
            ...
            if [.bordered, .underline].contains(textEditing.bracketEmphasis.highlightType) {
                Toggle(String(localized: "text-editing.bracket-highlight.use-custom-color", defaultValue: "Use Custom Color", comment: "Toggle for custom bracket highlight color"), isOn: $textEditing.bracketEmphasis.useCustomColor)
                SettingsColorPicker(
    ...
    @ViewBuilder private var reformatSettings: some View {
        ...
        Stepper(
            String(localized: "text-editing.reformat-column", defaultValue: "Reformat at Column", comment: "Label for reformat at column stepper"),
            value: Binding<Double>(
        ...
        .help(String(localized: "text-editing.reformat-column.help", defaultValue: "The column at which text should be reformatted.", comment: "Help text for reformat at column stepper"))
    }
    ...
    @ViewBuilder private var invisibles: some View {
        HStack {
            ...
            Button {
                ...
                Text(String(localized: "text-editing.configure", defaultValue: "Configure...", comment: "Button to configure invisible characters"))
            }
    ...
    @ViewBuilder private var warningCharacters: some View {
        HStack {
            ...
            Button {
                ...
                Text(String(localized: "text-editing.configure", defaultValue: "Configure...", comment: "Button to configure warning characters"))
            }
