...
private extension TextEditingSettingsView {
    @ViewBuilder private var fontSelector: some View {
        MonospacedFontPicker(title: String(
            ...
            defaultValue: "Font",
            comment: "Text editing settings view label for font selection"
    ...
    @ViewBuilder private var fontSizeSelector: some View {
        Stepper(
            String(
                ...
                comment: "Text editing settings view label for font size"
            ),
    ...
    @ViewBuilder private var autocompleteBraces: some View {
        Toggle(isOn: $textEditing.autocompleteBraces) {
            Text(String(
                ...
                comment: "Text editing settings view toggle label for autocompleting braces"
            ))
            Text(String(
                localized: "settings.text-editing.view.autocomplete-braces.description",
                defaultValue: "Automatically insert closing braces (\"}\")",
                comment: "Description for autocomplete braces setting"
            ))
        }
    }
    ...
    @ViewBuilder private var enableTypeOverCompletion: some View {
        Toggle(String(
            ...
            comment: "Text editing settings view toggle label for type-over completion"
    ...
    @ViewBuilder private var wrapLinesToEditorWidth: some View {
        Toggle(String(
            ...
            comment: "Text editing settings view toggle label for line wrapping"
    ...
    @ViewBuilder private var useSystemCursor: some View {
        if #available(macOS 14, *) {
            Toggle(String(
                ...
                comment: "Text editing settings view toggle label for using system cursor"
        ...
        Group {
            Picker(
                String(
                    ...
                    comment: "Text editing settings view label for editor overscroll amount"
                ),
                ...
                Text(String(
                    ...
                    defaultValue: "None",
                    comment: "Editor overscroll option for none"
                ))
                ...
                Text(String(
                    ...
                    defaultValue: "Small",
                    comment: "Editor overscroll option for small amount"
                ))
                    .tag(
                ...
                Text(String(
                    ...
                    defaultValue: "Medium",
                    comment: "Editor overscroll option for medium amount"
                ))
                    .tag(
                ...
                Text(String(
                    ...
                    defaultValue: "Large",
                    comment: "Editor overscroll option for large amount"
                ))
                    .tag(
    ...
    @ViewBuilder private var lineHeight: some View {
        Stepper(
            String(
                ...
                comment: "Text editing settings view label for line height"
            ),
    ...
    @ViewBuilder private var indentOption: some View {
        Group {
            Picker(String(
                ...
                comment: "Text editing settings view label for preferred indentation method"
            ), selection: $textEditing.indentOption.indentType) {
                Text(String(
                    localized: "settings.text-editing.view.prefer-indent-using.tabs",
                    defaultValue: "Tabs",
                    comment: "Indentation option for tabs"
                ))
                ...
                Text(String(
                    ...
                    defaultValue: "Spaces",
                    comment: "Indentation option for spaces"
                ))
            ...
            if textEditing.indentOption.indentType == .spaces {
                HStack {
                    Stepper(
                        String(
                            ...
                            comment: "Text editing settings view label for indent width"
                        ),
                    ...
                    Text(String(
                        localized: "settings.text-editing.view.indent-width.unit-spaces",
                        defaultValue: "spaces",
                        comment: "Unit label for indent width value"
                    ))
                ...
                .help(String(
                    ...
                    comment: "Description for indent width setting"
                ))
            }
        }
    }
        ...
        HStack(alignment: .top) {
            Stepper(
                String(
                    ...
                    comment: "Text editing settings view label for tab width"
                ),
                value: Binding<Double>(
            ...
            Text(String(
                localized: "settings.text-editing.view.tab-width.unit-spaces",
                defaultValue: "spaces",
                comment: "Unit label for tab width value in spaces"
            ))
                .foregroundColor(.secondary)
        }
        .help(String(
    ...
    @ViewBuilder private var letterSpacing: some View {
        Stepper(
            String(
                ...
                comment: "Text editing settings view label for letter spacing"
            ),
        ...
        Group {
            Picker(
                String(
                    ...
                    comment: "Text editing settings view label for bracket pair highlight mode"
                ),
                ...
                Text(String(
                    ...
                    comment: "Bracket pair highlight option disabled"
                ...
                Text(String(
                    ...
                    comment: "Bracket pair highlight option bordered"
                ...
                Text(String(
                    ...
                    defaultValue: "Flash",
                    comment: "Bracket pair highlight option flash"
                ...
                Text(String(
                    ...
                    comment: "Bracket pair highlight option underline"
            ...
            if [.bordered, .underline].contains(textEditing.bracketEmphasis.highlightType) {
                ...
                SettingsColorPicker(
                    String(
                        ...
                        comment: "Color picker label for bracket pair highlight color"
                    ),
    ...
    @ViewBuilder private var showGutter: some View {
        Toggle(String(
            ...
            comment: "Toggle label for showing gutter"
    ...
    @ViewBuilder private var reformatSettings: some View {
        ...
        Stepper(
            String(
                ...
                comment: "Label for reformat at column value"
            ),
            value: Binding<Double>(
        ...
        .help(String(
            ...
            comment: "Description for reformat at column setting"
        ))
    }
    ...
    @ViewBuilder private var invisibles: some View {
        HStack {
            Text(String(
                localized: "settings.text-editing.invisible-characters.show",
                defaultValue: "Show Invisible Characters",
                comment: "Toggle title for showing invisible characters in editor"
            ))
            Spacer()
            ...
            Button {
                ...
                Text(String(
                    ...
                    comment: "Button title to configure invisible character options"
                ))
            }
    ...
    @ViewBuilder private var warningCharacters: some View {
        HStack {
            Text(String(
                localized: "settings.text-editing.warning-characters.show",
                defaultValue: "Show Warning Characters",
                comment: "Toggle title for showing warning characters in editor"
            ))
            Spacer()
            ...
            Button {
                ...
                Text(String(
                    ...
                    defaultValue: "Configure...",
                    comment: "Button title to configure warning character options"
                ))
            }
