    ...
    struct TextEditingSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            var keys = [
                ...
                "Show Gutter",
                "String(localized: "show_minimap", comment: "Setting option to display minimap in editor")",
                "Reformat at Column",
            ...
            if #available(macOS 14.0, *) {
                keys.append("String(localized: "system_cursor", comment: "Setting option to use system cursor")")
            }
        ...
        private func populateCommands() {
            ...
            mgr.addCommand(name: "String(localized: "toggle_minimap", comment: "Command for toggling minimap display")", title: "String(localized: "toggle_minimap", comment: "Command for toggling minimap display")", id: "prefs.text_editing.toggle_minimap") {
                Settings[\.textEditing].showMinimap.toggle()
            }

            mgr.addCommand(name: "String(localized: "toggle_gutter", comment: "Command for toggling gutter display")", title: "String(localized: "toggle_gutter", comment: "Command for toggling gutter display")", id: "prefs.text_editing.toggle_gutter") {
            ...
            mgr.addCommand(
                ...
                title: "String(localized: "toggle_folding_ribbon", comment: "Command title for toggling folding ribbon")",
