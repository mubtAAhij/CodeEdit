    ...
    struct TextEditingSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            var keys = [
                ...
                "Editor Overscroll",
                String(localized: "settings.text-editing.font", defaultValue: "Font", comment: "Font setting in search keys"),
                String(localized: "settings.text-editing.font-size", defaultValue: "Font Size", comment: "Font size setting in search keys"),
                "Font Weight",
                "Line Height",
                "Letter Spacing",
                "Autocomplete braces",
                ...
                "Show Gutter",
                String(localized: "settings.text-editing.show-minimap", defaultValue: "Show Minimap", comment: "Show minimap setting in search keys"),
                "Reformat at Column",
        ...
        private func populateCommands() {
            ...
            mgr.addCommand(
                name: String(localized: "command.toggle-autocomplete-braces.name", defaultValue: "Toggle Autocomplete Braces", comment: "Command name for toggle autocomplete braces"),
                title: String(localized: "command.toggle-autocomplete-braces.title", defaultValue: "Toggle Autocomplete Braces", comment: "Command title for toggle autocomplete braces"),
            ...
            mgr.addCommand(
                name: String(localized: "command.toggle-word-wrap.name", defaultValue: "Toggle Word Wrap", comment: "Command name for toggle word wrap"),
                title: String(localized: "command.toggle-word-wrap.title", defaultValue: "Toggle Word Wrap", comment: "Command title for toggle word wrap"),
            ...
            mgr.addCommand(name: String(localized: "command.toggle-minimap.name", defaultValue: "Toggle Minimap", comment: "Command name for toggle minimap"), title: String(localized: "command.toggle-minimap.title", defaultValue: "Toggle Minimap", comment: "Command title for toggle minimap"), id: "prefs.text_editing.toggle_minimap") {
                Settings[\.textEditing].showMinimap.toggle()
            }

            mgr.addCommand(name: String(localized: "command.toggle-gutter.name", defaultValue: "Toggle Gutter", comment: "Command name for toggle gutter"), title: String(localized: "command.toggle-gutter.title", defaultValue: "Toggle Gutter", comment: "Command title for toggle gutter"), id: "prefs.text_editing.toggle_gutter") {
                Settings[\.textEditing].showGutter.toggle()
            }

            mgr.addCommand(
                name: String(localized: "command.toggle-folding-ribbon.name", defaultValue: "Toggle Folding Ribbon", comment: "Command name for toggle folding ribbon"),
                title: String(localized: "command.toggle-folding-ribbon.title", defaultValue: "Toggle Folding Ribbon", comment: "Command title for toggle folding ribbon"),
