    ...
    struct TextEditingSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            var keys = [
                ...
                String(localized: "settings.text-editing.enable-type-over-completion", defaultValue: "Enable type-over completion", comment: "Enable type-over completion search key"),
        ...
        private func populateCommands() {
            ...
            mgr.addCommand(
                name: String(localized: "commands.text-editing.toggle-type-over-completion.name", defaultValue: "Toggle Type-Over Completion", comment: "Toggle type-over completion command name"),
                title: String(localized: "commands.text-editing.toggle-type-over-completion.title", defaultValue: "Toggle Type-Over Completion", comment: "Toggle type-over completion command title"),
            ...
            mgr.addCommand(
                name: String(localized: "commands.text-editing.toggle-autocomplete-braces.name", defaultValue: "Toggle Autocomplete Braces", comment: "Toggle autocomplete braces command name"),
                title: String(localized: "commands.text-editing.toggle-autocomplete-braces.title", defaultValue: "Toggle Autocomplete Braces", comment: "Toggle autocomplete braces command title"),
            ...
            mgr.addCommand(
                name: String(localized: "commands.text-editing.toggle-word-wrap.name", defaultValue: "Toggle Word Wrap", comment: "Toggle word wrap command name"),
                title: String(localized: "commands.text-editing.toggle-word-wrap.title", defaultValue: "Toggle Word Wrap", comment: "Toggle word wrap command title"),
            ...
            mgr.addCommand(name: String(localized: "commands.text-editing.toggle-minimap.name", defaultValue: "Toggle Minimap", comment: "Toggle minimap command name"), title: String(localized: "commands.text-editing.toggle-minimap.title", defaultValue: "Toggle Minimap", comment: "Toggle minimap command title"), id: "prefs.text_editing.toggle_minimap") {
                Settings[\.textEditing].showMinimap.toggle()
            }

            mgr.addCommand(name: String(localized: "commands.text-editing.toggle-gutter.name", defaultValue: "Toggle Gutter", comment: "Toggle gutter command name"), title: String(localized: "commands.text-editing.toggle-gutter.title", defaultValue: "Toggle Gutter", comment: "Toggle gutter command title"), id: "prefs.text_editing.toggle_gutter") {
                Settings[\.textEditing].showGutter.toggle()
            }

            mgr.addCommand(
                name: String(localized: "commands.text-editing.toggle-folding-ribbon.name", defaultValue: "Toggle Folding Ribbon", comment: "Toggle folding ribbon command name"),
                title: String(localized: "commands.text-editing.toggle-folding-ribbon.title", defaultValue: "Toggle Folding Ribbon", comment: "Toggle folding ribbon command title"),
        ...
        struct WarningCharacters: Equatable, Hashable, Codable {
            static let `default`: WarningCharacters = WarningCharacters(enabled: true, characters: [
                0x0003: String(localized: "settings.text-editing.warning-characters.end-of-text", defaultValue: "End of text", comment: "End of text warning character"),

                0x00A0: String(localized: "settings.text-editing.warning-characters.non-breaking-space", defaultValue: "Non-breaking space", comment: "Non-breaking space warning character"),
                0x202F: String(localized: "settings.text-editing.warning-characters.narrow-non-breaking-space", defaultValue: "Narrow non-breaking space", comment: "Narrow non-breaking space warning character"),
                0x200B: String(localized: "settings.text-editing.warning-characters.zero-width-space", defaultValue: "Zero-width space", comment: "Zero-width space warning character"),
                0x200C: String(localized: "settings.text-editing.warning-characters.zero-width-non-joiner", defaultValue: "Zero-width non-joiner", comment: "Zero-width non-joiner warning character"),
                0x2029: String(localized: "settings.text-editing.warning-characters.paragraph-separator", defaultValue: "Paragraph separator", comment: "Paragraph separator warning character"),

                0x2013: String(localized: "settings.text-editing.warning-characters.em-dash", defaultValue: "Em-dash", comment: "Em-dash warning character"),
                0x00AD: String(localized: "settings.text-editing.warning-characters.soft-hyphen", defaultValue: "Soft hyphen", comment: "Soft hyphen warning character"),

                0x2018: String(localized: "settings.text-editing.warning-characters.left-single-quote", defaultValue: "Left single quote", comment: "Left single quote warning character"),
                0x2019: String(localized: "settings.text-editing.warning-characters.right-single-quote", defaultValue: "Right single quote", comment: "Right single quote warning character"),
                0x201C: String(localized: "settings.text-editing.warning-characters.left-double-quote", defaultValue: "Left double quote", comment: "Left double quote warning character"),
                0x201D: String(localized: "settings.text-editing.warning-characters.right-double-quote", defaultValue: "Right double quote", comment: "Right double quote warning character"),

                0x037E: String(localized: "settings.text-editing.warning-characters.greek-question-mark", defaultValue: "Greek Question Mark", comment: "Greek question mark warning character")
            ])
