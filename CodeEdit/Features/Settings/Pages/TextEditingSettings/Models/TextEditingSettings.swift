    ...
    struct TextEditingSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            var keys = [
                ...
                "Editor Overscroll",
                String(localized: "settings.text_editing.font", comment: "Search key"),
                String(localized: "settings.text_editing.font_size", comment: "Search key"),
                "Font Weight",
                "Line Height",
                "Letter Spacing",
                "Autocomplete braces",
                ...
                "Show Gutter",
                String(localized: "settings.text_editing.show_minimap", comment: "Search key"),
                "Reformat at Column",
