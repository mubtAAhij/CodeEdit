    ...
    struct TextEditingSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        private func populateCommands() {
            ...
            mgr.addCommand(
                ...
                title: String(localized: "settings.text-editing.command.toggle-autocomplete-braces", defaultValue: "Toggle Autocomplete Braces", comment: "Command title for toggling autocomplete braces"),
            ...
            mgr.addCommand(
                ...
                title: String(localized: "settings.text-editing.command.toggle-word-wrap", defaultValue: "Toggle Word Wrap", comment: "Command title for toggling word wrap"),
            ...
            mgr.addCommand(name: String(localized: "settings.text-editing.command.toggle-minimap", defaultValue: "Toggle Minimap", comment: "Command name for toggling minimap"), title: String(localized: "settings.text-editing.command.toggle-minimap", defaultValue: "Toggle Minimap", comment: "Command title for toggling minimap"), id: "prefs.text_editing.toggle_minimap") {
            ...
            mgr.addCommand(
                ...
                title: String(localized: "settings.text-editing.command.toggle-folding-ribbon", defaultValue: "Toggle Folding Ribbon", comment: "Command title for toggling folding ribbon"),
