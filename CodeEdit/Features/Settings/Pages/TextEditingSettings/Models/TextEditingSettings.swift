...
extension SettingsData {
    ...
    struct TextEditingSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            ...
            if #available(macOS 14.0, *) {
                keys.append(String(
                    ...
                    comment: "Text editing settings toggle for using system cursor"
                ))
            }
        ...
        private func populateCommands() {
            ...
            mgr.addCommand(
                name: String(
                    localized: "settings.text-editing.toggle-type-over-completion.title",
                    defaultValue: "Toggle Type-Over Completion",
                    comment: "Command title for toggling type-over completion"
                ),
                title: String(
                    localized: "settings.text-editing.toggle-type-over-completion.action",
                    defaultValue: "Toggle Type-Over Completion",
                    comment: "Menu action label for toggling type-over completion"
                ),
            ...
            mgr.addCommand(
                name: String(
                    localized: "settings.text-editing.toggle-autocomplete-braces.title",
                    defaultValue: "Toggle Autocomplete Braces",
                    comment: "Command title for toggling autocomplete braces"
                ),
                title: String(
                    localized: "settings.text-editing.toggle-autocomplete-braces.action",
                    defaultValue: "Toggle Autocomplete Braces",
                    comment: "Menu action label for toggling autocomplete braces"
                ),
            ...
            mgr.addCommand(
                name: String(
                    localized: "settings.text-editing.toggle-word-wrap.title",
                    defaultValue: "Toggle Word Wrap",
                    comment: "Command title for toggling word wrap"
                ),
                title: String(
                    localized: "settings.text-editing.toggle-word-wrap.action",
                    defaultValue: "Toggle Word Wrap",
                    comment: "Menu action label for toggling word wrap"
                ),
            ...
            mgr.addCommand(
                name: String(
                    localized: "settings.text-editing.toggle-folding-ribbon.title",
                    defaultValue: "Toggle Folding Ribbon",
                    comment: "Command title for toggling folding ribbon visibility"
                ),
                title: String(
                    localized: "settings.text-editing.toggle-folding-ribbon.action",
                    defaultValue: "Toggle Folding Ribbon",
                    comment: "Menu action label for toggling folding ribbon visibility"
                ),
        ...
        struct WarningCharacters: Equatable, Hashable, Codable {
            static let `default`: WarningCharacters = WarningCharacters(enabled: true, characters: [
                0x0003: String(
                    ...
                    comment: "Warning character name for end of text"
                ),
