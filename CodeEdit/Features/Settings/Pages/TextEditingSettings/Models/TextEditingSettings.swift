    ...
    struct TextEditingSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        struct WarningCharacters: Equatable, Hashable, Codable {
            static let `default`: WarningCharacters = WarningCharacters(enabled: true, characters: [
                0x0003: String(localized: "text-editing.warning-char.end-of-text", defaultValue: "End of text", comment: "Warning character name for end of text character"),

                0x00A0: String(localized: "text-editing.warning-char.non-breaking-space", defaultValue: "Non-breaking space", comment: "Warning character name for non-breaking space"),
                0x202F: String(localized: "text-editing.warning-char.narrow-non-breaking-space", defaultValue: "Narrow non-breaking space", comment: "Warning character name for narrow non-breaking space"),
                0x200B: String(localized: "text-editing.warning-char.zero-width-space", defaultValue: "Zero-width space", comment: "Warning character name for zero-width space"),
                0x200C: String(localized: "text-editing.warning-char.zero-width-non-joiner", defaultValue: "Zero-width non-joiner", comment: "Warning character name for zero-width non-joiner"),
                0x2029: String(localized: "text-editing.warning-char.paragraph-separator", defaultValue: "Paragraph separator", comment: "Warning character name for paragraph separator"),

                0x2013: String(localized: "text-editing.warning-char.em-dash", defaultValue: "Em-dash", comment: "Warning character name for em-dash"),
                0x00AD: String(localized: "text-editing.warning-char.soft-hyphen", defaultValue: "Soft hyphen", comment: "Warning character name for soft hyphen"),

                0x2018: String(localized: "text-editing.warning-char.left-single-quote", defaultValue: "Left single quote", comment: "Warning character name for left single quote"),
                0x2019: String(localized: "text-editing.warning-char.right-single-quote", defaultValue: "Right single quote", comment: "Warning character name for right single quote"),
                0x201C: String(localized: "text-editing.warning-char.left-double-quote", defaultValue: "Left double quote", comment: "Warning character name for left double quote"),
                0x201D: String(localized: "text-editing.warning-char.right-double-quote", defaultValue: "Right double quote", comment: "Warning character name for right double quote"),

                0x037E: String(localized: "text-editing.warning-char.greek-question-mark", defaultValue: "Greek Question Mark", comment: "Warning character name for Greek question mark")
            ])
