...
extension SettingsData {
    ...
    struct TextEditingSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            var keys = [
                String(localized: "text-editing-search.prefer-indent", defaultValue: "Prefer Indent Using", comment: "Search key for prefer indent setting"),
                ...
                String(localized: "text-editing-search.overscroll", defaultValue: "Editor Overscroll", comment: "Search key for editor overscroll setting"),
                ...
                String(localized: "text-editing-search.bracket-emphasis", defaultValue: "Bracket Pair Emphasis", comment: "Search key for bracket pair emphasis setting"),
                String(localized: "text-editing-search.bracket-highlight", defaultValue: "Bracket Pair Highlight", comment: "Search key for bracket pair highlight setting"),
                ...
                String(localized: "text-editing-search.reformat-column", defaultValue: "Reformat at Column", comment: "Search key for reformat at column setting"),
                String(localized: "text-editing-search.show-reformat-guide", defaultValue: "Show Reformatting Guide", comment: "Search key for show reformatting guide setting"),
        ...
        private func populateCommands() {
            ...
            mgr.addCommand(
                name: String(localized: "command.toggle-type-over", defaultValue: "Toggle Type-Over Completion", comment: "Command name for toggle type-over completion"),
                title: String(localized: "command.toggle-type-over", defaultValue: "Toggle Type-Over Completion", comment: "Command title for toggle type-over completion"),
            ...
            mgr.addCommand(
                ...
                title: String(localized: "command.toggle-autocomplete-braces", defaultValue: "Toggle Autocomplete Braces", comment: "Command title for toggle autocomplete braces"),
            ...
            mgr.addCommand(
                ...
                title: String(localized: "command.toggle-word-wrap", defaultValue: "Toggle Word Wrap", comment: "Command title for toggle word wrap"),
            ...
            mgr.addCommand(name: String(localized: "command.toggle-minimap", defaultValue: "Toggle Minimap", comment: "Command name for toggle minimap"), title: String(localized: "command.toggle-minimap", defaultValue: "Toggle Minimap", comment: "Command title for toggle minimap"), id: "prefs.text_editing.toggle_minimap") {
                Settings[\.textEditing].showMinimap.toggle()
            }

            mgr.addCommand(name: String(localized: "command.toggle-gutter", defaultValue: "Toggle Gutter", comment: "Command name for toggle gutter"), title: String(localized: "command.toggle-gutter", defaultValue: "Toggle Gutter", comment: "Command title for toggle gutter"), id: "prefs.text_editing.toggle_gutter") {
            ...
            mgr.addCommand(
                ...
                title: String(localized: "command.toggle-folding-ribbon", defaultValue: "Toggle Folding Ribbon", comment: "Command title for toggle folding ribbon"),
