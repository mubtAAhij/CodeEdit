    ...
    struct TextEditingSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        struct WarningCharacters: Equatable, Hashable, Codable {
            static let `default`: WarningCharacters = WarningCharacters(enabled: true, characters: [
                0x0003: String(localized: "settings.text-editing.warning-chars.end-of-text", defaultValue: "End of text", comment: "End of text character name"),

                0x00A0: String(localized: "settings.text-editing.warning-chars.non-breaking-space", defaultValue: "Non-breaking space", comment: "Non-breaking space character name"),
                0x202F: String(localized: "settings.text-editing.warning-chars.narrow-non-breaking-space", defaultValue: "Narrow non-breaking space", comment: "Narrow non-breaking space character name"),
                0x200B: String(localized: "settings.text-editing.warning-chars.zero-width-space", defaultValue: "Zero-width space", comment: "Zero-width space character name"),
                0x200C: String(localized: "settings.text-editing.warning-chars.zero-width-non-joiner", defaultValue: "Zero-width non-joiner", comment: "Zero-width non-joiner character name"),
                0x2029: String(localized: "settings.text-editing.warning-chars.paragraph-separator", defaultValue: "Paragraph separator", comment: "Paragraph separator character name"),

                0x2013: String(localized: "settings.text-editing.warning-chars.em-dash", defaultValue: "Em-dash", comment: "Em-dash character name"),
                0x00AD: String(localized: "settings.text-editing.warning-chars.soft-hyphen", defaultValue: "Soft hyphen", comment: "Soft hyphen character name"),

                0x2018: String(localized: "settings.text-editing.warning-chars.left-single-quote", defaultValue: "Left single quote", comment: "Left single quote character name"),
                0x2019: String(localized: "settings.text-editing.warning-chars.right-single-quote", defaultValue: "Right single quote", comment: "Right single quote character name"),
                0x201C: String(localized: "settings.text-editing.warning-chars.left-double-quote", defaultValue: "Left double quote", comment: "Left double quote character name"),
                0x201D: String(localized: "settings.text-editing.warning-chars.right-double-quote", defaultValue: "Right double quote", comment: "Right double quote character name"),

                0x037E: String(localized: "settings.text-editing.warning-chars.greek-question-mark", defaultValue: "Greek Question Mark", comment: "Greek Question Mark character name")
            ])
