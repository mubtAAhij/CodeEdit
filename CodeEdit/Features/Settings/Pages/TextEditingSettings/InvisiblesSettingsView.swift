                    ...
                    VStack {
                        ...
                        if invisibleCharacters.showSpaces {
                            TextField(
                                ...
                                Text(String(localized: "invisibles.space-description", defaultValue: "Character used to render spaces", comment: "Description for space replacement character field"))
                    ...
                    VStack {
                        ...
                        if invisibleCharacters.showTabs {
                            TextField(
                                ...
                                Text(String(localized: "invisibles.tab-description", defaultValue: "Character used to render tabs", comment: "Description for tab replacement character field"))
                                    .foregroundStyle(.secondary)
                                    .font(.caption)
                            }
                            .autocorrectionDisabled()
                    ...
                    VStack {
                        ...
                        if invisibleCharacters.showLineEndings {
                            ...
                            TextField(
                                ...
                                prompt: Text(String(format: String(localized: "invisibles.carriage-return-default", defaultValue: "Default: %@", comment: "Default carriage return replacement character prompt"), Config.default.carriageReturnReplacement))
                            ) {
                                Text(String(localized: "invisibles.carriage-return-description", defaultValue: "Character used to render carriage returns (Microsoft-style line endings)", comment: "Description for carriage return replacement character field"))
                                    .foregroundStyle(.secondary)
                                    .font(.caption)
                            }
                            .autocorrectionDisabled()
                            ...
                            TextField(
                                ...
                                prompt: Text(String(format: String(localized: "invisibles.paragraph-separator-default", defaultValue: "Default: %@", comment: "Default paragraph separator replacement character prompt"), Config.default.paragraphSeparatorReplacement))
                            ) {
                                Text(String(localized: "invisibles.paragraph-separator-description", defaultValue: "Character used to render paragraph separators", comment: "Description for paragraph separator replacement character field"))
                                    .foregroundStyle(.secondary)
                                    .font(.caption)
                            }
                            .autocorrectionDisabled()
                            ...
                            TextField(
                                ...
                                prompt: Text(String(format: String(localized: "invisibles.line-separator-default", defaultValue: "Default: %@", comment: "Default line separator replacement character prompt"), Config.default.lineSeparatorReplacement))
                            ) {
                                Text(String(localized: "invisibles.line-separator-description", defaultValue: "Character used to render line separators", comment: "Description for line separator replacement character field"))
                                    .foregroundStyle(.secondary)
                                    .font(.caption)
                            }
                            .autocorrectionDisabled()
