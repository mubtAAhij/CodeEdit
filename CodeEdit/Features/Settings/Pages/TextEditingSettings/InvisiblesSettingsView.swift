    ...
    var body: some View {
        VStack(spacing: 0) {
            Form {
                Section {
                    VStack {
                        Toggle(isOn: $invisibleCharacters.showSpaces) { Text(String(localized: "invisibles-settings.show-spaces", defaultValue: "Show Spaces", comment: "Show spaces toggle label")) }
                    ...
                    VStack {
                        Toggle(isOn: $invisibleCharacters.showTabs) { Text(String(localized: "invisibles-settings.show-tabs", defaultValue: "Show Tabs", comment: "Show tabs toggle label")) }
                    ...
                    VStack {
                        Toggle(isOn: $invisibleCharacters.showLineEndings) { Text(String(localized: "invisibles-settings.show-line-endings", defaultValue: "Show Line Endings", comment: "Show line endings toggle label")) }
                        if invisibleCharacters.showLineEndings {
                            TextField(
                                ...
                                Text(String(localized: "invisibles-settings.line-feed-character", defaultValue: "Character used to render line feeds (\\n)", comment: "Line feed character description"))
                                    .foregroundStyle(.secondary)
                                    .font(.caption)
                            }
                            .autocorrectionDisabled()
                    ...
                    Text(String(localized: "invisibles-settings.header-title", defaultValue: "Invisible Characters", comment: "Invisible characters section header title"))
                    Text(String(localized: "invisibles-settings.header-description", defaultValue: "Toggle whitespace symbols CodeEdit will render with replacement characters.", comment: "Invisible characters section header description"))
                }
