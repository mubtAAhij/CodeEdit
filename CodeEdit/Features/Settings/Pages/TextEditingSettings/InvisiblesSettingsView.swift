        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    ...
                    VStack {
                        ...
                        if invisibleCharacters.showLineEndings {
                            ...
                            TextField(
                                ...
                                prompt: Text(String(format: String(localized: "invisibles.carriage-return-default", defaultValue: "Default: %@", comment: "Default carriage return replacement character"), Config.default.carriageReturnReplacement))
                            ) {
                            ...
                            TextField(
                                ...
                                prompt: Text(String(format: String(localized: "invisibles.paragraph-separator-default", defaultValue: "Default: %@", comment: "Default paragraph separator replacement character"), Config.default.paragraphSeparatorReplacement))
                            ) {
                    ...
                    Text(String(localized: "invisibles.description", defaultValue: "Toggle whitespace symbols CodeEdit will render with replacement characters.", comment: "Description for invisible characters settings"))
                }
            ...
            HStack {
                ...
                Button {
                    ...
                    Text(String(localized: "invisibles.done", defaultValue: "Done", comment: "Button to close invisible characters settings"))
                        .frame(minWidth: 56)
                }
