                    ...
                    VStack {
                        ...
                        if invisibleCharacters.showSpaces {
                            TextField(
                                ...
                                prompt: Text(String(format: NSLocalizedString("settings.text-editing.invisibles.default-space", comment: "Default space replacement character prompt"), Config.default.spaceReplacement))
                            ) {
                    ...
                    VStack {
                        ...
                        if invisibleCharacters.showTabs {
                            TextField(
                                ...
                                prompt: Text(String(format: NSLocalizedString("settings.text-editing.invisibles.default-tab", comment: "Default tab replacement character prompt"), Config.default.tabReplacement))
                            ) {
                    ...
                    VStack {
                        ...
                        if invisibleCharacters.showLineEndings {
                            TextField(
                                ...
                                prompt: Text(String(format: NSLocalizedString("settings.text-editing.invisibles.default-line-feed", comment: "Default line feed replacement character prompt"), Config.default.lineFeedReplacement))
                            ) {
                            ...
                            TextField(
                                ...
                                prompt: Text(String(format: NSLocalizedString("settings.text-editing.invisibles.default-carriage-return", comment: "Default carriage return replacement character prompt"), Config.default.carriageReturnReplacement))
                            ) {
                            ...
                            TextField(
                                ...
                                prompt: Text(String(format: NSLocalizedString("settings.text-editing.invisibles.default-paragraph-separator", comment: "Default paragraph separator replacement character prompt"), Config.default.paragraphSeparatorReplacement))
                            ) {
                            ...
                            TextField(
                                ...
                                prompt: Text(String(format: NSLocalizedString("settings.text-editing.invisibles.default-line-separator", comment: "Default line separator replacement character prompt"), Config.default.lineSeparatorReplacement))
                            ) {
