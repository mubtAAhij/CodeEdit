    ...
    var body: some View {
        VStack(spacing: 0) {
            Form {
                Section {
                    VStack {
                        Toggle(isOn: $invisibleCharacters.showSpaces) { Text(String(localized: "show_spaces", comment: "Toggle label for showing spaces")) }
                        if invisibleCharacters.showSpaces {
                            TextField(
                                ...
                                Text(String(localized: "space_replacement_description", comment: "Description for space replacement character field"))
                    ...
                    VStack {
                        Toggle(isOn: $invisibleCharacters.showTabs) { Text(String(localized: "show_tabs", comment: "Toggle label for showing tabs")) }
                        if invisibleCharacters.showTabs {
                            TextField(
                                ...
                                Text(String(localized: "tab_replacement_description", comment: "Description for tab replacement character field"))
                                    .foregroundStyle(.secondary)
                                    .font(.caption)
                            }
                            .autocorrectionDisabled()
                    ...
                    VStack {
                        Toggle(isOn: $invisibleCharacters.showLineEndings) { Text(String(localized: "show_line_endings", comment: "Toggle label for showing line endings")) }
                        if invisibleCharacters.showLineEndings {
                            TextField(
                                ...
                                Text(String(localized: "line_feed_replacement_description", comment: "Description for line feed replacement character field"))
                                    .foregroundStyle(.secondary)
                                    .font(.caption)
                            }
                            .autocorrectionDisabled()
                            ...
                            TextField(
                                ...
                                Text(String(localized: "carriage_return_replacement_description", comment: "Description for carriage return replacement character field"))
                                    .foregroundStyle(.secondary)
                                    .font(.caption)
                            }
                            .autocorrectionDisabled()
                            ...
                            TextField(
                                ...
                                Text(String(localized: "paragraph_separator_replacement_description", comment: "Description for paragraph separator replacement character field"))
                                    .foregroundStyle(.secondary)
                                    .font(.caption)
                            }
                            .autocorrectionDisabled()
                            ...
                            TextField(
                                ...
                                Text(String(localized: "line_separator_replacement_description", comment: "Description for line separator replacement character field"))
                                    .foregroundStyle(.secondary)
                                    .font(.caption)
                            }
                            .autocorrectionDisabled()
                    ...
                    Text("String(localized: "toggle_whitespace_symbols_description", comment: "Description for invisible characters settings explaining what the toggle does")")
                }
            ...
            HStack {
                ...
                Button {
                    ...
                    Text("String(localized: "done", comment: "Button text to close dialog")")
                        .frame(minWidth: 56)
                }
