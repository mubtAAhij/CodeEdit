...
extension SettingsData {
    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.general.appearance", defaultValue: "Appearance", comment: "Appearance setting label"),
                String(localized: "settings.general.file-icon-style", defaultValue: "File Icon Style", comment: "File Icon Style setting label"),
                String(localized: "settings.general.tab-bar-style", defaultValue: "Tab Bar Style", comment: "Tab Bar Style search key"),
                String(localized: "settings.general.show-jump-bar", defaultValue: "Show Jump Bar", comment: "Show Jump Bar toggle label"),
                String(localized: "settings.general.dim-editors", defaultValue: "Dim editors without focus", comment: "Dim editors without focus toggle label"),
                ...
                String(localized: "settings.general.show-issues", defaultValue: "Show Issues", comment: "Show Issues setting label"),
                String(localized: "settings.general.show-live-issues", defaultValue: "Show Live Issues", comment: "Show Live Issues toggle label"),
                ...
                String(localized: "settings.general.reopen-behavior", defaultValue: "Reopen Behavior", comment: "Reopen behavior setting label"),
                ...
                String(localized: "settings.general.file-extensions", defaultValue: "File Extensions", comment: "File Extensions setting label"),
                ...
                String(localized: "settings.general.shell-command-search", defaultValue: "'codeedit' Shell command", comment: "Shell command search key"),
                String(localized: "settings.general.dialog-warnings", defaultValue: "Dialog Warnings", comment: "Dialog warnings setting label"),
    ...
    enum NavigatorDetail: Int, Codable, CaseIterable {
        ...
        var label: String {
            ...
            default:
                return String(
                    format: String(localized: "settings.general.navigator-detail.up-to-lines", defaultValue: "Up to %d lines", comment: "Up to N lines navigator detail option"),
                    self.rawValue
                )
            }
        }
