...
extension SettingsData {
    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "general-settings.appearance", defaultValue: "Appearance", comment: "Appearance search key"),
                String(localized: "general-settings.file-icon-style", defaultValue: "File Icon Style", comment: "File icon style search key"),
                String(localized: "general-settings.tab-bar-style", defaultValue: "Tab Bar Style", comment: "Tab bar style search key"),
                String(localized: "general-settings.show-jump-bar", defaultValue: "Show Jump Bar", comment: "Show jump bar search key"),
                String(localized: "general-settings.dim-editors-without-focus", defaultValue: "Dim editors without focus", comment: "Dim editors without focus search key"),
                String(localized: "general-settings.navigator-tab-bar-position", defaultValue: "Navigator Tab Bar Position", comment: "Navigator tab bar position search key"),
                String(localized: "general-settings.inspector-tab-bar-position", defaultValue: "Inspector Tab Bar Position", comment: "Inspector tab bar position search key"),
                String(localized: "general-settings.show-issues", defaultValue: "Show Issues", comment: "Show issues search key"),
                String(localized: "general-settings.show-live-issues", defaultValue: "Show Live Issues", comment: "Show live issues search key"),
                String(localized: "general-settings.automatically-save-change-to-disk", defaultValue: "Automatically save change to disk", comment: "Auto save search key"),
                String(localized: "general-settings.automatically-reveal-in-project-navigator", defaultValue: "Automatically reveal in project navigator", comment: "Auto reveal in navigator search key"),
                String(localized: "general-settings.reopen-behavior", defaultValue: "Reopen Behavior", comment: "Reopen behavior search key"),
                String(localized: "general-settings.after-last-window-closed", defaultValue: "After the last window is closed", comment: "After last window closed search key"),
                String(localized: "general-settings.file-extensions", defaultValue: "File Extensions", comment: "File extensions search key"),
                String(localized: "general-settings.project-navigator-size", defaultValue: "Project Navigator Size", comment: "Project navigator size search key"),
                String(localized: "general-settings.find-navigator-detail", defaultValue: "Find Navigator Detail", comment: "Find navigator detail search key"),
                String(localized: "general-settings.issue-navigator-detail", defaultValue: "Issue Navigator Detail", comment: "Issue navigator detail search key"),
                String(localized: "general-settings.show-open-with-codeedit", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Show open with CodeEdit search key"),
                String(localized: "general-settings.codeedit-shell-command", defaultValue: "'codeedit' Shell command", comment: "Codeedit shell command search key"),
                String(localized: "general-settings.dialog-warnings", defaultValue: "Dialog Warnings", comment: "Dialog warnings search key"),
                String(localized: "general-settings.check-for-updates", defaultValue: "Check for updates", comment: "Check for updates search key"),
                String(localized: "general-settings.automatically-check-for-app-updates", defaultValue: "Automatically check for app updates", comment: "Auto check for updates search key"),
                String(localized: "general-settings.include-pre-release-versions", defaultValue: "Include pre-release versions", comment: "Include pre-release versions search key")
            ]
        }
    ...
    enum NavigatorDetail: Int, Codable, CaseIterable {
        ...
        var label: String {
            switch self {
            case .upTo1:
                return String(localized: "general-settings.one-line", defaultValue: "One Line", comment: "One line label")
            default:
                return String(format: String(localized: "general-settings.up-to-n-lines", defaultValue: "Up to %d lines", comment: "Up to N lines label"), self.rawValue)
            }
        }
    }
}
