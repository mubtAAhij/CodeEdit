...
extension SettingsData {
    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "settings.general.search.navigator-tab-position", defaultValue: "Navigator Tab Bar Position", comment: "Search key for navigator tab position"),
                String(localized: "settings.general.search.inspector-tab-position", defaultValue: "Inspector Tab Bar Position", comment: "Search key for inspector tab position"),
                ...
                String(localized: "settings.general.search.after-close", defaultValue: "After the last window is closed", comment: "Search key for after close behavior"),
                ...
                String(localized: "settings.general.search.navigator-size", defaultValue: "Project Navigator Size", comment: "Search key for navigator size"),
                ...
                String(localized: "settings.general.search.check-updates", defaultValue: "Check for updates", comment: "Search key for check updates"),
                String(localized: "settings.general.search.auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Search key for auto check updates"),
                String(localized: "settings.general.search.include-prerelease", defaultValue: "Include pre-release versions", comment: "Search key for include prerelease")
            ]
        }
    ...
    enum NavigatorDetail: Int, Codable, CaseIterable {
        ...
        var label: String {
            ...
            default:
                return String(format: String(localized: "settings.general.navigator-detail.up-to-n-lines", defaultValue: "Up to %d lines", comment: "Navigator detail up to N lines"), self.rawValue)
            }
        }
    }
}
