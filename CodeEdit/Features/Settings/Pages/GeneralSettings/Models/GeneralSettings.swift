...
extension SettingsData {
    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.general.search-key.appearance", defaultValue: "Appearance", comment: "Search key for appearance"),
                String(localized: "settings.general.search-key.file-icon-style", defaultValue: "File Icon Style", comment: "Search key for file icon style"),
                String(localized: "settings.general.search-key.tab-bar-style", defaultValue: "Tab Bar Style", comment: "Search key for tab bar style"),
                String(localized: "settings.general.search-key.show-jump-bar", defaultValue: "Show Jump Bar", comment: "Search key for show jump bar"),
                String(localized: "settings.general.search-key.dim-editors", defaultValue: "Dim editors without focus", comment: "Search key for dim editors without focus"),
                String(localized: "settings.general.search-key.navigator-tab-bar-position", defaultValue: "Navigator Tab Bar Position", comment: "Search key for navigator tab bar position"),
                String(localized: "settings.general.search-key.inspector-tab-bar-position", defaultValue: "Inspector Tab Bar Position", comment: "Search key for inspector tab bar position"),
                String(localized: "settings.general.search-key.show-issues", defaultValue: "Show Issues", comment: "Search key for show issues"),
                String(localized: "settings.general.search-key.show-live-issues", defaultValue: "Show Live Issues", comment: "Search key for show live issues"),
                String(localized: "settings.general.search-key.auto-save", defaultValue: "Automatically save change to disk", comment: "Search key for auto save"),
                String(localized: "settings.general.search-key.auto-reveal", defaultValue: "Automatically reveal in project navigator", comment: "Search key for auto reveal"),
                String(localized: "settings.general.search-key.reopen-behavior", defaultValue: "Reopen Behavior", comment: "Search key for reopen behavior"),
                String(localized: "settings.general.search-key.after-last-window-closed", defaultValue: "After the last window is closed", comment: "Search key for after last window closed"),
                String(localized: "settings.general.search-key.file-extensions", defaultValue: "File Extensions", comment: "Search key for file extensions"),
                String(localized: "settings.general.search-key.project-navigator-size", defaultValue: "Project Navigator Size", comment: "Search key for project navigator size"),
                String(localized: "settings.general.search-key.find-navigator-detail", defaultValue: "Find Navigator Detail", comment: "Search key for find navigator detail"),
                String(localized: "settings.general.search-key.issue-navigator-detail", defaultValue: "Issue Navigator Detail", comment: "Search key for issue navigator detail"),
                String(localized: "settings.general.search-key.open-with-codeedit", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Search key for open with CodeEdit"),
                String(localized: "settings.general.search-key.shell-command", defaultValue: "'codeedit' Shell command", comment: "Search key for shell command"),
                String(localized: "settings.general.search-key.dialog-warnings", defaultValue: "Dialog Warnings", comment: "Search key for dialog warnings"),
                String(localized: "settings.general.search-key.check-for-updates", defaultValue: "Check for updates", comment: "Search key for check for updates"),
                String(localized: "settings.general.search-key.auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Search key for automatically check for updates"),
                String(localized: "settings.general.search-key.prerelease", defaultValue: "Include pre-release versions", comment: "Search key for include pre-release versions")
            ]
        }
