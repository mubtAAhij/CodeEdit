    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                "String(localized: "automatically_save_change_disk", comment: "Search key for automatically save changes to disk setting")",
                "String(localized: "automatically_reveal_project_navigator", comment: "Search key for automatically reveal in project navigator setting")",
                "Reopen Behavior",
                "String(localized: "after_last_window_closed", comment: "Search key for after last window is closed setting")",
                "String(localized: "file_extensions", comment: "Search key for file extensions setting")",
                "String(localized: "project_navigator_size", comment: "Search key for project navigator size setting")",
                "String(localized: "find_navigator_detail", comment: "Search key for find navigator detail setting")",
                "String(localized: "issue_navigator_detail", comment: "Search key for issue navigator detail setting")",
                "Show “Open With CodeEdit“ option in Finder",
                "String(localized: "codeedit_shell_command", comment: "Search key for codeedit shell command setting")",
                "String(localized: "dialog_warnings", comment: "Search key for dialog warnings setting")",
                "String(localized: "check_for_updates", comment: "Search key for check for updates setting")",
                "String(localized: "automatically_check_app_updates", comment: "Search key for automatically check for app updates setting")",
