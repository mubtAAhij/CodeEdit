...
extension SettingsData {
    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "settings.general.search.show-jump-bar", defaultValue: "Show Jump Bar", comment: "Search key for show jump bar setting"),
                String(localized: "settings.general.search.dim-editors", defaultValue: "Dim editors without focus", comment: "Search key for dim editors setting"),
                ...
                String(localized: "settings.general.search.after-window-closed", defaultValue: "After the last window is closed", comment: "Search key for after window closed setting"),
                ...
                String(localized: "settings.general.search.open-with-codeedit", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Search key for open with CodeEdit setting"),
                ...
                String(localized: "settings.general.search.check-for-updates", defaultValue: "Check for updates", comment: "Search key for check for updates setting"),
                String(localized: "settings.general.search.auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Search key for automatically check for app updates setting"),
                String(localized: "settings.general.search.include-prerelease", defaultValue: "Include pre-release versions", comment: "Search key for include pre-release versions setting")
            ]
        }
    ...
    enum NavigatorDetail: Int, Codable, CaseIterable {
        ...
        var label: String {
            switch self {
            case .upTo1:
                return String(localized: "settings.general.navigator-detail.one-line", defaultValue: "One Line", comment: "Navigator detail label for one line")
            default:
                return String(format: String(localized: "settings.general.navigator-detail.up-to-lines", defaultValue: "Up to %d lines", comment: "Navigator detail label for multiple lines"), self.rawValue)
            }
        }
    }
}
