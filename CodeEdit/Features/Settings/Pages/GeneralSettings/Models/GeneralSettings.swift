...
extension SettingsData {
    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "general-settings.search.appearance", defaultValue: "Appearance", comment: "Appearance search key"),
                String(localized: "general-settings.search.file-icon-style", defaultValue: "File Icon Style", comment: "File icon style search key"),
                String(localized: "general-settings.search.tab-bar-style", defaultValue: "Tab Bar Style", comment: "Tab bar style search key"),
                String(localized: "general-settings.search.show-jump-bar", defaultValue: "Show Jump Bar", comment: "Show jump bar search key"),
                String(localized: "general-settings.search.dim-editors", defaultValue: "Dim editors without focus", comment: "Dim editors without focus search key"),
                String(localized: "general-settings.search.navigator-position", defaultValue: "Navigator Tab Bar Position", comment: "Navigator tab bar position search key"),
                String(localized: "general-settings.search.inspector-position", defaultValue: "Inspector Tab Bar Position", comment: "Inspector tab bar position search key"),
                String(localized: "general-settings.search.show-issues", defaultValue: "Show Issues", comment: "Show issues search key"),
                String(localized: "general-settings.search.show-live-issues", defaultValue: "Show Live Issues", comment: "Show live issues search key"),
                String(localized: "general-settings.search.auto-save", defaultValue: "Automatically save change to disk", comment: "Auto save search key"),
                String(localized: "general-settings.search.auto-reveal", defaultValue: "Automatically reveal in project navigator", comment: "Auto reveal search key"),
                String(localized: "general-settings.search.reopen-behavior", defaultValue: "Reopen Behavior", comment: "Reopen behavior search key"),
                String(localized: "general-settings.search.after-last-window", defaultValue: "After the last window is closed", comment: "After last window closed search key"),
                String(localized: "general-settings.search.file-extensions", defaultValue: "File Extensions", comment: "File extensions search key"),
                String(localized: "general-settings.search.navigator-size", defaultValue: "Project Navigator Size", comment: "Project navigator size search key"),
                String(localized: "general-settings.search.find-detail", defaultValue: "Find Navigator Detail", comment: "Find navigator detail search key"),
                String(localized: "general-settings.search.issue-detail", defaultValue: "Issue Navigator Detail", comment: "Issue navigator detail search key"),
                String(localized: "general-settings.search.open-with-finder", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Open with Finder search key"),
                String(localized: "general-settings.search.shell-command", defaultValue: "'codeedit' Shell command", comment: "Shell command search key"),
                String(localized: "general-settings.search.dialog-warnings", defaultValue: "Dialog Warnings", comment: "Dialog warnings search key"),
                String(localized: "general-settings.search.check-updates", defaultValue: "Check for updates", comment: "Check for updates search key"),
                String(localized: "general-settings.search.auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Auto check for updates search key"),
                String(localized: "general-settings.search.prerelease", defaultValue: "Include pre-release versions", comment: "Pre-release versions search key")
            ]
        }
    ...
    enum NavigatorDetail: Int, Codable, CaseIterable {
        ...
        var label: String {
            switch self {
            case .upTo1:
                return String(localized: "general-settings.navigator-detail.one-line", defaultValue: "One Line", comment: "One line navigator detail option")
            default:
                return String(format: String(localized: "general-settings.navigator-detail.up-to-lines", defaultValue: "Up to %d lines", comment: "Up to N lines navigator detail option"), self.rawValue)
            }
        }
    }
}
