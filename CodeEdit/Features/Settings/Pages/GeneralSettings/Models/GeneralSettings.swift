    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "settings.general.dim-editors", defaultValue: "Dim editors without focus", comment: "Search key for dim editors setting"),
                ...
                String(localized: "settings.general.auto-save", defaultValue: "Automatically save change to disk", comment: "Search key for auto save setting"),
                String(localized: "settings.general.auto-reveal", defaultValue: "Automatically reveal in project navigator", comment: "Search key for auto reveal setting"),
                ...
                String(localized: "settings.general.after-last-window-closed", defaultValue: "After the last window is closed", comment: "Search key for after last window closed setting"),
                ...
                String(localized: "settings.general.open-with-codeedit", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Search key for open with CodeEdit setting"),
                String(localized: "settings.general.shell-command", defaultValue: "'codeedit' Shell command", comment: "Search key for shell command setting"),
                ...
                String(localized: "settings.general.auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Search key for auto check updates setting"),
                String(localized: "settings.general.pre-release-versions", defaultValue: "Include pre-release versions", comment: "Search key for pre-release versions setting")
            ]
        }
