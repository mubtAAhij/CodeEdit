...
extension SettingsData {
    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "general.search.appearance", defaultValue: "Appearance", comment: "Search key for appearance setting"),
                String(localized: "general.search.file-icon-style", defaultValue: "File Icon Style", comment: "Search key for file icon style setting"),
                String(localized: "general.search.tab-bar-style", defaultValue: "Tab Bar Style", comment: "Search key for tab bar style setting"),
                String(localized: "general.search.show-jump-bar", defaultValue: "Show Jump Bar", comment: "Search key for show jump bar setting"),
                String(localized: "general.search.dim-editors-without-focus", defaultValue: "Dim editors without focus", comment: "Search key for dim editors without focus setting"),
                String(localized: "general.search.navigator-tab-bar-position", defaultValue: "Navigator Tab Bar Position", comment: "Search key for navigator tab bar position setting"),
                String(localized: "general.search.inspector-tab-bar-position", defaultValue: "Inspector Tab Bar Position", comment: "Search key for inspector tab bar position setting"),
                String(localized: "general.search.show-issues", defaultValue: "Show Issues", comment: "Search key for show issues setting"),
                String(localized: "general.search.show-live-issues", defaultValue: "Show Live Issues", comment: "Search key for show live issues setting"),
                String(localized: "general.search.automatically-save-change-to-disk", defaultValue: "Automatically save change to disk", comment: "Search key for auto save setting"),
                String(localized: "general.search.automatically-reveal-in-project-navigator", defaultValue: "Automatically reveal in project navigator", comment: "Search key for auto reveal setting"),
                String(localized: "general.search.reopen-behavior", defaultValue: "Reopen Behavior", comment: "Search key for reopen behavior setting"),
                String(localized: "general.search.after-the-last-window-is-closed", defaultValue: "After the last window is closed", comment: "Search key for window close behavior setting"),
                String(localized: "general.search.file-extensions", defaultValue: "File Extensions", comment: "Search key for file extensions setting"),
                String(localized: "general.search.project-navigator-size", defaultValue: "Project Navigator Size", comment: "Search key for project navigator size setting"),
                String(localized: "general.search.find-navigator-detail", defaultValue: "Find Navigator Detail", comment: "Search key for find navigator detail setting"),
                String(localized: "general.search.issue-navigator-detail", defaultValue: "Issue Navigator Detail", comment: "Search key for issue navigator detail setting"),
                String(localized: "general.search.show-open-with-codeedit-option-in-finder", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Search key for open with CodeEdit finder option setting"),
                String(localized: "general.search.codeedit-shell-command", defaultValue: "'codeedit' Shell command", comment: "Search key for codeedit shell command setting"),
                String(localized: "general.search.dialog-warnings", defaultValue: "Dialog Warnings", comment: "Search key for dialog warnings setting"),
                String(localized: "general.search.check-for-updates", defaultValue: "Check for updates", comment: "Search key for check for updates setting"),
                String(localized: "general.search.automatically-check-for-updates", defaultValue: "Automatically check for app updates", comment: "Search key for automatically check for app updates setting"),
                String(localized: "general.search.include-prerelease-versions", defaultValue: "Include pre-release versions", comment: "Search key for include pre-release versions setting")
            ]
        }
    ...
    enum NavigatorDetail: Int, Codable, CaseIterable {
        ...
        var label: String {
            switch self {
            case .upTo1:
                return String(localized: "general.navigator-detail.one-line", defaultValue: "One Line", comment: "Navigator detail label for single line display")
            default:
                return String(format: String(localized: "general.navigator-detail.up-to-lines", defaultValue: "Up to %d lines", comment: "Navigator detail label for multiple lines display with line count"), self.rawValue)
            }
        }
    }
}
