...
extension SettingsData {
    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "settings.general.search-navigator-position", defaultValue: "Navigator Tab Bar Position", comment: "Search key for navigator tab bar position setting"),
                String(localized: "settings.general.search-inspector-position", defaultValue: "Inspector Tab Bar Position", comment: "Search key for inspector tab bar position setting"),
                ...
                String(localized: "settings.general.search-reveal-in-navigator", defaultValue: "Automatically reveal in project navigator", comment: "Search key for reveal in navigator setting"),
                ...
                String(localized: "settings.general.search-after-last-window-closed", defaultValue: "After the last window is closed", comment: "Search key for after last window closed setting"),
                ...
                String(localized: "settings.general.search-open-with-finder", defaultValue: "Show "Open With CodeEdit" option in Finder", comment: "Search key for open with CodeEdit in Finder setting"),
                ...
                String(localized: "settings.general.search-check-updates", defaultValue: "Check for updates", comment: "Search key for check for updates setting"),
                String(localized: "settings.general.search-auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Search key for automatically check for updates setting"),
                String(localized: "settings.general.search-prerelease-versions", defaultValue: "Include pre-release versions", comment: "Search key for pre-release versions setting")
            ]
        }
    ...
    enum NavigatorDetail: Int, Codable, CaseIterable {
        ...
        var label: String {
            ...
            default:
                return String(localized: "settings.general.navigator-detail.up-to-lines", defaultValue: "Up to \(self.rawValue) lines", comment: "Navigator detail option for multiple lines")
            }
        }
    }
}
