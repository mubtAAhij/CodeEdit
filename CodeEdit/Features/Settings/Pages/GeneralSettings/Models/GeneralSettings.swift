...
extension SettingsData {
    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "general.appearance", defaultValue: "Appearance", comment: "Appearance search key"),
                String(localized: "general.file-icon-style", defaultValue: "File Icon Style", comment: "File icon style search key"),
                String(localized: "general.tab-bar-style", defaultValue: "Tab Bar Style", comment: "Tab bar style search key"),
                String(localized: "general.show-jump-bar", defaultValue: "Show Jump Bar", comment: "Show jump bar search key"),
                String(localized: "general.dim-editors-without-focus", defaultValue: "Dim editors without focus", comment: "Dim editors without focus search key"),
                String(localized: "general.navigator-tab-bar-position", defaultValue: "Navigator Tab Bar Position", comment: "Navigator tab bar position search key"),
                String(localized: "general.inspector-tab-bar-position", defaultValue: "Inspector Tab Bar Position", comment: "Inspector tab bar position search key"),
                String(localized: "general.show-issues", defaultValue: "Show Issues", comment: "Show issues search key"),
                String(localized: "general.show-live-issues", defaultValue: "Show Live Issues", comment: "Show live issues search key"),
                String(localized: "general.auto-save", defaultValue: "Automatically save change to disk", comment: "Automatically save change to disk search key"),
                String(localized: "general.auto-reveal-in-navigator", defaultValue: "Automatically reveal in project navigator", comment: "Automatically reveal in project navigator search key"),
                String(localized: "general.reopen-behavior", defaultValue: "Reopen Behavior", comment: "Reopen behavior search key"),
                String(localized: "general.after-last-window-closed", defaultValue: "After the last window is closed", comment: "After the last window is closed search key"),
                String(localized: "general.file-extensions", defaultValue: "File Extensions", comment: "File extensions search key"),
                String(localized: "general.project-navigator-size", defaultValue: "Project Navigator Size", comment: "Project navigator size search key"),
                String(localized: "general.find-navigator-detail", defaultValue: "Find Navigator Detail", comment: "Find navigator detail search key"),
                String(localized: "general.issue-navigator-detail", defaultValue: "Issue Navigator Detail", comment: "Issue navigator detail search key"),
                String(localized: "general.show-open-with-codeedit", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Show open with CodeEdit option search key"),
                String(localized: "general.codeedit-shell-command", defaultValue: "'codeedit' Shell command", comment: "Codeedit shell command search key"),
                String(localized: "general.dialog-warnings", defaultValue: "Dialog Warnings", comment: "Dialog warnings search key"),
                String(localized: "general.check-for-updates", defaultValue: "Check for updates", comment: "Check for updates search key"),
                String(localized: "general.auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Automatically check for app updates search key"),
                String(localized: "general.include-prerelease", defaultValue: "Include pre-release versions", comment: "Include pre-release versions search key")
            ]
        }
    ...
    enum NavigatorDetail: Int, Codable, CaseIterable {
        ...
        var label: String {
            switch self {
            case .upTo1:
                return String(localized: "navigator-detail.one-line", defaultValue: "One Line", comment: "One line navigator detail option")
            default:
                return String(format: String(localized: "navigator-detail.up-to-lines", defaultValue: "Up to %d lines", comment: "Up to N lines navigator detail option"), self.rawValue)
            }
        }
    }
}
