...
extension SettingsData {
    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "settings.general.search.dim-unfocused-editors", defaultValue: "Dim editors without focus", comment: "Search key for dim unfocused editors setting"),
                ...
                String(localized: "settings.general.search.auto-reveal-navigator", defaultValue: "Automatically reveal in project navigator", comment: "Search key for auto reveal in navigator setting"),
                ...
                String(localized: "settings.general.search.show-open-with-finder", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Search key for show open with in Finder setting"),
                ...
                String(localized: "settings.general.search.auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Search key for auto check for updates setting"),
                String(localized: "settings.general.search.include-prereleases", defaultValue: "Include pre-release versions", comment: "Search key for include pre-release versions setting")
            ]
        }
    ...
    enum NavigatorDetail: Int, Codable, CaseIterable {
        ...
        var label: String {
            ...
            default:
                return String(localized: "settings.general.navigator-detail.up-to-lines", defaultValue: "Up to \(self.rawValue) lines", comment: "Label for multiple lines navigator detail option with count")
            }
        }
    }
}
