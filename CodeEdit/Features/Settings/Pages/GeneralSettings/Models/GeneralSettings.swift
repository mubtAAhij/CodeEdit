...
extension SettingsData {
    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "settings.general.inspector_tab_bar_position", comment: "Setting for inspector tab bar position"),
                String(localized: "settings.general.show_issues", comment: "Setting for showing issues"),
                String(localized: "settings.general.show_live_issues", comment: "Setting for showing live issues"),
                "Automatically save change to disk",
                String(localized: "settings.general.auto_reveal_in_navigator", comment: "Setting for automatically revealing files in project navigator"),
                String(localized: "settings.general.reopen_behavior", comment: "Setting for reopen behavior"),
                String(localized: "settings.general.after_last_window_closed", comment: "Setting for behavior after last window is closed"),
                String(localized: "settings.general.file_extensions", comment: "Setting for file extensions"),
                String(localized: "settings.general.project_navigator_size", comment: "Setting for project navigator size"),
                String(localized: "settings.general.find_navigator_detail", comment: "Setting for find navigator detail level"),
                String(localized: "settings.general.issue_navigator_detail", comment: "Setting for issue navigator detail level"),
                "Show “Open With CodeEdit“ option in Finder",
                String(localized: "settings.general.codeedit_shell_command", comment: "Setting for codeedit shell command"),
                String(localized: "settings.general.dialog_warnings", comment: "Setting for dialog warnings"),
                String(localized: "settings.general.check_for_updates", comment: "Setting for checking for updates"),
                String(localized: "settings.general.auto_check_for_updates", comment: "Setting for automatically checking for app updates"),
                String(localized: "settings.general.include_prerelease_versions", comment: "Setting for including pre-release versions")
            ]
    ...
    enum NavigatorDetail: Int, Codable, CaseIterable {
        ...
        var label: String {
            switch self {
            case .upTo1:
                return String(localized: "settings.general.one_line", comment: "Navigator detail option for one line")
            default:
