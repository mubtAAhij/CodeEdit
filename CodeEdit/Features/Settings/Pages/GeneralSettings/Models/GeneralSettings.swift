    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "settings.general.dim-editors-without-focus", defaultValue: "Dim editors without focus", comment: "Search key for dim editors without focus setting"),
                ...
                String(localized: "settings.general.after-the-last-window-is-closed", defaultValue: "After the last window is closed", comment: "Search key for after window close setting"),
                ...
                String(localized: "settings.general.automatically-check-for-app-updates", defaultValue: "Automatically check for app updates", comment: "Search key for automatically check for updates setting"),
                String(localized: "settings.general.include-pre-release-versions", defaultValue: "Include pre-release versions", comment: "Search key for include pre-release versions setting")
            ]
        }
