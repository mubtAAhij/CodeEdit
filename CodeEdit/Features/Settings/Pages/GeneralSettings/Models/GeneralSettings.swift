...
extension SettingsData {
    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.general.search.appearance", defaultValue: "Appearance", comment: "Search key for appearance setting"),
                String(localized: "settings.general.search.file-icon-style", defaultValue: "File Icon Style", comment: "Search key for file icon style setting"),
                String(localized: "settings.general.search.tab-bar-style", defaultValue: "Tab Bar Style", comment: "Search key for tab bar style setting"),
                String(localized: "settings.general.search.show-jump-bar", defaultValue: "Show Jump Bar", comment: "Search key for jump bar visibility setting"),
                String(localized: "settings.general.search.dim-editors-without-focus", defaultValue: "Dim editors without focus", comment: "Search key for dim editors setting"),
                String(localized: "settings.general.search.navigator-tab-bar-position", defaultValue: "Navigator Tab Bar Position", comment: "Search key for navigator tab bar position setting"),
                String(localized: "settings.general.search.inspector-tab-bar-position", defaultValue: "Inspector Tab Bar Position", comment: "Search key for inspector tab bar position setting"),
                String(localized: "settings.general.search.show-issues", defaultValue: "Show Issues", comment: "Search key for show issues setting"),
                String(localized: "settings.general.search.show-live-issues", defaultValue: "Show Live Issues", comment: "Search key for show live issues setting"),
                String(localized: "settings.general.search.auto-save", defaultValue: "Automatically save change to disk", comment: "Search key for auto-save setting"),
                String(localized: "settings.general.search.auto-reveal", defaultValue: "Automatically reveal in project navigator", comment: "Search key for auto-reveal setting"),
                String(localized: "settings.general.search.reopen-behavior", defaultValue: "Reopen Behavior", comment: "Search key for reopen behavior setting"),
                String(localized: "settings.general.search.after-last-window-closed", defaultValue: "After the last window is closed", comment: "Search key for window close behavior setting"),
                String(localized: "settings.general.search.file-extensions", defaultValue: "File Extensions", comment: "Search key for file extensions setting"),
                String(localized: "settings.general.search.project-navigator-size", defaultValue: "Project Navigator Size", comment: "Search key for project navigator size setting"),
                String(localized: "settings.general.search.find-navigator-detail", defaultValue: "Find Navigator Detail", comment: "Search key for find navigator detail setting"),
                String(localized: "settings.general.search.issue-navigator-detail", defaultValue: "Issue Navigator Detail", comment: "Search key for issue navigator detail setting"),
                String(localized: "settings.general.search.open-with-codeedit", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Search key for Finder integration setting"),
                String(localized: "settings.general.search.shell-command", defaultValue: "'codeedit' Shell command", comment: "Search key for shell command setting"),
                String(localized: "settings.general.search.dialog-warnings", defaultValue: "Dialog Warnings", comment: "Search key for dialog warnings setting"),
                String(localized: "settings.general.search.check-for-updates", defaultValue: "Check for updates", comment: "Search key for update checking setting"),
                String(localized: "settings.general.search.auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Search key for automatic update checking setting"),
                String(localized: "settings.general.search.include-prerelease", defaultValue: "Include pre-release versions", comment: "Search key for pre-release versions setting")
            ]
        }
    ...
    enum NavigatorDetail: Int, Codable, CaseIterable {
        ...
        var label: String {
            ...
            default:
                return String(format: String(localized: "settings.general.navigator-detail.up-to-lines", defaultValue: "Up to %d lines", comment: "Navigator detail option for multiple lines"), self.rawValue)
            }
        }
    }
}
