...
extension SettingsData {
    ...
    struct GeneralSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "settings.general.search.navigator-size", defaultValue: "Project Navigator Size", comment: "Search key for project navigator size setting"),
                ...
                String(localized: "settings.general.search.open-in-codeedit", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Search key for open in CodeEdit setting"),
                ...
                String(localized: "settings.general.search.check-for-updates", defaultValue: "Check for updates", comment: "Search key for update check setting"),
                String(localized: "settings.general.search.auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Search key for automatic update check setting"),
    ...
    enum NavigatorDetail: Int, Codable, CaseIterable {
        ...
        var label: String {
            switch self {
            case .upTo1:
                return String(localized: "settings.general.navigator-detail.one-line", defaultValue: "One Line", comment: "Label for one line navigator detail option")
            default:
                return String(
                    format: String(localized: "settings.general.navigator-detail.up-to-n-lines", defaultValue: "Up to %d lines", comment: "Label for multiple lines navigator detail option"),
                    self.rawValue
                )
            }
        }
