...
private extension GeneralSettingsView {
    ...
    var updateChecker: some View {
        Section {
            LabeledContent {
                ...
                Text(String(format: String(localized: "settings.general.last-checked", defaultValue: "Last checked: %@", comment: "Last checked timestamp"), lastUpdatedString))
    ...
    var autoUpdateToggle: some View {
        Toggle(String(localized: "settings.general.auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Auto check updates toggle"), isOn: $updater.automaticallyChecksForUpdates)
    }

    var prereleaseToggle: some View {
        Toggle(String(localized: "settings.general.include-prerelease", defaultValue: "Include pre-release versions", comment: "Include prerelease toggle"), isOn: $updater.includePrereleaseVersions)
    }
    ...
    private var lastUpdatedString: String {
        if let lastUpdatedDate = updater.lastUpdateCheckDate {
            ...
            return String(localized: "settings.general.never", defaultValue: "Never", comment: "Never checked")
        }
    }
    ...
    var revealFileOnFocusChangeToggle: some View {
        Toggle(String(localized: "settings.general.reveal-file-on-focus", defaultValue: "Automatically reveal in project navigator", comment: "Toggle to automatically reveal files in project navigator"), isOn: $settings.revealFileOnFocusChange)
    }
