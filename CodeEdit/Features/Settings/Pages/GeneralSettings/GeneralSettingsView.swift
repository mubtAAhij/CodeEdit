...
private extension GeneralSettingsView {
    var appearance: some View {
        Picker(String(localized: "settings.general.appearance", defaultValue: "Appearance", comment: "Picker label for app appearance setting"), selection: $settings.appAppearance) {
    ...
    var showIssues: some View {
        Picker(String(localized: "settings.general.show-issues", defaultValue: "Show Issues", comment: "Picker label for issue display preference"), selection: $settings.showIssues) {
    ...
    var dimEditorsWithoutFocus: some View {
        Toggle(String(localized: "settings.general.dim-editors-without-focus", defaultValue: "Dim editors without focus", comment: "Toggle for dimming inactive editor splits"), isOn: $settings.dimEditorsWithoutFocus)
    }

    var fileExtensions: some View {
        Group {
            Picker(String(localized: "settings.general.file-extensions", defaultValue: "File Extensions", comment: "Picker label for file extensions visibility setting"), selection: $settings.fileExtensionsVisibility) {
    ...
    var fileIconStyle: some View {
        Picker(String(localized: "settings.general.file-icon-style", defaultValue: "File Icon Style", comment: "Picker label for file icon style setting"), selection: $settings.fileIconStyle) {
            Text(String(localized: "settings.general.file-icon-style.color", defaultValue: "Color", comment: "Color file icons option"))
                .tag(SettingsData.FileIconStyle.color)
            Text(String(localized: "settings.general.file-icon-style.monochrome", defaultValue: "Monochrome", comment: "Monochrome file icons option"))
    ...
    var navigatorTabBarPosition: some View {
        Picker(String(localized: "settings.general.navigator-tab-bar-position", defaultValue: "Navigator Tab Bar Position", comment: "Picker label for navigator tab bar position setting"), selection: $settings.navigatorTabBarPosition) {
            Text(String(localized: "settings.general.tab-bar-position.top", defaultValue: "Top", comment: "Top position option for tab bar"))
                .tag(SettingsData.SidebarTabBarPosition.top)
            Text(String(localized: "settings.general.tab-bar-position.side", defaultValue: "Side", comment: "Side position option for tab bar"))
    ...
    var inspectorTabBarPosition: some View {
        Picker(String(localized: "settings.general.inspector-tab-bar-position", defaultValue: "Inspector Tab Bar Position", comment: "Picker label for inspector tab bar position setting"), selection: $settings.inspectorTabBarPosition) {
            Text(String(localized: "settings.general.tab-bar-position.top", defaultValue: "Top", comment: "Top position option for tab bar"))
                .tag(SettingsData.SidebarTabBarPosition.top)
            Text(String(localized: "settings.general.tab-bar-position.side", defaultValue: "Side", comment: "Side position option for tab bar"))
                .tag(SettingsData.SidebarTabBarPosition.side)
    ...
    var reopenBehavior: some View {
        Picker(String(localized: "settings.general.reopen-behavior", defaultValue: "Reopen Behavior", comment: "Picker label for app reopen behavior setting"), selection: $settings.reopenBehavior) {
            Text(String(localized: "settings.general.reopen-behavior.welcome-screen", defaultValue: "Welcome Screen", comment: "Show welcome screen on reopen option"))
                .tag(SettingsData.ReopenBehavior.welcome)
            Divider()
            Text(String(localized: "settings.general.reopen-behavior.open-panel", defaultValue: "Open Panel", comment: "Show open panel on reopen option"))
                .tag(SettingsData.ReopenBehavior.openPanel)
            Text(String(localized: "settings.general.reopen-behavior.new-document", defaultValue: "New Document", comment: "Create new document on reopen option"))
    ...
    var afterWindowsCloseBehaviour: some View {
        Picker(
            String(localized: "settings.general.after-last-window-closed", defaultValue: "After the last window is closed", comment: "Picker label for behavior after last window closes"),
            ...
            Divider()
            Text(String(localized: "settings.general.after-last-window-closed.show-welcome", defaultValue: "Show Welcome Window", comment: "Show welcome window after last window closes option"))
                .tag(SettingsData.ReopenWindowBehavior.showWelcomeWindow)
            Text(String(localized: "settings.general.after-last-window-closed.quit", defaultValue: "Quit", comment: "Quit app after last window closes option"))
                .tag(SettingsData.ReopenWindowBehavior.quit)
        }
    }

    var projectNavigatorSize: some View {
        Picker(String(localized: "settings.general.project-navigator-size", defaultValue: "Project Navigator Size", comment: "Picker label for project navigator size setting"), selection: $settings.projectNavigatorSize) {
    ...
    var findNavigatorDetail: some View {
        Picker(String(localized: "settings.general.find-navigator-detail", defaultValue: "Find Navigator Detail", comment: "Picker label for find navigator detail level setting"), selection: $settings.findNavigatorDetail) {
    ...
    var issueNavigatorDetail: some View {
        Picker(String(localized: "settings.general.issue-navigator-detail", defaultValue: "Issue Navigator Detail", comment: "Picker label for issue navigator detail level setting"), selection: $settings.issueNavigatorDetail) {
            ForEach(SettingsData.NavigatorDetail.allCases, id: \.self) { tag in
                Text(tag.label).tag(tag)
            }
        }
    ...
    var dialogWarnings: some View {
        LabeledContent(String(localized: "settings.general.dialog-warnings", defaultValue: "Dialog Warnings", comment: "Label for dialog warnings reset section")) {
            Button(action: {
            }, label: {
                Text(String(localized: "settings.general.reset-warnings", defaultValue: "Reset \"Don't Ask Me\" Warnings", comment: "Button to reset suppressed warning dialogs"))
            })
    ...
    var shellCommand: some View {
        LabeledContent(String(localized: "settings.general.codeedit-shell-command", defaultValue: "'codeedit' Shell Command", comment: "Label for shell command installation section")) {
            Button(action: installShellCommand, label: {
                Text(String(localized: "settings.general.install", defaultValue: "Install", comment: "Button to install shell command"))
            })
            .disabled(true)
            .buttonStyle(.bordered)
        }
    ...
    var updateChecker: some View {
        Section {
            LabeledContent {
                Button(String(localized: "settings.general.check-now", defaultValue: "Check Now", comment: "Button to check for app updates now")) {
                    updater.checkForUpdates()
                }
            } label: {
                Text(String(localized: "settings.general.check-for-updates", defaultValue: "Check for updates", comment: "Label for update checking section"))
                Text(String(localized: "settings.general.last-checked", defaultValue: "Last checked: \(lastUpdatedString)", comment: "Text showing when updates were last checked"))
    ...
    var autoUpdateToggle: some View {
        Toggle(String(localized: "settings.general.auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Toggle for automatic update checking"), isOn: $updater.automaticallyChecksForUpdates)
    }

    var prereleaseToggle: some View {
        Toggle(String(localized: "settings.general.include-prerelease", defaultValue: "Include pre-release versions", comment: "Toggle for including pre-release versions in updates"), isOn: $updater.includePrereleaseVersions)
    }

    var autoSave: some View {
        Toggle(String(localized: "settings.general.auto-save", defaultValue: "Automatically save changes to disk", comment: "Toggle for automatic file saving"), isOn: $settings.isAutoSaveOn)
    }
    ...
    private var lastUpdatedString: String {
        if let lastUpdatedDate = updater.lastUpdateCheckDate {
            ...
            return String(localized: "settings.general.never", defaultValue: "Never", comment: "Indicates updates have never been checked")
        }
    }
    ...
    var openInCodeEditToggle: some View {
        Toggle(String(localized: "settings.general.show-open-with-codeedit", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Toggle for showing Open With CodeEdit in Finder context menu"), isOn: $openInCodeEdit)
    ...
    var revealFileOnFocusChangeToggle: some View {
        Toggle(String(localized: "settings.general.auto-reveal-in-navigator", defaultValue: "Automatically reveal in project navigator", comment: "Toggle for automatically revealing focused files in project navigator"), isOn: $settings.revealFileOnFocusChange)
    }
