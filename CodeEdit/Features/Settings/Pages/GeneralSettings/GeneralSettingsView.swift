...
private extension GeneralSettingsView {
    ...
    var fileExtensions: some View {
        Group {
            Picker(String(localized: "general-settings.file-extensions", defaultValue: "File Extensions", comment: "File extensions picker label"), selection: $settings.fileExtensionsVisibility) {
                ...
                Divider()
                Text(String(localized: "general-settings.file-extensions-show-only", defaultValue: "Show only", comment: "Show only specified file extensions option"))
                    .tag(SettingsData.FileExtensionsVisibility.showOnly)
                Text(String(localized: "general-settings.file-extensions-hide-only", defaultValue: "Hide only", comment: "Hide only specified file extensions option"))
    ...
    var navigatorTabBarPosition: some View {
        Picker(String(localized: "general-settings.navigator-tab-bar-position", defaultValue: "Navigator Tab Bar Position", comment: "Navigator tab bar position picker label"), selection: $settings.navigatorTabBarPosition) {
            Text(String(localized: "general-settings.navigator-tab-bar-position-top", defaultValue: "Top", comment: "Top navigator tab bar position option"))
                .tag(SettingsData.SidebarTabBarPosition.top)
            Text(String(localized: "general-settings.navigator-tab-bar-position-side", defaultValue: "Side", comment: "Side navigator tab bar position option"))
    ...
    var inspectorTabBarPosition: some View {
        Picker(String(localized: "general-settings.inspector-tab-bar-position", defaultValue: "Inspector Tab Bar Position", comment: "Inspector tab bar position picker label"), selection: $settings.inspectorTabBarPosition) {
            Text(String(localized: "general-settings.inspector-tab-bar-position-top", defaultValue: "Top", comment: "Top inspector tab bar position option"))
                .tag(SettingsData.SidebarTabBarPosition.top)
            Text(String(localized: "general-settings.inspector-tab-bar-position-side", defaultValue: "Side", comment: "Side inspector tab bar position option"))
                .tag(SettingsData.SidebarTabBarPosition.side)
        }
        .pickerStyle(.radioGroup)
    }
    ...
    var reopenBehavior: some View {
        Picker(String(localized: "general-settings.reopen-behavior", defaultValue: "Reopen Behavior", comment: "Reopen behavior picker label"), selection: $settings.reopenBehavior) {
            Text(String(localized: "general-settings.reopen-behavior-welcome", defaultValue: "Welcome Screen", comment: "Welcome screen reopen option"))
    ...
    var afterWindowsCloseBehaviour: some View {
        Picker(
            ...
            Text(String(localized: "general-settings.after-last-window-do-nothing", defaultValue: "Do nothing", comment: "Do nothing after last window closed option"))
                .tag(SettingsData.ReopenWindowBehavior.doNothing)
            Divider()
            Text(String(localized: "general-settings.after-last-window-show-welcome", defaultValue: "Show Welcome Window", comment: "Show welcome window after last window closed option"))
                .tag(SettingsData.ReopenWindowBehavior.showWelcomeWindow)
            Text(String(localized: "general-settings.after-last-window-quit", defaultValue: "Quit", comment: "Quit after last window closed option"))
    ...
    var projectNavigatorSize: some View {
        Picker(String(localized: "general-settings.project-navigator-size", defaultValue: "Project Navigator Size", comment: "Project navigator size picker label"), selection: $settings.projectNavigatorSize) {
            Text(String(localized: "general-settings.project-navigator-size-small", defaultValue: "Small", comment: "Small project navigator size option"))
                .tag(SettingsData.ProjectNavigatorSize.small)
            Text(String(localized: "general-settings.project-navigator-size-medium", defaultValue: "Medium", comment: "Medium project navigator size option"))
                .tag(SettingsData.ProjectNavigatorSize.medium)
            Text(String(localized: "general-settings.project-navigator-size-large", defaultValue: "Large", comment: "Large project navigator size option"))
    ...
    var dialogWarnings: some View {
        LabeledContent(String(localized: "general-settings.dialog-warnings", defaultValue: "Dialog Warnings", comment: "Dialog warnings label")) {
            Button(action: {
                ...
                Text(String(localized: "general-settings.reset-dont-ask-warnings", defaultValue: "Reset \"Don't Ask Me\" Warnings", comment: "Reset don't ask me warnings button"))
            })
    ...
    var shellCommand: some View {
        LabeledContent(String(localized: "general-settings.codeedit-shell-command", defaultValue: "'codeedit' Shell Command", comment: "'codeedit' shell command label")) {
            Button(action: installShellCommand, label: {
                Text(String(localized: "general-settings.install-shell-command", defaultValue: "Install", comment: "Install shell command button"))
            })
            .disabled(true)
            .buttonStyle(.bordered)
        }
    ...
    var autoSave: some View {
        Toggle(String(localized: "general-settings.auto-save", defaultValue: "Automatically save changes to disk", comment: "Automatically save changes to disk toggle"), isOn: $settings.isAutoSaveOn)
    }
    ...
    private var lastUpdatedString: String {
        if let lastUpdatedDate = updater.lastUpdateCheckDate {
            ...
            return String(localized: "general-settings.never-checked", defaultValue: "Never", comment: "Never checked for updates")
        }
    }
    ...
    var openInCodeEditToggle: some View {
        Toggle(String(localized: "general-settings.show-open-with-codeedit", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Show open with CodeEdit option in Finder toggle"), isOn: $openInCodeEdit)
    ...
    var revealFileOnFocusChangeToggle: some View {
        Toggle(String(localized: "general-settings.auto-reveal-in-navigator", defaultValue: "Automatically reveal in project navigator", comment: "Automatically reveal in project navigator toggle"), isOn: $settings.revealFileOnFocusChange)
    }
