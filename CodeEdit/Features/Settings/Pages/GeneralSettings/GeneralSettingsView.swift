...
private extension GeneralSettingsView {
    var appearance: some View {
        Picker(String(localized: "settings.general.appearance", defaultValue: "Appearance", comment: "Label for appearance preference picker"), selection: $settings.appAppearance) {
    ...
    var showIssues: some View {
        Picker(String(localized: "settings.general.show-issues", defaultValue: "Show Issues", comment: "Label for show issues preference picker"), selection: $settings.showIssues) {
    ...
    var showLiveIssues: some View {
        Toggle(String(localized: "settings.general.show-live-issues", defaultValue: "Show Live Issues", comment: "Label for show live issues toggle"), isOn: $settings.showLiveIssues)
    }

    var showEditorJumpBar: some View {
        Toggle(String(localized: "settings.general.show-jump-bar", defaultValue: "Show Jump Bar", comment: "Label for show jump bar toggle"), isOn: $settings.showEditorJumpBar)
    }

    var dimEditorsWithoutFocus: some View {
        Toggle(String(localized: "settings.general.dim-editors-without-focus", defaultValue: "Dim editors without focus", comment: "Label for dim editors without focus toggle"), isOn: $settings.dimEditorsWithoutFocus)
    }

    var fileExtensions: some View {
        Group {
            Picker(String(localized: "settings.general.file-extensions", defaultValue: "File Extensions", comment: "Label for file extensions preference picker"), selection: $settings.fileExtensionsVisibility) {
                ...
                Divider()
                Text(String(localized: "settings.general.file-extensions.show-only", defaultValue: "Show only", comment: "Show only selected file extensions option"))
                    .tag(SettingsData.FileExtensionsVisibility.showOnly)
                Text(String(localized: "settings.general.file-extensions.hide-only", defaultValue: "Hide only", comment: "Hide only selected file extensions option"))
    ...
    var fileIconStyle: some View {
        Picker(String(localized: "settings.general.file-icon-style", defaultValue: "File Icon Style", comment: "Label for file icon style preference picker"), selection: $settings.fileIconStyle) {
    ...
    var navigatorTabBarPosition: some View {
        Picker(String(localized: "settings.general.navigator-tab-bar-position", defaultValue: "Navigator Tab Bar Position", comment: "Label for navigator tab bar position preference picker"), selection: $settings.navigatorTabBarPosition) {
    ...
    var inspectorTabBarPosition: some View {
        Picker(String(localized: "settings.general.inspector-tab-bar-position", defaultValue: "Inspector Tab Bar Position", comment: "Label for inspector tab bar position preference picker"), selection: $settings.inspectorTabBarPosition) {
            Text(String(localized: "settings.general.position.top", defaultValue: "Top", comment: "Top position option"))
                .tag(SettingsData.SidebarTabBarPosition.top)
            Text(String(localized: "settings.general.position.side", defaultValue: "Side", comment: "Side position option"))
                .tag(SettingsData.SidebarTabBarPosition.side)
    ...
    var reopenBehavior: some View {
        Picker(String(localized: "settings.general.reopen-behavior", defaultValue: "Reopen Behavior", comment: "Label for reopen behavior preference picker"), selection: $settings.reopenBehavior) {
    ...
    var afterWindowsCloseBehaviour: some View {
        Picker(
            String(localized: "settings.general.after-last-window-closed", defaultValue: "After the last window is closed", comment: "Label for after last window closed behavior preference picker"),
    ...
    var projectNavigatorSize: some View {
        Picker(String(localized: "settings.general.project-navigator-size", defaultValue: "Project Navigator Size", comment: "Label for project navigator size preference picker"), selection: $settings.projectNavigatorSize) {
    ...
    var findNavigatorDetail: some View {
        Picker(String(localized: "settings.general.find-navigator-detail", defaultValue: "Find Navigator Detail", comment: "Label for find navigator detail preference picker"), selection: $settings.findNavigatorDetail) {
    ...
    var issueNavigatorDetail: some View {
        Picker(String(localized: "settings.general.issue-navigator-detail", defaultValue: "Issue Navigator Detail", comment: "Label for issue navigator detail preference picker"), selection: $settings.issueNavigatorDetail) {
            ForEach(SettingsData.NavigatorDetail.allCases, id: \.self) { tag in
                Text(tag.label).tag(tag)
            }
        }
    ...
    var dialogWarnings: some View {
        LabeledContent(String(localized: "settings.general.dialog-warnings", defaultValue: "Dialog Warnings", comment: "Label for dialog warnings section")) {
            Button(action: {
            }, label: {
    ...
    var shellCommand: some View {
        LabeledContent(String(localized: "settings.general.shell-command", defaultValue: "'codeedit' Shell Command", comment: "Label for codeedit shell command section")) {
    ...
    var updateChecker: some View {
        Section {
            LabeledContent {
                ...
                Text(String(localized: "settings.general.updates.check-for-updates", defaultValue: "Check for updates", comment: "Label for check for updates section"))
    ...
    var prereleaseToggle: some View {
        Toggle(String(localized: "settings.general.updates.include-prerelease", defaultValue: "Include pre-release versions", comment: "Toggle to include pre-release versions in updates"), isOn: $updater.includePrereleaseVersions)
    }

    var autoSave: some View {
        Toggle(String(localized: "settings.general.auto-save", defaultValue: "Automatically save changes to disk", comment: "Toggle to automatically save changes to disk"), isOn: $settings.isAutoSaveOn)
    }
    ...
    private var lastUpdatedString: String {
        if let lastUpdatedDate = updater.lastUpdateCheckDate {
            ...
            return String(localized: "settings.general.updates.never", defaultValue: "Never", comment: "Text shown when updates have never been checked")
        }
    }
    ...
    var openInCodeEditToggle: some View {
        Toggle(String(localized: "settings.general.open-in-codeedit", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Toggle to show Open With CodeEdit option in Finder"), isOn: $openInCodeEdit)
    ...
    var revealFileOnFocusChangeToggle: some View {
        Toggle(String(localized: "settings.general.reveal-in-navigator", defaultValue: "Automatically reveal in project navigator", comment: "Toggle to automatically reveal in project navigator"), isOn: $settings.revealFileOnFocusChange)
    }
