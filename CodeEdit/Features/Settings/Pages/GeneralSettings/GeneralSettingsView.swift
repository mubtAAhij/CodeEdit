...
private extension GeneralSettingsView {
    ...
    var afterWindowsCloseBehaviour: some View {
        Picker(
            String(localized: "settings.general.after-last-window-closed", defaultValue: "After the last window is closed", comment: "After last window is closed picker label"),
            ...
            Divider()
            Text(String(localized: "settings.general.after-last-window-closed.show-welcome", defaultValue: "Show Welcome Window", comment: "Show welcome window after last window closed option"))
    ...
    var projectNavigatorSize: some View {
        Picker(String(localized: "settings.general.project-navigator-size", defaultValue: "Project Navigator Size", comment: "Project navigator size picker label"), selection: $settings.projectNavigatorSize) {
            Text(String(localized: "settings.general.navigator-size.small", defaultValue: "Small", comment: "Small navigator size option"))
                .tag(SettingsData.ProjectNavigatorSize.small)
            Text(String(localized: "settings.general.navigator-size.medium", defaultValue: "Medium", comment: "Medium navigator size option"))
                .tag(SettingsData.ProjectNavigatorSize.medium)
            Text(String(localized: "settings.general.navigator-size.large", defaultValue: "Large", comment: "Large navigator size option"))
    ...
    var dialogWarnings: some View {
        LabeledContent(String(localized: "settings.general.dialog-warnings", defaultValue: "Dialog Warnings", comment: "Dialog warnings labeled content label")) {
            Button(action: {
            }, label: {
                Text(String(localized: "settings.general.reset-warnings", defaultValue: "Reset \"Don't Ask Me\" Warnings", comment: "Reset warnings button label"))
            })
    ...
    var shellCommand: some View {
        LabeledContent(String(localized: "settings.general.shell-command", defaultValue: "'codeedit' Shell Command", comment: "Shell command labeled content label")) {
            Button(action: installShellCommand, label: {
                Text(String(localized: "settings.extensions.install", defaultValue: "Install", comment: "Install button"))
            })
            .disabled(true)
            .buttonStyle(.bordered)
        }
    ...
    var updateChecker: some View {
        Section {
            LabeledContent {
                ...
                Text(String(format: String(localized: "settings.general.last-checked", defaultValue: "Last checked: %@", comment: "Last update check time label"), lastUpdatedString))
    ...
    var autoUpdateToggle: some View {
        Toggle(String(localized: "settings.general.auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Automatically check for updates toggle label"), isOn: $updater.automaticallyChecksForUpdates)
    }

    var prereleaseToggle: some View {
        Toggle(String(localized: "settings.general.include-prerelease", defaultValue: "Include pre-release versions", comment: "Include pre-release versions toggle label"), isOn: $updater.includePrereleaseVersions)
    }

    var autoSave: some View {
        Toggle(String(localized: "settings.general.auto-save", defaultValue: "Automatically save changes to disk", comment: "Auto-save toggle label"), isOn: $settings.isAutoSaveOn)
    }
    ...
    var openInCodeEditToggle: some View {
        Toggle(String(localized: "settings.general.show-open-with-codeedit", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Show open with CodeEdit in Finder toggle label"), isOn: $openInCodeEdit)
    ...
    var revealFileOnFocusChangeToggle: some View {
        Toggle(String(localized: "settings.general.auto-reveal-in-navigator", defaultValue: "Automatically reveal in project navigator", comment: "Auto-reveal in navigator toggle label"), isOn: $settings.revealFileOnFocusChange)
    }
