...
private extension GeneralSettingsView {
    ...
    var dimEditorsWithoutFocus: some View {
        Toggle(String(localized: "settings.general.dim-editors", defaultValue: "Dim editors without focus", comment: "Dim unfocused editors toggle label"), isOn: $settings.dimEditorsWithoutFocus)
    }
    ...
    var navigatorTabBarPosition: some View {
        Picker(String(localized: "settings.general.navigator-tab-position", defaultValue: "Navigator Tab Bar Position", comment: "Navigator tab bar position picker label"), selection: $settings.navigatorTabBarPosition) {
    ...
    var inspectorTabBarPosition: some View {
        Picker(String(localized: "settings.general.inspector-tab-position", defaultValue: "Inspector Tab Bar Position", comment: "Inspector tab bar position picker label"), selection: $settings.inspectorTabBarPosition) {
            Text(String(localized: "settings.general.position.top", defaultValue: "Top", comment: "Top position option"))
                .tag(SettingsData.SidebarTabBarPosition.top)
            Text(String(localized: "settings.general.position.side", defaultValue: "Side", comment: "Side position option"))
                .tag(SettingsData.SidebarTabBarPosition.side)
    ...
    var reopenBehavior: some View {
        Picker(String(localized: "settings.general.reopen-behavior", defaultValue: "Reopen Behavior", comment: "Reopen behavior picker label"), selection: $settings.reopenBehavior) {
            Text(String(localized: "settings.general.reopen.welcome", defaultValue: "Welcome Screen", comment: "Show welcome screen on reopen"))
                .tag(SettingsData.ReopenBehavior.welcome)
            Divider()
            Text(String(localized: "settings.general.reopen.open-panel", defaultValue: "Open Panel", comment: "Show open panel on reopen"))
                .tag(SettingsData.ReopenBehavior.openPanel)
            Text(String(localized: "settings.general.reopen.new-document", defaultValue: "New Document", comment: "Create new document on reopen"))
    ...
    var afterWindowsCloseBehaviour: some View {
        Picker(
            String(localized: "settings.general.after-last-window-closed", defaultValue: "After the last window is closed", comment: "Behavior after last window closes picker label"),
            selection: $settings.reopenWindowAfterClose
        ) {
            Text(String(localized: "settings.general.window-close.do-nothing", defaultValue: "Do nothing", comment: "Do nothing after last window closes"))
                .tag(SettingsData.ReopenWindowBehavior.doNothing)
            Divider()
            Text(String(localized: "settings.general.window-close.show-welcome", defaultValue: "Show Welcome Window", comment: "Show welcome window after last window closes"))
                .tag(SettingsData.ReopenWindowBehavior.showWelcomeWindow)
            Text(String(localized: "settings.general.window-close.quit", defaultValue: "Quit", comment: "Quit application after last window closes"))
    ...
    var dialogWarnings: some View {
        LabeledContent(String(localized: "settings.general.dialog-warnings", defaultValue: "Dialog Warnings", comment: "Dialog warnings label")) {
            Button(action: {
                ...
                Text(String(localized: "settings.general.reset-warnings", defaultValue: "Reset \"Don't Ask Me\" Warnings", comment: "Button to reset don't ask me warnings"))
            })
    ...
    var shellCommand: some View {
        LabeledContent(String(localized: "settings.general.shell-command", defaultValue: "'codeedit' Shell Command", comment: "Shell command installation label")) {
            Button(action: installShellCommand, label: {
                Text(String(localized: "settings.general.install", defaultValue: "Install", comment: "Install button label"))
            })
            .disabled(true)
            .buttonStyle(.bordered)
        }
    ...
    private var lastUpdatedString: String {
        if let lastUpdatedDate = updater.lastUpdateCheckDate {
            ...
            return String(localized: "settings.general.never-checked", defaultValue: "Never", comment: "Never checked for updates")
        }
    }
    ...
    var openInCodeEditToggle: some View {
        Toggle(String(localized: "settings.general.open-with-codeedit-toggle", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Toggle to show Open With CodeEdit in Finder context menu"), isOn: $openInCodeEdit)
    ...
    var revealFileOnFocusChangeToggle: some View {
        Toggle(String(localized: "settings.general.reveal-in-navigator-toggle", defaultValue: "Automatically reveal in project navigator", comment: "Toggle to automatically reveal current file in project navigator"), isOn: $settings.revealFileOnFocusChange)
    }
