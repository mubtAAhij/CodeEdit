...
private extension GeneralSettingsView {
    ...
    var dimEditorsWithoutFocus: some View {
        Toggle(String(localized: "settings.general.dim-editors", defaultValue: "Dim editors without focus", comment: "Dim editors without focus toggle label"), isOn: $settings.dimEditorsWithoutFocus)
    }
    ...
    var navigatorTabBarPosition: some View {
        Picker(
            String(localized: "settings.general.navigator-tab-bar-position", defaultValue: "Navigator Tab Bar Position", comment: "Navigator tab bar position setting label"),
    ...
    var inspectorTabBarPosition: some View {
        Picker(
            String(localized: "settings.general.inspector-tab-bar-position", defaultValue: "Inspector Tab Bar Position", comment: "Inspector tab bar position setting label"),
    ...
    var reopenBehavior: some View {
        Picker(String(localized: "settings.general.reopen-behavior", defaultValue: "Reopen Behavior", comment: "Reopen behavior setting label"), selection: $settings.reopenBehavior) {
    ...
    var afterWindowsCloseBehaviour: some View {
        Picker(
            String(localized: "settings.general.after-last-window-closed", defaultValue: "After the last window is closed", comment: "After last window closed setting label"),
    ...
    var projectNavigatorSize: some View {
        Picker(
            String(localized: "settings.general.project-navigator-size", defaultValue: "Project Navigator Size", comment: "Project navigator size setting label"),
    ...
    var findNavigatorDetail: some View {
        Picker(
            String(localized: "settings.general.find-navigator-detail", defaultValue: "Find Navigator Detail", comment: "Find navigator detail setting label"),
    ...
    var issueNavigatorDetail: some View {
        Picker(
            String(localized: "settings.general.issue-navigator-detail", defaultValue: "Issue Navigator Detail", comment: "Issue navigator detail setting label"),
    ...
    var dialogWarnings: some View {
        LabeledContent(String(localized: "settings.general.dialog-warnings", defaultValue: "Dialog Warnings", comment: "Dialog warnings setting label")) {
            Button(action: {
            }, label: {
    ...
    var shellCommand: some View {
        LabeledContent(String(localized: "settings.general.shell-command", defaultValue: "'codeedit' Shell Command", comment: "Shell command setting label")) {
            Button(action: installShellCommand, label: {
                Text(String(localized: "settings.general.shell-command.install", defaultValue: "Install", comment: "Install button label"))
            })
            .disabled(true)
            .buttonStyle(.bordered)
        }
    ...
    var updateChecker: some View {
        Section {
            LabeledContent {
                Button(String(localized: "settings.general.updates.check-now", defaultValue: "Check Now", comment: "Check now button label")) {
                ...
                Text(String(format: String(localized: "settings.general.updates.last-checked", defaultValue: "Last checked: %@", comment: "Last checked label with date"), lastUpdatedString))
    ...
    var autoUpdateToggle: some View {
        Toggle(
            String(localized: "settings.general.updates.auto-check", defaultValue: "Automatically check for app updates", comment: "Automatically check for updates toggle label"),
    ...
    var prereleaseToggle: some View {
        Toggle(
            String(localized: "settings.general.updates.include-prerelease", defaultValue: "Include pre-release versions", comment: "Include pre-release versions toggle label"),
    ...
    var openInCodeEditToggle: some View {
        Toggle(
            String(localized: "settings.general.open-with-codeedit", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Show Open With CodeEdit option toggle label"),
            isOn: $openInCodeEdit
        )
    ...
    var revealFileOnFocusChangeToggle: some View {
        Toggle(
            String(localized: "settings.general.reveal-in-navigator", defaultValue: "Automatically reveal in project navigator", comment: "Automatically reveal in navigator toggle label"),
