...
private extension GeneralSettingsView {
    ...
    var showIssues: some View {
        Picker(String(localized: "settings.general.show-issues", defaultValue: "Show Issues", comment: "Show issues picker label"), selection: $settings.showIssues) {
            Text(String(localized: "settings.general.show-issues.inline", defaultValue: "Show Inline", comment: "Show inline issues option"))
                .tag(SettingsData.Issues.inline)
            Text(String(localized: "settings.general.show-issues.minimized", defaultValue: "Show Minimized", comment: "Show minimized issues option"))
                .tag(SettingsData.Issues.minimized)
        }
    }

    var showLiveIssues: some View {
        Toggle(String(localized: "settings.general.show-live-issues", defaultValue: "Show Live Issues", comment: "Show live issues toggle label"), isOn: $settings.showLiveIssues)
    }

    var showEditorJumpBar: some View {
        Toggle(String(localized: "settings.general.show-jump-bar", defaultValue: "Show Jump Bar", comment: "Show jump bar toggle label"), isOn: $settings.showEditorJumpBar)
    }

    var dimEditorsWithoutFocus: some View {
        Toggle(String(localized: "settings.general.dim-editors-without-focus", defaultValue: "Dim editors without focus", comment: "Dim editors without focus toggle label"), isOn: $settings.dimEditorsWithoutFocus)
    }
    ...
    var navigatorTabBarPosition: some View {
        Picker(String(localized: "settings.general.navigator-tab-bar-position", defaultValue: "Navigator Tab Bar Position", comment: "Navigator tab bar position picker label"), selection: $settings.navigatorTabBarPosition) {
            Text(String(localized: "settings.general.navigator-tab-bar-position.top", defaultValue: "Top", comment: "Top position option"))
                .tag(SettingsData.SidebarTabBarPosition.top)
            Text(String(localized: "settings.general.navigator-tab-bar-position.side", defaultValue: "Side", comment: "Side position option"))
    ...
    var inspectorTabBarPosition: some View {
        Picker(String(localized: "settings.general.inspector-tab-bar-position", defaultValue: "Inspector Tab Bar Position", comment: "Inspector tab bar position picker label"), selection: $settings.inspectorTabBarPosition) {
            Text(String(localized: "settings.general.inspector-tab-bar-position.top", defaultValue: "Top", comment: "Top position option"))
                .tag(SettingsData.SidebarTabBarPosition.top)
            Text(String(localized: "settings.general.inspector-tab-bar-position.side", defaultValue: "Side", comment: "Side position option"))
                .tag(SettingsData.SidebarTabBarPosition.side)
        }
        .pickerStyle(.radioGroup)
    }
    ...
    var dialogWarnings: some View {
        LabeledContent(String(localized: "settings.general.dialog-warnings", defaultValue: "Dialog Warnings", comment: "Dialog warnings label")) {
            Button(action: {
                ...
                Text(String(localized: "settings.general.dialog-warnings.reset", defaultValue: "Reset \"Don't Ask Me\" Warnings", comment: "Reset don't ask me warnings button"))
            })
    ...
    var shellCommand: some View {
        LabeledContent(String(localized: "settings.general.codeedit-shell-command", defaultValue: "'codeedit' Shell Command", comment: "Codeedit shell command label")) {
            Button(action: installShellCommand, label: {
                Text(String(localized: "settings.general.codeedit-shell-command.install", defaultValue: "Install", comment: "Install button"))
            })
            .disabled(true)
            .buttonStyle(.bordered)
        }
    ...
    var updateChecker: some View {
        Section {
            LabeledContent {
                Button(String(localized: "settings.general.updates.check-now", defaultValue: "Check Now", comment: "Check now button")) {
                    updater.checkForUpdates()
                }
            } label: {
                Text(String(localized: "settings.general.updates.check-for-updates", defaultValue: "Check for updates", comment: "Check for updates label"))
                Text(String(format: String(localized: "settings.general.updates.last-checked", defaultValue: "Last checked: %@", comment: "Last checked label"), lastUpdatedString))
    ...
    var autoUpdateToggle: some View {
        Toggle(String(localized: "settings.general.updates.automatically-check", defaultValue: "Automatically check for app updates", comment: "Automatically check for updates toggle"), isOn: $updater.automaticallyChecksForUpdates)
    }
    ...
    var autoSave: some View {
        Toggle(String(localized: "settings.general.auto-save", defaultValue: "Automatically save changes to disk", comment: "Automatically save changes toggle"), isOn: $settings.isAutoSaveOn)
    }
    ...
    private var lastUpdatedString: String {
        if let lastUpdatedDate = updater.lastUpdateCheckDate {
            ...
            return String(localized: "settings.general.updates.never", defaultValue: "Never", comment: "Never checked for updates")
        }
    }
    ...
    var openInCodeEditToggle: some View {
        Toggle(String(localized: "settings.general.open-with-codeedit-toggle", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Show open with CodeEdit option toggle"), isOn: $openInCodeEdit)
