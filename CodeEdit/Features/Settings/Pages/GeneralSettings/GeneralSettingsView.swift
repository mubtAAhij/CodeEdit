...
private extension GeneralSettingsView {
    ...
    var prereleaseToggle: some View {
        Toggle(String(localized: "settings.general.include-prereleases", defaultValue: "Include pre-release versions", comment: "Include pre-release versions toggle"), isOn: $updater.includePrereleaseVersions)
    }
