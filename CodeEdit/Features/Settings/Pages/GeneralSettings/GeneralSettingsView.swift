...
private extension GeneralSettingsView {
    var appearance: some View {
        Picker(String(localized: "settings.general.appearance", defaultValue: "Appearance", comment: "Appearance setting label"), selection: $settings.appAppearance) {
    ...
    var showIssues: some View {
        Picker(String(localized: "settings.general.show-issues", defaultValue: "Show Issues", comment: "Show issues setting label"), selection: $settings.showIssues) {
    ...
    var dimEditorsWithoutFocus: some View {
        Toggle(String(localized: "settings.general.dim-editors", defaultValue: "Dim editors without focus", comment: "Dim unfocused editors toggle"), isOn: $settings.dimEditorsWithoutFocus)
    }

    var fileExtensions: some View {
        Group {
            Picker(String(localized: "settings.general.file-extensions", defaultValue: "File Extensions", comment: "File extensions setting label"), selection: $settings.fileExtensionsVisibility) {
                Text(String(localized: "settings.general.file-extensions.hide-all", defaultValue: "Hide all", comment: "Hide all extensions option"))
                    .tag(SettingsData.FileExtensionsVisibility.hideAll)
                Text(String(localized: "settings.general.file-extensions.show-all", defaultValue: "Show all", comment: "Show all extensions option"))
                    .tag(SettingsData.FileExtensionsVisibility.showAll)
                Divider()
                Text(String(localized: "settings.general.file-extensions.show-only", defaultValue: "Show only", comment: "Show only specific extensions option"))
                    .tag(SettingsData.FileExtensionsVisibility.showOnly)
                Text(String(localized: "settings.general.file-extensions.hide-only", defaultValue: "Hide only", comment: "Hide only specific extensions option"))
    ...
    var fileIconStyle: some View {
        Picker(String(localized: "settings.general.file-icon-style", defaultValue: "File Icon Style", comment: "File icon style setting label"), selection: $settings.fileIconStyle) {
    ...
    var navigatorTabBarPosition: some View {
        Picker(String(localized: "settings.general.navigator-tab-position", defaultValue: "Navigator Tab Bar Position", comment: "Navigator tab bar position setting"), selection: $settings.navigatorTabBarPosition) {
            Text(String(localized: "settings.general.tab-position.top", defaultValue: "Top", comment: "Top tab position option"))
                .tag(SettingsData.SidebarTabBarPosition.top)
            Text(String(localized: "settings.general.tab-position.side", defaultValue: "Side", comment: "Side tab position option"))
    ...
    var inspectorTabBarPosition: some View {
        Picker(String(localized: "settings.general.inspector-tab-position", defaultValue: "Inspector Tab Bar Position", comment: "Inspector tab bar position setting"), selection: $settings.inspectorTabBarPosition) {
            Text(String(localized: "settings.general.tab-position.top", defaultValue: "Top", comment: "Top tab position option"))
                .tag(SettingsData.SidebarTabBarPosition.top)
            Text(String(localized: "settings.general.tab-position.side", defaultValue: "Side", comment: "Side tab position option"))
                .tag(SettingsData.SidebarTabBarPosition.side)
    ...
    var reopenBehavior: some View {
        Picker(String(localized: "settings.general.reopen-behavior", defaultValue: "Reopen Behavior", comment: "Reopen behavior setting"), selection: $settings.reopenBehavior) {
    ...
    var afterWindowsCloseBehaviour: some View {
        Picker(
            String(localized: "settings.general.after-close", defaultValue: "After the last window is closed", comment: "After window close behavior setting"),
            selection: $settings.reopenWindowAfterClose
        ) {
            Text(String(localized: "settings.general.after-close.do-nothing", defaultValue: "Do nothing", comment: "Do nothing after close option"))
                .tag(SettingsData.ReopenWindowBehavior.doNothing)
            Divider()
            Text(String(localized: "settings.general.after-close.show-welcome", defaultValue: "Show Welcome Window", comment: "Show welcome window after close option"))
                .tag(SettingsData.ReopenWindowBehavior.showWelcomeWindow)
            Text(String(localized: "settings.general.after-close.quit", defaultValue: "Quit", comment: "Quit after close option"))
                .tag(SettingsData.ReopenWindowBehavior.quit)
        }
    }

    var projectNavigatorSize: some View {
        Picker(String(localized: "settings.general.navigator-size", defaultValue: "Project Navigator Size", comment: "Project navigator size setting"), selection: $settings.projectNavigatorSize) {
    ...
    var findNavigatorDetail: some View {
        Picker(String(localized: "settings.general.find-navigator-detail", defaultValue: "Find Navigator Detail", comment: "Find navigator detail setting"), selection: $settings.findNavigatorDetail) {
    ...
    var issueNavigatorDetail: some View {
        Picker(String(localized: "settings.general.issue-navigator-detail", defaultValue: "Issue Navigator Detail", comment: "Issue navigator detail setting"), selection: $settings.issueNavigatorDetail) {
            ForEach(SettingsData.NavigatorDetail.allCases, id: \.self) { tag in
                Text(tag.label).tag(tag)
            }
        }
    ...
    var dialogWarnings: some View {
        LabeledContent(String(localized: "settings.general.dialog-warnings", defaultValue: "Dialog Warnings", comment: "Dialog warnings setting")) {
            Button(action: {
            }, label: {
                Text(String(localized: "settings.general.reset-warnings", defaultValue: "Reset \"Don't Ask Me\" Warnings", comment: "Reset warnings button"))
            })
    ...
    var shellCommand: some View {
        LabeledContent(String(localized: "settings.general.shell-command", defaultValue: "'codeedit' Shell Command", comment: "Shell command setting")) {
    ...
    var updateChecker: some View {
        Section {
            LabeledContent {
                ...
                Text(String(localized: "settings.general.check-updates", defaultValue: "Check for updates", comment: "Check for updates label"))
                Text(String(format: String(localized: "settings.general.last-checked", defaultValue: "Last checked: %@", comment: "Last update check timestamp"), lastUpdatedString))
    ...
    var prereleaseToggle: some View {
        Toggle(String(localized: "settings.general.include-prerelease", defaultValue: "Include pre-release versions", comment: "Include prerelease versions toggle"), isOn: $updater.includePrereleaseVersions)
    }
    ...
    var openInCodeEditToggle: some View {
        Toggle(String(localized: "settings.general.open-with-codeedit", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Show open with CodeEdit in Finder toggle"), isOn: $openInCodeEdit)
    ...
    var revealFileOnFocusChangeToggle: some View {
        Toggle(String(localized: "settings.general.auto-reveal", defaultValue: "Automatically reveal in project navigator", comment: "Auto reveal in project navigator toggle"), isOn: $settings.revealFileOnFocusChange)
    }
