...
private extension GeneralSettingsView {
    var appearance: some View {
        Picker(String(
            localized: "settings.general.appearance.title",
            defaultValue: "Appearance",
            comment: "Section title for appearance settings."
        ), selection: $settings.appAppearance) {
            Text(String(
                localized: "settings.general.appearance.option.system",
                defaultValue: "System",
                comment: "Appearance option label for using system setting."
            ))
                .tag(SettingsData.Appearances.system)
            Divider()
            Text(String(
                localized: "settings.general.appearance.option.light",
                defaultValue: "Light",
                comment: "Appearance option label for light mode."
            ))
                .tag(SettingsData.Appearances.light)
            Text(String(
                localized: "settings.general.appearance.option.dark",
                defaultValue: "Dark",
    ...
    var showLiveIssues: some View {
        Toggle(String(
            ...
            comment: "General settings toggle label for showing live issues"
    ...
    var showEditorJumpBar: some View {
        Toggle(String(
            ...
            comment: "Toggle label for showing jump bar."
    ...
    var dimEditorsWithoutFocus: some View {
        Toggle(String(
            ...
            comment: "Toggle label for dimming unfocused editors."
    ...
    var fileExtensions: some View {
        Group {
            Picker(String(
                localized: "settings.general.file-extensions.title",
                defaultValue: "File Extensions",
                comment: "Section title for file extension display settings."
            ), selection: $settings.fileExtensionsVisibility) {
                Text(String(
                    localized: "settings.general.file-extensions.option.hide-all",
                    defaultValue: "Hide all",
                    comment: "File extension display option to hide all extensions."
                ))
                    .tag(SettingsData.FileExtensionsVisibility.hideAll)
                Text(String(
                    localized: "settings.general.file-extensions.option.show-all",
                    defaultValue: "Show all",
                    comment: "File extension display option to show all extensions."
                ))
                    .tag(SettingsData.FileExtensionsVisibility.showAll)
                Divider()
                Text(String(
                    localized: "settings.general.file-extensions.option.show-only",
                    defaultValue: "Show only",
                    comment: "File extension display option to show only selected extensions."
                ))
                    .tag(SettingsData.FileExtensionsVisibility.showOnly)
                Text(String(
                    localized: "settings.general.file-extensions.option.hide-only",
                    defaultValue: "Hide only",
                    comment: "File extension display option to hide only selected extensions."
                ))
    ...
    var fileIconStyle: some View {
        Picker(String(
            localized: "settings.general.file-icon-style.title",
            defaultValue: "File Icon Style",
            comment: "Section title for file icon style settings."
        ), selection: $settings.fileIconStyle) {
            Text(String(
                localized: "settings.general.file-icon-style.option.color",
                defaultValue: "Color",
                comment: "File icon style option for colored icons."
            ))
                .tag(SettingsData.FileIconStyle.color)
            Text(String(
                localized: "settings.general.file-icon-style.option.monochrome",
                defaultValue: "Monochrome",
                comment: "File icon style option for monochrome icons."
            ))
    ...
    var navigatorTabBarPosition: some View {
        Picker(String(
            localized: "settings.general.navigator-tab-bar-position.title",
            defaultValue: "Navigator Tab Bar Position",
            comment: "Section title for navigator tab bar position setting."
        ), selection: $settings.navigatorTabBarPosition) {
            Text(String(
                localized: "settings.general.navigator-tab-bar-position.option.top",
                defaultValue: "Top",
                comment: "Navigator tab bar position option for top placement."
            ))
                .tag(SettingsData.SidebarTabBarPosition.top)
            Text(String(
                localized: "settings.general.navigator-tab-bar-position.option.side",
                defaultValue: "Side",
                comment: "Navigator tab bar position option for side placement."
            ))
    ...
    var inspectorTabBarPosition: some View {
        Picker(String(
            localized: "settings.general.inspector-tab-bar-position.title",
            defaultValue: "Inspector Tab Bar Position",
            comment: "Section title for inspector tab bar position setting."
        ), selection: $settings.inspectorTabBarPosition) {
            Text(String(
                localized: "settings.general.inspector-tab-bar-position.option.top",
                defaultValue: "Top",
                comment: "Inspector tab bar position option for top placement."
            ))
                .tag(SettingsData.SidebarTabBarPosition.top)
            Text(String(
                localized: "settings.general.inspector-tab-bar-position.option.side",
                defaultValue: "Side",
                comment: "Inspector tab bar position option for side placement."
            ))
                .tag(SettingsData.SidebarTabBarPosition.side)
        }
        .pickerStyle(.radioGroup)
    ...
    var reopenBehavior: some View {
        Picker(String(
            localized: "settings.general.reopen-behavior.title",
            defaultValue: "Reopen Behavior",
            comment: "Section title for reopen behavior setting."
        ), selection: $settings.reopenBehavior) {
            Text(String(
                localized: "settings.general.reopen-behavior.option.welcome-screen",
                defaultValue: "Welcome Screen",
                comment: "Reopen behavior option for showing welcome screen."
            ))
                .tag(SettingsData.ReopenBehavior.welcome)
            Divider()
            Text(String(
                localized: "settings.general.reopen-behavior.option.open-panel",
                defaultValue: "Open Panel",
                comment: "Reopen behavior option for showing open panel."
            ))
                .tag(SettingsData.ReopenBehavior.openPanel)
            Text(String(
                localized: "settings.general.reopen-behavior.option.new-document",
                defaultValue: "New Document",
                comment: "Reopen behavior option for creating a new document."
            ))
    ...
    var afterWindowsCloseBehaviour: some View {
        Picker(
            String(
                localized: "settings.general.after-last-window-closed.title",
                defaultValue: "After the last window is closed",
                comment: "Section title for app behavior after the last window is closed."
            ),
            selection: $settings.reopenWindowAfterClose
        ) {
            Text(String(
                localized: "settings.general.after-last-window-closed.option.do-nothing",
                defaultValue: "Do nothing",
                comment: "Option for taking no action after the last window is closed."
            ))
                .tag(SettingsData.ReopenWindowBehavior.doNothing)
            Divider()
            Text(String(
                localized: "settings.general.after-last-window-closed.option.show-welcome-window",
                defaultValue: "Show Welcome Window",
                comment: "Option for showing welcome window after last window is closed."
            ))
                .tag(SettingsData.ReopenWindowBehavior.showWelcomeWindow)
            Text(String(
                localized: "settings.general.after-last-window-closed.option.quit",
                defaultValue: "Quit",
                comment: "Option for quitting app after the last window is closed."
            ))
    ...
    var projectNavigatorSize: some View {
        Picker(String(
            localized: "settings.general.project-navigator-size.title",
            defaultValue: "Project Navigator Size",
            comment: "Section title for project navigator size setting."
        ), selection: $settings.projectNavigatorSize) {
            Text(String(
                localized: "settings.general.project-navigator-size.option.small",
                defaultValue: "Small",
                comment: "Project navigator size option for small."
            ))
                .tag(SettingsData.ProjectNavigatorSize.small)
            Text(String(
                localized: "settings.general.project-navigator-size.option.medium",
                defaultValue: "Medium",
                comment: "Project navigator size option for medium."
            ))
                .tag(SettingsData.ProjectNavigatorSize.medium)
            Text(String(
                localized: "settings.general.project-navigator-size.option.large",
                defaultValue: "Large",
                comment: "Project navigator size option for large."
            ))
    ...
    var findNavigatorDetail: some View {
        Picker(String(
            ...
            comment: "Toggle label for showing find navigator detail."
    ...
    var issueNavigatorDetail: some View {
        Picker(String(
            ...
            comment: "Toggle label for showing issue navigator detail."
    ...
    var dialogWarnings: some View {
        LabeledContent(String(
            localized: "settings.general.dialog-warnings.title",
            ...
            Button(action: {
                ...
                Text(String(
                    ...
                    comment: "Button title for resetting suppressed dialog warnings."
                ))
            })
    ...
    var shellCommand: some View {
        LabeledContent(String(
            localized: "settings.general.shell-command.title",
            defaultValue: "'codeedit' Shell Command",
            comment: "Section title for shell command integration settings."
        )) {
        ...
        Section {
            LabeledContent {
                ...
                Text(String(
                    ...
                    comment: "Section title for update check settings."
                ))
                Text(String(format: String(
                    localized: "settings.general.updates.last-checked",
                    defaultValue: "Last checked: %@",
                    comment: "Label showing when updates were last checked."
                ), "\(lastUpdatedString)"))
    ...
    var prereleaseToggle: some View {
        Toggle(String(
            localized: "settings.general.updates.include-pre-release",
            defaultValue: "Include pre-release versions",
            comment: "Toggle label for including pre-release versions in update checks."
        ), isOn: $updater.includePrereleaseVersions)
    }

    var autoSave: some View {
        Toggle(String(
            localized: "settings.general.auto-save.automatically-save-changes",
            defaultValue: "Automatically save changes to disk",
            comment: "Toggle label for automatically saving edits to disk."
    ...
    private var lastUpdatedString: String {
        if let lastUpdatedDate = updater.lastUpdateCheckDate {
            ...
            return String(
                localized: "settings.general.auto-save.interval.never",
                defaultValue: "Never",
                comment: "Auto-save interval option for never."
            )
        }
    }
    ...
    var openInCodeEditToggle: some View {
        Toggle(String(
            localized: "settings.general.finder-integration.show-open-with-codeedit",
            defaultValue: "Show “Open With CodeEdit” option in Finder",
            comment: "Toggle label for showing Open With CodeEdit context menu option in Finder."
        ), isOn: $openInCodeEdit)
    ...
    var revealFileOnFocusChangeToggle: some View {
        Toggle(String(
            localized: "settings.general.navigator.automatically-reveal-in-project-navigator",
            defaultValue: "Automatically reveal in project navigator",
            comment: "Toggle label for automatically revealing active file in project navigator."
