...
private extension GeneralSettingsView {
    ...
    var dimEditorsWithoutFocus: some View {
        Toggle(
            String(localized: "settings.general.dim-editors", defaultValue: "Dim editors without focus", comment: "Toggle for dimming editors without focus"),
    ...
    var fileExtensions: some View {
        Group {
            Picker(
                String(localized: "settings.general.file-extensions", defaultValue: "File Extensions", comment: "Label for file extensions visibility picker"),
    ...
    var fileIconStyle: some View {
        Picker(String(localized: "settings.general.file-icon-style", defaultValue: "File Icon Style", comment: "Label for file icon style picker"), selection: $settings.fileIconStyle) {
            Text(String(localized: "settings.general.file-icon-style.color", defaultValue: "Color", comment: "Colored file icons option"))
    ...
    var navigatorTabBarPosition: some View {
        Picker(
            String(localized: "settings.general.navigator-position", defaultValue: "Navigator Tab Bar Position", comment: "Label for navigator tab bar position picker"),
    ...
    var inspectorTabBarPosition: some View {
        Picker(
            String(localized: "settings.general.inspector-position", defaultValue: "Inspector Tab Bar Position", comment: "Label for inspector tab bar position picker"),
    ...
    var afterWindowsCloseBehaviour: some View {
        Picker(
            String(localized: "settings.general.after-close", defaultValue: "After the last window is closed", comment: "Label for behavior after last window closes"),
            ...
            Text(String(localized: "settings.general.after-close.quit", defaultValue: "Quit", comment: "Quit application after close option"))
    ...
    var projectNavigatorSize: some View {
        Picker(
            String(localized: "settings.general.navigator-size", defaultValue: "Project Navigator Size", comment: "Label for project navigator size picker"),
    ...
    var findNavigatorDetail: some View {
        Picker(
            String(localized: "settings.general.find-navigator-detail", defaultValue: "Find Navigator Detail", comment: "Label for find navigator detail picker"),
    ...
    var issueNavigatorDetail: some View {
        Picker(
            String(localized: "settings.general.issue-navigator-detail", defaultValue: "Issue Navigator Detail", comment: "Label for issue navigator detail picker"),
    ...
    var dialogWarnings: some View {
        LabeledContent(String(localized: "settings.general.dialog-warnings", defaultValue: "Dialog Warnings", comment: "Label for dialog warnings setting")) {
            Button(action: {}, label: {
                Text(String(localized: "settings.general.reset-warnings", defaultValue: "Reset \"Don't Ask Me\" Warnings", comment: "Button to reset dismissed warning dialogs"))
            })
    ...
    var shellCommand: some View {
        LabeledContent(String(localized: "settings.general.shell-command", defaultValue: "'codeedit' Shell Command", comment: "Label for shell command installation")) {
    ...
    var updateChecker: some View {
        Section {
            LabeledContent {
                Button(String(localized: "settings.general.check-now", defaultValue: "Check Now", comment: "Button to check for updates now")) {
                    updater.checkForUpdates()
                }
            } label: {
                Text(String(localized: "settings.general.check-updates", defaultValue: "Check for updates", comment: "Label for update checking setting"))
    ...
    var autoUpdateToggle: some View {
        Toggle(
            String(localized: "settings.general.auto-check-updates", defaultValue: "Automatically check for app updates", comment: "Toggle for automatic update checking"),
    ...
    var prereleaseToggle: some View {
        Toggle(
            String(localized: "settings.general.include-prerelease", defaultValue: "Include pre-release versions", comment: "Toggle for including pre-release versions in updates"),
    ...
    private var lastUpdatedString: String {
        if let lastUpdatedDate = updater.lastUpdateCheckDate {
            ...
            String(localized: "settings.general.never", defaultValue: "Never", comment: "Indicates update was never checked")
        }
    }
    ...
    var openInCodeEditToggle: some View {
        Toggle(
            String(localized: "settings.general.open-with-codeedit", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Toggle for showing Open With CodeEdit in Finder"),
            isOn: $openInCodeEdit
        )
    ...
    var revealFileOnFocusChangeToggle: some View {
        Toggle(
            String(localized: "settings.general.auto-reveal", defaultValue: "Automatically reveal in project navigator", comment: "Toggle for automatically revealing files in project navigator"),
