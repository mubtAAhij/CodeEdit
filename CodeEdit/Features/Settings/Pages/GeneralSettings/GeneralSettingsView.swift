...
private extension GeneralSettingsView {
    ...
    var dimEditorsWithoutFocus: some View {
        Toggle(String(localized: "settings.general.dim-editors", defaultValue: "Dim editors without focus", comment: "Dim editors without focus toggle"), isOn: $settings.dimEditorsWithoutFocus)
    }
    ...
    var inspectorTabBarPosition: some View {
        Picker(String(localized: "settings.general.inspector-tab-bar-position", defaultValue: "Inspector Tab Bar Position", comment: "Inspector tab bar position picker label"), selection: $settings.inspectorTabBarPosition) {
            Text(String(localized: "settings.general.tab-bar-position.top-inspector", defaultValue: "Top", comment: "Top inspector tab bar position option"))
                .tag(SettingsData.SidebarTabBarPosition.top)
            Text(String(localized: "settings.general.tab-bar-position.side-inspector", defaultValue: "Side", comment: "Side inspector tab bar position option"))
                .tag(SettingsData.SidebarTabBarPosition.side)
        }
        .pickerStyle(.radioGroup)
    }
    ...
    var updateChecker: some View {
        Section {
            LabeledContent {
                Button(String(localized: "settings.general.update-checker.check-now", defaultValue: "Check Now", comment: "Check now button")) {
                    updater.checkForUpdates()
                }
            } label: {
                Text(String(localized: "settings.general.update-checker.title", defaultValue: "Check for updates", comment: "Check for updates label"))
                Text(String(format: String(localized: "settings.general.update-checker.last-checked", defaultValue: "Last checked: %@", comment: "Last checked timestamp"), lastUpdatedString))
    ...
    var autoUpdateToggle: some View {
        Toggle(String(localized: "settings.general.update-checker.auto-check", defaultValue: "Automatically check for app updates", comment: "Automatically check for updates toggle"), isOn: $updater.automaticallyChecksForUpdates)
    }

    var prereleaseToggle: some View {
        Toggle(String(localized: "settings.general.update-checker.include-prerelease", defaultValue: "Include pre-release versions", comment: "Include pre-release versions toggle"), isOn: $updater.includePrereleaseVersions)
    }
    ...
    private var lastUpdatedString: String {
        if let lastUpdatedDate = updater.lastUpdateCheckDate {
            ...
            return String(localized: "settings.general.update-checker.never", defaultValue: "Never", comment: "Never checked for updates")
        }
    }
    ...
    var openInCodeEditToggle: some View {
        Toggle(String(localized: "settings.general.open-with-codeedit", defaultValue: "Show \"Open With CodeEdit\" option in Finder", comment: "Show open with CodeEdit option toggle"), isOn: $openInCodeEdit)
