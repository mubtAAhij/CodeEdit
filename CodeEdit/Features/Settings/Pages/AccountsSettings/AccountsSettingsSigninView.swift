            ...
            Form {
                Section(
                    ...
                    header: {
                        VStack(alignment: .center, spacing: 10) {
                            FeatureIcon(image: Image(provider.iconResource), size: 52)
                                .padding(.top, 5)
                            Text(String(localized: "sign_in_to_provider", arguments: [provider.name], comment: "Sign in header with provider name"))
                    ...
                    footer: {
                        VStack(alignment: .leading, spacing: 5) {
                            if provider == .github {
                                Text(String(localized: "token_scopes_required", arguments: [provider.name], comment: "Message about required token scopes"))
                            ...
                            Button {
                                ...
                                if provider.authType == .password {
                                    Text(String(localized: "create_password_on_provider", arguments: [provider.name], comment: "Create password link text"))
                                        .font(.system(size: 10.5))
                                } else {
                                    Text(String(localized: "create_token_on_provider", arguments: [provider.name], comment: "Create token link text"))
                                        .font(.system(size: 10.5))
                                }
                            }
                            .buttonStyle(.link)
