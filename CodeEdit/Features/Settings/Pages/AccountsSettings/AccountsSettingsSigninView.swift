...
struct AccountsSettingsSigninView: View {
        ...
        VStack(spacing: 0) {
            Form {
                Section(
                    content: {
                        if provider.baseURL == nil {
                            VStack(alignment: .leading, spacing: 5) {
                                Text(String(localized: "accounts.signin.server", comment: "Label for server field in account signin"))
                                    .font(.caption3)
                        ...
                        VStack(alignment: .leading, spacing: 5) {
                            Text(String(localized: "accounts.signin.username", comment: "Label for username field in account signin"))
                                .font(.caption3)
                                .foregroundColor(.secondary)
                        ...
                        VStack(alignment: .leading, spacing: 5) {
                            Text(String(localized: "accounts.signin.personal_access_token", comment: "Label for personal access token field in account signin"))
                                .font(.caption3)
                                .foregroundColor(.secondary)
                    ...
                    header: {
                        VStack(alignment: .center, spacing: 10) {
                            FeatureIcon(image: Image(provider.iconResource), size: 52)
                                .padding(.top, 5)
                            Text(String(localized: "accounts.signin.title", comment: "Title for account signin dialog with provider name"))
                    ...
                    footer: {
                        VStack(alignment: .leading, spacing: 5) {
                            if provider == .github {
                                Text(String(localized: "accounts.signin.scopes_required", comment: "Instructions about required scopes for personal access tokens"))
                                ...
                                HStack(alignment: .center) {
                                    ...
                                    VStack(alignment: .leading) {
                                        ...
                                        HStack(spacing: 2.5) {
                                            Image(systemName: "checkmark")
                                                .font(.system(size: 10.5, weight: .semibold))
                                            Text(String(localized: "accounts.signin.scope.user", comment: "Required scope name for user access"))
                                                .font(.system(size: 10.5))
                                        }
                                    }
                                    Spacer()
                            ...
                            Button {
                                ...
                                if provider.authType == .password {
                                    Text(String(localized: "accounts.signin.create_password", comment: "Link text to create password on provider"))
                                        .font(.system(size: 10.5))
                                } else {
                                    Text(String(localized: "accounts.signin.create_token", comment: "Link text to create token on provider"))
                                        .font(.system(size: 10.5))
                                }
                            }
                            .buttonStyle(.link)
            ...
            HStack {
                ...
                Button {
                    ...
                    Text(String(localized: "accounts.signin.button", comment: "Sign in button"))
                        .frame(maxWidth: .infinity)
                }
                ...
                .alert(
                    ...
                    Button(String(localized: "general.ok", comment: "OK button")) {
    ...
    private func signin() {
        if gitAccounts.contains(
            ...
            signinErrorDetail = String(localized: "accounts.signin.error.duplicate_account", comment: "Error message when account already exists")
            signinErrorAlertIsPresented.toggle()
        } else {
    ...
    private func handleGitRequestFailed(_ error: Error) {
        ...
        case 401:
            signinErrorDetail = String(localized: "accounts.signin.error.auth_failed", comment: "Error message when authentication fails")
        case 403:
            signinErrorDetail = String(localized: "accounts.signin.error.api_forbidden", comment: "Error message when API access is forbidden")
        default:
            signinErrorDetail = String(localized: "accounts.signin.error.unknown", comment: "Generic unknown error message")
        }
        signinErrorAlertIsPresented.toggle()
    }
}
