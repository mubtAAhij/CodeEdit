...
struct AccountsSettingsView: View {
    ...
    private var implementationNeeded: some View {
        VStack(spacing: 20) {
            Text(String(localized: "accounts.git-client-not-supported", defaultValue: "This git client is currently not supported.", comment: "Error message for unsupported git clients"))
            HStack {
                Button(String(localized: "accounts.close", defaultValue: "Close", comment: "Close button")) {
