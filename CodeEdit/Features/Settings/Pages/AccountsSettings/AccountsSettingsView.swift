...
struct AccountsSettingsView: View {
    ...
    private var implementationNeeded: some View {
        VStack(spacing: 20) {
            Text(String(localized: "settings.accounts.git-client-not-supported", defaultValue: "This git client is currently not supported.", comment: "Alert message for unsupported git client"))
            HStack {
