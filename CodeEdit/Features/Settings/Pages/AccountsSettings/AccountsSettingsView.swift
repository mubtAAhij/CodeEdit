        ...
        SettingsForm {
            Section {
                if $gitAccounts.isEmpty {
                    Text(String(localized: "settings.accounts.empty", defaultValue: "No accounts", comment: "Message when no accounts configured"))
                ...
                HStack {
                    Spacer()
                    Button(String(localized: "settings.accounts.add", defaultValue: "Add Account...", comment: "Add account menu item")) { addAccountSheetPresented.toggle() }
