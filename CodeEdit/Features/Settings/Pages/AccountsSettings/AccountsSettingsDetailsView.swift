    ...
    var body: some View {
        SettingsForm {
            Section {
                ...
                TextField(String(localized: "description", comment: "Description field placeholder"), text: $currentAccount.description)
                if currentAccount.provider.baseURL == nil {
                    TextField(String(localized: "server", comment: "Server field placeholder"), text: $currentAccount.serverURL)
                }
            }
            ...
            Section {
                Picker(selection: $currentAccount.urlProtocol) {
                    ...
                    Text(String(localized: "clone_using", comment: "Clone Using picker label"))
                    Text(String(localized: "new_repositories_will_be_cloned_from", comment: "Clone description text")
                         + String(localized: "using_protocol", comment: "Protocol usage description"))
                }
                ...
                HStack {
                    Button(String(localized: "delete_account", comment: "Delete Account button text")) {
                    ...
                    .alert(
                        ...
                        Text(String(localized: "delete_account_confirmation_message", comment: "Account deletion confirmation message"))
                    }
