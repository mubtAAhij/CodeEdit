    ...
    var body: some View {
        SettingsForm {
            Section {
                LabeledContent(
                    String(
                        localized: "settings.accounts.details.account.label",
                        defaultValue: "Account",
                        comment: "Label for account name in account details settings"
                    )
                ) {
                ...
                TextField(
                    String(
                        localized: "settings.accounts.details.description.placeholder",
                        defaultValue: "Description",
                        comment: "Placeholder for account description field in account details settings"
                    ),
                ...
                if currentAccount.provider.baseURL == nil {
                    TextField(
                        String(
                            localized: "settings.accounts.details.server.placeholder",
                            defaultValue: "Server",
                            comment: "Placeholder for server field in account details settings"
                        ),
                ...
                Picker(selection: $currentAccount.urlProtocol) {
                    ...
                    Text(
                        String(
                            ...
                            comment: "Label for clone protocol picker in account details settings"
                        )
                    )
                    Text(
                        String(
                            format: String(
                                ...
                                comment: "Description for clone protocol picker showing provider and protocol"
                            ),
                ...
                if currentAccount.urlProtocol == .ssh {
                    Picker(
                        String(
                            ...
                            comment: "Label for SSH key picker in account details settings"
                        ),
                        ...
                        Text(
                            String(
                                ...
                                defaultValue: "None",
                                comment: "Option indicating no SSH key is selected"
                            )
                        )
                            .tag("")
                        Divider()
                ...
                HStack {
                    Button(
                        String(
                            ...
                            comment: "Button title to delete current account"
                        )
                    ) {
                    ...
                    .alert(
                        Text(
                            String(
                                format: String(
                                    ...
                                    comment: "Alert title asking to confirm account deletion"
                                ),
                                account.description
                            )
                        ),
                        ...
                        Button(
                            String(
                                localized: "settings.accounts.details.delete-account.confirm",
                                defaultValue: "OK",
                                comment: "Confirmation button for account deletion"
                            )
                        ) {
                        ...
                        Button(
                            String(
                                ...
                                defaultValue: "Cancel",
                                comment: "Cancel button for account deletion alert"
                            )
                        ) {
                        ...
                        Text(
                            String(
                                ...
                                comment: "Alert message explaining consequence of account deletion"
                            )
                        )
                    }
