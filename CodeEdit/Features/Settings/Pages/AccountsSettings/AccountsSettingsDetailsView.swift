        ...
        SettingsForm {
            ...
            Section {
                Picker(selection: $currentAccount.urlProtocol) {
                    ...
                    Text(String(localized: "new_repositories_will_be_cloned_from", comment: "Description for repository cloning source")
                         + String(localized: "using_protocol", comment: "Description for protocol used for cloning"))
                }
                ...
                HStack {
                    ...
                    .alert(
                        ...
                        Text("String(localized: "delete_account_confirmation_message", comment: "Confirmation message when deleting an account")")
                    }
