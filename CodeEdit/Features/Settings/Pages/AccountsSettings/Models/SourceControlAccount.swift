...
struct SourceControlAccount: Codable, Identifiable, Hashable {
    ...
    enum Provider: Codable, CaseIterable, Identifiable {
        ...
        var name: String {
            switch self {
            case .bitbucketCloud:
                return String(localized: "settings.accounts.source-control-provider.bitbucket-cloud", defaultValue: "BitBucket Cloud", comment: "Provider display name for BitBucket Cloud")
            case .bitbucketServer:
                return String(localized: "settings.accounts.source-control-provider.bitbucket-server", defaultValue: "BitBucket Server", comment: "Provider display name for BitBucket Server")
            case .github:
                return String(localized: "settings.accounts.source-control-provider.github", defaultValue: "GitHub", comment: "Provider display name for GitHub")
            case .githubEnterprise:
                return String(localized: "settings.accounts.source-control-provider.github-enterprise", defaultValue: "GitHub Enterprise", comment: "Provider display name for GitHub Enterprise")
            case .gitlab:
                return String(localized: "settings.accounts.source-control-provider.gitlab", defaultValue: "GitLab", comment: "Provider display name for GitLab")
            case .gitlabSelfHosted:
                return String(localized: "settings.accounts.source-control-provider.gitlab-self-hosted", defaultValue: "GitLab Self-hosted", comment: "Provider display name for self-hosted GitLab")
            }
        }
