...
struct SourceControlAccount: Codable, Identifiable, Hashable {
    ...
    enum URLProtocol: String, Codable, CaseIterable {
        ...
        var localizedName: String {
            switch self {
            case .https:
                return String(localized: "account.protocol.https", defaultValue: "HTTPS", comment: "HTTPS protocol name")
            case .ssh:
                return String(localized: "account.protocol.ssh", defaultValue: "SSH", comment: "SSH protocol name")
            }
        }
    }
    ...
    enum Provider: Codable, CaseIterable, Identifiable {
        ...
        var name: String {
            ...
            case .gitlabSelfHosted:
                return String(localized: "account.provider.gitlab-selfhosted", defaultValue: "GitLab Self-hosted", comment: "GitLab Self-hosted provider name")
            }
        }
