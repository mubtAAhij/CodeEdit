...
struct SourceControlAccount: Codable, Identifiable, Hashable {
    ...
    enum URLProtocol: String, Codable, CaseIterable {
        ...
        var displayName: String {
            ...
            case .https:
                return String(
                    localized: "source-control.protocol.https",
                    defaultValue: "HTTPS",
                    comment: "HTTPS protocol display name"
                )
            case .ssh:
                return String(
                    localized: "source-control.protocol.ssh",
                    defaultValue: "SSH",
                    comment: "SSH protocol display name"
                )
            }
        }
    }
    ...
    enum Provider: Codable, CaseIterable, Identifiable {
        ...
        var name: String {
            ...
            case .bitbucketCloud:
                return String(
                    localized: "source-control.provider.bitbucket-cloud",
                    defaultValue: "BitBucket Cloud",
                    comment: "BitBucket Cloud provider name"
                )
            case .bitbucketServer:
                return String(
                    localized: "source-control.provider.bitbucket-server",
                    defaultValue: "BitBucket Server",
                    comment: "BitBucket Server provider name"
                )
            case .github:
                return String(
                    localized: "source-control.provider.github",
                    defaultValue: "GitHub",
                    comment: "GitHub provider name"
                )
            case .githubEnterprise:
                return String(
                    localized: "source-control.provider.github-enterprise",
                    defaultValue: "GitHub Enterprise",
                    comment: "GitHub Enterprise provider name"
                )
            case .gitlab:
                return String(
                    localized: "source-control.provider.gitlab",
                    defaultValue: "GitLab",
                    comment: "GitLab provider name"
                )
            case .gitlabSelfHosted:
                return String(
                    localized: "source-control.provider.gitlab-self-hosted",
                    defaultValue: "GitLab Self-hosted",
                    comment: "GitLab Self-hosted provider name"
                )
            }
        }
