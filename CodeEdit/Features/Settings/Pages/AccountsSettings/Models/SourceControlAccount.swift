...
struct SourceControlAccount: Codable, Identifiable, Hashable {
    ...
    enum URLProtocol: String, Codable, CaseIterable {
        ...
        var displayName: String {
            switch self {
            case .https:
                return String(localized: "source-control.protocol.https", defaultValue: "HTTPS", comment: "HTTPS protocol display name")
            case .ssh:
                return String(localized: "source-control.protocol.ssh", defaultValue: "SSH", comment: "SSH protocol display name")
            }
        }
    }
    ...
    enum Provider: Codable, CaseIterable, Identifiable {
        ...
        var name: String {
            ...
            case .gitlabSelfHosted:
                return String(localized: "source-control.provider.gitlab-selfhosted", defaultValue: "GitLab Self-hosted", comment: "GitLab Self-hosted provider name")
            }
        }
