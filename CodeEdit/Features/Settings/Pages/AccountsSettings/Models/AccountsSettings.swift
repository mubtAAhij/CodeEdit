...
extension SettingsData {
    ...
    struct AccountsSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "accounts-settings.accounts", defaultValue: "Accounts", comment: "Search key for accounts"),
                String(localized: "accounts-settings.delete-account", defaultValue: "Delete Account...", comment: "Search key for delete account"),
                String(localized: "accounts-settings.add-account", defaultValue: "Add Account...", comment: "Search key for add account")
            ]
        }
