...
extension SettingsData {
    ...
    struct AccountsSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                "Accounts",
                String(localized: "accounts_settings.delete_account", comment: "Menu item to delete account"),
                String(localized: "accounts_settings.add_account", comment: "Menu item to add account")
            ]
