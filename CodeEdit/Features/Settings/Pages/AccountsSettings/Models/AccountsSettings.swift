    ...
    struct AccountsSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "settings.accounts.delete", defaultValue: "Delete Account...", comment: "Delete account menu item"),
                String(localized: "settings.accounts.add", defaultValue: "Add Account...", comment: "Add account menu item")
            ]
        }
