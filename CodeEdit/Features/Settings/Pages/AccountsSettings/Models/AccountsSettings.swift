...
extension SettingsData {
    ...
    struct AccountsSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.accounts.title", defaultValue: "Accounts", comment: "Accounts settings search key"),
                String(localized: "settings.accounts.delete", defaultValue: "Delete Account...", comment: "Delete account settings search key"),
                String(localized: "settings.accounts.add", defaultValue: "Add Account...", comment: "Add account settings search key")
            ]
        }
