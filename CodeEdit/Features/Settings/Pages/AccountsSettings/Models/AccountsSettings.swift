...
extension SettingsData {
    ...
    struct AccountsSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.accounts.section-title", defaultValue: "Accounts", comment: "Settings section title for accounts"),
                String(localized: "settings.accounts.delete-account", defaultValue: "Delete Account...", comment: "Command title to delete selected account"),
                String(localized: "settings.accounts.add-account", defaultValue: "Add Account...", comment: "Command title to add a new account"),
            ]
