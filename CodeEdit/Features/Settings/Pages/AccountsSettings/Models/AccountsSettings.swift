...
extension SettingsData {
    ...
    struct AccountsSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                "Accounts",
                String(localized: "settings.accounts.search-keys.delete-account", defaultValue: "Delete Account...", comment: "Accounts settings search key for delete account"),
                String(localized: "settings.accounts.search-keys.add-account", defaultValue: "Add Account...", comment: "Accounts settings search key for add account")
            ]
