...
extension SettingsData {
    ...
    struct AccountsSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.accounts.title", defaultValue: "Accounts", comment: "Settings section title for accounts"),
                String(localized: "settings.accounts.delete-account", defaultValue: "Delete Account...", comment: "Command title to delete an account"),
                String(localized: "settings.accounts.add-account", defaultValue: "Add Account...", comment: "Command title to add an account"),
            ]
