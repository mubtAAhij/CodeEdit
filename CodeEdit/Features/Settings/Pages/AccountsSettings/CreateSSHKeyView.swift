        ...
        VStack {
            Form {
                Section(String(
                    ...
                    Picker(String(
                        ...
                        comment: "Label for SSH key type selector"
                    ...
                    if !passphrase.isEmpty {
                        SecureField(String(
                            ...
                            comment: "Label for passphrase confirmation field"
            ...
            HStack {
                ...
                Button(String(
                    ...
                    defaultValue: "Cancel",
                    comment: "Cancel button title in create SSH key sheet"
                )) {
                    dismiss()
                }
                Button(String(
                    ...
                    defaultValue: "Create",
                    comment: "Create button title in create SSH key sheet"
                )) {
                    // create the ssh key
                    dismiss()
                }
