...
final class SearchSettingsModel: ObservableObject {
    ...
    var extensionsURL: URL {
        baseURL.appending(path: String(localized: "settings.search.extensions", defaultValue: "Extensions", comment: "Search settings section title for file extensions"), directoryHint: .isDirectory)
    }
