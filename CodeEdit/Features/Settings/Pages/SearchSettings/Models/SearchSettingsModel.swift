...
final class SearchSettingsModel: ObservableObject {
    ...
    internal var extensionsURL: URL {
        baseURL.appending(path: String(localized: "search.extensions-folder", defaultValue: "Extensions", comment: "Search extensions folder name"), directoryHint: .isDirectory)
    }
