...
final class SearchSettingsModel: ObservableObject {
    ...
    internal var extensionsURL: URL {
        baseURL.appending(path: String(localized: "search-settings.path.extensions", defaultValue: "Extensions", comment: "Extensions folder path name"), directoryHint: .isDirectory)
    }
