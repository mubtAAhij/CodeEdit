...
extension SettingsData {
    struct SearchSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.search.ignore-glob-patterns", defaultValue: "Ignore Glob Patterns", comment: "Ignore glob patterns setting label"),
                String(localized: "settings.search.ignore-patterns", defaultValue: "Ignore Patterns", comment: "Ignore patterns setting label")
            ]
        }
