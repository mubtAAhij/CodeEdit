...
extension SettingsData {
    struct SearchSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.search.ignore-glob-patterns", defaultValue: "Ignore Glob Patterns", comment: "Search key for ignore glob patterns"),
                String(localized: "settings.search.ignore-patterns", defaultValue: "Ignore Patterns", comment: "Search key for ignore patterns")
            ]
        }
