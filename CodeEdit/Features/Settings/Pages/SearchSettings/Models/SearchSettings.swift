...
extension SettingsData {
    struct SearchSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "search-settings.ignore-glob-patterns", defaultValue: "Ignore Glob Patterns", comment: "Search key for ignore glob patterns setting"),
                String(localized: "search-settings.ignore-patterns", defaultValue: "Ignore Patterns", comment: "Search key for ignore patterns setting")
            ]
        }
