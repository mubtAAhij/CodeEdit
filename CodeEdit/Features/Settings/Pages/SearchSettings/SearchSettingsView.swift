    ...
    var body: some View {
        SettingsForm {
            Section {
                ...
                Text(String(localized: "search_settings.exclude", comment: "Exclude patterns section title"))
                Text(
...
struct ExcludedGlobPatternList: View {
    ...
    var body: some View {
        GlobPatternList(
            ...
            emptyMessage: String(localized: "search_settings.no_excluded_patterns", comment: "Message when no patterns are excluded")
        )
    }
}
