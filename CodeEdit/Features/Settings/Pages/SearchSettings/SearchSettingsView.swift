    ...
    var body: some View {
        SettingsForm {
            Section {
                ...
                Text(String(localized: "settings.search.exclude.title", defaultValue: "Exclude", comment: "Title for exclude section in search settings"))
                Text(String(
                    ...
                    comment: "Description for exclude glob patterns in search settings"
                ))
            }
        }
    }
