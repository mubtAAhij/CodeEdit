    ...
    var body: some View {
        SettingsForm {
            Section {
                ...
                Text(String(localized: "search_settings.exclude", comment: "Exclude section header"))
                Text(
...
struct ExcludedGlobPatternList: View {
    ...
    var body: some View {
        GlobPatternList(
            ...
            emptyMessage: String(localized: "search_settings.no_excluded_patterns", comment: "Empty state message for excluded patterns")
        )
    }
}
