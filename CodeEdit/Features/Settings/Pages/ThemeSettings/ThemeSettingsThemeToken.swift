        ...
        LabeledContent {
            HStack(spacing: 20) {
                HStack(spacing: 8) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "theme.font.bold", defaultValue: "Bold", comment: "Bold font style"))
                    Divider()
                        .fixedSize()
                    Toggle(isOn: $italic) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "theme.font.italic", defaultValue: "Italic", comment: "Italic font style"))
                }
