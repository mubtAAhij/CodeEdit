        ...
        LabeledContent {
            HStack(spacing: 20) {
                HStack(spacing: 8) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "theme.bold", defaultValue: "Bold", comment: "Bold text formatting toggle"))
                    Divider()
                        .fixedSize()
                    Toggle(isOn: $italic) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "theme.italic", defaultValue: "Italic", comment: "Italic text formatting toggle"))
                }
