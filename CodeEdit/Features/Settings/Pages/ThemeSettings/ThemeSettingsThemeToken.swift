        ...
        LabeledContent {
            HStack(spacing: 20) {
                HStack(spacing: 8) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "settings.theme.bold", defaultValue: "Bold", comment: "Tooltip for bold text formatting toggle"))
                    Divider()
                        .fixedSize()
                    Toggle(isOn: $italic) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "settings.theme.italic", defaultValue: "Italic", comment: "Tooltip for italic text formatting toggle"))
                }
