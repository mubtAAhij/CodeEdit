        ...
        LabeledContent {
            HStack(spacing: 20) {
                HStack(spacing: 8) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "theme.token.bold", defaultValue: "Bold", comment: "Tooltip for bold text toggle"))
                    Divider()
                        .fixedSize()
                    Toggle(isOn: $italic) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "theme.token.italic", defaultValue: "Italic", comment: "Tooltip for italic text toggle"))
                }
