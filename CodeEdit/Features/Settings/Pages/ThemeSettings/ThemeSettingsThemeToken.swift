        ...
        LabeledContent {
            HStack(spacing: 20) {
                HStack(spacing: 8) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "settings.theme.token.bold", defaultValue: "Bold", comment: "Bold toggle tooltip in theme token settings"))
                    Divider()
                        .fixedSize()
                    Toggle(isOn: $italic) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "settings.theme.token.italic", defaultValue: "Italic", comment: "Italic toggle tooltip in theme token settings"))
                }
