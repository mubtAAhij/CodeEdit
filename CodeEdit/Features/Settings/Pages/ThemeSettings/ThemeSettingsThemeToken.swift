        ...
        LabeledContent {
            HStack(spacing: 20) {
                HStack(spacing: 8) {
                    ...
                    .help(
                        String(
                            localized: "settings.theme.token.bold.help",
                            defaultValue: "Bold",
                            comment: "Help text for bold toggle in theme token editor"
                        )
                    )
                    Divider()
                        .fixedSize()
                    ...
                    .help(
                        String(
                            localized: "settings.theme.token.italic.help",
                            defaultValue: "Italic",
                            comment: "Help text for italic toggle in theme token editor"
                        )
                    )
                }
