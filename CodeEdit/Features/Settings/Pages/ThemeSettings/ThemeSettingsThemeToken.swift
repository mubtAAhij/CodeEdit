        ...
        LabeledContent {
            HStack(spacing: 20) {
                HStack(spacing: 8) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "theme-settings.style.bold", defaultValue: "Bold", comment: "Bold style toggle"))
                    Divider()
                        .fixedSize()
                    Toggle(isOn: $italic) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "theme-settings.style.italic", defaultValue: "Italic", comment: "Italic style toggle"))
                }
