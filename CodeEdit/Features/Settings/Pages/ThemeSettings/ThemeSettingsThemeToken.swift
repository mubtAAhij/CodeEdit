        ...
        LabeledContent {
            HStack(spacing: 20) {
                HStack(spacing: 8) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "settings.theme.token.bold", defaultValue: "Bold", comment: "Theme token style label for bold text"))
                    Divider()
                        .fixedSize()
                    Toggle(isOn: $italic) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "settings.theme.token.italic", defaultValue: "Italic", comment: "Theme token style label for italic text"))
                }
