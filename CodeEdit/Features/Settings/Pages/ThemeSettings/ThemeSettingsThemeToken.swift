        ...
        LabeledContent {
            HStack(spacing: 20) {
                HStack(spacing: 8) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "theme-token.bold.help", defaultValue: "Bold", comment: "Help text for bold toggle button"))
                    Divider()
                        .fixedSize()
                    Toggle(isOn: $italic) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "theme-token.italic.help", defaultValue: "Italic", comment: "Help text for italic toggle button"))
                }
