        ...
        LabeledContent {
            HStack(spacing: 20) {
                HStack(spacing: 8) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "theme.font-style.bold", defaultValue: "Bold", comment: "Bold font style toggle"))
                    Divider()
                        .fixedSize()
                    Toggle(isOn: $italic) {
                    ...
                    .toggleStyle(.icon)
                    .help(String(localized: "theme.font-style.italic", defaultValue: "Italic", comment: "Italic font style toggle"))
                }
