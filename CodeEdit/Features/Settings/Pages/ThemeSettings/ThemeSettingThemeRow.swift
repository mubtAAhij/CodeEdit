    ...
    var body: some View {
        HStack {
            ...
            Menu {
                ...
                Divider()
                Button(String(localized: "theme.delete", defaultValue: "Delete...", comment: "Delete theme button")) {
        ...
        .alert(
            ...
            Button(String(localized: "theme.delete-theme", defaultValue: "Delete Theme", comment: "Delete theme confirmation button")) {
