...
struct ThemeSettingsThemeRow: View {
    ...
    var body: some View {
        HStack {
            ...
            if !active {
                Button {
                    ...
                    Text(String(localized: "settings.theme.choose", defaultValue: "Choose", comment: "Button to choose a theme"))
                }
            ...
            Menu {
                Button(String(localized: "settings.theme.details", defaultValue: "Details...", comment: "Button to show theme details")) {
        ...
        .alert(
            Text(String(format: String(localized: "settings.theme.delete-confirmation", defaultValue: "Are you sure you want to delete the theme \"%@\"?", comment: "Alert message confirming theme deletion"), theme.displayName)),
