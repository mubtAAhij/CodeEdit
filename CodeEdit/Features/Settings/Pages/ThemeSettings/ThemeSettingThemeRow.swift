...
struct ThemeSettingsThemeRow: View {
    ...
    var body: some View {
        ...
        .alert(
            ...
            Button(String(localized: "theme-row.delete-action", defaultValue: "Delete Theme", comment: "Destructive button to confirm theme deletion")) {
            ...
            Text(String(localized: "theme-row.delete-warning", defaultValue: "This action cannot be undone.", comment: "Warning message for irreversible action"))
        }
    }
}
