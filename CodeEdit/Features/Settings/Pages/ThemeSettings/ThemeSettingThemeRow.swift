...
struct ThemeSettingsThemeRow: View {
    ...
    var body: some View {
        HStack {
            ...
            if !active {
                Button {
                    ...
                    Text(String(localized: "theme_settings.choose", comment: "Button to choose a theme"))
                }
        ...
        .alert(
            ...
            Button(String(localized: "theme_settings.delete_theme", comment: "Button to confirm theme deletion")) {
                themeModel.delete(theme)
            }
            Button(String(localized: "general.cancel", comment: "Button to cancel action")) {
                deleteConfirmationIsPresented = false
            }
        } message: {
            Text(String(localized: "general.action_cannot_be_undone", comment: "Warning that action cannot be undone"))
        }
    }
}
