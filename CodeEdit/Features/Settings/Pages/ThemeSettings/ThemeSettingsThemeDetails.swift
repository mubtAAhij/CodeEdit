...
struct ThemeSettingsThemeDetails: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            Form {
                Group {
                    ...
                    Section(String(localized: "theme-details.text", defaultValue: "Text", comment: "Section title for text colors")) {
                        SettingsColorPicker(
                    ...
                    Section(String(localized: "theme-details.background", defaultValue: "Background", comment: "Section title for background colors")) {
                        SettingsColorPicker(
                    ...
                    Section(String(localized: "theme-details.tokens", defaultValue: "Tokens", comment: "Section title for syntax token colors")) {
                        VStack(spacing: 0) {
                            ThemeSettingsThemeToken(
                                String(localized: "theme-details.tokens.keywords", defaultValue: "Keywords", comment: "Label for keywords token"),
                            ...
                            ThemeSettingsThemeToken(
                                String(localized: "theme-details.tokens.commands", defaultValue: "Commands", comment: "Label for commands token"),
                            ...
                            Divider().padding(.horizontal, 10)
                            ThemeSettingsThemeToken(
                                String(localized: "theme-details.tokens.types", defaultValue: "Types", comment: "Label for types token"),
                            ...
                            Divider().padding(.horizontal, 10)
                            ThemeSettingsThemeToken(
                                String(localized: "theme-details.tokens.attributes", defaultValue: "Attributes", comment: "Label for attributes token"),
                            ...
                            Divider().padding(.horizontal, 10)
                            ThemeSettingsThemeToken(
                                String(localized: "theme-details.tokens.variables", defaultValue: "Variables", comment: "Label for variables token"),
                            ...
                            Divider().padding(.horizontal, 10)
                            ThemeSettingsThemeToken(
                                String(localized: "theme-details.tokens.values", defaultValue: "Values", comment: "Label for values token"),
                            ...
                            Divider().padding(.horizontal, 10)
                            ThemeSettingsThemeToken(
                                String(localized: "theme-details.tokens.numbers", defaultValue: "Numbers", comment: "Label for numbers token"),
                            ...
                            Divider().padding(.horizontal, 10)
                            ThemeSettingsThemeToken(
                                String(localized: "theme-details.tokens.strings", defaultValue: "Strings", comment: "Label for strings token"),
                            ...
                            Divider().padding(.horizontal, 10)
                            ThemeSettingsThemeToken(
                                String(localized: "theme-details.tokens.characters", defaultValue: "Characters", comment: "Label for characters token"),
                            ...
                            Divider().padding(.horizontal, 10)
                            ThemeSettingsThemeToken(
                                String(localized: "theme-details.tokens.comments", defaultValue: "Comments", comment: "Label for comments token"),
            ...
            HStack {
                if theme.isBundled {
                    HStack {
                        ...
                        Text(String(localized: "theme-details.duplicate-to-edit", defaultValue: "Duplicate this theme to make changes.", comment: "Message to duplicate bundled theme"))
                            .font(.subheadline)
                            .lineLimit(2)
                    }
                    .help(String(localized: "theme-details.bundled-themes-help", defaultValue: "Bundled themes must be duplicated to make changes.", comment: "Help text for bundled themes"))
                    .accessibilityElement(children: .combine)
                    .accessibilityLabel(String(localized: "theme-details.duplicate-warning-accessibility", defaultValue: "Warning: Duplicate this theme to make changes.", comment: "Accessibility label for theme duplication warning"))
                ...
                if !themeModel.isAdding && theme.isBundled {
                    Button {
                        ...
                        Text(String(localized: "theme-details.duplicate", defaultValue: "Duplicate", comment: "Duplicate button for bundled theme"))
                            .frame(minWidth: 56)
                    }
                } else {
                    Button {
        ...
        .alert(
            ...
            Button(String(localized: "theme-details.cancel-delete", defaultValue: "Cancel", comment: "Cancel deletion button")) {
                deleteConfirmationIsPresented = false
            }
        } message: {
            Text(String(localized: "theme-details.cannot-undo", defaultValue: "This action cannot be undone.", comment: "Warning that deletion cannot be undone"))
        }
    }
}
