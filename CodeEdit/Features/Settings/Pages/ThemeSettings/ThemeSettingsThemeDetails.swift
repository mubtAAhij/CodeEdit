    ...
    var body: some View {
        VStack(spacing: 0) {
            Form {
                Group {
                    Section {
                        TextField(String(localized: "name", comment: "Theme name field label"), text: $theme.displayName)
                        TextField(String(localized: "author", comment: "Theme author field label"), text: $theme.author)
                        Picker(String(localized: "type", comment: "Theme type picker label"), selection: $theme.appearance) {
                            Text("Light")
                    ...
                    Section("Text") {
                        ...
                        SettingsColorPicker(
                            String(localized: "cursor", comment: "Cursor color setting label"),
                    ...
                    Section(String(localized: "background", comment: "Background color section title")) {
                        SettingsColorPicker(
                            String(localized: "background", comment: "Background color setting label"),
                            color: $theme.editor.background.swiftColor
                        )
                        SettingsColorPicker(
                            String(localized: "current_line", comment: "Current line highlight color setting"),
                    ...
                    Section(String(localized: "tokens", comment: "Syntax tokens color section title")) {
                        VStack(spacing: 0) {
                            ThemeSettingsThemeToken(
                                String(localized: "keywords", comment: "Keywords token type label"),
                            ...
                            ThemeSettingsThemeToken(
                                String(localized: "commands", comment: "Commands token type label"),
                            ...
                            Divider().padding(.horizontal, 10)
                            ThemeSettingsThemeToken(
                                String(localized: "types", comment: "Types token type label"),
                            ...
                            Divider().padding(.horizontal, 10)
                            ThemeSettingsThemeToken(
                                String(localized: "attributes", comment: "Attributes token type label"),
                            ...
                            Divider().padding(.horizontal, 10)
                            ThemeSettingsThemeToken(
                                String(localized: "variables", comment: "Variables token type label"),
                            ...
                            Divider().padding(.horizontal, 10)
                            ThemeSettingsThemeToken(
                                String(localized: "values", comment: "Values token type label"),
                            ...
                            Divider().padding(.horizontal, 10)
                            ThemeSettingsThemeToken(
                                String(localized: "numbers", comment: "Numbers token type label"),
                            ...
                            Divider().padding(.horizontal, 10)
                            ThemeSettingsThemeToken(
                                String(localized: "strings", comment: "Strings token type label"),
                            ...
                            Divider().padding(.horizontal, 10)
                            ThemeSettingsThemeToken(
                                String(localized: "characters", comment: "Characters token type label"),
                            ...
                            Divider().padding(.horizontal, 10)
                            ThemeSettingsThemeToken(
                                String(localized: "comments", comment: "Comments token type label"),
            ...
            HStack {
                if theme.isBundled {
                    HStack {
                        ...
                        Text(String(localized: "duplicate_theme_to_edit", comment: "Message prompting user to duplicate theme for editing"))
                            .font(.subheadline)
                            .lineLimit(2)
                    }
                    .help(String(localized: "bundled_themes_duplicate_help", comment: "Help text explaining bundled themes must be duplicated"))
