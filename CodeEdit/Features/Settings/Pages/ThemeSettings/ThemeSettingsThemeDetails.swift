...
struct ThemeSettingsThemeDetails: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            HStack {
                if theme.isBundled {
                    ...
                    .help(String(localized: "theme.details.bundled-must-duplicate", defaultValue: "Bundled themes must be duplicated to make changes.", comment: "Help text for bundled themes"))
                    .accessibilityElement(children: .combine)
                    .accessibilityLabel(String(localized: "theme.details.warning-duplicate", defaultValue: "Warning: Duplicate this theme to make changes.", comment: "Accessibility label for bundled theme warning"))
                ...
                if !themeModel.isAdding && theme.isBundled {
                    Button {
                        ...
                        Text(String(localized: "theme.details.duplicate", defaultValue: "Duplicate", comment: "Duplicate button label for bundled theme"))
                            .frame(minWidth: 56)
                    }
                } else {
                    Button {
        ...
        .alert(
            ...
            Button(String(localized: "theme.details.delete-theme", defaultValue: "Delete Theme", comment: "Delete theme button in alert")) {
                themeModel.delete(theme)
                dismiss()
            }
            Button(String(localized: "theme.details.cancel-delete", defaultValue: "Cancel", comment: "Cancel delete button in alert")) {
                deleteConfirmationIsPresented = false
            }
        } message: {
            Text(String(localized: "theme.details.cannot-undo", defaultValue: "This action cannot be undone.", comment: "Warning that delete cannot be undone"))
        }
    }
}
