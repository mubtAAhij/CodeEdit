...
struct ThemeSettingsThemeDetails: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            Form {
                Group {
                    ...
                    Section(String(localized: "theme-details.section.text", defaultValue: "Text", comment: "Text section header")) {
                        SettingsColorPicker(
                        ...
                        SettingsColorPicker(
                            String(localized: "theme-details.cursor-color", defaultValue: "Cursor", comment: "Cursor color picker label"),
                    ...
                    Section(String(localized: "theme-details.section.background", defaultValue: "Background", comment: "Background section header")) {
                        SettingsColorPicker(
                        ...
                        SettingsColorPicker(
                            String(localized: "theme-details.current-line-color", defaultValue: "Current Line", comment: "Current line color picker label"),
                            color: $theme.editor.lineHighlight.swiftColor
                        )
                        SettingsColorPicker(
                            String(localized: "theme-details.selection-color", defaultValue: "Selection", comment: "Selection color picker label"),
                            color: $theme.editor.selection.swiftColor
                        )
                    }
                    Section(String(localized: "theme-details.section.tokens", defaultValue: "Tokens", comment: "Tokens section header")) {
                        VStack(spacing: 0) {
            ...
            HStack {
                if theme.isBundled {
                    HStack {
                        ...
                        Text(String(localized: "theme-details.duplicate-to-edit", defaultValue: "Duplicate this theme to make changes.", comment: "Message for bundled theme"))
                            .font(.subheadline)
                            .lineLimit(2)
                    }
                    .help(String(localized: "theme-details.duplicate-to-edit-help", defaultValue: "Bundled themes must be duplicated to make changes.", comment: "Help text for bundled theme"))
                    .accessibilityElement(children: .combine)
                    .accessibilityLabel(String(localized: "theme-details.duplicate-to-edit-warning", defaultValue: "Warning: Duplicate this theme to make changes.", comment: "Accessibility label for bundled theme warning"))
                } else if !themeModel.isAdding {
                    Button(role: .destructive) {
                        deleteConfirmationIsPresented = true
                    } label: {
                        Text(String(localized: "theme-details.delete-ellipsis", defaultValue: "Delete...", comment: "Delete button label"))
                            .foregroundStyle(.red)
                            .frame(minWidth: 56)
                    }
                    Button {
                        ...
                        Text(String(localized: "theme-details.duplicate-ellipsis", defaultValue: "Duplicate...", comment: "Duplicate button label"))
                            .frame(minWidth: 56)
                    }
                }
                Spacer()
                if !themeModel.isAdding && theme.isBundled {
                    Button {
                        ...
                        Text(String(localized: "theme-details.duplicate", defaultValue: "Duplicate", comment: "Duplicate button label"))
                            .frame(minWidth: 56)
                    }
                } else {
                    Button {
                        ...
                        Text(String(localized: "theme-details.cancel", defaultValue: "Cancel", comment: "Cancel button label"))
                            .frame(minWidth: 56)
                    }
                ...
                Button {
                    ...
                    Text(String(localized: "theme-details.done", defaultValue: "Done", comment: "Done button label"))
                        .frame(minWidth: 56)
                }
        ...
        .alert(
            Text(String(format: String(localized: "theme-details.delete-confirmation", defaultValue: "Are you sure you want to delete the theme \"%@\"?", comment: "Delete confirmation message"), theme.displayName)),
            ...
            Button(String(localized: "theme-details.cancel", defaultValue: "Cancel", comment: "Cancel button label")) {
