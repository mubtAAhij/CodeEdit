    ...
    var body: some View {
        VStack(spacing: 0) {
            Form {
                Group {
                    Section {
                        TextField(String(localized: "theme.name", defaultValue: "Name", comment: "Name field"), text: $theme.displayName)
                        TextField(String(localized: "theme.author", defaultValue: "Author", comment: "Author field"), text: $theme.author)
                    ...
                    Section(String(localized: "theme.text", defaultValue: "Text", comment: "Text section")) {
                        SettingsColorPicker(
                            String(localized: "theme.text", defaultValue: "Text", comment: "Text color picker"),
                    ...
                    Section(String(localized: "theme.background", defaultValue: "Background", comment: "Background section")) {
                        SettingsColorPicker(
                            String(localized: "theme.background", defaultValue: "Background", comment: "Background color picker"),
                    ...
                    Section(String(localized: "theme.tokens", defaultValue: "Tokens", comment: "Tokens section")) {
                        VStack(spacing: 0) {
            ...
            HStack {
                if theme.isBundled {
                    HStack {
                        ...
                        Text(String(localized: "theme.duplicate-to-edit", defaultValue: "Duplicate this theme to make changes.", comment: "Duplicate this theme to make changes text"))
                            .font(.subheadline)
                            .lineLimit(2)
                    }
                    .help(String(localized: "theme.bundled-themes-must-duplicate", defaultValue: "Bundled themes must be duplicated to make changes.", comment: "Bundled themes must be duplicated help text"))
                    .accessibilityElement(children: .combine)
                    .accessibilityLabel(String(localized: "theme.warning-duplicate-to-edit", defaultValue: "Warning: Duplicate this theme to make changes.", comment: "Warning duplicate to edit accessibility label"))
                } else if !themeModel.isAdding {
                    Button(role: .destructive) {
                        deleteConfirmationIsPresented = true
                    } label: {
                        Text(String(localized: "theme.delete-ellipsis", defaultValue: "Delete...", comment: "Delete button"))
                            .foregroundStyle(.red)
                            .frame(minWidth: 56)
                    }
                    Button {
        ...
        .alert(
            Text(String(format: String(localized: "theme.delete-confirmation", defaultValue: "Are you sure you want to delete the theme \"%@\"?", comment: "Delete theme confirmation"), theme.displayName)),
