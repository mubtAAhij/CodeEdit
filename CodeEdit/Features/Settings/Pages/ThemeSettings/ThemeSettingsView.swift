    ...
    var body: some View {
        VStack {
            SettingsForm {
                Section {
                    HStack(spacing: 10) {
                        SearchField(String(localized: "theme.settings.search", defaultValue: "Search", comment: "Search field placeholder for theme settings"), text: $themeSearchQuery)
                        ...
                        .help(String(localized: "theme.settings.create-theme-tooltip", defaultValue: "Create a new Theme", comment: "Tooltip for button to create a new theme"))
                        ...
                        MenuWithButtonStyle(systemImage: "ellipsis", menu: {
                            Group {
                                ...
                                Button {
                                    ...
                                    Text(String(localized: "theme.settings.export-all-themes", defaultValue: "Export All Custom Themes...", comment: "Menu item to export all custom themes"))
                                }
                                .disabled(themeModel.themes.filter { !$0.isBundled }.isEmpty)
                            }
                        })
                        .padding(.horizontal, 5)
                        .help(String(localized: "theme.settings.import-export-tooltip", defaultValue: "Import or Export Custom Themes", comment: "Tooltip for import/export themes menu"))
                    }
                }
                ...
                Section {
                    ...
                    HStack {
                        Spacer()
                        Button(String(localized: "theme.settings.import-button", defaultValue: "Import...", comment: "Button to import a theme")) {
                            themeModel.importTheme()
                        }
                    }
                    .padding(.top, 10)
