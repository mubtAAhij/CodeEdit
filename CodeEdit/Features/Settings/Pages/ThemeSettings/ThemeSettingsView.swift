    ...
    var body: some View {
        VStack {
            SettingsForm {
                Section {
                    HStack(spacing: 10) {
                        SearchField(String(localized: "search", defaultValue: "Search", comment: "Search field placeholder"), text: $themeSearchQuery)
                        ...
                        .help(String(localized: "settings.theme.create-new", defaultValue: "Create a new Theme", comment: "Help text for creating a new theme"))
                ...
                Section {
                    ...
                    HStack {
                        Spacer()
                        Button(String(localized: "settings.theme.import-button", defaultValue: "Import...", comment: "Button to import theme in footer")) {
                            themeModel.importTheme()
                        }
                    }
                    .padding(.top, 10)
