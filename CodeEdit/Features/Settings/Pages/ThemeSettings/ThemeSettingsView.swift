            ...
            SettingsForm {
                Section {
                    HStack(spacing: 10) {
                        ...
                        .help(String(localized: "theme-settings.create-help", defaultValue: "Create a new Theme", comment: "Tooltip for create theme button"))
                        ...
                        MenuWithButtonStyle(systemImage: "ellipsis", menu: {
                            Group {
                                Button {
                                    ...
                                    Text(String(localized: "theme-settings.import", defaultValue: "Import Theme...", comment: "Menu item to import theme"))
                                }
                                Button {
                ...
                Section {
                    ...
                    HStack {
                        Spacer()
                        Button(String(localized: "theme-settings.import-footer", defaultValue: "Import...", comment: "Footer button to import theme")) {
                            themeModel.importTheme()
                        }
                    }
                    .padding(.top, 10)
...
private extension ThemeSettingsView {
    private var useThemeBackground: some View {
        Toggle(String(localized: "theme-settings.use-background", defaultValue: "Use theme background ", comment: "Toggle to use theme background"), isOn: $settings.useThemeBackground)
    }
    ...
    private var changeThemeOnSystemAppearance: some View {
        Toggle(
            String(localized: "theme-settings.match-appearance", defaultValue: "Automatically change theme based on system appearance", comment: "Toggle to match system appearance"),
