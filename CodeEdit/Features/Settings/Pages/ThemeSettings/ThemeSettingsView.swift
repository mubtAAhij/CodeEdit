            ...
            SettingsForm {
                Section {
                    HStack(spacing: 10) {
                        ...
                        .help(String(localized: "theme-settings.create-new", defaultValue: "Create a new Theme", comment: "Create new theme help text"))
                        ...
                        MenuWithButtonStyle(systemImage: "ellipsis", menu: {
                            Group {
                                Button {
                                    ...
                                    Text(String(localized: "theme-settings.import-theme", defaultValue: "Import Theme...", comment: "Import theme button"))
                                }
                                Button {
                                    themeModel.exportAllCustomThemes()
                                } label: {
                                    Text(String(localized: "theme-settings.export-all", defaultValue: "Export All Custom Themes...", comment: "Export all custom themes button"))
                                }
                                .disabled(themeModel.themes.filter { !$0.isBundled }.isEmpty)
                            }
                        })
                        .padding(.horizontal, 5)
                        .help(String(localized: "theme-settings.import-export-help", defaultValue: "Import or Export Custom Themes", comment: "Import or export help text"))
                    }
                }
...
private extension ThemeSettingsView {
    ...
    private var alwaysUseDarkTerminalAppearance: some View {
        Toggle(String(localized: "theme-settings.dark-terminal", defaultValue: "Always use dark terminal appearance", comment: "Always use dark terminal appearance toggle"), isOn: $useDarkTerminalAppearance)
    }

    private var changeThemeOnSystemAppearance: some View {
        Toggle(
            String(localized: "theme-settings.auto-change", defaultValue: "Automatically change theme based on system appearance", comment: "Automatically change theme toggle"),
