            ...
            SettingsForm {
                Section {
                    HStack(spacing: 10) {
                        ...
                        .help(String(localized: "theme-settings.create-theme", defaultValue: "Create a new Theme", comment: "Tooltip for create theme button"))
                ...
                Section {
                    ...
                    HStack {
                        Spacer()
                        Button(String(localized: "theme-settings.import", defaultValue: "Import...", comment: "Button to import a theme")) {
                            themeModel.importTheme()
                        }
                    }
                    .padding(.top, 10)
