    ...
    var body: some View {
        VStack {
            SettingsForm {
                Section {
                    HStack(spacing: 10) {
                        SearchField(String(localized: "common.search", defaultValue: "Search", comment: "Search field placeholder"), text: $themeSearchQuery)
                        ...
                        .help(String(localized: "theme-settings.create-new-theme", defaultValue: "Create a new Theme", comment: "Tooltip for button to create a new theme"))
                        ...
                        MenuWithButtonStyle(systemImage: "ellipsis", menu: {
                            Group {
                                Button {
                                    ...
                                    Text(String(localized: "theme-settings.import-theme", defaultValue: "Import Theme...", comment: "Menu item to import a theme"))
                                }
                                Button {
                        ...
                        .help(String(localized: "theme-settings.import-export-help", defaultValue: "Import or Export Custom Themes", comment: "Tooltip for import/export menu"))
                    }
                }
                ...
                Section {
                    ...
                    HStack {
                        Spacer()
                        Button(String(localized: "theme-settings.import", defaultValue: "Import...", comment: "Button to import themes")) {
                            themeModel.importTheme()
                        }
                    }
                    .padding(.top, 10)
...
private extension ThemeSettingsView {
    private var useThemeBackground: some View {
        Toggle(String(localized: "theme-settings.use-theme-background", defaultValue: "Use theme background ", comment: "Toggle to use theme background"), isOn: $settings.useThemeBackground)
    }
    ...
    private var changeThemeOnSystemAppearance: some View {
        Toggle(
            String(localized: "theme-settings.auto-change-theme", defaultValue: "Automatically change theme based on system appearance", comment: "Toggle to automatically change theme based on system appearance"),
