    ...
    var body: some View {
        VStack {
            SettingsForm {
                Section {
                    HStack(spacing: 10) {
                        SearchField(String(localized: "settings.theme.search", defaultValue: "Search", comment: "Placeholder for theme search field"), text: $themeSearchQuery)
                        ...
                        .help(String(localized: "settings.theme.create-new-help", defaultValue: "Create a new Theme", comment: "Help text for creating a new theme"))
                        ...
                        MenuWithButtonStyle(systemImage: "ellipsis", menu: {
                            Group {
                                ...
                                Button {
                                    ...
                                    Text(String(localized: "settings.theme.export-all-themes", defaultValue: "Export All Custom Themes...", comment: "Menu item to export all custom themes"))
                                }
                                .disabled(themeModel.themes.filter { !$0.isBundled }.isEmpty)
                            }
                        })
                        .padding(.horizontal, 5)
                        .help(String(localized: "settings.theme.import-export-help", defaultValue: "Import or Export Custom Themes", comment: "Help text for import/export themes menu"))
                    }
                }
...
private extension ThemeSettingsView {
    ...
    private var changeThemeOnSystemAppearance: some View {
        Toggle(
            String(localized: "settings.theme.auto-change-appearance", defaultValue: "Automatically change theme based on system appearance", comment: "Toggle to automatically change theme with system appearance"),
