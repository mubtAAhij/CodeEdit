            ...
            SettingsForm {
                Section {
                    HStack(spacing: 10) {
                        ...
                        .help(String(
                            localized: "settings.theme.create-new",
                            ...
                            Group {
                                Button {
                                    ...
                                    Text(String(
                                        ...
                                        comment: "Menu action to import a single theme"
                                    ))
                                }
                                Button {
                                    ...
                                    Text(String(
                                        localized: "settings.theme.export-all-custom",
                                        defaultValue: "Export All Custom Themes...",
                                        comment: "Menu action to export all custom themes"
                                    ))
                                }
                        ...
                        .help(String(
                            localized: "settings.theme.import-export.section-title",
                            defaultValue: "Import or Export Custom Themes",
                            comment: "Section title for theme import/export controls"
                        ))
                    }
                }
                ...
                Section {
                    ...
                    HStack {
                        ...
                        Button(String(
                            ...
                            defaultValue: "Import...",
                            comment: "Button title to import themes"
                        )) {
                            themeModel.importTheme()
                        }
                    }
...
private extension ThemeSettingsView {
    private var useThemeBackground: some View {
        Toggle(String(
            localized: "settings.theme.terminal.use-theme-background",
            defaultValue: "Use theme background",
            comment: "Label for using theme background in terminal settings"
        ) + " ", isOn: $settings.useThemeBackground)
    }

    private var alwaysUseDarkTerminalAppearance: some View {
        Toggle(String(
            localized: "settings.theme.terminal.always-dark-appearance",
    ...
    private var changeThemeOnSystemAppearance: some View {
        Toggle(
            String(
                localized: "settings.theme.automatically-change-based-on-system",
                defaultValue: "Automatically change theme based on system appearance",
                comment: "Toggle label for automatic theme changes based on system appearance"
            ),
