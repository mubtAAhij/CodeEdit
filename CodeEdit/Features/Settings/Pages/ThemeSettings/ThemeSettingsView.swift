    ...
    var body: some View {
        VStack {
            SettingsForm {
                Section {
                    HStack(spacing: 10) {
                        SearchField(String(localized: "common.search", defaultValue: "Search", comment: "Search placeholder"), text: $themeSearchQuery)
                        ...
                        .help(String(localized: "settings.theme.create-new", defaultValue: "Create a new Theme", comment: "Create a new theme tooltip"))
                        ...
                        .help(String(localized: "settings.theme.import-export", defaultValue: "Import or Export Custom Themes", comment: "Import or export custom themes tooltip"))
                    }
                }
