            ...
            SettingsForm {
                Section {
                    HStack(spacing: 10) {
                        ...
                        .help(String(localized: "theme.create-new", defaultValue: "Create a new Theme", comment: "Create new theme tooltip"))
                        ...
                        MenuWithButtonStyle(systemImage: "ellipsis", menu: {
                            Group {
                                Button {
                                    ...
                                    Text(String(localized: "theme.import", defaultValue: "Import Theme...", comment: "Import theme menu item"))
                                }
                                Button {
                                    themeModel.exportAllCustomThemes()
                                } label: {
                                    Text(String(localized: "theme.export-all-custom", defaultValue: "Export All Custom Themes...", comment: "Export all custom themes menu item"))
                                }
                                .disabled(themeModel.themes.filter { !$0.isBundled }.isEmpty)
                            }
                        })
                        .padding(.horizontal, 5)
                        .help(String(localized: "theme.import-export-help", defaultValue: "Import or Export Custom Themes", comment: "Import or export custom themes tooltip"))
                    }
                }
                ...
                Section {
                    ...
                    HStack {
                        Spacer()
                        Button(String(localized: "theme.import-button", defaultValue: "Import...", comment: "Import theme button")) {
                            themeModel.importTheme()
                        }
                    }
                    .padding(.top, 10)
...
private extension ThemeSettingsView {
    ...
    private var changeThemeOnSystemAppearance: some View {
        Toggle(
            String(localized: "theme.auto-change-theme", defaultValue: "Automatically change theme based on system appearance", comment: "Automatically change theme toggle"),
