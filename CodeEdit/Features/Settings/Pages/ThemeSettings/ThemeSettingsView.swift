                ...
                Section {
                    HStack(spacing: 10) {
                        ...
                        Button {
                            ...
                            Image(systemName: String(localized: "settings.theme.add-icon", defaultValue: "plus", comment: "Add new theme button icon"))
                        }
                        .disabled(themeModel.selectedTheme == nil)
                        .help(String(localized: "settings.theme.add-tooltip", defaultValue: "Create a new Theme", comment: "Tooltip for creating a new theme"))

                        MenuWithButtonStyle(systemImage: String(localized: "settings.theme.menu-icon", defaultValue: "ellipsis", comment: "Theme menu icon"), menu: {
                            Group {
                                Button {
                        ...
                        .help(String(localized: "settings.theme.menu-tooltip", defaultValue: "Import or Export Custom Themes", comment: "Tooltip for theme import/export menu"))
                    }
                }
