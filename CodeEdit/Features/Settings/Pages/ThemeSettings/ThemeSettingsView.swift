            ...
            SettingsForm {
                Section {
                    HStack(spacing: 10) {
                        ...
                        .help(String(localized: "settings.theme.create-new", defaultValue: "Create a new Theme", comment: "Help text to create new theme"))
                        ...
                        MenuWithButtonStyle(systemImage: "ellipsis", menu: {
                            Group {
                                Button {
                                    ...
                                    Text(String(localized: "settings.theme.import", defaultValue: "Import Theme...", comment: "Button to import a theme"))
                                }
                                Button {
