    ...
    var body: some View {
        VStack {
            SettingsForm {
                Section {
                    HStack(spacing: 10) {
                        SearchField(String(localized: "settings.theme.search", defaultValue: "Search", comment: "Search field placeholder in theme settings"), text: $themeSearchQuery)
                        ...
                        .help(String(localized: "settings.theme.create-help", defaultValue: "Create a new Theme", comment: "Help text for create theme button"))
                        ...
                        .help(String(localized: "settings.theme.import-export-help", defaultValue: "Import or Export Custom Themes", comment: "Help text for import/export menu"))
                    }
                }
                ...
                Section {
                    ...
                    HStack {
                        Spacer()
                        Button(String(localized: "settings.theme.import-button", defaultValue: "Import...", comment: "Import button in theme settings footer")) {
                            themeModel.importTheme()
                        }
                    }
                    .padding(.top, 10)
...
private extension ThemeSettingsView {
    private var useThemeBackground: some View {
        Toggle(String(localized: "settings.theme.use-background", defaultValue: "Use theme background ", comment: "Use theme background toggle"), isOn: $settings.useThemeBackground)
    }

    private var alwaysUseDarkTerminalAppearance: some View {
        Toggle(String(localized: "settings.theme.dark-terminal", defaultValue: "Always use dark terminal appearance", comment: "Always use dark terminal appearance toggle"), isOn: $useDarkTerminalAppearance)
    }

    private var changeThemeOnSystemAppearance: some View {
        Toggle(
            String(localized: "settings.theme.auto-change", defaultValue: "Automatically change theme based on system appearance", comment: "Automatically change theme toggle"),
