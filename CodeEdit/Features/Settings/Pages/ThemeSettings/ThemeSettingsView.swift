            ...
            SettingsForm {
                Section {
                    HStack(spacing: 10) {
                        ...
                        .help(String(localized: "theme-settings.create-theme-tooltip", defaultValue: "Create a new Theme", comment: "Tooltip for creating a new theme"))
                        ...
                        .help(String(localized: "theme-settings.import-export-tooltip", defaultValue: "Import or Export Custom Themes", comment: "Tooltip for import/export menu"))
                    }
                }
                ...
                Section {
                    ...
                    HStack {
                        Spacer()
                        Button(String(localized: "theme-settings.import-button", defaultValue: "Import...", comment: "Button to import themes")) {
                            themeModel.importTheme()
                        }
                    }
                    .padding(.top, 10)
...
private extension ThemeSettingsView {
    ...
    private var changeThemeOnSystemAppearance: some View {
        Toggle(
            String(localized: "theme-settings.auto-change-theme", defaultValue: "Automatically change theme based on system appearance", comment: "Toggle to automatically change theme with system appearance"),
