            ...
            SettingsForm {
                Section {
                    HStack(spacing: 10) {
                        ...
                        .help(String(localized: "theme-settings.create-new-theme", defaultValue: "Create a new Theme", comment: "Create new theme button tooltip"))
                        ...
                        .help(String(localized: "theme-settings.import-export-help", defaultValue: "Import or Export Custom Themes", comment: "Import/export button tooltip"))
                    }
                }
