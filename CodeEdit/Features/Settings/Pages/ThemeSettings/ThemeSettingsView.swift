    ...
    var body: some View {
        VStack {
            SettingsForm {
                Section {
                    HStack(spacing: 10) {
                        SearchField(String(localized: "theme.search", defaultValue: "Search", comment: "Search themes prompt"), text: $themeSearchQuery)
                        ...
                        .help(String(localized: "theme.import-export-help", defaultValue: "Import or Export Custom Themes", comment: "Import/export themes tooltip"))
                    }
                }
                ...
                Section {
                    ...
                    HStack {
                        Spacer()
                        Button(String(localized: "theme.import-footer", defaultValue: "Import...", comment: "Import theme footer button")) {
                            themeModel.importTheme()
                        }
                    }
                    .padding(.top, 10)
...
private extension ThemeSettingsView {
    ...
    private var alwaysUseDarkTerminalAppearance: some View {
        Toggle(String(localized: "theme.dark-terminal", defaultValue: "Always use dark terminal appearance", comment: "Always dark terminal toggle"), isOn: $useDarkTerminalAppearance)
    }

    private var changeThemeOnSystemAppearance: some View {
        Toggle(
            String(localized: "theme.auto-change-system", defaultValue: "Automatically change theme based on system appearance", comment: "Auto change theme toggle"),
