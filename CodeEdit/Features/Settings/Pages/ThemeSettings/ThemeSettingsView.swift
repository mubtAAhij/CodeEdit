        ...
        VStack {
            SettingsForm {
                        ...
                        MenuWithButtonStyle(systemImage: "ellipsis", menu: {
                            Group {
                                ...
                                Button {
                                    ...
                                    Text(String(localized: "theme.export-all", defaultValue: "Export All Custom Themes...", comment: "Export all custom themes menu item"))
                                }
                ...
                Section {
                    ...
                    HStack {
                        Spacer()
                        Button(String(localized: "theme.import-ellipsis", defaultValue: "Import...", comment: "Import button")) {
                            themeModel.importTheme()
                        }
                    }
                    .padding(.top, 10)
...
private extension ThemeSettingsView {
    ...
    private var alwaysUseDarkTerminalAppearance: some View {
        Toggle(String(localized: "theme.dark-terminal", defaultValue: "Always use dark terminal appearance", comment: "Always use dark terminal appearance toggle"), isOn: $useDarkTerminalAppearance)
    }

    private var changeThemeOnSystemAppearance: some View {
        Toggle(
            String(localized: "theme.auto-change", defaultValue: "Automatically change theme based on system appearance", comment: "Auto change theme toggle"),
