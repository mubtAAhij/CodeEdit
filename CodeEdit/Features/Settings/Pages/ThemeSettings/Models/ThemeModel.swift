...
final class ThemeModel: ObservableObject {
    ...
    internal var themesURL: URL {
        baseURL.appending(path: String(localized: "theme.folder.themes", defaultValue: "Themes", comment: "Themes folder name"), directoryHint: .isDirectory)
    }

    /// The URL of the `Extensions` folder
    internal var extensionsURL: URL {
        baseURL.appending(path: String(localized: "theme.folder.extensions", defaultValue: "Extensions", comment: "Extensions folder name"), directoryHint: .isDirectory)
    }
    ...
    enum ThemeSettingsAppearances: String, CaseIterable {
        ...
        var displayName: String {
            switch self {
            case .light:
                return String(localized: "settings.theme.light-appearance", defaultValue: "Light Appearance", comment: "Light appearance label")
            case .dark:
                return String(localized: "settings.theme.dark-appearance", defaultValue: "Dark Appearance", comment: "Dark appearance label")
            }
        }
    }
    ...
    func exportTheme(_ theme: Theme) {
        ...
        savePanel.prompt = String(localized: "theme.export", defaultValue: "Export", comment: "Export theme prompt")
    ...
    func exportAllCustomThemes() {
            ...
            openPanel.prompt = String(localized: "theme.export-all", defaultValue: "Export", comment: "Export all themes prompt")
