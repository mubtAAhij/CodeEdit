...
final class ThemeModel: ObservableObject {
    ...
    internal var extensionsURL: URL {
        baseURL.appending(path: String(localized: "theme.extensions", comment: "Folder name"), directoryHint: .isDirectory)
    }
    ...
    enum ThemeSettingsAppearances: String, CaseIterable {
        ...
        var displayName: String {
            switch self {
            case .light: String(localized: "theme.lightAppearance", comment: "Theme appearance option")
            case .dark: String(localized: "theme.darkAppearance", comment: "Theme appearance option")
            }
        }
    }
    ...
    func exportTheme(_ theme: Theme) {
        ...
        savePanel.prompt = String(localized: "theme.exportPrompt", comment: "Button text")
    ...
    func exportAllCustomThemes() {
            ...
            openPanel.prompt = String(localized: "theme.exportAllPrompt", comment: "Button text")
