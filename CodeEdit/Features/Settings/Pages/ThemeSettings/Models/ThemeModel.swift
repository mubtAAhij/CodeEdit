...
final class ThemeModel: ObservableObject {
    ...
    func exportTheme(_ theme: Theme) {
        ...
        savePanel.prompt = String(localized: "settings.theme.context-menu.export", defaultValue: "Export", comment: "Context menu action title to export a theme")
    ...
    func exportAllCustomThemes() {
            ...
            openPanel.prompt = String(localized: "settings.theme.export-button", defaultValue: "Export", comment: "Button title to export selected theme")
