...
final class ThemeModel: ObservableObject {
    ...
    internal var extensionsURL: URL {
        baseURL.appending(path: String(localized: "settings.theme.extensions-folder", defaultValue: "Extensions", comment: "Folder name"), directoryHint: .isDirectory)
    }
    ...
    enum ThemeSettingsAppearances: String, CaseIterable {
        ...
        var displayName: String {
            switch self {
            case .light: String(localized: "settings.theme.appearance.light", defaultValue: "Light Appearance", comment: "Theme appearance option")
            case .dark: String(localized: "settings.theme.appearance.dark", defaultValue: "Dark Appearance", comment: "Theme appearance option")
            }
        }
    }
    ...
    func exportTheme(_ theme: Theme) {
        ...
        savePanel.prompt = String(localized: "settings.theme.export-prompt", defaultValue: "Export", comment: "Save panel prompt")
    ...
    func exportAllCustomThemes() {
            ...
            openPanel.prompt = String(localized: "settings.theme.export-prompt", defaultValue: "Export", comment: "Save panel prompt")
