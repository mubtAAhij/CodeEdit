...
final class ThemeModel: ObservableObject {
    ...
    enum ThemeSettingsAppearances: String, CaseIterable {
        ...
        var displayName: String {
            switch self {
            case .light:
                return String(localized: "theme.light-appearance", defaultValue: "Light Appearance", comment: "Light appearance setting")
            case .dark:
                return String(localized: "theme.dark-appearance", defaultValue: "Dark Appearance", comment: "Dark appearance setting")
            }
        }
    }
    ...
    func exportTheme(_ theme: Theme) {
        ...
        savePanel.prompt = String(localized: "export", defaultValue: "Export", comment: "Export button")
    ...
    func exportAllCustomThemes() {
            ...
            openPanel.prompt = String(localized: "export", defaultValue: "Export", comment: "Export button")
