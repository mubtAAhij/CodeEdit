...
final class ThemeModel: ObservableObject {
    ...
    func exportTheme(_ theme: Theme) {
        ...
        savePanel.prompt = String(localized: "theme-model.export", defaultValue: "Export", comment: "Export button prompt")
    ...
    func exportAllCustomThemes() {
            ...
            openPanel.prompt = String(localized: "theme-model.export", defaultValue: "Export", comment: "Export button prompt")
