...
final class ThemeModel: ObservableObject {
    ...
    internal var extensionsURL: URL {
        baseURL.appending(path: String(localized: "theme.extensions-folder", defaultValue: "Extensions", comment: "Name of extensions folder"), directoryHint: .isDirectory)
    }
    ...
    func exportAllCustomThemes() {
            ...
            openPanel.prompt = String(localized: "theme.export", defaultValue: "Export", comment: "Export theme prompt")
