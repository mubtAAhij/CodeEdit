...
final class ThemeModel: ObservableObject {
    ...
    internal var extensionsURL: URL {
        baseURL.appending(path: String(localized: "theme.extensions", comment: "Extensions label for theme settings"), directoryHint: .isDirectory)
    }
    ...
    enum ThemeSettingsAppearances: String, CaseIterable {
        case light = String(localized: "theme.light_appearance", comment: "Light appearance theme option")
        case dark = String(localized: "theme.dark_appearance", comment: "Dark appearance theme option")
    }
    ...
    func exportTheme(_ theme: Theme) {
        ...
        savePanel.prompt = String(localized: "theme.export", comment: "Export button label")
    ...
    func exportAllCustomThemes() {
            ...
            openPanel.prompt = String(localized: "theme.export", comment: "Export button label")
