...
final class ThemeModel: ObservableObject {
    ...
    internal var extensionsURL: URL {
        baseURL.appending(path: String(localized: "settings.theme.extensions", defaultValue: "Extensions", comment: "Extensions folder label"), directoryHint: .isDirectory)
    }
    ...
    enum ThemeSettingsAppearances: String, CaseIterable {
        ...
        var localizedString: String {
            switch self {
            case .light:
                return String(localized: "settings.theme.light-appearance-label", defaultValue: "Light Appearance", comment: "Light appearance label")
            case .dark:
                return String(localized: "settings.theme.dark-appearance-label", defaultValue: "Dark Appearance", comment: "Dark appearance label")
            }
        }
    }
