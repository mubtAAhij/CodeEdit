...
final class ThemeModel: ObservableObject {
    ...
    func exportTheme(_ theme: Theme) {
        ...
        savePanel.prompt = "String(localized: "export_button", comment: "Button to export theme")"
    ...
    func exportAllCustomThemes() {
            ...
            openPanel.prompt = "String(localized: "export_button", comment: "Button to export theme")"
