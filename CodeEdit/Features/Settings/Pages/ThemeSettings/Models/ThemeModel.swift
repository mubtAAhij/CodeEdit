...
final class ThemeModel: ObservableObject {
    ...
    func exportTheme(_ theme: Theme) {
        ...
        savePanel.prompt = String(localized: "settings.theme.export.prompt", defaultValue: "Export", comment: "Export prompt in save panel")
    ...
    func exportAllCustomThemes() {
            ...
            openPanel.prompt = String(localized: "settings.theme.export.prompt", defaultValue: "Export", comment: "Export prompt in save panel")
