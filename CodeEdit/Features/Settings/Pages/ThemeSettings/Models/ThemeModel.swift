...
final class ThemeModel: ObservableObject {
    ...
    enum ThemeSettingsAppearances: String, CaseIterable {
        ...
        var rawValue: String {
            switch self {
            case .light:
                return String(localized: "theme-model.light-appearance", defaultValue: "Light Appearance", comment: "Light appearance label")
            case .dark:
                return String(localized: "theme-model.dark-appearance", defaultValue: "Dark Appearance", comment: "Dark appearance label")
            }
        }
    }
    ...
    func exportTheme(_ theme: Theme) {
        ...
        savePanel.prompt = String(localized: "theme-model.export", defaultValue: "Export", comment: "Export button label")
    ...
    func exportAllCustomThemes() {
            ...
            openPanel.prompt = String(localized: "theme-model.export-all", defaultValue: "Export", comment: "Export all button label")
