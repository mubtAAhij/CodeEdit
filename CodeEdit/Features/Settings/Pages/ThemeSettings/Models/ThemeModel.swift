...
final class ThemeModel: ObservableObject {
    ...
    internal var themesURL: URL {
        baseURL.appending(path: String(localized: "theme.themes-folder", defaultValue: "Themes", comment: "Themes folder name"), directoryHint: .isDirectory)
    }
    ...
    enum ThemeSettingsAppearances: String, CaseIterable {
        ...
        var localizedName: String {
            switch self {
            case .light:
                return String(localized: "theme.light-appearance", defaultValue: "Light Appearance", comment: "Light appearance label")
            case .dark:
                return String(localized: "theme.dark-appearance", defaultValue: "Dark Appearance", comment: "Dark appearance label")
            }
        }
    }
    ...
    func exportTheme(_ theme: Theme) {
        ...
        savePanel.prompt = String(localized: "common.export", defaultValue: "Export", comment: "Export button")
    ...
    func exportAllCustomThemes() {
            ...
            openPanel.prompt = String(localized: "common.export", defaultValue: "Export", comment: "Export button")
