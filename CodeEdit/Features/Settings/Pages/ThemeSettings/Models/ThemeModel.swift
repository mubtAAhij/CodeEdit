...
final class ThemeModel: ObservableObject {
    ...
    internal var extensionsURL: URL {
        baseURL.appending(path: String(localized: "theme.extensions_folder", comment: "Folder name"), directoryHint: .isDirectory)
    }
    ...
    func exportTheme(_ theme: Theme) {
        ...
        savePanel.prompt = String(localized: "theme.export_prompt", comment: "Save panel prompt")
    ...
    func exportAllCustomThemes() {
            ...
            openPanel.prompt = String(localized: "theme.export_prompt", comment: "Open panel prompt")
