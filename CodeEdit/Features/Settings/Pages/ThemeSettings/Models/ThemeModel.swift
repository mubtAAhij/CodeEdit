...
final class ThemeModel: ObservableObject {
    ...
    internal var extensionsURL: URL {
        baseURL.appending(path: String(localized: "extensions", comment: "Extensions folder name"), directoryHint: .isDirectory)
    }
    ...
    enum ThemeSettingsAppearances: String, CaseIterable {
        case light = String(localized: "light_appearance", comment: "Light theme appearance option")
        case dark = String(localized: "dark_appearance", comment: "Dark theme appearance option")
    }
    ...
    func exportTheme(_ theme: Theme) {
        ...
        savePanel.prompt = String(localized: "export", comment: "Export button prompt text")
    ...
    func exportAllCustomThemes() {
            ...
            openPanel.prompt = String(localized: "export", comment: "Export button prompt text")
