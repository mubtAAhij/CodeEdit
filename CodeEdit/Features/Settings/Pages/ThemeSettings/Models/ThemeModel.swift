...
final class ThemeModel: ObservableObject {
    ...
    internal var extensionsURL: URL {
        baseURL.appending(path: String(localized: "theme.extensions-folder", defaultValue: "Extensions", comment: "Name of the Extensions folder"), directoryHint: .isDirectory)
    }
    ...
    enum ThemeSettingsAppearances: String, CaseIterable {
        ...
        var localizedString: String {
            switch self {
            case .light:
                return String(localized: "theme.light-appearance", defaultValue: "Light Appearance", comment: "Light appearance option for theme settings")
            case .dark:
                return String(localized: "theme.dark-appearance", defaultValue: "Dark Appearance", comment: "Dark appearance option for theme settings")
            }
        }
    }
    ...
    func exportTheme(_ theme: Theme) {
        ...
        savePanel.prompt = String(localized: "theme.export-button", defaultValue: "Export", comment: "Button prompt to export a theme")
    ...
    func exportAllCustomThemes() {
            ...
            openPanel.prompt = String(localized: "theme.export-button", defaultValue: "Export", comment: "Button prompt to export a theme")
