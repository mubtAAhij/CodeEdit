...
final class ThemeModel: ObservableObject {
    ...
    internal var themesURL: URL {
        baseURL.appending(path: String(localized: "themes", comment: "Label for themes folder"), directoryHint: .isDirectory)
    }

    /// The URL of the `Extensions` folder
    internal var extensionsURL: URL {
        baseURL.appending(path: String(localized: "extensions", comment: "Label for extensions folder"), directoryHint: .isDirectory)
    }
    ...
    func exportTheme(_ theme: Theme) {
        ...
        savePanel.prompt = String(localized: "export", comment: "Button text for exporting themes")
    ...
    func exportAllCustomThemes() {
            ...
            openPanel.prompt = String(localized: "export", comment: "Export button text")
