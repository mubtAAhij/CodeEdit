...
final class ThemeModel: ObservableObject {
    ...
    internal var themesURL: URL {
        baseURL.appending(path: String(localized: "settings.theme.themes", defaultValue: "Themes", comment: "Themes label"), directoryHint: .isDirectory)
    }

    /// The URL of the `Extensions` folder
    internal var extensionsURL: URL {
        baseURL.appending(path: String(localized: "settings.theme.extensions", defaultValue: "Extensions", comment: "Extensions label"), directoryHint: .isDirectory)
    }
    ...
    enum ThemeSettingsAppearances: String, CaseIterable {
        case light = String(localized: "theme.light-appearance", defaultValue: "Light Appearance", comment: "Light appearance label")
        case dark = String(localized: "theme.dark-appearance", defaultValue: "Dark Appearance", comment: "Dark appearance label")
    }
