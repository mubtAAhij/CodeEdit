...
final class ThemeModel: ObservableObject {
    ...
    enum ThemeSettingsAppearances: String, CaseIterable {
        case light = String(localized: "light_appearance", comment: "Light appearance option")
        case dark = String(localized: "dark_appearance", comment: "Dark appearance option")
    }
    ...
    func exportTheme(_ theme: Theme) {
        ...
        savePanel.prompt = String(localized: "export", comment: "Export button label")
    ...
    func exportAllCustomThemes() {
            ...
            openPanel.prompt = String(localized: "export", comment: "Export button label")
