...
extension SettingsData {
    ...
    struct ThemeSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.theme.search.auto-change-appearance", defaultValue: "Automatically Change theme based on system appearance", comment: "Search key for automatic theme switching based on system appearance"),
                ...
                String(localized: "settings.theme.search.use-theme-background", defaultValue: "Use theme background", comment: "Search key for theme background setting"),
                String(localized: "settings.theme.search.light-appearance", defaultValue: "Light Appearance", comment: "Search key for light appearance section"),
