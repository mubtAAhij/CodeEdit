...
extension SettingsData {
    ...
    struct ThemeSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.theme.auto-change", defaultValue: "Automatically Change theme based on system appearance", comment: "Theme auto-change setting"),
                String(localized: "settings.theme.dark-terminal", defaultValue: "Always use dark terminal appearance", comment: "Dark terminal appearance setting"),
