    ...
    struct ThemeSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "light_appearance", comment: "Light appearance theme setting"),
                "GitHub Light",
                "Xcode Light",
                "Solarized Light",
                String(localized: "solarized_dark", comment: "Solarized Dark theme name"),
                String(localized: "midnight", comment: "Midnight theme name"),
                String(localized: "xcode_dark", comment: "Xcode Dark theme name"),
                String(localized: "github_dark", comment: "GitHub Dark theme name")
            ]
            .map { NSLocalizedString($0, comment: "") }
        }

        /// The name of the currently selected dark theme
        var selectedDarkTheme: String = String(localized: "default_dark", comment: "Default dark theme name")

        /// The name of the currently selected light theme
        var selectedLightTheme: String = String(localized: "default_light", comment: "Default light theme name")
