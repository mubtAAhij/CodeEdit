...
extension SettingsData {
    ...
    struct ThemeSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.theme.auto-change", defaultValue: "Automatically Change theme based on system appearance", comment: "Auto theme change option"),
                String(localized: "settings.theme.dark-terminal", defaultValue: "Always use dark terminal appearance", comment: "Always dark terminal option"),
                String(localized: "settings.theme.use-background", defaultValue: "Use theme background", comment: "Use theme background option"),
                String(localized: "settings.theme.light-appearance", defaultValue: "Light Appearance", comment: "Light appearance label"),
                "GitHub Light",
                "Xcode Light",
                "Solarized Light",
                "Solarized Dark",
