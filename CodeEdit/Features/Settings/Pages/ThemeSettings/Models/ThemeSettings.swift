...
extension SettingsData {
    ...
    struct ThemeSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "theme.auto-change", defaultValue: "Automatically Change theme based on system appearance", comment: "Auto theme change setting"),
                String(localized: "theme.dark-terminal", defaultValue: "Always use dark terminal appearance", comment: "Dark terminal setting"),
                String(localized: "theme.use-background", defaultValue: "Use theme background", comment: "Use theme background setting"),
