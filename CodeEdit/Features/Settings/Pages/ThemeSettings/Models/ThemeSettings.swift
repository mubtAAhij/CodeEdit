...
extension SettingsData {
    ...
    struct ThemeSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.theme.search-auto-change", defaultValue: "Automatically Change theme based on system appearance", comment: "Search keyword for auto theme switching setting"),
                String(localized: "settings.theme.search-dark-terminal", defaultValue: "Always use dark terminal appearance", comment: "Search keyword for dark terminal setting"),
                String(localized: "settings.theme.search-use-background", defaultValue: "Use theme background", comment: "Search keyword for theme background setting"),
                String(localized: "settings.theme.search-light-appearance", defaultValue: "Light Appearance", comment: "Search keyword for light appearance"),
                "GitHub Light",
                "Xcode Light",
                "Solarized Light",
                "Solarized Dark",
