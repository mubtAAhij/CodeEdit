...
extension ThemeModel {
    ...
    func importTheme() {
        ...
        openPanel.prompt = String(localized: "theme.import.prompt", defaultValue: "Import", comment: "Prompt text for theme import panel")
        ...
        do {
            guard let oldURL = theme.fileURL else {
                throw NSError(
                    domain: "ThemeModel",
                    code: 1,
                    userInfo: [NSLocalizedDescriptionKey: String(localized: "theme.error.url_not_found", defaultValue: "Theme file URL not found", comment: "Error message when theme file URL is not found")]
                )
            }
