...
private extension NavigationSettingsView {
    private var navigationStyle: some View {
        Picker(String(localized: "settings.navigation.style-label", defaultValue: "Navigation Style", comment: "Navigation style setting label"), selection: $settings.navigationStyle) {
