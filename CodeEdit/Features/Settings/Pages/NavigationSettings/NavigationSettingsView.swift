...
private extension NavigationSettingsView {
    private var navigationStyle: some View {
        Picker(String(localized: "settings.navigation.navigation-style", defaultValue: "Navigation Style", comment: "Navigation style picker label"), selection: $settings.navigationStyle) {
