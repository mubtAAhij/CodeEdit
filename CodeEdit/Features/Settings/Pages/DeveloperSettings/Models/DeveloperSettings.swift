...
extension SettingsData {
    struct DeveloperSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "developer.title", defaultValue: "Developer", comment: "Developer settings title"),
                String(localized: "developer.lsp", defaultValue: "Language Server Protocol", comment: "Language Server Protocol"),
                String(localized: "developer.lsp-binaries", defaultValue: "LSP Binaries", comment: "LSP binaries setting"),
                String(localized: "developer.show-inspector", defaultValue: "Show Internal Development Inspector", comment: "Show internal development inspector setting")
            ]
        }
