...
extension SettingsData {
    struct DeveloperSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                String(localized: "settings.developer", defaultValue: "Developer", comment: "Developer settings search key"),
                String(localized: "settings.developer.lsp", defaultValue: "Language Server Protocol", comment: "Language Server Protocol search key"),
                String(localized: "settings.developer.lsp-binaries", defaultValue: "LSP Binaries", comment: "LSP Binaries search key"),
                String(localized: "settings.developer.show-inspector", defaultValue: "Show Internal Development Inspector", comment: "Show inspector search key")
            ]
        }
