    ...
    struct DeveloperSettings: Codable, Hashable, SearchableSettingsPage {
        ...
        var searchKeys: [String] {
            [
                ...
                String(localized: "settings.developer.language-server-protocol", defaultValue: "Language Server Protocol", comment: "Title for language server protocol developer settings section."),
                String(localized: "settings.developer.lsp-binaries", defaultValue: "LSP Binaries", comment: "Title for LSP binaries developer settings section."),
                String(localized: "settings.developer.show-internal-development-inspector", defaultValue: "Show Internal Development Inspector", comment: "Toggle label to show the internal development inspector.")
            ]
