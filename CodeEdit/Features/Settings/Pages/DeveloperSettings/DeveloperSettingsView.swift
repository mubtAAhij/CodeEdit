        ...
        SettingsForm {
            ...
            Section {
                KeyValueTable(
                    ...
                    keyColumnName: String(localized: "developer_settings.language", comment: "Column header for language"),
                    ...
                    Text(
                        String(localized: "developer_settings.lsp_binary_instruction", comment: "Instruction text for specifying LSP binary path")
                    )
                } actionBarTrailing: {
                    EmptyView()
                }
                ...
                Text(String(localized: "developer_settings.lsp_binaries_description", comment: "Description for LSP binaries section"))
            }
        }
    }
}
