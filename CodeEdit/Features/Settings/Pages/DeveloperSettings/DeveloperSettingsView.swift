        ...
        SettingsForm {
            ...
            Section {
                KeyValueTable(
                    ...
                    newItemInstruction: String(localized: "settings.developer.add-lsp", defaultValue: "Add a language server", comment: "Add language server instruction")
                ) {
                    Text(String(localized: "settings.developer.add-lsp", defaultValue: "Add a language server", comment: "Add language server instruction"))
                    Text(
                        String(localized: "settings.developer.lsp-instruction", defaultValue: "Specify the absolute path to your LSP binary and its associated language.", comment: "LSP binary instruction")
                    )
                } actionBarTrailing: {
                    EmptyView()
                }
