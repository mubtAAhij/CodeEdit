...
struct DeveloperSettingsView: View {
    ...
    var body: some View {
        SettingsForm {
            Section {
                Toggle(String(localized: "settings.developer.show-inspector", defaultValue: "Show Internal Development Inspector", comment: "Show Internal Development Inspector toggle"), isOn: $showInternalDevelopmentInspector)
            }
            ...
            Section {
                KeyValueTable(
                    ...
                    newItemInstruction: String(localized: "settings.developer.add-lsp", defaultValue: "Add a language server", comment: "Add a language server instruction")
                ) {
                    Text(String(localized: "settings.developer.add-lsp.title", defaultValue: "Add a language server", comment: "Add a language server title"))
                    Text(
