        ...
        SettingsForm {
            ...
            Section {
                KeyValueTable(
                    ...
                    Text(
                        String(
                            ...
                            comment: "Description text for adding a language server binary"
                        )
                    )
                } actionBarTrailing: {
                    EmptyView()
                ...
                Text(String(
                    ...
                    comment: "Section title for configured LSP binaries list"
                ))
                Text(String(
