...
struct DeveloperSettingsView: View {
    ...
    var body: some View {
        SettingsForm {
            Section {
                Toggle(String(localized: "developer.show-internal-development-inspector", defaultValue: "Show Internal Development Inspector", comment: "Show internal development inspector toggle"), isOn: $showInternalDevelopmentInspector)
            }
            ...
            Section {
                KeyValueTable(
                    ...
                    newItemInstruction: String(localized: "developer.add-language-server", defaultValue: "Add a language server", comment: "Add language server instruction")
                ) {
                    ...
                    Text(String(localized: "developer.add-language-server-description", defaultValue: "Specify the absolute path to your LSP binary and its associated language.", comment: "Add language server description"))
                } actionBarTrailing: {
                    EmptyView()
                }
                .frame(minHeight: 96)
            } header: {
                Text(String(localized: "developer.lsp-binaries", defaultValue: "LSP Binaries", comment: "LSP binaries header"))
