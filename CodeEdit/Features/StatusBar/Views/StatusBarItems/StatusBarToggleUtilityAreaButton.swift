        ...
        .onChange(of: controlActiveState) { _, newValue in
            if newValue == .key {
                CommandManager.shared.addCommand(
                    name: String(localized: "status-bar.toggle-utility-area", defaultValue: "Toggle Utility Area", comment: "Command name for toggling utility area"),
                    title: String(localized: "status-bar.toggle-utility-area", defaultValue: "Toggle Utility Area", comment: "Command name for toggling utility area"),
                    id: "open.drawer",
