        ...
        .onChange(of: controlActiveState) { _, newValue in
            if newValue == .key {
                CommandManager.shared.addCommand(
                    name: String(localized: "status-bar.utility-area.toggle-command", defaultValue: "Toggle Utility Area", comment: "Command name for toggle utility area"),
                    title: String(localized: "status-bar.utility-area.toggle-command", defaultValue: "Toggle Utility Area", comment: "Command name for toggle utility area"),
                    id: "open.drawer",
