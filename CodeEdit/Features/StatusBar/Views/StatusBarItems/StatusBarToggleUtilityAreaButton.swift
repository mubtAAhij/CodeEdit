        ...
        .onChange(of: controlActiveState) { _, newValue in
            if newValue == .key {
                CommandManager.shared.addCommand(
                    name: String(localized: "utility.area.toggle", defaultValue: "Toggle Utility Area", comment: "Toggle utility area command name"),
                    title: String(localized: "utility.area.toggle", defaultValue: "Toggle Utility Area", comment: "Toggle utility area command title"),
                    id: "open.drawer",
