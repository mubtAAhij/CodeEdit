...
internal struct StatusBarToggleUtilityAreaButton: View {
    ...
    internal var body: some View {
        ...
        .help(utilityAreaViewModel.isCollapsed ? String(localized: "status-bar.show-utility-area", defaultValue: "Show the Utility area", comment: "Help text to show utility area") : String(localized: "status-bar.hide-utility-area", defaultValue: "Hide the Utility area", comment: "Help text to hide utility area"))
