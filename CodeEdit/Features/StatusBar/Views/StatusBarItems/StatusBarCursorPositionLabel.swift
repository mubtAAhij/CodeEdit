    ...
    struct LineLabel: View {
        ...
        func getLabel() -> String {
            ...
            if cursorPositions[0].range.length > 0 {
                ...
                return String(format: String(localized: "status-bar.characters-count", defaultValue: "%ld characters", comment: "Number of characters selected"), cursorPositions[0].range.length)
            }
            ...
            return String(format: String(localized: "status-bar.line-column", defaultValue: "Line: %ld  Col: %ld", comment: "Cursor line and column position"), cursorPositions[0].start.line, cursorPositions[0].start.column)
        }
    }
}
