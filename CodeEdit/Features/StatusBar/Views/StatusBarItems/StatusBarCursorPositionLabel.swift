        ...
        Group {
            if let currentTab = tab {
                ...
                Text("").accessibilityLabel(String(
                    ...
                    comment: "Status bar text when there is no active selection"
                ))
            }
        }
        .fixedSize()
        ...
        func getLabel() -> String {
            ...
            if cursorPositions[0].range.length > 0 {
                ...
                if modifierKeys.contains(.option) {
                    return String(format: String(
                        ...
                        comment: "Status bar text showing selection start character and length"
            ...
            if modifierKeys.contains(.option) {
                return String(format: String(
                    ...
                    comment: "Status bar text showing caret character position with zero selection length"
