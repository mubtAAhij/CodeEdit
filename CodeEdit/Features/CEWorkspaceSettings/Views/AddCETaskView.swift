        ...
        VStack(spacing: 0) {
            ...
            HStack {
                Button {
                    ...
                    Text(String(localized: "workspace-settings.task.add.cancel", defaultValue: "Cancel", comment: "Cancel button in add task view"))
                        .frame(minWidth: 56)
                }
                Spacer()
                Button {
                    ...
                    Text(String(localized: "workspace-settings.task.add.save", defaultValue: "Save", comment: "Save button in add task view"))
                        .frame(minWidth: 56)
                }
