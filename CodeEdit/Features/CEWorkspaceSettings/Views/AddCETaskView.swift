        ...
        VStack(spacing: 0) {
            ...
            HStack {
                Button {
                    ...
                    Text(String(localized: "button.cancel", defaultValue: "Cancel", comment: "Cancel button for add task dialog"))
                        .frame(minWidth: 56)
                }
                Spacer()
                Button {
                    ...
                    Text(String(localized: "button.save", defaultValue: "Save", comment: "Save button for add task dialog"))
                        .frame(minWidth: 56)
                }
