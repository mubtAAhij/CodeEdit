        ...
        VStack(spacing: 0) {
            ...
            HStack {
                Button {
                    ...
                    Text(String(localized: "button.cancel", defaultValue: "Cancel", comment: "Button to cancel an action"))
                        .frame(minWidth: 56)
                }
                Spacer()
                Button {
                    ...
                    Text(String(localized: "button.save", defaultValue: "Save", comment: "Button to save changes"))
                        .frame(minWidth: 56)
                }
