        ...
        VStack(spacing: 0) {
            ...
            HStack {
                Button {
                    ...
                    Text(String(localized: "task.add.cancel", defaultValue: "Cancel", comment: "Button to cancel adding a new task"))
                        .frame(minWidth: 56)
                }
                Spacer()
                Button {
                    ...
                    Text(String(localized: "task.add.save", defaultValue: "Save", comment: "Button to save a new task"))
                        .frame(minWidth: 56)
                }
