...
struct CEWorkspaceSettingsTaskListView: View {
    ...
    var body: some View {
        if settings.tasks.isEmpty {
            Text(String(localized: "workspace.tasks.no-tasks", defaultValue: "No tasks", comment: "Message when no tasks are configured"))
                ...
                TaskTile(task: task)
                    ...
                    .contextMenu {
                        Button {
                            ...
                            Text(String(localized: "workspace.tasks.edit", defaultValue: "Edit", comment: "Menu item to edit a task"))
                        }
                        Button {
                            ...
                            Text(String(localized: "workspace.tasks.delete", defaultValue: "Delete", comment: "Menu item to delete a task"))
                        }
                    }
            }
        }
