...
struct CEWorkspaceSettingsTaskListView: View {
    ...
    var body: some View {
        if settings.tasks.isEmpty {
            Text(String(localized: "settings.tasks.no-tasks", defaultValue: "No tasks", comment: "Empty state when no tasks configured"))
                ...
                TaskTile(task: task)
                    ...
                    .contextMenu {
                        Button {
                            ...
                            Text(String(localized: "settings.tasks.edit", defaultValue: "Edit", comment: "Edit task context menu item"))
                        }
                        Button {
                            ...
                            Text(String(localized: "settings.tasks.delete", defaultValue: "Delete", comment: "Delete task context menu item"))
                        }
                    }
            }
        }
