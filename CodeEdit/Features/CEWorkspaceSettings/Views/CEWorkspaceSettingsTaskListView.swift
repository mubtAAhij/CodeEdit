...
struct CEWorkspaceSettingsTaskListView: View {
    ...
    var body: some View {
        if settings.tasks.isEmpty {
            Text(String(localized: "workspace-settings.tasks.no-tasks", defaultValue: "No tasks", comment: "Empty state when there are no tasks"))
                ...
                TaskTile(task: task)
                    ...
                    .contextMenu {
                        Button {
                            ...
                            Text(String(localized: "edit", defaultValue: "Edit", comment: "Edit button"))
                        }
                        Button {
