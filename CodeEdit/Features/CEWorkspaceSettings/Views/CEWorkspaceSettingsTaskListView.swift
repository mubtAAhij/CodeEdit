...
struct CEWorkspaceSettingsTaskListView: View {
    ...
    var body: some View {
        if settings.tasks.isEmpty {
            Text(String(localized: "tasks.list.no-tasks", defaultValue: "No tasks", comment: "Message when no tasks are configured"))
                ...
                TaskTile(task: task)
                    ...
                    .contextMenu {
                        Button {
                            ...
                            Text(String(localized: "tasks.list.edit", defaultValue: "Edit", comment: "Edit task context menu item"))
                        }
                        Button {
                            ...
                            Text(String(localized: "tasks.list.delete", defaultValue: "Delete", comment: "Delete task context menu item"))
                        }
                    }
            }
        }
