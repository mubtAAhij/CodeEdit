...
struct CEWorkspaceSettingsTaskListView: View {
    ...
    var body: some View {
        if settings.tasks.isEmpty {
            Text(String(localized: "workspace_settings.task_list.empty_state.no_tasks", comment: "Empty state message when no tasks are configured"))
                ...
                TaskTile(task: task)
                    ...
                    .contextMenu {
                        Button {
                            ...
                            Text(String(localized: "workspace_settings.task_list.context_menu.edit", comment: "Edit menu item in task context menu"))
                        }
                        Button {
                            ...
                            Text(String(localized: "workspace_settings.task_list.context_menu.delete", comment: "Delete menu item in task context menu"))
                        }
                    }
            }
        }
