...
struct CEWorkspaceSettingsTaskListView: View {
    ...
    var body: some View {
        if settings.tasks.isEmpty {
            Text("String(localized: "no_tasks", comment: "Message shown when no tasks are configured")")
                ...
                TaskTile(task: task)
                    ...
                    .contextMenu {
                        Button {
                            ...
                            Text("String(localized: "edit", comment: "Context menu option to edit a task")")
                        }
                        Button {
