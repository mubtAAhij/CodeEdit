...
struct CEWorkspaceSettingsTaskListView: View {
    ...
    var body: some View {
        if settings.tasks.isEmpty {
            Text(String(localized: "no_tasks", comment: "Empty state message when no tasks are configured"))
                ...
                TaskTile(task: task)
                    ...
                    .contextMenu {
                        Button {
                            ...
                            Text(String(localized: "edit", comment: "Context menu edit action"))
                        }
                        Button {
                            ...
                            Text(String(localized: "delete", comment: "Context menu delete action"))
                        }
                    }
            }
        }
