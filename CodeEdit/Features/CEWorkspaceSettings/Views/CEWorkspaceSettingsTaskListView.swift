...
struct CEWorkspaceSettingsTaskListView: View {
    ...
    var body: some View {
        if settings.tasks.isEmpty {
            Text(String(localized: "workspace-settings.task.no-tasks", defaultValue: "No tasks", comment: "Message when no tasks are configured"))
                ...
                TaskTile(task: task)
                    ...
                    .contextMenu {
                        Button {
                            ...
                            Text(String(localized: "workspace-settings.task.edit", defaultValue: "Edit", comment: "Edit task button"))
                        }
                        Button {
                            ...
                            Text(String(localized: "workspace-settings.task.delete", defaultValue: "Delete", comment: "Delete task button"))
                        }
                    }
            }
        }
