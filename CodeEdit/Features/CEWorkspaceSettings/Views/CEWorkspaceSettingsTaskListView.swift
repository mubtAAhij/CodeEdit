...
struct CEWorkspaceSettingsTaskListView: View {
    ...
    var body: some View {
        if settings.tasks.isEmpty {
            Text(String(localized: "workspace-settings.tasks.empty", defaultValue: "No tasks", comment: "Message shown when no tasks are configured"))
                ...
                TaskTile(task: task)
                    ...
                    .contextMenu {
                        Button {
                            ...
                            Text(String(localized: "common.edit", defaultValue: "Edit", comment: "Edit button title in context menu"))
                        }
                        Button {
