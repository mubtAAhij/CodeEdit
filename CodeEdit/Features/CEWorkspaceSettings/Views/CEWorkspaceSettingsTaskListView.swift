...
struct CEWorkspaceSettingsTaskListView: View {
    ...
    var body: some View {
        if settings.tasks.isEmpty {
            Text(String(localized: "workspace-settings.tasks.no-tasks", defaultValue: "No tasks", comment: "No tasks configured"))
                ...
                TaskTile(task: task)
                    ...
                    .contextMenu {
                        Button {
                            ...
                            Text(String(localized: "button.edit", defaultValue: "Edit", comment: "Edit button"))
                        }
                        Button {
