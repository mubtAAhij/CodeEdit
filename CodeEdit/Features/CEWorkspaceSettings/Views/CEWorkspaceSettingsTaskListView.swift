...
struct CEWorkspaceSettingsTaskListView: View {
    ...
    var body: some View {
        if settings.tasks.isEmpty {
            Text(String(localized: "workspace-settings.task-list.no-tasks", defaultValue: "No tasks", comment: "Empty state text when no workspace tasks exist"))
                ...
                TaskTile(task: task)
                    ...
                    .contextMenu {
                        Button {
                            ...
                            Text(String(localized: "workspace-settings.task-list.edit", defaultValue: "Edit", comment: "Button title to edit selected workspace task"))
                        }
                        Button {
                            ...
                            Text(String(localized: "workspace-settings.task-list.delete", defaultValue: "Delete", comment: "Button title to delete selected workspace task"))
                        }
                    }
            }
        }
