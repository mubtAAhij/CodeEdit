...
struct CEWorkspaceSettingsTaskListView: View {
    ...
    var body: some View {
        if settings.tasks.isEmpty {
            Text(String(localized: "workspace_settings.tasks.no_tasks", comment: "Message shown when no tasks are configured"))
                ...
                TaskTile(task: task)
                    ...
                    .contextMenu {
                        Button {
                            ...
                            Text(String(localized: "general.edit", comment: "Edit button label"))
                        }
                        Button {
                            ...
                            Text(String(localized: "general.delete", comment: "Delete button label"))
                        }
                    }
            }
        }
