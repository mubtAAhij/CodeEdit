...
struct CEWorkspaceSettingsTaskListView: View {
    ...
    var body: some View {
        if settings.tasks.isEmpty {
            Text(String(localized: "no_tasks", comment: "Empty state message for tasks"))
                ...
                TaskTile(task: task)
                    ...
                    .contextMenu {
                        Button {
                            ...
                            Text(String(localized: "edit", comment: "Edit context menu item"))
                        }
                        Button {
                            ...
                            Text(String(localized: "delete", comment: "Delete context menu item"))
                        }
                    }
            }
        }
