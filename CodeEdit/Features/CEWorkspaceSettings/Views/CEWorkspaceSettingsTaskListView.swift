...
struct CEWorkspaceSettingsTaskListView: View {
    ...
    var body: some View {
        if settings.tasks.isEmpty {
            Text(String(localized: "workspace-settings.tasks.no-tasks", defaultValue: "No tasks", comment: "Message when no tasks are configured"))
                ...
                TaskTile(task: task)
                    ...
                    .contextMenu {
                        Button {
                            ...
                            Text(String(localized: "workspace-settings.tasks.edit", defaultValue: "Edit", comment: "Edit button in task context menu"))
                        }
                        Button {
                            ...
                            Text(String(localized: "workspace-settings.tasks.delete", defaultValue: "Delete", comment: "Delete button in task context menu"))
                        }
                    }
            }
        }
