...
struct CEWorkspaceSettingsTaskListView: View {
    ...
    var body: some View {
        if settings.tasks.isEmpty {
            Text(String(localized: "no_tasks", comment: "Message shown when there are no tasks configured"))
                ...
                TaskTile(task: task)
                    ...
                    .contextMenu {
                        Button {
                            ...
                            Text(String(localized: "edit", comment: "Edit task context menu item"))
                        }
                        Button {
                            ...
                            Text(String(localized: "delete", comment: "Delete task context menu item"))
                        }
                    }
            }
        }
