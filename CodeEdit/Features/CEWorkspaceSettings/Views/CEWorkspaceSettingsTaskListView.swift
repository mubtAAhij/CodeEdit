...
struct CEWorkspaceSettingsTaskListView: View {
    ...
    var body: some View {
        if settings.tasks.isEmpty {
            Text(String(localized: "task.no-tasks", defaultValue: "No tasks", comment: "Message when no tasks exist"))
                ...
                TaskTile(task: task)
                    ...
                    .contextMenu {
                        Button {
                            ...
                            Text(String(localized: "task.edit", defaultValue: "Edit", comment: "Edit task button"))
                        }
                        Button {
                            ...
                            Text(String(localized: "task.delete", defaultValue: "Delete", comment: "Delete task button"))
                        }
                    }
            }
        }
