        ...
        VStack(spacing: 0) {
            ...
            HStack {
                Button(role: .destructive) {
                    ...
                    Text(String(localized: "edit_task.delete", comment: "Button to delete the task being edited"))
                        .foregroundStyle(.red)
                        .frame(minWidth: 56)
                }
                ...
                Button {
                    ...
                    Text(String(localized: "edit_task.done", comment: "Button to finish editing task"))
                        .frame(minWidth: 56)
                }
