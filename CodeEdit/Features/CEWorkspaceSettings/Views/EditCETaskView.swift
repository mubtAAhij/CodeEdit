        ...
        VStack(spacing: 0) {
            ...
            HStack {
                Button(role: .destructive) {
                    ...
                    Text(String(localized: "edit-task.delete-button", defaultValue: "Delete", comment: "Button to delete a task"))
                        .foregroundStyle(.red)
                        .frame(minWidth: 56)
                }
                ...
                Button {
                    ...
                    Text(String(localized: "edit-task.done-button", defaultValue: "Done", comment: "Button to finish editing a task"))
                        .frame(minWidth: 56)
                }
