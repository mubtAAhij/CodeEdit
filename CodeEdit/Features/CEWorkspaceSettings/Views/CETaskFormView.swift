        ...
        Form {
            Section {
                ...
                .accessibilityLabel(String(
                    ...
                    comment: "Placeholder for entering task name."
                ))
                Picker(String(
                    ...
                    Text(String(
                        ...
                        defaultValue: "My Mac",
                        comment: "Task target option for running on local machine."
                    ))
                        .tag("My Mac")
                    ...
                    Text(String(
                        ...
                        defaultValue: "SSH",
                        comment: "Task target option for SSH environment."
                    ))
                        .tag("SSH")
                    ...
                    Text(String(
                        ...
                        defaultValue: "Docker",
                        comment: "Task target option for Docker environment."
                    ))
                        .tag("Docker")
                    ...
                    Text(String(
                        ...
                        comment: "Task target option for Docker Compose environment."
                    ))
                        .tag("Docker Compose")
                }
                .disabled(true)
            ...
            Section {
                TextField(text: $task.command) {
                    Text(String(
                        ...
                        defaultValue: "Task",
                        comment: "Section title for task command settings."
                    ))
                }
                .accessibilityLabel(String(
                    localized: "workspace-settings.task-form.task-command.placeholder",
                    defaultValue: "Task Command",
                    comment: "Placeholder for task command input."
                ))
                TextField(text: $task.workingDirectory) {
                    Text(String(
                        localized: "workspace-settings.task-form.working-directory.placeholder",
            ...
            Section {
                ...
                .overlay {
                    if task.environmentVariables.isEmpty {
                        Text(String(
                            localized: "workspace-settings.task-form.environment-variables.empty-state",
                ...
                Text(String(
                    localized: "workspace-settings.task-form.environment-variables.section-title",
                    defaultValue: "Environment Variables",
                    comment: "Section title for environment variables list."
                ))
            }
        }
        .formStyle(.grouped)
