        ...
        Form {
            Section {
                TextField(text: $task.name) {
                    Text(String(localized: "name", comment: "Label for name field"))
                }
                .accessibilityLabel(String(localized: "task_name", comment: "Accessibility label for task name field"))
                Picker(String(localized: "target", comment: "Label for target picker"), selection: $task.target) {
                    Text("My Mac")
                        .tag("My Mac")
            ...
            Section {
                TextField(text: $task.command) {
                    Text(String(localized: "task", comment: "Task command input label"))
                }
                ...
                TextField(text: $task.workingDirectory) {
                    Text(String(localized: "working_directory", comment: "Working directory input label"))
                }
            }
            ...
            Section {
                ...
                .overlay {
                    if task.environmentVariables.isEmpty {
                        Text(String(localized: "no_environment_variables", comment: "Message when no environment variables are set"))
