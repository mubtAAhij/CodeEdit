        ...
        Form {
            Section {
                ...
                Picker(String(localized: "task.target", defaultValue: "Target", comment: "Label for task target picker"), selection: $task.target) {
                    Text(String(localized: "task.target.my_mac", defaultValue: "My Mac", comment: "Task target option for local Mac"))
                        .tag("My Mac")
                    ...
                    Text(String(localized: "task.target.docker_compose", defaultValue: "Docker Compose", comment: "Task target option for Docker Compose"))
                        .tag("Docker Compose")
                }
                .disabled(true)
            }
            ...
            Section {
                ...
                TextField(text: $task.workingDirectory) {
                    Text(String(localized: "task.working_directory", defaultValue: "Working Directory", comment: "Label for working directory field"))
                }
            }
            ...
            Section {
                ...
                .overlay {
                    if task.environmentVariables.isEmpty {
                        Text(String(localized: "task.env_vars.empty", defaultValue: "No environment variables", comment: "Message shown when no environment variables are defined"))
                ...
                Text(String(localized: "task.env_vars.header", defaultValue: "Environment Variables", comment: "Section header for environment variables"))
            }
        }
        .formStyle(.grouped)
    }
