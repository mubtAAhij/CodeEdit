        ...
        Form {
            Section {
                ...
                Picker(String(localized: "task.target", defaultValue: "Target", comment: "Label for task target picker"), selection: $task.target) {
                    Text(String(localized: "task.my-mac", defaultValue: "My Mac", comment: "Task target option for local Mac"))
                        .tag(String(localized: "task.my-mac-tag", defaultValue: "My Mac", comment: "Tag value for My Mac target"))
            ...
            Section {
                TextField(text: $task.command) {
                    Text(String(localized: "task.task", defaultValue: "Task", comment: "Label for task command field"))
                }
            ...
            Section {
                ...
                .overlay {
                    if task.environmentVariables.isEmpty {
                        Text(String(localized: "task.no-env-vars", defaultValue: "No environment variables", comment: "Message when there are no environment variables"))
