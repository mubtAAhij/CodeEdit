    ...
    var body: some View {
        VStack(spacing: 0) {
            Form {
                Section {
                    TextField(
                        String(localized: "workspace.settings.name", defaultValue: "Name", comment: "Workspace name field label"),
                ...
                Section {
                    ...
                    HStack {
                        ...
                        Button {
                            ...
                            Text(String(localized: "workspace.settings.add_task", defaultValue: "Add Task...", comment: "Add task button"))
                        }
                    }
                }
            }
