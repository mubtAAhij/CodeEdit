        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    TextField(
                        String(
                            localized: "workspace-settings.view.name",
                            defaultValue: "Name",
                            comment: "Section title for workspace name settings"
                        ),
                        text: $workspaceSettingsManager.settings.project.projectName
                    )
                    .accessibilityLabel(String(
                        localized: "workspace-settings.view.workspace-name",
                        defaultValue: "Workspace Name",
                        comment: "Label for workspace name text field"
                    ))
                } header: {
                    Text(String(
                        localized: "workspace-settings.view.workspace",
                        defaultValue: "Workspace",
                        comment: "Navigation title for workspace settings view"
                    ))
                ...
                Section {
                    ...
                    Text(String(
                        localized: "workspace-settings.view.tasks",
                        defaultValue: "Tasks",
                        comment: "Section title for workspace tasks list"
                    ))
                } footer: {
                    HStack {
                        Spacer()
                        Button {
                            ...
                            Text(String(
                                localized: "workspace-settings.view.add-task",
                                defaultValue: "Add Task...",
                                comment: "Button title to add a workspace task"
                            ))
                        }
                    }
                }
            ...
            HStack {
                ...
                Button {
                    ...
                    Text(String(
                        localized: "workspace-settings.view.done",
                        defaultValue: "Done",
