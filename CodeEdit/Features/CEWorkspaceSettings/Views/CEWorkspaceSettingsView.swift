    ...
    var body: some View {
        VStack(spacing: 0) {
            Form {
                Section {
                    TextField(
                        String(localized: "workspace.settings.name", defaultValue: "Name", comment: "Workspace name text field"),
                    ...
                    Text(String(localized: "workspace.settings.workspace", defaultValue: "Workspace", comment: "Workspace section header"))
                ...
                Section {
                    ...
                    HStack {
                        ...
                        Button {
                            ...
                            Text(String(localized: "workspace.settings.add-task", defaultValue: "Add Task...", comment: "Add task button"))
                        }
                    }
                }
            }
            ...
            HStack {
                ...
                Button {
                    ...
                    Text(String(localized: "workspace.settings.done", defaultValue: "Done", comment: "Done button"))
                        .frame(minWidth: 56)
                }
...
#Preview {
    CEWorkspaceSettingsView(dismiss: { print(String(localized: "workspace.settings.dismiss", defaultValue: "Dismiss", comment: "Dismiss action")) })
}
