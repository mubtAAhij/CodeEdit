    ...
    var body: some View {
        VStack(spacing: 0) {
            Form {
                Section {
                    TextField(
                        String(localized: "workspace.name", defaultValue: "Name", comment: "Workspace name field"),
                        text: $workspaceSettingsManager.settings.project.projectName
                    )
                    .accessibilityLabel(String(localized: "workspace.workspace-name", defaultValue: "Workspace Name", comment: "Workspace name accessibility label"))
                } header: {
                    Text(String(localized: "workspace.workspace", defaultValue: "Workspace", comment: "Workspace section header"))
