...
struct NavigatorAreaView: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel(String(localized: "accessibility.navigator.id", defaultValue: "navigator", comment: "Accessibility identifier - technical constant, should not be localized"))
    }
}
