...
struct NavigatorAreaView: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel(String(localized: "navigator.area.accessibility.identifier-label", defaultValue: "navigator", comment: "Accessibility label for navigator area"))
    }
}
