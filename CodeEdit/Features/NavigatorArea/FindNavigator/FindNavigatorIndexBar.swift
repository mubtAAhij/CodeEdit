            ...
            if shouldShow {
                HStack(alignment: .center) {
                    ProgressView(value: progress, total: 1.0) {
                        ...
                        HStack {
                            Text(String(format: String(
                                localized: "find-navigator.index-bar.progress",
                                defaultValue: "Indexing %d%%",
                                comment: "Indexing progress percentage label"
                            ), Int(progress * 100)))
                                .font(.system(size: 10))
                                .animation(.none)
                        }
                    ...
                    .help(String(
                        ...
                        comment: "Description shown while indexing workspace files for find navigator"
                    ))
                }
