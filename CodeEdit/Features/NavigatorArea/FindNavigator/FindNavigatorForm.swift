    ...
    var body: some View {
        VStack {
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find_navigator.with_placeholder", comment: "Placeholder text for replace field"),
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find_navigator.only_in_folders", comment: "Placeholder for folder inclusion field"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                ...
                PaneTextField(
                    String(localized: "find_navigator.excluding_folders", comment: "Placeholder for folder exclusion field"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "find_navigator.replace_all", comment: "Button text to replace all occurrences"))
