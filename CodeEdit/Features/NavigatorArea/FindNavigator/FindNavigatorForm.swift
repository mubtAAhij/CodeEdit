    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find-navigator.scoped-label", defaultValue: "Scoped", comment: "Label for scoped search toggle"))
                    .controlSize(.small)
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "find-navigator.match-case-tooltip", defaultValue: "Match Case", comment: "Tooltip for match case toggle"))
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find-navigator.replace-with-placeholder", defaultValue: "With", comment: "Placeholder for replace text field"),
                    ...
                    trailingAccessories: {
                        ...
                        Toggle(
                            isOn: $preserveCase,
                            label: {
                                Text(String(localized: "find-navigator.preserve-case-label", defaultValue: "AB", comment: "Label for preserve case toggle"))
                        ...
                        .help(String(localized: "find-navigator.preserve-case-tooltip", defaultValue: "Preserve Case", comment: "Tooltip for preserve case toggle"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find-navigator.only-in-folders-placeholder", defaultValue: "Only in folders", comment: "Placeholder for include folders field"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.open-editors-tooltip", defaultValue: "Search only in Open Editors", comment: "Tooltip for search in open editors toggle"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find-navigator.excluding-folders-placeholder", defaultValue: "Excluding folders", comment: "Placeholder for exclude folders field"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.exclude-settings-tooltip", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Tooltip for exclude settings toggle"))
                    },
                    clearable: true,
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "find-navigator.replace-all-button", defaultValue: "Replace All", comment: "Button to replace all occurrences"))
