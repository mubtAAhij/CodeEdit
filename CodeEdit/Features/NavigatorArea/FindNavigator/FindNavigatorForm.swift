    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "scoped", comment: "Scoped search option"))
                    .controlSize(.small)
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "match_case", comment: "Match case toggle tooltip"))
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "with", comment: "Replace with field placeholder"),
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "preserve_case", comment: "Preserve case toggle tooltip"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "only_in_folders", comment: "Only in folders field placeholder"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "search_only_in_open_editors", comment: "Search only in open editors tooltip"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "excluding_folders", comment: "Excluding folders field placeholder"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "use_exclude_settings_and_ignore_files", comment: "Use exclude settings tooltip"))
                    },
                    clearable: true,
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "replace_all", comment: "Replace all button text"))
