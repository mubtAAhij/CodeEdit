    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find.scoped", defaultValue: "Scoped", comment: "Scoped search toggle label"))
                    .controlSize(.small)
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "find.match-case", defaultValue: "Match Case", comment: "Match case toggle tooltip"))
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find.replace.with", defaultValue: "With", comment: "Replace with field label"),
                    ...
                    trailingAccessories: {
                        ...
                        Toggle(
                            isOn: $preserveCase,
                            label: {
                                Text(String(localized: "find.preserve-case.icon", defaultValue: "AB", comment: "Preserve case toggle icon text"))
                        ...
                        .help(String(localized: "find.preserve-case", defaultValue: "Preserve Case", comment: "Preserve case toggle tooltip"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find.scope.only-in-folders", defaultValue: "Only in folders", comment: "Include folders field label"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find.scope.open-editors", defaultValue: "Search only in Open Editors", comment: "Search only in open editors toggle tooltip"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find.scope.excluding-folders", defaultValue: "Excluding folders", comment: "Exclude folders field label"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find.scope.exclude-settings", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Use exclude settings toggle tooltip"))
                    },
                    clearable: true,
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "find.replace.replace-all", defaultValue: "Replace All", comment: "Replace all button label"))
