    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "navigator.find.scoped", defaultValue: "Scoped", comment: "Toggle label for scoped search"))
                    .controlSize(.small)
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "navigator.find.match-case", defaultValue: "Match Case", comment: "Help text for case-sensitive search toggle"))
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "navigator.find.replace-with", defaultValue: "With", comment: "Placeholder for replacement text field"),
                    ...
                    trailingAccessories: {
                        ...
                        Toggle(
                            isOn: $preserveCase,
                            label: {
                                Text(String(localized: "navigator.find.preserve-case-icon", defaultValue: "AB", comment: "Icon text for preserve case toggle"))
                        ...
                        .help(String(localized: "navigator.find.preserve-case", defaultValue: "Preserve Case", comment: "Help text for preserve case toggle in replace"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "navigator.find.only-in-folders", defaultValue: "Only in folders", comment: "Placeholder for folder inclusion filter"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "navigator.find.open-editors-only", defaultValue: "Search only in Open Editors", comment: "Help text for toggle to search only in open editors"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "navigator.find.excluding-folders", defaultValue: "Excluding folders", comment: "Placeholder for folder exclusion filter"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "navigator.find.use-exclude-settings", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Help text for toggle to use exclude settings"))
                    },
                    clearable: true,
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "navigator.find.replace-all", defaultValue: "Replace All", comment: "Button to replace all occurrences"))
