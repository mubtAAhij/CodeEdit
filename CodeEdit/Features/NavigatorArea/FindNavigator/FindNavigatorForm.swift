    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "scoped", comment: "Search scope toggle label"))
                    .controlSize(.small)
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "match_case", comment: "Match case toggle help text"))
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "with", comment: "Replace field placeholder"),
                    ...
                    trailingAccessories: {
                        ...
                        Toggle(
                            isOn: $preserveCase,
                            label: {
                                Text(String(localized: "ab", comment: "Preserve case toggle symbol"))
                        ...
                        .help(String(localized: "preserve_case", comment: "Preserve case toggle help text"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "only_in_folders", comment: "Search include folders field placeholder"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "search_only_in_open_editors", comment: "Search in open editors toggle help text"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "excluding_folders", comment: "Search exclude folders field placeholder"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "use_exclude_settings_ignore_files", comment: "Use exclude settings toggle help text"))
                    },
                    clearable: true,
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "replace_all", comment: "Button to replace all search matches"))
