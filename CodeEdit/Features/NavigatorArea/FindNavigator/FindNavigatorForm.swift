    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find.navigator.scoped", defaultValue: "Scoped", comment: "Button to toggle scoped search"))
                    .controlSize(.small)
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "find.navigator.match-case", defaultValue: "Match Case", comment: "Help text for case-sensitive search toggle"))
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find.navigator.replace.with", defaultValue: "With", comment: "Placeholder for replacement text field"),
                    ...
                    trailingAccessories: {
                        ...
                        Toggle(
                            isOn: $preserveCase,
                            label: {
                                Text(String(localized: "find.navigator.replace.ab-indicator", defaultValue: "AB", comment: "Label for preserve case toggle"))
                        ...
                        .help(String(localized: "find.navigator.replace.preserve-case", defaultValue: "Preserve Case", comment: "Help text for preserve case toggle"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find.navigator.scope.only-in-folders", defaultValue: "Only in folders", comment: "Placeholder for folder inclusion filter"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find.navigator.scope.open-editors", defaultValue: "Search only in Open Editors", comment: "Help text for open editors filter toggle"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find.navigator.scope.excluding-folders", defaultValue: "Excluding folders", comment: "Placeholder for folder exclusion filter"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find.navigator.scope.exclude-settings", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Help text for exclude settings toggle"))
                    },
                    clearable: true,
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "find.navigator.replace.replace-all", defaultValue: "Replace All", comment: "Button to replace all search results"))
