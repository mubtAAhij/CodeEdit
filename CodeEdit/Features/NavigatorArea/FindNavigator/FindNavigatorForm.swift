    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text("String(localized: "scoped", comment: "Toggle label for scoped search option")")
                    .controlSize(.small)
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help("String(localized: "match_case", comment: "Help text for case sensitive search toggle")")
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    "String(localized: "with", comment: "Placeholder text for replacement field in find and replace")",
                    ...
                    trailingAccessories: {
                        ...
                        .help("String(localized: "preserve_case", comment: "Help text for preserve case toggle in find and replace")")
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    "String(localized: "only_in_folders", comment: "Placeholder text for folder inclusion field in scoped search")",
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help("String(localized: "search_only_in_open_editors", comment: "Help text for toggle to limit search to open editor files")")
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    "String(localized: "excluding_folders", comment: "Placeholder text for folder exclusion field in scoped search")",
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help("String(localized: "use_exclude_settings_and_ignore_files", comment: "Help text for toggle to use project exclude settings and ignore files")")
                    },
                    clearable: true,
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text("String(localized: "replace_all", comment: "Button text to replace all search results")")
