    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find.scoped", defaultValue: "Scoped", comment: "Label for scoped search toggle"))
                    .controlSize(.small)
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "find.match-case", defaultValue: "Match Case", comment: "Help text for match case toggle"))
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find.preserve-case", defaultValue: "Preserve Case", comment: "Help text for preserve case toggle"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find.only-in-folders", defaultValue: "Only in folders", comment: "Placeholder for folder inclusion field"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find.search-open-editors", defaultValue: "Search only in Open Editors", comment: "Help text for searching only in open editors"))
                    },
                    clearable: true,
                ...
                PaneTextField(
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find.use-exclude-settings", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Help text for using exclude settings and ignore files"))
                    },
                    clearable: true,
