    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find.scoped", defaultValue: "Scoped", comment: "Scoped search toggle"))
                    .controlSize(.small)
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "find.match-case", defaultValue: "Match Case", comment: "Match case toggle help"))
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find.with", defaultValue: "With", comment: "Replace with field label"),
                    ...
                    trailingAccessories: {
                        ...
                        Toggle(
                            isOn: $preserveCase,
                            label: {
                                Text(String(localized: "find.preserve-case.icon", defaultValue: "AB", comment: "Preserve case icon"))
                        ...
                        .help(String(localized: "find.preserve-case", defaultValue: "Preserve Case", comment: "Preserve case toggle help"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find.only-in-folders", defaultValue: "Only in folders", comment: "Only in folders field label"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find.open-editors-only", defaultValue: "Search only in Open Editors", comment: "Search only in open editors toggle help"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find.excluding-folders", defaultValue: "Excluding folders", comment: "Excluding folders field label"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find.use-exclude-settings", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Use exclude settings toggle help"))
                    },
                    clearable: true,
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "find.replace-all", defaultValue: "Replace All", comment: "Replace all button"))
