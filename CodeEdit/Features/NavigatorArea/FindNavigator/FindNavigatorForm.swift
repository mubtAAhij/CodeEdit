    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find-navigator.scoped", defaultValue: "Scoped", comment: "Toggle label for scoped search"))
                    .controlSize(.small)
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find-navigator.with", defaultValue: "With", comment: "Placeholder for replace field"),
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find-navigator.only-in-folders", defaultValue: "Only in folders", comment: "Placeholder for folders filter field"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.open-editors-only", defaultValue: "Search only in Open Editors", comment: "Help text for open editors filter toggle"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find-navigator.excluding-folders", defaultValue: "Excluding folders", comment: "Placeholder for excluding folders field"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "find-navigator.replace-all", defaultValue: "Replace All", comment: "Button to replace all matches"))
