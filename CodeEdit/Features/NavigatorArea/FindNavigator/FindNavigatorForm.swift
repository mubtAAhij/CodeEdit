    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find.scoped", defaultValue: "Scoped", comment: "Scoped toggle label"))
                    .controlSize(.small)
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "find.match-case", defaultValue: "Match Case", comment: "Match Case tooltip"))
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find.with", defaultValue: "With", comment: "Replace with field placeholder"),
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find.preserve-case", defaultValue: "Preserve Case", comment: "Preserve Case tooltip"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find.only-in-folders", defaultValue: "Only in folders", comment: "Only in folders field placeholder"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find.search-only-in-open-editors", defaultValue: "Search only in Open Editors", comment: "Search only in Open Editors tooltip"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find.excluding-folders", defaultValue: "Excluding folders", comment: "Excluding folders field placeholder"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find.use-exclude-settings", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Use Exclude Settings and Ignore Files tooltip"))
                    },
                    clearable: true,
