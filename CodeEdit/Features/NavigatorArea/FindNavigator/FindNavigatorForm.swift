    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find-navigator.scoped", defaultValue: "Scoped", comment: "Toggle label for scoped search in find navigator"))
                    .controlSize(.small)
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find-navigator.replace-with", defaultValue: "With", comment: "Placeholder for replace field in find navigator"),
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.preserve-case", defaultValue: "Preserve Case", comment: "Help text for preserve case toggle in replace"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find-navigator.only-in-folders", defaultValue: "Only in folders", comment: "Placeholder for folder inclusion field in scoped search"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.open-editors-only", defaultValue: "Search only in Open Editors", comment: "Help text for open editors search scope toggle"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find-navigator.excluding-folders", defaultValue: "Excluding folders", comment: "Placeholder for folder exclusion field in scoped search"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.use-exclude-settings", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Help text for exclude settings toggle"))
                    },
                    clearable: true,
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "find-navigator.replace-all", defaultValue: "Replace All", comment: "Button label to replace all occurrences"))
