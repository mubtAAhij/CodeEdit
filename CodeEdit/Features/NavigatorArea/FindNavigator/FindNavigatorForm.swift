    ...
    var body: some View {
        VStack {
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find-navigator.with", defaultValue: "With", comment: "Replace field placeholder"),
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find-navigator.only-in-folders", defaultValue: "Only in folders", comment: "Include folders field placeholder"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.open-editors-only", defaultValue: "Search only in Open Editors", comment: "Search in open editors toggle tooltip"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find-navigator.excluding-folders", defaultValue: "Excluding folders", comment: "Exclude folders field placeholder"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
