    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find.scoped", defaultValue: "Scoped", comment: "Toggle for scoped search"))
                    .controlSize(.small)
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find.only-in-folders", defaultValue: "Only in folders", comment: "Placeholder for include folders field"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find.open-editors-only", defaultValue: "Search only in Open Editors", comment: "Tooltip for open editors toggle"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find.excluding-folders", defaultValue: "Excluding folders", comment: "Placeholder for exclude folders field"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find.exclude-settings", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Tooltip for exclude settings toggle"))
                    },
                    clearable: true,
