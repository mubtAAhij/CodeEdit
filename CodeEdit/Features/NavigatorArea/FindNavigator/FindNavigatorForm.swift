    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find.scoped", defaultValue: "Scoped", comment: "Toggle text"))
                    .controlSize(.small)
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "find.match_case", defaultValue: "Match Case", comment: "Help text"))
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find.with", defaultValue: "With", comment: "Placeholder text"),
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find.preserve_case", defaultValue: "Preserve Case", comment: "Help text"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find.only_in_folders", defaultValue: "Only in folders", comment: "Placeholder text"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find.open_editors_only", defaultValue: "Search only in Open Editors", comment: "Help text"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find.excluding_folders", defaultValue: "Excluding folders", comment: "Placeholder text"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find.exclude_settings", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Help text"))
                    },
                    clearable: true,
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "find.replace_all", defaultValue: "Replace All", comment: "Button text"))
