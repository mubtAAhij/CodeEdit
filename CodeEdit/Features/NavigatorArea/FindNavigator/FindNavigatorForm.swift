    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find-navigator.form.scoped.toggle", defaultValue: "Scoped", comment: "Toggle label for scoped search in the find navigator."))
                    .controlSize(.small)
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "find-navigator.form.match-case.toggle", defaultValue: "Match Case", comment: "Toggle label for case-sensitive search in the find navigator."))
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find-navigator.form.replace.with.label", defaultValue: "With", comment: "Label for replacement text field in find and replace form."),
                    ...
                    trailingAccessories: {
                        ...
                        Toggle(
                            isOn: $preserveCase,
                            label: {
                                Text(String(localized: "find-navigator.form.preserve-case.abbreviation", defaultValue: "AB", comment: "Abbreviation shown next to preserve case option in find and replace form."))
                        ...
                        .help(String(localized: "find-navigator.form.preserve-case.toggle", defaultValue: "Preserve Case", comment: "Toggle label for preserving letter case during replace."))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find-navigator.form.only-in-folders.label", defaultValue: "Only in folders", comment: "Label for folder inclusion scope in find navigator."),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.form.open-editors-only.toggle", defaultValue: "Search only in Open Editors", comment: "Toggle label to restrict search to open editors."))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find-navigator.form.excluding-folders.label", defaultValue: "Excluding folders", comment: "Label for excluded folders in find navigator."),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.form.use-exclude-settings.toggle", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Toggle label to apply exclude settings and ignore files during search."))
                    },
                    clearable: true,
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "find-navigator.form.replace-all.button", defaultValue: "Replace All", comment: "Button title to replace all matches in find navigator."))
