        ...
        VStack {
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "find-navigator.match-case", defaultValue: "Match Case", comment: "Tooltip for case-sensitive search toggle"))
                ...
                PaneTextField(
                    ...
                    trailingAccessories: {
                        ...
                        Toggle(
                            isOn: $preserveCase,
                            label: {
                                Text(String(localized: "find-navigator.preserve-case.icon", defaultValue: "AB", comment: "Icon label for preserve case toggle"))
                        ...
                        .help(String(localized: "find-navigator.preserve-case", defaultValue: "Preserve Case", comment: "Tooltip for preserve case toggle in replace"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find-navigator.only-in-folders", defaultValue: "Only in folders", comment: "Placeholder for folder inclusion filter"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.search-open-editors", defaultValue: "Search only in Open Editors", comment: "Tooltip for open editors search scope toggle"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find-navigator.excluding-folders", defaultValue: "Excluding folders", comment: "Placeholder for folder exclusion filter"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.use-exclude-settings", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Tooltip for exclude settings toggle"))
                    },
                    clearable: true,
