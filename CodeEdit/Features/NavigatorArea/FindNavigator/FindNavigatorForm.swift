    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find-navigator.scoped", defaultValue: "Scoped", comment: "Toggle label for scoped search mode"))
                    .controlSize(.small)
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.preserve-case", defaultValue: "Preserve Case", comment: "Help text for preserve case toggle"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find-navigator.only-in-folders", defaultValue: "Only in folders", comment: "Placeholder for include folders filter field"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.search-only-open-editors", defaultValue: "Search only in Open Editors", comment: "Help text for search in open editors toggle"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find-navigator.excluding-folders", defaultValue: "Excluding folders", comment: "Placeholder for exclude folders filter field"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
