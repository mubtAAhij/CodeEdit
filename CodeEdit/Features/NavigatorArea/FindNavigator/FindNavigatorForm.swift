    ...
    var body: some View {
        VStack {
            HStack {
                ...
                Spacer()
                Text(String(localized: "find-navigator.form.scope.section-title", defaultValue: "Scoped", comment: "Section title for scoped search options"))
                    .controlSize(.small)
            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    ...
                    .help(String(localized: "find-navigator.form.option.match-case", defaultValue: "Match Case", comment: "Toggle label for case-sensitive search"))
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                PaneTextField(
                    String(localized: "find-navigator.form.replace.with-label", defaultValue: "With", comment: "Label for replace text field"),
                    ...
                    trailingAccessories: {
                        ...
                        Toggle(
                            isOn: $preserveCase,
                            label: {
                                Text(String(localized: "find-navigator.form.replace.preserve-case.icon-text", defaultValue: "AB", comment: "Short icon text indicating preserve case option"))
                        ...
                        .help(String(localized: "find-navigator.form.replace.preserve-case.label", defaultValue: "Preserve Case", comment: "Toggle label to preserve letter case during replacement"))
                    },
                    clearable: true,
            ...
            if scoped {
                PaneTextField(
                    String(localized: "find-navigator.form.scope.only-in-folders", defaultValue: "Only in folders", comment: "Label for folders-only search scope"),
                    text: $includesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.form.scope.open-editors-only", defaultValue: "Search only in Open Editors", comment: "Option label for limiting search to open editors"))
                    },
                    clearable: true,
                    hasValue: scopedToOpenEditors
                )
                PaneTextField(
                    String(localized: "find-navigator.form.scope.excluding-folders", defaultValue: "Excluding folders", comment: "Label for excluding folders from search scope"),
                    text: $excludesText,
                    axis: .vertical,
                    leadingAccessories: {
                    ...
                    trailingAccessories: {
                        ...
                        .help(String(localized: "find-navigator.form.scope.use-exclude-settings-and-ignore-files", defaultValue: "Use Exclude Settings and Ignore Files", comment: "Option label to apply exclude settings and ignore files in search"))
                    },
                    clearable: true,
            ...
            if selectedMode[0] == SearchModeModel.Replace {
                Button {
                    ...
                    Text(String(localized: "find-navigator.form.action.replace-all", defaultValue: "Replace All", comment: "Button title to replace all matches"))
