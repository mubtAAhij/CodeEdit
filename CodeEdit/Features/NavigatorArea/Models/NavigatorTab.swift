...
enum NavigatorTab: WorkspacePanelTab {
    ...
    var title: String {
        switch self {
        case .project:
            return String(localized: "navigator.tab.project", comment: "Navigator tab title for project view")
        case .sourceControl:
            return String(localized: "navigator.tab.source_control", comment: "Navigator tab title for source control view")
        case .search:
            return String(localized: "navigator.tab.search", comment: "Navigator tab title for search view")
        case .uiExtension(_, let data):
