    ...
    var body: some View {
        if sourceControlManager.isGitRepository {
            SegmentedControl(
                $selectedSection,
                options: [
                    String(localized: "source-control.tab.changes", defaultValue: "Changes", comment: "Tab title for source control changes"),
                    String(localized: "source-control.tab.history", defaultValue: "History", comment: "Tab title for commit history"),
                    String(localized: "source-control.tab.repository", defaultValue: "Repository", comment: "Tab title for repository view")
                ],
                prominent: true
            )
