    ...
    var body: some View {
        if sourceControlManager.isGitRepository {
            SegmentedControl(
                $selectedSection,
                options: [
                    String(localized: "source-control.tab.changes", defaultValue: "Changes", comment: "Source control changes tab"),
                    String(localized: "source-control.tab.history", defaultValue: "History", comment: "Source control history tab"),
                    String(localized: "source-control.tab.repository", defaultValue: "Repository", comment: "Source control repository tab")
                ],
                prominent: true
            )
            ...
            CEContentUnavailableView(
                String(localized: "source-control.no-repository", defaultValue: "No Repository", comment: "Message when no git repository"),
                 description: String(localized: "source-control.no-repository-description", defaultValue: "This project is not a git repository.", comment: "Description when no git repository"),
