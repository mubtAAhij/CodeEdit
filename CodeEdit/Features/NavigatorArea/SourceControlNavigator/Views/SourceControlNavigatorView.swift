...
struct SourceControlNavigatorTabs: View {
    ...
    var body: some View {
        if sourceControlManager.isGitRepository {
            SegmentedControl(
                $selectedSection,
                options: [String(localized: "source-control.navigator.changes", defaultValue: "Changes", comment: "Changes tab"), String(localized: "source-control.navigator.history", defaultValue: "History", comment: "History tab"), String(localized: "source-control.navigator.repository", defaultValue: "Repository", comment: "Repository tab")],
                prominent: true
            )
            ...
            CEContentUnavailableView(
                String(localized: "source-control.navigator.no-repository", defaultValue: "No Repository", comment: "No repository message"),
                 description: String(localized: "source-control.navigator.not-git", defaultValue: "This project is not a git repository.", comment: "Not a git repository message"),
                 systemImage: "externaldrive.fill",
                 actions: {
                    Button(String(localized: "source-control.navigator.initialize", defaultValue: "Initialize", comment: "Initialize button")) {
                        Task {
