        ...
        if sourceControlManager.isGitRepository {
            ...
            CEContentUnavailableView(
                String(localized: "source-control.no-repository", defaultValue: "No Repository", comment: "No repository title"),
                 description: String(localized: "source-control.not-a-git-repository", defaultValue: "This project is not a git repository.", comment: "Not a git repository description"),
