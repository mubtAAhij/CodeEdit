...
struct SourceControlNavigatorTabs: View {
    ...
    var body: some View {
        if sourceControlManager.isGitRepository {
            SegmentedControl(
                $selectedSection,
                options: ["String(localized: "changes", comment: "Tab label for changes view in source control navigator")", "String(localized: "history", comment: "Tab label for history view in source control navigator")", "String(localized: "repository", comment: "Tab label for repository view in source control navigator")"],
                prominent: true
            )
            ...
            CEContentUnavailableView(
                "String(localized: "no_repository", comment: "Title when no git repository is found")",
                 description: "String(localized: "not_git_repository_description", comment: "Description when project is not a git repository")",
                 systemImage: "externaldrive.fill",
                 actions: {
                    Button("String(localized: "initialize", comment: "Button to initialize a git repository")") {
                        Task {
