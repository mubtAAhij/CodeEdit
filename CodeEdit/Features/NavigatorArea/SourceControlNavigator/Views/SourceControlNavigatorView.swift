...
struct SourceControlNavigatorTabs: View {
    ...
    var body: some View {
        if sourceControlManager.isGitRepository {
            SegmentedControl(
                $selectedSection,
                options: ["String(localized: "changes", comment: "Tab label for changes view")", String(localized: "history", comment: "Source control history tab label"), String(localized: "repository", comment: "Source control repository tab label")],
                prominent: true
            )
            ...
            CEContentUnavailableView(
                String(localized: "no_repository", comment: "Message when project has no git repository"),
                 description: String(localized: "project_not_git_repository", comment: "Description explaining project is not a git repository"),
