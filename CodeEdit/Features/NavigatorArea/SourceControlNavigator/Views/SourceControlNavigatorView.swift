    ...
    var body: some View {
        if sourceControlManager.isGitRepository {
            SegmentedControl(
                $selectedSection,
                options: [
                    String(localized: "sourcecontrol.changes", defaultValue: "Changes", comment: "Changes tab"),
                    String(localized: "sourcecontrol.history", defaultValue: "History", comment: "History tab"),
                    String(localized: "sourcecontrol.repository", defaultValue: "Repository", comment: "Repository tab")
                ],
                prominent: true
            )
            ...
            CEContentUnavailableView(
                String(localized: "sourcecontrol.no-repository", defaultValue: "No Repository", comment: "No repository message"),
                 description: String(localized: "sourcecontrol.not-git-repository", defaultValue: "This project is not a git repository.", comment: "Not a git repository description"),
                 systemImage: "externaldrive.fill",
                 actions: {
                    Button(String(localized: "sourcecontrol.initialize", defaultValue: "Initialize", comment: "Initialize repository button")) {
                        Task {
