...
extension SourceControlNavigatorRepositoryView {
    ...
    func contextMenu(for item: RepoOutlineGroupItem, branch: GitBranch) -> some View {
        Button(String(localized: "source-control.repository.context-menu.switch", defaultValue: "Switch...", comment: "Context menu action to switch source control branch or reference")) {
        ...
        Divider()
        Button(String(localized: "source-control.repository.context-menu.add-existing-remote", defaultValue: "Add Existing Remote...", comment: "Context menu action to add an existing remote repository")) {
