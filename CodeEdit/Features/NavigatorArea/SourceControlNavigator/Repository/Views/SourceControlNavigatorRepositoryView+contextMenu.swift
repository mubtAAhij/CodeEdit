...
extension SourceControlNavigatorRepositoryView {
    ...
    func contextMenu(for item: RepoOutlineGroupItem, branch: GitBranch) -> some View {
        Button(String(localized: "source-control.switch-branch", defaultValue: "Switch...", comment: "Menu item to switch branches")) {
        ...
        Button(
            ...
            ? String(localized: "source-control.new-branch", defaultValue: "New Branch...", comment: "Menu item to create a new branch")
            : String(format: String(localized: "source-control.new-branch-from", defaultValue: "New Branch from \"%@\"...", comment: "Menu item to create a new branch from a specific branch"), branch.name)
        ) {
            showNewBranch = true
        ...
        Button(
            item.branch == nil
            ? String(localized: "source-control.rename-branch", defaultValue: "Rename Branch...", comment: "Menu item to rename a branch")
            : String(format: String(localized: "source-control.rename-branch-named", defaultValue: "Rename \"%@\"...", comment: "Menu item to rename a specific branch"), branch.name)
        ) {
        ...
        Divider()
        Button(String(localized: "source-control.add-remote", defaultValue: "Add Existing Remote...", comment: "Menu item to add an existing remote")) {
        ...
        Divider()
        Button(String(localized: "source-control.delete", defaultValue: "Delete...", comment: "Menu item to delete a branch, remote, or stash entry")) {
            handleDelete(item)
        }
        .disabled(
            (item.branch == nil
