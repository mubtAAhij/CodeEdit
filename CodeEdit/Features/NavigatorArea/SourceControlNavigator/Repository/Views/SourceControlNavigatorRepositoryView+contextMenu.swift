...
extension SourceControlNavigatorRepositoryView {
    ...
    func contextMenu(for item: RepoOutlineGroupItem, branch: GitBranch) -> some View {
        Button(String(
            localized: "source-control.repository.context-menu.switch",
            defaultValue: "Switch...",
            comment: "Context menu action to switch branches."
        )) {
        ...
        Button(
            ...
            ? String(
                localized: "source-control.repository.context-menu.new-branch",
                defaultValue: "New Branch...",
                comment: "Context menu action to create a new branch."
            )
            : String(format: String(
                localized: "source-control.repository.context-menu.new-branch-from",
                defaultValue: "New Branch from \"%@\"...",
                comment: "Context menu action to create a new branch from a selected branch."
            ), "\(branch.name)")
        ) {
            showNewBranch = true
        ...
        Button(
            item.branch == nil
            ? String(
                localized: "source-control.repository.context-menu.rename-branch",
                defaultValue: "Rename Branch...",
                comment: "Context menu action to rename a branch."
            )
            : String(format: String(
                localized: "source-control.repository.context-menu.rename-branch-name",
                defaultValue: "Rename \"%@\"...",
                comment: "Context menu action to rename the selected branch."
            ), "\(branch.name)")
        ) {
        ...
        Divider()
        Button(String(
            localized: "source-control.repository.context-menu.add-existing-remote",
            defaultValue: "Add Existing Remote...",
            comment: "Context menu action to add an existing remote."
        )) {
        ...
        Divider()
        Button(String(
            localized: "source-control.repository.context-menu.apply-stashed-changes",
            defaultValue: "Apply Stashed Changes...",
            comment: "Context menu action to apply stashed changes."
        )) {
        ...
        Divider()
        Button(String(
            localized: "source-control.repository.context-menu.delete",
            defaultValue: "Delete...",
            comment: "Context menu action to delete selected source control item."
        )) {
            handleDelete(item)
        }
        .disabled(
