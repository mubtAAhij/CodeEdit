...
extension SourceControlNavigatorRepositoryView {
    ...
    func contextMenu(for item: RepoOutlineGroupItem, branch: GitBranch) -> some View {
        ...
        Button(
            ...
            : String(format: NSLocalizedString("source-control.new-branch-from", comment: "New branch from button"), branch.name)
        ) {
            showNewBranch = true
        ...
        Button(
            ...
            : String(format: NSLocalizedString("source-control.rename-branch-name", comment: "Rename specific branch button"), branch.name)
        ) {
        ...
        Divider()
        Button(String(localized: "source-control.add-existing-remote", defaultValue: "Add Existing Remote...", comment: "Add existing remote button")) {
            sourceControlManager.addExistingRemoteSheetIsPresented = true
        }
        .disabled(item.id != "RemotesGroup")
        Divider()
        Button(String(localized: "source-control.apply-stashed-changes", defaultValue: "Apply Stashed Changes...", comment: "Apply stashed changes button")) {
