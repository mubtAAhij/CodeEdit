...
struct SourceControlNavigatorRepositoryView: View {
    ...
    var body: some View {
        ...
        .alert(
            ...
            : String(localized: "source-control-navigator.apply-stash.uncommitted-changes", defaultValue: "The local repository has uncommitted changes.", comment: "Alert title when repository has uncommitted changes"),
            isPresented: $applyStashedChangesIsPresented
        ) {
            if sourceControlManager.changedFiles.isEmpty {
                Button(String(localized: "source-control-navigator.apply-stash.apply", defaultValue: "Apply", comment: "Button to apply stashed changes")) {
                ...
                Button(String(localized: "source-control-navigator.apply-stash.apply-and-delete", defaultValue: "Apply and Delete", comment: "Button to apply and delete stashed changes")) {
                    if let stashEntry = stashEntryToApply {
                        Task {
                            try await sourceControlManager.applyStashEntry(stashEntry: stashEntry)
                ...
                Button(String(localized: "source-control-navigator.apply-stash.cancel", defaultValue: "Cancel", comment: "Cancel button"), role: .cancel) {}
            } else {
                Button(String(localized: "source-control-navigator.apply-stash.okay", defaultValue: "Okay", comment: "Okay button"), role: .cancel) {}
            }
        } message: {
            sourceControlManager.changedFiles.isEmpty
            ? Text(String(localized: "source-control-navigator.apply-stash.message", defaultValue: "Applying the stashed changes will restore modifications to files in your local repository.", comment: "Message explaining stash apply action"))
            : Text(String(localized: "source-control-navigator.apply-stash.try-committing", defaultValue: "Try committing or discarding the changes.", comment: "Message suggesting to commit or discard changes"))
        }
        .confirmationDialog(
            ...
            Button(String(localized: "source-control-navigator.delete-branch.delete", defaultValue: "Delete", comment: "Delete button for branch")) {
                    ...
                    Task {
                        do {
                            ...
                            await sourceControlManager.showAlertForError(
                                title: String(localized: "source-control-navigator.delete-branch.failed", defaultValue: "Failed to delete", comment: "Error alert title for failed branch deletion"),
                                error: error
                            )
                        }
                        branchToDelete = nil
            ...
            Text(String(localized: "source-control-navigator.delete-branch.message", defaultValue: "The branch will be removed from the repository. You can't undo this action.", comment: "Warning message for branch deletion"))
        }
        .confirmationDialog(
            ...
            Button(String(localized: "source-control-navigator.delete-stash.delete", defaultValue: "Delete", comment: "Delete button for stash")) {
                if let stashEntry = stashEntryToDelete {
                    Task {
                        do {
                            ...
                            await sourceControlManager.showAlertForError(
                                title: String(localized: "source-control-navigator.delete-stash.failed", defaultValue: "Failed to delete", comment: "Error alert title for failed stash deletion"),
                                error: error
                            )
                        }
            ...
            Text(String(localized: "source-control-navigator.delete-stash.message", defaultValue: "The stash will be removed from the repository. You can't undo this action.", comment: "Warning message for stash deletion"))
        }
        .confirmationDialog(
            ...
            Button(String(localized: "source-control-navigator.delete-remote.delete", defaultValue: "Delete", comment: "Delete button for remote")) {
                if let remote = remoteToDelete {
                    Task {
                        do {
                            ...
                            await sourceControlManager.showAlertForError(
                                title: String(localized: "source-control-navigator.delete-remote.failed", defaultValue: "Failed to delete", comment: "Error alert title for failed remote deletion"),
                                error: error
                            )
                        }
                        remoteToDelete = nil
            ...
            Text(String(localized: "source-control-navigator.delete-remote.message", defaultValue: "The remote will be removed from the repository. You can't undo this action.", comment: "Warning message for remote deletion"))
        }
        .task {
