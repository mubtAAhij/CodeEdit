...
struct SourceControlNavigatorRepositoryView: View {
    ...
    var body: some View {
        ...
        .alert(
            ...
            : String(localized: "repository_has_uncommitted_changes", comment: "Alert title when repository has uncommitted changes"),
            isPresented: $applyStashedChangesIsPresented
        ) {
            if sourceControlManager.changedFiles.isEmpty {
                Button(String(localized: "apply", comment: "Button label to apply changes")) {
                ...
                Button(String(localized: "apply_and_delete", comment: "Button label to apply changes and delete stash")) {
                    if let stashEntry = stashEntryToApply {
                        Task {
                            try await sourceControlManager.applyStashEntry(stashEntry: stashEntry)
            ...
            : Text(String(localized: "try_committing_or_discarding_changes", comment: "Message suggesting to commit or discard changes"))
        }
        .confirmationDialog(
