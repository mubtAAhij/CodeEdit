    ...
    var body: some View {
        ...
        .alert(
            ...
            if sourceControlManager.changedFiles.isEmpty {
                ...
                Button(String(localized: "alert.cancel", defaultValue: "Cancel", comment: "Cancel button"), role: .cancel) {}
            } else {
                Button(String(localized: "alert.okay", defaultValue: "Okay", comment: "Okay button"), role: .cancel) {}
            }
        } message: {
            sourceControlManager.changedFiles.isEmpty
            ? Text(String(localized: "source-control.stash.apply-message", defaultValue: "Applying the stashed changes will restore modifications to files in your local repository.", comment: "Alert message explaining stash apply"))
            : Text(String(localized: "source-control.stash.uncommitted-message", defaultValue: "Try committing or discarding the changes.", comment: "Alert message when there are uncommitted changes"))
        }
        .confirmationDialog(
            String(format: String(localized: "source-control.branch.delete-prompt", defaultValue: "Do you want to delete the branch \"%@\"?", comment: "Confirmation dialog for deleting branch"), branchToDelete?.name ?? ""),
                    ...
                    Task {
                        do {
                            ...
                            await sourceControlManager.showAlertForError(
                                title: String(localized: "source-control.delete.failed", defaultValue: "Failed to delete", comment: "Error title when delete fails"),
                                error: error
                            )
                        }
                        branchToDelete = nil
            ...
            Text(String(localized: "source-control.branch.delete-warning", defaultValue: "The branch will be removed from the repository. You can't undo this action.", comment: "Warning message for branch deletion"))
        }
        .confirmationDialog(
            String(format: String(localized: "source-control.stash.delete-prompt", defaultValue: "Do you want to delete the stash \"%@\"?", comment: "Confirmation dialog for deleting stash"), stashEntryToDelete?.message ?? ""),
            ...
            Text(String(localized: "source-control.stash.delete-warning", defaultValue: "The stash will be removed from the repository. You can't undo this action.", comment: "Warning message for stash deletion"))
        }
        .confirmationDialog(
            String(format: String(localized: "source-control.remote.delete-prompt", defaultValue: "Do you want to delete the remote \"%@\"?", comment: "Confirmation dialog for deleting remote"), remoteToDelete?.name ?? ""),
            ...
            Text(String(localized: "source-control.remote.delete-warning", defaultValue: "The remote will be removed from the repository. You can't undo this action.", comment: "Warning message for remote deletion"))
        }
        .task {
