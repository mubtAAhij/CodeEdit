...
struct SourceControlNavigatorRepositoryView: View {
    ...
    var body: some View {
        ...
        .alert(
            ...
            : String(localized: "source-control.repository.uncommitted-changes", defaultValue: "The local repository has uncommitted changes.", comment: "Alert title when repository has uncommitted changes"),
            ...
            if sourceControlManager.changedFiles.isEmpty {
                ...
                Button(String(localized: "general.cancel", defaultValue: "Cancel", comment: "Cancel button"), role: .cancel) {}
            } else {
                Button(String(localized: "general.okay", defaultValue: "Okay", comment: "Okay button"), role: .cancel) {}
            }
        } message: {
            sourceControlManager.changedFiles.isEmpty
            ? Text(String(localized: "source-control.stash.apply-message", defaultValue: "Applying the stashed changes will restore modifications to files in your local repository.", comment: "Alert message explaining stash apply action"))
            : Text(String(localized: "source-control.repository.uncommitted-changes-message", defaultValue: "Try committing or discarding the changes.", comment: "Alert message suggesting to commit or discard changes"))
        }
        .confirmationDialog(
            String(format: String(localized: "source-control.branch.delete-prompt", defaultValue: "Do you want to delete the branch \"%@\"?", comment: "Confirmation dialog asking to delete a branch"), branchToDelete?.name ?? ""),
            isPresented: $isPresentingConfirmDeleteBranch
        ) {
            Button(String(localized: "general.delete", defaultValue: "Delete", comment: "Delete button")) {
            ...
            Text(String(localized: "source-control.branch.delete-message", defaultValue: "The branch will be removed from the repository. You can't undo this action.", comment: "Warning message when deleting a branch"))
        }
        .confirmationDialog(
            String(format: String(localized: "source-control.stash.delete-prompt", defaultValue: "Do you want to delete the stash \"%@\"?", comment: "Confirmation dialog asking to delete a stash"), stashEntryToDelete?.message ?? ""),
            ...
            Text(String(localized: "source-control.stash.delete-message", defaultValue: "The stash will be removed from the repository. You can't undo this action.", comment: "Warning message when deleting a stash"))
        }
        .confirmationDialog(
            String(format: String(localized: "source-control.remote.delete-prompt", defaultValue: "Do you want to delete the remote \"%@\"?", comment: "Confirmation dialog asking to delete a remote"), remoteToDelete?.name ?? ""),
            ...
            Text(String(localized: "source-control.remote.delete-message", defaultValue: "The remote will be removed from the repository. You can't undo this action.", comment: "Warning message when deleting a remote"))
        }
        .task {
