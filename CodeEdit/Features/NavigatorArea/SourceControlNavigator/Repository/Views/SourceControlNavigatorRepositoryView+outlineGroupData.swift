...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "source-control-navigator.branches", defaultValue: "Branches", comment: "Source control navigator branches group label"),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "source-control-navigator.current-branch", defaultValue: "(current)", comment: "Indicator for current branch in source control navigator") : nil,
            ...
            .init(
                ...
                label: String(localized: "source-control-navigator.stashed-changes", defaultValue: "Stashed Changes", comment: "Source control navigator stashed changes group label"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "source-control-navigator.remotes", defaultValue: "Remotes", comment: "Source control navigator remotes group label"),
