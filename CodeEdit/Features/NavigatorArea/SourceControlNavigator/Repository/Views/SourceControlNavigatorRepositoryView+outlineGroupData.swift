...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "source-control.navigator.branches", defaultValue: "Branches", comment: "Source control navigator branches section"),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "source-control.navigator.current-branch", defaultValue: "(current)", comment: "Label for current branch") : nil,
            ...
            .init(
                ...
                label: String(localized: "source-control.navigator.stashed-changes", defaultValue: "Stashed Changes", comment: "Source control navigator stashed changes section"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "source-control.navigator.remotes", defaultValue: "Remotes", comment: "Source control navigator remotes section"),
