            ...
            .init(
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "source-control.navigator.current-branch", defaultValue: "(current)", comment: "Label indicating the current active branch") : nil,
