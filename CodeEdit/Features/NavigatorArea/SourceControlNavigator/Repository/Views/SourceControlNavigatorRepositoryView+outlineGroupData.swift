...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "navigator.source-control.branches", defaultValue: "Branches", comment: "Branches group label"),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "navigator.source-control.current-branch", defaultValue: "(current)", comment: "Current branch indicator") : nil,
            ...
            .init(
                ...
                label: String(localized: "navigator.source-control.stashed-changes", defaultValue: "Stashed Changes", comment: "Stashed changes group label"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "navigator.source-control.remotes", defaultValue: "Remotes", comment: "Remotes group label"),
