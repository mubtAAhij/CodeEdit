...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: "String(localized: "branches", comment: "Group label for branches in source control navigator")",
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? "String(localized: "current", comment: "Label indicating the currently active branch")" : nil,
            ...
            .init(
                ...
                label: "String(localized: "stashed_changes", comment: "Group label for stashed changes in source control navigator")",
            ...
            .init(
                id: "RemotesGroup",
                label: "String(localized: "remotes", comment: "Group label for remote repositories in source control navigator")",
