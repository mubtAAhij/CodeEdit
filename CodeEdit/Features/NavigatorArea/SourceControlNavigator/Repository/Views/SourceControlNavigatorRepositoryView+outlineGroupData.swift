...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "source_control.branches", comment: "Branches group"),
            ...
            .init(
                ...
                label: String(localized: "source_control.stashed_changes", comment: "Stashed changes group"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "source_control.remotes", comment: "Remotes group"),
