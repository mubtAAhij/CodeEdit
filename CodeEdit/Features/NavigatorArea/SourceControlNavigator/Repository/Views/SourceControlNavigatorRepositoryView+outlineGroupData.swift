...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "navigator.source-control.branches", defaultValue: "Branches", comment: "Branches group label in source control navigator"),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "navigator.source-control.current-branch-indicator", defaultValue: "(current)", comment: "Indicator showing current branch") : nil,
            ...
            .init(
                ...
                label: String(localized: "navigator.source-control.stashed-changes", defaultValue: "Stashed Changes", comment: "Stashed changes group label in source control navigator"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "navigator.source-control.remotes", defaultValue: "Remotes", comment: "Remotes group label in source control navigator"),
