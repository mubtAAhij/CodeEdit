...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "source-control.branches", defaultValue: "Branches", comment: "Branches section header"),
            ...
            .init(
                ...
                label: String(localized: "source-control.stashed-changes", defaultValue: "Stashed Changes", comment: "Stashed changes section header"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "source-control.remotes", defaultValue: "Remotes", comment: "Remotes section header"),
