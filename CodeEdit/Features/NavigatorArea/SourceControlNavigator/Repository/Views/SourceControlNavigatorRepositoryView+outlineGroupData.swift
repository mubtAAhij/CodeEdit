...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "source_control.outline.current", comment: "Label indicating current branch") : nil,
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "source_control.outline.remotes", comment: "Section header for remotes in source control navigator"),
