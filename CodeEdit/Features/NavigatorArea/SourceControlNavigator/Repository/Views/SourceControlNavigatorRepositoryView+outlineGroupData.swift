...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "branches", comment: "Source control navigator section header for branches"),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "current_branch_indicator", comment: "Indicator text for current active branch") : nil,
            ...
            .init(
                ...
                label: String(localized: "stashed_changes", comment: "Source control navigator section header for stashed changes"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "remotes", comment: "Source control navigator section header for remotes"),
