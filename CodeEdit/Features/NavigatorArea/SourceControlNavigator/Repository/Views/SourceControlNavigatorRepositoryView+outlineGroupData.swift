...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "source.control.repository.branches", defaultValue: "Branches", comment: "Label for branches group in source control"),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "source.control.repository.branch.current", defaultValue: "(current)", comment: "Indicator for current branch") : nil,
            ...
            .init(
                ...
                label: String(localized: "source.control.repository.stashed-changes", defaultValue: "Stashed Changes", comment: "Label for stashed changes group in source control"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "source.control.repository.remotes", defaultValue: "Remotes", comment: "Label for remotes group in source control"),
