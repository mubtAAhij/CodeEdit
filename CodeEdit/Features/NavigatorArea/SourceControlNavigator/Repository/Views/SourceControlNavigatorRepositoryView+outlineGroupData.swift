...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "source-control.repository.branches", defaultValue: "Branches", comment: "Branches section"),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "source-control.repository.current", defaultValue: "(current)", comment: "Current branch indicator") : nil,
            ...
            .init(
                ...
                label: String(localized: "source-control.repository.stashed-changes", defaultValue: "Stashed Changes", comment: "Stashed changes section"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "source-control.repository.remotes", defaultValue: "Remotes", comment: "Remotes section"),
