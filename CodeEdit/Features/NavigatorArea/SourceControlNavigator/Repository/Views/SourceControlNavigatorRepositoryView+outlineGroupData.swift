...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "current", comment: "Indicator that this is the current branch") : nil,
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "remotes", comment: "Source control navigator section header for remote repositories"),
