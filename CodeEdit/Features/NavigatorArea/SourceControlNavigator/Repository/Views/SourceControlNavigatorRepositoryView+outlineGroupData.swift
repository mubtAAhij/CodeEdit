    ...
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(
                    localized: "source-control.navigator.repository.branches",
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            description: branch == sourceControlManager.currentBranch ? String(
                                localized: "source-control.navigator.repository.current-branch-suffix",
                                defaultValue: "(current)",
                                comment: "Suffix shown next to the currently checked out branch"
                            ) : nil,
            ...
            .init(
                ...
                label: String(
                    localized: "source-control.navigator.repository.stashed-changes",
            ...
            .init(
                id: "RemotesGroup",
                label: String(
                    localized: "source-control.navigator.repository.remotes",
                    defaultValue: "Remotes",
                    comment: "Outline group title for git remotes"
                ),
