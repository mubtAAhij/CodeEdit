...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "source-control.branches", defaultValue: "Branches", comment: "Branches section label"),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "source-control.branch-current", defaultValue: "(current)", comment: "Indicator for current branch") : nil,
            ...
            .init(
                ...
                label: String(localized: "source-control.stashed-changes", defaultValue: "Stashed Changes", comment: "Stashed changes section label"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "source-control.remotes", defaultValue: "Remotes", comment: "Remotes section label"),
