...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "source-control.repository.branches", defaultValue: "Branches", comment: "Label for branches section in source control repository view"),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "source-control.repository.current-branch", defaultValue: "(current)", comment: "Indicator shown next to the currently checked out branch") : nil,
            ...
            .init(
                ...
                label: String(localized: "source-control.repository.stashed-changes", defaultValue: "Stashed Changes", comment: "Label for stashed changes section in source control repository view"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "source-control.repository.remotes", defaultValue: "Remotes", comment: "Label for remotes section in source control repository view"),
