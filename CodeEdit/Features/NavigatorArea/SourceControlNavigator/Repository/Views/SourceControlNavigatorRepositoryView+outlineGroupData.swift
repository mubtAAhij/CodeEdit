...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "source-control.repo.branches-label", defaultValue: "Branches", comment: "Label for branches section"),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "source-control.repo.current-branch", defaultValue: "(current)", comment: "Label for current branch") : nil,
            ...
            .init(
                ...
                label: String(localized: "source-control.repo.stashed-changes-label", defaultValue: "Stashed Changes", comment: "Label for stashed changes section"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "source-control.repo.remotes-label", defaultValue: "Remotes", comment: "Label for remotes section"),
