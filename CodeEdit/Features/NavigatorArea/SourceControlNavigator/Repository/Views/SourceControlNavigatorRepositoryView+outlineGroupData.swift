...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "source-control.branches", defaultValue: "Branches", comment: "Branches section title in source control navigator"),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "source-control.current-branch", defaultValue: "(current)", comment: "Label indicating the current branch") : nil,
            ...
            .init(
                ...
                label: String(localized: "source-control.stashed-changes", defaultValue: "Stashed Changes", comment: "Stashed changes section title"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "source-control.remotes", defaultValue: "Remotes", comment: "Remotes section title in source control navigator"),
