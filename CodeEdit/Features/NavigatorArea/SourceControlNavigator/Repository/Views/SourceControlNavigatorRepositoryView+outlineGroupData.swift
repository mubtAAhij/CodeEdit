...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "source_control.branches", defaultValue: "Branches", comment: "Label for branches section in source control navigator"),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "source_control.branch_current", defaultValue: "(current)", comment: "Label indicating the current branch") : nil,
            ...
            .init(
                ...
                label: String(localized: "source_control.stashed_changes", defaultValue: "Stashed Changes", comment: "Label for stashed changes section in source control navigator"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "source_control.remotes", defaultValue: "Remotes", comment: "Label for remotes section in source control navigator"),
