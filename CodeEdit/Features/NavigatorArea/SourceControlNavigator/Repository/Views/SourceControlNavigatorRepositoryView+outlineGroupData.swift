...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "branches", comment: "Section header for git branches"),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "current", comment: "Label indicating current branch") : nil,
            ...
            .init(
                ...
                label: String(localized: "stashed_changes", comment: "Section header for stashed changes"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "remotes", comment: "Section header for git remotes"),
