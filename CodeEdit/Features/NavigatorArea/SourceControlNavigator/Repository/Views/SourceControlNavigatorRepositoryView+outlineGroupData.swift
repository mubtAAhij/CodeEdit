...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "Branches", comment: "Section label"),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "(current)", comment: "Branch status") : nil,
            ...
            .init(
                ...
                label: String(localized: "Stashed Changes", comment: "Section label"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "Remotes", comment: "Section label"),
