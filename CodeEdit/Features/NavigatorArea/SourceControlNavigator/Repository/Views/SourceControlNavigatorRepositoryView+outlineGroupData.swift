...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "source-control-navigator.branches", defaultValue: "Branches", comment: "Label for branches group in source control navigator"),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "source-control-navigator.current-branch", defaultValue: "(current)", comment: "Description indicating current branch") : nil,
            ...
            .init(
                ...
                label: String(localized: "source-control-navigator.stashed-changes", defaultValue: "Stashed Changes", comment: "Label for stashed changes group in source control navigator"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "source-control-navigator.remotes", defaultValue: "Remotes", comment: "Label for remotes group in source control navigator"),
