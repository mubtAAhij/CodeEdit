...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "Branches"),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "(current)") : nil,
            ...
            .init(
                ...
                label: String(localized: "Stashed Changes"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "Remotes"),
