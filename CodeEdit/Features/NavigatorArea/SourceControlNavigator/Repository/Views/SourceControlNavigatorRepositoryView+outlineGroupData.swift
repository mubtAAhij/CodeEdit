...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "source-control.repository.branches", defaultValue: "Branches", comment: "Outline group title for repository branches."),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "source-control.repository.current-branch-indicator", defaultValue: "(current)", comment: "Suffix label indicating the currently checked out branch.") : nil,
            ...
            .init(
                ...
                label: String(localized: "source-control.repository.stashed-changes", defaultValue: "Stashed Changes", comment: "Outline group title for stashed changes."),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "source-control.repository.remotes", defaultValue: "Remotes", comment: "Outline group title for remote repositories."),
