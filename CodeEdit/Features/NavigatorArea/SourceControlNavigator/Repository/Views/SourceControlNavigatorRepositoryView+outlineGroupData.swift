...
extension SourceControlNavigatorRepositoryView {
    var outlineGroupData: [RepoOutlineGroupItem] {
        [
            .init(
                id: "BranchesGroup",
                label: String(localized: "navigator.source-control.repository.branches", defaultValue: "Branches", comment: "Section label for branches in repository view"),
                ...
                children: sourceControlManager.orderedLocalBranches.map { branch in
                        .init(
                            ...
                            label: branch.name,
                            description: branch == sourceControlManager.currentBranch ? String(localized: "navigator.source-control.repository.current-branch", defaultValue: "(current)", comment: "Label indicating the current branch") : nil,
            ...
            .init(
                ...
                label: String(localized: "navigator.source-control.repository.stashed-changes", defaultValue: "Stashed Changes", comment: "Section label for stashed changes in repository view"),
            ...
            .init(
                id: "RemotesGroup",
                label: String(localized: "navigator.source-control.repository.remotes", defaultValue: "Remotes", comment: "Section label for remotes in repository view"),
