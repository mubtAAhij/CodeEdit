    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            HStack {
                ...
                Text(String(localized: "navigator.source-control.commit-details", defaultValue: "Commit Details", comment: "Title for commit details view"))
            ...
            if let commit = commit {
                ...
                if !commitChanges.isEmpty {
                    ...
                    CEContentUnavailableView(String(localized: "navigator.source-control.commit.no-changes", defaultValue: "No Changes", comment: "Message shown when a commit has no changes"))
                }
            } else {
                Spacer()
            }
