    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            HStack {
                ...
                Text(String(localized: "source-control.commit-details", defaultValue: "Commit Details", comment: "Commit details view title"))
            ...
            if let commit = commit {
                ...
                if !commitChanges.isEmpty {
                    ...
                    CEContentUnavailableView(String(localized: "source-control.no-changes", defaultValue: "No Changes", comment: "Empty state when commit has no changes"))
                }
            } else {
                Spacer()
            }
