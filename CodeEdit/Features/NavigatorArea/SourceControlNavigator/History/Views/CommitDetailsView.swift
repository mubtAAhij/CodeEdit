    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            HStack {
                ...
                Text(String(localized: "commit_details", comment: "Title for commit details view"))
            ...
            if let commit = commit {
                ...
                if !commitChanges.isEmpty {
                    ...
                    CEContentUnavailableView(String(localized: "no_changes", comment: "Message displayed when a commit has no file changes"))
                }
            } else {
                Spacer()
            }
