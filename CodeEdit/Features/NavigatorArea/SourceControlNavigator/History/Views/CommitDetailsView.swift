    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            HStack {
                ...
                Text(String(localized: "commit-details.title", defaultValue: "Commit Details", comment: "Title for commit details view"))
            ...
            if let commit = commit {
                ...
                if !commitChanges.isEmpty {
                    ...
                    CEContentUnavailableView(String(localized: "source-control.changes.no-changes", defaultValue: "No Changes", comment: "Message when there are no source control changes"))
                }
            } else {
                Spacer()
            }
