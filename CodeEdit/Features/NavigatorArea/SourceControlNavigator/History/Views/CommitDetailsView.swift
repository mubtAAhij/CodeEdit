    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            HStack {
                ...
                Text(String(localized: "source-control.commit-details", defaultValue: "Commit Details", comment: "Accessibility label for commit details view"))
            ...
            if let commit = commit {
                ...
                if !commitChanges.isEmpty {
                    ...
                    CEContentUnavailableView(String(localized: "source-control.no-changes", defaultValue: "No Changes", comment: "Message when there are no changes"))
                }
            } else {
                Spacer()
            }
