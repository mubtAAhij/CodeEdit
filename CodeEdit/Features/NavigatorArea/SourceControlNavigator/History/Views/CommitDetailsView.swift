    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            HStack {
                ...
                Text(String(localized: "source-control.commit-details.title", defaultValue: "Commit Details", comment: "Commit details view title"))
            ...
            if let commit = commit {
                ...
                if !commitChanges.isEmpty {
                    ...
                    CEContentUnavailableView(String(localized: "source-control.commit-details.no-changes", defaultValue: "No Changes", comment: "Message when a commit has no changes"))
                }
            } else {
                Spacer()
            }
