        ...
        VStack(alignment: .leading, spacing: 0) {
            ...
            if let commit = commit {
                ...
                if !commitChanges.isEmpty {
                    ...
                    CEContentUnavailableView(String(localized: "navigator.source-control.no-changes", defaultValue: "No Changes", comment: "Message shown when commit has no changes"))
                }
            } else {
                Spacer()
            }
