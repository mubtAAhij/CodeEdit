    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            HStack {
                ...
                Text(String(localized: "commit.details.title", defaultValue: "Commit Details", comment: "Title for the commit details view"))
            ...
            if let commit = commit {
                ...
                if !commitChanges.isEmpty {
                    ...
                    CEContentUnavailableView(String(localized: "commit.details.no-changes", defaultValue: "No Changes", comment: "Message shown when a commit has no file changes"))
                }
            } else {
                Spacer()
            }
