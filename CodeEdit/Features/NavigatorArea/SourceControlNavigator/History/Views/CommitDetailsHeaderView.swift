...
struct CommitDetailsHeaderView: View {
    ...
    private func coAuthDetail() -> String {
        if commit.committerEmail == "noreply@github.com" {
            ...
            return String(format: String(localized: "sourcecontrol.commit.co-authored", defaultValue: "Co-authored by: %@\n<%@>", comment: "Co-authored by message"), commit.committer, commit.committerEmail)
        }
        return ""
    }
