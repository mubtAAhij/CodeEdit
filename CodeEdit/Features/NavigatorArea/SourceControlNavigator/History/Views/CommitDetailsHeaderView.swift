...
struct CommitDetailsHeaderView: View {
    ...
    private func coAuthDetail() -> String {
        if commit.committerEmail == "noreply@github.com" {
            ...
            return String(format: NSLocalizedString("navigator.source-control.commit.co-authored-by", comment: "Co-author information in commit details"), commit.committer, commit.committerEmail)
        }
        return ""
    }
