...
struct CommitDetailsHeaderView: View {
    ...
    private func coAuthDetail() -> String {
        if commit.committerEmail == "noreply@github.com" {
            ...
            return String(format: String(localized: "commit.co-authored", defaultValue: "Co-authored by: %@\n<%@>", comment: "Co-author details with name and email"), commit.committer, commit.committerEmail)
        }
        return ""
    }
