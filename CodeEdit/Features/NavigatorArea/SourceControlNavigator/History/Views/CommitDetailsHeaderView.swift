...
struct CommitDetailsHeaderView: View {
    ...
    private func coAuthDetail() -> String {
        if commit.committerEmail == "noreply@github.com" {
            ...
            return String(format: String(localized: "source-control.commit.co-authored-by", defaultValue: "Co-authored by: %@\n<%@>", comment: "Format for co-author information in commit details"), commit.committer, commit.committerEmail)
        }
        return ""
    }
