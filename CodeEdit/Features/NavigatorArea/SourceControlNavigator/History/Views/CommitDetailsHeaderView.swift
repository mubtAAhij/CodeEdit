...
struct CommitDetailsHeaderView: View {
    ...
    private func coAuthDetail() -> String {
        if commit.committerEmail == "noreply@github.com" {
            ...
            return String(localized: "navigator.source-control.commit.co-authored-by", defaultValue: "Co-authored by: \(commit.committer)\n<\(commit.committerEmail)>", comment: "Co-author information in commit details")
        }
        return ""
    }
