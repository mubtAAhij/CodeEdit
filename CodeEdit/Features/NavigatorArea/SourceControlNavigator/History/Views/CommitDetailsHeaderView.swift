...
struct CommitDetailsHeaderView: View {
    ...
    private func coAuthDetail() -> String {
        if commit.committerEmail == "noreply@github.com" {
            ...
            return String(format: String(localized: "source-control.commit-details.co-authored", defaultValue: "Co-authored by: %@\n<%@>", comment: "Co-author attribution format"), commit.committer, commit.committerEmail)
        }
        return ""
    }
