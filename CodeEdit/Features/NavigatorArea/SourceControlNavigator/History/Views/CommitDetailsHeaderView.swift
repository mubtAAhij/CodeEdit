...
struct CommitDetailsHeaderView: View {
    ...
    private func coAuthDetail() -> String {
        if commit.committerEmail == "noreply@github.com" {
            ...
            return String(localized: "source-control.commit.co-author", defaultValue: "Co-authored by: \(commit.committer)\n<\(commit.committerEmail)>", comment: "Co-author attribution in commit details")
        }
        return ""
    }
