    ...
    var body: some View {
        ...
        .contextMenu {
            Group {
                ...
                Button(String(localized: "email_author_ellipsis", comment: "Context menu item to email commit author")) {
            ...
            Group {
                Button(String(localized: "tag_commit_ellipsis", comment: "Context menu item to tag commit")) {}
                    .disabled(true) // TODO: Implementation Needed
                Button(String(localized: "new_branch_from_commit_ellipsis", comment: "Context menu item to create new branch from commit")) {}
                    .disabled(true) // TODO: Implementation Needed
                Button(String(localized: "cherry_pick_commit_ellipsis", comment: "Context menu item to cherry-pick commit")) {}
                    .disabled(true) // TODO: Implementation Needed
            }
            Group {
                Divider()
                if let commitRemoteURL = commit.commitBaseURL?.absoluteString {
                    Button(String(localized: "view_on_remote_ellipsis", comment: "Context menu item to view commit on remote")) {
                        let commitURL = "\(commitRemoteURL)/\(commit.commitHash)"
                        openCommit(URL(string: commitURL)!)
                    }
                    Divider()
                }
                Button(String(localized: "check_out_commit_ellipsis", comment: "Context menu item to check out commit")) {}
                    .disabled(true) // TODO: Implementation Needed
                Divider()
