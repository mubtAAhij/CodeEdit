        ...
        Group {
            ...
            case .ready:
                if commitHistory.isEmpty {
                    CEContentUnavailableView(String(localized: "source-control.history.no-history", defaultValue: "No History", comment: "Message shown when there is no commit history"))
                } else {
            ...
            case .error(let error):
                VStack {
                    ...
                    CEContentUnavailableView(
                        String(localized: "source-control.history.error-loading", defaultValue: "Error Loading History", comment: "Title shown when commit history fails to load"),
