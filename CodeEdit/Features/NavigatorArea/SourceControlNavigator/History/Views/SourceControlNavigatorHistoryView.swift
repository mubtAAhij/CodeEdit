        ...
        Group {
            ...
            case .loading:
                VStack {
                    Spacer()
                    ProgressView {
                        Text(String(localized: "navigator.source-control.loading-history", defaultValue: "Loading History", comment: "Message when loading commit history"))
                    }
                    Spacer()
                }
            case .ready:
                if commitHistory.isEmpty {
                    CEContentUnavailableView(String(localized: "navigator.source-control.no-history", defaultValue: "No History", comment: "Message when no commit history is available"))
                } else {
            ...
            case .error(let error):
                VStack {
                    ...
                    CEContentUnavailableView(
                        String(localized: "navigator.source-control.error-loading-history", defaultValue: "Error Loading History", comment: "Error message when loading commit history fails"),
                        ...
                        Button {
                            ...
                            Text(String(localized: "navigator.source-control.retry", defaultValue: "Retry", comment: "Retry button for loading commit history"))
                        }
                    }
                    Spacer()
                }
