        ...
        Group {
            ...
            case .loading:
                VStack {
                    Spacer()
                    ProgressView {
                        Text(String(localized: "loading_history", comment: "Progress message while loading commit history"))
                    }
                    Spacer()
                }
            case .ready:
                if commitHistory.isEmpty {
                    CEContentUnavailableView(String(localized: "no_history", comment: "Message when there is no commit history"))
                } else {
                ...
                VStack {
                    ...
                    CEContentUnavailableView(
                        ...
                        Button {
                            ...
                            Text(String(localized: "retry", comment: "Button to retry loading history"))
                        }
                    }
                    Spacer()
                }
