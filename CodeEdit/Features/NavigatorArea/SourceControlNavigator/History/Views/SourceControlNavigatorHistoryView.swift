        ...
        Group {
            ...
            case .loading:
                VStack {
                    Spacer()
                    ProgressView {
                        Text(String(localized: "source-control.loading-history", defaultValue: "Loading History", comment: "Loading history progress message"))
                    }
                    Spacer()
                }
            case .ready:
                if commitHistory.isEmpty {
                    CEContentUnavailableView(String(localized: "source-control.no-history", defaultValue: "No History", comment: "Message when no commit history available"))
                } else {
                ...
                VStack {
                    ...
                    CEContentUnavailableView(
                        ...
                        Button {
                            ...
                            Text(String(localized: "source-control.retry", defaultValue: "Retry", comment: "Retry button label"))
                        }
                    }
                    Spacer()
                }
