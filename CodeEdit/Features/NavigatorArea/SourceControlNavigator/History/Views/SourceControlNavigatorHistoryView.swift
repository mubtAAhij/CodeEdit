        ...
        Group {
            ...
            case .loading:
                VStack {
                    Spacer()
                    ProgressView {
                        Text(String(localized: "navigator.source-control.history.loading", defaultValue: "Loading History", comment: "Progress message when loading commit history"))
                    }
                    Spacer()
                }
            case .ready:
                if commitHistory.isEmpty {
                    CEContentUnavailableView(String(localized: "navigator.source-control.history.no-history", defaultValue: "No History", comment: "Message when there is no commit history"))
                } else {
            ...
            case .error(let error):
                VStack {
                    ...
                    CEContentUnavailableView(
                        String(localized: "navigator.source-control.history.error", defaultValue: "Error Loading History", comment: "Error title when loading commit history fails"),
                        ...
                        Button {
                            ...
                            Text(String(localized: "navigator.source-control.history.retry", defaultValue: "Retry", comment: "Button to retry loading commit history"))
                        }
                    }
                    Spacer()
                }
