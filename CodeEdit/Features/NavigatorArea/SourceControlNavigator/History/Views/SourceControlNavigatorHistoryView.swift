            ...
            case .error(let error):
                VStack {
                    ...
                    CEContentUnavailableView(
                        String(localized: "source_control.history.error_loading", comment: "Error message when failing to load git commit history"),
                        ...
                        Button {
                            ...
                            Text(String(localized: "source_control.history.retry", comment: "Button to retry loading git commit history"))
                        }
                    }
                    Spacer()
                }
