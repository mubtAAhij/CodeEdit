        ...
        Group {
            ...
            case .loading:
                VStack {
                    Spacer()
                    ProgressView {
                        Text(String(localized: "source-control.history.loading", defaultValue: "Loading History", comment: "Loading message for commit history"))
                    }
                    Spacer()
                }
            case .ready:
            ...
            case .error(let error):
                VStack {
                    ...
                    CEContentUnavailableView(
                        String(localized: "source-control.history.error", defaultValue: "Error Loading History", comment: "Error message when loading commit history fails"),
