        ...
        Group {
            ...
            case .loading:
                VStack {
                    Spacer()
                    ProgressView {
                        Text(String(localized: "source-control.loading-history", defaultValue: "Loading History", comment: "Progress indicator for loading commit history"))
                    }
                    Spacer()
                }
            case .ready:
                if commitHistory.isEmpty {
                    CEContentUnavailableView(String(localized: "source-control.no-history", defaultValue: "No History", comment: "Message when there is no commit history"))
                } else {
            ...
            case .error(let error):
                VStack {
                    ...
                    CEContentUnavailableView(
                        String(localized: "source-control.error-loading-history", defaultValue: "Error Loading History", comment: "Error message when history fails to load"),
                        ...
                        Button {
                            ...
                            Text(String(localized: "source-control.retry", defaultValue: "Retry", comment: "Button to retry loading history"))
                        }
                    }
                    Spacer()
                }
