        ...
        Group {
            ...
            case .loading:
                VStack {
                    Spacer()
                    ProgressView {
                        Text(String(localized: "navigator.source-control.loading-history", defaultValue: "Loading History", comment: "Loading history progress message"))
                    }
                    Spacer()
                }
            case .ready:
                if commitHistory.isEmpty {
                    CEContentUnavailableView(String(localized: "navigator.source-control.no-history", defaultValue: "No History", comment: "No history available"))
                } else {
            ...
            case .error(let error):
                VStack {
                    ...
                    CEContentUnavailableView(
                        String(localized: "navigator.source-control.error-loading-history", defaultValue: "Error Loading History", comment: "Error loading history title"),
                        ...
                        Button {
                            ...
                            Text(String(localized: "navigator.source-control.retry", defaultValue: "Retry", comment: "Retry button"))
                        }
                    }
                    Spacer()
                }
