        ...
        Group {
            ...
            case .loading:
                VStack {
                    Spacer()
                    ProgressView {
                        CEContentUnavailableView(String(localized: "source-control.history.loading", defaultValue: "Loading History", comment: "Loading history message"))
                    }
                    Spacer()
                }
            case .ready:
                if commitHistory.isEmpty {
                    CEContentUnavailableView(String(localized: "source-control.history.no-history", defaultValue: "No History", comment: "No history message"))
                } else {
            ...
            case .error(let error):
                VStack {
                    ...
                    CEContentUnavailableView(
                        String(localized: "source-control.history.error", defaultValue: "Error Loading History", comment: "Error loading history"),
                        ...
                        Button {
                            ...
                            Text(String(localized: "source-control.history.retry", defaultValue: "Retry", comment: "Retry button"))
                        }
                    }
                    Spacer()
                }
