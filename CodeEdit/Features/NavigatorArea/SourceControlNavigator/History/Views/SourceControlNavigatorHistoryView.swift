        ...
        Group {
            ...
            case .loading:
                VStack {
                    Spacer()
                    ProgressView {
                        Text(String(localized: "sourcecontrol.history.loading", defaultValue: "Loading History", comment: "Loading history progress message"))
                    }
                    Spacer()
                }
            case .ready:
                if commitHistory.isEmpty {
                    CEContentUnavailableView(String(localized: "sourcecontrol.history.empty", defaultValue: "No History", comment: "Empty history state message"))
                } else {
            ...
            case .error(let error):
                VStack {
                    ...
                    CEContentUnavailableView(
                        String(localized: "sourcecontrol.history.error", defaultValue: "Error Loading History", comment: "Error loading history message"),
                        ...
                        Button {
                            ...
                            Text(String(localized: "sourcecontrol.history.retry", defaultValue: "Retry", comment: "Retry button"))
                        }
                    }
                    Spacer()
                }
