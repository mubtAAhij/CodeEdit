        ...
        Group {
            ...
            case .ready:
                if commitHistory.isEmpty {
                    CEContentUnavailableView(String(localized: "source-control.history.no-history", defaultValue: "No History", comment: "Message when commit history is empty"))
                } else {
                ...
                VStack {
                    ...
                    CEContentUnavailableView(
                        ...
                        Button {
                            ...
                            Text(String(localized: "source-control.history.retry", defaultValue: "Retry", comment: "Retry button for loading commit history"))
                        }
                    }
                    Spacer()
                }
