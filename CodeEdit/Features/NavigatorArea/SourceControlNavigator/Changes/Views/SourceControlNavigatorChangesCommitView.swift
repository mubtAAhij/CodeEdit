        ...
        VStack(spacing: 0) {
            VStack(spacing: 0) {
                ...
                HStack(spacing: 8) {
                    ...
                    Menu(isCommiting ? String(localized: "source-control.committing", defaultValue: "Committing...", comment: "Label when commit is in progress") : String(localized: "source-control.commit", defaultValue: "Commit", comment: "Button to commit changes")) {
