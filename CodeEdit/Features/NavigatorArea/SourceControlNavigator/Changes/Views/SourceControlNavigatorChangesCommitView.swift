        ...
        VStack(spacing: 0) {
            VStack(spacing: 0) {
                ...
                VStack(spacing: 0) {
                    if showDetails {
                        Toggle(isOn: $ammend) {
                            Text(String(localized: "source-control.amend", defaultValue: "Amend", comment: "Toggle label for amend commit option"))
                ...
                HStack(spacing: 8) {
                    ...
                    Menu(isCommiting ? String(localized: "source-control.committing", defaultValue: "Committing...", comment: "Status message when commit is in progress") : String(localized: "source-control.commit", defaultValue: "Commit", comment: "Button to commit changes")) {
                            ...
                            Task {
                                ...
                                do {
                                    ...
                                    await sourceControlManager.showAlertForError(
                                        title: String(localized: "source-control.failed-to-commit", defaultValue: "Failed to commit", comment: "Error message when commit fails"),
                                        error: error
                                    )
                                }
                                do {
                                    ...
                                    await sourceControlManager.showAlertForError(title: String(localized: "source-control.failed-to-push", defaultValue: "Failed to push", comment: "Error message when push fails"), error: error)
                                }
                        ...
                        Task {
                            ...
                            do {
                                ...
                                await sourceControlManager.showAlertForError(title: String(localized: "source-control.failed-to-commit", defaultValue: "Failed to commit", comment: "Error message when commit fails"), error: error)
                            }
                            self.isCommiting = false
                        }
                    }
