...
struct SourceControlNavigatorChangesCommitView: View {
    ...
    private func stageAll() async {
        do {
            ...
            sourceControlManager.logger.error(String(format: String(localized: "source-control.failed-to-stage-all", defaultValue: "Failed to stage all files: %@", comment: "Failed to stage all files log"), String(describing: error)))
        }
    }
    ...
    private func resetAll() async {
        do {
            ...
            sourceControlManager.logger.error(String(format: String(localized: "source-control.failed-to-reset-all", defaultValue: "Failed to reset all files: %@", comment: "Failed to reset all files log"), String(describing: error)))
        }
    }
}
