...
struct SourceControlNavigatorChangesCommitView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            VStack(spacing: 0) {
                PaneTextField(
                    String(localized: "source-control.commit-message", defaultValue: "Commit message (required)", comment: "Placeholder for commit message text field"),
                    text: $message,
                    axis: .vertical
                )
                .lineLimit(1...3)
                ...
                HStack(spacing: 8) {
                    ...
                    Menu(isCommiting ? String(localized: "source-control.committing", defaultValue: "Committing...", comment: "Menu title when commit is in progress") : String(localized: "source-control.commit", defaultValue: "Commit", comment: "Menu title for commit action")) {
