                ...
                if currentBranch.upstream == nil {
                    Label(title: {
                        Text(String(format: String(
                            ...
                            comment: "Warning text when current branch has no tracked remote branch"
                ...
                if sourceControlManager.numberOfUnsyncedCommits.behind > 0 {
                    Button {
                        ...
                        Text(String(
                            ...
                            defaultValue: "Pull...",
                            comment: "Menu action title to pull remote changes"
                        ))
                    }
                    .disabled(isLoading)
                    ...
                    Button {
                        ...
                        Text(String(
                            ...
                            defaultValue: "Push...",
                            comment: "Menu action title to push local changes"
                        ))
                    }
                    .disabled(isLoading)
                }
    ...
    func formatUnsyncedlabel(ahead: Int?, behind: Int?) -> String {
        ...
        if let ahead = ahead, ahead > 0 {
            parts.append(String(format: String(
                ...
                comment: "Status text showing number of commits ahead of remote"
            ), ahead))
        }
        ...
        if let behind = behind, behind > 0 {
            parts.append(String(format: String(
                ...
                comment: "Status text showing number of commits behind remote"
            ), behind))
        }
