    ...
    var body: some View {
        VStack(alignment: .center, spacing: 0) {
            ...
            if hasChanges {
                ...
                CEContentUnavailableView(String(localized: "navigator.source-control.changes.empty", defaultValue: "No Changes", comment: "Empty state message when no source control changes"))
            }
        }
