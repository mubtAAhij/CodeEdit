    ...
    var body: some View {
        VStack(alignment: .center, spacing: 0) {
            ...
            if hasChanges {
                ...
                CEContentUnavailableView(String(localized: "source-control.changes.no-changes", defaultValue: "No Changes", comment: "Message shown when there are no uncommitted changes"))
            }
        }
