            ...
            menu: { selectedFiles in
                if selectedFiles.count == 1,
                   let file = selectedFiles.first {
                    ...
                    Group {
                        Button(String(localized: "source-control.open-in-new-tab", defaultValue: "Open in New Tab", comment: "Menu item to open file in new tab")) {
                            openGitFile(file)
                        }
                        Button(String(localized: "source-control.open-in-new-window", defaultValue: "Open in New Window", comment: "Menu item to open file in new window")) {}
                            .disabled(true) // TODO: Implementation Needed
                    }
