                ...
                if selectedFiles.count == 1,
                   let file = selectedFiles.first {
                    Group {
                        ...
                        Button(String(localized: "context-menu.reveal-in-navigator", defaultValue: "Reveal in Project Navigator", comment: "Context menu item to reveal file in project navigator")) {}
                    ...
                    if file.anyStatus() != .none {
                        Group {
                            Divider()
                            Button(String(localized: "source-control.discard-changes-in-file", defaultValue: "Discard Changes in \(file.fileURL.lastPathComponent)...", comment: "Context menu item to discard changes in a specific file")) {
