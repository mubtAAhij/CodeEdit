                ...
                if selectedFiles.count == 1,
                   let file = selectedFiles.first {
                    ...
                    if file.anyStatus() != .none {
                        Group {
                            Divider()
                            Button(String(format: String(localized: "source-control.discard-changes", defaultValue: "Discard Changes in %@...", comment: "Menu item to discard changes in file"), file.fileURL.lastPathComponent)) {
