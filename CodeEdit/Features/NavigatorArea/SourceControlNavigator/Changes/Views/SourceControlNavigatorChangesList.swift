            ...
            menu: { selectedFiles in
                if selectedFiles.count == 1,
                   let file = selectedFiles.first {
                    Group {
                        Button(String(
                            localized: "source-control.navigator.changes.view-in-finder",
                        ...
                        Button(String(
                            localized: "source-control.navigator.changes.reveal-in-project-navigator",
                    ...
                    Group {
                        Button(String(
                            localized: "source-control.navigator.changes.open-in-new-tab",
                        ...
                        Button(String(
                            localized: "source-control.navigator.changes.open-in-new-window",
                    ...
                    if file.anyStatus() != .none {
                        Group {
                            ...
                            Button(String(format: String(
                                localized: "source-control.navigator.changes.discard-changes-in-file",
