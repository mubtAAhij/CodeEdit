...
extension ProjectNavigatorViewController: NSOutlineViewDataSource {
    ...
    func replaceFileDialog(fileName: String) -> Bool {
        ...
        """
        alert.informativeText = String(localized: "project_navigator.irreversible_warning", comment: "Warning that file replacement is irreversible")
        alert.alertStyle = .warning
        alert.addButton(withTitle: String(localized: "project_navigator.replace_button", comment: "Button to replace existing file"))
        alert.addButton(withTitle: String(localized: "project_navigator.cancel_button", comment: "Button to cancel file replacement"))
