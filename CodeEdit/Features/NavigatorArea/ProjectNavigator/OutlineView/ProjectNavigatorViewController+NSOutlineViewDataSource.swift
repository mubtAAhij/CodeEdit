...
extension ProjectNavigatorViewController: NSOutlineViewDataSource {
    ...
    func replaceFileDialog(fileName: String) -> Bool {
        ...
        alert.addButton(withTitle: String(localized: "project-navigator.replace", defaultValue: "Replace", comment: "Replace button in file conflict dialog"))
        alert.addButton(withTitle: String(localized: "project-navigator.cancel", defaultValue: "Cancel", comment: "Cancel button in file conflict dialog"))
