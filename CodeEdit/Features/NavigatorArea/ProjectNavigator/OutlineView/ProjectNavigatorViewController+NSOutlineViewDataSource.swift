...
extension ProjectNavigatorViewController: NSOutlineViewDataSource {
    ...
    func replaceFileDialog(fileName: String) -> Bool {
        ...
        """
        alert.informativeText = String(localized: "action_irreversible", comment: "Warning message in file replacement dialog")
        alert.alertStyle = .warning
        alert.addButton(withTitle: String(localized: "replace", comment: "Button to confirm file replacement"))
        alert.addButton(withTitle: String(localized: "cancel", comment: "Button to cancel file replacement"))
