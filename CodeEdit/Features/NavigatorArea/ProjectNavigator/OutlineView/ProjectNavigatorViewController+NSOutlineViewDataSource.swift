...
extension ProjectNavigatorViewController: NSOutlineViewDataSource {
    ...
    func replaceFileDialog(fileName: String) -> Bool {
        ...
        """
        alert.informativeText = String(localized: "action_irreversible_warning", comment: "Warning text indicating action cannot be undone")
        alert.alertStyle = .warning
        alert.addButton(withTitle: String(localized: "replace", comment: "Button title to replace existing file"))
        alert.addButton(withTitle: String(localized: "cancel", comment: "Button title to cancel operation"))
