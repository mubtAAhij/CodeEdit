...
extension ProjectNavigatorViewController: NSOutlineViewDataSource {
    ...
    func replaceFileDialog(fileName: String) -> Bool {
        let alert = NSAlert()
        alert.messageText = String(localized: "dialog.replace_file_message \(fileName)", comment: "Replace file dialog message")
        alert.informativeText = String(localized: "dialog.replace_file_warning", comment: "Replace file warning")
