...
extension ProjectNavigatorViewController: NSOutlineViewDataSource {
    ...
    func replaceFileDialog(fileName: String) -> Bool {
        ...
        alert.messageText = String(
            localized: "project-navigator.replace-file.message",
            defaultValue: "A file or folder with the name \(name) already exists in the destination folder. Do you want to replace it?",
            comment: "Alert message asking if user wants to replace existing file"
        )
        alert.informativeText = String(
            localized: "project-navigator.replace-file.warning",
            defaultValue: "This action is irreversible!",
            comment: "Warning that file replacement cannot be undone"
        )
        alert.alertStyle = .warning
        alert.addButton(withTitle: String(
            localized: "project-navigator.replace-file.replace-button",
            defaultValue: "Replace",
            comment: "Button to confirm file replacement"
        ))
        alert.addButton(withTitle: String(
            localized: "project-navigator.replace-file.cancel-button",
            defaultValue: "Cancel",
            comment: "Button to cancel file replacement"
        ))
