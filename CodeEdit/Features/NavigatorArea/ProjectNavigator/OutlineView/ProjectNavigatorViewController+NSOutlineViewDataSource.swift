...
extension ProjectNavigatorViewController: NSOutlineViewDataSource {
    ...
    func replaceFileDialog(fileName: String) -> Bool {
        let alert = NSAlert()
        alert.messageText = String(format: String(localized: "project-navigator.replace.message", defaultValue: "A file or folder with the name %@ already exists in the destination folder. Do you want to replace it?", comment: "Replace file dialog message"), fileName)
        alert.informativeText = String(localized: "project-navigator.replace.warning", defaultValue: "This action is irreversible!", comment: "Replace file warning")
        alert.alertStyle = .warning
        alert.addButton(withTitle: String(localized: "button.replace", defaultValue: "Replace", comment: "Replace button"))
