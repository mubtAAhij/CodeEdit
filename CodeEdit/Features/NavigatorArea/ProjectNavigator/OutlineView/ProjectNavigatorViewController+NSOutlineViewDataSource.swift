...
extension ProjectNavigatorViewController: NSOutlineViewDataSource {
    ...
    func replaceFileDialog(fileName: String) -> Bool {
        ...
        alert.messageText = String(
            format: String(localized: "projectnavigator.replace.message", defaultValue: "A file or folder with the name %@ already exists in the destination folder. Do you want to replace it?", comment: "Replace file confirmation message"),
            fileName
        )
        alert.informativeText = String(localized: "projectnavigator.replace.warning", defaultValue: "This action is irreversible!", comment: "Replace file warning")
