...
extension ProjectNavigatorViewController: NSOutlineViewDataSource {
    ...
    func replaceFileDialog(fileName: String) -> Bool {
        ...
        alert.messageText = String(
            localized: "navigator.project.replace-file.message",
            defaultValue: "A file or folder with the name \(fileName) already exists in the destination folder. Do you want to replace it?",
            comment: "Message asking to confirm file replacement"
        )
        alert.informativeText = String(localized: "navigator.project.replace-file.warning", defaultValue: "This action is irreversible!", comment: "Warning that file replacement is irreversible")
        alert.alertStyle = .warning
        alert.addButton(withTitle: String(localized: "navigator.project.replace-file.replace", defaultValue: "Replace", comment: "Replace button in file replacement dialog"))
        alert.addButton(withTitle: String(localized: "navigator.project.replace-file.cancel", defaultValue: "Cancel", comment: "Cancel button in file replacement dialog"))
