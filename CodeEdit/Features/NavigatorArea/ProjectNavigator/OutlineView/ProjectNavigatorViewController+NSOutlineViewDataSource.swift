...
extension ProjectNavigatorViewController: NSOutlineViewDataSource {
    ...
    func replaceFileDialog(fileName: String) -> Bool {
        ...
        """
        alert.informativeText = String(localized: "action_irreversible_warning", comment: "Warning text indicating the action cannot be undone")
        alert.alertStyle = .warning
        alert.addButton(withTitle: String(localized: "replace_button", comment: "Button text to replace existing file"))
        alert.addButton(withTitle: String(localized: "cancel_button", comment: "Button text to cancel the action"))
