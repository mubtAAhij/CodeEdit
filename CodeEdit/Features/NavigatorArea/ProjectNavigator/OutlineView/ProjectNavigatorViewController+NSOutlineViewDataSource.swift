...
extension ProjectNavigatorViewController: NSOutlineViewDataSource {
    ...
    func replaceFileDialog(fileName: String) -> Bool {
        ...
        alert.messageText = String(
            format: String(
                localized: "project-navigator.replace-file-dialog.message",
                defaultValue: "A file or folder with the name %@ already exists in the destination folder. Do you want to replace it?",
                comment: "Alert message when file already exists"
            ),
            fileName
        )
        alert.informativeText = String(localized: "project-navigator.replace-file-dialog.warning", defaultValue: "This action is irreversible!", comment: "Warning that file replacement cannot be undone")
        alert.alertStyle = .warning
        alert.addButton(withTitle: String(localized: "project-navigator.replace-file-dialog.replace", defaultValue: "Replace", comment: "Button to replace existing file"))
        alert.addButton(withTitle: String(localized: "project-navigator.replace-file-dialog.cancel", defaultValue: "Cancel", comment: "Button to cancel file replacement"))
