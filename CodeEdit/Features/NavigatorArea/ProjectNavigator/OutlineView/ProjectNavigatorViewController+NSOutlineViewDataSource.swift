...
extension ProjectNavigatorViewController: NSOutlineViewDataSource {
    ...
    func replaceFileDialog(fileName: String) -> Bool {
        let alert = NSAlert()
        alert.messageText = String(format: String(localized: "project-navigator.replace-file-message", defaultValue: "A file or folder with the name %@ already exists in the destination folder. Do you want to replace it?", comment: "Message asking to replace existing file"), fileName)
        alert.informativeText = String(localized: "project-navigator.irreversible-warning", defaultValue: "This action is irreversible!", comment: "Warning about irreversible action")
        alert.alertStyle = .warning
        alert.addButton(withTitle: String(localized: "project-navigator.replace", defaultValue: "Replace", comment: "Replace button"))
        alert.addButton(withTitle: String(localized: "project-navigator.cancel", defaultValue: "Cancel", comment: "Cancel button"))
