...
extension ProjectNavigatorViewController: NSOutlineViewDataSource {
    ...
    func replaceFileDialog(fileName: String) -> Bool {
        ...
        alert.messageText = String(
            localized: "projectNavigator.replaceFileMessage",
            comment: "Dialog message",
            arguments: fileName
        )
        alert.informativeText = String(localized: "projectNavigator.actionIrreversible", comment: "Warning message")
        alert.alertStyle = .warning
        alert.addButton(withTitle: String(localized: "projectNavigator.replace", comment: "Button text"))
        alert.addButton(withTitle: String(localized: "projectNavigator.cancel", comment: "Button text"))
