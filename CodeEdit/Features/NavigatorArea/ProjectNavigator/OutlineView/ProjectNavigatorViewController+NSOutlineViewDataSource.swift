...
extension ProjectNavigatorViewController: NSOutlineViewDataSource {
    ...
    func replaceFileDialog(fileName: String) -> Bool {
        ...
        alert.informativeText = String(localized: "project-navigator.replace-file.warning", defaultValue: "This action is irreversible!", comment: "Warning that replace action cannot be undone")
