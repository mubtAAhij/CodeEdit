...
final class ProjectNavigatorMenu: NSMenu {
    ...
    private func sourceControlMenu(item: CEWorkspaceFile) -> NSMenu {
        ...
        sourceControlMenu.addItem(
            withTitle: String(format: String(localized: "project-navigator.menu.source-control.commit", defaultValue: "Commit \"%@\"...", comment: "Commit file menu item"), String(describing: item.fileName())),
            action: nil,
            keyEquivalent: ""
        )
        ...
        sourceControlMenu.addItem(.separator())
        sourceControlMenu.addItem(withTitle: String(localized: "project-navigator.menu.source-control.add-selected-files", defaultValue: "Add Selected Files", comment: "Add Selected Files menu item"), action: nil, keyEquivalent: "")
...
extension NSMenuItem {
    fileprivate static func none() -> NSMenuItem {
        let item = NSMenuItem(title: String(localized: "project-navigator.menu.open-as.none", defaultValue: "<None>", comment: "None option for Open As menu"), action: nil, keyEquivalent: "")
