...
final class ProjectNavigatorMenu: NSMenu {
    ...
    private func setupMenu() { // swiftlint:disable:this function_body_length
        ...
        let openExternalEditor = menuItem(String(localized: "project-navigator.menu.open-external-editor", defaultValue: "Open with External Editor", comment: "Open with External Editor menu item"), action: #selector(openWithExternalEditor))
        let openAs = menuItem(String(localized: "project-navigator.menu.open-as", defaultValue: "Open As", comment: "Open As menu item"), action: nil)
        ...
        let duplicate = menuItem(
            item.isFolder
                ? String(localized: "project-navigator.menu.duplicate-folder", defaultValue: "Duplicate Folder", comment: "Duplicate Folder menu item")
                : String(localized: "project-navigator.menu.duplicate-file", defaultValue: "Duplicate File", comment: "Duplicate File menu item"),
        ...
        let sourceControl = menuItem(String(localized: "project-navigator.menu.source-control", defaultValue: "Source Control", comment: "Source Control menu item"), action: nil)
    ...
    private func openAsMenu(item: CEWorkspaceFile) -> NSMenu {
        ...
        func getMenusItems() -> ([NSMenuItem], [NSMenuItem]) {
            ...
            if type.conforms(to: UTType(filenameExtension: "xcassets")!) {
                primaryItems.append(NSMenuItem(title: String(localized: "project-navigator.open-as.asset-catalog", defaultValue: "Asset Catalog Document", comment: "Asset Catalog Document open as option"), action: nil, keyEquivalent: ""))
            }
            if type.conforms(to: UTType(filenameExtension: "xib")!) {
                primaryItems.append(NSMenuItem(title: String(localized: "project-navigator.open-as.xib-document", defaultValue: "Interface Builder XIB Document", comment: "Interface Builder XIB Document open as option"), action: nil, keyEquivalent: ""))
            }
            if type.conforms(to: UTType(filenameExtension: "xcodeproj")!) {
                primaryItems.append(NSMenuItem(title: String(localized: "project-navigator.open-as.xcode-project", defaultValue: "Xcode Project", comment: "Xcode Project open as option"), action: nil, keyEquivalent: ""))
            }
    ...
    private func sourceControlMenu(item: CEWorkspaceFile) -> NSMenu {
        ...
        sourceControlMenu.addItem(
            withTitle: String(format: String(localized: "project-navigator.source-control.commit-file", defaultValue: "Commit \"%@\"...", comment: "Commit file menu item with filename"), String(describing: item.fileName())),
            action: nil,
            keyEquivalent: ""
        )
        sourceControlMenu.addItem(.separator())
        sourceControlMenu.addItem(withTitle: String(localized: "project-navigator.source-control.discard-changes", defaultValue: "Discard Changes...", comment: "Discard Changes menu item"), action: nil, keyEquivalent: "")
        sourceControlMenu.addItem(.separator())
        sourceControlMenu.addItem(withTitle: String(localized: "project-navigator.source-control.add-selected-files", defaultValue: "Add Selected Files", comment: "Add Selected Files menu item"), action: nil, keyEquivalent: "")
        sourceControlMenu.addItem(withTitle: String(localized: "project-navigator.source-control.mark-resolved", defaultValue: "Mark Selected Files as Resolved", comment: "Mark Selected Files as Resolved menu item"), action: nil, keyEquivalent: "")
...
extension NSMenuItem {
    fileprivate static func none() -> NSMenuItem {
        let item = NSMenuItem(title: String(localized: "project-navigator.open-as.none", defaultValue: "<None>", comment: "None option in open as menu"), action: nil, keyEquivalent: "")
        item.isEnabled = false
        return item
    }

    fileprivate static func sourceCode() -> NSMenuItem {
        NSMenuItem(title: String(localized: "project-navigator.open-as.source-code", defaultValue: "Source Code", comment: "Source Code open as option"), action: nil, keyEquivalent: "")
    }

    fileprivate static func propertyList() -> NSMenuItem {
        NSMenuItem(title: String(localized: "project-navigator.open-as.property-list", defaultValue: "Property List", comment: "Property List open as option"), action: nil, keyEquivalent: "")
    }

    fileprivate static func asciiPropertyList() -> NSMenuItem {
        NSMenuItem(title: String(localized: "project-navigator.open-as.ascii-property-list", defaultValue: "ASCII Property List", comment: "ASCII Property List open as option"), action: nil, keyEquivalent: "")
    }

    fileprivate static func hex() -> NSMenuItem {
        NSMenuItem(title: String(localized: "project-navigator.open-as.hex", defaultValue: "Hex", comment: "Hex open as option"), action: nil, keyEquivalent: "")
    }

    fileprivate static func quickLook() -> NSMenuItem {
        NSMenuItem(title: String(localized: "project-navigator.open-as.quick-look", defaultValue: "Quick Look", comment: "Quick Look open as option"), action: nil, keyEquivalent: "")
    }
}
