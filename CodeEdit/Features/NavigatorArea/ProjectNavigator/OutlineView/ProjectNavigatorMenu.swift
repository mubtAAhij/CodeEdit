...
final class ProjectNavigatorMenu: NSMenu {
    ...
    private func setupMenu() { // swiftlint:disable:this function_body_length
        ...
        let duplicate = menuItem(String(format: String(localized: "project-navigator.duplicate-item", defaultValue: "Duplicate %@", comment: "Duplicate Folder/File menu item"), item.isFolder ? String(localized: "project-navigator.folder", defaultValue: "Folder", comment: "Folder label") : String(localized: "project-navigator.file", defaultValue: "File", comment: "File label")), action: #selector(duplicate))
    ...
    private func openAsMenu(item: CEWorkspaceFile) -> NSMenu {
        ...
        func getMenusItems() -> ([NSMenuItem], [NSMenuItem]) {
            ...
            if type.conforms(to: UTType(filenameExtension: "xib")!) {
                primaryItems.append(NSMenuItem(title: String(localized: "project-navigator.interface-builder-xib", defaultValue: "Interface Builder XIB Document", comment: "Interface Builder XIB Document menu item"), action: nil, keyEquivalent: ""))
            }
