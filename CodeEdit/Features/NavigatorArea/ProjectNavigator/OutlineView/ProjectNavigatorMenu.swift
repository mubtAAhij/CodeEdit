...
final class ProjectNavigatorMenu: NSMenu {
    ...
    private func openAsMenu(item: CEWorkspaceFile) -> NSMenu {
        let openAsMenu = NSMenu(title: String(localized: "project-navigator-menu.open-as", defaultValue: "Open As", comment: "Open as menu item"))
        func getMenusItems() -> ([NSMenuItem], [NSMenuItem]) {
            ...
            if type.conforms(to: UTType(filenameExtension: "xib")!) {
                primaryItems.append(NSMenuItem(title: String(localized: "project-navigator-menu.interface-builder-xib-document", defaultValue: "Interface Builder XIB Document", comment: "Interface builder XIB document menu item"), action: nil, keyEquivalent: ""))
            }
    ...
    private func sourceControlMenu(item: CEWorkspaceFile) -> NSMenu {
        let sourceControlMenu = NSMenu(title: String(localized: "project-navigator-menu.source-control", defaultValue: "Source Control", comment: "Source control menu item"))
        ...
        sourceControlMenu.addItem(withTitle: String(localized: "project-navigator-menu.mark-selected-files-resolved", defaultValue: "Mark Selected Files as Resolved", comment: "Mark selected files as resolved menu item"), action: nil, keyEquivalent: "")
