    ...
    private func openAsMenu(item: CEWorkspaceFile) -> NSMenu {
        ...
        func getMenusItems() -> ([NSMenuItem], [NSMenuItem]) {
            ...
            if type.conforms(to: UTType(filenameExtension: "xcassets")!) {
                primaryItems.append(NSMenuItem(title: String(localized: "project-navigator-menu.asset-catalog-document", defaultValue: "Asset Catalog Document", comment: "Open as asset catalog document"), action: nil, keyEquivalent: ""))
            }
            if type.conforms(to: UTType(filenameExtension: "xib")!) {
                primaryItems.append(NSMenuItem(title: String(localized: "project-navigator-menu.interface-builder-xib", defaultValue: "Interface Builder XIB Document", comment: "Open as Interface Builder XIB document"), action: nil, keyEquivalent: ""))
            }
            if type.conforms(to: UTType(filenameExtension: "xcodeproj")!) {
                primaryItems.append(NSMenuItem(title: String(localized: "project-navigator-menu.xcode-project", defaultValue: "Xcode Project", comment: "Open as Xcode project"), action: nil, keyEquivalent: ""))
            }
...
extension NSMenuItem {
    fileprivate static func none() -> NSMenuItem {
        let item = NSMenuItem(title: String(localized: "project-navigator-menu.none", defaultValue: "<None>", comment: "Menu item for none option"), action: nil, keyEquivalent: "")
        item.isEnabled = false
        return item
    }

    fileprivate static func sourceCode() -> NSMenuItem {
        NSMenuItem(title: String(localized: "project-navigator-menu.source-code", defaultValue: "Source Code", comment: "Open as source code"), action: nil, keyEquivalent: "")
    }

    fileprivate static func propertyList() -> NSMenuItem {
        NSMenuItem(title: String(localized: "project-navigator-menu.property-list", defaultValue: "Property List", comment: "Open as property list"), action: nil, keyEquivalent: "")
    }

    fileprivate static func asciiPropertyList() -> NSMenuItem {
        NSMenuItem(title: String(localized: "project-navigator-menu.ascii-property-list", defaultValue: "ASCII Property List", comment: "Open as ASCII property list"), action: nil, keyEquivalent: "")
    }

    fileprivate static func hex() -> NSMenuItem {
        NSMenuItem(title: String(localized: "project-navigator-menu.hex", defaultValue: "Hex", comment: "Open as hex"), action: nil, keyEquivalent: "")
    }

    fileprivate static func quickLook() -> NSMenuItem {
        NSMenuItem(title: String(localized: "project-navigator-menu.quick-look", defaultValue: "Quick Look", comment: "Open with Quick Look"), action: nil, keyEquivalent: "")
    }
}
