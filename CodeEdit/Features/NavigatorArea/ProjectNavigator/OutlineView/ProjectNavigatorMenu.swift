...
final class ProjectNavigatorMenu: NSMenu {
    ...
    private func setupMenu() { // swiftlint:disable:this function_body_length
        ...
        let openExternalEditor = menuItem(String(localized: "project-navigator.menu.open-external-editor", defaultValue: "Open with External Editor", comment: "Menu item to open file with external editor"), action: #selector(openWithExternalEditor))
        ...
        let duplicate = menuItem(
            item.isFolder
                ? String(localized: "project-navigator.menu.duplicate-folder", defaultValue: "Duplicate Folder", comment: "Menu item to duplicate a folder")
                : String(localized: "project-navigator.menu.duplicate-file", defaultValue: "Duplicate File", comment: "Menu item to duplicate a file"),
    ...
    private func openAsMenu(item: CEWorkspaceFile) -> NSMenu {
        ...
        func getMenusItems() -> ([NSMenuItem], [NSMenuItem]) {
            ...
            if type.conforms(to: UTType(filenameExtension: "xib")!) {
                primaryItems.append(NSMenuItem(title: String(localized: "project-navigator.menu.open-as.xib", defaultValue: "Interface Builder XIB Document", comment: "Menu item to open file as Interface Builder XIB document"), action: nil, keyEquivalent: ""))
            }
    ...
    private func sourceControlMenu(item: CEWorkspaceFile) -> NSMenu {
        ...
        sourceControlMenu.addItem(
            withTitle: String(format: String(localized: "project-navigator.menu.source-control.commit", defaultValue: "Commit \"%@\"...", comment: "Menu item to commit a specific file"), String(describing: item.fileName())),
            action: nil,
            keyEquivalent: ""
        )
...
extension NSMenuItem {
    fileprivate static func none() -> NSMenuItem {
        let item = NSMenuItem(title: String(localized: "project-navigator.menu.open-as.none", defaultValue: "<None>", comment: "Menu item indicating no suitable open-as option"), action: nil, keyEquivalent: "")
    ...
    fileprivate static func quickLook() -> NSMenuItem {
        NSMenuItem(title: String(localized: "project-navigator.menu.open-as.quick-look", defaultValue: "Quick Look", comment: "Menu item to open file with Quick Look"), action: nil, keyEquivalent: "")
    }
}
