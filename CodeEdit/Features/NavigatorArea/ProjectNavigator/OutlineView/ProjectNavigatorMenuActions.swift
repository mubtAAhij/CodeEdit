...
extension ProjectNavigatorMenu {
    ...
    func newFile() {
        ...
        do {
            ...
            alert.addButton(withTitle: String(localized: "project-navigator.menu-actions.dismiss", defaultValue: "Dismiss", comment: "Dismiss button title for project navigator menu action alert"))
            alert.runModal()
        }
    }
