...
extension ProjectNavigatorMenu {
    ...
    func newFile() {
        ...
        do {
            ...
            alert.addButton(withTitle: String(
                localized: "project-navigator.menu-actions.dismiss.alert-1",
                defaultValue: "Dismiss",
                comment: "Dismiss button title for project navigator menu action alert"
            ))
            alert.runModal()
        }
    }
    ...
    func newFileFromClipboard() {
        ...
        do {
            ...
            let alert = NSAlert(error: error)
            alert.addButton(withTitle: String(
                localized: "project-navigator.menu-actions.dismiss.alert-2",
                defaultValue: "Dismiss",
                comment: "Dismiss button title for project navigator menu action alert"
            ))
            alert.runModal()
    ...
    func newFolder() {
        ...
        do {
            ...
            let alert = NSAlert(error: error)
            alert.addButton(withTitle: String(
                localized: "project-navigator.menu-actions.dismiss.alert-3",
                defaultValue: "Dismiss",
                comment: "Dismiss button title for project navigator menu action alert"
            ))
            alert.runModal()
    ...
    func newFolderFromSelection() {
        ...
        do {
            ...
            let alert = NSAlert(error: error)
            alert.addButton(withTitle: String(
                localized: "project-navigator.menu-actions.dismiss.alert-4",
                defaultValue: "Dismiss",
                comment: "Dismiss button title for project navigator menu action alert"
            ))
            alert.runModal()
    ...
    func trash() {
        do {
            ...
            let alert = NSAlert(error: error)
            alert.addButton(withTitle: String(
                localized: "project-navigator.menu-actions.dismiss.alert-5",
                defaultValue: "Dismiss",
                comment: "Dismiss button title for project navigator menu action alert"
            ))
            alert.runModal()
    ...
    func delete() {
        do {
            ...
            let alert = NSAlert(error: error)
            alert.addButton(withTitle: String(
                localized: "project-navigator.menu-actions.dismiss.alert-6",
                defaultValue: "Dismiss",
                comment: "Dismiss button title for project navigator menu action alert"
            ))
            alert.runModal()
    ...
    func duplicate() {
        do {
            ...
            let alert = NSAlert(error: error)
            alert.addButton(withTitle: String(
                localized: "project-navigator.menu-actions.dismiss.alert-7",
                defaultValue: "Dismiss",
                comment: "Dismiss button title for project navigator menu action alert"
            ))
            alert.runModal()
