...
final class ProjectNavigatorViewController: NSViewController {
    ...
    override func loadView() {
        ...
        self.outlineView.setAccessibilityLabel(String(localized: "navigator.project", defaultValue: "Project Navigator", comment: "Accessibility label for project navigator"))
        ...
        noResultsLabel = NSTextField(labelWithString: String(localized: "navigator.no-filter-results", defaultValue: "No Filter Results", comment: "Empty state label when filter returns no results"))
