...
final class ProjectNavigatorViewController: NSViewController {
    ...
    override func loadView() {
        ...
        self.outlineView.setAccessibilityLabel(String(localized: "Project Navigator", comment: "Accessibility label for project navigator"))
        ...
        noResultsLabel = NSTextField(labelWithString: String(localized: "No Filter Results", comment: "Message when project navigator filter returns no results"))
