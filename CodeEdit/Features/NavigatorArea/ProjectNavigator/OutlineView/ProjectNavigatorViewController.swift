...
final class ProjectNavigatorViewController: NSViewController {
    ...
    override func loadView() {
        ...
        self.outlineView.setAccessibilityLabel(
            String(localized: "navigator.project", comment: "Project navigator accessibility label")
        )
        ...
        noResultsLabel = NSTextField(
            labelWithString: String(localized: "navigator.no_filter_results", comment: "No filter results label")
        )
