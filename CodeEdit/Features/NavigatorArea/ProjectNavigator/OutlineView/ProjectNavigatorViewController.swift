...
final class ProjectNavigatorViewController: NSViewController {
    ...
    override func loadView() {
        ...
        self.outlineView.setAccessibilityLabel(String(localized: "project_navigator", comment: "Accessibility label for the project navigator"))
        ...
        noResultsLabel = NSTextField(labelWithString: String(localized: "no_filter_results", comment: "Label shown when filter returns no results"))
