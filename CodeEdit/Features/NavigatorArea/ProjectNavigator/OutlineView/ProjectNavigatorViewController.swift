...
final class ProjectNavigatorViewController: NSViewController {
    ...
    override func loadView() {
        ...
        self.outlineView.setAccessibilityLabel(String(localized: "navigator.project.title", defaultValue: "Project Navigator", comment: "Title of the project navigator panel"))
        ...
        noResultsLabel = NSTextField(labelWithString: String(localized: "navigator.project.no-filter-results", defaultValue: "No Filter Results", comment: "Empty state text when project navigator filter matches no items"))
