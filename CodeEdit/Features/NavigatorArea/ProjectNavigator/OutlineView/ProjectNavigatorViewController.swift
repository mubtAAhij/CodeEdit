...
final class ProjectNavigatorViewController: NSViewController {
    ...
    override func loadView() {
        ...
        self.outlineView.setAccessibilityLabel(String(localized: "project_navigator.title", comment: "Project Navigator view title"))
        ...
        /// String(localized: "project_navigator.no_filter_results", comment: "No results found for current filter") label.
