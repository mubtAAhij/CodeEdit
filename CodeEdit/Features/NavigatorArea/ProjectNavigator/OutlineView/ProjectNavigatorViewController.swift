...
final class ProjectNavigatorViewController: NSViewController {
    ...
    override func loadView() {
        ...
        self.outlineView.setAccessibilityLabel(String(localized: "project-navigator.title", defaultValue: "Project Navigator", comment: "Project navigator title"))
        ...
        noResultsLabel = NSTextField(labelWithString: String(localized: "project-navigator.no-results", defaultValue: "No Filter Results", comment: "Message when no filter results found"))
