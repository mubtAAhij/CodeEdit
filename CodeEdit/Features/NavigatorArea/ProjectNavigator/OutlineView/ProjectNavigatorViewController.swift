...
final class ProjectNavigatorViewController: NSViewController {
    ...
    override func loadView() {
        ...
        outlineView.setAccessibilityLabel(String(localized: "navigator.project.title", defaultValue: "Project Navigator", comment: "Title of the project navigator panel"))
