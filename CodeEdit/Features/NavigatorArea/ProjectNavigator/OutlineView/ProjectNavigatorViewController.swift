...
final class ProjectNavigatorViewController: NSViewController {
    ...
    override func loadView() {
        ...
        noResultsLabel = NSTextField(labelWithString: String(localized: "project-navigator.no-filter-results", defaultValue: "No Filter Results", comment: "Message when filter returns no results"))
