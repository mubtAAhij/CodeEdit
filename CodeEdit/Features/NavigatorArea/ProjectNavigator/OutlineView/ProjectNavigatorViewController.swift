...
final class ProjectNavigatorViewController: NSViewController {
    ...
    override func loadView() {
        ...
        self.outlineView.setAccessibilityLabel(String(localized: "navigator.project.label", defaultValue: "Project Navigator", comment: "Project Navigator accessibility label"))
        ...
        noResultsLabel = NSTextField(labelWithString: String(localized: "navigator.project.no-results", defaultValue: "No Filter Results", comment: "No filter results message"))
