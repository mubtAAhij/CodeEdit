...
final class ProjectNavigatorViewController: NSViewController {
    ...
    override func loadView() {
        ...
        noResultsLabel = NSTextField(labelWithString: String(localized: "navigator.project.no-filter-results", defaultValue: "No Filter Results", comment: "Message shown when filter returns no results"))
