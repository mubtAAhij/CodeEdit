...
final class ProjectNavigatorViewController: NSViewController {
    ...
    override func loadView() {
        ...
        self.outlineView.setAccessibilityLabel(String(localized: "navigator.project.accessibility-label", defaultValue: "Project Navigator", comment: "Accessibility label for project navigator outline view"))
        ...
        noResultsLabel = NSTextField(labelWithString: String(localized: "navigator.project.no-filter-results", defaultValue: "No Filter Results", comment: "Label shown when project navigator filter returns no results"))
