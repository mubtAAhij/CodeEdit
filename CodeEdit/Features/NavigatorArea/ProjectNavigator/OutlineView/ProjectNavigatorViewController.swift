...
final class ProjectNavigatorViewController: NSViewController {
    ...
    override func loadView() {
        ...
        self.outlineView.setAccessibilityLabel(String(localized: "accessibility.project-navigator", defaultValue: "Project Navigator", comment: "Accessibility label for project navigator outline view"))
        ...
        noResultsLabel = NSTextField(labelWithString: String(localized: "project-navigator.no-filter-results", defaultValue: "No Filter Results", comment: "Message when no files match the filter in project navigator"))
