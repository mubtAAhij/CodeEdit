...
final class ProjectNavigatorViewController: NSViewController {
    ...
    override func loadView() {
        ...
        noResultsLabel = NSTextField(labelWithString: String(localized: "project-navigator.no-results", defaultValue: "No Filter Results", comment: "Empty state for filtered project navigator"))
