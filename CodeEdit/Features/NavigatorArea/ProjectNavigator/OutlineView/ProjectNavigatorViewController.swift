...
final class ProjectNavigatorViewController: NSViewController {
    ...
    override func loadView() {
        ...
        self.outlineView.setAccessibilityLabel(String(localized: "project.navigator.label", defaultValue: "Project Navigator", comment: "Accessibility label for project navigator"))
        ...
        noResultsLabel = NSTextField(labelWithString: String(localized: "project.navigator.no.filter.results", defaultValue: "No Filter Results", comment: "Message when project navigator filter has no results"))
