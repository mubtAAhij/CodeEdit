...
final class ProjectNavigatorViewController: NSViewController {
    ...
    override func loadView() {
        ...
        self.outlineView.setAccessibilityLabel(String(localized: "navigator.project.label", defaultValue: "Project Navigator", comment: "Accessibility label for the project navigator"))
        ...
        noResultsLabel = NSTextField(labelWithString: String(localized: "navigator.project.no-filter-results", defaultValue: "No Filter Results", comment: "Message shown when no files match the filter criteria"))
