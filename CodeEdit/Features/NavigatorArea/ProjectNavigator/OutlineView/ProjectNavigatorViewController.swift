...
final class ProjectNavigatorViewController: NSViewController {
    ...
    override func loadView() {
        ...
        self.outlineView.setAccessibilityLabel(String(localized: "project-navigator.title", defaultValue: "Project Navigator", comment: "Title of the project navigator pane"))
        ...
        noResultsLabel = NSTextField(labelWithString: String(localized: "project-navigator.no-filter-results", defaultValue: "No Filter Results", comment: "Empty state title when project navigator filter returns no results"))
