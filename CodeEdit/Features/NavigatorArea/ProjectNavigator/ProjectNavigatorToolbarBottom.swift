...
struct ProjectNavigatorToolbarBottom: View {
        ...
        HStack(spacing: 5) {
            ...
            PaneTextField(
                ...
                leadingAccessories: {
                    ...
                    .help(String(localized: "show_files_matching_name", comment: "Help text for filter button"))
                },
                trailingAccessories: {
                    HStack(spacing: 0) {
                        ...
                        .help(String(localized: "show_only_recent_files", comment: "Help text for recent files filter button"))
    ...
    private var addNewFileButton: some View {
        Menu {
            ...
            Button("String(localized: "add_folder", comment: "Button text to add a new folder")") {
                let filePathURL = activeTabURL()
                guard let rootFile = workspace.workspaceFileManager?.getFile(filePathURL.path) else { return }
                do {
