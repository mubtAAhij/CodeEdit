        ...
        HStack(spacing: 5) {
            ...
            PaneTextField(
                ...
                leadingAccessories: {
                    ...
                    .help(String(localized: "show_files_matching_name", comment: "Tooltip for filter dropdown button"))
                },
                trailingAccessories: {
                    HStack(spacing: 0) {
                        ...
                        .help(String(localized: "show_recent_files", comment: "Tooltip for recent files filter button"))
                        Toggle(isOn: $workspace.sourceControlFilter) {
                            Image(systemName: "plusminus.circle")
                        }
                        .help(String(localized: "show_source_control_files", comment: "Tooltip for source control status filter button"))
                    }
