        ...
        HStack(spacing: 5) {
            ...
            PaneTextField(
                String(
                    ...
                    defaultValue: "Filter",
                    comment: "Label for project navigator filter menu"
                ),
                ...
                leadingAccessories: {
                    FilterDropDownIconButton(menu: {
                        ForEach([(true, String(
                            ...
                            comment: "Sort option to keep folders listed before files"
                        )), (false, String(
                            localized: "project-navigator.toolbar-bottom.sort.alphabetically",
                            defaultValue: "Alphabetically",
                            comment: "Sort option to order items alphabetically"
                        ))], id: \.0) { value, title in
                    ...
                    .help(String(
                        ...
                        comment: "Filter option to display only files matching the search name"
                    ))
                },
                trailingAccessories: {
                    HStack(spacing: 0) {
                        ...
                        .help(String(
                            ...
                            comment: "Filter option to display only recently opened files"
                        ))
                        ...
                        .help(String(
                            ...
                            comment: "Filter option to display only files that have source control status"
                        ))
                    }
    ...
    private var addNewFileButton: some View {
        Menu {
            Button(String(
                ...
                comment: "Menu action to add a new file from project navigator toolbar"
            )) {
                ...
                do {
                    ...
                    alert.addButton(withTitle: String(
                        localized: "project-navigator.toolbar-bottom.dismiss",
                        defaultValue: "Dismiss",
                        comment: "Button title to dismiss add file sheet"
                    ))
                    alert.runModal()
                }
            }
            ...
            Button(String(
                ...
                comment: "Menu action to add a new folder from project navigator toolbar"
            )) {
                let filePathURL = activeTabURL()
                guard let rootFile = workspace.workspaceFileManager?.getFile(filePathURL.path) else { return }
                do {
                    ...
                    alert.addButton(withTitle: String(
                        localized: "project-navigator.toolbar-bottom.dismiss",
                        defaultValue: "Dismiss",
                        comment: "Button title to dismiss add folder sheet"
                    ))
                    alert.runModal()
                }
            }
        ...
        .accessibilityLabel(String(
            ...
            comment: "Toolbar menu action to add either a folder or a file"
        ))
