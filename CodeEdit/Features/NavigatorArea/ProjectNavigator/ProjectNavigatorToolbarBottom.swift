            ...
            PaneTextField(
                ...
                trailingAccessories: {
                    HStack(spacing: 0) {
                        ...
                        .help(String(localized: "project-navigator.recent-files-help", defaultValue: "Show only recent files", comment: "Recent files filter help text"))
                        Toggle(isOn: $workspace.sourceControlFilter) {
                            Image(systemName: "plusminus.circle")
                        }
                        .help(String(localized: "project-navigator.source-control-help", defaultValue: "Show only files with source-control status", comment: "Source control filter help text"))
                    }
            ...
            Button(String(localized: "project-navigator.add-file", defaultValue: "Add File", comment: "Add file menu item")) {
                ...
                do {
                    if let newFile = try workspace.workspaceFileManager?.addFile(
                        fileName: String(localized: "project-navigator.untitled", defaultValue: "untitled", comment: "Default name for new file"),
                        toFile: rootFile
                    ) {
            ...
            Button(String(localized: "project-navigator.add-folder", defaultValue: "Add Folder", comment: "Add folder menu item")) {
                ...
                do {
                    if let newFolder = try workspace.workspaceFileManager?.addFolder(
                        folderName: String(localized: "project-navigator.untitled", defaultValue: "untitled", comment: "Default name for new file"),
                        toFile: rootFile
                    ) {
