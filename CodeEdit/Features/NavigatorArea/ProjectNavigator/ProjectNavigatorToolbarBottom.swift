            ...
            PaneTextField(
                ...
                leadingAccessories: {
                    FilterDropDownIconButton(menu: {
                        ForEach([(true, String(localized: "project-navigator.folders-on-top", defaultValue: "Folders on top", comment: "Sort option to show folders first")), (false, String(localized: "project-navigator.alphabetically", defaultValue: "Alphabetically", comment: "Sort option to show items alphabetically"))], id: \.0) { value, title in
                    ...
                    .help(String(localized: "project-navigator.show-matching-files", defaultValue: "Show files with matching name", comment: "Help text for filter dropdown"))
                },
                trailingAccessories: {
                    HStack(spacing: 0) {
                        ...
                        .help(String(localized: "project-navigator.show-recent-files", defaultValue: "Show only recent files", comment: "Help text for recent files filter toggle"))
                        Toggle(isOn: $workspace.sourceControlFilter) {
                            Image(systemName: "plusminus.circle")
                        }
                        .help(String(localized: "project-navigator.show-source-control-files", defaultValue: "Show only files with source-control status", comment: "Help text for source control filter toggle"))
                    }
