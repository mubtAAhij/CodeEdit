    ...
    var body: some View {
        VStack(alignment: .leading) {
            HStack {
                ...
                Form {
                    Section(String(localized: "extensions.detail.features", defaultValue: "Features", comment: "Section title for extension features")) {
            ...
            Text(String(localized: "extensions.detail.settings", defaultValue: "Extension Settings", comment: "Section title for extension settings"))
                .font(.title3)
                .fontWeight(.semibold)
                .padding(.leading)
