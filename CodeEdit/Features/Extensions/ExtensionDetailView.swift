    ...
    var body: some View {
        VStack(alignment: .leading) {
            HStack {
                ...
                Form {
                    Section(String(localized: "extensions.detail.features", defaultValue: "Features", comment: "Section title listing extension features")) {
            ...
            Text(String(localized: "extensions.detail.extension-settings", defaultValue: "Extension Settings", comment: "Section title for extension settings"))
                ...
                .fontWeight(.semibold)
                .padding(.leading)
            ExtensionSceneView(with: ext.endpoint, sceneID: String(localized: "extensions.detail.settings-button", defaultValue: "Settings", comment: "Button title to open extension settings"))
                .padding(.top, -5)
