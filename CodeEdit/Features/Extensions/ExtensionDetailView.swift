    ...
    var body: some View {
        VStack(alignment: .leading) {
            HStack {
                ...
                Form {
                    Section(String(localized: "extensions.features", comment: "Features section title in extension detail view")) {
            ...
            Text(String(localized: "extensions.settings", comment: "Extension settings section title"))
                .font(.title3)
                .fontWeight(.semibold)
                .padding(.leading)
