    ...
    var body: some View {
        VStack(alignment: .leading) {
            HStack {
                ...
                Form {
                    Section(String(localized: "extension_detail.features", comment: "Section header for extension features")) {
            ...
            Text(String(localized: "extension_detail.settings", comment: "Header for extension settings section"))
                .font(.title3)
                .fontWeight(.semibold)
                .padding(.leading)
