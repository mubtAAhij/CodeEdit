    ...
    var body: some View {
        VStack(alignment: .leading) {
            HStack {
                ...
                Form {
                    Section(String(localized: "extensions.features", comment: "Section header for extension features")) {
            ...
            Text(String(localized: "extensions.settings", comment: "Section header for extension settings"))
                .font(.title3)
                .fontWeight(.semibold)
                .padding(.leading)
