    ...
    var body: some View {
        VStack(alignment: .leading) {
            HStack {
                ...
                Form {
                    Section(String(
                        ...
                        comment: "Section header for extension capabilities in extension detail view"
                    )) {
            ...
            Text(String(
                ...
                comment: "Section header for extension settings in extension detail view"
            ))
                .font(.title3)
                .fontWeight(.semibold)
                .padding(.leading)
            ExtensionSceneView(with: ext.endpoint, sceneID: String(
                localized: "extensions.detail.settings.button",
                defaultValue: "Settings",
                comment: "Button title to open extension-specific settings"
            ))
                .padding(.top, -5)
