    ...
    var body: some View {
        VStack(alignment: .leading) {
            HStack {
                ...
                Form {
                    Section(String(localized: "extension.features", defaultValue: "Features", comment: "Extension features section")) {
            ...
            Text(String(localized: "extension.settings.title", defaultValue: "Extension Settings", comment: "Extension settings section title"))
                .font(.title3)
                .fontWeight(.semibold)
                .padding(.leading)
