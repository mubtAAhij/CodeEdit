...
struct ContributorsView: View {
    ...
    var body: some View {
        AboutDetailView(title: String(localized: "about.contributors.title", defaultValue: "Contributors", comment: "Title of the contributors section in the About window")) {
