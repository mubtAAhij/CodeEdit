...
struct AcknowledgementsView: View {
    ...
    var body: some View {
        AboutDetailView(title: String(localized: "about.acknowledgements.title", defaultValue: "Acknowledgements", comment: "Title for the acknowledgements section in the About window")) {
