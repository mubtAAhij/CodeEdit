...
struct AcknowledgementsView: View {
    ...
    var body: some View {
        AboutDetailView(title: String(localized: "about.acknowledgements.title", defaultValue: "Acknowledgements", comment: "User-visible window/view title for acknowledgements")) {
