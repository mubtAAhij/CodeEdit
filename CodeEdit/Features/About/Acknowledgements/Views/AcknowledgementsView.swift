...
struct AcknowledgementsView: View {
    ...
    var body: some View {
        AboutDetailView(title: String(localized: "about.acknowledgements.title", defaultValue: "Acknowledgements", comment: "Title of acknowledgements section in about area")) {
