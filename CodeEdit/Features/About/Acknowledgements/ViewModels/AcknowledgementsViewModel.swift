...
final class AcknowledgementsViewModel: ObservableObject {
    ...
    func fetchDependencies() {
        ...
        do {
            if let bundlePath = Bundle.main.path(forResource: String(localized: "acknowledgements.package-resolved.filename", defaultValue: "Package", comment: "Base filename for Swift package resolution file"), ofType: "resolved") {
