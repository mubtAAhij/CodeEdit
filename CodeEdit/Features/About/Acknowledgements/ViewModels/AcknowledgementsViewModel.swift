...
final class AcknowledgementsViewModel: ObservableObject {
    ...
    func fetchDependencies() {
        ...
        do {
            if let bundlePath = Bundle.main.path(forResource: String(localized: "about.package-file", defaultValue: "Package", comment: "Package resolved file name"), ofType: "resolved") {
