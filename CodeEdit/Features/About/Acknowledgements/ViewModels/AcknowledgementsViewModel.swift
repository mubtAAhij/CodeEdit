...
final class AcknowledgementsViewModel: ObservableObject {
    ...
    func fetchDependencies() {
        ...
        do {
            if let bundlePath = Bundle.main.path(forResource: String(localized: "acknowledgements.package", defaultValue: "Package", comment: "Package column header"), ofType: "resolved") {
