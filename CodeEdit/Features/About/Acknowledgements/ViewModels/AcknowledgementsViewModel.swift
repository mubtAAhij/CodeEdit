...
final class AcknowledgementsViewModel: ObservableObject {
    ...
    func fetchDependencies() {
        ...
        do {
            if let bundlePath = Bundle.main.path(forResource: String(localized: "acknowledgements.package-resource", defaultValue: "Package", comment: "Package resource file name"), ofType: "resolved") {
