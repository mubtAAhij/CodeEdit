...
final class AcknowledgementsViewModel: ObservableObject {
    ...
    func fetchDependencies() {
        ...
        do {
            if let bundlePath = Bundle.main.path(forResource: String(localized: "about.acknowledgements.package", defaultValue: "Package", comment: "Column title for package name in acknowledgements"), ofType: "resolved") {
