...
final class AcknowledgementsViewModel: ObservableObject {
    ...
    func fetchDependencies() {
        ...
        do {
            if let bundlePath = Bundle.main.path(forResource: String(localized: "about.package-resource", defaultValue: "Package", comment: "Package resolved file resource name"), ofType: "resolved") {
