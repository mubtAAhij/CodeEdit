...
struct AboutSubtitleView: View {
    ...
    var body: some View {
        Text(String(format: String(
            ...
            comment: "About subtitle line showing app version, postfix, and build number"
            ...
            .onTapGesture {
                ...
                NSPasteboard.general.setString(
                    String(format: String(
                        localized: "about.subtitle.copy-text",
                        defaultValue: "CodeEdit: %@ (%@)\nmacOS: %@",
                        comment: "Copied about details containing app version, build number, and macOS version"
