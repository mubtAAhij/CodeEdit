...
struct AboutSubtitleView: View {
    ...
    var body: some View {
        Text(String(localized: "version_format", comment: "Format string for app version display").replacingOccurrences(of: "%1$@", with: appVersion).replacingOccurrences(of: "%2$@", with: appVersionPostfix).replacingOccurrences(of: "%3$@", with: appBuild))
