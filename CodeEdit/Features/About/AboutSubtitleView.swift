...
struct AboutSubtitleView: View {
    ...
    private var appBuild: String { Bundle.buildString ?? String(localized: "about.subtitle.no-build", defaultValue: "No Build", comment: "Fallback text when app build is unavailable") }
