    ...
    private var appVersion: String {
        Bundle.versionString
            ?? String(
                ...
                comment: "Fallback app version text when version is unavailable"
            )
    }
    private var appBuild: String {
        Bundle.buildString
            ?? String(
                ...
                comment: "Fallback app build text when build number is unavailable"
            )
    }
        ...
        Text(
            String(
                format: String(
                    ...
                    comment: "About view subtitle showing app version, optional postfix, and build"
                ),
                appVersion,
                appVersionPostfix,
                appBuild
            ...
            .onTapGesture {
                ...
                NSPasteboard.general.setString(
                    String(
                        format: String(
                            localized: "about.subtitle.copy-version-info",
                            defaultValue: "CodeEdit: %@ (%@)\nmacOS: %@",
                            comment: "Copied About view text including app and macOS versions"
                        ),
                        appVersion,
                        appBuild,
                        macOSVersion
