    ...
    private var appVersion: String {
        Bundle.versionString
            ?? String(
                ...
                comment: "Fallback app version text when bundle version is unavailable"
            )
    }
    private var appBuild: String {
        Bundle.buildString
            ?? String(
                ...
                comment: "Fallback app build text when bundle build is unavailable"
            )
    }
        ...
        Text(
            String(
                format: String(
                    ...
                    comment: "About subtitle showing app version, optional postfix, and build"
                ),
                appVersion,
                appVersionPostfix,
                appBuild
            ...
            .onTapGesture {
                ...
                NSPasteboard.general.setString(
                    String(
                        format: String(
                            localized: "about.subtitle.copied-version-info",
                            defaultValue: "CodeEdit: %@ (%@)\nmacOS: %@",
                            comment: "Copied version details for bug reports including app and macOS versions"
                        ),
                        appVersion,
                        appBuild,
                        macOSVersion
