...
struct AboutSubtitleView: View {
    ...
    private var appVersion: String {
        ...
        ?? String(localized: "about.subtitle.no-version", defaultValue: "No Version", comment: "Fallback value when the app version is unavailable")
    }
    private var appBuild: String {
        Bundle.buildString
        ?? String(localized: "about.subtitle.no-build", defaultValue: "No Build", comment: "Fallback value when the app build number is unavailable")
    }
    ...
    var body: some View {
        Text(
            String(
                format: String(
                    localized: "about.subtitle.version",
                    defaultValue: "Version %@%@ (%@)",
                    comment: "About subtitle showing app version, optional postfix, and build number"
                ),
                appVersion,
                appVersionPostfix,
                appBuild
            ...
            .onTapGesture {
                ...
                NSPasteboard.general.setString(
                    String(
                        format: String(
                            localized: "about.subtitle.copy-details",
                            defaultValue: "CodeEdit: %@ (%@)\nmacOS: %@",
                            comment: "Copied version details including app version, build, and macOS version"
                        ),
                        appVersion,
                        appBuild,
                        macOSVersion
