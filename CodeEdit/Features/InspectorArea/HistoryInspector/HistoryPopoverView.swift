    ...
    var body: some View {
        VStack {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                ActionButton(
                    String(localized: "Show Commit", comment: "Button to show commit details"),
                    systemImage: "clock"
                ) {}
                    .disabled(true)
                // TODO: Implementation Needed
                ActionButton(
                    String(localized: "Open in Code Review", comment: "Button to open commit in code review"),
                    systemImage: "arrow.left.arrow.right"
                ) {}
                    .disabled(true)
                ActionButton(
                    String(localized: "Email \(commit.author)", comment: "Button to email commit author"),
