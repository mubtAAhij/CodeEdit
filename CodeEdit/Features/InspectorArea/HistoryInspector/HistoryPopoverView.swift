    ...
    var body: some View {
        VStack {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                ActionButton(String(localized: "show_commit", comment: "Button to show commit details"), systemImage: "clock") {}
                    .disabled(true)
                // TODO: Implementation Needed
                ActionButton(String(localized: "open_in_code_review", comment: "Button to open commit in code review"), systemImage: "arrow.left.arrow.right") {}
                    .disabled(true)
                ActionButton(String(localized: "email_author", comment: "Button to email commit author"), systemImage: "envelope") {
