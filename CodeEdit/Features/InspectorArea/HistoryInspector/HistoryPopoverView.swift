    ...
    var body: some View {
        VStack {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                ActionButton(String(
                    localized: "inspector.history.show-commit",
                    defaultValue: "Show Commit",
                    comment: "Menu action to show commit details"
                ), systemImage: "clock") {}
                    .disabled(true)
                // TODO: Implementation Needed
                ActionButton(String(
                    localized: "inspector.history.open-in-code-review",
                    defaultValue: "Open in Code Review",
                    comment: "Menu action to open commit in code review tool"
                ), systemImage: "arrow.left.arrow.right") {}
                    .disabled(true)
                ActionButton(String(format: String(
                    localized: "inspector.history.email-author",
                    defaultValue: "Email %@",
                    comment: "Menu action to email commit author"
