    ...
    var body: some View {
        VStack {
            ...
            VStack(alignment: .leading, spacing: 0) {
                ...
                ActionButton(
                    String(localized: "history.showCommit", comment: "Action button"),
                    systemImage: "clock"
                ) {}
                    .disabled(true)
                // TODO: Implementation Needed
                ActionButton(
                    String(localized: "history.openCodeReview", comment: "Action button"),
                    systemImage: "arrow.left.arrow.right"
                ) {}
                    .disabled(true)
                ActionButton(
                    String(localized: "history.emailAuthor", comment: "Action button", arguments: commit.author),
