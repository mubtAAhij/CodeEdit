...
enum InspectorTab: WorkspacePanelTab {
    ...
    var title: String {
        switch self {
        case .file:
            return String(localized: "file_inspector", comment: "File inspector tab title")
        case .gitHistory:
            return String(localized: "history_inspector", comment: "History inspector tab title")
        case .internalDevelopment:
            return String(localized: "internal_development", comment: "Internal development inspector tab title")
        case .uiExtension(_, let data):
