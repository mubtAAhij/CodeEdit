...
enum InspectorTab: WorkspacePanelTab {
    ...
    var title: String {
        switch self {
        case .file:
            return String(localized: "inspector-area.tab.file", defaultValue: "File Inspector", comment: "File Inspector tab title")
        case .gitHistory:
            return String(localized: "inspector-area.tab.history", defaultValue: "History Inspector", comment: "History Inspector tab title")
        case .internalDevelopment:
            return String(localized: "inspector-area.tab.internal-dev", defaultValue: "Internal Development", comment: "Internal Development tab title")
        case .uiExtension(_, let data):
