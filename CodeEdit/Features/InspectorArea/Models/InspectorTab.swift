...
enum InspectorTab: WorkspacePanelTab {
    ...
    var title: String {
        switch self {
        case .file:
            return String(localized: "inspector.tab.file", defaultValue: "File Inspector", comment: "Title for file inspector tab")
        case .gitHistory:
            return String(localized: "inspector.tab.history", defaultValue: "History Inspector", comment: "Title for history inspector tab")
        case .internalDevelopment:
