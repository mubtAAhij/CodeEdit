...
enum InspectorTab: WorkspacePanelTab {
    ...
    var title: String {
        switch self {
        case .file:
            return String(localized: "inspector.tab.file-inspector", defaultValue: "File Inspector", comment: "Title for file inspector tab")
        case .gitHistory:
            return String(localized: "inspector.tab.history-inspector", defaultValue: "History Inspector", comment: "Title for history inspector tab")
        case .internalDevelopment:
            return String(localized: "inspector.tab.internal-development", defaultValue: "Internal Development", comment: "Title for internal development inspector tab")
        case .uiExtension(_, let data):
