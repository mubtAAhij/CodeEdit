...
enum InspectorTab: WorkspacePanelTab {
    ...
    var title: String {
        switch self {
        case .file:
            return String(localized: "inspector.tab.file", defaultValue: "File Inspector", comment: "Title for the file inspector tab")
        case .gitHistory:
            return String(localized: "inspector.tab.history", defaultValue: "History Inspector", comment: "Title for the history inspector tab")
        case .internalDevelopment:
            return String(localized: "inspector.tab.internal-development", defaultValue: "Internal Development", comment: "Title for the internal development inspector tab")
        case .uiExtension(_, let data):
