...
enum InspectorTab: WorkspacePanelTab {
    ...
    var title: String {
        switch self {
        case .file:
            return String(localized: "inspector.tab.file", defaultValue: "File Inspector", comment: "File inspector tab")
        case .gitHistory:
            return String(localized: "inspector.tab.history", defaultValue: "History Inspector", comment: "History inspector tab")
        case .internalDevelopment:
            return String(localized: "inspector.tab.internal-dev", defaultValue: "Internal Development", comment: "Internal development tab")
        case .uiExtension(_, let data):
