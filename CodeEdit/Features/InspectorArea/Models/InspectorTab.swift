...
enum InspectorTab: WorkspacePanelTab {
    ...
    var title: String {
        switch self {
        case .file:
            return String(localized: "inspector.file.title", comment: "Title for file inspector tab")
        case .gitHistory:
            return String(localized: "inspector.history.title", comment: "Title for history inspector tab")
        case .internalDevelopment:
            return String(localized: "inspector.internal_development.title", comment: "Title for internal development inspector tab")
        case .uiExtension(_, let data):
