...
struct FileInspectorView: View {
    ...
    private var indentUsing: some View {
        Picker(String(localized: "file-inspector.indent-using", defaultValue: "Indent using", comment: "Label for indentation type picker"), selection: $indentOption.indentType) {
    ...
    private var widthOptions: some View {
        LabeledContent(String(localized: "file-inspector.widths", defaultValue: "Widths", comment: "Label for tab and indent width settings")) {
            HStack(spacing: 5) {
                ...
                .help(String(localized: "file-inspector.widths.tab.help", defaultValue: "The visual width of tab characters", comment: "Tooltip for tab width setting"))
                VStack(alignment: .center, spacing: 0) {
                    Stepper(
                        "",
                        value: Binding<Double>(
                ...
                .help(String(localized: "file-inspector.widths.indent.help", defaultValue: "The number of spaces to insert when the tab key is pressed.", comment: "Tooltip for indent width setting"))
            }
        }
    ...
    private func chooseNewFileLocation() -> URL? {
        ...
        dialogue.title = String(localized: "file-inspector.save-file", defaultValue: "Save File", comment: "Title for save panel")
