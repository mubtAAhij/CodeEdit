...
struct FileInspectorView: View {
    ...
    @ViewBuilder private var fileNameField: some View {
        if let file {
            TextField(String(localized: "file-inspector.name", defaultValue: "Name", comment: "Name text field"), text: $fileName)
                .background(
    ...
    @ViewBuilder private var fileType: some View {
        Picker(
            ...
            Text(String(localized: "file-inspector.default-detected", defaultValue: "Default - Detected", comment: "Default - Detected option")).tag(nil as CodeLanguage?)
            Divider()
        ...
        Group {
            if let file {
                LabeledContent(String(localized: "file-inspector.location", defaultValue: "Location", comment: "Location label")) {
                    Button(String(localized: "file-inspector.choose", defaultValue: "Choose...", comment: "Choose button")) {
        ...
        LabeledContent(String(localized: "file-inspector.widths", defaultValue: "Widths", comment: "Widths label")) {
            HStack(spacing: 5) {
                VStack(alignment: .center, spacing: 0) {
                    ...
                    .labelsHidden()
                    Text(String(localized: "file-inspector.tab", defaultValue: "Tab", comment: "Tab label"))
                ...
                VStack(alignment: .center, spacing: 0) {
                    ...
                    .labelsHidden()
                    Text(String(localized: "file-inspector.indent", defaultValue: "Indent", comment: "Indent label"))
                        .foregroundColor(.primary)
                        .font(.footnote)
                }
                .help(String(localized: "file-inspector.indent-help", defaultValue: "The number of spaces to insert when the tab key is pressed.", comment: "Indent help text"))
            }
        }
