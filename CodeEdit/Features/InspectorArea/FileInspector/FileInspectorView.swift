...
struct FileInspectorView: View {
    ...
    @ViewBuilder private var fileNameField: some View {
        if let file {
            TextField(String(localized: "file_inspector.name", comment: "Label for file name field"), text: $fileName)
                .background(
    ...
    private var indentUsing: some View {
        Picker(String(localized: "file_inspector.indent_using", comment: "Label for indent type picker"), selection: $indentOption.indentType) {
            Text(String(localized: "file_inspector.spaces", comment: "Option for indenting with spaces")).tag(SettingsData.TextEditingSettings.IndentOption.IndentType.spaces)
            Text(String(localized: "file_inspector.tabs", comment: "Option for indenting with tabs")).tag(SettingsData.TextEditingSettings.IndentOption.IndentType.tab)
        }
    ...
    private var widthOptions: some View {
        LabeledContent(String(localized: "file_inspector.widths", comment: "Label for tab and indent width settings")) {
            HStack(spacing: 5) {
                ...
                .help(String(localized: "file_inspector.indent_width_help", comment: "Help text for indent width setting"))
            }
        }
    ...
    private var wrapLinesToggle: some View {
        Toggle(String(localized: "file_inspector.wrap_lines", comment: "Label for line wrapping toggle"), isOn: $wrapLines)
