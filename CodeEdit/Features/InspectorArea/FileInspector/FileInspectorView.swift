...
struct FileInspectorView: View {
    ...
    var body: some View {
        Group {
            if file != nil {
                Form {
                    Section(String(localized: "file_inspector_identity_and_type", comment: "Section header for identity and type information in file inspector")) {
                        fileNameField
                        fileType
                    }
                    Section {
                    ...
                    Section(String(localized: "text_settings", comment: "Section header for text editing settings")) {
                        indentUsing
                        widthOptions
                        wrapLinesToggle
                    }
    ...
    @ViewBuilder private var fileType: some View {
        Picker(
            ...
            Text(String(localized: "default_detected", comment: "Auto-detected file type option")).tag(nil as CodeLanguage?)
            Divider()
    ...
    private var indentUsing: some View {
        Picker(String(localized: "indent_using", comment: "Picker label for indentation method"), selection: $indentOption.indentType) {
            Text(String(localized: "spaces", comment: "Indentation option using spaces")).tag(SettingsData.TextEditingSettings.IndentOption.IndentType.spaces)
            Text(String(localized: "tabs", comment: "Indentation option using tabs")).tag(SettingsData.TextEditingSettings.IndentOption.IndentType.tab)
        }
    ...
    private var wrapLinesToggle: some View {
        Toggle(String(localized: "wrap_lines", comment: "Toggle for line wrapping"), isOn: $wrapLines)
