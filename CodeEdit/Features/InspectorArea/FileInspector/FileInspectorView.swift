...
struct FileInspectorView: View {
    ...
    var body: some View {
        Group {
            if file != nil {
                Form {
                    Section(String(localized: "file-inspector.identity-and-type", defaultValue: "Identity and Type", comment: "Identity and type section title")) {
                        fileNameField
                        fileType
                    }
                    Section {
                    ...
                    Section(String(localized: "file-inspector.text-settings", defaultValue: "Text Settings", comment: "Text settings section title")) {
                        indentUsing
                        widthOptions
                        wrapLinesToggle
                    }
                    ...
                    Button(String(localized: "file-inspector.choose", defaultValue: "Choose...", comment: "Choose location button")) {
                        ...
                        DispatchQueue.main.async { [weak workspace] in
                            do {
                                ...
                                let alert = NSAlert(error: error)
                                alert.addButton(withTitle: String(localized: "file-inspector.dismiss-location", defaultValue: "Dismiss", comment: "Dismiss button for location error"))
                                alert.runModal()
                            }
                        }
                    }
