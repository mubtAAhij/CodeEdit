...
struct InternalDevelopmentOutputView: View {
    var body: some View {
        Section(String(localized: "inspector.internal.output", defaultValue: "Output Utility", comment: "Output utility tab")) {
            Button(String(localized: "inspector.internal.error-log", defaultValue: "Error Log", comment: "Error log tab")) {
                pushLog(.error)
            }
            Button(String(localized: "inspector.internal.warning-log", defaultValue: "Warning Log", comment: "Warning log tab")) {
                pushLog(.warning)
            }
            Button(String(localized: "inspector.internal.info-log", defaultValue: "Info Log", comment: "Info log tab")) {
                pushLog(.info)
            }
            Button(String(localized: "inspector.internal.debug-log", defaultValue: "Debug Log", comment: "Debug log tab")) {
                pushLog(.debug)
            }
        }
