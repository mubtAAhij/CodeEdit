...
struct InternalDevelopmentOutputView: View {
    var body: some View {
        Section(String(localized: "internal-dev.output-utility", defaultValue: "Output Utility", comment: "Section title for output utility in internal development inspector")) {
            Button(String(localized: "internal-dev.error-log", defaultValue: "Error Log", comment: "Button to push error log message")) {
                pushLog(.error)
            }
            Button(String(localized: "internal-dev.warning-log", defaultValue: "Warning Log", comment: "Button to push warning log message")) {
                pushLog(.warning)
            }
            Button(String(localized: "internal-dev.info-log", defaultValue: "Info Log", comment: "Button to push info log message")) {
                pushLog(.info)
            }
            Button(String(localized: "internal-dev.debug-log", defaultValue: "Debug Log", comment: "Button to push debug log message")) {
                pushLog(.debug)
            }
        }
