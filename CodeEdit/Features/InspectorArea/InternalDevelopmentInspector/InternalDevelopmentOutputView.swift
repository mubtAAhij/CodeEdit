...
struct InternalDevelopmentOutputView: View {
    var body: some View {
        Section(String(localized: "dev.output-utility", defaultValue: "Output Utility", comment: "Output utility section")) {
            Button(String(localized: "dev.error-log", defaultValue: "Error Log", comment: "Error log button")) {
                pushLog(.error)
            }
            Button(String(localized: "dev.warning-log", defaultValue: "Warning Log", comment: "Warning log button")) {
                pushLog(.warning)
            }
            Button(String(localized: "dev.info-log", defaultValue: "Info Log", comment: "Info log button")) {
                pushLog(.info)
            }
            Button(String(localized: "dev.debug-log", defaultValue: "Debug Log", comment: "Debug log button")) {
                pushLog(.debug)
            }
        }
