...
struct InternalDevelopmentOutputView: View {
    var body: some View {
        Section(String(localized: "dev.output-utility", defaultValue: "Output Utility", comment: "Section title for output utility tools")) {
            Button(String(localized: "dev.error-log", defaultValue: "Error Log", comment: "Button to push an error log entry")) {
                pushLog(.error)
            }
            Button(String(localized: "dev.warning-log", defaultValue: "Warning Log", comment: "Button to push a warning log entry")) {
                pushLog(.warning)
            }
            Button(String(localized: "dev.info-log", defaultValue: "Info Log", comment: "Button to push an info log entry")) {
                pushLog(.info)
            }
            Button(String(localized: "dev.debug-log", defaultValue: "Debug Log", comment: "Button to push a debug log entry")) {
                pushLog(.debug)
            }
        }
    ...
    func pushLog(_ level: UtilityAreaLogLevel) {
        InternalDevelopmentOutputSource.shared.pushLog(
            .init(
                ...
                category: String(localized: "dev.logs-category", defaultValue: "Logs", comment: "Category name for development logs"),
                level: level
            )
        )
    }
