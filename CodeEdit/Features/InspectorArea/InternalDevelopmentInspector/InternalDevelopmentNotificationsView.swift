...
struct InternalDevelopmentNotificationsView: View {
    ...
    @State private var actionButtonText: String = String(localized: "internal-dev.notifications.view", defaultValue: "View", comment: "View action button")
    @State private var notificationTitle: String = String(localized: "internal-dev.notifications.test-notification", defaultValue: "Test Notification", comment: "Test Notification title")
    ...
    var body: some View {
        Section(String(localized: "internal-dev.notifications.section-title", defaultValue: "Notifications", comment: "Notifications section title")) {
            ...
            Group {
                ...
                case .symbol:
                    Picker(String(localized: "internal-dev.notifications.symbol", defaultValue: "Symbol", comment: "Symbol picker"), selection: $selectedSymbol) {
                ...
                case .emoji:
                    Picker(String(localized: "internal-dev.notifications.emoji", defaultValue: "Emoji", comment: "Emoji picker"), selection: $selectedEmoji) {
                        Label(String(localized: "internal-dev.notifications.random", defaultValue: "Random", comment: "Random option"), systemImage: "dice").tag(nil as String?)
                        Divider()
                ...
                case .text:
                    Picker(String(localized: "internal-dev.notifications.text", defaultValue: "Text", comment: "Text picker"), selection: $selectedText) {
                        Label(String(localized: "internal-dev.notifications.random", defaultValue: "Random", comment: "Random option"), systemImage: "dice").tag(nil as String?)
                        Divider()
                ...
                case .image:
                    Picker(String(localized: "internal-dev.notifications.image", defaultValue: "Image", comment: "Image picker"), selection: $selectedImage) {
                        Label(String(localized: "internal-dev.notifications.random", defaultValue: "Random", comment: "Random option"), systemImage: "dice").tag(nil as String?)
                        Divider()
                ...
                if selectedIconType == .symbol || selectedIconType == .text || selectedIconType == .emoji {
                    Picker(String(localized: "internal-dev.notifications.icon-color", defaultValue: "Icon Color", comment: "Icon Color picker"), selection: $selectedColor) {
            ...
            TextField(String(localized: "internal-dev.notifications.title-field", defaultValue: "Title", comment: "Title text field"), text: $notificationTitle)
            TextField(String(localized: "internal-dev.notifications.description-field", defaultValue: "Description", comment: "Description text field"), text: $notificationDescription, axis: .vertical)
                .lineLimit(1...5)
            TextField(String(localized: "internal-dev.notifications.action-button-field", defaultValue: "Action Button", comment: "Action Button text field"), text: $actionButtonText)
