...
struct InternalDevelopmentNotificationsView: View {
    ...
    @State private var actionButtonText: String = String(localized: "View", comment: "Button text")
    @State private var notificationTitle: String = String(localized: "Test Notification", comment: "Notification title")
    @State private var notificationDescription: String = String(localized: "This is a test notification.", comment: "Notification description")
    ...
    var body: some View {
        Section("Notifications") {
            ...
            Group {
                ...
                Label(String(localized: "Random", comment: "Picker option"), systemImage: "dice").tag(nil as String?)
                        Divider()
                ...
                if selectedIconType == .symbol || selectedIconType == .text || selectedIconType == .emoji {
                    Picker(String(localized: "Icon Color", comment: "Picker label"), selection: $selectedColor) {
                        Label(String(localized: "Random", comment: "Picker option"), systemImage: "dice").tag(nil as Color?)
                        Divider()
            ...
            TextField(String(localized: "Title", comment: "Text field label"), text: $notificationTitle)
            TextField(String(localized: "Description", comment: "Text field label"), text: $notificationDescription, axis: .vertical)
                .lineLimit(1...5)
            TextField(String(localized: "Action Button", comment: "Text field label"), text: $actionButtonText)

            Button(String(localized: "Add Notification", comment: "Button text")) {
                let action = {
                    switch selectedIconType {
                    case .symbol:
