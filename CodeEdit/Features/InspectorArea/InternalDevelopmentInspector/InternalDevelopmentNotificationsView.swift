...
struct InternalDevelopmentNotificationsView: View {
    ...
    var body: some View {
        Section(String(localized: "internal.dev.notifications.section", defaultValue: "Notifications", comment: "Section header for notifications settings")) {
            Toggle(String(localized: "internal.dev.notifications.delay", defaultValue: "Delay 5s", comment: "Toggle for notification delay"), isOn: $delay)
            ...
            Picker(String(localized: "internal.dev.notifications.icon-type.picker", defaultValue: "Icon Type", comment: "Picker label for icon type"), selection: $selectedIconType) {
            ...
            TextField(String(localized: "internal.dev.notifications.title.label", defaultValue: "Title", comment: "Label for notification title field"), text: $notificationTitle)
            TextField(String(localized: "internal.dev.notifications.description.label", defaultValue: "Description", comment: "Label for notification description field"), text: $notificationDescription, axis: .vertical)
                .lineLimit(1...5)
            TextField(String(localized: "internal.dev.notifications.action-button.label", defaultValue: "Action Button", comment: "Label for action button text field"), text: $actionButtonText)

            Button(String(localized: "internal.dev.notifications.add", defaultValue: "Add Notification", comment: "Button to add a test notification")) {
                let action = {
                    switch selectedIconType {
                    case .symbol:
