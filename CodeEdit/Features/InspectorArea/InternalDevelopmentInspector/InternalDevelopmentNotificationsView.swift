...
struct InternalDevelopmentNotificationsView: View {
    ...
    @State private var actionButtonText: String = String(localized: "internal-dev-notifications.view-button", defaultValue: "View", comment: "View action button text")
    @State private var notificationTitle: String = String(localized: "internal-dev-notifications.test-notification-title", defaultValue: "Test Notification", comment: "Test notification title")
    @State private var notificationDescription: String = String(localized: "internal-dev-notifications.test-notification-description", defaultValue: "This is a test notification.", comment: "Test notification description")
    ...
    var body: some View {
        Section(String(localized: "internal-dev-notifications.section-title", defaultValue: "Notifications", comment: "Notifications section title")) {
            Toggle(String(localized: "internal-dev-notifications.delay-5s", defaultValue: "Delay 5s", comment: "Delay 5 seconds toggle"), isOn: $delay)
            ...
            TextField(String(localized: "internal-dev-notifications.title", defaultValue: "Title", comment: "Title text field placeholder"), text: $notificationTitle)
            TextField(String(localized: "internal-dev-notifications.description", defaultValue: "Description", comment: "Description text field placeholder"), text: $notificationDescription, axis: .vertical)
                .lineLimit(1...5)
            TextField(String(localized: "internal-dev-notifications.action-button", defaultValue: "Action Button", comment: "Action button text field placeholder"), text: $actionButtonText)
