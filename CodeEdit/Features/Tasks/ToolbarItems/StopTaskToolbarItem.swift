...
final class StopTaskToolbarItem: NSToolbarItem {
    ...
    init?(workspace: WorkspaceDocument) {
        ...
        paletteLabel = String(localized: "tasks.toolbar.stop-task.title", defaultValue: "Stop Task", comment: "Toolbar item title to stop a task")
        toolTip = String(localized: "tasks.toolbar.stop-task.help", defaultValue: "Stop the selected task", comment: "Toolbar item help text for stopping selected task")
        target = self
        isEnabled = false
        isBordered = true
