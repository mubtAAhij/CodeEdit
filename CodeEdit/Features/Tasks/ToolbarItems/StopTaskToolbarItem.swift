...
final class StopTaskToolbarItem: NSToolbarItem {
    ...
    init?(workspace: WorkspaceDocument) {
        ...
        paletteLabel = String(localized: "tasks.stop", defaultValue: "Stop Task", comment: "Label for stop task toolbar item")
        toolTip = String(localized: "tasks.stop-task-help", defaultValue: "Stop the selected task", comment: "Tooltip for stop task toolbar item")
        target = self
        isEnabled = false
        isBordered = true
