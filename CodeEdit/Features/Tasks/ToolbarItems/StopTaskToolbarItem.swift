...
final class StopTaskToolbarItem: NSToolbarItem {
    ...
    init?(workspace: WorkspaceDocument) {
        ...
        paletteLabel = String(localized: "task.stop", defaultValue: "Stop Task", comment: "Stop task toolbar item label")
        toolTip = String(localized: "task.stop.tooltip", defaultValue: "Stop the selected task", comment: "Stop task toolbar item tooltip")
        target = self
        isEnabled = false
        isBordered = true
