...
final class StopTaskToolbarItem: NSToolbarItem {
    ...
    init?(workspace: WorkspaceDocument) {
        ...
        paletteLabel = String(localized: "task.stop.toolbar", defaultValue: "Stop Task", comment: "Stop task toolbar item label")
        toolTip = String(localized: "task.stop.tooltip", defaultValue: "Stop the selected task", comment: "Tooltip for stop task toolbar item")
        target = self
        isEnabled = false
        isBordered = true
