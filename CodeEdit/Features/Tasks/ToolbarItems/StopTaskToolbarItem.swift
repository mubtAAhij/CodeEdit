...
final class StopTaskToolbarItem: NSToolbarItem {
    ...
    init?(workspace: WorkspaceDocument) {
        ...
        paletteLabel = String(localized: "tasks.toolbar.stop-task", defaultValue: "Stop Task", comment: "Toolbar item label to stop a task")
        toolTip = String(localized: "tasks.toolbar.stop-task.help", defaultValue: "Stop the selected task", comment: "Help text for stop task toolbar item")
        target = self
        isEnabled = false
        isBordered = true
