...
final class StopTaskToolbarItem: NSToolbarItem {
    ...
    init?(workspace: WorkspaceDocument) {
        ...
        paletteLabel = String(localized: "tasks.stop", defaultValue: "Stop Task", comment: "Stop task toolbar label")
        toolTip = String(localized: "tasks.stop.help", defaultValue: "Stop the selected task", comment: "Stop task tooltip")
        target = self
        isEnabled = false
        isBordered = true
