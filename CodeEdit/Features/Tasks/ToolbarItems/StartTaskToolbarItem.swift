...
final class StartTaskToolbarItem: NSToolbarItem {
    ...
    init(workspace: WorkspaceDocument) {
        ...
        paletteLabel = String(localized: "tasks.start-task", defaultValue: "Start Task", comment: "Toolbar item label for starting a task")
        toolTip = String(localized: "tasks.start-task.tooltip", defaultValue: "Run the selected task", comment: "Tooltip for start task toolbar item")
        target = self
