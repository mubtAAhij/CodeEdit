...
final class StartTaskToolbarItem: NSToolbarItem {
    ...
    init(workspace: WorkspaceDocument) {
        ...
        paletteLabel = String(localized: "tasks.toolbar.start-task", defaultValue: "Start Task", comment: "Toolbar item label used to start a task")
        toolTip = String(localized: "tasks.toolbar.start-task.help", defaultValue: "Run the selected task", comment: "Help text for start task toolbar item")
        target = self
