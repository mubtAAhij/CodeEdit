...
final class StartTaskToolbarItem: NSToolbarItem {
    ...
    init(workspace: WorkspaceDocument) {
        ...
        paletteLabel = String(localized: "task.start.palette-label", defaultValue: "Start Task", comment: "Palette label for start task toolbar item")
        toolTip = String(localized: "task.start.tooltip", defaultValue: "Run the selected task", comment: "Tooltip for start task toolbar button")
        target = self
