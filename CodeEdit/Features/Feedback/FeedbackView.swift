...
struct FeedbackView: View {
        ...
        VStack {
            ...
            FeedbackToolbar {
                ...
                Button {
                    ...
                    Text(String(localized: "feedback.submit", defaultValue: "Submit", comment: "Button label to submit feedback"))
                }
                .alert(isPresented: self.$showsAlert) {
                    Alert(
                        ...
                        message: Text(String(localized: "feedback.github-account-required", defaultValue: "A GitHub account is required to submit feedback.", comment: "Alert message explaining GitHub account is needed")),
    ...
    private var basicInformation: some View {
        VStack(alignment: .leading) {
            Text(String(localized: "feedback.basic-information", defaultValue: "Basic Information", comment: "Section title for basic feedback information"))
                .fontWeight(.bold)
                .font(.system(size: 20))
                    ...
                    if isSubmitButtonPressed && feedbackModel.feedbackTitle.isEmpty {
                        HStack {
                            Image(systemName: "arrow.right.circle.fill")
                                .foregroundColor(.red)
                            Text(String(localized: "feedback.provide-title-prompt", defaultValue: "Please provide a descriptive title for your feedback:", comment: "Prompt asking user to provide feedback title"))
                        }.padding(.leading, -23)
                    } else {
                        Text(String(localized: "feedback.provide-title-prompt", defaultValue: "Please provide a descriptive title for your feedback:", comment: "Prompt asking user to provide feedback title"))
                    }
                ...
                HStack {
                    if isSubmitButtonPressed && feedbackModel.issueAreaListSelection == "none" {
                        HStack {
                            Image(systemName: "arrow.right.circle.fill")
                                .foregroundColor(.red)
                            Text(String(localized: "feedback.which-area-prompt", defaultValue: "Which area are you seeing an issue with?", comment: "Prompt asking user which area has an issue"))
                        }.padding(.leading, -23)
                    } else {
                        Text(String(localized: "feedback.which-area-prompt", defaultValue: "Which area are you seeing an issue with?", comment: "Prompt asking user which area has an issue"))
                    }
            ...
            VStack(alignment: .leading) {
                if isSubmitButtonPressed && feedbackModel.feedbackTypeListSelection == "none" {
                    HStack {
                        Image(systemName: "arrow.right.circle.fill")
                            .foregroundColor(.red)
                        Text(String(localized: "feedback.what-type-prompt", defaultValue: "What type of feedback are you reporting?", comment: "Prompt asking user what type of feedback they are reporting"))
                    }.padding(.leading, -23)
                } else {
                    Text(String(localized: "feedback.what-type-prompt", defaultValue: "What type of feedback are you reporting?", comment: "Prompt asking user what type of feedback they are reporting"))
                }
    ...
    private var description: some View {
        VStack(alignment: .leading) {
            Text(String(localized: "feedback.description", defaultValue: "Description", comment: "Section title for feedback description"))
                .fontWeight(.bold)
                .font(.system(size: 20))
                .padding(.top)
            ...
            VStack(alignment: .leading) {
                Text(String(localized: "feedback.steps-to-reproduce-prompt", defaultValue: "Please list the steps you took to reproduce the issue:", comment: "Prompt asking user for steps to reproduce"))
            ...
            VStack(alignment: .leading) {
                Text(String(localized: "feedback.expected-behavior-prompt", defaultValue: "What did you expect to happen?", comment: "Prompt asking user what they expected to happen"))
            ...
            VStack(alignment: .leading) {
                Text(String(localized: "feedback.actual-behavior-prompt", defaultValue: "What actually happened?", comment: "Prompt asking user what actually happened"))
