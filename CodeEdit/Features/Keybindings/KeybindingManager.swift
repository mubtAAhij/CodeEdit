...
final class KeybindingManager {
    ...
    var fallbackShortcut = KeyboardShortcutWrapper(
        name: "?",
        description: String(localized: "test", comment: "Test description for fallback keyboard shortcut"),
        context: String(localized: "fallback", comment: "Context label for fallback keyboard shortcut"),
        keybinding: "?",
        modifier: "shift",
        id: "fallback"
    )
