...
class CELocalShellTerminalView: CETerminalView, TerminalViewDelegate, LocalProcessDelegate {
    ...
    public func startProcess(
        ...
        do {
            ...
            terminal.feed(text: String(format: String(localized: "terminal.start-session-error", defaultValue: "Failed to start a terminal session: %@", comment: "Terminal session start error message"), error.localizedDescription))
        }
    }
