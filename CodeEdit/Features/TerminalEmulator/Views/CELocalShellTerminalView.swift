...
class CELocalShellTerminalView: CETerminalView, TerminalViewDelegate, LocalProcessDelegate {
    ...
    public func startProcess(
        ...
        do {
            ...
            terminal.feed(text: "String(localized: "terminal_session_failed", comment: "Error message when terminal session fails to start").replacingOccurrences(of: "{error}", with: error.localizedDescription)")
        }
    }
