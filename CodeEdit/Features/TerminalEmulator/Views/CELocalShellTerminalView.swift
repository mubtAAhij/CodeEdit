...
class CELocalShellTerminalView: CETerminalView, TerminalViewDelegate, LocalProcessDelegate {
    ...
    public func startProcess(
        ...
        do {
            ...
            terminal.feed(text: String(format: String(localized: "terminal.error.failed-to-start", defaultValue: "Failed to start a terminal session: %@", comment: "Error message when terminal fails to start"), error.localizedDescription))
        }
    }
