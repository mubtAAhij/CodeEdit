...
class CELocalShellTerminalView: CETerminalView, TerminalViewDelegate, LocalProcessDelegate {
    ...
    public func startProcess(
        ...
        do {
            ...
            terminal.feed(text: String(format: String(localized: "terminal.failed-to-start", defaultValue: "Failed to start a terminal session: %@", comment: "Terminal session start failure message"), error.localizedDescription))
        }
    }
