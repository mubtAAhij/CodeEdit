...
class CELocalShellTerminalView: CETerminalView, TerminalViewDelegate, LocalProcessDelegate {
    ...
    public func startProcess(
        ...
        do {
            ...
            terminal.feed(text: String(format: String(localized: "terminal.session-start-failed", defaultValue: "Failed to start a terminal session: %@", comment: "Terminal session start failure message"), error.localizedDescription))
        }
    }
