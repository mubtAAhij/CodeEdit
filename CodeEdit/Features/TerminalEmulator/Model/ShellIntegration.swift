...
enum ShellIntegration {
    ...
    enum Error: Swift.Error, LocalizedError {
        ...
        var localizedDescription: String {
            ...
            case .bashShellFileNotFound:
                return String(
                    localized: "terminal-emulator.shell-integration.bash-injection-file-not-found",
                    defaultValue: "Failed to find bash injection file.",
                    comment: "Error when bash shell integration injection file cannot be found"
                )
            case .zshShellFileNotFound:
                return String(
                    localized: "terminal-emulator.shell-integration.zsh-injection-file-not-found",
                    defaultValue: "Failed to find zsh injection file.",
                    comment: "Error when zsh shell integration injection file cannot be found"
                )
            }
        }
    }
