...
enum ShellIntegration {
    ...
    enum Error: Swift.Error, LocalizedError {
        ...
        var localizedDescription: String {
            switch self {
            case .bashShellFileNotFound:
                return String(localized: "shell-integration.error.bash-file-not-found", defaultValue: "Failed to find bash injection file.", comment: "Error message when bash shell integration file is missing")
            case .zshShellFileNotFound:
                return String(localized: "shell-integration.error.zsh-file-not-found", defaultValue: "Failed to find zsh injection file.", comment: "Error message when zsh shell integration file is missing")
            }
        }
    }
