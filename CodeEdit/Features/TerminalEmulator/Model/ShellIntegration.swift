...
enum ShellIntegration {
    ...
    enum Error: Swift.Error, LocalizedError {
        ...
        var localizedDescription: String {
            switch self {
            case .bashShellFileNotFound:
                return String(localized: "terminal.shell-integration.error.bash-not-found", defaultValue: "Failed to find bash injection file.", comment: "Error message when bash integration file is not found")
            case .zshShellFileNotFound:
                return String(localized: "terminal.shell-integration.error.zsh-not-found", defaultValue: "Failed to find zsh injection file.", comment: "Error message when zsh integration file is not found")
            }
        }
    }
