...
enum ShellIntegration {
    ...
    enum Error: Swift.Error, LocalizedError {
        ...
        var localizedDescription: String {
            switch self {
            case .bashShellFileNotFound:
                return String(localized: "terminal.shell.error.bash-file-not-found", defaultValue: "Failed to find bash injection file.", comment: "Error message when bash injection file is not found")
            case .zshShellFileNotFound:
                return String(localized: "terminal.shell.error.zsh-file-not-found", defaultValue: "Failed to find zsh injection file.", comment: "Error message when zsh injection file is not found")
            }
        }
    }
