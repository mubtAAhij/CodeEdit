...
enum ShellIntegration {
    ...
    enum Error: Swift.Error, LocalizedError {
        ...
        var localizedDescription: String {
            switch self {
            case .bashShellFileNotFound:
                return String(localized: "shell_integration.error.bash_file_not_found", comment: "Error message")
            case .zshShellFileNotFound:
                return String(localized: "shell_integration.error.zsh_file_not_found", comment: "Error message")
            }
        }
    }
