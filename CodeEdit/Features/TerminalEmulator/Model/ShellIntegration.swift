...
enum ShellIntegration {
    ...
    enum Error: Swift.Error, LocalizedError {
        ...
        var localizedDescription: String {
            switch self {
            case .bashShellFileNotFound:
                return String(localized: "shell_integration.error.bash_injection_file_not_found", comment: "Error message when bash injection file is not found")
            case .zshShellFileNotFound:
                return String(localized: "shell_integration.error.zsh_injection_file_not_found", comment: "Error message when zsh injection file is not found")
            }
        }
    }
