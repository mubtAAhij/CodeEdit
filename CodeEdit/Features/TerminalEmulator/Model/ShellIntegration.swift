...
enum ShellIntegration {
    ...
    enum Error: Swift.Error, LocalizedError {
        ...
        var localizedDescription: String {
            switch self {
            case .bashShellFileNotFound:
                return String(localized: "terminal.error.bash-integration-not-found", defaultValue: "Failed to find bash injection file.", comment: "Error message when bash shell integration file is not found")
            case .zshShellFileNotFound:
                return String(localized: "terminal.error.zsh-integration-not-found", defaultValue: "Failed to find zsh injection file.", comment: "Error message when zsh shell integration file is not found")
            }
        }
    }
