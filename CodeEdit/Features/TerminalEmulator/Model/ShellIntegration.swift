...
enum ShellIntegration {
    ...
    enum Error: Swift.Error, LocalizedError {
        ...
        var localizedDescription: String {
            switch self {
            case .bashShellFileNotFound:
                return String(localized: "terminal.shell-integration.bash-injection-file-missing", defaultValue: "Failed to find bash injection file.", comment: "Error when bash shell integration file is missing")
            case .zshShellFileNotFound:
                return String(localized: "terminal.shell-integration.zsh-injection-file-missing", defaultValue: "Failed to find zsh injection file.", comment: "Error when zsh shell integration file is missing")
            }
        }
    }
