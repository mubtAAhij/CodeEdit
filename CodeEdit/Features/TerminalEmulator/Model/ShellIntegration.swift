...
enum ShellIntegration {
    ...
    enum Error: Swift.Error, LocalizedError {
        ...
        var localizedDescription: String {
            switch self {
            case .bashShellFileNotFound:
                return String(localized: "terminal.bash-file-not-found", defaultValue: "Failed to find bash injection file.", comment: "Bash injection file not found error")
            case .zshShellFileNotFound:
                return String(localized: "terminal.zsh-file-not-found", defaultValue: "Failed to find zsh injection file.", comment: "Zsh injection file not found error")
            }
        }
    }
