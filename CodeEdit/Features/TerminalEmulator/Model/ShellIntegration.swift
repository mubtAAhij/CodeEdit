...
enum ShellIntegration {
    ...
    enum Error: Swift.Error, LocalizedError {
        ...
        var localizedDescription: String {
            switch self {
            case .bashShellFileNotFound:
                return String(localized: "shell-integration.error.bash-not-found", defaultValue: "Failed to find bash injection file.", comment: "Error when bash injection file is not found")
            case .zshShellFileNotFound:
                return String(localized: "shell-integration.error.zsh-not-found", defaultValue: "Failed to find zsh injection file.", comment: "Error when zsh injection file is not found")
            }
        }
    }
