...
enum ShellIntegration {
    ...
    enum Error: Swift.Error, LocalizedError {
        ...
        var localizedDescription: String {
            switch self {
            case .bashShellFileNotFound:
                return String(localized: "shell_integration.error.bash_file_not_found", comment: "Error when bash injection file is not found")
            case .zshShellFileNotFound:
                return String(localized: "shell_integration.error.zsh_file_not_found", comment: "Error when zsh injection file is not found")
            }
        }
    }
