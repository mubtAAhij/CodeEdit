...
class GitClient {
    enum GitClientError: Error {
        ...
        var description: String {
            ...
            case .failedToDecodeURL: String(localized: "source-control.error.decode-url-failed", defaultValue: "Failed to decode URL", comment: "Error message when URL decoding fails")
            case .noRemoteConfigured: String(localized: "source-control.error.no-remote", defaultValue: "No remote configured", comment: "Error message when no git remote is configured")
            ...
            case let .invalidStatus(char): String(format: String(localized: "source-control.error.invalid-status", defaultValue: "Invalid status received: %@", comment: "Error message when invalid git status is received"), String(char))
            case let .statusInvalidChangeType(char): String(format: String(localized: "source-control.error.invalid-change-type", defaultValue: "Status invalid change type: %@", comment: "Error message when git status has invalid change type"), String(char))
            }
        }
    }
