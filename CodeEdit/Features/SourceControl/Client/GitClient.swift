...
class GitClient {
    enum GitClientError: Error {
        ...
        var description: String {
            ...
            case .failedToDecodeURL: String(localized: "source-control.git-client.error.failed-to-decode-url", defaultValue: "Failed to decode URL", comment: "Error message when repository URL decoding fails")
            case .noRemoteConfigured: String(localized: "source-control.git-client.error.no-remote-configured", defaultValue: "No remote configured", comment: "Error message when no git remote is configured")
            case .statusParseEarlyEnd: String(localized: "source-control.git-client.error.invalid-status-end-of-string", defaultValue: "Invalid status, found end of string too early", comment: "Error message for malformed git status output ending too early")
            case let .invalidStatus(char): String(format: String(localized: "source-control.git-client.error.invalid-status-received", defaultValue: "Invalid status received: %@", comment: "Error message for invalid git status character received"), "\(char)")
            case let .statusInvalidChangeType(char): String(format: String(localized: "source-control.git-client.error.invalid-change-type", defaultValue: "Status invalid change type: %@", comment: "Error message for invalid git status change type"), "\(char)")
            }
        }
    }
