...
class GitClient {
    enum GitClientError: Error {
        ...
        var description: String {
            ...
            case .notGitRepository: String(localized: "git.not-repository", defaultValue: "Not a git repository", comment: "Not a git repository error")
            case .failedToDecodeURL: String(localized: "git.failed-decode-url", defaultValue: "Failed to decode URL", comment: "Failed to decode URL error")
