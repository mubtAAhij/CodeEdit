...
class GitClient {
    enum GitClientError: Error {
        ...
        var description: String {
            ...
            case .notGitRepository: String(localized: "git.error.not-repository", defaultValue: "Not a git repository", comment: "Error message when the directory is not a git repository")
