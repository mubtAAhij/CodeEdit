...
extension GitClient {
    ...
    enum GitCloneProgressState {
        ...
        var label: String {
            switch self {
            case .initialState: String(localized: "git.clone.cloning", defaultValue: "Cloning", comment: "Git clone progress state: cloning")
            case .counting: String(localized: "git.clone.counting", defaultValue: "Counting", comment: "Git clone progress state: counting objects")
            case .compressing: String(localized: "git.clone.compressing", defaultValue: "Compressing", comment: "Git clone progress state: compressing objects")
            case .receiving: String(localized: "git.clone.receiving", defaultValue: "Receiving", comment: "Git clone progress state: receiving objects")
            case .resolving: String(localized: "git.clone.resolving", defaultValue: "Resolving", comment: "Git clone progress state: resolving deltas")
            }
        }
    }
