...
extension GitClient {
    ...
    enum GitCloneProgressState {
        ...
        var label: String {
            switch self {
            case .initialState: String(localized: "source-control.clone.state.cloning", defaultValue: "Cloning", comment: "Git clone progress state: initial cloning")
            case .counting: String(localized: "source-control.clone.state.counting", defaultValue: "Counting", comment: "Git clone progress state: counting objects")
            case .compressing: String(localized: "source-control.clone.state.compressing", defaultValue: "Compressing", comment: "Git clone progress state: compressing objects")
            case .receiving: String(localized: "source-control.clone.state.receiving", defaultValue: "Receiving", comment: "Git clone progress state: receiving objects")
            case .resolving: String(localized: "source-control.clone.state.resolving", defaultValue: "Resolving", comment: "Git clone progress state: resolving deltas")
            }
        }
    }
