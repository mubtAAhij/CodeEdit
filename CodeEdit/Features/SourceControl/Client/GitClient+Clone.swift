...
extension GitClient {
    ...
    enum GitCloneProgressState {
        ...
        var label: String {
            switch self {
            case .initialState: String(localized: "git.clone.cloning", comment: "Git clone progress state")
            case .counting: String(localized: "git.clone.counting", comment: "Git clone progress state")
            case .compressing: String(localized: "git.clone.compressing", comment: "Git clone progress state")
            case .receiving: String(localized: "git.clone.receiving", comment: "Git clone progress state")
            case .resolving: String(localized: "git.clone.resolving", comment: "Git clone progress state")
            }
        }
    }
