        ...
        VStack(spacing: 8) {
            HStack(alignment: .top) {
                ...
                VStack(alignment: .leading) {
                    Text(String(
                        localized: "source-control.clone-view.clone-repository",
                    ...
                    Text(String(
                        ...
                        comment: "Instruction text for entering repository URL"
                    ))
                        .font(.system(size: 11))
                    ...
                    TextField(String(
                        localized: "source-control.clone-view.repository-url-label",
                        defaultValue: "Git Repository URL",
                        comment: "Label for git repository URL input"
                    ...
                    HStack {
                        ...
                        Button(String(
                            ...
                            defaultValue: "Cancel",
                            comment: "Cancel button title in clone repository sheet"
                        )) {
                            dismiss()
                        }
                        Button(String(
                            ...
                            defaultValue: "Clone",
                            comment: "Confirm button title to start clone"
                        )) {
                            cloneRepository()
                        }
        ...
        .toolbar {
            ToolbarItem {
                Button(String(
                    ...
                    comment: "Button title to cancel in-progress cloning"
                )) {
