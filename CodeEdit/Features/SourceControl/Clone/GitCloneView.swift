        ...
        VStack(spacing: 8) {
            HStack(alignment: .top) {
                ...
                VStack(alignment: .leading) {
                    Text(String(localized: "git.clone.title", defaultValue: "Clone a Repository", comment: "Git clone dialog title"))
                        .bold()
                        .padding(.bottom, 2)
                    Text(String(localized: "git.clone.prompt", defaultValue: "Enter a git repository URL:", comment: "Git clone URL prompt"))
                        .font(.system(size: 11))
