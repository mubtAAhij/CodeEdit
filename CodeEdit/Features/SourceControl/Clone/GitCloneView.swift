            ...
            HStack(alignment: .top) {
                ...
                VStack(alignment: .leading) {
                    Text(String(localized: "git.clone.title", defaultValue: "Clone a Repository", comment: "Title for clone repository dialog"))
                        .bold()
                        .padding(.bottom, 2)
                    Text(String(localized: "git.clone.prompt", defaultValue: "Enter a git repository URL:", comment: "Prompt to enter git repository URL"))
                        .font(.system(size: 11))
                    ...
                    HStack {
                        ...
                        Button(String(localized: "git.clone.clone-button", defaultValue: "Clone", comment: "Clone button")) {
                            cloneRepository()
                        }
