        ...
        VStack(spacing: 8) {
            HStack {
                ...
                VStack(alignment: .leading) {
                    Text(String(
                        localized: "git.clone.title",
                        defaultValue: "Clone a repository",
                        comment: "Title for git clone dialog"
                    ))
                        .bold()
                        .padding(.bottom, 2)
                    Text(String(
                        localized: "git.clone.description",
                        defaultValue: "Enter a git repository URL:",
                        comment: "Description for git clone dialog"
                    ))
                        .font(.system(size: 11))
                    ...
                    TextField(String(
                        localized: "git.clone.url-placeholder",
                        defaultValue: "Git Repository URL",
                        comment: "Placeholder for git repository URL text field"
                    ...
                    HStack {
                        Button(String(
                            localized: "git.clone.cancel",
                            defaultValue: "Cancel",
                            comment: "Button to cancel git clone"
                        )) {
                            dismiss()
                        }
                        Button(String(
                            localized: "git.clone.button",
                            defaultValue: "Clone",
                            comment: "Button to start cloning repository"
                        )) {
                            cloneRepository()
                        }
            ...
            .sheet(isPresented: $viewModel.isCloning) {
                ...
                .toolbar {
                    ToolbarItem {
                        Button(String(
                            localized: "git.clone.cancel-cloning",
                            defaultValue: "Cancel Cloning",
                            comment: "Button to cancel ongoing clone operation"
                        )) {
