            ...
            HStack(alignment: .top) {
                ...
                VStack(alignment: .leading) {
                    ...
                    Text(String(
                        ...
                        comment: "Prompt text asking user to enter repository URL"
                    ))
                        .font(.system(size: 11))
                    ...
                    TextField(String(
                        ...
                        comment: "Label for git repository URL input field"
                    ...
                    HStack {
                        ...
                        Button(String(
                            ...
                            defaultValue: "Cancel",
                            comment: "Button title to cancel cloning workflow"
                        )) {
                            dismiss()
                        }
                        Button(String(
                            ...
                            defaultValue: "Clone",
                            comment: "Button title to start clone operation"
                        )) {
                            cloneRepository()
                        }
