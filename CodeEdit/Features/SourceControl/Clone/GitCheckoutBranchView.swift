        ...
        VStack(spacing: 8) {
            HStack {
                ...
                VStack(alignment: .leading) {
                    Text(String(localized: "source-control.checkout-branch", defaultValue: "Checkout branch", comment: "Checkout branch dialog title"))
                        .bold()
                        .padding(.bottom, 2)
                    Text(String(localized: "source-control.checkout-branch.select", defaultValue: "Select a branch to checkout", comment: "Checkout branch dialog description"))
                        .font(.system(size: 11))
