        ...
        VStack(spacing: 8) {
            HStack {
                ...
                VStack(alignment: .leading) {
                    Text(String(localized: "sourcecontrol.checkout.branch", defaultValue: "Checkout branch", comment: "Checkout branch dialog title"))
                        .bold()
                        .padding(.bottom, 2)
                    Text(String(localized: "sourcecontrol.checkout.branch.select", defaultValue: "Select a branch to checkout", comment: "Select branch instruction"))
                        .font(.system(size: 11))
                    ...
                    HStack {
                        Button(String(localized: "sourcecontrol.checkout.cancel", defaultValue: "Cancel", comment: "Cancel button")) {
                            dismiss()
                        }
                        Button(String(localized: "sourcecontrol.checkout.button", defaultValue: "Checkout", comment: "Checkout button")) {
                            Task {
