            ...
            HStack {
                ...
                VStack(alignment: .leading) {
                    Text(String(localized: "source-control.checkout-branch", defaultValue: "Checkout branch", comment: "Checkout branch title"))
                        .bold()
                        .padding(.bottom, 2)
                    Text(String(localized: "source-control.select-branch", defaultValue: "Select a branch to checkout", comment: "Select branch prompt"))
                        .font(.system(size: 11))
                    ...
                    HStack {
                        Button(String(localized: "source-control.cancel", defaultValue: "Cancel", comment: "Cancel button")) {
                            dismiss()
                        }
