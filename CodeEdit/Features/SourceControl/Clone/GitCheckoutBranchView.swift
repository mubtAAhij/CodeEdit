        ...
        VStack(spacing: 8) {
            HStack {
                ...
                VStack(alignment: .leading) {
                    Text(String(localized: "git.checkout-branch.title", defaultValue: "Checkout branch", comment: "Title for checkout branch dialog"))
                        .bold()
                        .padding(.bottom, 2)
                    Text(String(localized: "git.checkout-branch.prompt", defaultValue: "Select a branch to checkout", comment: "Prompt to select a branch"))
                        .font(.system(size: 11))
                    ...
                    HStack {
                        ...
                        Button(String(localized: "git.checkout", defaultValue: "Checkout", comment: "Checkout button title")) {
                            Task {
