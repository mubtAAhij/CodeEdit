        ...
        VStack(spacing: 8) {
            HStack {
                ...
                VStack(alignment: .leading) {
                    Text(String(localized: "git.checkout.title", defaultValue: "Checkout branch", comment: "Title for checkout branch dialog"))
                        .bold()
                        .padding(.bottom, 2)
                    Text(String(localized: "git.checkout.description", defaultValue: "Select a branch to checkout", comment: "Description for branch checkout dialog"))
                        .font(.system(size: 11))
                    ...
                    HStack {
                        Button(String(localized: "git.checkout.cancel", defaultValue: "Cancel", comment: "Cancel button in checkout branch dialog")) {
                            dismiss()
                        }
                        Button(String(localized: "git.checkout.button", defaultValue: "Checkout", comment: "Button to checkout selected branch")) {
                            Task {
