        ...
        VStack(spacing: 8) {
            HStack {
                ...
                VStack(alignment: .leading) {
                    Text("git.checkout_branch", comment: "Checkout branch title")
                        .bold()
                        .padding(.bottom, 2)
                    Text("git.select_branch_to_checkout", comment: "Select branch instruction")
                        .font(.system(size: 11))
                    ...
                    HStack {
                        ...
                        Button("git.checkout", comment: "Checkout button") {
                            Task {
