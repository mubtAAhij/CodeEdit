        ...
        VStack(spacing: 8) {
            HStack {
                ...
                VStack(alignment: .leading) {
                    Text(String(localized: "source-control.checkout-branch", defaultValue: "Checkout branch", comment: "Title for checkout branch dialog"))
                        .bold()
                        .padding(.bottom, 2)
                    Text(String(localized: "source-control.select-branch", defaultValue: "Select a branch to checkout", comment: "Description for branch checkout dialog"))
                        .font(.system(size: 11))
                    ...
                    HStack {
                        ...
                        Button(String(localized: "source-control.checkout.button", defaultValue: "Checkout", comment: "Checkout button for branch checkout")) {
                            Task {
