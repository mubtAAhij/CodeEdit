        ...
        VStack(spacing: 8) {
            HStack {
                ...
                VStack(alignment: .leading) {
                    Text(String(localized: "source-control.checkout-branch.title", defaultValue: "Checkout branch", comment: "Title for checkout branch dialog"))
                        .bold()
                        .padding(.bottom, 2)
                    Text(String(localized: "source-control.checkout-branch.subtitle", defaultValue: "Select a branch to checkout", comment: "Subtitle instructing user to pick a branch"))
                        .font(.system(size: 11))
