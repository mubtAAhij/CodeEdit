        ...
        VStack(spacing: 8) {
            HStack {
                ...
                VStack(alignment: .leading) {
                    Text(String(localized: "git.checkout.title", defaultValue: "Checkout branch", comment: "Checkout branch dialog title"))
                        .bold()
                        .padding(.bottom, 2)
                    Text(String(localized: "git.checkout.message", defaultValue: "Select a branch to checkout", comment: "Select branch message"))
                        .font(.system(size: 11))
