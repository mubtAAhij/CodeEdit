        ...
        VStack(spacing: 8) {
            HStack {
                ...
                VStack(alignment: .leading) {
                    Text(String(localized: "git.checkout-branch", defaultValue: "Checkout branch", comment: "Checkout branch title"))
                        .bold()
                        .padding(.bottom, 2)
                    Text(String(localized: "git.select-branch", defaultValue: "Select a branch to checkout", comment: "Select branch prompt"))
                        .font(.system(size: 11))
