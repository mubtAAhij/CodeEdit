        ...
        VStack(spacing: 8) {
            HStack {
                ...
                VStack(alignment: .leading) {
                    Text("String(localized: "checkout_branch", comment: "Dialog title for checking out a branch")")
                        .bold()
                        .padding(.bottom, 2)
                    Text("String(localized: "select_branch_to_checkout", comment: "Instructions for selecting a branch to checkout")")
                        .font(.system(size: 11))
                    ...
                    HStack {
                        Button("String(localized: "cancel", comment: "Button text to cancel an action")") {
                            dismiss()
                        }
                        Button("String(localized: "checkout", comment: "Button text to checkout a branch")") {
                            Task {
