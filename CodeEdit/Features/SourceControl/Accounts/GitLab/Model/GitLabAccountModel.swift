...
extension GitLabAccount {
    ...
    func projects(
        ...
        page: String = String(localized: "gitlab.pagination.page.default", defaultValue: "1", comment: "GitLab pagination default page number"),
        perPage: String = String(localized: "gitlab.pagination.perpage.default", defaultValue: "20", comment: "GitLab pagination default items per page"),
        archived: Bool = false,
