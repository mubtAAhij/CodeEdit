            ...
            VStack(spacing: 0) {
                Form {
                    Section {
                        ...
                        Text(String(localized: "source-control.create-new-branch", defaultValue: "Create a new branch", comment: "Header for create new branch section"))
                        Text(String(localized: "source-control.create-branch-description", defaultValue: "Create a branch from the current branch and switch to it. All uncommited changes will be preserved on the new branch. ", comment: "Description of create new branch behavior"))
                    }
                }
                .formStyle(.grouped)
                .scrollDisabled(true)
                ...
                HStack {
                    ...
                    Button {
                        ...
                        Text(String(localized: "create", defaultValue: "Create", comment: "Create button"))
                            .frame(minWidth: 56)
                    }
