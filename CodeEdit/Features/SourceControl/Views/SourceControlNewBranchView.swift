            ...
            VStack(spacing: 0) {
                ...
                HStack {
                    ...
                    Button {
                        ...
                        Text(String(localized: "source-control.new-branch.cancel", defaultValue: "Cancel", comment: "Cancel button for new branch creation"))
                            .frame(minWidth: 56)
                    }
                    Button {
                        submit(branch)
                    } label: {
                        Text(String(localized: "source-control.new-branch.create", defaultValue: "Create", comment: "Create button for new branch"))
                            .frame(minWidth: 56)
                    }
        ...
        Task {
            do {
                ...
                await sourceControlManager.showAlertForError(
                    title: String(localized: "source-control.new-branch.error", defaultValue: "Failed to create branch", comment: "Error alert title when branch creation fails"),
                    error: error
                )
            }
        }
