                    ...
                    Section {
                        ...
                        Text(
                            String(
                                ...
                                comment: "Description explaining new branch creation and switch behavior"
                            ) + " "
                        )
                    }
                }
                ...
                HStack {
                    ...
                    Button {
                        ...
                        Text(String(
                            ...
                            defaultValue: "Cancel",
                            comment: "Button title to cancel new branch creation"
                        ))
                            .frame(minWidth: 56)
                    }
                    Button {
                        ...
                        Text(String(
                            ...
                            defaultValue: "Create",
                            comment: "Button title to create and switch to new branch"
                        ))
                            .frame(minWidth: 56)
                    }
            ...
            do {
                ...
                await sourceControlManager.showAlertForError(
                    title: String(
                        ...
                        comment: "Error title shown when creating branch fails"
                    ),
                    error: error
                )
            }
