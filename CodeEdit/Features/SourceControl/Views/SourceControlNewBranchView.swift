            ...
            VStack(spacing: 0) {
                Form {
                    Section {
                        ...
                        TextField(String(localized: "source_control.new_branch.to", comment: "Label for new branch name field"), value: $name, formatter: RegexFormatter(pattern: "[^a-zA-Z0-9_-]"))
                    } header: {
                        Text(String(localized: "source_control.new_branch.title", comment: "Title for new branch creation section"))
                        Text(String(localized: "source_control.new_branch.description", comment: "Description of what happens when creating a new branch"))
                    }
                }
                .formStyle(.grouped)
                .scrollDisabled(true)
                ...
                HStack {
                    ...
                    Button {
                        ...
                        Text(String(localized: "source_control.new_branch.create", comment: "Button to create new branch"))
                            .frame(minWidth: 56)
                    }
        ...
        Task {
            do {
                ...
                await sourceControlManager.showAlertForError(
                    title: String(localized: "source_control.new_branch.error.failed", comment: "Error message when branch creation fails"),
                    error: error
                )
            }
        }
