    ...
    var body: some View {
        ...
        .task {
            do {
                ...
                await sourceControlManager.showAlertForError(title: String(localized: "source_control.fetch.error_title", comment: "Error title when fetch operation fails"), error: error)
            }
        }
    }
}
