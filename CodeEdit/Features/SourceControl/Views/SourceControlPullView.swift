        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    ...
                    Text(String(
                        localized: "source-control.pull.pull-remote-changes-from",
                        defaultValue: "Pull remote changes from",
                        comment: "Label introducing remote branch selection for pull operation"
                    ))
                }
                Section {
                    Toggle(String(
                        localized: "source-control.pull.rebase-local-changes",
                        defaultValue: "Rebase local changes onto upstream changes",
                        comment: "Toggle title for rebasing during pull"
            ...
            HStack {
                if loading {
                    HStack(spacing: 7.5) {
                        ProgressView()
                            ...
                            .controlSize(.small)
                        Text(String(
                            localized: "source-control.pull.pulling-changes",
                            defaultValue: "Pulling changes...",
                            comment: "Progress label shown while pulling changes"
                        ))
                            .font(.subheadline)
                    }
                }
                ...
                Button {
                    ...
                    Text(String(
                        localized: "source-control.pull.cancel",
                        defaultValue: "Cancel",
                        comment: "Button title to cancel pull operation"
                    ))
                        .frame(minWidth: 56)
                }
                .disabled(loading)
                Button(action: submit) {
                    Text(String(
                        localized: "source-control.pull.pull",
                        defaultValue: "Pull",
                        comment: "Button title to confirm pull operation"
                    ))
                        .frame(minWidth: 56)
                }
        ...
        Task {
            do {
                ...
                await sourceControlManager.showAlertForError(title: String(
                    localized: "source-control.pull.failed-to-pull",
                    defaultValue: "Failed to pull",
                    comment: "Error title when pull operation fails"
                ), error: error)
            }
        }
    }
