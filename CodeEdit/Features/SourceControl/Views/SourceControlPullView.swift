        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    ...
                    Text(String(
                        localized: "source-control.pull.header",
                        defaultValue: "Pull remote changes from",
                        comment: "Section header for pulling remote changes"
                    ))
                }
                Section {
                    Toggle(String(
                        localized: "source-control.pull.rebase-toggle",
                        defaultValue: "Rebase local changes onto upstream changes",
                        comment: "Toggle to rebase local changes onto upstream changes"
            ...
            HStack {
                if loading {
                    HStack(spacing: 7.5) {
                        ProgressView()
                            ...
                            .controlSize(.small)
                        Text(String(
                            localized: "source-control.pull.pulling-progress",
                            defaultValue: "Pulling changes...",
                            comment: "Progress message while pulling changes"
                        ))
                            .font(.subheadline)
                    }
                }
                ...
                Button {
                    ...
                    Text(String(
                        ...
                        defaultValue: "Cancel",
                        comment: "Button to cancel pull operation"
                    ))
                        .frame(minWidth: 56)
                }
                .disabled(loading)
                Button(action: submit) {
                    Text(String(
                        localized: "source-control.pull.button",
                        defaultValue: "Pull",
                        comment: "Button to confirm pull operation"
                    ))
                        .frame(minWidth: 56)
                }
        ...
        Task {
            do {
                ...
                await sourceControlManager.showAlertForError(
                    title: String(
                        localized: "source-control.pull.error",
