        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    ...
                    Text(String(localized: "source_control.pull.header", comment: "Header text for pull remote changes section"))
                }
                Section {
                    Toggle(String(localized: "source_control.pull.rebase_option", comment: "Toggle text for rebase option when pulling"), isOn: $sourceControlManager.operationRebase)
                }
            }
            .formStyle(.grouped)
            .scrollDisabled(true)
            ...
            HStack {
                ...
                Button(action: submit) {
                    Text(String(localized: "source_control.pull.action", comment: "Pull button text"))
                        .frame(minWidth: 56)
                }
