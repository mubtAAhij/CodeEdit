        ...
        Group {
            Picker(selection: $remote) {
                ...
                Text(String(
                    ...
                    comment: "Menu item title to add an existing remote"
                ))
                    .tag(GitRemote?(nil))
            } label: {
                Text(String(
                    ...
                    defaultValue: "Remote",
                    comment: "Section title for remote selection"
                ))
            }
            Picker(selection: $branch) {
                if shouldCreateBranch {
                    Label {
                        Text(String(format: String(
                            ...
                            defaultValue: "%@ (Create)",
                            comment: "Menu item title to create a remote branch from current branch name"
                ...
                Text(String(
                    ...
                    defaultValue: "Branch",
                    comment: "Section title for branch selection"
                ))
            }
        }
        .onAppear {
