        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    ...
                    Text(String(localized: "source_control.push.header", comment: "Header text for push local changes section"))
                }
                Section {
                    Toggle(String(localized: "source_control.push.force", comment: "Toggle text for force push option"), isOn: $sourceControlManager.operationForce)
                    Toggle(String(localized: "source_control.push.include_tags", comment: "Toggle text for including tags when pushing"), isOn: $sourceControlManager.operationIncludeTags)
                }
            }
            .formStyle(.grouped)
            .scrollDisabled(true)
