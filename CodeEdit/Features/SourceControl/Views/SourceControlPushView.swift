        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    ...
                    Text(String(
                        localized: "source-control.push.push-local-changes-to",
                        defaultValue: "Push local changes to",
                        comment: "Label introducing remote branch target for push operation"
                    ))
                }
                Section {
                    Toggle(String(
            ...
            HStack {
                if loading {
                    HStack(spacing: 7.5) {
                        ProgressView()
                            ...
                            .controlSize(.small)
                        Text(String(
                            localized: "source-control.push.pushing-changes",
                            defaultValue: "Pushing changes...",
                            comment: "Progress text while push operation is running"
                        ))
                            .font(.subheadline)
                    }
                }
                ...
                Button {
                    ...
                    Text(String(
                        ...
                        defaultValue: "Cancel",
                        comment: "Button title to cancel push operation"
                    ))
                        .frame(minWidth: 56)
                }
                .disabled(loading)
                Button(action: submit) {
                    Text(String(
                        ...
                        defaultValue: "Push",
                        comment: "Button title to confirm push operation"
                    ))
                        .frame(minWidth: 56)
                }
        ...
        Task {
            do {
                ...
                await sourceControlManager.showAlertForError(title: String(
                    localized: "source-control.push.failed-to-push",
