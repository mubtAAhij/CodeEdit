        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    ...
                    Text(String(localized: "source-control.push-local-changes", defaultValue: "Push local changes to", comment: "Section header for pushing local changes"))
                }
                Section {
                ...
                if loading {
                    HStack(spacing: 7.5) {
                        ProgressView()
                            ...
                            .controlSize(.small)
                        Text(String(localized: "source-control.pushing-changes", defaultValue: "Pushing changes...", comment: "Status message while pushing changes"))
                            .font(.subheadline)
                    }
                }
                Spacer()
