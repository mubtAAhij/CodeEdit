            ...
            Form {
                Section {
                    ...
                    Text(String(
                        ...
                        comment: "Label for destination remote when pushing changes"
                    ))
                }
                Section {
                    Toggle(String(
                    ...
                    Toggle(String(
                        ...
                        comment: "Toggle label for including tags when pushing"
            ...
            HStack {
                if loading {
                    HStack(spacing: 7.5) {
                        ...
                        Text(String(
                            ...
                            comment: "Progress status text while push operation is running"
                        ))
                            .font(.subheadline)
                    }
                }
                ...
                Button {
                    ...
                    Text(String(
                        ...
                        defaultValue: "Cancel",
                        comment: "Cancel button title in push sheet"
                    ))
                        .frame(minWidth: 56)
                }
                .disabled(loading)
                Button(action: submit) {
                    Text(String(
                        ...
                        defaultValue: "Push",
                        comment: "Push button title in push sheet"
                    ))
                        .frame(minWidth: 56)
                }
