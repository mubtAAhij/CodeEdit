        ...
        VStack(spacing: 0) {
            Form {
                Section {
                    ...
                    Text(String(localized: "source-control.push-local-changes-to", defaultValue: "Push local changes to", comment: "Push local changes to section header"))
                }
                Section {
                    Toggle(String(localized: "source-control.force", defaultValue: "Force", comment: "Force toggle"), isOn: $sourceControlManager.operationForce)
                ...
                if loading {
                    HStack(spacing: 7.5) {
                        ProgressView()
                            ...
                            .controlSize(.small)
                        Text(String(localized: "source-control.pushing-changes", defaultValue: "Pushing changes...", comment: "Pushing changes status"))
                            .font(.subheadline)
                    }
                }
                Spacer()
