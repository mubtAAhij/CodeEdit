            ...
            Form {
                Section {
                    ...
                    Text(String(
                        ...
                        comment: "Label for selecting remote destination when pushing changes"
                    ))
                }
                Section {
                    Toggle(String(
            ...
            HStack {
                if loading {
                    HStack(spacing: 7.5) {
                        ...
                        Text(String(
                            ...
                            comment: "Progress text shown while pushing changes"
                        ))
                            .font(.subheadline)
                    }
                }
                ...
                Button(action: submit) {
                    Text(String(
                        ...
                        defaultValue: "Push",
                        comment: "Button title to start push operation"
                    ))
                        .frame(minWidth: 56)
                }
