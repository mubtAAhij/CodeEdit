            ...
            VStack(spacing: 0) {
                Form {
                    Section {
                        ...
                        TextField(String(localized: "source-control.rename-branch.to", defaultValue: "To", comment: "Label for target branch name"), text: $name)
                    } header: {
                        ...
                        Text(String(localized: "source-control.rename-branch.description", defaultValue: "All uncommited changes will be preserved on the renamed branch.", comment: "Description explaining uncommitted changes preservation"))
                    }
                }
                .formStyle(.grouped)
                .scrollDisabled(true)
                ...
                HStack {
                    ...
                    Button {
                        ...
                        Text(String(localized: "source-control.rename-branch.button", defaultValue: "Rename", comment: "Button to rename branch"))
                            .frame(minWidth: 56)
                    }
        ...
        Task {
            do {
                ...
                await sourceControlManager.showAlertForError(
                    title: String(localized: "source-control.rename-branch.failed", defaultValue: "Failed to create branch", comment: "Error message when branch rename fails"),
                    error: error
                )
            }
        }
