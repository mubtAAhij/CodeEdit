                ...
                Form {
                    Section {
                        LabeledContent(String(
                            ...
                            defaultValue: "From",
                            comment: "Label for current branch name"
                        ), value: branch.name)
                        TextField(String(
                        ...
                        Text(String(
                            ...
                            comment: "Section header for rename branch dialog"
                        ))
                        Text(String(
                            ...
                            comment: "Description explaining uncommitted changes preservation"
                        ))
                    }
                }
                .formStyle(.grouped)
                ...
                HStack {
                    ...
                    Button {
                        ...
                        Text(String(
                            ...
                            defaultValue: "Cancel",
                            comment: "Button to cancel rename operation"
                        ))
                            .frame(minWidth: 56)
                    }
                    Button {
                        ...
                        Text(String(
                            ...
                            defaultValue: "Rename",
                            comment: "Button to rename branch"
                        ))
                            .frame(minWidth: 56)
                    }
        ...
        Task {
            do {
                ...
                await sourceControlManager.showAlertForError(
                    title: String(
                        localized: "source-control.rename-branch.failed",
                        defaultValue: "Failed to create branch",
                        comment: "Error title when branch rename fails"
                    ),
                    error: error
                )
            }
