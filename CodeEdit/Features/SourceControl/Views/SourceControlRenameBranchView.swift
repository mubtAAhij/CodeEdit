            ...
            VStack(spacing: 0) {
                Form {
                    Section {
                        ...
                        TextField(String(localized: "source-control.rename-branch.to", defaultValue: "To", comment: "To label"), text: $name)
                    } header: {
                ...
                HStack {
                    ...
                    Button {
                        ...
                        Text(String(localized: "source-control.rename-branch.button", defaultValue: "Rename", comment: "Rename button"))
                            .frame(minWidth: 56)
                    }
