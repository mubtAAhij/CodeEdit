            ...
            VStack(spacing: 0) {
                Form {
                    Section {
                        ...
                        Text(String(localized: "source-control.uncommited-changes-preserved", defaultValue: "All uncommited changes will be preserved on the renamed branch.", comment: "Uncommited changes preserved description"))
                    }
                }
                .formStyle(.grouped)
                .scrollDisabled(true)
        ...
        Task {
            do {
                ...
                await sourceControlManager.showAlertForError(
                    title: String(localized: "source-control.failed-to-create-branch", defaultValue: "Failed to create branch", comment: "Failed to create branch error"),
                    error: error
                )
            }
        }
