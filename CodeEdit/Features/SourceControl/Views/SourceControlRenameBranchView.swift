            ...
            VStack(spacing: 0) {
                Form {
                    Section {
                        ...
                        Text(String(localized: "source-control.rename-branch.title", defaultValue: "Rename branch", comment: "Title for rename branch section"))
                        Text(String(localized: "source-control.rename-branch.description", defaultValue: "All uncommited changes will be preserved on the renamed branch.", comment: "Description for rename branch operation"))
                    }
                }
                .formStyle(.grouped)
                .scrollDisabled(true)
