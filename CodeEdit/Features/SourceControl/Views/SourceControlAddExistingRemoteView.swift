...
struct SourceControlAddExistingRemoteView: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            Form {
                Section(String(localized: "source-control.add-remote.title", defaultValue: "Add Remote", comment: "Title for add remote section")) {
            ...
            HStack {
                ...
                Button {
                    ...
                    Text(String(localized: "source-control.add-remote.button", defaultValue: "Add", comment: "Button to add remote"))
                        .frame(minWidth: 56)
                }
