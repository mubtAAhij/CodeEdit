...
extension CEWorkspaceFileManager {
    ...
    public func delete(file: CEWorkspaceFile, confirmDelete: Bool = true) throws {
        ...
        deleteConfirmation.messageText = String(localized: "file-manager.delete-confirmation", defaultValue: "Do you want to delete "\(fileName)"?", comment: "Alert message asking to confirm file deletion")
        deleteConfirmation.informativeText = String(localized: "file-manager.delete-warning", defaultValue: "This item will be deleted immediately. You can't undo this action.", comment: "Warning that file deletion is permanent")
        deleteConfirmation.alertStyle = .critical
        deleteConfirmation.addButton(withTitle: String(localized: "button.delete", defaultValue: "Delete", comment: "Button to delete an item"))
        deleteConfirmation.buttons.last?.hasDestructiveAction = true
        deleteConfirmation.addButton(withTitle: String(localized: "button.cancel", defaultValue: "Cancel", comment: "Button to cancel an action"))
    ...
    public func batchDelete(files: Set<CEWorkspaceFile>, confirmDelete: Bool = true) throws {
        let deleteConfirmation = NSAlert()
        deleteConfirmation.messageText = String(localized: "file-manager.batch-delete-confirmation", defaultValue: "Are you sure you want to delete the \(files.count) selected items?", comment: "Alert message asking to confirm deletion of multiple files")
        // swiftlint:disable:next line_length
        deleteConfirmation.informativeText = String(localized: "file-manager.batch-delete-warning", defaultValue: "\(files.count) items will be deleted immediately. You cannot undo this action.", comment: "Warning that multiple file deletion is permanent")
        deleteConfirmation.alertStyle = .critical
        deleteConfirmation.addButton(withTitle: String(localized: "button.delete", defaultValue: "Delete", comment: "Button to delete an item"))
        deleteConfirmation.buttons.last?.hasDestructiveAction = true
        deleteConfirmation.addButton(withTitle: String(localized: "button.cancel", defaultValue: "Cancel", comment: "Button to cancel an action"))
