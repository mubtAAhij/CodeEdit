...
extension CEWorkspaceFileManager {
    ...
    public func delete(file: CEWorkspaceFile, confirmDelete: Bool = true) throws {
        ...
        deleteConfirmation.messageText = String(format: String(localized: "file-manager.delete-confirmation.message", defaultValue: "Do you want to delete \"%@\"?", comment: "Delete confirmation message for single file"), fileName)
        deleteConfirmation.informativeText = String(localized: "file-manager.delete-confirmation.info", defaultValue: "This item will be deleted immediately. You can't undo this action.", comment: "Delete confirmation informative text")
        deleteConfirmation.alertStyle = .critical
        deleteConfirmation.addButton(withTitle: String(localized: "common.delete", defaultValue: "Delete", comment: "Delete button label"))
        deleteConfirmation.buttons.last?.hasDestructiveAction = true
        deleteConfirmation.addButton(withTitle: String(localized: "common.cancel", defaultValue: "Cancel", comment: "Cancel button label"))
    ...
    public func batchDelete(files: Set<CEWorkspaceFile>, confirmDelete: Bool = true) throws {
        let deleteConfirmation = NSAlert()
        deleteConfirmation.messageText = String(format: String(localized: "file-manager.delete-multiple.message", defaultValue: "Are you sure you want to delete the %d selected items?", comment: "Delete confirmation message for multiple files"), files.count)
        // swiftlint:disable:next line_length
        deleteConfirmation.informativeText = String(format: String(localized: "file-manager.delete-multiple.info", defaultValue: "%d items will be deleted immediately. You cannot undo this action.", comment: "Delete multiple files informative text"), files.count)
        deleteConfirmation.alertStyle = .critical
        deleteConfirmation.addButton(withTitle: String(localized: "common.delete", defaultValue: "Delete", comment: "Delete button label"))
        deleteConfirmation.buttons.last?.hasDestructiveAction = true
        deleteConfirmation.addButton(withTitle: String(localized: "common.cancel", defaultValue: "Cancel", comment: "Cancel button label"))
    ...
    public func duplicate(file: CEWorkspaceFile) throws {
        ...
        while fileManager.fileExists(atPath: fileUrl.path) {
            ...
            fileUrl = fileUrl.deletingLastPathComponent().appending(path: String(format: String(localized: "file-manager.duplicate-name", defaultValue: "%@ copy%@", comment: "Duplicate file name format"), fileName, fileExtension))
        }
