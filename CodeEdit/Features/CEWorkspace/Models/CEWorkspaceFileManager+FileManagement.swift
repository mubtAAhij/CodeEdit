...
extension CEWorkspaceFileManager {
    ...
    public func delete(file: CEWorkspaceFile, confirmDelete: Bool = true) throws {
        ...
        deleteConfirmation.informativeText = String(localized: "delete_item_warning", comment: "Warning message about permanent deletion")
        deleteConfirmation.alertStyle = .critical
        deleteConfirmation.addButton(withTitle: String(localized: "delete_button", comment: "Delete button label"))
        deleteConfirmation.buttons.last?.hasDestructiveAction = true
        deleteConfirmation.addButton(withTitle: String(localized: "cancel_button", comment: "Cancel button label"))
    ...
    public func batchDelete(files: Set<CEWorkspaceFile>, confirmDelete: Bool = true) throws {
        let deleteConfirmation = NSAlert()
        deleteConfirmation.messageText = String(localized: "delete_multiple_files_confirmation", comment: "Confirmation dialog for deleting multiple files")
        // swiftlint:disable:next line_length
        deleteConfirmation.informativeText = String(localized: "delete_multiple_items_warning", comment: "Warning message about permanent deletion of multiple items")
        deleteConfirmation.alertStyle = .critical
        deleteConfirmation.addButton(withTitle: String(localized: "delete_button", comment: "Delete button label"))
        deleteConfirmation.buttons.last?.hasDestructiveAction = true
        deleteConfirmation.addButton(withTitle: String(localized: "cancel_button", comment: "Cancel button label"))
    ...
    public func duplicate(file: CEWorkspaceFile) throws {
        ...
        while fileManager.fileExists(atPath: fileUrl.path) {
            ...
            fileUrl = fileUrl.deletingLastPathComponent().appending(path: String(localized: "file_copy_name", comment: "Template for copied file names"))
        }
