...
extension CEWorkspaceFileManager {
    ...
    public func delete(file: CEWorkspaceFile, confirmDelete: Bool = true) throws {
        ...
        deleteConfirmation.messageText = String(localized: "delete.file.confirmation \(fileName)", comment: "Delete file confirmation message")
        deleteConfirmation.informativeText = String(localized: "delete.file.warning", comment: "Delete file warning")
    ...
    public func batchDelete(files: Set<CEWorkspaceFile>, confirmDelete: Bool = true) throws {
        let deleteConfirmation = NSAlert()
        deleteConfirmation.messageText = String(localized: "delete.multiple.confirmation \(files.count)", comment: "Delete multiple files confirmation message")
        // swiftlint:disable:next line_length
        deleteConfirmation.informativeText = String(localized: "delete.multiple.warning \(files.count)", comment: "Delete multiple files warning")
        deleteConfirmation.alertStyle = .critical
        deleteConfirmation.addButton(withTitle: String(localized: "actions.delete", comment: "Delete button"))
        deleteConfirmation.buttons.last?.hasDestructiveAction = true
        deleteConfirmation.addButton(withTitle: String(localized: "actions.cancel", comment: "Cancel button"))
