...
extension CEWorkspaceFileManager {
    ...
    public func delete(file: CEWorkspaceFile, confirmDelete: Bool = true) throws {
        ...
        deleteConfirmation.informativeText = String(localized: "delete_warning_immediate", comment: "Warning about immediate deletion")
        deleteConfirmation.alertStyle = .critical
        deleteConfirmation.addButton(withTitle: String(localized: "delete", comment: "Delete button"))
        deleteConfirmation.buttons.last?.hasDestructiveAction = true
        deleteConfirmation.addButton(withTitle: String(localized: "cancel", comment: "Cancel button"))
    ...
    public func batchDelete(files: Set<CEWorkspaceFile>, confirmDelete: Bool = true) throws {
        let deleteConfirmation = NSAlert()
        deleteConfirmation.messageText = String(localized: "confirm_delete_multiple_files", defaultValue: "Are you sure you want to delete the \(files.count) selected items?", comment: "Confirmation dialog for deleting multiple files")
        // swiftlint:disable:next line_length
        deleteConfirmation.informativeText = String(localized: "delete_warning_multiple_immediate", defaultValue: "\(files.count) items will be deleted immediately. You cannot undo this action.", comment: "Warning about immediate deletion of multiple items")
        deleteConfirmation.alertStyle = .critical
