...
extension CEWorkspaceFileManager {
    ...
    public func delete(file: CEWorkspaceFile, confirmDelete: Bool = true) throws {
        ...
        deleteConfirmation.messageText = String(localized: "delete.file.message", comment: "Delete file confirmation message", arguments: fileName)
        deleteConfirmation.informativeText = String(localized: "delete.file.description", comment: "Delete file description")
        deleteConfirmation.alertStyle = .critical
        deleteConfirmation.addButton(withTitle: String(localized: "delete.file.delete", comment: "Button text"))
        deleteConfirmation.buttons.last?.hasDestructiveAction = true
        deleteConfirmation.addButton(withTitle: String(localized: "delete.file.cancel", comment: "Button text"))
    ...
    public func batchDelete(files: Set<CEWorkspaceFile>, confirmDelete: Bool = true) throws {
        let deleteConfirmation = NSAlert()
        deleteConfirmation.messageText = String(localized: "delete.multipleFiles.message", comment: "Delete multiple files confirmation message", arguments: files.count)
        // swiftlint:disable:next line_length
        deleteConfirmation.informativeText = String(localized: "delete.multipleFiles.description", comment: "Delete multiple files description", arguments: files.count)
        deleteConfirmation.alertStyle = .critical
        deleteConfirmation.addButton(withTitle: String(localized: "delete.multipleFiles.delete", comment: "Button text"))
        deleteConfirmation.buttons.last?.hasDestructiveAction = true
        deleteConfirmation.addButton(withTitle: String(localized: "delete.multipleFiles.cancel", comment: "Button text"))
