...
extension CEWorkspaceFileManager {
    ...
    public func batchDelete(files: Set<CEWorkspaceFile>, confirmDelete: Bool = true) throws {
        let deleteConfirmation = NSAlert()
        deleteConfirmation.messageText = String(localized: "file_manager.delete.confirm_multiple", arguments: [files.count], comment: "Confirmation message to delete multiple files")
