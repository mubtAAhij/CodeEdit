...
extension CEWorkspaceFileManager {
    ...
    public func delete(file: CEWorkspaceFile, confirmDelete: Bool = true) throws {
        ...
        deleteConfirmation.messageText = String(format: String(localized: "workspace.delete.confirm", defaultValue: "Do you want to delete \"%@\"?", comment: "Delete file confirmation message"), fileName)
        deleteConfirmation.informativeText = String(localized: "workspace.delete.warning", defaultValue: "This item will be deleted immediately. You can't undo this action.", comment: "Delete file warning message")
    ...
    public func batchDelete(files: Set<CEWorkspaceFile>, confirmDelete: Bool = true) throws {
        let deleteConfirmation = NSAlert()
        deleteConfirmation.messageText = String(format: String(localized: "workspace.delete-multiple.confirm", defaultValue: "Are you sure you want to delete the %d selected items?", comment: "Delete multiple files confirmation message"), files.count)
        // swiftlint:disable:next line_length
        deleteConfirmation.informativeText = String(format: String(localized: "workspace.delete-multiple.warning", defaultValue: "%d items will be deleted immediately. You cannot undo this action.", comment: "Delete multiple files warning message"), files.count)
        deleteConfirmation.alertStyle = .critical
        deleteConfirmation.addButton(withTitle: String(localized: "workspace.delete.button", defaultValue: "Delete", comment: "Delete button"))
        deleteConfirmation.buttons.last?.hasDestructiveAction = true
        deleteConfirmation.addButton(withTitle: String(localized: "common.cancel", defaultValue: "Cancel", comment: "Cancel button"))
    ...
    public func duplicate(file: CEWorkspaceFile) throws {
        ...
        while fileManager.fileExists(atPath: fileUrl.path) {
            ...
            fileUrl = fileUrl.deletingLastPathComponent().appending(path: String(format: String(localized: "workspace.duplicate.name", defaultValue: "%@ copy%@", comment: "Duplicate file name format"), fileName, fileExtension))
        }
