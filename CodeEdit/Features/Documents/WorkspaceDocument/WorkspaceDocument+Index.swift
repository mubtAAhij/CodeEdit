...
extension WorkspaceDocument.SearchState {
    ...
    func addProjectToIndex() {
        ...
        let createInfo: [String: Any] = [
            ...
            "action": "create",
            "title": String(
                localized: "workspace-document.index.progress-title",
                defaultValue: "Indexing | Processing files",
                comment: "Progress notification title while indexing workspace files"
            ),
            "message": String(
                localized: "workspace-document.index.progress-description",
                defaultValue: "Creating an index to enable fast and accurate searches within your codebase.",
                comment: "Progress notification description while building workspace index"
            ),
            "isLoading": true
        ]
        ...
        Task.detached {
            ...
            let updateInfo: [String: Any] = [
                ...
                "title": String(
                    ...
                    comment: "Completion notification title after workspace indexing finishes"
                ),
                "isLoading": false
            ]
            NotificationCenter.default.post(name: .taskNotification, object: nil, userInfo: updateInfo)
