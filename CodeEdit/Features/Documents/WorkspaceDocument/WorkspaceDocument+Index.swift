...
extension WorkspaceDocument.SearchState {
    ...
    func addProjectToIndex() {
        ...
        let createInfo: [String: Any] = [
            "id": uuidString,
            "action": "create",
            "title": String(localized: "indexing.processing-files", defaultValue: "Indexing | Processing files", comment: "Title for indexing notification"),
            "message": String(localized: "indexing.creating-index", defaultValue: "Creating an index to enable fast and accurate searches within your codebase.", comment: "Message explaining indexing process"),
            "isLoading": true
        ]
        ...
        Task.detached {
            ...
            let updateInfo: [String: Any] = [
                "id": uuidString,
                "action": "update",
                "title": String(localized: "indexing.finished", defaultValue: "Finished indexing", comment: "Title when indexing is complete"),
                "isLoading": false
            ]
            NotificationCenter.default.post(name: .taskNotification, object: nil, userInfo: updateInfo)
