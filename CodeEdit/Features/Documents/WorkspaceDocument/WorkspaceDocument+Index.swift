...
extension WorkspaceDocument.SearchState {
    ...
    func addProjectToIndex() {
        ...
        let createInfo: [String: Any] = [
            "id": uuidString,
            "action": "create",
            "title": String(localized: "find.indexing-title", defaultValue: "Indexing | Processing files", comment: "Indexing notification title"),
            "message": String(localized: "find.indexing-message", defaultValue: "Creating an index to enable fast and accurate searches within your codebase.", comment: "Indexing notification message"),
            "isLoading": true
        ]
        ...
        Task.detached {
            ...
            let updateInfo: [String: Any] = [
                "id": uuidString,
                "action": "update",
                "title": String(localized: "find.indexing-finished", defaultValue: "Finished indexing", comment: "Indexing finished notification"),
                "isLoading": false
            ]
            NotificationCenter.default.post(name: .taskNotification, object: nil, userInfo: updateInfo)
