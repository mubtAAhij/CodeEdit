...
extension WorkspaceDocument.SearchState {
    ...
    func addProjectToIndex() {
        ...
        let createInfo: [String: Any] = [
            "id": uuidString,
            "action": "create",
            "title": String(localized: "workspace.indexing.title", defaultValue: "Indexing | Processing files", comment: "Notification title when workspace indexing starts"),
            "message": String(localized: "workspace.indexing.message", defaultValue: "Creating an index to enable fast and accurate searches within your codebase.", comment: "Notification message explaining indexing process"),
            "isLoading": true
        ]
        ...
        Task.detached {
            ...
            let updateInfo: [String: Any] = [
                "id": uuidString,
                "action": "update",
                "title": String(localized: "workspace.indexing.finished", defaultValue: "Finished indexing", comment: "Notification title when workspace indexing completes"),
                "isLoading": false
            ]
            NotificationCenter.default.post(name: .taskNotification, object: nil, userInfo: updateInfo)
