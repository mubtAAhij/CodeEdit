...
extension WorkspaceDocument.SearchState {
    ...
    func addProjectToIndex() {
        ...
        let createInfo: [String: Any] = [
            "id": uuidString,
            "action": "create",
            "title": "String(localized: "indexing_processing_files", comment: "Title for indexing notification")",
            "message": "String(localized: "indexing_description", comment: "Description of the indexing process")",
            "isLoading": true
        ]
        ...
        Task.detached {
            ...
            let updateInfo: [String: Any] = [
                "id": uuidString,
                "action": "update",
                "title": "String(localized: "finished_indexing", comment: "Message when indexing is complete")",
                "isLoading": false
            ]
            NotificationCenter.default.post(name: .taskNotification, object: nil, userInfo: updateInfo)
