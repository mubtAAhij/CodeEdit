...
extension WorkspaceDocument.SearchState {
    ...
    func addProjectToIndex() {
        ...
        let createInfo: [String: Any] = [
            "id": uuidString,
            "action": "create",
            "title": String(localized: "workspace_document.indexing.processing_files", defaultValue: "Indexing | Processing files", comment: "Indexing progress title shown while processing workspace files"),
            "message": String(localized: "workspace_document.indexing.create_index_message", defaultValue: "Creating an index to enable fast and accurate searches within your codebase.", comment: "Message explaining why workspace index creation is in progress"),
            "isLoading": true
        ]
        ...
        Task.detached {
            ...
            let updateInfo: [String: Any] = [
                "id": uuidString,
                "action": "update",
                "title": String(localized: "workspace_document.indexing.finished", defaultValue: "Finished indexing", comment: "Status message shown when workspace indexing has completed"),
                "isLoading": false
            ]
            NotificationCenter.default.post(name: .taskNotification, object: nil, userInfo: updateInfo)
