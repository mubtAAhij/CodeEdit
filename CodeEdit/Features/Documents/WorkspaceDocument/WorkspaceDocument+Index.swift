...
extension WorkspaceDocument.SearchState {
    ...
    func addProjectToIndex() {
        ...
        let createInfo: [String: Any] = [
            "id": uuidString,
            "action": "create",
            "title": String(localized: "indexing.processing_files", defaultValue: "Indexing | Processing files", comment: "Status message"),
            "message": String(localized: "indexing.creating_index_message", defaultValue: "Creating an index to enable fast and accurate searches within your codebase.", comment: "Status message"),
            "isLoading": true
        ]
        ...
        Task.detached {
            ...
            let updateInfo: [String: Any] = [
                "id": uuidString,
                "action": "update",
                "title": String(localized: "indexing.finished", defaultValue: "Finished indexing", comment: "Status message"),
                "isLoading": false
            ]
            NotificationCenter.default.post(name: .taskNotification, object: nil, userInfo: updateInfo)
