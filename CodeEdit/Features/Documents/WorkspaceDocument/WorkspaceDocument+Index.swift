...
extension WorkspaceDocument.SearchState {
    ...
    func addProjectToIndex() {
        ...
        let createInfo: [String: Any] = [
            ...
            "action": "create",
            "title": String(
                localized: "workspace.indexing.progress-title",
                defaultValue: "Indexing | Processing files",
                comment: "Progress title shown while workspace indexer processes files"
            ),
            "message": String(
                localized: "workspace.indexing.progress-message",
                defaultValue: "Creating an index to enable fast and accurate searches within your codebase.",
                comment: "Progress message explaining indexing purpose"
            ),
            "isLoading": true
        ]
        ...
        Task.detached {
            ...
            let updateInfo: [String: Any] = [
                ...
                "action": "update",
                "title": String(
                    localized: "workspace.indexing.finished",
                    defaultValue: "Finished indexing",
                    comment: "Notification title shown when indexing completes"
                ),
                "isLoading": false
            ]
            NotificationCenter.default.post(name: .taskNotification, object: nil, userInfo: updateInfo)
