...
extension WorkspaceDocument.SearchState {
    ...
    func addProjectToIndex() {
        ...
        let createInfo: [String: Any] = [
            "id": uuidString,
            "action": "create",
            "title": String(localized: "workspace.index.title", defaultValue: "Indexing | Processing files", comment: "Title for indexing notification"),
            "message": String(localized: "workspace.index.message", defaultValue: "Creating an index to enable fast and accurate searches within your codebase.", comment: "Message explaining indexing process"),
            "isLoading": true
        ]
