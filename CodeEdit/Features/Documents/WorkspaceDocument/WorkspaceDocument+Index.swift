...
extension WorkspaceDocument.SearchState {
    ...
    func addProjectToIndex() {
        ...
        let createInfo: [String: Any] = [
            "id": uuidString,
            "action": "create",
            "title": String(localized: "indexing.title", defaultValue: "Indexing | Processing files", comment: "Title for indexing notification"),
            "message": String(localized: "indexing.message", defaultValue: "Creating an index to enable fast and accurate searches within your codebase.", comment: "Message explaining the indexing process"),
            "isLoading": true
        ]
        ...
        Task.detached {
            ...
            let updateInfo: [String: Any] = [
                "id": uuidString,
                "action": "update",
                "title": String(localized: "indexing.finished", defaultValue: "Finished indexing", comment: "Title for finished indexing notification"),
                "isLoading": false
            ]
            NotificationCenter.default.post(name: .taskNotification, object: nil, userInfo: updateInfo)
