...
extension WorkspaceDocument.SearchState {
    ...
    func addProjectToIndex() {
        ...
        let createInfo: [String: Any] = [
            "id": uuidString,
            "action": "create",
            "title": String(localized: "indexing_processing_files", comment: "Status message during file indexing"),
            "message": String(localized: "creating_index_description", comment: "Description of indexing process"),
            "isLoading": true
        ]
