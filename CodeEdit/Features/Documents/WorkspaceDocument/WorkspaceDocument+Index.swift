...
extension WorkspaceDocument.SearchState {
    ...
    func addProjectToIndex() {
        ...
        let createInfo: [String: Any] = [
            "id": uuidString,
            "action": "create",
            "title": "String(localized: "indexing_processing_files", comment: "Status message during file indexing process")",
            "message": "String(localized: "creating_search_index", comment: "Description of indexing process for search functionality")",
            "isLoading": true
        ]
        ...
        Task.detached {
            ...
            let updateInfo: [String: Any] = [
                "id": uuidString,
                "action": "update",
                "title": "String(localized: "finished_indexing", comment: "Status message when indexing is complete")",
                "isLoading": false
            ]
            NotificationCenter.default.post(name: .taskNotification, object: nil, userInfo: updateInfo)
