...
extension WorkspaceDocument.SearchState {
    ...
    func addProjectToIndex() {
        ...
        let createInfo: [String: Any] = [
            "id": uuidString,
            "action": "create",
            "title": String(localized: "workspace.index.processing-title", defaultValue: "Indexing | Processing files", comment: "Title for indexing notification"),
            "message": String(localized: "workspace.index.processing-message", defaultValue: "Creating an index to enable fast and accurate searches within your codebase.", comment: "Message for indexing notification"),
            "isLoading": true
        ]
        ...
        Task.detached {
            ...
            let updateInfo: [String: Any] = [
                "id": uuidString,
                "action": "update",
                "title": String(localized: "workspace.index.finished-title", defaultValue: "Finished indexing", comment: "Title for finished indexing notification"),
                "isLoading": false
            ]
            NotificationCenter.default.post(name: .taskNotification, object: nil, userInfo: updateInfo)
