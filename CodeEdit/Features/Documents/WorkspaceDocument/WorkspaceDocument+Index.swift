...
extension WorkspaceDocument.SearchState {
    ...
    func addProjectToIndex() {
        ...
        let createInfo: [String: Any] = [
            "id": uuidString,
            "action": "create",
            "title": String(localized: "workspace.indexing.title", defaultValue: "Indexing | Processing files", comment: "Indexing workspace notification title"),
            "message": String(localized: "workspace.indexing.message", defaultValue: "Creating an index to enable fast and accurate searches within your codebase.", comment: "Indexing workspace notification message"),
            "isLoading": true
        ]
        ...
        Task.detached {
            ...
            let updateInfo: [String: Any] = [
                "id": uuidString,
                "action": "update",
                "title": String(localized: "workspace.indexing.finished-title", defaultValue: "Finished indexing", comment: "Finished indexing notification title"),
                "isLoading": false
            ]
            NotificationCenter.default.post(name: .taskNotification, object: nil, userInfo: updateInfo)
