...
extension CodeEditWindowController {
    ...
    func registerCommands() {
        CommandManager.shared.addCommand(
            name: String(localized: "quick-open", defaultValue: "Quick Open", comment: "Quick open command name"),
            title: String(localized: "quick-open", defaultValue: "Quick Open", comment: "Quick open command name"),
            id: "quick_open",
            command: { [weak self] in self?.openQuickly(nil) }
        )

        CommandManager.shared.addCommand(
            name: String(localized: "toggle-navigator", defaultValue: "Toggle Navigator", comment: "Toggle navigator command name"),
            title: String(localized: "toggle-navigator", defaultValue: "Toggle Navigator", comment: "Toggle navigator command name"),
            id: "toggle_left_sidebar",
            command: { [weak self] in self?.toggleFirstPanel() }
        )

        CommandManager.shared.addCommand(
            name: String(localized: "toggle-inspector", defaultValue: "Toggle Inspector", comment: "Toggle inspector command name"),
            title: String(localized: "toggle-inspector", defaultValue: "Toggle Inspector", comment: "Toggle inspector command name"),
