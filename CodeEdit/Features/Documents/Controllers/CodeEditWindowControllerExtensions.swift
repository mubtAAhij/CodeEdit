...
extension CodeEditWindowController {
    ...
    func registerCommands() {
        CommandManager.shared.addCommand(
            name: String(localized: "window-controller.quick-open", defaultValue: "Quick Open", comment: "Quick open command name"),
            title: String(localized: "window-controller.quick-open.title", defaultValue: "Quick Open", comment: "Quick open command title"),
            id: "quick_open",
            command: { [weak self] in self?.openQuickly(nil) }
        )

        CommandManager.shared.addCommand(
            name: String(localized: "window-controller.toggle-navigator", defaultValue: "Toggle Navigator", comment: "Toggle navigator command name"),
            title: String(localized: "window-controller.toggle-navigator.title", defaultValue: "Toggle Navigator", comment: "Toggle navigator command title"),
            id: "toggle_left_sidebar",
            command: { [weak self] in self?.toggleFirstPanel() }
        )

        CommandManager.shared.addCommand(
            name: String(localized: "window-controller.toggle-inspector", defaultValue: "Toggle Inspector", comment: "Toggle inspector command name"),
            title: String(localized: "window-controller.toggle-inspector.title", defaultValue: "Toggle Inspector", comment: "Toggle inspector command title"),
    ...
    @IBAction func openWorkspaceSettings(_ sender: Any) {
        ...
        if let workspaceSettingsWindow, workspaceSettingsWindow.isVisible {
            ...
            settingsWindow.setAccessibilityTitle(String(localized: "window-controller.workspace-settings", defaultValue: "Workspace Settings", comment: "Workspace settings accessibility title"))
