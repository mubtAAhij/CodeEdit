...
extension CodeEditWindowController {
    ...
    @IBAction func openWorkspaceSettings(_ sender: Any) {
        ...
        if let workspaceSettingsWindow, workspaceSettingsWindow.isVisible {
            ...
            settingsWindow.setAccessibilityTitle(String(localized: "workspace.workspace-settings", defaultValue: "Workspace Settings", comment: "Workspace settings accessibility title"))
