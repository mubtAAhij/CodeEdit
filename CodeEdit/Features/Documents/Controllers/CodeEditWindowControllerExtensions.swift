...
extension CodeEditWindowController {
    ...
    func registerCommands() {
        CommandManager.shared.addCommand(
            name: String(localized: "commands.quick_open.name", comment: "Command name"),
            title: String(localized: "commands.quick_open.title", comment: "Command title"),
            id: "quick_open",
            command: { [weak self] in self?.openQuickly(nil) }
        )

        CommandManager.shared.addCommand(
            name: String(localized: "commands.toggle_navigator.name", comment: "Command name"),
            title: String(localized: "commands.toggle_navigator.title", comment: "Command title"),
            id: "toggle_left_sidebar",
            command: { [weak self] in self?.toggleFirstPanel() }
        )

        CommandManager.shared.addCommand(
            name: String(localized: "commands.toggle_inspector.name", comment: "Command name"),
            title: String(localized: "commands.toggle_inspector.title", comment: "Command title"),
    ...
    @IBAction func openWorkspaceSettings(_ sender: Any) {
        ...
        if let workspaceSettingsWindow, workspaceSettingsWindow.isVisible {
            ...
            settingsWindow.setAccessibilityTitle(String(localized: "workspace.settings.accessibility_title", comment: "Accessibility title"))
