...
extension CodeEditWindowController {
    ...
    func registerCommands() {
        CommandManager.shared.addCommand(
            name: String(localized: "documents.window.quick-open.title", defaultValue: "Quick Open", comment: "Command title for quick open"),
            title: String(localized: "documents.window.quick-open.accessibility-label", defaultValue: "Quick Open", comment: "Accessibility label for quick open action"),
            id: "quick_open",
            command: { [weak self] in self?.openQuickly(nil) }
        )

        CommandManager.shared.addCommand(
            name: String(localized: "documents.window.toggle-navigator.title", defaultValue: "Toggle Navigator", comment: "Command title for toggling the navigator panel"),
            title: String(localized: "documents.window.toggle-navigator.accessibility-label", defaultValue: "Toggle Navigator", comment: "Accessibility label for toggling the navigator panel"),
            id: "toggle_left_sidebar",
            command: { [weak self] in self?.toggleFirstPanel() }
        )

        CommandManager.shared.addCommand(
            name: String(localized: "documents.window.toggle-inspector.title", defaultValue: "Toggle Inspector", comment: "Command title for toggling the inspector panel"),
            title: String(localized: "documents.window.toggle-inspector.accessibility-label", defaultValue: "Toggle Inspector", comment: "Accessibility label for toggling the inspector panel"),
    ...
    @IBAction func openWorkspaceSettings(_ sender: Any) {
        ...
        if let workspaceSettingsWindow, workspaceSettingsWindow.isVisible {
            ...
            settingsWindow.setAccessibilityTitle(String(localized: "documents.window.workspace-settings.title", defaultValue: "Workspace Settings", comment: "Menu item title for opening workspace settings"))
