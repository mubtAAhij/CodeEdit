...
extension CodeEditWindowController {
    ...
    func registerCommands() {
        CommandManager.shared.addCommand(
            name: String(localized: "commands.quick-open.name", defaultValue: "Quick Open", comment: "Command name for quick open"),
            title: String(localized: "commands.quick-open.title", defaultValue: "Quick Open", comment: "Command title for quick open"),
            id: "quick_open",
            command: { [weak self] in self?.openQuickly(nil) }
        )

        CommandManager.shared.addCommand(
            name: String(localized: "commands.toggle-navigator.name", defaultValue: "Toggle Navigator", comment: "Command name for toggling navigator"),
            title: String(localized: "commands.toggle-navigator.title", defaultValue: "Toggle Navigator", comment: "Command title for toggling navigator"),
            id: "toggle_left_sidebar",
            command: { [weak self] in self?.toggleFirstPanel() }
        )

        CommandManager.shared.addCommand(
            name: String(localized: "commands.toggle-inspector.name", defaultValue: "Toggle Inspector", comment: "Command name for toggling inspector"),
            title: String(localized: "commands.toggle-inspector.title", defaultValue: "Toggle Inspector", comment: "Command title for toggling inspector"),
