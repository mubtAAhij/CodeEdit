...
extension CodeEditWindowController {
    ...
    func registerCommands() {
        CommandManager.shared.addCommand(
            name: "String(localized: "quick_open", comment: "Command name for quick open functionality")",
            title: "String(localized: "quick_open", comment: "Command title for quick open functionality")",
            id: "quick_open",
            command: { [weak self] in self?.openQuickly(nil) }
        )

        CommandManager.shared.addCommand(
            name: "String(localized: "toggle_navigator", comment: "Command name for toggling navigator sidebar")",
            title: "String(localized: "toggle_navigator", comment: "Command title for toggling navigator sidebar")",
            id: "toggle_left_sidebar",
            command: { [weak self] in self?.toggleFirstPanel() }
        )

        CommandManager.shared.addCommand(
            name: "String(localized: "toggle_inspector", comment: "Command name for toggling inspector sidebar")",
            title: "String(localized: "toggle_inspector", comment: "Command title for toggling inspector sidebar")",
    ...
    @IBAction func openWorkspaceSettings(_ sender: Any) {
        ...
        if let workspaceSettingsWindow, workspaceSettingsWindow.isVisible {
            ...
            settingsWindow.setAccessibilityTitle("String(localized: "workspace_settings", comment: "Accessibility title for workspace settings window")")
