...
extension CodeEditWindowController {
    ...
    func registerCommands() {
        CommandManager.shared.addCommand(
            name: String(localized: "command.quick-open", defaultValue: "Quick Open", comment: "Command name for quick open"),
            title: String(localized: "command.quick-open", defaultValue: "Quick Open", comment: "Command name for quick open"),
            id: "quick_open",
            command: { [weak self] in self?.openQuickly(nil) }
        )

        CommandManager.shared.addCommand(
            name: String(localized: "command.toggle-navigator", defaultValue: "Toggle Navigator", comment: "Command name for toggling navigator"),
            title: String(localized: "command.toggle-navigator", defaultValue: "Toggle Navigator", comment: "Command name for toggling navigator"),
            id: "toggle_left_sidebar",
            command: { [weak self] in self?.toggleFirstPanel() }
        )

        CommandManager.shared.addCommand(
            name: String(localized: "command.toggle-inspector", defaultValue: "Toggle Inspector", comment: "Command name for toggling inspector"),
            title: String(localized: "command.toggle-inspector", defaultValue: "Toggle Inspector", comment: "Command name for toggling inspector"),
    ...
    @IBAction func openWorkspaceSettings(_ sender: Any) {
        ...
        if let workspaceSettingsWindow, workspaceSettingsWindow.isVisible {
            ...
            settingsWindow.setAccessibilityTitle(String(localized: "workspace.settings", defaultValue: "Workspace Settings", comment: "Accessibility title for workspace settings window"))
