...
extension CodeEditWindowController {
    ...
    @IBAction func openWorkspaceSettings(_ sender: Any) {
        ...
        if let workspaceSettingsWindow, workspaceSettingsWindow.isVisible {
            ...
            settingsWindow.setAccessibilityTitle(String(localized: "documents.window.workspace-settings", defaultValue: "Workspace Settings", comment: "Menu or command title to open workspace settings"))
