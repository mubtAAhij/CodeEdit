...
extension CodeEditWindowController {
    ...
    func registerCommands() {
        CommandManager.shared.addCommand(
            name: String(localized: "command.quick_open", defaultValue: "Quick Open", comment: "Command name for quick open"),
        ...
        CommandManager.shared.addCommand(
            name: String(localized: "command.toggle_navigator", defaultValue: "Toggle Navigator", comment: "Command name for toggling navigator"),
            title: String(localized: "command.toggle_navigator.title", defaultValue: "Toggle Navigator", comment: "Command title for toggling navigator"),
            id: "toggle_left_sidebar",
            command: { [weak self] in self?.toggleFirstPanel() }
        )

        CommandManager.shared.addCommand(
            name: String(localized: "command.toggle_inspector", defaultValue: "Toggle Inspector", comment: "Command name for toggling inspector"),
            title: String(localized: "command.toggle_inspector.title", defaultValue: "Toggle Inspector", comment: "Command title for toggling inspector"),
