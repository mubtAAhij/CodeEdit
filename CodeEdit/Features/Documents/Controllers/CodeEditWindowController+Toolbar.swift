...
extension CodeEditWindowController {
    ...
    func toolbar(
        ...
        case .toggleFirstSidebarItem:
            ...
            toolbarItem.label = String(localized: "Navigator Sidebar", comment: "Toolbar label")
            toolbarItem.paletteLabel = String(localized: " Navigator Sidebar", comment: "Toolbar label")
            toolbarItem.toolTip = String(localized: "Hide or show the Navigator", comment: "Tooltip text")
        ...
        case .toggleLastSidebarItem:
            ...
            toolbarItem.label = String(localized: "Inspector Sidebar", comment: "Toolbar label")
            toolbarItem.paletteLabel = String(localized: "Inspector Sidebar", comment: "Toolbar label")
            toolbarItem.toolTip = String(localized: "Hide or show the Inspectors", comment: "Tooltip text")
            toolbarItem.isBordered = true
            toolbarItem.target = self
