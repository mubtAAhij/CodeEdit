...
extension CodeEditWindowController {
    ...
    func updateToolbarVisibility() {
        if toolbarCollapsed {
            ...
            window?.title = workspace?.workspaceFileManager?.folderUrl.lastPathComponent ?? String(localized: "window.title.empty", defaultValue: "Empty", comment: "Empty window title placeholder")
            window?.toolbar = nil
        } else {
    ...
    func toolbar(
        ...
        case .toggleFirstSidebarItem:
            ...
            toolbarItem.paletteLabel = String(localized: "toolbar.navigator-sidebar", defaultValue: " Navigator Sidebar", comment: "Navigator sidebar toolbar item label")
            toolbarItem.toolTip = String(localized: "toolbar.navigator-sidebar.tooltip", defaultValue: "Hide or show the Navigator", comment: "Navigator sidebar toolbar item tooltip")
        ...
        case .toggleLastSidebarItem:
            ...
            toolbarItem.paletteLabel = String(localized: "toolbar.inspector-sidebar", defaultValue: "Inspector Sidebar", comment: "Inspector sidebar toolbar item label")
            toolbarItem.toolTip = String(localized: "toolbar.inspector-sidebar.tooltip", defaultValue: "Hide or show the Inspectors", comment: "Inspector sidebar toolbar item tooltip")
            toolbarItem.isBordered = true
            toolbarItem.target = self
