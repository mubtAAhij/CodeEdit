...
extension CodeEditWindowController {
    ...
    func toolbar(
        ...
        case .toggleFirstSidebarItem:
            ...
            toolbarItem.label = "String(localized: "navigator_sidebar", comment: "Label for navigator sidebar toolbar item")"
            toolbarItem.paletteLabel = "String(localized: "navigator_sidebar_palette", comment: "Palette label for navigator sidebar toolbar item")"
        ...
        case .toggleLastSidebarItem:
            ...
            toolbarItem.label = "String(localized: "inspector_sidebar", comment: "Label for inspector sidebar toolbar item")"
            toolbarItem.paletteLabel = "String(localized: "inspector_sidebar", comment: "Palette label for inspector sidebar toolbar item")"
