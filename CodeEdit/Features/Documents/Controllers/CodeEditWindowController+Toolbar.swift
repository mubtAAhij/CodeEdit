...
extension CodeEditWindowController {
    ...
    func updateToolbarVisibility() {
        if toolbarCollapsed {
            ...
            window?.title = workspace?.workspaceFileManager?.folderUrl.lastPathComponent ?? "String(localized: "empty", comment: "Default window title when no workspace is open")"
            window?.toolbar = nil
        } else {
    ...
    func toolbar(
        ...
        case .toggleFirstSidebarItem:
            ...
            toolbarItem.label = "String(localized: "navigator_sidebar", comment: "Toolbar item label for navigator sidebar toggle")"
            toolbarItem.paletteLabel = "String(localized: "navigator_sidebar_palette", comment: "Toolbar item palette label for navigator sidebar toggle")"
            toolbarItem.toolTip = "String(localized: "hide_show_navigator", comment: "Tooltip for navigator sidebar toggle button")"
        ...
        case .toggleLastSidebarItem:
            ...
            toolbarItem.label = "String(localized: "inspector_sidebar", comment: "Toolbar item label for inspector sidebar toggle")"
            toolbarItem.paletteLabel = "String(localized: "inspector_sidebar_palette", comment: "Toolbar item palette label for inspector sidebar toggle")"
            toolbarItem.toolTip = "String(localized: "hide_show_inspectors", comment: "Tooltip for inspector sidebar toggle button")"
            toolbarItem.isBordered = true
            toolbarItem.target = self
