...
extension CodeEditWindowController {
    ...
    func updateToolbarVisibility() {
        if toolbarCollapsed {
            ...
            window?.title = workspace?.workspaceFileManager?.folderUrl.lastPathComponent ?? "String(localized: "empty", comment: "Default window title when no workspace is loaded")"
            window?.toolbar = nil
        } else {
    ...
    func toolbar(
        ...
        case .toggleFirstSidebarItem:
            ...
            toolbarItem.paletteLabel = "String(localized: "navigator_sidebar", comment: "Toolbar item palette label for navigator sidebar toggle")"
        ...
        case .toggleLastSidebarItem:
            ...
            toolbarItem.paletteLabel = "String(localized: "inspector_sidebar", comment: "Toolbar item palette label for inspector sidebar toggle")"
