...
extension CodeEditWindowController {
    ...
    func toolbar(
        ...
        case .toggleFirstSidebarItem:
            ...
            toolbarItem.toolTip = String(localized: "toolbar.toggle-navigator-tooltip", defaultValue: "Hide or show the Navigator", comment: "Tooltip for toggle navigator button")
        ...
        case .toggleLastSidebarItem:
            ...
            toolbarItem.toolTip = String(localized: "toolbar.toggle-inspector-tooltip", defaultValue: "Hide or show the Inspectors", comment: "Tooltip for toggle inspector button")
            toolbarItem.isBordered = true
            toolbarItem.target = self
