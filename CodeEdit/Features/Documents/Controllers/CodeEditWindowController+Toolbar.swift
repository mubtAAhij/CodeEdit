...
extension CodeEditWindowController {
    ...
    func toolbar(
        ...
        case .toggleFirstSidebarItem:
            ...
            toolbarItem.label = String(localized: "toolbar.navigator-sidebar", defaultValue: "Navigator Sidebar", comment: "Label for navigator sidebar toolbar item")
            toolbarItem.paletteLabel = String(localized: "toolbar.navigator-sidebar-palette", defaultValue: " Navigator Sidebar", comment: "Palette label for navigator sidebar toolbar item")
        ...
        case .toggleLastSidebarItem:
            ...
            toolbarItem.label = String(localized: "toolbar.inspector-sidebar", defaultValue: "Inspector Sidebar", comment: "Label for inspector sidebar toolbar item")
            toolbarItem.paletteLabel = String(localized: "toolbar.inspector-sidebar-palette", defaultValue: "Inspector Sidebar", comment: "Palette label for inspector sidebar toolbar item")
