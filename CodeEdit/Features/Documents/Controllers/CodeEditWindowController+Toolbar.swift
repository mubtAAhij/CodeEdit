...
extension CodeEditWindowController {
    ...
    func updateToolbarVisibility() {
        if toolbarCollapsed {
            ...
            window?.title = workspace?.workspaceFileManager?.folderUrl.lastPathComponent ?? String(localized: "toolbar.empty", defaultValue: "Empty", comment: "Empty workspace")
            window?.toolbar = nil
        } else {
    ...
    func toolbar(
        ...
        case .toggleFirstSidebarItem:
            ...
            toolbarItem.paletteLabel = String(localized: "toolbar.navigator-sidebar", defaultValue: " Navigator Sidebar", comment: "Navigator sidebar label")
            toolbarItem.toolTip = String(localized: "toolbar.toggle-navigator", defaultValue: "Hide or show the Navigator", comment: "Toggle navigator tooltip")
        ...
        case .toggleLastSidebarItem:
            ...
            toolbarItem.paletteLabel = String(localized: "toolbar.inspector-sidebar", defaultValue: "Inspector Sidebar", comment: "Inspector sidebar label")
            toolbarItem.toolTip = String(localized: "toolbar.toggle-inspectors", defaultValue: "Hide or show the Inspectors", comment: "Toggle inspectors tooltip")
            toolbarItem.isBordered = true
            toolbarItem.target = self
