...
extension CodeEditWindowController {
    ...
    func updateToolbarVisibility() {
        if toolbarCollapsed {
            ...
            window?.title = workspace?.workspaceFileManager?.folderUrl.lastPathComponent ?? String(localized: "window.empty", defaultValue: "Empty", comment: "Empty window title")
            window?.toolbar = nil
        } else {
    ...
    func toolbar(
        ...
        case .toggleFirstSidebarItem:
            ...
            toolbarItem.toolTip = String(localized: "toolbar.navigator-sidebar-tooltip", defaultValue: "Hide or show the Navigator", comment: "Navigator sidebar tooltip")
        ...
        case .toggleLastSidebarItem:
            ...
            toolbarItem.toolTip = String(localized: "toolbar.inspector-sidebar-tooltip", defaultValue: "Hide or show the Inspectors", comment: "Inspector sidebar tooltip")
            toolbarItem.isBordered = true
            toolbarItem.target = self
