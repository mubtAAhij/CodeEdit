    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                ...
                Button(String(localized: "editor.tab-bar.context-menu.close-tabs-to-right", defaultValue: "Close Tabs to the Right", comment: "Context menu action to close tabs located to the right of current tab.")) {
                    withAnimation {
                ...
                if isTemporary {
                    Button(String(localized: "editor.tab-bar.context-menu.keep-open", defaultValue: "Keep Open", comment: "Context menu action to pin or keep current tab open.")) {
