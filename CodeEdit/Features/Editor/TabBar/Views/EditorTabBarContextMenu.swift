    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                ...
                Button(String(localized: "editor.tab-bar.context-menu.close-other-tabs", defaultValue: "Close Other Tabs", comment: "Context menu action to close tabs except current")) {
                    withAnimation {
                        for file in tabs.tabs.map(\.file) {
                            if file != item {
                ...
                Button(String(localized: "editor.tab-bar.context-menu.close-tabs-to-the-right", defaultValue: "Close Tabs to the Right", comment: "Context menu action to close tabs to the right")) {
                    withAnimation {
                ...
                if isTemporary {
                    Button(String(localized: "editor.tab-bar.context-menu.keep-open", defaultValue: "Keep Open", comment: "Context menu action to pin or keep tab open")) {
            ...
            Group {
                Button(String(localized: "editor.tab-bar.context-menu.copy-path", defaultValue: "Copy Path", comment: "Context menu action to copy file path")) {
                    copyPath(item: item)
                }
