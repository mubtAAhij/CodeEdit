...
struct EditorTabBarContextMenu: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                Button(String(localized: "tab.close-tab", defaultValue: "Close Tab", comment: "Close Tab menu item")) {
                    withAnimation {
                ...
                Button(String(localized: "tab.close-other-tabs", defaultValue: "Close Other Tabs", comment: "Close Other Tabs menu item")) {
                    withAnimation {
                ...
                Button(String(localized: "tab.close-tabs-to-the-right", defaultValue: "Close Tabs to the Right", comment: "Close Tabs to the Right menu item")) {
                    withAnimation {
                ...
                Button(String(localized: "tab.close-all", defaultValue: "Close All", comment: "Close All menu item")) {
                    withAnimation {
                        tabs.tabs.forEach {
                            tabs.closeTab(file: $0.file)
                        }
                ...
                if isTemporary {
                    Button(String(localized: "tab.keep-open", defaultValue: "Keep Open", comment: "Keep Open menu item")) {
            ...
            Group {
                Button(String(localized: "tab.copy-path", defaultValue: "Copy Path", comment: "Copy Path menu item")) {
                    copyPath(item: item)
                }

                Button(String(localized: "tab.copy-relative-path", defaultValue: "Copy Relative Path", comment: "Copy Relative Path menu item")) {
            ...
            Group {
                Button(String(localized: "tab.show-in-finder", defaultValue: "Show in Finder", comment: "Show in Finder menu item")) {
                    item.showInFinder()
                }

                Button(String(localized: "tab.reveal-in-project-navigator", defaultValue: "Reveal in Project Navigator", comment: "Reveal in Project Navigator menu item")) {
                    workspace.listenerModel.highlightedFileItem = item
                }

                Button(String(localized: "tab.open-in-new-window", defaultValue: "Open in New Window", comment: "Open in New Window menu item")) {
            ...
            Button(String(localized: "tab.split-up", defaultValue: "Split Up", comment: "Split Up menu item")) {
                moveToNewSplit(.top)
            }
            Button(String(localized: "tab.split-down", defaultValue: "Split Down", comment: "Split Down menu item")) {
                moveToNewSplit(.bottom)
            }
            Button(String(localized: "tab.split-left", defaultValue: "Split Left", comment: "Split Left menu item")) {
                moveToNewSplit(.leading)
            }
            Button(String(localized: "tab.split-right", defaultValue: "Split Right", comment: "Split Right menu item")) {
