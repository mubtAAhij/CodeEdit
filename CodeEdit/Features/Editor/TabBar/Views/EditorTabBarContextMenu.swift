    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                ...
                Button(String(localized: "editor.tab-bar.context-menu.close-tabs-to-the-right", defaultValue: "Close Tabs to the Right", comment: "Context menu action to close tabs positioned to the right")) {
                    withAnimation {
                ...
                if isTemporary {
                    Button(String(localized: "editor.tab-bar.context-menu.keep-open", defaultValue: "Keep Open", comment: "Context menu toggle to keep tab open")) {
            ...
            Group {
                Button(String(localized: "editor.tab-bar.context-menu.copy-path", defaultValue: "Copy Path", comment: "Context menu action to copy absolute path")) {
                    copyPath(item: item)
                }

                Button(String(localized: "editor.tab-bar.context-menu.copy-relative-path", defaultValue: "Copy Relative Path", comment: "Context menu action to copy relative path")) {
