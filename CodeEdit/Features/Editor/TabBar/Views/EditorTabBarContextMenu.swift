...
struct EditorTabBarContextMenu: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                Button(String(localized: "tab-bar.close-tab", defaultValue: "Close Tab", comment: "Close tab menu item")) {
                    withAnimation {
                ...
                Button(String(localized: "tab-bar.close-other-tabs", defaultValue: "Close Other Tabs", comment: "Close other tabs menu item")) {
                    withAnimation {
                ...
                Button(String(localized: "tab-bar.close-tabs-to-right", defaultValue: "Close Tabs to the Right", comment: "Close tabs to the right menu item")) {
                    withAnimation {
                ...
                Button(String(localized: "tab-bar.close-all", defaultValue: "Close All", comment: "Close all tabs menu item")) {
                    withAnimation {
                        tabs.tabs.forEach {
                            tabs.closeTab(file: $0.file)
                        }
                ...
                if isTemporary {
                    Button(String(localized: "tab-bar.keep-open", defaultValue: "Keep Open", comment: "Keep tab open menu item")) {
            ...
            Group {
                Button(String(localized: "tab-bar.copy-path", defaultValue: "Copy Path", comment: "Copy path menu item")) {
                    copyPath(item: item)
                }

                Button(String(localized: "tab-bar.copy-relative-path", defaultValue: "Copy Relative Path", comment: "Copy relative path menu item")) {
            ...
            Group {
                Button(String(localized: "tab-bar.show-in-finder", defaultValue: "Show in Finder", comment: "Show in Finder menu item")) {
                    item.showInFinder()
                }

                Button(String(localized: "tab-bar.reveal-in-navigator", defaultValue: "Reveal in Project Navigator", comment: "Reveal in project navigator menu item")) {
                    workspace.listenerModel.highlightedFileItem = item
                }

                Button(String(localized: "tab-bar.open-in-new-window", defaultValue: "Open in New Window", comment: "Open in new window menu item")) {
            ...
            Button(String(localized: "tab-bar.split-up", defaultValue: "Split Up", comment: "Split up menu item")) {
                moveToNewSplit(.top)
            }
            Button(String(localized: "tab-bar.split-down", defaultValue: "Split Down", comment: "Split down menu item")) {
                moveToNewSplit(.bottom)
            }
            Button(String(localized: "tab-bar.split-left", defaultValue: "Split Left", comment: "Split left menu item")) {
                moveToNewSplit(.leading)
            }
            Button(String(localized: "tab-bar.split-right", defaultValue: "Split Right", comment: "Split right menu item")) {
