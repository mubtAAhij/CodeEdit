    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                ...
                Button(String(localized: "editor.close-tabs-to-right", defaultValue: "Close Tabs to the Right", comment: "Close tabs to the right menu item")) {
                    withAnimation {
                ...
                Button(String(localized: "editor.close-all", defaultValue: "Close All", comment: "Close all tabs menu item")) {
                    withAnimation {
                        tabs.tabs.forEach {
                            tabs.closeTab(file: $0.file)
                        }
                ...
                if isTemporary {
                    Button(String(localized: "editor.keep-open", defaultValue: "Keep Open", comment: "Keep tab open menu item")) {
            ...
            Group {
                ...
                Button(String(localized: "editor.reveal-in-navigator", defaultValue: "Reveal in Project Navigator", comment: "Reveal in project navigator menu item")) {
