    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            ...
            Group {
                ...
                Button(String(localized: "editor.tab-bar.context-menu.open-in-new-window", defaultValue: "Open in New Window", comment: "Context menu action to open editor in a new window")) {
