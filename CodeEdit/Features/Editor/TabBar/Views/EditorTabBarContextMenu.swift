...
struct EditorTabBarContextMenu: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                Button(String(localized: "editor.tab.close", defaultValue: "Close Tab", comment: "Menu item to close current tab")) {
                    withAnimation {
                ...
                Button(String(localized: "editor.tab.close-others", defaultValue: "Close Other Tabs", comment: "Menu item to close other tabs")) {
                    withAnimation {
                ...
                Button(String(localized: "editor.tab.close-right", defaultValue: "Close Tabs to the Right", comment: "Menu item to close tabs to the right")) {
                    withAnimation {
                ...
                Button(String(localized: "editor.tab.close-all", defaultValue: "Close All", comment: "Menu item to close all tabs")) {
                    withAnimation {
                        tabs.tabs.forEach {
                            tabs.closeTab(file: $0.file)
                        }
                ...
                if isTemporary {
                    Button(String(localized: "editor.tab.keep-open", defaultValue: "Keep Open", comment: "Menu item to keep temporary tab open")) {
            ...
            Group {
                Button(String(localized: "editor.tab.copy-path", defaultValue: "Copy Path", comment: "Menu item to copy absolute file path")) {
                    copyPath(item: item)
                }

                Button(String(localized: "editor.tab.copy-relative-path", defaultValue: "Copy Relative Path", comment: "Menu item to copy relative file path")) {
            ...
            Group {
                Button(String(localized: "editor.tab.show-in-finder", defaultValue: "Show in Finder", comment: "Menu item to show file in Finder")) {
                    item.showInFinder()
                }

                Button(String(localized: "editor.tab.reveal-in-navigator", defaultValue: "Reveal in Project Navigator", comment: "Menu item to reveal file in project navigator")) {
                    workspace.listenerModel.highlightedFileItem = item
                }

                Button(String(localized: "editor.tab.open-new-window", defaultValue: "Open in New Window", comment: "Menu item to open file in new window")) {
            ...
            Button(String(localized: "editor.tab.split-up", defaultValue: "Split Up", comment: "Menu item to split editor upward")) {
                moveToNewSplit(.top)
            }
            Button(String(localized: "editor.tab.split-down", defaultValue: "Split Down", comment: "Menu item to split editor downward")) {
                moveToNewSplit(.bottom)
            }
            Button(String(localized: "editor.tab.split-left", defaultValue: "Split Left", comment: "Menu item to split editor to the left")) {
                moveToNewSplit(.leading)
            }
            Button(String(localized: "editor.tab.split-right", defaultValue: "Split Right", comment: "Menu item to split editor to the right")) {
