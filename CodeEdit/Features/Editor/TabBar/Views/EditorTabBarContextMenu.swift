...
struct EditorTabBarContextMenu: ViewModifier {
    ...
    comment: "Context menu action to close all tabs except current"
)) {
                    withAnimation {
    ...
    comment: "Context menu action to close tabs to the right"
)) {
                    withAnimation {
    ...
    comment: "Context menu action to pin tab open"
)) {
    ...
    comment: "Context menu action to split editor up"
)) {
                moveToNewSplit(.top)
            }
                    Button(String(
    ...
    comment: "Context menu action to split editor down"
)) {
    ...
    comment: "Context menu action to split editor left"
)) {
    ...
    comment: "Context menu action to split editor right"
)) {
