    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                ...
                Button(String(localized: "editor.tab-bar.context-menu.close-tabs-to-the-right", defaultValue: "Close Tabs to the Right", comment: "Context menu action to close tabs to the right of current")) {
                    withAnimation {
