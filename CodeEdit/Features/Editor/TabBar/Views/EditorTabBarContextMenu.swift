...
struct EditorTabBarContextMenu: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                Button(String(localized: "close_tab", comment: "Context menu item to close the current tab")) {
                    withAnimation {
                ...
                Button(String(localized: "close_other_tabs", comment: "Context menu item to close all tabs except the current one")) {
                    withAnimation {
                ...
                Button(String(localized: "close_tabs_to_the_right", comment: "Context menu item to close all tabs to the right of the current tab")) {
                    withAnimation {
                ...
                if isTemporary {
                    Button(String(localized: "keep_open", comment: "Context menu item to keep a temporary tab open")) {
            ...
            Group {
                ...
                Button(String(localized: "copy_relative_path", comment: "Context menu item to copy the relative path of the file")) {
            ...
            Group {
                ...
                Button(String(localized: "reveal_in_project_navigator", comment: "Context menu item to reveal the file in the project navigator")) {
                    workspace.listenerModel.highlightedFileItem = item
                }

                Button(String(localized: "open_in_new_window", comment: "Context menu item to open the file in a new window")) {
            ...
            Button(String(localized: "split_up", comment: "Context menu item to split the editor upward")) {
                moveToNewSplit(.top)
            }
            Button(String(localized: "split_down", comment: "Context menu item to split the editor downward")) {
                moveToNewSplit(.bottom)
            }
            Button(String(localized: "split_left", comment: "Context menu item to split the editor to the left")) {
                moveToNewSplit(.leading)
            }
            Button(String(localized: "split_right", comment: "Context menu item to split the editor to the right")) {
