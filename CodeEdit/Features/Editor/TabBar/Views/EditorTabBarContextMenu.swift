    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                ...
                Button(String(localized: "editor.tab-bar.context-menu.close-tabs-to-right", defaultValue: "Close Tabs to the Right", comment: "Context menu action to close tabs to the right")) {
                    withAnimation {
                ...
                if isTemporary {
                    Button(String(localized: "editor.tab-bar.context-menu.keep-open", defaultValue: "Keep Open", comment: "Context menu action to keep current tab open")) {
            ...
            Group {
                ...
                Button(String(localized: "editor.tab-bar.context-menu.copy-relative-path", defaultValue: "Copy Relative Path", comment: "Context menu action to copy file path relative to workspace")) {
