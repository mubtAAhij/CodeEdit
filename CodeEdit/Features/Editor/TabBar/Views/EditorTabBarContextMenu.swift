...
struct EditorTabBarContextMenu: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                Button(String(localized: "close_tab", comment: "Context menu item to close current tab")) {
                    withAnimation {
                ...
                Button(String(localized: "close_other_tabs", comment: "Context menu item to close all tabs except current")) {
                    withAnimation {
                ...
                Button(String(localized: "close_tabs_to_right", comment: "Context menu item to close tabs to the right of current tab")) {
                    withAnimation {
                ...
                if isTemporary {
                    Button(String(localized: "keep_open", comment: "Context menu item to keep temporary tab open")) {
            ...
            Group {
                ...
                Button(String(localized: "copy_relative_path", comment: "Context menu item to copy relative file path")) {
