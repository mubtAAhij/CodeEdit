    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                ...
                Button(String(localized: "editor.tab-bar.context-menu.close-other-tabs", defaultValue: "Close Other Tabs", comment: "Context menu action to close all tabs except current")) {
                    withAnimation {
                ...
                if isTemporary {
                Button(String(localized: "editor.tab-bar.context-menu.keep-open", defaultValue: "Keep Open", comment: "Context menu action to pin tab open")) {
            ...
            Divider()
                    ...
                    Button(String(localized: "editor.tab-bar.context-menu.split-up", defaultValue: "Split Up", comment: "Context menu action to split editor up")) {
                moveToNewSplit(.top)
            }
                    Button(String(localized: "editor.tab-bar.context-menu.split-down", defaultValue: "Split Down", comment: "Context menu action to split editor down")) {
                moveToNewSplit(.bottom)
            }
                    Button(String(localized: "editor.tab-bar.context-menu.split-left", defaultValue: "Split Left", comment: "Context menu action to split editor left")) {
                moveToNewSplit(.leading)
            }
                    Button(String(localized: "editor.tab-bar.context-menu.split-right", defaultValue: "Split Right", comment: "Context menu action to split editor right")) {
