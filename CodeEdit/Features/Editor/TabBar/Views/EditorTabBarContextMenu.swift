    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                ...
                Button(String(localized: "Close Tabs to the Right")) {
                    withAnimation {
                ...
                Button(String(localized: "Close All")) {
                    withAnimation {
                        tabs.tabs.forEach {
                            tabs.closeTab(file: $0.file)
                        }
                ...
                if isTemporary {
                    Button(String(localized: "Keep Open")) {
            ...
            Group {
                ...
                Button(String(localized: "Copy Relative Path")) {
            ...
            Group {
                ...
                Button(String(localized: "Reveal in Project Navigator")) {
                    workspace.listenerModel.highlightedFileItem = item
                }

                Button(String(localized: "Open in New Window")) {
