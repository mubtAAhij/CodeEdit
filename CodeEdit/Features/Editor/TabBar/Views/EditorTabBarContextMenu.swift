        ...
        content.contextMenu(menuItems: {
            Group {
                Button(String(
                    ...
                    comment: "Context menu action to close the current tab."
                )) {
                    withAnimation {
                ...
                Button(String(
                    ...
                    comment: "Context menu action to close all tabs except current tab."
                )) {
                    withAnimation {
                ...
                Button(String(
                    ...
                    comment: "Context menu action to close tabs located to the right of current tab."
                )) {
                    withAnimation {
                ...
                if isTemporary {
                    Button(String(
                        ...
                        comment: "Context menu action to pin or keep current tab open."
                    )) {
            ...
            Button(String(
                ...
                comment: "Context menu action to split editor upward."
            )) {
                moveToNewSplit(.top)
            }
            Button(String(
                ...
                comment: "Context menu action to split editor downward."
            )) {
