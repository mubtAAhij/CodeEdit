...
struct EditorTabBarContextMenu: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                Button(String(localized: "close_tab", comment: "Context menu action to close tab")) {
                    withAnimation {
                ...
                Button(String(localized: "close_other_tabs", comment: "Context menu action to close all other tabs")) {
                    withAnimation {
                ...
                Button(String(localized: "close_tabs_to_right", comment: "Context menu action to close tabs to the right")) {
                    withAnimation {
                ...
                Button(String(localized: "close_all", comment: "Context menu action to close all tabs")) {
                    withAnimation {
                        tabs.tabs.forEach {
                            tabs.closeTab(file: $0.file)
                        }
                ...
                if isTemporary {
                    Button(String(localized: "keep_open", comment: "Context menu action to keep temporary tab open")) {
            ...
            Group {
                Button(String(localized: "copy_path", comment: "Context menu action to copy file path")) {
                    copyPath(item: item)
                }

                Button(String(localized: "copy_relative_path", comment: "Context menu action to copy relative file path")) {
            ...
            Group {
                Button(String(localized: "show_in_finder", comment: "Context menu action to show file in Finder")) {
                    item.showInFinder()
                }

                Button(String(localized: "reveal_in_project_navigator", comment: "Context menu action to reveal file in project navigator")) {
                    workspace.listenerModel.highlightedFileItem = item
                }

                Button(String(localized: "open_in_new_window", comment: "Context menu action to open file in new window")) {
            ...
            Button(String(localized: "split_up", comment: "Context menu action to split editor upward")) {
                moveToNewSplit(.top)
            }
            Button(String(localized: "split_down", comment: "Context menu action to split editor downward")) {
                moveToNewSplit(.bottom)
            }
            Button(String(localized: "split_left", comment: "Context menu action to split editor to the left")) {
                moveToNewSplit(.leading)
            }
            Button(String(localized: "split_right", comment: "Context menu action to split editor to the right")) {
