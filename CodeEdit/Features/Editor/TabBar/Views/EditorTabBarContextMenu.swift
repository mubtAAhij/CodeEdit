    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                ...
                if isTemporary {
                    Button(String(localized: "editor.tab-bar.context-menu.keep-open", defaultValue: "Keep Open", comment: "Context menu action to pin or keep the selected tab open")) {
            ...
            Group {
                ...
                Button(String(localized: "editor.tab-bar.context-menu.reveal-in-project-navigator", defaultValue: "Reveal in Project Navigator", comment: "Context menu action to reveal the file in project navigator")) {
