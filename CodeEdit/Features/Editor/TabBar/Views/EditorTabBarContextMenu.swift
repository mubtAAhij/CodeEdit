...
struct EditorTabBarContextMenu: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                Button(String(localized: "editor.close-tab", defaultValue: "Close Tab", comment: "Menu item to close tab")) {
                    withAnimation {
                ...
                Button(String(localized: "editor.close-other-tabs", defaultValue: "Close Other Tabs", comment: "Menu item to close other tabs")) {
                    withAnimation {
                ...
                Button(String(localized: "editor.close-tabs-to-right", defaultValue: "Close Tabs to the Right", comment: "Menu item to close tabs to the right")) {
                    withAnimation {
                ...
                Button(String(localized: "editor.close-all", defaultValue: "Close All", comment: "Menu item to close all tabs")) {
                    withAnimation {
                        tabs.tabs.forEach {
                            tabs.closeTab(file: $0.file)
                        }
                ...
                if isTemporary {
                    Button(String(localized: "editor.keep-open", defaultValue: "Keep Open", comment: "Menu item to keep temporary tab open")) {
            ...
            Group {
                Button(String(localized: "editor.copy-path", defaultValue: "Copy Path", comment: "Menu item to copy file path")) {
                    copyPath(item: item)
                }

                Button(String(localized: "editor.copy-relative-path", defaultValue: "Copy Relative Path", comment: "Menu item to copy relative file path")) {
            ...
            Group {
                Button(String(localized: "editor.show-in-finder", defaultValue: "Show in Finder", comment: "Menu item to show file in Finder")) {
                    item.showInFinder()
                }

                Button(String(localized: "editor.reveal-in-navigator", defaultValue: "Reveal in Project Navigator", comment: "Menu item to reveal file in project navigator")) {
                    workspace.listenerModel.highlightedFileItem = item
                }

                Button(String(localized: "editor.open-in-new-window", defaultValue: "Open in New Window", comment: "Menu item to open file in new window")) {
            ...
            Button(String(localized: "editor.split-up", defaultValue: "Split Up", comment: "Menu item to split editor upward")) {
                moveToNewSplit(.top)
            }
            Button(String(localized: "editor.split-down", defaultValue: "Split Down", comment: "Menu item to split editor downward")) {
                moveToNewSplit(.bottom)
            }
            Button(String(localized: "editor.split-left", defaultValue: "Split Left", comment: "Menu item to split editor to the left")) {
                moveToNewSplit(.leading)
            }
            Button(String(localized: "editor.split-right", defaultValue: "Split Right", comment: "Menu item to split editor to the right")) {
