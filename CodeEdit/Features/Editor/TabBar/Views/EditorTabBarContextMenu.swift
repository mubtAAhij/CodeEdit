...
struct EditorTabBarContextMenu: ViewModifier {
    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                Button(String(localized: "editor.tab.close-tab", defaultValue: "Close Tab", comment: "Context menu item to close tab")) {
                    withAnimation {
                ...
                Button(String(localized: "editor.tab.close-other-tabs", defaultValue: "Close Other Tabs", comment: "Context menu item to close other tabs")) {
                    withAnimation {
                ...
                Button(String(localized: "editor.tab.close-tabs-to-right", defaultValue: "Close Tabs to the Right", comment: "Context menu item to close tabs to the right")) {
                    withAnimation {
            ...
            Group {
                ...
                Button(String(localized: "editor.tab.reveal-in-navigator", defaultValue: "Reveal in Project Navigator", comment: "Context menu item to reveal file in project navigator")) {
                    workspace.listenerModel.highlightedFileItem = item
                }

                Button(String(localized: "editor.tab.open-in-new-window", defaultValue: "Open in New Window", comment: "Context menu item to open file in new window")) {
            ...
            Button(String(localized: "editor.tab.split-up", defaultValue: "Split Up", comment: "Context menu item to split editor upwards")) {
                moveToNewSplit(.top)
            }
            Button(String(localized: "editor.tab.split-down", defaultValue: "Split Down", comment: "Context menu item to split editor downwards")) {
                moveToNewSplit(.bottom)
            }
            Button(String(localized: "editor.tab.split-left", defaultValue: "Split Left", comment: "Context menu item to split editor to the left")) {
                moveToNewSplit(.leading)
            }
            Button(String(localized: "editor.tab.split-right", defaultValue: "Split Right", comment: "Context menu item to split editor to the right")) {
