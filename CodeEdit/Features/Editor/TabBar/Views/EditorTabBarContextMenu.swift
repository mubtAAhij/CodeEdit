    ...
    func body(content: Content) -> some View {
        content.contextMenu(menuItems: {
            Group {
                ...
                Button(String(localized: "editor.tab-bar.context-menu.close-other-tabs", defaultValue: "Close Other Tabs", comment: "Context menu action to close all tabs except current one")) {
                    withAnimation {
