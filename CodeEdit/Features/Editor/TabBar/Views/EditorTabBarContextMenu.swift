        ...
        content.contextMenu(menuItems: {
            Group {
                ...
                Button(String(
                    ...
                    comment: "Context menu action to close tabs to the right of current tab"
                )) {
                    withAnimation {
                ...
                if isTemporary {
                    Button(String(
                        ...
                        comment: "Context menu action to pin or keep tab open"
                    )) {
            ...
            Group {
                ...
                Button(String(
                    ...
                    comment: "Context menu action to open editor in a new window"
                )) {
