    ...
    var body: some View {
        HStack(alignment: .center, spacing: 0) {
            ...
            EditorTabs()
                ...
                .accessibilityLabel(String(localized: "editor.tab-bar.accessibility-label", defaultValue: "Tab Bar", comment: "Accessibility label for the editor tab bar container"))
