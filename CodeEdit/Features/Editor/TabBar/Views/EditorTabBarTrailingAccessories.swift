                ...
                Menu {
                    Toggle(
                        String(
                            ...
                            comment: "Editor options toggle to show or hide the minimap"
                        ),
                        isOn: $showMinimap
                    )
                    ...
                    Toggle(
                        String(
                            ...
                            comment: "Editor options toggle to wrap lines"
                        ),
                        isOn: Binding(
            ...
            case (.horizontal, true), (.vertical, false):
                ...
                .help(
                    String(
                        ...
                        comment: "Help tooltip for splitting the editor vertically"
                    )
                )
            ...
            case (.vertical, true), (.horizontal, false):
                ...
                .help(
                    String(
                        ...
                        comment: "Help tooltip for splitting the editor horizontally"
                    )
                )
