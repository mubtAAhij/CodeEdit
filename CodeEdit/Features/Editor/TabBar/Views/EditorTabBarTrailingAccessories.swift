    ...
    var splitviewButton: some View {
        Group {
            ...
            case (.horizontal, true), (.vertical, false):
                ...
                .help(String(localized: "editor.split.vertically", defaultValue: "Split Vertically", comment: "Tooltip for split vertically button"))
            ...
            case (.vertical, true), (.horizontal, false):
                ...
                .help(String(localized: "editor.split.horizontally", defaultValue: "Split Horizontally", comment: "Tooltip for split horizontally button"))
