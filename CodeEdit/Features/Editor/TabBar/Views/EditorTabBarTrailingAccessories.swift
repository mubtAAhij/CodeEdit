...
struct EditorTabBarTrailingAccessories: View {
    ...
    func editorOptionsMenu(codeFile: CodeFileDocument) -> some View {
        ...
        Button(action: {}, label: { Image(systemName: "slider.horizontal.3") })
            .overlay {
                Menu {
                    Toggle(String(localized: "editor.tabbar.trailing.show-minimap", defaultValue: "Show Minimap", comment: "Menu action to show minimap in editor"), isOn: $showMinimap)
                        .keyboardShortcut("M", modifiers: [.command, .shift, .control])
                    Divider()
                    Toggle(
                        String(localized: "editor.tabbar.trailing.wrap-lines", defaultValue: "Wrap Lines", comment: "Menu action to toggle line wrapping in editor"),
                        isOn: Binding(
    ...
    var splitviewButton: some View {
        Group {
            ...
            case (.horizontal, true), (.vertical, false):
                ...
                .help(String(localized: "editor.tabbar.trailing.split-vertically", defaultValue: "Split Vertically", comment: "Menu action to split editor vertically"))
            ...
            case (.vertical, true), (.horizontal, false):
                ...
                .help(String(localized: "editor.tabbar.trailing.split-horizontally", defaultValue: "Split Horizontally", comment: "Menu action to split editor horizontally"))
