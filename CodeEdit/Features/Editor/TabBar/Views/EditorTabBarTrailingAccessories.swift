...
struct EditorTabBarTrailingAccessories: View {
    ...
    func editorOptionsMenu(codeFile: CodeFileDocument) -> some View {
        ...
        Button(action: {}, label: { Image(systemName: "slider.horizontal.3") })
            .overlay {
                Menu {
                    Toggle(String(localized: "editor.menu.show-minimap", defaultValue: "Show Minimap", comment: "Show minimap menu item"), isOn: $showMinimap)
                        .keyboardShortcut("M", modifiers: [.command, .shift, .control])
                    Divider()
                    Toggle(
                        String(localized: "editor.menu.wrap-lines", defaultValue: "Wrap Lines", comment: "Wrap lines menu item"),
                        isOn: Binding(
    ...
    var splitviewButton: some View {
        Group {
            ...
            case (.horizontal, true), (.vertical, false):
                ...
                .help(String(localized: "editor.split.vertically", defaultValue: "Split Vertically", comment: "Split vertically help text"))
            ...
            case (.vertical, true), (.horizontal, false):
                ...
                .help(String(localized: "editor.split.horizontally", defaultValue: "Split Horizontally", comment: "Split horizontally help text"))
