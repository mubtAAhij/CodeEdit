...
struct EditorTabBarTrailingAccessories: View {
    ...
    func editorOptionsMenu(codeFile: CodeFileDocument) -> some View {
        ...
        Button(action: {}, label: { Image(systemName: "slider.horizontal.3") })
            .overlay {
                Menu {
                    Toggle(String(localized: "editor.tab-bar.trailing.show-minimap", defaultValue: "Show Minimap", comment: "Tooltip for toggling the editor minimap"), isOn: $showMinimap)
                        .keyboardShortcut("M", modifiers: [.command, .shift, .control])
                    Divider()
                    Toggle(
                        String(localized: "editor.tab-bar.trailing.wrap-lines", defaultValue: "Wrap Lines", comment: "Tooltip for toggling line wrapping"),
                        isOn: Binding(
    ...
    var splitviewButton: some View {
        Group {
            ...
            case (.horizontal, true), (.vertical, false):
                ...
                .help(String(localized: "editor.tab-bar.trailing.split-vertically", defaultValue: "Split Vertically", comment: "Menu item to split editor vertically"))
            ...
            case (.vertical, true), (.horizontal, false):
                ...
                .help(String(localized: "editor.tab-bar.trailing.split-horizontally", defaultValue: "Split Horizontally", comment: "Menu item to split editor horizontally"))
