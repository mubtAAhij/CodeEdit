                ...
                Menu {
                    Toggle(
                        String(
                            ...
                            comment: "Toggle title for showing the minimap in editor tab bar options"
                        ),
                        isOn: $showMinimap
                    )
                    ...
                    Toggle(
                        String(
                            ...
                            comment: "Toggle title for wrapping lines in editor tab bar options"
                        ),
                        isOn: Binding(
            ...
            case (.horizontal, true), (.vertical, false):
                ...
                .help(
                    String(
                        ...
                        comment: "Help text for splitting the editor vertically"
                    )
                )
            ...
            case (.vertical, true), (.horizontal, false):
                ...
                .help(
                    String(
                        ...
                        comment: "Help text for splitting the editor horizontally"
                    )
                )
