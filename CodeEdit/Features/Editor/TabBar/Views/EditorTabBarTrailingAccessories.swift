...
struct EditorTabBarTrailingAccessories: View {
    ...
    func editorOptionsMenu(codeFile: CodeFileDocument) -> some View {
        ...
        Button(action: {}, label: { Image(systemName: "slider.horizontal.3") })
            .overlay {
                Menu {
                    Toggle("String(localized: "show_minimap", comment: "Toggle option to show/hide the code minimap")", isOn: $showMinimap)
    ...
    var splitviewButton: some View {
        Group {
            ...
            case (.horizontal, true), (.vertical, false):
                ...
                .help("String(localized: "split_vertically", comment: "Tooltip for button to split editor vertically")")
            ...
            case (.vertical, true), (.horizontal, false):
                ...
                .help("String(localized: "split_horizontally", comment: "Tooltip for button to split editor horizontally")")
