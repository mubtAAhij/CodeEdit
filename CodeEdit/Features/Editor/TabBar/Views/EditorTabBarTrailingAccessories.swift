...
struct EditorTabBarTrailingAccessories: View {
    ...
    func editorOptionsMenu(codeFile: CodeFileDocument) -> some View {
        ...
        Button(action: {}, label: { Image(systemName: "slider.horizontal.3") })
            .overlay {
                Menu {
                    Toggle(String(localized: "editor.tab-bar.show-minimap", defaultValue: "Show Minimap", comment: "Menu item to toggle minimap visibility"), isOn: $showMinimap)
                        .keyboardShortcut("M", modifiers: [.command, .shift, .control])
                    Divider()
                    Toggle(
                        String(localized: "editor.tab-bar.wrap-lines", defaultValue: "Wrap Lines", comment: "Menu item to toggle line wrapping"),
                        isOn: Binding(
    ...
    var splitviewButton: some View {
        Group {
            ...
            case (.horizontal, true), (.vertical, false):
                ...
                .help(String(localized: "editor.tab-bar.split-vertically", defaultValue: "Split Vertically", comment: "Tooltip for split editor vertically button"))
            ...
            case (.vertical, true), (.horizontal, false):
                ...
                .help(String(localized: "editor.tab-bar.split-horizontally", defaultValue: "Split Horizontally", comment: "Tooltip for split editor horizontally button"))
