...
struct EditorTabBarTrailingAccessories: View {
    ...
    func editorOptionsMenu(codeFile: CodeFileDocument) -> some View {
        ...
        Button(action: {}, label: { Image(systemName: "slider.horizontal.3") })
            .overlay {
                Menu {
                    Toggle(String(localized: "editor.options.show-minimap", defaultValue: "Show Minimap", comment: "Toggle to show editor minimap"), isOn: $showMinimap)
    ...
    var splitviewButton: some View {
        Group {
            ...
            case (.horizontal, true), (.vertical, false):
                ...
                .help(String(localized: "editor.split-vertically", defaultValue: "Split Vertically", comment: "Tooltip for split editor vertically button"))
            ...
            case (.vertical, true), (.horizontal, false):
                ...
                .help(String(localized: "editor.split-horizontally", defaultValue: "Split Horizontally", comment: "Tooltip for split editor horizontally button"))
