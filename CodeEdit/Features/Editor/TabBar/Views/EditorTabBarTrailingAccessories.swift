...
struct EditorTabBarTrailingAccessories: View {
    ...
    func editorOptionsMenu(codeFile: CodeFileDocument) -> some View {
        ...
        Button(action: {}, label: { Image(systemName: "slider.horizontal.3") })
            .overlay {
                Menu {
                    Toggle(String(localized: "editor.toolbar.show_minimap", comment: "Toggle menu item to show minimap"), isOn: $showMinimap)
                        .keyboardShortcut("M", modifiers: [.command, .shift, .control])
                    Divider()
                    Toggle(
                        String(localized: "editor.toolbar.wrap_lines", comment: "Toggle menu item to wrap lines"),
                        isOn: Binding(
    ...
    var splitviewButton: some View {
        Group {
            ...
            case (.horizontal, true), (.vertical, false):
                ...
                .help(String(localized: "editor.toolbar.split_vertically", comment: "Tooltip for button to split editor vertically"))
            ...
            case (.vertical, true), (.horizontal, false):
                ...
                .help(String(localized: "editor.toolbar.split_horizontally", comment: "Tooltip for button to split editor horizontally"))
