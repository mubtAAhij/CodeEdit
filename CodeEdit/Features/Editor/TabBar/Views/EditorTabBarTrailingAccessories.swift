...
struct EditorTabBarTrailingAccessories: View {
    ...
    func editorOptionsMenu(codeFile: CodeFileDocument) -> some View {
        ...
        Button(action: {}, label: { Image(systemName: "slider.horizontal.3") })
            .overlay {
                Menu {
                    Toggle(String(localized: "Show Minimap", comment: "Toggle option to show/hide minimap in editor"), isOn: $showMinimap)
                        .keyboardShortcut("M", modifiers: [.command, .shift, .control])
                    Divider()
                    Toggle(
                        String(localized: "Wrap Lines", comment: "Toggle option to wrap lines in editor"),
                        isOn: Binding(
    ...
    var splitviewButton: some View {
        Group {
            ...
            case (.horizontal, true), (.vertical, false):
                ...
                .help(String(localized: "Split Vertically", comment: "Help text for split editor vertically button"))
            ...
            case (.vertical, true), (.horizontal, false):
                ...
                .help(String(localized: "Split Horizontally", comment: "Help text for split editor horizontally button"))
