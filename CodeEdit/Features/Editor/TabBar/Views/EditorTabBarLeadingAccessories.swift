    ...
    var body: some View {
        HStack(spacing: 0) {
            if otherEditor != nil {
                ...
                .help(String(
                    localized: "editor.tabbar.close-this-editor",
                    defaultValue: "Close this Editor",
                    comment: "Tooltip for closing the current editor"
                ))
                ...
                .help(
                    ...
                    ? String(
                        localized: "editor.tabbar.unfocus-this-editor",
                        defaultValue: "Unfocus this Editor",
                        comment: "Tooltip for unfocusing the current editor"
                    )
                    : String(
                        localized: "editor.tabbar.focus-this-editor",
