    ...
    var body: some View {
        HStack(spacing: 0) {
            if otherEditor != nil {
                ...
                .help(String(localized: "editor.tab-bar.leading.close-this-editor", defaultValue: "Close this Editor", comment: "Accessibility label for control that closes the current editor"))
                ...
                .help(
                    editorManager.isFocusingActiveEditor
                        ? String(localized: "editor.tab-bar.leading.unfocus-this-editor", defaultValue: "Unfocus this Editor", comment: "Accessibility label for control that unfocuses the current editor")
                        : String(localized: "editor.tab-bar.leading.focus-this-editor", defaultValue: "Focus this Editor", comment: "Accessibility label for control that focuses the current editor")
                )
