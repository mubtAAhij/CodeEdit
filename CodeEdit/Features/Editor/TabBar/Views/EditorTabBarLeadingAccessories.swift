    ...
    var body: some View {
        HStack(spacing: 0) {
            if otherEditor != nil {
                ...
                .help(String(localized: "editor.tab-bar.leading-accessories.close-this-editor", defaultValue: "Close this Editor", comment: "Tooltip for button that closes the focused editor"))
