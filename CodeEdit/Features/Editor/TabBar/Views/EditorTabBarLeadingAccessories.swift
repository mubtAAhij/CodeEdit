    ...
    var body: some View {
        HStack(spacing: 0) {
            if otherEditor != nil {
                ...
                .help(String(localized: "editor.close-editor", defaultValue: "Close this Editor", comment: "Help text for close editor button"))
                ...
                .help(
                    ...
                    ? String(localized: "editor.unfocus-editor", defaultValue: "Unfocus this Editor", comment: "Help text for unfocus editor button")
                    : String(localized: "editor.focus-editor", defaultValue: "Focus this Editor", comment: "Help text for focus editor button")
                )
