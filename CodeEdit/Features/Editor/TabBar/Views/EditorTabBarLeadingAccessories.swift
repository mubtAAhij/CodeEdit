    ...
    var body: some View {
        HStack(spacing: 0) {
            if otherEditor != nil {
                ...
                .help(String(localized: "editor.tab-bar.leading.close-this-editor", defaultValue: "Close this Editor", comment: "Tooltip for closing current editor from tab bar accessory"))
                ...
                .help(
                    ...
                    ? String(localized: "editor.tab-bar.leading.unfocus-this-editor", defaultValue: "Unfocus this Editor", comment: "Tooltip for unfocusing current editor from tab bar accessory")
                    : String(localized: "editor.tab-bar.leading.focus-this-editor", defaultValue: "Focus this Editor", comment: "Tooltip for focusing current editor from tab bar accessory")
                )
