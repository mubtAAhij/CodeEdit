    ...
    var body: some View {
        HStack(spacing: 0) {
            if otherEditor != nil {
                ...
                .help(String(localized: "editor.tab-bar.close-editor", defaultValue: "Close this Editor", comment: "Tooltip for closing an editor"))
                ...
                .help(
                    ...
                    ? String(localized: "editor.tab-bar.unfocus-editor", defaultValue: "Unfocus this Editor", comment: "Tooltip for unfocusing an editor")
                    : String(localized: "editor.tab-bar.focus-editor", defaultValue: "Focus this Editor", comment: "Tooltip for focusing an editor")
                )
