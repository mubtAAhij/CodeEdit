    ...
    var body: some View {
        HStack(spacing: 0) {
            if otherEditor != nil {
                ...
                .help(String(localized: "editor.close_editor", comment: "Tooltip"))
                ...
                .help(
                    ...
                    ? String(localized: "editor.unfocus_editor", comment: "Tooltip")
                    : String(localized: "editor.focus_editor", comment: "Tooltip")
                )
