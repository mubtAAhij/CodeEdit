    ...
    var body: some View {
        HStack(spacing: 0) {
            if otherEditor != nil {
                ...
                .help(String(localized: "editor.tab-bar.close-editor", defaultValue: "Close this Editor", comment: "Close editor tooltip"))
                ...
                .help(
                    ...
                    ? String(localized: "editor.tab-bar.unfocus-editor", defaultValue: "Unfocus this Editor", comment: "Unfocus editor tooltip")
                    : String(localized: "editor.tab-bar.focus-editor", defaultValue: "Focus this Editor", comment: "Focus editor tooltip")
                )
