    ...
    var body: some View {
        HStack(spacing: 0) {
            if otherEditor != nil {
                ...
                .help(String(localized: "editor.closeEditor", comment: "Tooltip text"))
                ...
                .help(
                    ...
                    ? String(localized: "editor.unfocusEditor", comment: "Tooltip text")
                    : String(localized: "editor.focusEditor", comment: "Tooltip text")
                )
