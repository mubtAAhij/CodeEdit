    ...
    var body: some View {
        HStack(spacing: 0) {
            if otherEditor != nil {
                ...
                .help(String(localized: "editor.tab-bar.leading.close-this-editor", defaultValue: "Close this Editor", comment: "Tooltip to close the current editor tab"))
                ...
                .help(
                    ...
                    ? String(localized: "editor.tab-bar.leading.unfocus-this-editor", defaultValue: "Unfocus this Editor", comment: "Tooltip to unfocus the current editor tab")
                    : String(localized: "editor.tab-bar.leading.focus-this-editor", defaultValue: "Focus this Editor", comment: "Tooltip to focus the current editor tab")
                )
