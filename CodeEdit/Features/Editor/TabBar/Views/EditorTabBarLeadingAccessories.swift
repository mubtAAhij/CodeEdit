            ...
            if otherEditor != nil {
                ...
                .help(
                    String(
                        ...
                        comment: "Help tooltip for button to close this editor"
                    )
                )
                ...
                .help(
                    ...
                    ? String(
                        ...
                        comment: "Help tooltip for button to unfocus this editor"
                    )
                    : String(
                        localized: "editor.tab-bar.leading-accessories.focus-this-editor",
                        defaultValue: "Focus this Editor",
                        comment: "Help tooltip for button to focus this editor"
                    )
                )
