    ...
    var body: some View {
        HStack(spacing: 0) {
            if otherEditor != nil {
                ...
                .help(String(localized: "editor.tab_bar.close_editor", comment: "Button tooltip to close the current editor"))
                ...
                .help(
                    ...
                    ? String(localized: "editor.tab_bar.unfocus_editor", comment: "Button tooltip to unfocus the current editor")
                    : String(localized: "editor.tab_bar.focus_editor", comment: "Button tooltip to focus the current editor")
                )
