            ...
            if otherEditor != nil {
                ...
                .help(
                    String(
                        ...
                        comment: "Help tooltip to close current editor in split view"
                    )
                )
                ...
                .help(
                    ...
                    ? String(
                        ...
                        comment: "Help tooltip to disable focused editor mode"
                    )
                    : String(
                        localized: "editor.tab-bar.leading-accessories.focus-this-editor",
                        defaultValue: "Focus this Editor",
                        comment: "Help tooltip to enable focused editor mode"
                    )
                )
