    ...
    var body: some View {
        HStack(spacing: 0) {
            if otherEditor != nil {
                ...
                .help(String(localized: "editor.close.this.editor", defaultValue: "Close this Editor", comment: "Close this editor tooltip"))
                ...
                .help(
                    ...
                    ? String(localized: "editor.unfocus.this.editor", defaultValue: "Unfocus this Editor", comment: "Unfocus this editor tooltip")
                    : String(localized: "editor.focus.this.editor", defaultValue: "Focus this Editor", comment: "Focus this editor tooltip")
                )
