    ...
    var body: some View {
        HStack(spacing: 0) {
            if otherEditor != nil {
                ...
                .help(String(localized: "editor.tab-bar.leading.close-this-editor", defaultValue: "Close this Editor", comment: "Tooltip for button that closes the currently focused editor"))
                ...
                .help(
                    ...
                    ? String(localized: "editor.tab-bar.leading.unfocus-this-editor", defaultValue: "Unfocus this Editor", comment: "Tooltip for control that unfocuses the current editor")
                    : String(localized: "editor.tab-bar.leading.focus-this-editor", defaultValue: "Focus this Editor", comment: "Tooltip for control that focuses the current editor")
                )
