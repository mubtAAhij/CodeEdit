    ...
    var body: some View {
        HStack(spacing: 0) {
            if otherEditor != nil {
                ...
                .help(String(localized: "editor.close", comment: "Close the current editor"))
                ...
                .help(
                    ...
                    ? String(localized: "editor.unfocus", comment: "Unfocus the current editor")
                    : String(localized: "editor.focus", comment: "Focus the current editor")
                )
