    ...
    var body: some View {
        HStack(spacing: 0) {
            if otherEditor != nil {
                ...
                .help(String(localized: "Close this Editor", comment: "Tooltip for close editor button"))
                ...
                .help(
                    ...
                    ? String(localized: "Unfocus this Editor", comment: "Tooltip for unfocus editor button")
                    : String(localized: "Focus this Editor", comment: "Tooltip for focus editor button")
                )
