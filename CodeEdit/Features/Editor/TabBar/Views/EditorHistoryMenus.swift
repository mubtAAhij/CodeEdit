...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "editor.history.back", defaultValue: "Navigate back", comment: "Navigate back help text"))
            ...
            .help(String(localized: "editor.history.forward", defaultValue: "Navigate forward", comment: "Navigate forward help text"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
