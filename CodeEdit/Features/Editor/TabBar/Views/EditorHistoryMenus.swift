...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "editor.history.navigate-back", defaultValue: "Navigate back", comment: "Help tooltip for navigating backward in editor history"))
            ...
            .help(String(localized: "editor.history.navigate-forward", defaultValue: "Navigate forward", comment: "Help tooltip for navigating forward in editor history"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
