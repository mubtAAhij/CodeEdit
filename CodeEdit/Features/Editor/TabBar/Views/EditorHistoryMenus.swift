...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "editor.history.navigate-back", defaultValue: "Navigate back", comment: "Help text for the navigate back button in editor history"))
            ...
            .help(String(localized: "editor.history.navigate-forward", defaultValue: "Navigate forward", comment: "Help text for the navigate forward button in editor history"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
