...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "editor.navigate-back", defaultValue: "Navigate back", comment: "Tooltip for navigate back button"))
            ...
            .help(String(localized: "editor.navigate-forward", defaultValue: "Navigate forward", comment: "Tooltip for navigate forward button"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
