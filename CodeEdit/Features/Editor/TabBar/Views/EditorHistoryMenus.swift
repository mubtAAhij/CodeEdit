...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "editor.navigate-back", defaultValue: "Navigate back", comment: "Navigate back help text"))
            ...
            .help(String(localized: "editor.navigate-forward", defaultValue: "Navigate forward", comment: "Navigate forward help text"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
