...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "editor.history-menu.navigate-back", defaultValue: "Navigate back", comment: "Menu item title to navigate backward in editor history"))
            ...
            .help(String(localized: "editor.history-menu.navigate-forward", defaultValue: "Navigate forward", comment: "Menu item title to navigate forward in editor history"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
