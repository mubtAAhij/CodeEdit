...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "editor.history-menu.navigate-back", defaultValue: "Navigate back", comment: "Menu item title for navigating to previous editor location"))
            ...
            .help(String(localized: "editor.history-menu.navigate-forward", defaultValue: "Navigate forward", comment: "Menu item title for navigating to next editor location"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
