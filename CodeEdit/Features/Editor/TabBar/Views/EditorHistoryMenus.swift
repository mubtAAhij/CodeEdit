...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "editor.tab.history.navigate-back", defaultValue: "Navigate back", comment: "Accessibility label for navigating backward in editor tab history"))
            ...
            .help(String(localized: "editor.tab.history.navigate-forward", defaultValue: "Navigate forward", comment: "Accessibility label for navigating forward in editor tab history"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
