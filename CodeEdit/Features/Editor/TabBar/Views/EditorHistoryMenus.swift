...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "navigation.back", comment: "Tooltip for navigate back button"))
            ...
            .help(String(localized: "navigation.forward", comment: "Tooltip for navigate forward button"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
