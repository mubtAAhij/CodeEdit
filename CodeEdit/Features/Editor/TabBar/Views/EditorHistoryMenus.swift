...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "editor.history.navigate_back", comment: "Tooltip for navigate back button"))
            ...
            .help(String(localized: "editor.history.navigate_forward", comment: "Tooltip for navigate forward button"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
