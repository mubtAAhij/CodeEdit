...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "navigate_back", comment: "Help text for navigate back button"))
            ...
            .help(String(localized: "navigate_forward", comment: "Help text for navigate forward button"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
