...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "editor.tab-bar.history.navigate-back", defaultValue: "Navigate back", comment: "Help text for navigating back in editor history"))
            ...
            .help(String(localized: "editor.tab-bar.history.navigate-forward", defaultValue: "Navigate forward", comment: "Help text for navigating forward in editor history"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
