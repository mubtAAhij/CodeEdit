...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "editor.history.navigate-back.help", defaultValue: "Navigate back", comment: "Help text for navigating to the previous editor history item"))
            ...
            .help(String(localized: "editor.history.navigate-forward.help", defaultValue: "Navigate forward", comment: "Help text for navigating to the next editor history item"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
