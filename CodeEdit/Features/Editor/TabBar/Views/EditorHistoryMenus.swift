...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help("String(localized: "navigate_back", comment: "Help text for back navigation button")")
            ...
            .help("String(localized: "navigate_forward", comment: "Help text for forward navigation button")")
        }
        .buttonStyle(.icon)
        .controlSize(.small)
