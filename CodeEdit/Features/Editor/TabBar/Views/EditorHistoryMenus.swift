...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(
                localized: "editor.history-menus.navigate-back.help",
                defaultValue: "Navigate back",
                comment: "Help text for navigating backward in editor history"
            ))
            ...
            .help(String(
                localized: "editor.history-menus.navigate-forward.help",
                defaultValue: "Navigate forward",
                comment: "Help text for navigating forward in editor history"
            ))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
