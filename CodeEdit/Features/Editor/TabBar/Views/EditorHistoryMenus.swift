...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "editor.tab-bar.history.navigate-back.help", defaultValue: "Navigate back", comment: "Tooltip for navigating backward in editor history"))
            ...
            .help(String(localized: "editor.tab-bar.history.navigate-forward.help", defaultValue: "Navigate forward", comment: "Tooltip for navigating forward in editor history"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
