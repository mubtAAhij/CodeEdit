...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "editor.tab-bar.history.navigate-back.help", defaultValue: "Navigate back", comment: "Help text for navigating to previous editor location"))
            ...
            .help(String(localized: "editor.tab-bar.history.navigate-forward.help", defaultValue: "Navigate forward", comment: "Help text for navigating to next editor location"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
