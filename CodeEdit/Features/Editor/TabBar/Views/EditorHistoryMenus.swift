...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "editor.history.navigate-back", defaultValue: "Navigate back", comment: "Menu item title to navigate to previous editor history location"))
            ...
            .help(String(localized: "editor.history.navigate-forward", defaultValue: "Navigate forward", comment: "Menu item title to navigate to next editor history location"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
