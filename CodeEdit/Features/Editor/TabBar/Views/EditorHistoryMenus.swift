...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "editor.history.navigate-back", defaultValue: "Navigate back", comment: "Navigate back in history tooltip"))
            ...
            .help(String(localized: "editor.history.navigate-forward", defaultValue: "Navigate forward", comment: "Navigate forward in history tooltip"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
