...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "editor.history.navigate.back", defaultValue: "Navigate back", comment: "Navigate back tooltip"))
            ...
            .help(String(localized: "editor.history.navigate.forward", defaultValue: "Navigate forward", comment: "Navigate forward tooltip"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
