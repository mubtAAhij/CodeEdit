...
struct EditorHistoryMenus: View {
    ...
    var body: some View {
        Group {
            ...
            .help(String(localized: "Navigate back", comment: "Help text for back navigation button"))
            ...
            .help(String(localized: "Navigate forward", comment: "Help text for forward navigation button"))
        }
        .buttonStyle(.icon)
        .controlSize(.small)
