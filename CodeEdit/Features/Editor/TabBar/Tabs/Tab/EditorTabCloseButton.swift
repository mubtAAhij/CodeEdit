...
struct EditorTabCloseButton: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel(Text(String(localized: "editor.tab.close-button.title", defaultValue: "Close", comment: "Tooltip or accessibility title for closing an editor tab")))
