...
struct EditorTabCloseButton: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel(Text(String(localized: "editor.tab-bar.tab.close.accessibility-label", defaultValue: "Close", comment: "Accessibility label for the editor tab close button")))
