...
struct EditorTabCloseButton: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel(Text(String(localized: "editor.tab.close-button.accessibility-label", defaultValue: "Close", comment: "Accessibility label for closing an editor tab")))
