...
final class Editor: ObservableObject, Identifiable {
    ...
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "", category: String(localized: "editor.title", defaultValue: "Editor", comment: "Generic editor title"))
