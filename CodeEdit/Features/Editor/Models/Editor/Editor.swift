...
final class Editor: ObservableObject, Identifiable {
    ...
    private let logger = Logger(subsystem: Bundle.main.bundleIdentifier ?? "", category: String(localized: "editor.logger.category", defaultValue: "Editor", comment: "Logger category name for editor"))
