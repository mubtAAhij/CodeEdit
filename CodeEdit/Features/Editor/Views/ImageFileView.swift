...
///
/// If the preview image cannot be created, it shows a  *String(localized: "editor.image.cannot_preview", comment: "Error message when image cannot be previewed")* text.
