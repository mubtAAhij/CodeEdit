...
///
/// If the preview image cannot be created, it shows a  *String(localized: "editor.image_view.cannot_preview", comment: "Error message when image cannot be previewed")* text.
    ...
    var body: some View {
        if let nsImage = NSImage(contentsOf: imageURL),
           let imageReps = nsImage.representations.first {
            ...
            Text(String(localized: "editor.image_view.cannot_preview", comment: "Error message when image cannot be previewed"))
        }
    }
