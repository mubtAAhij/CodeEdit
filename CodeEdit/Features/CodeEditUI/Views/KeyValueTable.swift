    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            HStack {
                ...
                Button(String(localized: "add", comment: "Add button label")) {
                    if !key.isEmpty && !value.isEmpty {
                        completion(key, value)
                    }
                }
    ...
    var body: some View {
        ...
        .contextMenu(
            ...
            menu: { selectedItems in
                Button(String(localized: "edit", comment: "Edit context menu item")) {
                    editItem(id: selectedItems.first)
                }
                Button(String(localized: "remove", comment: "Remove context menu item")) {
