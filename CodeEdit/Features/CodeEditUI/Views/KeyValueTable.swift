        ...
        VStack(spacing: 0) {
                    ...
                    if validKeys.isEmpty {
                        ...
                        Picker(keyColumnName, selection: $key) {
                            ...
                            Text(String(
                                ...
                                comment: "Placeholder text when no row is selected in key value table"
                            )).tag("")
                        }
                    }
            ...
            HStack {
                ...
                Button(String(
                    ...
                    defaultValue: "Cancel",
                    comment: "Button title to cancel key value table editor action"
                )) {
                    dismiss()
                }
                Button(String(
                    ...
                    defaultValue: "Add",
                    comment: "Button title to add key value entry"
                )) {
                    if !key.isEmpty && !value.isEmpty {
                        completion(key, value)
                    }
        ...
        .contextMenu(
            ...
            menu: { selectedItems in
                Button(String(
                    ...
                    defaultValue: "Edit",
                    comment: "Context menu action title to edit selected key value entry"
                )) {
                ...
                Button(String(
                    ...
                    defaultValue: "Remove",
                    comment: "Context menu action title to remove selected key value entry"
                )) {
