...
private struct NewListTableItemView<HeaderView: View>: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
                ...
                Section {
                    if validKeys.isEmpty {
                        ...
                        Picker(keyColumnName, selection: $key) {
                            ...
                            Divider()
                            Text(String(localized: "keyvalue.no-selection", defaultValue: "No Selection", comment: "No selection picker option")).tag("")
                        }
                    }
            ...
            HStack {
                Spacer()
                Button(String(localized: "keyvalue.cancel", defaultValue: "Cancel", comment: "Cancel button")) {
                    dismiss()
                }
