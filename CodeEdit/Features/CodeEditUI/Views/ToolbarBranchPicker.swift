        ...
        var body: some View {
            VStack(alignment: .leading) {
                if let currentBranch = sourceControlManager.currentBranch {
                    Section {
                        headerLabel(String(localized: "git.current_branch", comment: "Current branch label"))
                ...
                if !branches.isEmpty {
                    Section {
                        headerLabel(String(localized: "git.branches", comment: "Branches label"))
            ...
            func switchBranch() {
                Task {
                    do {
                        ...
                        await sourceControlManager.showAlertForError(title: String(localized: "error.failed_checkout", comment: "Failed checkout error"), error: error)
                    }
                }
            }
        }
