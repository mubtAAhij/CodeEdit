        ...
        var body: some View {
            VStack(alignment: .leading) {
                if let currentBranch = sourceControlManager.currentBranch {
                    Section {
                        headerLabel(String(localized: "Current Branch"))
                ...
                if !branches.isEmpty {
                    Section {
                        headerLabel(String(localized: "Branches"))
            ...
            func switchBranch() {
                Task {
                    do {
                        ...
                        await sourceControlManager.showAlertForError(title: String(localized: "Failed to checkout"), error: error)
                    }
                }
            }
        }
