        ...
        var body: some View {
            VStack(alignment: .leading) {
                if let currentBranch = sourceControlManager.currentBranch {
                    Section {
                        headerLabel(String(localized: "branch_picker.current_branch", defaultValue: "Current Branch", comment: "Section label"))
                ...
                if !branches.isEmpty {
                    Section {
                        headerLabel(String(localized: "branch_picker.branches", defaultValue: "Branches", comment: "Section label"))
            ...
            func switchBranch() {
                Task {
                    do {
                        ...
                        await sourceControlManager.showAlertForError(title: String(localized: "branch_picker.failed_checkout", defaultValue: "Failed to checkout", comment: "Error message"), error: error)
                    }
                }
            }
        }
