        ...
        var body: some View {
            VStack(alignment: .leading) {
                if let currentBranch = sourceControlManager.currentBranch {
                    Section {
                        headerLabel(String(localized: "source-control.current-branch", defaultValue: "Current Branch", comment: "Label for current branch section"))
                ...
                if !branches.isEmpty {
                    Section {
                        headerLabel(String(localized: "source-control.branches", defaultValue: "Branches", comment: "Label for branches section"))
            ...
            func switchBranch() {
                Task {
                    do {
                        ...
                        await sourceControlManager.showAlertForError(title: String(localized: "source-control.checkout-failed", defaultValue: "Failed to checkout", comment: "Error title when branch checkout fails"), error: error)
                    }
                }
            }
        }
