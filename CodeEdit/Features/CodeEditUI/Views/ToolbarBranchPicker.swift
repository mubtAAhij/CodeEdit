...
struct ToolbarBranchPicker: View {
    ...
    private var title: String {
        workspaceFileManager?.folderUrl.lastPathComponent ?? String(localized: "empty", comment: "Default text when no workspace is loaded")
    }
    ...
    private struct PopoverView: View {
        ...
        var body: some View {
            VStack(alignment: .leading) {
                ...
                if !branches.isEmpty {
                    Section {
                        headerLabel(String(localized: "branches", comment: "Branch picker section header"))
