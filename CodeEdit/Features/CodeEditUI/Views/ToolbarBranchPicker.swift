...
struct ToolbarBranchPicker: View {
    ...
    private var title: String {
        workspaceFileManager?.folderUrl.lastPathComponent ?? String(localized: "toolbar.empty", defaultValue: "Empty", comment: "Empty workspace")
    }
    ...
    private struct PopoverView: View {
        ...
        var body: some View {
            VStack(alignment: .leading) {
                ...
                if !branches.isEmpty {
                    Section {
                        headerLabel(String(localized: "toolbar.branches", defaultValue: "Branches", comment: "Branches section header"))
            ...
            func switchBranch() {
                Task {
                    do {
                        ...
                        await sourceControlManager.showAlertForError(title: String(localized: "toolbar.failed-to-checkout", defaultValue: "Failed to checkout", comment: "Failed to checkout error"), error: error)
                    }
                }
            }
        }
