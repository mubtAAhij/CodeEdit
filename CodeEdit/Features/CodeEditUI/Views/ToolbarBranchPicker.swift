        ...
        var body: some View {
            VStack(alignment: .leading) {
                if let currentBranch = sourceControlManager.currentBranch {
                    Section {
                        headerLabel(String(localized: "current_branch", comment: "Header for current branch section"))
                ...
                if !branches.isEmpty {
                    Section {
                        headerLabel(String(localized: "branches", comment: "Header for branches section"))
