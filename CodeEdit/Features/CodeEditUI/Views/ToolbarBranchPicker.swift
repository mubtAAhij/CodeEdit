...
struct ToolbarBranchPicker: View {
    ...
    private var title: String {
        workspaceFileManager?.folderUrl.lastPathComponent ?? String(localized: "empty", defaultValue: "Empty", comment: "Empty workspace placeholder")
    }
        ...
        var body: some View {
            VStack(alignment: .leading) {
                if let currentBranch = sourceControlManager.currentBranch {
                    Section {
                        headerLabel(String(localized: "git.current-branch", defaultValue: "Current Branch", comment: "Current branch section header"))
                ...
                if !branches.isEmpty {
                    Section {
                        headerLabel(String(localized: "source-control.branches", defaultValue: "Branches", comment: "Branches section header"))
