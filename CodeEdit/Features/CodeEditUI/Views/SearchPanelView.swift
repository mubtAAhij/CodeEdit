...
struct SearchPanelView<RowView: View, PreviewView: View, Option: Identifiable & Hashable>: View {
                    ...
                    if hasPreview && previewVisible {
                        ...
                        if options.isEmpty {
                            ...
                            if let selection, let previewViewBuilder {
                                ...
                                Text(String(localized: "select_option_to_preview", comment: "Message to select an option for preview"))
                                    .frame(maxWidth: .infinity)
                            }
                        }
                    }
    ...
    @ViewBuilder var keyHandlers: some View {
        ...
        Button {
            ...
            .accessibilityLabel(String(localized: "select_up", comment: "Accessibility label for select up action"))
        Button {
            ...
            .accessibilityLabel(String(localized: "select_down", comment: "Accessibility label for select down action"))
    }
}
