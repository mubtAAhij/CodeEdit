...
struct SearchPanelView<RowView: View, PreviewView: View, Option: Identifiable & Hashable>: View {
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            if !text.isEmpty || alwaysShowOptions == true {
                ...
                HStack(spacing: 0) {
                    if options.isEmpty {
                        Text(String(localized: "no_matching_options", comment: "Empty state message when search returns no results"))
                            .font(.system(size: 17))
                            .foregroundColor(.secondary)
                    ...
                    if hasPreview && previewVisible {
                        ...
                        if options.isEmpty {
                            ...
                            if let selection, let previewViewBuilder {
                                ...
                                Text(String(localized: "select_option_to_preview", comment: "Preview panel placeholder message"))
                                    .frame(maxWidth: .infinity)
                            }
                        }
                    }
    ...
    @ViewBuilder var keyHandlers: some View {
        Button {
            ...
            .accessibilityLabel(String(localized: "close_overlay", comment: "Close overlay accessibility label"))
        Button {
            ...
            .accessibilityLabel(String(localized: "select_up", comment: "Select up accessibility label"))
        Button {
            ...
            .accessibilityLabel(String(localized: "select_down", comment: "Select down accessibility label"))
    }
}
