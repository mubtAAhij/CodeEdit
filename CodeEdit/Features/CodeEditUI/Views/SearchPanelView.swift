...
struct SearchPanelView<RowView: View, PreviewView: View, Option: Identifiable & Hashable>: View {
                    ...
                    if hasPreview && previewVisible {
                        ...
                        if options.isEmpty {
                            ...
                            if let selection, let previewViewBuilder {
                                ...
                                Text(String(localized: "select_option_to_preview", comment: "Message in preview pane when no option is selected"))
                                    .frame(maxWidth: .infinity)
                            }
                        }
                    }
    ...
    @ViewBuilder var keyHandlers: some View {
        Button {
            ...
            .accessibilityLabel(String(localized: "close_overlay", comment: "Accessibility label for close overlay button"))
        Button {
            ...
            .accessibilityLabel(String(localized: "select_up", comment: "Accessibility label for up arrow selection"))
        Button {
            ...
            .accessibilityLabel(String(localized: "select_down", comment: "Accessibility label for down arrow selection"))
    }
}
