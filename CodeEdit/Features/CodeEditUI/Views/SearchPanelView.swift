...
struct SearchPanelView<RowView: View, PreviewView: View, Option: Identifiable & Hashable>: View {
                    ...
                    if hasPreview && previewVisible {
                        ...
                        if options.isEmpty {
                            ...
                            if let selection, let previewViewBuilder {
                                ...
                                Text(String(localized: "search-panel.preview-prompt", defaultValue: "Select an option to preview", comment: "Preview prompt message"))
                                    .frame(maxWidth: .infinity)
                            }
                        }
                    }
    ...
    @ViewBuilder var keyHandlers: some View {
        Button {
            ...
            .accessibilityLabel(String(localized: "search-panel.close", defaultValue: "Close Overlay", comment: "Close overlay tooltip"))
        Button {
            ...
            .accessibilityLabel(String(localized: "search-panel.select-up", defaultValue: "Select Up", comment: "Select up tooltip"))
        Button {
            ...
            .accessibilityLabel(String(localized: "search-panel.select-down", defaultValue: "Select Down", comment: "Select down tooltip"))
    }
}
