...
struct SearchPanelView<RowView: View, PreviewView: View, Option: Identifiable & Hashable>: View {
                    ...
                    if hasPreview && previewVisible {
                        ...
                        if options.isEmpty {
                            ...
                            if let selection, let previewViewBuilder {
                                ...
                                Text(String(localized: "search-panel.select-option-to-preview", defaultValue: "Select an option to preview", comment: "Placeholder when no option is selected"))
                                    .frame(maxWidth: .infinity)
                            }
                        }
                    }
    ...
    @ViewBuilder var keyHandlers: some View {
        ...
        Button {
            ...
            .accessibilityLabel(String(localized: "search-panel.select-up", defaultValue: "Select Up", comment: "Accessibility label for select up action"))
        Button {
            ...
            .accessibilityLabel(String(localized: "search-panel.select-down", defaultValue: "Select Down", comment: "Accessibility label for select down action"))
    }
}
