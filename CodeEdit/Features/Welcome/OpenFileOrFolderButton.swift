...
struct OpenFileOrFolderButton: View {
    ...
    var body: some View {
        WelcomeButton(
            iconName: "folder",
            title: String(localized: "welcome.open-file-or-folder-button", defaultValue: "Open File or Folder...", comment: "Welcome screen button title to open a file or folder"),
            action: {
