...
struct OpenFileOrFolderButton: View {
    ...
    var body: some View {
        WelcomeButton(
            iconName: "folder",
            title: String(localized: "welcome.open-file-or-folder.button-title", defaultValue: "Open File or Folder...", comment: "Button title to open a file or folder from the welcome screen"),
            action: {
