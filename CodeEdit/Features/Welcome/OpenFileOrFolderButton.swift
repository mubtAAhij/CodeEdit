...
struct OpenFileOrFolderButton: View {
    ...
    var body: some View {
        WelcomeButton(
            iconName: "folder",
            title: String(localized: "welcome.open-file-or-folder.button.title", defaultValue: "Open File or Folder...", comment: "Title for welcome screen button to open a file or folder"),
            action: {
