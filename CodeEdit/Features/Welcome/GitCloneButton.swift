...
struct GitCloneButton: View {
    ...
    var body: some View {
        WelcomeButton(
            ...
            title: String(localized: "welcome.clone-git-repository-button", defaultValue: "Clone Git Repository...", comment: "Welcome screen button title to clone a repository"),
            action: {
                showGitClone = true
            }
        )
