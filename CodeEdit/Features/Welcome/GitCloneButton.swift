...
struct GitCloneButton: View {
    ...
    var body: some View {
        WelcomeButton(
            ...
            title: String(localized: "welcome.git-clone.button.title", defaultValue: "Clone Git Repository...", comment: "Title for the welcome screen button that clones a Git repository"),
            action: {
                showGitClone = true
            }
        )
