...
struct WelcomeSubtitleView: View {
    ...
    var body: some View {
        ...
        .help(String(localized: "welcome.system-info.copy-to-clipboard", defaultValue: "Copy System Information to Clipboard", comment: "Button title to copy system information to clipboard"))
    }
}
