...
struct WelcomeSubtitleView: View {
    ...
    var body: some View {
        ...
        .help(String(localized: "welcome.system-info.help", defaultValue: "Copy System Information to Clipboard", comment: "Help text for system information button on welcome screen"))
    }
}
