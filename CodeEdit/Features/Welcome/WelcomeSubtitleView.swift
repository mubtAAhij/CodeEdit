...
struct WelcomeSubtitleView: View {
    ...
    var body: some View {
        ...
        .help(String(localized: "welcome.copy-system-info", defaultValue: "Copy System Information to Clipboard", comment: "Tooltip for copying system information to clipboard"))
    }
}
