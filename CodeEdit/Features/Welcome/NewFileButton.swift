...
struct NewFileButton: View {
    ...
    var body: some View {
        WelcomeButton(
            ...
            title: String(localized: "welcome.create-new-file.button-title", defaultValue: "Create New File...", comment: "Button title to create a new file from the welcome screen"),
            action: {
