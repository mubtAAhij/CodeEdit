...
extension NotificationManager: UNUserNotificationCenterDelegate {
    ...
    func setupNotificationDelegate() {
        ...
        let action = UNNotificationAction(
            ...
            title: String(localized: "notifications.banner.action", defaultValue: "Action", comment: "Label for notification action section"), // This will be replaced with actual button title
            options: .foreground
        )
