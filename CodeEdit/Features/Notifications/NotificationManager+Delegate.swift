...
extension NotificationManager: UNUserNotificationCenterDelegate {
    ...
    func setupNotificationDelegate() {
        ...
        let action = UNNotificationAction(
            ...
            title: String(localized: "notifications.banner.action-button", defaultValue: "Action", comment: "Default action button title for notifications"), // This will be replaced with actual button title
            options: .foreground
        )
