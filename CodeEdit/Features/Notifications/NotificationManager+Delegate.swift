...
extension NotificationManager: UNUserNotificationCenterDelegate {
    ...
    func setupNotificationDelegate() {
        ...
        let action = UNNotificationAction(
            ...
            title: String(localized: "notifications.action", defaultValue: "Action", comment: "Default action button title for notification"), // This will be replaced with actual button title
            options: .foreground
        )
