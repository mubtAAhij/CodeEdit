...
extension NotificationManager: UNUserNotificationCenterDelegate {
    ...
    func setupNotificationDelegate() {
        ...
        let action = UNNotificationAction(
            ...
            title: String(localized: "notification.action", defaultValue: "Action", comment: "Default notification action button title"), // This will be replaced with actual button title
            options: .foreground
        )
