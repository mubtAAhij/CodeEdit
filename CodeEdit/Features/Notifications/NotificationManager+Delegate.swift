...
extension NotificationManager: UNUserNotificationCenterDelegate {
    ...
    func setupNotificationDelegate() {
        ...
        let action = UNNotificationAction(
            ...
            title: String(localized: "notifications.action_button_title", comment: "Default title for notification action button"), // This will be replaced with actual button title
            options: .foreground
        )
