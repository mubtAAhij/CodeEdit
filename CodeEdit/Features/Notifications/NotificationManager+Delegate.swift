...
extension NotificationManager: UNUserNotificationCenterDelegate {
    ...
    func setupNotificationDelegate() {
        ...
        let action = UNNotificationAction(
            ...
            title: String(localized: "notifications.action", defaultValue: "Action", comment: "Action button title for notifications"), // This will be replaced with actual button title
            options: .foreground
        )
