...
struct SearchModeModel: Hashable {
    ...
    static let Containing = SearchModeModel(
        title: String(
            localized: "search-mode.containing",
            defaultValue: "Containing",
            comment: "Search mode for containing text"
        ),
        children: [],
    ...
    static let MatchingWord = SearchModeModel(
        title: String(
            ...
            comment: "Search mode for matching whole word"
        ),
        children: [],
    ...
    static let StartingWith = SearchModeModel(
        title: String(
            ...
            comment: "Search mode for text starting with query"
        ),
        children: [],
        needSelectionHighlight: true
    )
    static let EndingWith = SearchModeModel(
        title: String(
            localized: "search-mode.ending-with",
            defaultValue: "Ending With",
            comment: "Search mode for text ending with query"
        ),
        children: [],
        needSelectionHighlight: true
    )
    ...
    static let References = SearchModeModel(
        title: String(
            ...
            comment: "Search mode for code references"
        ),
        children: [.Containing, .MatchingWord, .StartingWith, .EndingWith],
        needSelectionHighlight: true
    )
    static let Definitions = SearchModeModel(
        title: String(
            ...
            comment: "Search mode for code definitions"
        ),
        children: [.Containing, .MatchingWord, .StartingWith, .EndingWith],
        needSelectionHighlight: true
    )
    static let RegularExpression = SearchModeModel(
        title: String(
            ...
            comment: "Search mode for regular expression"
        ),
        children: [],
        needSelectionHighlight: true
    )
    static let CallHierarchy = SearchModeModel(
        title: String(
            ...
            comment: "Search mode for call hierarchy"
        ),
        children: [],
        needSelectionHighlight: true
    )
    ...
    static let Replace = SearchModeModel(
        title: String(
            ...
            comment: "Search mode for replace"
        ),
