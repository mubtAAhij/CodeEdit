...
struct SearchModeModel: Hashable {
    ...
    static let MatchingWord = SearchModeModel(
        title: String(localized: "matching_word", comment: "Search mode for matching whole words"),
        children: [],
        needSelectionHighlight: true
    )
    static let StartingWith = SearchModeModel(
        title: String(localized: "starting_with", comment: "Search mode for text starting with pattern"),
        children: [],
        needSelectionHighlight: true
    )
    static let EndingWith = SearchModeModel(title: String(localized: "ending_with", comment: "Search mode for text ending with pattern"), children: [], needSelectionHighlight: true)
    ...
    static let References = SearchModeModel(
        title: String(localized: "references", comment: "Search mode for finding code references"),
        children: [.Containing, .MatchingWord, .StartingWith, .EndingWith],
        needSelectionHighlight: true
    )
    static let Definitions = SearchModeModel(
        title: String(localized: "definitions", comment: "Search mode for finding code definitions"),
        children: [.Containing, .MatchingWord, .StartingWith, .EndingWith],
        needSelectionHighlight: true
    )
    static let RegularExpression = SearchModeModel(
        title: String(localized: "regular_expression", comment: "Search mode for regular expression patterns"),
        children: [],
        needSelectionHighlight: true
    )
    static let CallHierarchy = SearchModeModel(
        title: String(localized: "call_hierarchy", comment: "Search mode for call hierarchy analysis"),
        children: [],
        needSelectionHighlight: true
    )

    static let Find = SearchModeModel(
        title: String(localized: "find", comment: "Search mode category for finding items"),
        children: [.Text, .References, .Definitions, .RegularExpression, .CallHierarchy],
        needSelectionHighlight: false
    )
    static let Replace = SearchModeModel(
        title: String(localized: "replace", comment: "Search mode category for find and replace"),
