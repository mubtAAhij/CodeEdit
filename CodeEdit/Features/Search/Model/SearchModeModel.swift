...
struct SearchModeModel: Hashable {
    ...
    static let MatchingWord = SearchModeModel(
        title: String(localized: "search.mode.matching_word", defaultValue: "Matching Word", comment: "Matching word search mode"),
        children: [],
        needSelectionHighlight: true
    )
    static let StartingWith = SearchModeModel(
        title: String(localized: "search.mode.starting_with", defaultValue: "Starting With", comment: "Starting with search mode"),
        children: [],
        needSelectionHighlight: true
    )
    static let EndingWith = SearchModeModel(title: String(localized: "search.mode.ending_with", defaultValue: "Ending With", comment: "Ending with search mode"), children: [], needSelectionHighlight: true)
    ...
    static let RegularExpression = SearchModeModel(
        title: String(localized: "search.mode.regex", defaultValue: "Regular Expression", comment: "Regular expression search mode"),
        children: [],
        needSelectionHighlight: true
    )
    static let CallHierarchy = SearchModeModel(
        title: String(localized: "search.mode.call_hierarchy", defaultValue: "Call Hierarchy", comment: "Call hierarchy search mode"),
        children: [],
        needSelectionHighlight: true
    )

    static let Find = SearchModeModel(
        title: String(localized: "search.mode.find", defaultValue: "Find", comment: "Find mode"),
        children: [.Text, .References, .Definitions, .RegularExpression, .CallHierarchy],
        needSelectionHighlight: false
    )
    static let Replace = SearchModeModel(
        title: String(localized: "search.mode.replace", defaultValue: "Replace", comment: "Replace mode"),
