...
struct SearchModeModel: Hashable {
    ...
    static let Containing = SearchModeModel(title: String(localized: "search_mode.containing", comment: "Search mode for containing text"), children: [], needSelectionHighlight: false)
    static let MatchingWord = SearchModeModel(
        title: String(localized: "search_mode.matching_word", comment: "Search mode for matching whole words"),
        children: [],
        needSelectionHighlight: true
    )
    static let StartingWith = SearchModeModel(
        title: String(localized: "search_mode.starting_with", comment: "Search mode for text starting with pattern"),
        children: [],
        needSelectionHighlight: true
    )
    static let EndingWith = SearchModeModel(title: String(localized: "search.mode.ending_with", comment: "Search mode: ending with"), children: [], needSelectionHighlight: true)
    ...
    static let References = SearchModeModel(
        title: String(localized: "search.mode.references", comment: "Search mode: references"),
        children: [.Containing, .MatchingWord, .StartingWith, .EndingWith],
        needSelectionHighlight: true
    )
    static let Definitions = SearchModeModel(
        title: String(localized: "search.mode.definitions", comment: "Search mode: definitions"),
        children: [.Containing, .MatchingWord, .StartingWith, .EndingWith],
        needSelectionHighlight: true
    )
