...
struct SearchModeModel: Hashable {
    ...
    static let RegularExpression = SearchModeModel(
        title: String(localized: "search.mode.regular-expression", defaultValue: "Regular Expression", comment: "Search mode for regular expression"),
        children: [],
        needSelectionHighlight: true
    )
    ...
    static let Find = SearchModeModel(
        title: String(localized: "search.mode.find", defaultValue: "Find", comment: "Find mode option"),
        children: [.Text, .References, .Definitions, .RegularExpression, .CallHierarchy],
        needSelectionHighlight: false
    )
    static let Replace = SearchModeModel(
        title: String(localized: "search.mode.replace", defaultValue: "Replace", comment: "Replace mode option"),
