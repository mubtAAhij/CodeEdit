...
struct SearchModeModel: Hashable {
    ...
    static let Containing = SearchModeModel(title: String(localized: "containing", comment: "Search mode: containing text"), children: [], needSelectionHighlight: false)
    static let MatchingWord = SearchModeModel(
        title: String(localized: "matching_word", comment: "Search mode: matching whole word"),
        children: [],
        needSelectionHighlight: true
    )
    static let StartingWith = SearchModeModel(
        title: String(localized: "starting_with", comment: "Search mode: starting with text"),
        children: [],
        needSelectionHighlight: true
    )
    static let EndingWith = SearchModeModel(title: String(localized: "ending_with", comment: "Search mode: ending with text"), children: [], needSelectionHighlight: true)
    ...
    static let References = SearchModeModel(
        title: String(localized: "references", comment: "Search mode: find references"),
        children: [.Containing, .MatchingWord, .StartingWith, .EndingWith],
        needSelectionHighlight: true
    )
    static let Definitions = SearchModeModel(
        title: String(localized: "definitions", comment: "Search mode: find definitions"),
        children: [.Containing, .MatchingWord, .StartingWith, .EndingWith],
        needSelectionHighlight: true
    )
    ...
    static let Find = SearchModeModel(
        title: String(localized: "find", comment: "Search mode: find"),
        children: [.Text, .References, .Definitions, .RegularExpression, .CallHierarchy],
        needSelectionHighlight: false
    )
    static let Replace = SearchModeModel(
        title: String(localized: "replace", comment: "Search mode: replace"),
