...
struct SearchModeModel: Hashable {
    ...
    static let Containing = SearchModeModel(title: String(localized: "search-mode.containing", defaultValue: "Containing", comment: "Search mode for text containing"), children: [], needSelectionHighlight: false)
    ...
    static let StartingWith = SearchModeModel(
        title: String(localized: "search-mode.starting-with", defaultValue: "Starting With", comment: "Search mode for text starting with"),
        children: [],
        needSelectionHighlight: true
    )
    static let EndingWith = SearchModeModel(title: String(localized: "search-mode.ending-with", defaultValue: "Ending With", comment: "Search mode for text ending with"), children: [], needSelectionHighlight: true)
    ...
    static let RegularExpression = SearchModeModel(
        title: String(localized: "search-mode.regex", defaultValue: "Regular Expression", comment: "Search mode for regular expression"),
        children: [],
        needSelectionHighlight: true
    )
