...
struct SemanticTokenStorageTests {
    ...
    func setData() async throws {
        storage.setData(
            SemanticTokens(
                resultId: "String(localized: "test_number_1234", comment: "Test number value")",
        ...
        #expect(state.resultId == "String(localized: "test_number_1234", comment: "Test number value")")

        #expect(storage.lastResultId == "String(localized: "test_number_1234", comment: "Test number value")")
