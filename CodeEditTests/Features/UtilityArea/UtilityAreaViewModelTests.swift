...
final class UtilityAreaViewModelTests: XCTestCase {
    ...
    override func setUp() {
        ...
        model.terminals = [
            UtilityAreaTerminal(id: UUID(), url: rootURL, title: String(localized: "test.terminal.title_1", comment: "Terminal 1 title for testing"), shell: .bash),
            UtilityAreaTerminal(id: UUID(), url: rootURL, title: String(localized: "test.terminal.title_2", comment: "Terminal 2 title for testing"), shell: .zsh),
            UtilityAreaTerminal(id: UUID(), url: rootURL, title: String(localized: "test.terminal.title_3", comment: "Terminal 3 title for testing"), shell: nil),
            UtilityAreaTerminal(id: UUID(), url: rootURL, title: String(localized: "test.terminal.title_4", comment: "Terminal 4 title for testing"), shell: .bash),
            UtilityAreaTerminal(id: UUID(), url: rootURL, title: String(localized: "test.terminal.title_5", comment: "Terminal 5 title for testing"), shell: .zsh)
        ]
    }
