...
final class UtilityAreaViewModelTests: XCTestCase {
    ...
    override func setUp() {
        ...
        model.terminals = [
            UtilityAreaTerminal(id: UUID(), url: rootURL, title: String(localized: "Terminal 1", comment: "Terminal 1 label for test"), shell: .bash),
            UtilityAreaTerminal(id: UUID(), url: rootURL, title: String(localized: "Terminal 2", comment: "Terminal 2 label for test"), shell: .zsh),
            UtilityAreaTerminal(id: UUID(), url: rootURL, title: String(localized: "Terminal 3", comment: "Terminal 3 label for test"), shell: nil),
            UtilityAreaTerminal(id: UUID(), url: rootURL, title: String(localized: "Terminal 4", comment: "Terminal 4 label for test"), shell: .bash),
            UtilityAreaTerminal(id: UUID(), url: rootURL, title: String(localized: "Terminal 5", comment: "Terminal 5 label for test"), shell: .zsh)
        ]
    }
