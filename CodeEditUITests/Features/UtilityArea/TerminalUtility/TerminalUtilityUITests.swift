...
final class TerminalUtilityUITests: XCTestCase {
    ...
    func testTerminalsInputData() throws {
        let terminal = utilityArea.textViews[String(localized: "test.terminal-emulator", defaultValue: "Terminal Emulator", comment: "Terminal emulator accessibility identifier in test")]
    ...
    func testTerminalsKeepData() throws {
        var terminal = utilityArea.textViews[String(localized: "test.terminal-emulator", defaultValue: "Terminal Emulator", comment: "Terminal emulator accessibility identifier in test")]
        XCTAssertTrue(terminal.exists)
        terminal.click()
        terminal.typeText("echo hello world")
        terminal.typeKey(.enter, modifierFlags: [])
        ...
        terminal = utilityArea.textViews[String(localized: "test.terminal-emulator", defaultValue: "Terminal Emulator", comment: "Terminal emulator accessibility identifier in test")]
        XCTAssertTrue(terminal.exists)
