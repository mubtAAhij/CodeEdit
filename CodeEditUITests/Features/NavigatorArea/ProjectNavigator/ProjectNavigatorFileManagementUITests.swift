...
final class ProjectNavigatorFileManagementUITests: XCTestCase {
    ...
    func testNewFilesAppear() throws {
        ...
        guard Query.Navigator.getProjectNavigatorRow(
            fileTitle: String(localized: "test.new-folder", defaultValue: "New Folder", comment: "New folder name in test"),
            navigator
        ).waitForExistence(timeout: 2.0) else {
        ...
        let folderRow = Query.Navigator.getProjectNavigatorRow(fileTitle: String(localized: "test.new-folder", defaultValue: "New Folder", comment: "New folder name in test"), navigator)
    ...
    func testCreateNewFiles() throws {
        ...
        for idx in 0..<5 {
            ...
            addMenu.menuItems[String(localized: "test.add-file", defaultValue: "Add File", comment: "Add file menu item in test")].click()
