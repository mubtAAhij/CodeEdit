...
final class ProjectNavigatorFileManagementUITests: XCTestCase {
    ...
    func testNewFilesAppear() throws {
        ...
        guard Query.Navigator.getProjectNavigatorRow(
            fileTitle: String(localized: "New Folder", comment: "Default name for a new folder"),
            navigator
        ).waitForExistence(timeout: 2.0) else {
        ...
        let folderRow = Query.Navigator.getProjectNavigatorRow(fileTitle: String(localized: "New Folder", comment: "Default name for a new folder"), navigator)
    ...
    func testCreateNewFiles() throws {
        ...
        for idx in 0..<5 {
            ...
            addMenu.menuItems[String(localized: "Add File", comment: "Menu item to add a new file")].click()
