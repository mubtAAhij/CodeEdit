...
final class ProjectNavigatorFileManagementUITests: XCTestCase {
    ...
    func testNewFilesAppear() throws {
        ...
        guard Query.Navigator.getProjectNavigatorRow(
            fileTitle: String(localized: "test.new-folder", defaultValue: "New Folder", comment: "Test folder name for UI tests"),
            navigator
        ).waitForExistence(timeout: 2.0) else {
        ...
        let folderRow = Query.Navigator.getProjectNavigatorRow(fileTitle: String(localized: "test.new-folder", defaultValue: "New Folder", comment: "Test folder name for UI tests"), navigator)
    ...
    func testCreateNewFiles() throws {
        ...
        for idx in 0..<5 {
            ...
            addMenu.menuItems[String(localized: "test.add-file", defaultValue: "Add File", comment: "Menu item to add a file in UI tests")].click()
