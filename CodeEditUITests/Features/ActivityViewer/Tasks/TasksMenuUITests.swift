...
final class ActivityViewerTasksMenuTests: XCTestCase {
    ...
    func testTaskMenu() {
        ...
        XCTAssertEqual(taskDropdown.value as? String, String(localized: "create_tasks", comment: "Create Tasks label"), "Incorrect empty tasks label")
    ...
    func testNewTask() {
        ...
        let addTaskListOption = popover.buttons[String(localized: "add_task", comment: "Add Task menu option")]
        ...
        let addTaskButton = workspaceSettingsWindow.buttons[String(localized: "add_task", comment: "Add Task menu option")]
