...
final class HideInterfaceUITests: XCTestCase {
    ...
    private let allPanels: () -> [String] = {
        ["Navigator", "Inspector", String(localized: "test.utility-area", defaultValue: "Utility Area", comment: "Utility Area panel name in tests"), "Toolbar"]
    }
    ...
    func testPanelsShowAndHideIndividually() {
        let viewMenu = app.menuBars.menuBarItems[String(localized: "test.view-menu", defaultValue: "View", comment: "View menu name in tests")]
