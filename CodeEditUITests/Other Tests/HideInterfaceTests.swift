...
final class HideInterfaceUITests: XCTestCase {
    ...
    private let allPanels: () -> [String] = {
        ["Navigator", "Inspector", "String(localized: "utility_area", comment: "Label for the utility area UI component")", "Toolbar"]
    }
    ...
    func testPanelsShowAndHideIndividually() {
        let viewMenu = app.menuBars.menuBarItems["String(localized: "view", comment: "Menu item for View menu")"]
