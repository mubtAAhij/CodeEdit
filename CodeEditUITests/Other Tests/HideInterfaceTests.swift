...
final class HideInterfaceUITests: XCTestCase {
    ...
    private let allPanels: () -> [String] = {
        ["Navigator", "Inspector", String(localized: "panel.utility_area", comment: "Name of the utility area panel"), "Toolbar"]
    }
    ...
    func testPanelsShowAndHideIndividually() {
        let viewMenu = app.menuBars.menuBarItems[String(localized: "menu.view", comment: "View menu name")]
