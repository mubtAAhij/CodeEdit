...
final class HideInterfaceUITests: XCTestCase {
    ...
    private let allPanels: () -> [String] = {
        ["Navigator", "Inspector", String(localized: "hideInterfaceTests.utilityArea", comment: "Test panel name"), "Toolbar"]
    }
    ...
    func testPanelsShowAndHideIndividually() {
        let viewMenu = app.menuBars.menuBarItems[String(localized: "hideInterfaceTests.view", comment: "Menu title")]
