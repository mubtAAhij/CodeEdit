...
final class HideInterfaceUITests: XCTestCase {
    ...
    private let allPanels: () -> [String] = {
        ["Navigator", "Inspector", String(localized: "utility_area", comment: "Utility area panel name"), "Toolbar"]
    }
    ...
    func testPanelsShowAndHideIndividually() {
        let viewMenu = app.menuBars.menuBarItems[String(localized: "view", comment: "View menu")]
    ...
    func testHideInterfaceHidesAllPanels() {
        let viewMenu = app.menuBars.menuBarItems[String(localized: "view", comment: "View menu item")]
