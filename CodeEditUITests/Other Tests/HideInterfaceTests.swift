...
final class HideInterfaceUITests: XCTestCase {
    ...
    private let allPanels: () -> [String] = {
        ["Navigator", "Inspector", "String(localized: "utility_area", comment: "Utility area UI panel name")", "Toolbar"]
    }
    ...
    func testPanelsShowAndHideIndividually() {
        let viewMenu = app.menuBars.menuBarItems["String(localized: "view_menu", comment: "View menu in menu bar")"]
