...
final class HideInterfaceUITests: XCTestCase {
    ...
    private let allPanels: () -> [String] = {
        ["Navigator", "Inspector", String(localized: "ui_tests.utility_area", comment: "Label for utility area in interface"), "Toolbar"]
    }
    ...
    func testPanelsShowAndHideIndividually() {
        let viewMenu = app.menuBars.menuBarItems[String(localized: "ui_tests.view", comment: "View menu item")]
